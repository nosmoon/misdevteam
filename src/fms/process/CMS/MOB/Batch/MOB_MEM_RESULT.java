...
public class MOB_MEM_RESULT {
	public static void main(String [] ar){
		...
		sended_flag = conn.sendData(HP_SampleTelegrams.MOB_Start_MEM_RESULT);
		if(sended_flag)log.tgrLog("송신", HP_SampleTelegrams.MOB_Start_MEM_RESULT);
