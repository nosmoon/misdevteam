...
public class CMS_MEM_SEARCH_New {
	...
	public static void main(String [] ar){
		...
		sended_flag = conn.sendData(BATCH_CMS_Sample_Telegrams_New.CMS_REAL_AUTH_New);
		if(sended_flag)log.tgrLog("송신", BATCH_CMS_Sample_Telegrams_New.CMS_REAL_AUTH_New);
		
		/*ConsoleLog log = new ConsoleLog();
		boolean sended_flag=false;
		sended_flag = conn.sendData(BATCH_CMS_Sample_Telegrams.CMS_START_MEM_SEARCH_V2);
		if(sended_flag)log.tgrLog("송신", BATCH_CMS_Sample_Telegrams.CMS_START_MEM_SEARCH_V2);*/
