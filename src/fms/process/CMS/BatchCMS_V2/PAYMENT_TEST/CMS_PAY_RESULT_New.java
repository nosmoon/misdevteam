...
public class CMS_PAY_RESULT_New {
	...
	public static void main(String [] ar){
		...
		sended_flag = conn.sendData(BATCH_CMS_Sample_Telegrams_New.CMS_START_PAY_RESULT_New);
		if(sended_flag)log.tgrLog("송신", BATCH_CMS_Sample_Telegrams_New.CMS_START_PAY_RESULT_New);
