...
public class ARS_APR_APPLY {
	...
	public static void main(String [] ar){
		 ...
		 * 1. 시작전문 송신
		 */
		conn.sendData(ARS_SampleTelegrams.ARS_APR_APPLY); //신청일자 변경
		log.msgLog(ARS_SampleTelegrams.ARS_APR_APPLY);
		...
		//H
		conn.sendData(ARS_SampleTelegrams.ARS_APR_APPLY_Header);
		log.tgrLog("송신", ARS_SampleTelegrams.ARS_APR_APPLY_Header);
		
		//D
		conn.sendData(ARS_SampleTelegrams.ARS_APR_APPLY_Data);
		log.tgrLog("송신", ARS_SampleTelegrams.ARS_APR_APPLY_Data);
		
		//T
		conn.sendData(ARS_SampleTelegrams.ARS_APR_APPLY_Tail);
		log.tgrLog("송신", ARS_SampleTelegrams.ARS_APR_APPLY_Tail);
