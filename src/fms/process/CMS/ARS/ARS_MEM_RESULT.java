...
public class ARS_MEM_RESULT {
	...
	public static void main(String [] ar){
		 ...
		 * 1. 시작전문 송신
		 */
		conn.sendData(ARS_SampleTelegrams.ARS_MEM_RESULT); //신청일자 변경
		log.msgLog(ARS_SampleTelegrams.ARS_MEM_RESULT);
		...
		/*//H
		conn.sendData(ARS_SampleTelegrams.ARS_Header);
		log.tgrLog("송신", ARS_SampleTelegrams.ARS_Header);
		
		//D
		conn.sendData(ARS_SampleTelegrams.ARS_Data);
		log.tgrLog("송신", ARS_SampleTelegrams.ARS_Data);
		
		//T
		conn.sendData(ARS_SampleTelegrams.ARS_Tail);
		log.tgrLog("송신", ARS_SampleTelegrams.ARS_Tail);*/
