...
public class MT_ETCIMPT_1205_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String yy;
	public String leas_clsf;

	public MT_ETCIMPT_1205_LDM(){}
	public MT_ETCIMPT_1205_LDM(String cmpy_cd, String yy, String leas_clsf){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_ETCIMPT_1205_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_ETCIMPT_1205_LDM dm = (MT_ETCIMPT_1205_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.etcimpt.ds.MT_ETCIMPT_1205_LDataSet();
	}
