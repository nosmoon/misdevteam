...
public class MT_ETCIMPT_1101_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String yy;
	public String cmpy_cd;

	public MT_ETCIMPT_1101_LDM(){}
	public MT_ETCIMPT_1101_LDM(String yy, String cmpy_cd){
		this.yy = yy;
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_ETCIMPT_1101_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_ETCIMPT_1101_LDM dm = (MT_ETCIMPT_1101_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.etcimpt.ds.MT_ETCIMPT_1101_LDataSet();
	}
