...
public class MT_ETCPC_2002_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String modl_kind;

	public MT_ETCPC_2002_MDM(){}
	public MT_ETCPC_2002_MDM(String cmpy_cd, String modl_kind){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_ETCPC_2002_M(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_ETCPC_2002_MDM dm = (MT_ETCPC_2002_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.etcpc.ds.MT_ETCPC_2002_MDataSet();
	}
