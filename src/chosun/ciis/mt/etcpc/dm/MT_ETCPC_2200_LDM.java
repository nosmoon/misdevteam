...
public class MT_ETCPC_2200_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String mchn_mang_no;

	public MT_ETCPC_2200_LDM(){}
	public MT_ETCPC_2200_LDM(String cmpy_cd, String mchn_mang_no){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_ETCPC_2200_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_ETCPC_2200_LDM dm = (MT_ETCPC_2200_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.etcpc.ds.MT_ETCPC_2200_LDataSet();
	}
