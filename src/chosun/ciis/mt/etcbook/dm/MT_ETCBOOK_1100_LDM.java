...
public class MT_ETCBOOK_1100_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_ETCBOOK_1100_LDM(){}
	public MT_ETCBOOK_1100_LDM(String cmpy_cd, String clam_dt_fr, String clam_dt_to, String dept_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_ETCBOOK_1100_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_ETCBOOK_1100_LDM dm = (MT_ETCBOOK_1100_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.etcbook.ds.MT_ETCBOOK_1100_LDataSet();
	}
