...
public class MT_ETCBOOK_1104_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_ETCBOOK_1104_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_ETCBOOK_1104_ADM dm = (MT_ETCBOOK_1104_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.etcbook.ds.MT_ETCBOOK_1104_ADataSet();
	}
...
/* 작성시간 : Thu Apr 02 19:02:26 KST 2009 */