...
public class MT_SUBMATROUT_1152_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATROUT_1152_LDM(){}
	public MT_SUBMATROUT_1152_LDM(String cmpy_cd, String owh_dt_fr, String owh_dt_to, String fac_clsf){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATROUT_1152_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATROUT_1152_LDM dm = (MT_SUBMATROUT_1152_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrout.ds.MT_SUBMATROUT_1152_LDataSet();
	}
