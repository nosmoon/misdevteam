...
public class MT_SUBMATROUT_1115_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATROUT_1115_LDM(){}
	public MT_SUBMATROUT_1115_LDM(String cmpy_cd, String ewh_dt, String fac_clsf, String dept_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATROUT_1115_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATROUT_1115_LDM dm = (MT_SUBMATROUT_1115_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrout.ds.MT_SUBMATROUT_1115_LDataSet();
	}
