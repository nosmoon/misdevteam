...
public class MT_SUBMATROUT_2005_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATROUT_2005_UDM(){}
	public MT_SUBMATROUT_2005_UDM(String cmpy_cd, String occr_dt, String seq, String state, String per_id, String per_addr){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATROUT_2005_U(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATROUT_2005_UDM dm = (MT_SUBMATROUT_2005_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrout.ds.MT_SUBMATROUT_2005_UDataSet();
	}
...
/* 작성시간 : Mon Jul 27 18:38:57 KST 2009 */