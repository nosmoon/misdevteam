...
public class MT_SUBMATROUT_1602_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATROUT_1602_LDM(){}
	public MT_SUBMATROUT_1602_LDM(String cmpy_cd, String owh_dt, String occr_dt, String seq, String matr_cd, String fac_clsf){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATROUT_1602_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATROUT_1602_LDM dm = (MT_SUBMATROUT_1602_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrout.ds.MT_SUBMATROUT_1602_LDataSet();
	}
