...
public class MT_SUBMATROUT_1117_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATROUT_1117_UDM(){}
	public MT_SUBMATROUT_1117_UDM(String cmpy_cd, String occr_dt, String seq, String state, String per_id, String per_addr){
	...
	public String getSQL(){
		 return "{ call SP_MT_SUBMATROUT_1117_U( ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATROUT_1117_UDM dm = (MT_SUBMATROUT_1117_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrout.ds.MT_SUBMATROUT_1117_UDataSet();
	}
...
/* 작성시간 : Mon Jun 29 10:49:13 KST 2009 */