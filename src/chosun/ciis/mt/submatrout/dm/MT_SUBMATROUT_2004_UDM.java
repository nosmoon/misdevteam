...
public class MT_SUBMATROUT_2004_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATROUT_2004_UDM(){}
	public MT_SUBMATROUT_2004_UDM(String cmpy_cd, String occr_dt, String seq, String state, String per_id, String per_addr){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATROUT_2004_U(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATROUT_2004_UDM dm = (MT_SUBMATROUT_2004_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrout.ds.MT_SUBMATROUT_2004_UDataSet();
	}
...
/* 작성시간 : Mon Jul 27 19:01:04 KST 2009 */