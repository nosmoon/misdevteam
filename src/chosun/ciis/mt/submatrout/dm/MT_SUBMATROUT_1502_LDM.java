...
public class MT_SUBMATROUT_1502_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String owh_dt;
	public String fac_clsf;

	public MT_SUBMATROUT_1502_LDM(){}
	public MT_SUBMATROUT_1502_LDM(String cmpy_cd, String owh_dt, String fac_clsf){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATROUT_1502_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATROUT_1502_LDM dm = (MT_SUBMATROUT_1502_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrout.ds.MT_SUBMATROUT_1502_LDataSet();
	}
