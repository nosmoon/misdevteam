...
public class MT_PAPMEDA_1301_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String meda_yymm_fr;
	public String meda_yymm_to;

	public MT_PAPMEDA_1301_LDM(){}
	public MT_PAPMEDA_1301_LDM(String cmpy_cd, String meda_yymm_fr, String meda_yymm_to){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPMEDA_1301_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPMEDA_1301_LDM dm = (MT_PAPMEDA_1301_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papmeda.ds.MT_PAPMEDA_1301_LDataSet();
	}
