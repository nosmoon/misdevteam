...
public class MT_PAPMEDA_1100_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String papcmpy_cd;

	public MT_PAPMEDA_1100_LDM(){}
	public MT_PAPMEDA_1100_LDM(String cmpy_cd, String papcmpy_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPMEDA_1100_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPMEDA_1100_LDM dm = (MT_PAPMEDA_1100_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papmeda.ds.MT_PAPMEDA_1100_LDataSet();
	}
