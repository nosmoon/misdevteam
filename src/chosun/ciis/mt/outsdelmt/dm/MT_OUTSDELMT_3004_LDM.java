...
public class MT_OUTSDELMT_3004_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String outsd_elmt_clsf;
	public String aply_clsf;
	public String aply_yymm;
	public String aply_dt;

	public MT_OUTSDELMT_3004_LDM(){}
	public MT_OUTSDELMT_3004_LDM(String cmpy_cd, String outsd_elmt_clsf, String aply_clsf, String aply_yymm, String aply_dt){
	...
	public String getSQL(){
		 return "{ call SP_MT_OUTSDELMT_3004_L( ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_OUTSDELMT_3004_LDM dm = (MT_OUTSDELMT_3004_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.outsd_elmt_clsf);
		cstmt.setString(5, dm.aply_clsf);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.outsdelmt.ds.MT_OUTSDELMT_3004_LDataSet();
	}
    ...
    public void print(){
        ...
        System.out.println("aply_clsf = " + getAply_clsf());
...
String aply_clsf = req.getParameter("aply_clsf");
if( aply_clsf == null){
	System.out.println(this.toString+" : aply_clsf is null" );
}else{
	System.out.println(this.toString+" : aply_clsf is "+aply_clsf );
}
...
String aply_clsf = Util.checkString(req.getParameter("aply_clsf"));
...
String aply_clsf = Util.Uni2Ksc(Util.checkString(req.getParameter("aply_clsf")));
...
dm.setAply_clsf(aply_clsf);
dm.setAply_yymm(aply_yymm);
dm.setAply_dt(aply_dt);
----------------------------------------------------------------------------------------------------*/


/* 작성시간 : Thu May 28 14:07:38 KST 2009 */