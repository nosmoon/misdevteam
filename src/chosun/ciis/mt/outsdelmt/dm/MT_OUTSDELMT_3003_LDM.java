...
public class MT_OUTSDELMT_3003_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String matr_cd;

	public MT_OUTSDELMT_3003_LDM(){}
	public MT_OUTSDELMT_3003_LDM(String cmpy_cd, String matr_cd){
	...
	public String getSQL(){
		 return "{ call SP_MT_OUTSDELMT_3003_L( ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_OUTSDELMT_3003_LDM dm = (MT_OUTSDELMT_3003_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.outsdelmt.ds.MT_OUTSDELMT_3003_LDataSet();
	}
