...
public class MT_OUTSDELMT_1002_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MT_OUTSDELMT_1002_LDataSet(){}
	public MT_OUTSDELMT_1002_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_OUTSDELMT_1002_LCURLISTRecord rec = new MT_OUTSDELMT_1002_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		MT_OUTSDELMT_1002_LCURLISTRecord curlistRec = (MT_OUTSDELMT_1002_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
