...
public class MT_SUBMATRSTOK_1020_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATRSTOK_1020_ADM(){}
	public MT_SUBMATRSTOK_1020_ADM(String gubun, String cmpy_cd, String occr_dt, String seq, String fac_clsf, String medi_cd, String sect_cd, String issu_pcnt, String bw_pcnt, String clr_pcnt, String slip_qty, String prt_bgn_tm, String prt_end_tm, String real_prt_qty, String err_tms, String incmg_pers_ipaddr, String incmg_pers, String gubun2, String cmpy_cd2, String occr_dt2, String seq2, String fac_clsf2, String ewh_wgt, String jego_wgt, String req_wgt, String matr_cd, String remk, String req_remk){
		this.gubun = gubun;
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATRSTOK_1020_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?, ? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATRSTOK_1020_ADM dm = (MT_SUBMATRSTOK_1020_ADM)bdm;
		...
		cstmt.setString(12, dm.clr_pcnt);
		cstmt.setString(13, dm.slip_qty);
		cstmt.setString(14, dm.prt_bgn_tm);
		cstmt.setString(15, dm.prt_end_tm);
		cstmt.setString(16, dm.real_prt_qty);
		cstmt.setString(17, dm.err_tms);
		cstmt.setString(18, dm.incmg_pers_ipaddr);
		cstmt.setString(19, dm.incmg_pers);
		cstmt.setString(20, dm.gubun2);
		cstmt.setString(21, dm.cmpy_cd2);
		cstmt.setString(22, dm.occr_dt2);
		cstmt.setString(23, dm.seq2);
		cstmt.setString(24, dm.fac_clsf2);
		cstmt.setString(25, dm.ewh_wgt);
		cstmt.setString(26, dm.jego_wgt);
		cstmt.setString(27, dm.req_wgt);
		cstmt.setString(28, dm.matr_cd);
		cstmt.setString(29, dm.remk);
		cstmt.setString(30, dm.req_remk);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrstok.ds.MT_SUBMATRSTOK_1020_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("req_wgt = [" + getReq_wgt() + "]");
		System.out.println("matr_cd = [" + getMatr_cd() + "]");
		System.out.println("remk = [" + getRemk() + "]");
		System.out.println("req_remk = [" + getReq_remk() + "]");
