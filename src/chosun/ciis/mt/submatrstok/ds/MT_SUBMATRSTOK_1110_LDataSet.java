...
public class MT_SUBMATRSTOK_1110_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public MT_SUBMATRSTOK_1110_LDataSet(){}
	public MT_SUBMATRSTOK_1110_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_SUBMATRSTOK_1110_LCURLIST1Record rec = new MT_SUBMATRSTOK_1110_LCURLIST1Record();
		...
		while(rset1.next()){
			MT_SUBMATRSTOK_1110_LCURLIST2Record rec = new MT_SUBMATRSTOK_1110_LCURLIST2Record();
			...
			rec.befor_roll = Util.checkString(rset1.getString("befor_roll"));
			rec.ewh_roll = Util.checkString(rset1.getString("ewh_roll"));
			rec.use_roll = Util.checkString(rset1.getString("use_roll"));
			rec.jego_roll = Util.checkString(rset1.getString("jego_roll"));
