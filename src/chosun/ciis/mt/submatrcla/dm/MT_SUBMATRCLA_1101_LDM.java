...
public class MT_SUBMATRCLA_1101_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String acpn_dt_fr;
	public String acpn_dt_to;

	public MT_SUBMATRCLA_1101_LDM(){}
	public MT_SUBMATRCLA_1101_LDM(String cmpy_cd, String acpn_dt_fr, String acpn_dt_to){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATRCLA_1101_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATRCLA_1101_LDM dm = (MT_SUBMATRCLA_1101_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrcla.ds.MT_SUBMATRCLA_1101_LDataSet();
	}
