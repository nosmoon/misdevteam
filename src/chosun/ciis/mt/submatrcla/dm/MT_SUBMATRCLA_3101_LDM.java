...
public class MT_SUBMATRCLA_3101_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATRCLA_3101_LDM(){}
	public MT_SUBMATRCLA_3101_LDM(String cmpy_cd, String dept_cd, String occr_dt_fr, String occr_dt_to, String matr_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATRCLA_3101_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATRCLA_3101_LDM dm = (MT_SUBMATRCLA_3101_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrcla.ds.MT_SUBMATRCLA_3101_LDataSet();
	}
