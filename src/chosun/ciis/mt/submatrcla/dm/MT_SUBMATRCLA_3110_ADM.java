...
public class MT_SUBMATRCLA_3110_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATRCLA_3110_ADM(){}
	public MT_SUBMATRCLA_3110_ADM(String mst_mode, String cmpy_cd, String incmg_pers_ipaddr, String incmg_pers, String chg_pers, String occr_dt, String seq, String dept_cd, String clam_clsf, String clam_actu_cd, String via_dept, String aplc_pers, String buy_proc_stat, String mode, String sub_seq, String matr_cd, String matr_nm, String std_modl, String unit, String clam_qunt, String fix_qunt, String purc_uprc, String amt, String usag){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATRCLA_3110_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATRCLA_3110_ADM dm = (MT_SUBMATRCLA_3110_ADM)bdm;
		...
		cstmt.setString(14, dm.aplc_pers);
		cstmt.setString(15, dm.buy_proc_stat);
		cstmt.setString(16, dm.mode);
		cstmt.setString(17, dm.sub_seq);
		cstmt.setString(18, dm.matr_cd);
		cstmt.setString(19, dm.matr_nm);
		cstmt.setString(20, dm.std_modl);
		cstmt.setString(21, dm.unit);
		cstmt.setString(22, dm.clam_qunt);
		cstmt.setString(23, dm.fix_qunt);
		cstmt.setString(24, dm.purc_uprc);
		cstmt.setString(25, dm.amt);
		cstmt.setString(26, dm.usag);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrcla.ds.MT_SUBMATRCLA_3110_ADataSet();
	}
