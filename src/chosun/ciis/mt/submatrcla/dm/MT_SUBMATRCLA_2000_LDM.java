...
public class MT_SUBMATRCLA_2000_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATRCLA_2000_LDM(){}
	public MT_SUBMATRCLA_2000_LDM(String cmpy_cd, String dept_cd, String occr_dt_fr, String occr_dt_to){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATRCLA_2000_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATRCLA_2000_LDM dm = (MT_SUBMATRCLA_2000_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrcla.ds.MT_SUBMATRCLA_2000_LDataSet();
	}
