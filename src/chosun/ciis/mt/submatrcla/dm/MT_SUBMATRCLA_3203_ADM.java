...
public class MT_SUBMATRCLA_3203_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATRCLA_3203_ADM(){}
	public MT_SUBMATRCLA_3203_ADM(String gubun, String cmpy_cd, String occr_dt, String seq, String sub_seq, String matr_cd, String item_nm, String std, String unit, String clam_qunt, String fix_qunt, String uprc, String amt, String usag, String clam_clsf, String paper_clsf, String recp_pers, String res_yn, String pay_posb_dt, String job_cntc_no, String remk, String frex_unit, String frex_uprc, String acpn_dt , String dlco_no, String incmg_pers_ipaddr, String incmg_pers){
		this.gubun = gubun;
	...
	public String getFrex_unit(){
		return this.frex_unit;
	}

	public String getFrex_uprc(){
		return this.frex_uprc;
	}
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATRCLA_3203_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATRCLA_3203_ADM dm = (MT_SUBMATRCLA_3203_ADM)bdm;
		...
		cstmt.setString(24, dm.frex_unit);
		cstmt.setString(25, dm.frex_uprc);
		cstmt.setString(26, dm.acpn_dt);
		cstmt.setString(27, dm.dlco_no);
		cstmt.setString(28, dm.incmg_pers_ipaddr);
		cstmt.setString(29, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrcla.ds.MT_SUBMATRCLA_3203_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("frex_unit = [" + getFrex_unit() + "]");
		System.out.println("frex_uprc = [" + getFrex_uprc() + "]");
...
String frex_unit = req.getParameter("frex_unit");
if( frex_unit == null){
	System.out.println(this.toString+" : frex_unit is null" );
}else{
	System.out.println(this.toString+" : frex_unit is "+frex_unit );
}
String frex_uprc = req.getParameter("frex_uprc");
if( frex_uprc == null){
	System.out.println(this.toString+" : frex_uprc is null" );
}else{
	System.out.println(this.toString+" : frex_uprc is "+frex_uprc );
}
...
String frex_unit = Util.checkString(req.getParameter("frex_unit"));
String frex_uprc = Util.checkString(req.getParameter("frex_uprc"));
...
String frex_unit = Util.Uni2Ksc(Util.checkString(req.getParameter("frex_unit")));
String frex_uprc = Util.Uni2Ksc(Util.checkString(req.getParameter("frex_uprc")));
...
dm.setRemk(remk);
dm.setFrex_unit(frex_unit);
dm.setFrex_uprc(frex_uprc);
...
/* 작성시간 : Fri Mar 13 17:58:29 KST 2015 */