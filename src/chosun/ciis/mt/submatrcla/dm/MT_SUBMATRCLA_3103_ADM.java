...
public class MT_SUBMATRCLA_3103_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATRCLA_3103_ADM(){}
	public MT_SUBMATRCLA_3103_ADM(String mst_mode, String cmpy_cd, String incmg_pers_ipaddr, String incmg_pers, String chg_pers, String occr_dt, String seq, String dept_cd, String clam_clsf, String clam_actu_cd, String via_dept, String aplc_pers, String remk, String buy_proc_stat, String mode, String sub_seq, String matr_cd, String part_cd,  String part_nm, String std_modl, String unit, String clam_qunt, String fix_qunt, String purc_uprc, String amt, String usag, String dlco_no, String part_clas1, String frex_unit){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATRCLA_3103_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATRCLA_3103_ADM dm = (MT_SUBMATRCLA_3103_ADM)bdm;
		...
		cstmt.setString(20, dm.part_cd);
		cstmt.setString(21, dm.part_nm);
		cstmt.setString(22, dm.std_modl);
		cstmt.setString(23, dm.unit);
		cstmt.setString(24, dm.clam_qunt);
		cstmt.setString(25, dm.fix_qunt);
		cstmt.setString(26, dm.purc_uprc);
		cstmt.setString(27, dm.amt);
		cstmt.setString(28, dm.usag);
		cstmt.setString(29, dm.dlco_no);
		cstmt.setString(30, dm.part_clas1);
		cstmt.setString(31, dm.frex_unit);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrcla.ds.MT_SUBMATRCLA_3103_ADataSet();
	}
