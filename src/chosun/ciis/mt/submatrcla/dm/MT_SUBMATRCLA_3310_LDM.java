...
public class MT_SUBMATRCLA_3310_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATRCLA_3310_LDM(){}
	public MT_SUBMATRCLA_3310_LDM(String cmpy_cd, String matr_cd, String matr_nm, String part_cd, String part_nm, String part_clas1,String part_clas2, String occr_dt_fr, String occr_dt_to, String buy_proc_stat, String acpn_dt_fr, String acpn_dt_to, String dept_cd, String res_yn, String acpn_yn, String reqgubun, String name, String group){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATRCLA_3310_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATRCLA_3310_LDM dm = (MT_SUBMATRCLA_3310_LDM)bdm;
		...
		cstmt.setString(7, dm.part_nm);
		cstmt.setString(8, dm.part_clas1);
		cstmt.setString(9, dm.part_clas2);
		cstmt.setString(10, dm.occr_dt_fr);
		cstmt.setString(11, dm.occr_dt_to);
		cstmt.setString(12, dm.buy_proc_stat);
		cstmt.setString(13, dm.acpn_dt_fr);
		cstmt.setString(14, dm.acpn_dt_to);
		cstmt.setString(15, dm.dept_cd);
		cstmt.setString(16, dm.res_yn);
		cstmt.setString(17, dm.acpn_yn);
		cstmt.setString(18, dm.reqgubun);
		cstmt.setString(19, dm.name);
		cstmt.setString(20, dm.group);
		cstmt.registerOutParameter(21, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrcla.ds.MT_SUBMATRCLA_3310_LDataSet();
	}
