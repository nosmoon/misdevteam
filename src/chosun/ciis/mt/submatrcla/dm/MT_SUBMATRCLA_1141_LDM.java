...
public class MT_SUBMATRCLA_1141_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATRCLA_1141_LDM(){}
	public MT_SUBMATRCLA_1141_LDM(String cmpy_cd, String matr_cd, String matr_nm, String occr_dt_fr, String occr_dt_to, String buy_proc_stat, String acpn_dt_fr, String acpn_dt_to, String dept_cd, String res_yn, String acpn_yn, String name, String reqgubun, String group){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATRCLA_1141_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATRCLA_1141_LDM dm = (MT_SUBMATRCLA_1141_LDM)bdm;
		...
		cstmt.setString(15, dm.reqgubun);
		cstmt.setString(16, dm.group);
		cstmt.registerOutParameter(17, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrcla.ds.MT_SUBMATRCLA_1141_LDataSet();
	}
