...
public class MT_SUBMATRCLA_1120_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATRCLA_1120_LDM(){}
	public MT_SUBMATRCLA_1120_LDM(String cmpy_cd, String dept_cd, String occr_dt, String seq, String clam_actu_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATRCLA_1120_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATRCLA_1120_LDM dm = (MT_SUBMATRCLA_1120_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrcla.ds.MT_SUBMATRCLA_1120_LDataSet();
	}
