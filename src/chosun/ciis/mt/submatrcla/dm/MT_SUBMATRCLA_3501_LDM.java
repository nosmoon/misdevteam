...
public class MT_SUBMATRCLA_3501_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATRCLA_3501_LDM(){}
	public MT_SUBMATRCLA_3501_LDM(String cmpy_cd, String clam_dt_fr, String clam_dt_to, String fac_clsf, String part_cd, String part_nm, String part_clas1, String std_modl){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATRCLA_3501_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATRCLA_3501_LDM dm = (MT_SUBMATRCLA_3501_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrcla.ds.MT_SUBMATRCLA_3501_LDataSet();
	}
