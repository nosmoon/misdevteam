...
public class MT_SUBMATRCLA_3104_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public String errcode;
	public String errmsg;
	public String out_amt;

	public MT_SUBMATRCLA_3104_LDataSet(){}
	public MT_SUBMATRCLA_3104_LDataSet(String errcode, String errmsg, String out_amt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.out_amt = Util.checkString(cstmt.getString(6));
	}
}/*----------------------------------------------------------------------------------------------------
