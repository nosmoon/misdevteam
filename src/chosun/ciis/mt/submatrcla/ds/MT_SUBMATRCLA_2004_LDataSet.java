...
public class MT_SUBMATRCLA_2004_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MT_SUBMATRCLA_2004_LDataSet(){}
	public MT_SUBMATRCLA_2004_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_SUBMATRCLA_2004_LCURLISTRecord rec = new MT_SUBMATRCLA_2004_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		MT_SUBMATRCLA_2004_LCURLISTRecord curlistRec = (MT_SUBMATRCLA_2004_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
