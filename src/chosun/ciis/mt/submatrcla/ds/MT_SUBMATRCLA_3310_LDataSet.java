...
public class MT_SUBMATRCLA_3310_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MT_SUBMATRCLA_3310_LDataSet(){}
	public MT_SUBMATRCLA_3310_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_SUBMATRCLA_3310_LCURLISTRecord rec = new MT_SUBMATRCLA_3310_LCURLISTRecord();
			...
			rec.part_clas2_nm = Util.checkString(rset0.getString("part_clas2_nm"));
...
<%
	MT_SUBMATRCLA_3310_LDataSet ds = (MT_SUBMATRCLA_3310_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		MT_SUBMATRCLA_3310_LCURLISTRecord curlistRec = (MT_SUBMATRCLA_3310_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
