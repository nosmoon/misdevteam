...
public class MT_SUBMATRCLA_3100_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public MT_SUBMATRCLA_3100_MDataSet(){}
	public MT_SUBMATRCLA_3100_MDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_SUBMATRCLA_3100_MCURLIST1Record rec = new MT_SUBMATRCLA_3100_MCURLIST1Record();
		...
		while(rset1.next()){
			MT_SUBMATRCLA_3100_MCURLIST2Record rec = new MT_SUBMATRCLA_3100_MCURLIST2Record();
		...
		while(rset2.next()){
			MT_SUBMATRCLA_3100_MCURLIST3Record rec = new MT_SUBMATRCLA_3100_MCURLIST3Record();
		...
		while(rset3.next()){
			MT_SUBMATRCLA_3100_MCURLIST4Record rec = new MT_SUBMATRCLA_3100_MCURLIST4Record();
		...
		while(rset4.next()){
			MT_SUBMATRCLA_3100_MCURLIST5Record rec = new MT_SUBMATRCLA_3100_MCURLIST5Record();
		...
		while(rset5.next()){
			MT_SUBMATRCLA_3100_MCURLIST6Record rec = new MT_SUBMATRCLA_3100_MCURLIST6Record();
		...
		while(rset6.next()){
			MT_SUBMATRCLA_3100_MCURLIST7Record rec = new MT_SUBMATRCLA_3100_MCURLIST7Record();
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		MT_SUBMATRCLA_3100_MCURLIST1Record curlist1Rec = (MT_SUBMATRCLA_3100_MCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		MT_SUBMATRCLA_3100_MCURLIST2Record curlist2Rec = (MT_SUBMATRCLA_3100_MCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		MT_SUBMATRCLA_3100_MCURLIST3Record curlist3Rec = (MT_SUBMATRCLA_3100_MCURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist4.size(); i++){
		MT_SUBMATRCLA_3100_MCURLIST4Record curlist4Rec = (MT_SUBMATRCLA_3100_MCURLIST4Record)ds.curlist4.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist5.size(); i++){
		MT_SUBMATRCLA_3100_MCURLIST5Record curlist5Rec = (MT_SUBMATRCLA_3100_MCURLIST5Record)ds.curlist5.get(i);%>
HTML 코드들....
	<%}%>
