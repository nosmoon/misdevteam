...
public class MT_SUBMATRCLA_3102_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MT_SUBMATRCLA_3102_LDataSet(){}
	public MT_SUBMATRCLA_3102_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_SUBMATRCLA_3102_LCURLISTRecord rec = new MT_SUBMATRCLA_3102_LCURLISTRecord();
