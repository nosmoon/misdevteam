...
public class MT_SUBMATRCLA_2000_500_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MT_SUBMATRCLA_2000_500_LDataSet(){}
	public MT_SUBMATRCLA_2000_500_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_SUBMATRCLA_2000_500_LCURLISTRecord rec = new MT_SUBMATRCLA_2000_500_LCURLISTRecord();
			...
			rec.oz_cnt = Util.checkString(rset0.getString("oz_cnt"));
