...
public class MT_SUBMATRCLA_1142_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MT_SUBMATRCLA_1142_LDataSet(){}
	public MT_SUBMATRCLA_1142_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset2.next()){
			MT_SUBMATRCLA_1142_LCURLISTRecord rec = new MT_SUBMATRCLA_1142_LCURLISTRecord();
