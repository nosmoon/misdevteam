...
public class MT_ETCCAR_9101_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MT_ETCCAR_9101_LDataSet(){}
	public MT_ETCCAR_9101_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_ETCCAR_9101_LCURLISTRecord rec = new MT_ETCCAR_9101_LCURLISTRecord();
			...
			rec.rid_deptcd_nm = Util.checkString(rset0.getString("rid_deptcd_nm"));
			...
			rec.drvr_yn_nm = Util.checkString(rset0.getString("drvr_yn_nm"));
			...
			rec.driv_pers = Util.checkString(rset0.getString("driv_pers"));
			rec.driv_dt_tm = Util.checkString(rset0.getString("driv_dt_tm"));
			rec.cancle_pers = Util.checkString(rset0.getString("cancle_pers"));
			rec.cancle_dt_tm = Util.checkString(rset0.getString("cancle_dt_tm"));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		MT_ETCCAR_9101_LCURLISTRecord curlistRec = (MT_ETCCAR_9101_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
<%= curlistRec.remk%>
<%= curlistRec.drvr_yn%>
<%= curlistRec.drvr_yn_nm%>
<%= curlistRec.car_no%>
<%= curlistRec.drvr_nm%>
<%= curlistRec.tel_no%>
<%= curlistRec.driv_pers%>
<%= curlistRec.driv_dt_tm%>
<%= curlistRec.cancle_pers%>
<%= curlistRec.cancle_dt_tm%>
----------------------------------------------------------------------------------------------------*/
