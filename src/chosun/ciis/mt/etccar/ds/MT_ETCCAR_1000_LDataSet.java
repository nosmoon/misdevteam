...
public class MT_ETCCAR_1000_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public MT_ETCCAR_1000_LDataSet(){}
	public MT_ETCCAR_1000_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_ETCCAR_1000_LCURLIST1Record rec = new MT_ETCCAR_1000_LCURLIST1Record();
		...
		while(rset1.next()){
			MT_ETCCAR_1000_LCURLIST2Record rec = new MT_ETCCAR_1000_LCURLIST2Record();
		...
		while(rset2.next()){
			MT_ETCCAR_1000_LCURLIST3Record rec = new MT_ETCCAR_1000_LCURLIST3Record();
		...
		while(rset3.next()){
			MT_ETCCAR_1000_LCURLIST4Record rec = new MT_ETCCAR_1000_LCURLIST4Record();
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		MT_ETCCAR_1000_LCURLIST1Record curlist1Rec = (MT_ETCCAR_1000_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		MT_ETCCAR_1000_LCURLIST2Record curlist2Rec = (MT_ETCCAR_1000_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		MT_ETCCAR_1000_LCURLIST3Record curlist3Rec = (MT_ETCCAR_1000_LCURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist4.size(); i++){
		MT_ETCCAR_1000_LCURLIST4Record curlist4Rec = (MT_ETCCAR_1000_LCURLIST4Record)ds.curlist4.get(i);%>
HTML 코드들....
	<%}%>
