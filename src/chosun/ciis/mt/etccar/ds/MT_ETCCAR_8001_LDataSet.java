...
public class MT_ETCCAR_8001_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MT_ETCCAR_8001_LDataSet(){}
	public MT_ETCCAR_8001_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_ETCCAR_8001_LCURLISTRecord rec = new MT_ETCCAR_8001_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		MT_ETCCAR_8001_LCURLISTRecord curlistRec = (MT_ETCCAR_8001_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
<%= curlistRec.driver_cd%>
<%= curlistRec.driver_nm%>
<%= curlistRec.tel_no%>
