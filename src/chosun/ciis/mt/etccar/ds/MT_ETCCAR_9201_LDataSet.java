...
public class MT_ETCCAR_9201_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MT_ETCCAR_9201_LDataSet(){}
	public MT_ETCCAR_9201_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_ETCCAR_9201_LCURLISTRecord rec = new MT_ETCCAR_9201_LCURLISTRecord();
			...
			rec.drvr_tel_no = Util.checkString(rset0.getString("drvr_tel_no"));
