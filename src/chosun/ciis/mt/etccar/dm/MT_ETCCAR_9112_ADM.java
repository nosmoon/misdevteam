...
public class MT_ETCCAR_9112_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_ETCCAR_9112_ADM(){}
	public MT_ETCCAR_9112_ADM(String cmpy_cd, String occr_dt, String seq, String start_dt, String ariv_dt, String start_tm, String ariv_tm, String dest, String rid_pers, String rid_deptcd, String driv_purp, String drvr_yn, String remk, String rid_pers_cnt, String incmg_pers_ipaddr, String incmg_pers, String gubun, String car_no, String drvr_nm, String rid_ptphno){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_ETCCAR_9112_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_ETCCAR_9112_ADM dm = (MT_ETCCAR_9112_ADM)bdm;
		...
		cstmt.setString(20, dm.car_no);
		cstmt.setString(21, dm.drvr_nm);
		cstmt.setString(22, dm.rid_ptphno);
		cstmt.registerOutParameter(23, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.etccar.ds.MT_ETCCAR_9112_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("rid_ptphno = [" + getRid_ptphno() + "]");
	}
}
/*----------------------------------------------------------------------------------------------------
