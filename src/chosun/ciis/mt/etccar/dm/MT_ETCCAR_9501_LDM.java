...
public class MT_ETCCAR_9501_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String driv_mm;

	public MT_ETCCAR_9501_LDM(){}
	public MT_ETCCAR_9501_LDM(String cmpy_cd, String driv_mm){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_ETCCAR_9501_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_ETCCAR_9501_LDM dm = (MT_ETCCAR_9501_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.etccar.ds.MT_ETCCAR_9501_LDataSet();
	}
