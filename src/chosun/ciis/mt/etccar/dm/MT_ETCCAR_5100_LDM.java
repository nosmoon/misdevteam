...
public class MT_ETCCAR_5100_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_ETCCAR_5100_LDM(){}
	public MT_ETCCAR_5100_LDM(String cmpy_cd, String driv_dt_fr, String driv_dt_to, String car_no){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_ETCCAR_5100_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_ETCCAR_5100_LDM dm = (MT_ETCCAR_5100_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.etccar.ds.MT_ETCCAR_5100_LDataSet();
	}
