...
public class MT_ETCCAR_5500_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String driv_dt_fr;
	public String driv_dt_to;

	public MT_ETCCAR_5500_LDM(){}
	public MT_ETCCAR_5500_LDM(String cmpy_cd, String driv_dt_fr, String driv_dt_to){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_ETCCAR_5500_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_ETCCAR_5500_LDM dm = (MT_ETCCAR_5500_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.etccar.ds.MT_ETCCAR_5500_LDataSet();
	}
