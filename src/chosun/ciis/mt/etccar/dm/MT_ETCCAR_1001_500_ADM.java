...
public class MT_ETCCAR_1001_500_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_ETCCAR_1001_500_A(?, ? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_ETCCAR_1001_500_ADM dm = (MT_ETCCAR_1001_500_ADM)bdm;
		...
		cstmt.setString(39, dm.cmpy_cd_2);
		cstmt.setString(40, dm.endgbn_2);
	
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.etccar.ds.MT_ETCCAR_1001_500_ADataSet();
	}
...
/* 작성시간 : Tue Sep 18 15:53:00 KST 2012 */