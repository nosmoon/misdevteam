...
public class MT_ETCCAR_1000_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_ETCCAR_1000_LDM(){}
	public MT_ETCCAR_1000_LDM(String cmpy_cd, String driv_dt, String driv, String car_no){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_ETCCAR_1000_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_ETCCAR_1000_LDM dm = (MT_ETCCAR_1000_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.etccar.ds.MT_ETCCAR_1000_LDataSet();
	}
