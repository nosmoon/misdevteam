...
public class MT_COMMATR_6210_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	******************************************************************************************/
	...
	public MT_COMMATR_6210_LDataSet(){}
	public MT_COMMATR_6210_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_COMMATR_6210_LCURLISTRecord rec = new MT_COMMATR_6210_LCURLISTRecord();
			...
			image = rset0.getBinaryStream("add_file");
...
<%
	MT_COMMATR_6110_LDataSet ds = (MT_COMMATR_6110_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		MT_COMMATR_6110_LCURLISTRecord curlistRec = (MT_COMMATR_6110_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
