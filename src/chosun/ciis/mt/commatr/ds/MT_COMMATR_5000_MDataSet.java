...
public class MT_COMMATR_5000_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList sectlist = new ArrayList();
	public ArrayList medilist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MT_COMMATR_5000_MDataSet(){}
	public MT_COMMATR_5000_MDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_COMMATR_5000_MMEDILISTRecord rec = new MT_COMMATR_5000_MMEDILISTRecord();
		...
		while(rset1.next()){
			MT_COMMATR_5000_MSECTLISTRecord rec = new MT_COMMATR_5000_MSECTLISTRecord();
