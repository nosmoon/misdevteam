 ...
 * 
 */
public class MT_COMMATR_6000DAO {
	
	public MT_COMMATR_6000_MDataSet mt_commatr_6000_m(MT_COMMATR_6000_MDM dm) throws AppException {

        DBManager manager 			= new DBManager("MISMAT");
        MT_COMMATR_6000_MDataSet ds 	= (MT_COMMATR_6000_MDataSet) manager.executeCall(dm);
	...
	public MT_COMMATR_6010_LDataSet mt_commatr_6010_l(MT_COMMATR_6010_LDM dm) throws AppException {

        
        DBManager manager 			= new DBManager("MISMAT");
        MT_COMMATR_6010_LDataSet ds 	= (MT_COMMATR_6010_LDataSet) manager.executeCall(dm);
    ...
    public MT_COMMATR_6020_ADataSet mt_commatr_6020_a(MT_COMMATR_6020_ADM dm) throws AppException {
...
//	      	   !dm.getFlag().equals("D")){
    		...
    		try {
               ...
               // 결과
	    		ds = (MT_COMMATR_6020_ADataSet)dm.createDataSetObject();               
	    		ds.getValues(cstmt);
...
//              첫번째 첨부파일
	    	...
	    	DBManager manager = new DBManager("MISMAT");
	    	ds = (MT_COMMATR_6020_ADataSet) manager.executeCall(dm);
	    	if(!"".equals(ds.errcode)){
	    		throw new AppException(ds.errcode, ds.errmsg);
	    	}
	    }
...
//        DBManager manager 			= new DBManager("MISMAT");
//        MT_COMMATR_6020_ADataSet ds 	= (MT_COMMATR_6020_ADataSet) manager.executeCall(dm);
//        
//        if (!"".equals(ds.errcode)) {
...
//        return ds;
    ...
    public MT_COMMATR_6110_LDataSet mt_commatr_6110_l(MT_COMMATR_6110_LDM dm) throws AppException {

        
        DBManager manager 			= new DBManager("MISMAT");
        MT_COMMATR_6110_LDataSet ds 	= (MT_COMMATR_6110_LDataSet) manager.executeCall(dm);
    ...
    public MT_COMMATR_6210_LDataSet mt_commatr_6210_l(MT_COMMATR_6210_LDM dm) throws AppException {

    	DBManager manager 			= new DBManager("MISMAT");
        MT_COMMATR_6210_LDataSet ds 	= (MT_COMMATR_6210_LDataSet) manager.executeCall(dm);
        if (!"".equals(ds.errcode)) {
            throw new AppException(ds.errcode, ds.errmsg);
        }
        return ds;
    ...
    public MT_COMMATR_6120_SDataSet mt_commatr_6120_s(MT_COMMATR_6120_SDM dm) throws AppException {
		DBManager manager = new DBManager("MISMAT");
		
		MT_COMMATR_6120_SDataSet ds = (MT_COMMATR_6120_SDataSet) manager.executeCall(dm);		
        if (!"".equals(ds.errcode)) {
            throw new AppException(ds.errcode, ds.errmsg);
        }
        return ds;
