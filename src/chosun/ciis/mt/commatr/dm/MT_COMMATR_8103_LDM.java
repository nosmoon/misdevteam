...
public class MT_COMMATR_8103_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_COMMATR_8103_LDM(){}
	public MT_COMMATR_8103_LDM(String cmpy_cd, String search_dt_fr, String search_dt_to, String fac_clsf){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_COMMATR_8103_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_COMMATR_8103_LDM dm = (MT_COMMATR_8103_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.commatr.ds.MT_COMMATR_8103_LDataSet();
	}
