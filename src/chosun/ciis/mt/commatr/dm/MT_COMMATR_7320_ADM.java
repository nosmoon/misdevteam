...
public class MT_COMMATR_7320_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_COMMATR_7320_ADM(){}
	public MT_COMMATR_7320_ADM(String cmpy_cd, String issu_dt, String pubc_amt, String uprc, String incmg_pers_ipaddr, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_COMMATR_7320_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_COMMATR_7320_ADM dm = (MT_COMMATR_7320_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.issu_dt);
		cstmt.setString(5, dm.pubc_amt);
		cstmt.setString(6, dm.uprc);
		cstmt.setString(7, dm.incmg_pers_ipaddr);
		cstmt.setString(8, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.commatr.ds.MT_COMMATR_7320_ADataSet();
	}
