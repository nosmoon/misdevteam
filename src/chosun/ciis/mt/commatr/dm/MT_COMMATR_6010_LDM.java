...
public class MT_COMMATR_6010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_COMMATR_6010_LDM(){}
	public MT_COMMATR_6010_LDM(String cmpy_cd, String dept_no, String search_dt_fr, String search_dt_to, String dlco_clsf, String dlco_no, String patr_chrg_pers, String chrg_pers, String tag, String search_opt,String list_grd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_COMMATR_6010_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_COMMATR_6010_LDM dm = (MT_COMMATR_6010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.commatr.ds.MT_COMMATR_6010_LDataSet();
	}
