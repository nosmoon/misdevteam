...
public class MT_COMMATR_7010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_COMMATR_7010_LDM(){}
	public MT_COMMATR_7010_LDM(String cmpy_cd, String search_dt_fr, String search_dt_to, String fac_clsf, String list_gbn, String gs_gbn){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_COMMATR_7010_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_COMMATR_7010_LDM dm = (MT_COMMATR_7010_LDM)bdm;
		...
		cstmt.setString(8, dm.gs_gbn);
		cstmt.registerOutParameter(9, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.commatr.ds.MT_COMMATR_7010_LDataSet();
	}
...
String list_gb = req.getParameter("list_gb");
if( list_gb == null){
	System.out.println(this.toString+" : list_gb is null" );
}else{
	System.out.println(this.toString+" : list_gb is "+list_gb );
}
----------------------------------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------------------------------
...
String list_gb = Util.checkString(req.getParameter("list_gb"));
----------------------------------------------------------------------------------------------------*//*----------------------------------------------------------------------------------------------------
...
String list_gb = Util.Uni2Ksc(Util.checkString(req.getParameter("list_gb")));
----------------------------------------------------------------------------------------------------*/
...
dm.setList_gb(list_gb);
----------------------------------------------------------------------------------------------------*/


/* 작성시간 : Tue Dec 18 11:32:54 KST 2012 */