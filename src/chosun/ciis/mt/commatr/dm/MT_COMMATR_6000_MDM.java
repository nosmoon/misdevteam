...
public class MT_COMMATR_6000_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_COMMATR_6000_MDM(){}
	public MT_COMMATR_6000_MDM(String cmpy_cd, String u_id, String dept_cd, String page_id){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_COMMATR_6000_M(? ,? ,? ,? ,? ,? ,?,? ) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_COMMATR_6000_MDM dm = (MT_COMMATR_6000_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.commatr.ds.MT_COMMATR_6000_MDataSet();
	}
