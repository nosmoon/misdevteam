...
public class MT_COMMATR_7410_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String search_dt_fr;
	public String search_dt_to;

	public MT_COMMATR_7410_LDM(){}
	public MT_COMMATR_7410_LDM(String cmpy_cd, String search_dt_fr, String search_dt_to){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_COMMATR_7410_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_COMMATR_7410_LDM dm = (MT_COMMATR_7410_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.commatr.ds.MT_COMMATR_7410_LDataSet();
	}
