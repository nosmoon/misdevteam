...
public class MT_COMMATR_7310_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_COMMATR_7310_LDM(){}
	public MT_COMMATR_7310_LDM(String cmpy_cd, String search_dt_fr, String search_dt_to, String search_flag){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_COMMATR_7310_L(? ,?  ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_COMMATR_7310_LDM dm = (MT_COMMATR_7310_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.search_dt_fr);
		cstmt.setString(5, dm.search_dt_to);
		cstmt.setString(6, dm.search_flag);
		cstmt.registerOutParameter(7, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.commatr.ds.MT_COMMATR_7310_LDataSet();
	}
	...
	public void print(){
		...
		System.out.println("search_dt_flag = [" + getSearch_flag() + "]");
	}
}
/*----------------------------------------------------------------------------------------------------
