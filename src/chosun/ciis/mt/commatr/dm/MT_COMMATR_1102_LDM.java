...
public class MT_COMMATR_1102_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String matr_cd;

	public MT_COMMATR_1102_LDM(){}
	public MT_COMMATR_1102_LDM(String cmpy_cd, String matr_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_COMMATR_1102_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_COMMATR_1102_LDM dm = (MT_COMMATR_1102_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.commatr.ds.MT_COMMATR_1102_LDataSet();
	}
