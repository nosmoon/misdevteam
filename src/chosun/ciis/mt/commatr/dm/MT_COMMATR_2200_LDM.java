...
public class MT_COMMATR_2200_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_COMMATR_2200_LDM(){}
	public MT_COMMATR_2200_LDM(String cmpy_cd, String matr_cd, String uprc_meda_dt_fr, String uprc_meda_dt_to, String dlco_eps_no){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_COMMATR_2200_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_COMMATR_2200_LDM dm = (MT_COMMATR_2200_LDM)bdm;
		...
		cstmt.setString(7, dm.dlco_eps_no);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.commatr.ds.MT_COMMATR_2200_LDataSet();
	}
