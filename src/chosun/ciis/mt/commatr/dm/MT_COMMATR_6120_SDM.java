...
public class MT_COMMATR_6120_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_COMMATR_6120_SDM(){}
	public MT_COMMATR_6120_SDM(String cmpy_cd, String occr_dt, String seq, String add_file_no, String add_file_gb){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_COMMATR_6120_S(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_COMMATR_6120_SDM dm = (MT_COMMATR_6120_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.commatr.ds.MT_COMMATR_6120_SDataSet();
	}
