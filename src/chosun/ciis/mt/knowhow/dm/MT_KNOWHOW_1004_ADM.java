...
public class MT_KNOWHOW_1004_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_KNOWHOW_1004_ADM(){}
	public MT_KNOWHOW_1004_ADM(String mode, String cmpy_cd, String reg_dt, String lcls, String reg_seq, String seq, String question, String ans_mode, String answer, String dept_cd, String incmg_pers_ipadd, String incmg_pers, String chg_pers){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_KNOWHOW_1004_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_KNOWHOW_1004_ADM dm = (MT_KNOWHOW_1004_ADM)bdm;
		...
		cstmt.setString(9, dm.question);
		cstmt.setString(10, dm.ans_mode);
		cstmt.setString(11, dm.answer);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.knowhow.ds.MT_KNOWHOW_1004_ADataSet();
	}
...
if( question == null){
	System.out.println(this.toString+" : question is null" );
}else{
	System.out.println(this.toString+" : question is "+question );
}
...
String question = Util.checkString(req.getParameter("question"));
...
String question = Util.Uni2Ksc(Util.checkString(req.getParameter("question")));
...
/* 작성시간 : Thu Jun 11 10:14:26 KST 2009 */