...
public class MT_PAPINOUT_5101_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String issu_dt_fr;
	public String issu_dt_to;

	public MT_PAPINOUT_5101_LDM(){}
	public MT_PAPINOUT_5101_LDM(String cmpy_cd, String issu_dt_fr, String issu_dt_to){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_5101_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_5101_LDM dm = (MT_PAPINOUT_5101_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_5101_LDataSet();
	}
