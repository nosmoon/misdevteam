...
public class MT_PAPINOUT_2225_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String magam_dt;

	public MT_PAPINOUT_2225_LDM(){}
	public MT_PAPINOUT_2225_LDM(String cmpy_cd, String magam_dt){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_2225_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_2225_LDM dm = (MT_PAPINOUT_2225_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.magam_dt);
		cstmt.registerOutParameter(5, Types.VARCHAR);
		cstmt.registerOutParameter(6, Types.VARCHAR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_2225_LDataSet();
	}
