...
public class MT_PAPINOUT_2302_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPINOUT_2302_ADM(){}
	public MT_PAPINOUT_2302_ADM(String cmpy_cd, String ewh_dt, String magam_dt, String per_id, String per_ip_addr){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_2302_A(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_2302_ADM dm = (MT_PAPINOUT_2302_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_2302_ADataSet();
	}
