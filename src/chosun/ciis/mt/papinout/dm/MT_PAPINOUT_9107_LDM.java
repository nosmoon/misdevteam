...
public class MT_PAPINOUT_9107_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPINOUT_9107_LDM(){}
	public MT_PAPINOUT_9107_LDM(String cmpy_cd, String owh_dt_fr, String owh_dt_to, String fac_clsf, String matr_cd, String flag){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_9107_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_9107_LDM dm = (MT_PAPINOUT_9107_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_9107_LDataSet();
	}
