...
public class MT_PAPINOUT_2207_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPINOUT_2207_LDM(){}
	public MT_PAPINOUT_2207_LDM(String cmpy_cd, String inout_dt, String fac_clsf, String inout_clsf){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_2207_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_2207_LDM dm = (MT_PAPINOUT_2207_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_2207_LDataSet();
	}
