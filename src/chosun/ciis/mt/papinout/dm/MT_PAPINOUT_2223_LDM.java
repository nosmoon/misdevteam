...
public class MT_PAPINOUT_2223_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPINOUT_2223_LDM(){}
	public MT_PAPINOUT_2223_LDM(String cmpy_cd, String inout_dt, String fac_clsf_fr, String fac_clsf_to, String inout_clsf){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_2223_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_2223_LDM dm = (MT_PAPINOUT_2223_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_2223_LDataSet();
	}
