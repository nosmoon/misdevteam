...
public class MT_PAPINOUT_4400_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPINOUT_4400_LDM(){}
	public MT_PAPINOUT_4400_LDM(String cmpy_cd, String cut_err_occr_dt_fr, String cut_err_occr_dt_to, String fac_clsf, String papcmpy_cd, String cut_err_point, String cut_err_caus_prd, String order_cd, String occr_dt_gubun){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_4400_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_4400_LDM dm = (MT_PAPINOUT_4400_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_4400_LDataSet();
	}
