...
public class MT_PAPINOUT_3014_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPINOUT_3014_UDM(){}
	public MT_PAPINOUT_3014_UDM(String cmpy_cd, String fac_clsf, String issu_dt, String pers_ipaddr, String pers_id){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_3014_U(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_3014_UDM dm = (MT_PAPINOUT_3014_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_3014_UDataSet();
	}
...
/* 작성시간 : Mon Jun 29 17:27:20 KST 2009 */