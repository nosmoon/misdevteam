...
public class MT_PAPINOUT_2503_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPINOUT_2503_DDM(){}
	public MT_PAPINOUT_2503_DDM(String cmpy_cd, String save_yymm, String save_fac_clsf, String matr_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_2503_D(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_2503_DDM dm = (MT_PAPINOUT_2503_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_2503_DDataSet();
	}
