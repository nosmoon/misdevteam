...
public class MT_PAPINOUT_2701_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPINOUT_2701_LDM(){}
	public MT_PAPINOUT_2701_LDM(String cmpy_cd, String save_yymm, String save_fac_clsf, String matr_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_2701_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_2701_LDM dm = (MT_PAPINOUT_2701_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_2701_LDataSet();
	}
