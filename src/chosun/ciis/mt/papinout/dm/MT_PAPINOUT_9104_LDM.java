...
public class MT_PAPINOUT_9104_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPINOUT_9104_LDM(){}
	public MT_PAPINOUT_9104_LDM(String cmpy_cd, String ewh_dt_fr, String ewh_dt_to, String fac_clsf, String matr_cd, String flag){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_9104_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_9104_LDM dm = (MT_PAPINOUT_9104_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_9104_LDataSet();
	}
