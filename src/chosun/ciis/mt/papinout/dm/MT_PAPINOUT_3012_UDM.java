...
public class MT_PAPINOUT_3012_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPINOUT_3012_UDM(){}
	public MT_PAPINOUT_3012_UDM(String cmpy_cd, String fac_clsf, String issu_dt, String pers_ipaddr, String pers_id){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_3012_U(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_3012_UDM dm = (MT_PAPINOUT_3012_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_3012_UDataSet();
	}
...
/* 작성시간 : Mon Jun 29 15:20:04 KST 2009 */