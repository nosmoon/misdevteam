...
public class MT_PAPINOUT_4101_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String make_un_norm_occr_dt;
	public String fac_clsf;

	public MT_PAPINOUT_4101_LDM(){}
	public MT_PAPINOUT_4101_LDM(String cmpy_cd, String make_un_norm_occr_dt, String fac_clsf){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_4101_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_4101_LDM dm = (MT_PAPINOUT_4101_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.make_un_norm_occr_dt);
		cstmt.setString(5, dm.fac_clsf);
		cstmt.registerOutParameter(6, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_4101_LDataSet();
	}
