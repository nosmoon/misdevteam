...
public class MT_PAPINOUT_5200_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPINOUT_5200_ADM(){}
	public MT_PAPINOUT_5200_ADM(String cmpy_cd, String incmg_pers_ipaddr, String incmg_pers, String mode, String aply_dt, String pj_kind, String uprc, String simb_wgt){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_5200_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_5200_ADM dm = (MT_PAPINOUT_5200_ADM)bdm;
		...
		cstmt.setString(8, dm.pj_kind);
		cstmt.setString(9, dm.uprc);
		cstmt.setString(10, dm.simb_wgt);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_5200_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("simb_wgt = [" + getSimb_wgt() + "]");
	}
}
/*----------------------------------------------------------------------------------------------------
