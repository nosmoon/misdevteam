...
public class MT_PAPINOUT_1130_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String ewh_dt;
	public String issu_dt;

	public MT_PAPINOUT_1130_LDM(){}
	public MT_PAPINOUT_1130_LDM(String cmpy_cd, String ewh_dt, String issu_dt){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_1130_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_1130_LDM dm = (MT_PAPINOUT_1130_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_1130_LDataSet();
	}
