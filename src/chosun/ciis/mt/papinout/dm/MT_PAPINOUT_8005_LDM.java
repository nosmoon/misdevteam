...
public class MT_PAPINOUT_8005_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPINOUT_8005_LDM(){}
	public MT_PAPINOUT_8005_LDM(String cmpy_cd, String issu_dt_fr, String issu_dt_to, String fac_clsf_fr, String fac_clsf_to, String medi_cd, String sect_cd, String prt_clsf, String flag_1, String flag_2, String flag_3){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_8005_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_8005_LDM dm = (MT_PAPINOUT_8005_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_8005_LDataSet();
	}
