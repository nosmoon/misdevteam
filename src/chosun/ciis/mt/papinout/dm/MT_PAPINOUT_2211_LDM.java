...
public class MT_PAPINOUT_2211_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPINOUT_2211_LDM(){}
	public MT_PAPINOUT_2211_LDM(String cmpy_cd, String inout_dt, String inout_clsf, String fac_clsf){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_2211_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_2211_LDM dm = (MT_PAPINOUT_2211_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.inout_dt);
		cstmt.setString(5, dm.inout_clsf);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_2211_LDataSet();
	}
