...
public class MT_PAPINOUT_2226_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPINOUT_2226_ADM(){}
	public MT_PAPINOUT_2226_ADM(String cmpy_cd, String ewh_dt, String job_clsf, String pers_ip_addr, String pers_id){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_2226_A(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_2226_ADM dm = (MT_PAPINOUT_2226_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_2226_ADataSet();
	}
...
/* 작성시간 : Fri Sep 18 09:46:32 KST 2009 */