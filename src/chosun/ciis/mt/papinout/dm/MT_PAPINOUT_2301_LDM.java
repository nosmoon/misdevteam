...
public class MT_PAPINOUT_2301_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String ewh_dt;
	public String fac_clsf;

	public MT_PAPINOUT_2301_LDM(){}
	public MT_PAPINOUT_2301_LDM(String cmpy_cd, String ewh_dt, String fac_clsf){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_2301_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_2301_LDM dm = (MT_PAPINOUT_2301_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_2301_LDataSet();
	}
