...
public class MT_PAPINOUT_2702_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPINOUT_2702_LDM(){}
	public MT_PAPINOUT_2702_LDM(String cmpy_cd, String save_yymm, String save_fac_clsf, String matr_cd, String fac_clsf){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPINOUT_2702_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPINOUT_2702_LDM dm = (MT_PAPINOUT_2702_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papinout.ds.MT_PAPINOUT_2702_LDataSet();
	}
