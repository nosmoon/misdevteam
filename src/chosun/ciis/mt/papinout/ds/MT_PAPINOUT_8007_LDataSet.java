...
public class MT_PAPINOUT_8007_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist1 = new ArrayList();
	public String errcode;
	public String errmsg;

	public MT_PAPINOUT_8007_LDataSet(){}
	public MT_PAPINOUT_8007_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_PAPINOUT_8007_LCURLIST1Record rec = new MT_PAPINOUT_8007_LCURLIST1Record();
...
<%
	MT_PAPINOUT_8007_LDataSet ds = (MT_PAPINOUT_8007_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		MT_PAPINOUT_8007_LCURLIST1Record curlist1Rec = (MT_PAPINOUT_8007_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>
