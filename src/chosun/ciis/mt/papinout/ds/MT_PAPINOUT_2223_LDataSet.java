...
public class MT_PAPINOUT_2223_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public MT_PAPINOUT_2223_LDataSet(){}
	public MT_PAPINOUT_2223_LDataSet(String errcode, String errmsg, String slip_occr_dt, String prt_wgt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_PAPINOUT_2223_LCURLISTRecord rec = new MT_PAPINOUT_2223_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		MT_PAPINOUT_2223_LCURLISTRecord curlistRec = (MT_PAPINOUT_2223_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Sat Dec 05 16:14:31 KST 2009 */