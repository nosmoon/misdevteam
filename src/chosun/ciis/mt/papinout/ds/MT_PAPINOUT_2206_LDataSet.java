...
public class MT_PAPINOUT_2206_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public MT_PAPINOUT_2206_LDataSet(){}
	public MT_PAPINOUT_2206_LDataSet(String errcode, String errmsg, String slip_occr_dt, String prt_wgt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_PAPINOUT_2206_LCURLISTRecord rec = new MT_PAPINOUT_2206_LCURLISTRecord();
		...
		this.prt_wgt = Util.checkString(cstmt.getString(9));
	}
}/*----------------------------------------------------------------------------------------------------
Web Tier에서 DataSet 객체 관련 코드 작성시 사용하십시오.

<%
	MT_PAPINOUT_2206_LDataSet ds = (MT_PAPINOUT_2206_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		MT_PAPINOUT_2206_LCURLISTRecord curlistRec = (MT_PAPINOUT_2206_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Sat Dec 05 15:58:51 KST 2009 */