...
public class MT_PAPINOUT_4400_LCURLISTRecord extends java.lang.Object implements java.io.Serializable{
	...
	public String cut_err_point_nm;
	public String cut_err_caus_prd;
	public String cut_err_caus_prd_nm;
	public String cut_err_caus_midl;
	public String cut_err_caus_midl_nm;
	public String cut_err_caus_plac;
	public String clos_clsf;
	public String remk;

	public MT_PAPINOUT_4400_LCURLISTRecord(){}
	...
	public void setCut_err_point_nm(String cut_err_point_nm){
		this.cut_err_point_nm = cut_err_point_nm;
	}
	...
	public void setCut_err_caus_prd_nm(String cut_err_caus_prd_nm){
		this.cut_err_caus_prd_nm = cut_err_caus_prd_nm;
	}
	...
	public void setCut_err_caus_midl_nm(String cut_err_caus_midl_nm){
		this.cut_err_caus_midl_nm = cut_err_caus_midl_nm;
	}
	...
	public String getCut_err_point_nm(){
		return this.cut_err_point_nm;
	}
	...
	public String getCut_err_caus_prd_nm(){
		return this.cut_err_caus_prd_nm;
	}
	...
	public String getCut_err_caus_midl_nm(){
		return this.cut_err_caus_midl_nm;
	}
