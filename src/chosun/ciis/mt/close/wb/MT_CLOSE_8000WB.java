...
/*    
    public void mt_close_8000(HttpServletRequest req, HttpServletResponse res) throws   AppException {
		...
		dm.setAply_from(Util.checkString(req.getParameter("aply_from"  )));	// 적용일자(시작)
		dm.setAply_to(Util.checkString(req.getParameter("aply_to"    )));	// 적용일자(종료)
		dm.setFac_clsf(Util.checkString(req.getParameter("fac_clsf"  )));	// 공장구분
		dm.setMatr_cd(Util.checkString(req.getParameter("matr_clsf" )));	// 자재코드   	
