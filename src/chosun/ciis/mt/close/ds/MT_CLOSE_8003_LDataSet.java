...
public class MT_CLOSE_8003_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist2 = new ArrayList();
	public ArrayList curlist1 = new ArrayList();
	public String errcode;
	public String errmsg;

	public MT_CLOSE_8003_LDataSet(){}
	public MT_CLOSE_8003_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_CLOSE_8003_LCURLIST1Record rec = new MT_CLOSE_8003_LCURLIST1Record();
		...
		while(rset1.next()){
			MT_CLOSE_8003_LCURLIST2Record rec = new MT_CLOSE_8003_LCURLIST2Record();
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		MT_CLOSE_8003_LCURLIST1Record curlist1Rec = (MT_CLOSE_8003_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		MT_CLOSE_8003_LCURLIST2Record curlist2Rec = (MT_CLOSE_8003_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>
