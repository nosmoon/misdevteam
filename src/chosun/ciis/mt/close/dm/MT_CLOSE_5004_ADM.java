...
public class MT_CLOSE_5004_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_CLOSE_5004_ADM(){}
	public MT_CLOSE_5004_ADM(String cmpy_cd, String in_yymm, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_CLOSE_5004_A(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_CLOSE_5004_ADM dm = (MT_CLOSE_5004_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.close.ds.MT_CLOSE_5004_ADataSet();
	}
