...
public class MT_CLOSE_7013_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_CLOSE_7013_ADM(){}
	public MT_CLOSE_7013_ADM(String mode, String row, String cmpy_cd, String aply_dt, String fac_clsf, String matr_cd, String medi_cd, String sect_cd, String qunt, String amt, String incmg_pers_ipaddr, String incmg_pers){
		this.mode = mode;
		this.row = row;
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_CLOSE_7013_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_CLOSE_7013_ADM dm = (MT_CLOSE_7013_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.close.ds.MT_CLOSE_7013_ADataSet();
	}
