...
public class MT_CLOSE_5002_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_CLOSE_5002_ADM(){}
	public MT_CLOSE_5002_ADM(String cmpy_cd, String in_yymm, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_CLOSE_5002_A(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_CLOSE_5002_ADM dm = (MT_CLOSE_5002_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.close.ds.MT_CLOSE_5002_ADataSet();
	}
...
/* 작성시간 : Mon Aug 24 12:02:47 KST 2009 */