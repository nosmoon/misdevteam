...
public class MT_CLOSE_5008_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_CLOSE_5008_ADM(){}
	public MT_CLOSE_5008_ADM(String cmpy_cd, String in_yymm, String in_sabeon, String in_ipaddress){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_CLOSE_5008_A(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_CLOSE_5008_ADM dm = (MT_CLOSE_5008_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.in_yymm);
		cstmt.setString(5, dm.in_sabeon);
		cstmt.setString(6, dm.in_ipaddress);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.close.ds.MT_CLOSE_5008_ADataSet();
	}
...
/* 작성시간 : Fri Jul 17 11:33:46 KST 2009 */