...
public class MT_CLOSE_5101_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String in_yymm;

	public MT_CLOSE_5101_LDM(){}
	public MT_CLOSE_5101_LDM(String cmpy_cd, String in_yymm){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_CLOSE_5101_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_CLOSE_5101_LDM dm = (MT_CLOSE_5101_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.close.ds.MT_CLOSE_5101_LDataSet();
	}
