...
public class MT_CLOSE_7004_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_CLOSE_7004_LDM(){}
	public MT_CLOSE_7004_LDM(String cmpy_cd, String in_yymm, String fac_clsf, String bebubi_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_CLOSE_7004_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_CLOSE_7004_LDM dm = (MT_CLOSE_7004_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.close.ds.MT_CLOSE_7004_LDataSet();
	}
