...
public class MT_CLOSE_9001_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_CLOSE_9001_LDM(){}
	public MT_CLOSE_9001_LDM(String cmpy_cd, String in_yymm, String fac_clsf, String matr_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_CLOSE_9001_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_CLOSE_9001_LDM dm = (MT_CLOSE_9001_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.close.ds.MT_CLOSE_9001_LDataSet();
	}
