...
public class MT_CLOSE_2000_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String in_yymm;
	public String fac_clsf;

	public MT_CLOSE_2000_LDM(){}
	public MT_CLOSE_2000_LDM(String cmpy_cd, String in_yymm, String fac_clsf){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_CLOSE_2000_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_CLOSE_2000_LDM dm = (MT_CLOSE_2000_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.close.ds.MT_CLOSE_2000_LDataSet();
	}
