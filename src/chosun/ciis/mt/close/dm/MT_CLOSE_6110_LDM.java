...
public class MT_CLOSE_6110_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_CLOSE_6110_LDM(){}
	public MT_CLOSE_6110_LDM(String cmpy_cd, String bgn_yymm, String end_yymm, String base_mm, String medi_cd, String fac_clsf, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_MT_CLOSE_6110_L( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_CLOSE_6110_LDM dm = (MT_CLOSE_6110_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.close.ds.MT_CLOSE_6110_LDataSet();
	}
