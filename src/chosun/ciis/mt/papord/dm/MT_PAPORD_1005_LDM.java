...
public class MT_PAPORD_1005_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPORD_1005_LDM(){}
	public MT_PAPORD_1005_LDM(String cmpy_cd, String fac_clsf, String aply_dt, String occr_dt, String seq){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPORD_1005_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPORD_1005_LDM dm = (MT_PAPORD_1005_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papord.ds.MT_PAPORD_1005_LDataSet();
	}
