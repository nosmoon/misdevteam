...
public class MT_PAPORD_7002_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String ordr_dt;
	public String papcmpy_cd;

	public MT_PAPORD_7002_LDM(){}
	public MT_PAPORD_7002_LDM(String cmpy_cd, String ordr_dt, String papcmpy_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPORD_7002_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPORD_7002_LDM dm = (MT_PAPORD_7002_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papord.ds.MT_PAPORD_7002_LDataSet();
	}
