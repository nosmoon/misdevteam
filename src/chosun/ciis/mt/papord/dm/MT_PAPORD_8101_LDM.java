...
public class MT_PAPORD_8101_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String search_dt_fr;
	public String search_dt_to;

	public MT_PAPORD_8101_LDM(){}
	public MT_PAPORD_8101_LDM(String cmpy_cd, String search_dt_fr, String search_dt_to){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPORD_8101_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPORD_8101_LDM dm = (MT_PAPORD_8101_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papord.ds.MT_PAPORD_8101_LDataSet();
	}
