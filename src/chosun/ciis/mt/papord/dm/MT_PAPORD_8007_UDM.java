...
public class MT_PAPORD_8007_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPORD_8007_UDM(){}
	public MT_PAPORD_8007_UDM(String cmpy_cd, String fac_clsf, String issu_dt_fr, String issu_dt_to){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPORD_8007_U(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPORD_8007_UDM dm = (MT_PAPORD_8007_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papord.ds.MT_PAPORD_8007_UDataSet();
	}
