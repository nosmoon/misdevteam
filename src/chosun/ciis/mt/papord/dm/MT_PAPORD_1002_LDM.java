...
public class MT_PAPORD_1002_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String fac_clsf;
	public String matr_cd;

	public MT_PAPORD_1002_LDM(){}
	public MT_PAPORD_1002_LDM(String cmpy_cd, String fac_clsf, String matr_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPORD_1002_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPORD_1002_LDM dm = (MT_PAPORD_1002_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papord.ds.MT_PAPORD_1002_LDataSet();
	}
