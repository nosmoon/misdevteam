...
public class MT_PAPORD_4100_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String issu_dt_fr;
	public String issu_dt_to;

	public MT_PAPORD_4100_LDM(){}
	public MT_PAPORD_4100_LDM(String cmpy_cd, String issu_dt_fr, String issu_dt_to){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPORD_4100_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPORD_4100_LDM dm = (MT_PAPORD_4100_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papord.ds.MT_PAPORD_4100_LDataSet();
	}
...
/* 작성시간 : Tue Apr 14 16:55:57 KST 2009 */