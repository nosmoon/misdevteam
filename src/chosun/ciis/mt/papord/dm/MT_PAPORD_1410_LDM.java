...
public class MT_PAPORD_1410_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPORD_1410_LDM(){}
	public MT_PAPORD_1410_LDM(String cmpy_cd, String prt_dt_fr, String prt_dt_to, String fac_clsf){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPORD_1410_L(? ,? ,? ,? ,? ,? ,? ) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPORD_1410_LDM dm = (MT_PAPORD_1410_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.prt_dt_fr);
		cstmt.setString(5, dm.prt_dt_to);
		cstmt.setString(6, dm.fac_clsf);
		cstmt.registerOutParameter(7, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papord.ds.MT_PAPORD_1410_LDataSet();
	}
	...
	public void print(){
		...
		System.out.println("prt_dt_fr = [" + getPrt_dt_fr() + "]");
		System.out.println("prt_dt_to = [" + getPrt_dt_to() + "]");
