...
public class MT_PAPORD_1001_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PAPORD_1001_LDM(){}
	public MT_PAPORD_1001_LDM(String cmpy_cd, String fac_clsf_s, String aply_dt_fr_s, String aply_dt_to_s){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPORD_1001_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPORD_1001_LDM dm = (MT_PAPORD_1001_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papord.ds.MT_PAPORD_1001_LDataSet();
	}
