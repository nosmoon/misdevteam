...
public class MT_PAPORD_1000_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String mang_cd_3;

	public MT_PAPORD_1000_MDM(){}
	public MT_PAPORD_1000_MDM(String cmpy_cd, String mang_cd_3){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PAPORD_1000_M(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PAPORD_1000_MDM dm = (MT_PAPORD_1000_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.papord.ds.MT_PAPORD_1000_MDataSet();
	}
...
/* 작성시간 : Fri Apr 03 18:47:35 KST 2009 */