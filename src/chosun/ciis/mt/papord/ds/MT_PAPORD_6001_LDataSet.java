...
public class MT_PAPORD_6001_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MT_PAPORD_6001_LDataSet(){}
	public MT_PAPORD_6001_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_PAPORD_6001_LCURLISTRecord rec = new MT_PAPORD_6001_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		MT_PAPORD_6001_LCURLISTRecord curlistRec = (MT_PAPORD_6001_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
