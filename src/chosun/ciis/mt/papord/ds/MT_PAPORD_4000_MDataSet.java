...
public class MT_PAPORD_4000_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public MT_PAPORD_4000_MDataSet(){}
	public MT_PAPORD_4000_MDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_PAPORD_4000_MCURLIST1Record rec = new MT_PAPORD_4000_MCURLIST1Record();
		...
		while(rset1.next()){
			MT_PAPORD_4000_MCURLIST2Record rec = new MT_PAPORD_4000_MCURLIST2Record();
		...
		while(rset2.next()){
			MT_PAPORD_4000_MCURLIST3Record rec = new MT_PAPORD_4000_MCURLIST3Record();
		...
		while(rset3.next()){
			MT_PAPORD_4000_MCURLIST4Record rec = new MT_PAPORD_4000_MCURLIST4Record();
		...
		while(rset4.next()){
			MT_PAPORD_4000_MCURLIST5Record rec = new MT_PAPORD_4000_MCURLIST5Record();
