...
public class MT_SUBMATRIN_1105_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATRIN_1105_LDM(){}
	public MT_SUBMATRIN_1105_LDM(String cmpy_cd, String ewh_dt, String fac_clsf, String matr_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATRIN_1105_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATRIN_1105_LDM dm = (MT_SUBMATRIN_1105_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrin.ds.MT_SUBMATRIN_1105_LDataSet();
	}
