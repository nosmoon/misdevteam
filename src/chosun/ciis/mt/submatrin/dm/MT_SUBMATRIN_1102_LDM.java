...
public class MT_SUBMATRIN_1102_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATRIN_1102_LDM(){}
	public MT_SUBMATRIN_1102_LDM(String cmpy_cd, String ewh_dt_fr, String ewh_dt_to, String fac_clsf){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATRIN_1102_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATRIN_1102_LDM dm = (MT_SUBMATRIN_1102_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrin.ds.MT_SUBMATRIN_1102_LDataSet();
	}
