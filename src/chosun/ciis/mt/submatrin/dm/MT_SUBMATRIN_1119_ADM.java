...
public class MT_SUBMATRIN_1119_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_SUBMATRIN_1119_ADM(){}
	public MT_SUBMATRIN_1119_ADM(String cmpy_cd, String ewh_dt, String magam_dt, String per_id, String per_addr){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATRIN_1119_A(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATRIN_1119_ADM dm = (MT_SUBMATRIN_1119_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrin.ds.MT_SUBMATRIN_1119_ADataSet();
	}
