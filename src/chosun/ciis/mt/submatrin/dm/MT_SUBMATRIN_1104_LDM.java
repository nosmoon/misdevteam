...
public class MT_SUBMATRIN_1104_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String matr_cd;

	public MT_SUBMATRIN_1104_LDM(){}
	public MT_SUBMATRIN_1104_LDM(String cmpy_cd, String matr_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_SUBMATRIN_1104_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_SUBMATRIN_1104_LDM dm = (MT_SUBMATRIN_1104_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.submatrin.ds.MT_SUBMATRIN_1104_LDataSet();
	}
