...
public class MT_SUBMATRIN_1204_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MT_SUBMATRIN_1204_LDataSet(){}
	public MT_SUBMATRIN_1204_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_SUBMATRIN_1204_LCURLISTRecord rec = new MT_SUBMATRIN_1204_LCURLISTRecord();
