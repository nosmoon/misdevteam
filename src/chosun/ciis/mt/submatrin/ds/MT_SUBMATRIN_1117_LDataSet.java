...
public class MT_SUBMATRIN_1117_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MT_SUBMATRIN_1117_LDataSet(){}
	public MT_SUBMATRIN_1117_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_SUBMATRIN_1117_LCURLISTRecord rec = new MT_SUBMATRIN_1117_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		MT_SUBMATRIN_1117_LCURLISTRecord curlistRec = (MT_SUBMATRIN_1117_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Fri Jul 17 10:25:44 KST 2009 */