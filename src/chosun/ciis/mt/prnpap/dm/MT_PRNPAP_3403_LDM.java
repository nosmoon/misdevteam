...
public class MT_PRNPAP_3403_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PRNPAP_3403_LDM(){}
	public MT_PRNPAP_3403_LDM(String cmpy_cd, String issu_dt, String prt_dt, String fac_clsf, String medi_cd, String sect_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PRNPAP_3403_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PRNPAP_3403_LDM dm = (MT_PRNPAP_3403_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.prnpap.ds.MT_PRNPAP_3403_LDataSet();
	}
