...
public class MT_PRNPAP_3008_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PRNPAP_3008_UDM(){}
	public MT_PRNPAP_3008_UDM(String cmpy_cd, String fac_clsf, String issu_dt, String pers_ipaddr, String pers_id){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PRNPAP_3008_U(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PRNPAP_3008_UDM dm = (MT_PRNPAP_3008_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.prnpap.ds.MT_PRNPAP_3008_UDataSet();
	}
...
/* 작성시간 : Thu Jun 25 09:49:16 KST 2009 */