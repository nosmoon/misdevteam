...
public class MT_PRNPAP_3203_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String paper_cmpy;

	public MT_PRNPAP_3203_LDM(){}
	public MT_PRNPAP_3203_LDM(String cmpy_cd, String paper_cmpy){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PRNPAP_3203_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PRNPAP_3203_LDM dm = (MT_PRNPAP_3203_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.prnpap.ds.MT_PRNPAP_3203_LDataSet();
	}
