...
public class MT_PRNPAP_3501_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MT_PRNPAP_3501_ADM(){}
	public MT_PRNPAP_3501_ADM(String cmpy_cd, String occr_dt, String seq, String issu_dt, String fac_clsf, String medi_cd, String sect_cd, String pj_kind, String rem_qunt, String cnt, String wgt, String incmg_pers, String incmg_pers_ipaddr, String gubun){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_PRNPAP_3501_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_PRNPAP_3501_ADM dm = (MT_PRNPAP_3501_ADM)bdm;
		...
		cstmt.setString(11, dm.rem_qunt);
		cstmt.setString(12, dm.cnt);
		cstmt.setString(13, dm.wgt);
		cstmt.setString(14, dm.incmg_pers);
		cstmt.setString(15, dm.incmg_pers_ipaddr);
		cstmt.setString(16, dm.gubun);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.prnpap.ds.MT_PRNPAP_3501_ADataSet();
	}
...
/* 작성시간 : Fri May 15 16:58:28 KST 2009 */