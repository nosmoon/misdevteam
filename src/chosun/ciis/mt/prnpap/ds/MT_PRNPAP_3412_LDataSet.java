...
public class MT_PRNPAP_3412_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public MT_PRNPAP_3412_LDataSet(){}
	public MT_PRNPAP_3412_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_PRNPAP_3412_LCURLISTRecord rec = new MT_PRNPAP_3412_LCURLISTRecord();
		...
		while(rset1.next()){
			MT_PRNPAP_3412_LCURLIST1Record rec = new MT_PRNPAP_3412_LCURLIST1Record();
		...
		while(rset2.next()){
			MT_PRNPAP_3412_LCURLIST2Record rec = new MT_PRNPAP_3412_LCURLIST2Record();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		MT_PRNPAP_3412_LCURLISTRecord curlistRec = (MT_PRNPAP_3412_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		MT_PRNPAP_3412_LCURLIST1Record curlist1Rec = (MT_PRNPAP_3412_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		MT_PRNPAP_3412_LCURLIST2Record curlist2Rec = (MT_PRNPAP_3412_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>
