...
public class MT_COMMON_DLCO_0001_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String ern;

	public MT_COMMON_DLCO_0001_LDM(){}
	public MT_COMMON_DLCO_0001_LDM(String cmpy_cd, String ern){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_COMMON_DLCO_0001_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_COMMON_DLCO_0001_LDM dm = (MT_COMMON_DLCO_0001_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.common.ds.MT_COMMON_DLCO_0001_LDataSet();
	}
