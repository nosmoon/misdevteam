...
public class MT_COMMON_3001_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String matr_cd;
	public String matr_nm;
	public String cmpy_cd;

	public MT_COMMON_3001_LDM(){}
	public MT_COMMON_3001_LDM(String matr_cd, String matr_nm, String cmpy_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_COMMON_3001_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_COMMON_3001_LDM dm = (MT_COMMON_3001_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.common.ds.MT_COMMON_3001_LDataSet();
	}
