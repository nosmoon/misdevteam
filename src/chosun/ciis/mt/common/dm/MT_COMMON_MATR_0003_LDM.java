...
public class MT_COMMON_MATR_0003_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String matr_cd;

	public MT_COMMON_MATR_0003_LDM(){}
	public MT_COMMON_MATR_0003_LDM(String cmpy_cd, String matr_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_MT_COMMON_MATR_0003_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MT_COMMON_MATR_0003_LDM dm = (MT_COMMON_MATR_0003_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mt.common.ds.MT_COMMON_MATR_0003_LDataSet();
	}
