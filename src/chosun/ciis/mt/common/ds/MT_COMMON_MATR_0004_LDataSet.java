...
public class MT_COMMON_MATR_0004_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MT_COMMON_MATR_0004_LDataSet(){}
	public MT_COMMON_MATR_0004_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MT_COMMON_MATR_0004_LCURLISTRecord rec = new MT_COMMON_MATR_0004_LCURLISTRecord();
...
<%
	MT_COMMON_MATR_0004_LDataSet ds = (MT_COMMON_MATR_0004_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		MT_COMMON_MATR_0004_LCURLISTRecord curlistRec = (MT_COMMON_MATR_0004_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
