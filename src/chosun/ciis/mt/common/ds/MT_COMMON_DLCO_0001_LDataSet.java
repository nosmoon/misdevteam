...
public class MT_COMMON_DLCO_0001_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MT_COMMON_DLCO_0001_LDataSet(){}
	public MT_COMMON_DLCO_0001_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset4.next()){
			MT_COMMON_DLCO_0001_LCURLISTRecord rec = new MT_COMMON_DLCO_0001_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		MT_COMMON_DLCO_0001_LCURLISTRecord curlistRec = (MT_COMMON_DLCO_0001_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
