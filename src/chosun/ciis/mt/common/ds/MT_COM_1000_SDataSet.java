...
import chosun.ciis.mt.common.rec.MT_COM_1000_SCURLISTRecord;
import chosun.ciis.mt.common.*;
...
public class MT_COM_1000_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	******************************************************************************************/
	...
	public MT_COM_1000_SDataSet(){}
	public MT_COM_1000_SDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		if(rset0.next()){
			...
			MT_COM_1000_SCURLISTRecord rec = new MT_COM_1000_SCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		AS_COM_1000_SCURLISTRecord curlistRec = (AS_COM_1000_SCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
