...
public class CO_DLCO_1000_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public CO_DLCO_1000_LDataSet(){}
	public CO_DLCO_1000_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			CO_DLCO_1000_LCURLISTRecord rec = new CO_DLCO_1000_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		CO_DLCO_1000_LCURLISTRecord curlistRec = (CO_DLCO_1000_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
