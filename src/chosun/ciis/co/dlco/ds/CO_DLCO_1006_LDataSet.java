...
public class CO_DLCO_1006_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public CO_DLCO_1006_LDataSet(){}
	public CO_DLCO_1006_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			CO_DLCO_1006_LCURLISTRecord rec = new CO_DLCO_1006_LCURLISTRecord();
			...
			rec.frnc_pers_yn = Util.checkString(rset0.getString("frnc_pers_yn"));
			...
			rec.incmg_nm = Util.checkString(rset0.getString("incmg_nm"));
			rec.incmg_dt_tm = Util.checkString(rset0.getString("incmg_dt_tm"));
			rec.chg_pers_cmpy_cd = Util.checkString(rset0.getString("chg_pers_cmpy_cd"));
			rec.chg_pers = Util.checkString(rset0.getString("chg_pers"));
			rec.chg_nm = Util.checkString(rset0.getString("chg_nm"));
...
<%
	CO_DLCO_1006_LDataSet ds = (CO_DLCO_1006_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		CO_DLCO_1006_LCURLISTRecord curlistRec = (CO_DLCO_1006_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
