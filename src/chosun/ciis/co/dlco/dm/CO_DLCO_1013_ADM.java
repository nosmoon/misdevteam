...
public class CO_DLCO_1013_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public CO_DLCO_1013_ADM(){}
	public CO_DLCO_1013_ADM(String cmpy_cd, String dlco_no, String setl_bank, String acct_no, String acct_stat, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISCOM.SP_CO_DLCO_1013_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		CO_DLCO_1013_ADM dm = (CO_DLCO_1013_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.dlco_no);
		cstmt.setString(5, dm.setl_bank);
		cstmt.setString(6, dm.acct_no);
		cstmt.setString(7, dm.acct_stat);
		cstmt.setString(8, dm.incmg_pers_ipadd);
		cstmt.setString(9, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.co.dlco.ds.CO_DLCO_1013_ADataSet();
	}
...
/* 작성시간 : Tue Feb 19 18:11:38 KST 2013 */