...
public class CO_JOB_1070_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public CO_JOB_1070_ADM(){}
	public CO_JOB_1070_ADM(String cmpy_cd, String job_clsf, String cntc_seq, String rmsg_seq){
	...
	public String getSQL(){
		 return "{ call MISCOM.SP_CO_JOB_1070_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		CO_JOB_1070_ADM dm = (CO_JOB_1070_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.co.job.ds.CO_JOB_1070_ADataSet();
	}
