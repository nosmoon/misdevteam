...
public class CO_JOB_1020_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String job_clsf;
	public String cntc_seq;

	public CO_JOB_1020_SDM(){}
	public CO_JOB_1020_SDM(String cmpy_cd, String job_clsf, String cntc_seq){
	...
	public String getSQL(){
		 return "{ call MISCOM.SP_CO_JOB_1020_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		CO_JOB_1020_SDM dm = (CO_JOB_1020_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.co.job.ds.CO_JOB_1020_SDataSet();
	}
