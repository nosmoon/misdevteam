...
public class CO_JOB_3000_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String acct_cd;

	public CO_JOB_3000_MDM(){}
	public CO_JOB_3000_MDM(String cmpy_cd, String acct_cd){
	...
	public String getSQL(){
		 return "{ call MISCOM.SP_CO_JOB_3000_M(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		CO_JOB_3000_MDM dm = (CO_JOB_3000_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.co.job.ds.CO_JOB_3000_MDataSet();
	}
...
/* 작성시간 : Mon Sep 07 09:41:00 KST 2009 */