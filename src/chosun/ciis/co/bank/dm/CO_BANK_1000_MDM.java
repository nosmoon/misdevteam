...
public class CO_BANK_1000_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String incmg_pers;
	public String sys_clsf;

	public CO_BANK_1000_MDM(){}
	public CO_BANK_1000_MDM(String cmpy_cd, String incmg_pers, String sys_clsf){
	...
	public String getSQL(){
		 return "{ call MISCOM.SP_CO_BANK_1000_M(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		CO_BANK_1000_MDM dm = (CO_BANK_1000_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.co.bank.ds.CO_BANK_1000_MDataSet();
	}
