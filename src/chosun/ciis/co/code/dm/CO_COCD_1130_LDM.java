...
public class CO_COCD_1130_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public CO_COCD_1130_LDM(){}
	public CO_COCD_1130_LDM(String cmpy_cd, String job_clsf, String cd_clsf, String cnt){
	...
	public String getSQL(){
		 return "{ call MISCOM.SP_CO_COCD_1130_L( ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		CO_COCD_1130_LDM dm = (CO_COCD_1130_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.co.code.ds.CO_COCD_1130_LDataSet();
	}
...
/* 작성시간 : Wed Feb 11 21:22:49 KST 2009 */