...
public class CO_COCD_1020_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public CO_COCD_1020_LDM(){}
	public CO_COCD_1020_LDM(String cmpy_cd, String job_clsf, String cd_clsf, String cd){
	...
	public String getSQL(){
		 return "{ call MISCOM.SP_CO_COCD_1020_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		CO_COCD_1020_LDM dm = (CO_COCD_1020_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.co.cocd.ds.CO_COCD_1020_LDataSet();
	}
