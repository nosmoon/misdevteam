...
public class CO_SMTB_1071_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.fnd_user = Util.checkString(cstmt.getString(6));
		this.fnd_regno = Util.checkString(cstmt.getString(7));
		this.fnd_user_name = Util.checkString(cstmt.getString(8));
		this.smart_id = Util.checkString(cstmt.getString(9));
		this.smart_password = Util.checkString(cstmt.getString(10));
		this.smart_email = Util.checkString(cstmt.getString(11));
	}
}/*----------------------------------------------------------------------------------------------------
