...
public class SP_DEP_1010_SCURLIST2Record extends java.lang.Object implements java.io.Serializable{
	...
	public String cash_rcpt_use_yn;
	public String cash_rcpt_acq_yn;
	public String deal_cd;
	public String tmnl_no;
	public String aprv_no;
	public String card_aprv_dd;
	public String decid_no;
	public String card_rcpm_yn;
	public String card_mang_no;

	public SP_DEP_1010_SCURLIST2Record(){}
	...
	public void setCash_rcpt_use_yn(String cash_rcpt_use_yn){
		this.cash_rcpt_use_yn = cash_rcpt_use_yn;
	}

	public void setCash_rcpt_acq_yn(String cash_rcpt_acq_yn){
		this.cash_rcpt_acq_yn = cash_rcpt_acq_yn;
	}
	...
	public void setCard_aprv_dd(String card_aprv_dd){
		this.card_aprv_dd = card_aprv_dd;
	}

	public void setDecid_no(String decid_no){
		this.decid_no = decid_no;
	}
	...
	public String getCash_rcpt_use_yn(){
		return this.cash_rcpt_use_yn;
	}

	public String getCash_rcpt_acq_yn(){
		return this.cash_rcpt_acq_yn;
	}
	...
	public String getCard_aprv_dd(){
		return this.card_aprv_dd;
	}

	public String getDecid_no(){
		return this.decid_no;
	}
