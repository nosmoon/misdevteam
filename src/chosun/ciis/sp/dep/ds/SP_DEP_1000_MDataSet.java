...
public class SP_DEP_1000_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SP_DEP_1000_MDataSet(){}
	public SP_DEP_1000_MDataSet(String errcode, String errmsg, String xx_note_clsf_cd_001, String xx_note_clsf_cd_002, String xx_note_clsf_cd_003, String xx_note_clsf_cd_004, String xx_note_clsf_cd_005, String xx_job_clsf_02, String xx_cd_clsf_006, String xx_medi_cd_001, String xx_medi_cd_002, String xx_cd_clsf_007){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SP_DEP_1000_MCURLIST1Record rec = new SP_DEP_1000_MCURLIST1Record();
		...
		while(rset1.next()){
			SP_DEP_1000_MCURLIST2Record rec = new SP_DEP_1000_MCURLIST2Record();
		...
		while(rset2.next()){
			SP_DEP_1000_MCURLIST3Record rec = new SP_DEP_1000_MCURLIST3Record();
		...
		while(rset3.next()){
			SP_DEP_1000_MCURLIST4Record rec = new SP_DEP_1000_MCURLIST4Record();
		...
		while(rset4.next()){
			SP_DEP_1000_MCURLIST5Record rec = new SP_DEP_1000_MCURLIST5Record();
		...
		while(rset5.next()){
			SP_DEP_1000_MCURLIST6Record rec = new SP_DEP_1000_MCURLIST6Record();
		...
		while(rset6.next()){
			SP_DEP_1000_MCURLIST7Record rec = new SP_DEP_1000_MCURLIST7Record();
		...
		while(rset7.next()){
			SP_DEP_1000_MCURLIST8Record rec = new SP_DEP_1000_MCURLIST8Record();
		...
		while(rset8.next()){
			SP_DEP_1000_MCURLIST9Record rec = new SP_DEP_1000_MCURLIST9Record();
		...
		while(rset9.next()){
			SP_DEP_1000_MCURLIST10Record rec = new SP_DEP_1000_MCURLIST10Record();
		...
		while(rset10.next()){
			SP_DEP_1000_MCURLIST11Record rec = new SP_DEP_1000_MCURLIST11Record();
		...
		this.xx_note_clsf_cd_001 = Util.checkString(cstmt.getString(20));
		this.xx_note_clsf_cd_002 = Util.checkString(cstmt.getString(21));
		this.xx_note_clsf_cd_003 = Util.checkString(cstmt.getString(22));
		this.xx_note_clsf_cd_004 = Util.checkString(cstmt.getString(23));
		this.xx_note_clsf_cd_005 = Util.checkString(cstmt.getString(24));
		this.xx_job_clsf_02 = Util.checkString(cstmt.getString(25));
		this.xx_cd_clsf_006 = Util.checkString(cstmt.getString(26));
		this.xx_medi_cd_001 = Util.checkString(cstmt.getString(27));
		this.xx_medi_cd_002 = Util.checkString(cstmt.getString(28));
		this.xx_cd_clsf_007 = Util.checkString(cstmt.getString(29));
	}
}/*----------------------------------------------------------------------------------------------------
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		SP_DEP_1000_MCURLIST1Record curlist1Rec = (SP_DEP_1000_MCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		SP_DEP_1000_MCURLIST2Record curlist2Rec = (SP_DEP_1000_MCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		SP_DEP_1000_MCURLIST3Record curlist3Rec = (SP_DEP_1000_MCURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist4.size(); i++){
		SP_DEP_1000_MCURLIST4Record curlist4Rec = (SP_DEP_1000_MCURLIST4Record)ds.curlist4.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist5.size(); i++){
		SP_DEP_1000_MCURLIST5Record curlist5Rec = (SP_DEP_1000_MCURLIST5Record)ds.curlist5.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist6.size(); i++){
		SP_DEP_1000_MCURLIST6Record curlist6Rec = (SP_DEP_1000_MCURLIST6Record)ds.curlist6.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist7.size(); i++){
		SP_DEP_1000_MCURLIST7Record curlist7Rec = (SP_DEP_1000_MCURLIST7Record)ds.curlist7.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist8.size(); i++){
		SP_DEP_1000_MCURLIST8Record curlist8Rec = (SP_DEP_1000_MCURLIST8Record)ds.curlist8.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist9.size(); i++){
		SP_DEP_1000_MCURLIST9Record curlist9Rec = (SP_DEP_1000_MCURLIST9Record)ds.curlist9.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist10.size(); i++){
		SP_DEP_1000_MCURLIST10Record curlist10Rec = (SP_DEP_1000_MCURLIST10Record)ds.curlist10.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist11.size(); i++){
		SP_DEP_1000_MCURLIST11Record curlist11Rec = (SP_DEP_1000_MCURLIST11Record)ds.curlist11.get(i);%>
HTML 코드들....
	<%}%>
