...
public class SP_DEP_1012_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;
	public String dlco_no;

	public SP_DEP_1012_LDataSet(){}
	public SP_DEP_1012_LDataSet(String errcode, String errmsg, String dlco_no){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SP_DEP_1012_LCURLISTRecord rec = new SP_DEP_1012_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		SP_DEP_1012_LCURLISTRecord curlistRec = (SP_DEP_1012_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Wed Jul 25 20:06:19 KST 2012 */