...
public class SP_DEP_1751_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SP_DEP_1751_LDataSet(){}
	public SP_DEP_1751_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SP_DEP_1751_LCURLISTRecord rec = new SP_DEP_1751_LCURLISTRecord();
...
<%
	SP_DEP_1751_LDataSet ds = (SP_DEP_1751_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		SP_DEP_1751_LCURLISTRecord curlistRec = (SP_DEP_1751_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
