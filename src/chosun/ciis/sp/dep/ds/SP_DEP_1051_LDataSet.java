...
public class SP_DEP_1051_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SP_DEP_1051_LDataSet(){}
	public SP_DEP_1051_LDataSet(String errcode, String errmsg, String occr_dt, String slip_clsf, String seq, String medi_cd, String dlco_clsf_cd_seq, String rcpm_plac_clsf, String dlco_nm, long rcpm_tot_amt, long tot_rvord_amt, long setoff_done_amt, long setoff_tobe_amt, long final_setoff_yn, String proc_frdt, String proc_todt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.dlco_clsf_cd_seq = Util.checkString(cstmt.getString(12));
		...
		this.tot_rvord_amt = cstmt.getLong(16);
		this.setoff_done_amt = cstmt.getLong(17);
		this.setoff_tobe_amt = cstmt.getLong(18);
		this.final_setoff_yn = cstmt.getLong(19);
		this.proc_frdt = Util.checkString(cstmt.getString(20));
		this.proc_todt = Util.checkString(cstmt.getString(21));
		ResultSet rset0 = (ResultSet) cstmt.getObject(22);
		while(rset0.next()){
			SP_DEP_1051_LCURLISTRecord rec = new SP_DEP_1051_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		SP_DEP_1051_LCURLISTRecord curlistRec = (SP_DEP_1051_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
