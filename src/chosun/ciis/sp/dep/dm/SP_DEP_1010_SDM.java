...
public class SP_DEP_1010_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_DEP_1010_SDM(){}
	public SP_DEP_1010_SDM(String cmpy_cd, String occr_dt, String slip_clsf, String seq){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_DEP_1010_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_DEP_1010_SDM dm = (SP_DEP_1010_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.dep.ds.SP_DEP_1010_SDataSet();
	}
