...
public class SP_DEP_1030_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_DEP_1030_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_DEP_1030_ADM dm = (SP_DEP_1030_ADM)bdm;
		...
		cstmt.setString(54, dm.mode3);
		cstmt.setString(55, dm.checked3);
		cstmt.setString(56, dm.medi_cd3);
		cstmt.setString(57, dm.amt3);
		cstmt.setString(58, dm.rcpm_slip_no3);
		cstmt.setString(59, dm.occr_dt3);
		cstmt.setString(60, dm.slip_clsf3);
		cstmt.setString(61, dm.seq3);
		cstmt.setString(62, dm.subseq3);
		cstmt.setString(63, dm.mode4);
		cstmt.setString(64, dm.checked4);
		cstmt.setString(65, dm.swit_dlco4);
		cstmt.setString(66, dm.amt4);
		cstmt.setString(67, dm.rcpm_slip_no4);
		cstmt.setString(68, dm.budg_cd4);
		cstmt.setString(69, dm.occr_dt4);
		cstmt.setString(70, dm.slip_clsf4);
		cstmt.setString(71, dm.seq4);
		cstmt.setString(72, dm.subseq4);
		cstmt.setString(73, dm.mode5);
		cstmt.setString(74, dm.checked5);
		cstmt.setString(75, dm.budg_cd5);
		cstmt.setString(76, dm.amt5);
		cstmt.setString(77, dm.rcpm_slip_no5);
		cstmt.setString(78, dm.occr_dt5);
		cstmt.setString(79, dm.slip_clsf5);
		cstmt.setString(80, dm.seq5);
		cstmt.setString(81, dm.subseq5);
		cstmt.setString(82, dm.medi_cd6);
		cstmt.setString(83, dm.amt6);
		cstmt.setString(84, dm.depo_job_clsf7);
		cstmt.setString(85, dm.amt7);
		cstmt.setString(86, dm.swit_dlco7);
		cstmt.setString(87, dm.amt8);
		cstmt.setString(88, dm.budg_cd8);
		cstmt.setString(89, dm.incmg_pers_ip);
		cstmt.setString(90, dm.incmg_pers);
		cstmt.setString(91, dm.elec_note_key);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.dep.ds.SP_DEP_1030_ADataSet();
	}
...
/* 작성시간 : Wed Jul 25 21:08:47 KST 2012 */