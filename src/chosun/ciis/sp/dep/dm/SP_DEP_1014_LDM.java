...
public class SP_DEP_1014_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String slip_clsf;
	public String slip_no;

	public SP_DEP_1014_LDM(){}
	public SP_DEP_1014_LDM(String cmpy_cd, String slip_clsf, String slip_no){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_DEP_1014_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_DEP_1014_LDM dm = (SP_DEP_1014_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.dep.ds.SP_DEP_1014_LDataSet();
	}
