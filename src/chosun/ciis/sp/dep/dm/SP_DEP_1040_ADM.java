...
public class SP_DEP_1040_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_DEP_1040_ADM(){}
	public SP_DEP_1040_ADM(String medi_clsf, String cmpy_cd, String occr_dt, String slip_clsf, String seq, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_DEP_1040_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_DEP_1040_ADM dm = (SP_DEP_1040_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.dep.ds.SP_DEP_1040_ADataSet();
	}
...
/* 작성시간 : Wed Jul 25 21:13:12 KST 2012 */