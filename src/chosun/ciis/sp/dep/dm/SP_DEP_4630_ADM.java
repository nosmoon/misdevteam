...
public class SP_DEP_4630_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_DEP_4630_ADM(){}
	public SP_DEP_4630_ADM(String cmpy_cd, String work_clsf, String clos_dt, String actu_slip_no, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_DEP_4630_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_DEP_4630_ADM dm = (SP_DEP_4630_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.dep.ds.SP_DEP_4630_ADataSet();
	}
...
/* 작성시간 : Mon Jan 14 17:05:44 KST 2013 */