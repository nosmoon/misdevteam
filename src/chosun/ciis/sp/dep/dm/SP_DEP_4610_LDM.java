...
public class SP_DEP_4610_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_DEP_4610_LDM(){}
	public SP_DEP_4610_LDM(String cmpy_cd, String work_clsf, String clos_dt, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_DEP_4610_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_DEP_4610_LDM dm = (SP_DEP_4610_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.dep.ds.SP_DEP_4610_LDataSet();
	}
