...
public class SP_DEP_4620_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_DEP_4620_ADM(){}
	public SP_DEP_4620_ADM(String cmpy_cd, String work_clsf, String clos_dt, String incmg_dept_cd, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_DEP_4620_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_DEP_4620_ADM dm = (SP_DEP_4620_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.dep.ds.SP_DEP_4620_ADataSet();
	}
...
/* 작성시간 : Mon Jan 14 17:05:10 KST 2013 */