...
public class SP_DEP_1051_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_DEP_1051_LDM(){}
	public SP_DEP_1051_LDM(String flag, String cmpy_cd, String occr_dt, String slip_clsf, String seq, String proc_frdt, String proc_todt, String sale_item_cd){
		this.flag = flag;
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_DEP_1051_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_DEP_1051_LDM dm = (SP_DEP_1051_LDM)bdm;
		...
		cstmt.setString(10, dm.sale_item_cd);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.dep.ds.SP_DEP_1051_LDataSet();
	}
