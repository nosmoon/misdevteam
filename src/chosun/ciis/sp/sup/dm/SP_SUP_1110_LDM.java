...
public class SP_SUP_1110_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SUP_1110_LDM(){}
	public SP_SUP_1110_LDM(String cmpy_cd, String fr_dt, String to_dt, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SUP_1110_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SUP_1110_LDM dm = (SP_SUP_1110_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sup.ds.SP_SUP_1110_LDataSet();
	}
