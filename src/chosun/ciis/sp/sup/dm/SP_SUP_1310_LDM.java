...
public class SP_SUP_1310_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String clsf_cd;
	public String incmg_pers;

	public SP_SUP_1310_LDM(){}
	public SP_SUP_1310_LDM(String cmpy_cd, String clsf_cd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SUP_1310_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SUP_1310_LDM dm = (SP_SUP_1310_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sup.ds.SP_SUP_1310_LDataSet();
	}
...
/* 작성시간 : Tue Jul 03 13:20:52 KST 2012 */