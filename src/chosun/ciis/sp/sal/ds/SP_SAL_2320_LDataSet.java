...
public class SP_SAL_2320_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist1 = new ArrayList();
	public String errcode;
	public String errmsg;

	public SP_SAL_2320_LDataSet(){}
	public SP_SAL_2320_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SP_SAL_2320_LCURLIST1Record rec = new SP_SAL_2320_LCURLIST1Record();
...
<%
	SP_SAL_2320_LDataSet ds = (SP_SAL_2320_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		SP_SAL_2320_LCURLIST1Record curlist1Rec = (SP_SAL_2320_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Wed Jul 18 10:48:38 KST 2012 */