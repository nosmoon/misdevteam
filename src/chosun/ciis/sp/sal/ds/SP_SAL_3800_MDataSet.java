...
public class SP_SAL_3800_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SP_SAL_3800_MDataSet(){}
	public SP_SAL_3800_MDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SP_SAL_3800_MCURLIST1Record rec = new SP_SAL_3800_MCURLIST1Record();
		...
		while(rset1.next()){
			SP_SAL_3800_MCURLIST2Record rec = new SP_SAL_3800_MCURLIST2Record();
		...
		while(rset2.next()){
			SP_SAL_3800_MCURLIST3Record rec = new SP_SAL_3800_MCURLIST3Record();
		...
		while(rset3.next()){
			SP_SAL_3800_MCURLIST4Record rec = new SP_SAL_3800_MCURLIST4Record();
		...
		while(rset4.next()){
			SP_SAL_3800_MCURLIST5Record rec = new SP_SAL_3800_MCURLIST5Record();
		...
		while(rset5.next()){
			SP_SAL_3800_MCURLIST6Record rec = new SP_SAL_3800_MCURLIST6Record();
...
<%
	SP_SAL_3800_MDataSet ds = (SP_SAL_3800_MDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		SP_SAL_3800_MCURLIST1Record curlist1Rec = (SP_SAL_3800_MCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		SP_SAL_3800_MCURLIST2Record curlist2Rec = (SP_SAL_3800_MCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		SP_SAL_3800_MCURLIST3Record curlist3Rec = (SP_SAL_3800_MCURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist4.size(); i++){
		SP_SAL_3800_MCURLIST4Record curlist4Rec = (SP_SAL_3800_MCURLIST4Record)ds.curlist4.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist5.size(); i++){
		SP_SAL_3800_MCURLIST5Record curlist5Rec = (SP_SAL_3800_MCURLIST5Record)ds.curlist5.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist6.size(); i++){
		SP_SAL_3800_MCURLIST6Record curlist6Rec = (SP_SAL_3800_MCURLIST6Record)ds.curlist6.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Thu Aug 02 16:40:28 KST 2012 */