...
public class SP_SAL_3820_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SP_SAL_3820_LDataSet(){}
	public SP_SAL_3820_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SP_SAL_3820_LCURLISTRecord rec = new SP_SAL_3820_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		SP_SAL_3820_LCURLISTRecord curlistRec = (SP_SAL_3820_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
