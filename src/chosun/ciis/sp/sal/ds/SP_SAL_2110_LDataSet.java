...
public class SP_SAL_2110_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist1 = new ArrayList();
	public String errcode;
	public String errmsg;

	public SP_SAL_2110_LDataSet(){}
	public SP_SAL_2110_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SP_SAL_2110_LCURLIST1Record rec = new SP_SAL_2110_LCURLIST1Record();
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		SP_SAL_2110_LCURLIST1Record curlist1Rec = (SP_SAL_2110_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>
