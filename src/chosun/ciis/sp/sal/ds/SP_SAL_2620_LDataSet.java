...
public class SP_SAL_2620_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SP_SAL_2620_LDataSet(){}
	public SP_SAL_2620_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SP_SAL_2620_LCURLISTRecord rec = new SP_SAL_2620_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		SP_SAL_2620_LCURLISTRecord curlistRec = (SP_SAL_2620_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
