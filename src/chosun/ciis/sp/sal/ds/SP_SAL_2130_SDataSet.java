...
public class SP_SAL_2130_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public String errcode;
	public String errmsg;
	public String vat_flag;

	public SP_SAL_2130_SDataSet(){}
	public SP_SAL_2130_SDataSet(String errcode, String errmsg, String vat_flag){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.vat_flag = Util.checkString(cstmt.getString(5));
	}
}/*----------------------------------------------------------------------------------------------------
