...
public class SP_SAL_3610_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SP_SAL_3610_LDataSet(){}
	public SP_SAL_3610_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SP_SAL_3610_LCURLISTRecord rec = new SP_SAL_3610_LCURLISTRecord();
...
<%
	SP_SAL_3610_LDataSet ds = (SP_SAL_3610_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		SP_SAL_3610_LCURLISTRecord curlistRec = (SP_SAL_3610_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
