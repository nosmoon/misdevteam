...
public class SP_SAL_2020_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_2020_ADM(){}
	public SP_SAL_2020_ADM(String cmpy_cd, String sale_yymm, String sale_item_cd, String rcpm_clsf, String dlco_no, String qunt, String sale_cost, String sale_amt, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_2020_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_2020_ADM dm = (SP_SAL_2020_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_2020_ADataSet();
	}
...
/* 작성시간 : Tue Jul 17 11:11:32 KST 2012 */