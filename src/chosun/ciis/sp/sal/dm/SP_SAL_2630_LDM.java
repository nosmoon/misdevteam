...
public class SP_SAL_2630_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_2630_LDM(){}
	public SP_SAL_2630_LDM(String cmpy_cd, String sale_yymm_fr, String sale_yymm_to, String hdqt_sell_dept_cd, String hdqt_sell_sub_dept_cd, String hdqt_sell_area_cd, String sale_item_cd){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_2630_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_2630_LDM dm = (SP_SAL_2630_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_2630_LDataSet();
	}
