...
public class SP_SAL_1210_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String sale_yymm;
	public String incmg_pers;

	public SP_SAL_1210_LDM(){}
	public SP_SAL_1210_LDM(String cmpy_cd, String sale_yymm, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_1210_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_1210_LDM dm = (SP_SAL_1210_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_1210_LDataSet();
	}
