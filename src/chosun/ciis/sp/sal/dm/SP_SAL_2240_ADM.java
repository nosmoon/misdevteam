...
public class SP_SAL_2240_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_2240_ADM(){}
	public SP_SAL_2240_ADM(String cmpy_cd, String work_yymm, String purc_adjm_clsf, String reg_clsf, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_2240_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_2240_ADM dm = (SP_SAL_2240_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_2240_ADataSet();
	}
...
/* 작성시간 : Mon Jul 09 16:21:41 KST 2012 */