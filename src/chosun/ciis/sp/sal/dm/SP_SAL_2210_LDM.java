...
public class SP_SAL_2210_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_2210_LDM(){}
	public SP_SAL_2210_LDM(String cmpy_cd, String work_yymm, String purc_adjm_clsf, String dlco_no, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_2210_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_2210_LDM dm = (SP_SAL_2210_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_2210_LDataSet();
	}
