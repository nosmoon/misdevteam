...
public class SP_SAL_3850_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_3850_ADM(){}
	public SP_SAL_3850_ADM(String cmpy_cd, String slip_clsf_cd, String slip_occr_dt, String prof_type_cd, String slip_seq, String incmg_dept_cd, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_3850_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_3850_ADM dm = (SP_SAL_3850_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_3850_ADataSet();
	}
...
/* 작성시간 : Thu Aug 02 19:05:23 KST 2012 */