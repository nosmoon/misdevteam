...
public class SP_SAL_3830_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String dlco_clsf_cd_seq;

	public SP_SAL_3830_SDM(){}
	public SP_SAL_3830_SDM(String cmpy_cd, String dlco_clsf_cd_seq){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_3830_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_3830_SDM dm = (SP_SAL_3830_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_3830_SDataSet();
	}
