...
public class SP_SAL_1530_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_1530_LDM(){}
	public SP_SAL_1530_LDM(String cmpy_cd, String bo_cd, String sale_yymm, String cta_rdr_extn_amt_clsf, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_1530_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_1530_LDM dm = (SP_SAL_1530_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.bo_cd);
		cstmt.setString(5, dm.sale_yymm);
		cstmt.setString(6, dm.cta_rdr_extn_amt_clsf);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_1530_LDataSet();
	}
