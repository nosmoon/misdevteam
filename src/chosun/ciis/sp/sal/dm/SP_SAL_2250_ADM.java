...
public class SP_SAL_2250_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_2250_ADM(){}
	public SP_SAL_2250_ADM(String cmpy_cd, String mode, String purc_adjm_reg_dt, String purc_adjm_reg_seq, String dlco_clsf_cd_seq, String txn_clsf, String suply_amt, String vat_amt, String dduc_amt, String stot_amt, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_2250_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_2250_ADM dm = (SP_SAL_2250_ADM)bdm;
		...
		cstmt.setString(12, dm.stot_amt);
		cstmt.setString(13, dm.incmg_pers);
		cstmt.setString(14, dm.incmg_pers_ip);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_2250_ADataSet();
	}
...
/* 작성시간 : Mon Jul 09 16:59:20 KST 2012 */