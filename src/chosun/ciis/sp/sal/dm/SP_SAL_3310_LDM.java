...
public class SP_SAL_3310_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String ordr_dt_fr;
	public String ordr_dt_to;

	public SP_SAL_3310_LDM(){}
	public SP_SAL_3310_LDM(String cmpy_cd, String ordr_dt_fr, String ordr_dt_to){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_3310_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_3310_LDM dm = (SP_SAL_3310_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_3310_LDataSet();
	}
