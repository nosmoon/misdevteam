...
public class SP_SAL_2310_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_2310_LDM(){}
	public SP_SAL_2310_LDM(String cmpy_cd, String mappli, String auto_shift_clsf, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_2310_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_2310_LDM dm = (SP_SAL_2310_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_2310_LDataSet();
	}
