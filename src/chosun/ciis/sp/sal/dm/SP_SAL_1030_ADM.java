...
public class SP_SAL_1030_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String sale_yymm;
	public String incmg_pers;

	public SP_SAL_1030_ADM(){}
	public SP_SAL_1030_ADM(String cmpy_cd, String sale_yymm, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_1030_A(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_1030_ADM dm = (SP_SAL_1030_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_1030_ADataSet();
	}
...
/* 작성시간 : Wed Jul 18 20:33:13 KST 2012 */