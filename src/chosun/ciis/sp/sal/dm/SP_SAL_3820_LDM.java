...
public class SP_SAL_3820_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_3820_LDM(){}
	public SP_SAL_3820_LDM(String cmpy_cd, String make_dt_fr, String make_dt_to, String slip_occr_dt_fr, String slip_occr_dt_to, String dlco_clsf_cd_seq, String erplace_cd, String prof_type_cd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_3820_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_3820_LDM dm = (SP_SAL_3820_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_3820_LDataSet();
	}
