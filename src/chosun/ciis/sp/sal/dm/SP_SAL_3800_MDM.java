...
public class SP_SAL_3800_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_3800_MDM(){}
	public SP_SAL_3800_MDM(String cmpy_cd, String auth_gb, String use_yn, String incmg_pers, String base_dt){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_3800_M(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_3800_MDM dm = (SP_SAL_3800_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_3800_MDataSet();
	}
