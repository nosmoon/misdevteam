...
public class SP_SAL_3840_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_3840_ADM(){}
	public SP_SAL_3840_ADM(String cmpy_cd, String slip_clsf_cd, String slip_occr_dt, String prof_type_cd, String rcpm_plan_dt, String suply_erplace_cd, String make_dt, String suply_amt, String vat_amt, String demand_ern, String demand_dlco_no, String demand_dlco_nm, String demand_presi_nm, String demand_addr, String demand_bizcond, String demand_item, String checked, String tax_item, String medi_cd, String vexc_cmpy_cd, String a_sale_yymm, String a_sale_seq, String email_id, String elec_tax_comp_cd, String semuro_no, String biz_plc_cd, String remk, String incmg_dept_cd, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_3840_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_3840_ADM dm = (SP_SAL_3840_ADM)bdm;
		...
		cstmt.setString(23, dm.a_sale_yymm);
		cstmt.setString(24, dm.a_sale_seq);
		cstmt.setString(25, dm.email_id);
		cstmt.setString(26, dm.elec_tax_comp_cd);
		cstmt.setString(27, dm.semuro_no);
		cstmt.setString(28, dm.biz_plc_cd);
		cstmt.setString(29, dm.remk);
		cstmt.setString(30, dm.incmg_dept_cd);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_3840_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("a_sale_yymm = [" + getA_sale_yymm() + "]");
		System.out.println("a_sale_seq = [" + getA_sale_seq() + "]");
...
String a_sale_yymm = req.getParameter("a_sale_yymm");
if( a_sale_yymm == null){
	System.out.println(this.toString+" : a_sale_yymm is null" );
}else{
	System.out.println(this.toString+" : a_sale_yymm is "+a_sale_yymm );
}
String a_sale_seq = req.getParameter("a_sale_seq");
if( a_sale_seq == null){
	System.out.println(this.toString+" : a_sale_seq is null" );
}else{
	System.out.println(this.toString+" : a_sale_seq is "+a_sale_seq );
}
...
String a_sale_yymm = Util.checkString(req.getParameter("a_sale_yymm"));
String a_sale_seq = Util.checkString(req.getParameter("a_sale_seq"));
...
String a_sale_yymm = Util.Uni2Ksc(Util.checkString(req.getParameter("a_sale_yymm")));
String a_sale_seq = Util.Uni2Ksc(Util.checkString(req.getParameter("a_sale_seq")));
...
/* 작성시간 : Thu Aug 02 18:57:43 KST 2012 */