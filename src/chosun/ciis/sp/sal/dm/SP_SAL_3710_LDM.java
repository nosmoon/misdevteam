...
public class SP_SAL_3710_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_3710_LDM(){}
	public SP_SAL_3710_LDM(String cmpy_cd, String sale_yymm, String sale_item_cd, String rcpm_clsf, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_3710_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_3710_LDM dm = (SP_SAL_3710_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_3710_LDataSet();
	}
