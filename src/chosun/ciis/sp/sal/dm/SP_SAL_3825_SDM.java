...
public class SP_SAL_3825_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_3825_SDM(){}
	public SP_SAL_3825_SDM(String hndl_clsf, String cmpy_cd, String medi_clsf, String prof_type_cd, String slip_clsf_cd, String slip_occr_dt, String slip_seq){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_3825_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_3825_SDM dm = (SP_SAL_3825_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_3825_SDataSet();
	}
