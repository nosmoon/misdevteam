...
public class SP_SAL_3630_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_3630_ADM(){}
	public SP_SAL_3630_ADM(String cmpy_cd, String sale_yymm, String incmg_dept_cd, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_3630_A(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_3630_ADM dm = (SP_SAL_3630_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_3630_ADataSet();
	}
...
/* 작성시간 : Sun Jul 29 13:40:54 KST 2012 */