...
public class SP_SAL_2530_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_2530_DDM(){}
	public SP_SAL_2530_DDM(String cmpy_cd, String sale_yymm, String sale_item_cd, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_2530_D(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_2530_DDM dm = (SP_SAL_2530_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_2530_DDataSet();
	}
...
/* 작성시간 : Fri Aug 10 19:10:08 KST 2012 */