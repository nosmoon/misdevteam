...
public class SP_SAL_2410_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_2410_LDM(){}
	public SP_SAL_2410_LDM(String cmpy_cd, String mappli, String auto_shift_clsf, String dduc_clsf, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_2410_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_2410_LDM dm = (SP_SAL_2410_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_2410_LDataSet();
	}
