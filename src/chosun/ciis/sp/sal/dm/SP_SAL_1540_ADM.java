...
public class SP_SAL_1540_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_1540_ADM(){}
	public SP_SAL_1540_ADM(String cmpy_cd, String sale_yymm, String cta_rdr_extn_amt_clsf, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_1540_A(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_1540_ADM dm = (SP_SAL_1540_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_1540_ADataSet();
	}
...
/* 작성시간 : Sun Aug 19 16:49:08 KST 2012 */