...
public class SP_SAL_2330_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_2330_LDM(){}
	public SP_SAL_2330_LDM(String cmpy_cd, String mappli, String auto_shift_clsf, String sale_item_cd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_2330_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_2330_LDM dm = (SP_SAL_2330_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_2330_LDataSet();
	}
