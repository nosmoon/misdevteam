...
public class SP_SAL_1330_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_1330_DDM(){}
	public SP_SAL_1330_DDM(String cmpy_cd, String sale_yymm, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_1330_D(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_1330_DDM dm = (SP_SAL_1330_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_1330_DDataSet();
	}
...
/* 작성시간 : Fri Aug 10 19:34:05 KST 2012 */