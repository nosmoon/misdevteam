...
public class SP_SAL_1830_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_1830_ADM(){}
	public SP_SAL_1830_ADM(String cmpy_cd, String rdr_extn_yymm, String pay_plan_dt, String incmg_dept_cd, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_1830_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_1830_ADM dm = (SP_SAL_1830_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_1830_ADataSet();
	}
...
/* 작성시간 : Mon Jul 30 20:33:48 KST 2012 */