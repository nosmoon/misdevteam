...
public class SP_SAL_3600_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String incmg_pers;
	public String base_dt;

	public SP_SAL_3600_MDM(){}
	public SP_SAL_3600_MDM(String cmpy_cd, String incmg_pers, String base_dt){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_3600_M(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_3600_MDM dm = (SP_SAL_3600_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_3600_MDataSet();
	}
