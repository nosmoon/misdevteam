...
public class SP_SAL_3210_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String ordr_dt_fr;
	public String ordr_dt_to;

	public SP_SAL_3210_LDM(){}
	public SP_SAL_3210_LDM(String cmpy_cd, String ordr_dt_fr, String ordr_dt_to){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_3210_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_3210_LDM dm = (SP_SAL_3210_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_3210_LDataSet();
	}
