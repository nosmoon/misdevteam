...
public class SP_SAL_3730_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SP_SAL_3730_DDM(){}
	public SP_SAL_3730_DDM(String cmpy_cd, String sale_yymm, String sale_item_cd, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_SP_SAL_3730_D(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SP_SAL_3730_DDM dm = (SP_SAL_3730_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.sp.sal.ds.SP_SAL_3730_DDataSet();
	}
...
/* 작성시간 : Fri Aug 10 19:00:04 KST 2012 */