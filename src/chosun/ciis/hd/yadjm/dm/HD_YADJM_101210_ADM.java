...
public class HD_YADJM_101210_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_YADJM_101210_ADM(){}
	public HD_YADJM_101210_ADM(String cmpy_cd, String mode, String adjm_rvrs_yy, String emp_no, String faml_seq, String faml_rshp_cd, String faml_prn, String faml_flnm, String base_dduc_yn, String obcl_pers_dduc_yn, String fml_hshd_dduc_yn, String care_fee_dduc_yn, String adopt_dt, String dth_dt, String edu_fee_clsf_cd, String edu_cost_onta, String edu_cost_etc, String edu_splen_pers_onta, String edu_splen_pers_etc, String asrc_prpn_insr_fee_onta, String asrc_prpn_insr_fee_etc, String obcl_pers_insr_onta, String obcl_pers_insr_etc, String crdt_card_tot_amt_onta, String crdt_card_tot_amt_etc, String debit_card_tot_amt_onta, String debit_card_tot_amt_etc, String edu_cost_giro_pymt_onta, String edu_cost_giro_pymt_etc, String cash_rcpt_onta, String prsn_pens, String pens_savg, String invsm_cmpd_invsm_amt_6, String invsm_cmpd_invsm_amt, String hous_subc_savg, String multy_house_plan_savg, String ltrm_hous_savg, String labr_hous_savg, String hous_rcpm_won_li_amt_repa, String monthly_rent_amt, String hous_loan_amt_int_1, String ltrm_mogg_loan_amt_int_re, String hous_loan_amt_int, String ltrm_stok_savg_incm_dduc1, String ltrm_stok_savg_incm_dduc2, String ltrm_stok_savg_incm_dduc3, String connect_ip, String connect_userid){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_YADJM_101210_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_YADJM_101210_ADM dm = (HD_YADJM_101210_ADM)bdm;
		...
		cstmt.setString(33, dm.prsn_pens);
		cstmt.setString(34, dm.pens_savg);
		cstmt.setString(35, dm.invsm_cmpd_invsm_amt_6);
		cstmt.setString(36, dm.invsm_cmpd_invsm_amt);
		cstmt.setString(37, dm.hous_subc_savg);
		cstmt.setString(38, dm.multy_house_plan_savg);
		cstmt.setString(39, dm.ltrm_hous_savg);
		cstmt.setString(40, dm.labr_hous_savg);
		cstmt.setString(41, dm.hous_rcpm_won_li_amt_repa);
		cstmt.setString(42, dm.monthly_rent_amt);
		cstmt.setString(43, dm.hous_loan_amt_int_1);
		cstmt.setString(44, dm.ltrm_mogg_loan_amt_int_re);
		cstmt.setString(45, dm.hous_loan_amt_int);
		cstmt.setString(46, dm.ltrm_stok_savg_incm_dduc1);
		cstmt.setString(47, dm.ltrm_stok_savg_incm_dduc2);
		cstmt.setString(48, dm.ltrm_stok_savg_incm_dduc3);
		cstmt.setString(49, dm.connect_ip);
		cstmt.setString(50, dm.connect_userid);
	}

	public BaseDataSet createDataSetObject(){
		return new HD_YADJM_101210_ADataSet();
	}
...
/* 작성시간 : Thu Jan 06 17:07:07 KST 2011 */