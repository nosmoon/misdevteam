...
public class HD_YADJM_101232_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_YADJM_101232_ADM(){}
	public HD_YADJM_101232_ADM(String cmpy_cd, String adjm_rvrs_yy, String emp_no, String stok_savg_type, String incmg_pers_ip, String incmg_pers, String mode, String occr_dt, String seq, String bank_cd, String account_no, String payment, String deduct_amt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_YADJM_101232_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_YADJM_101232_ADM dm = (HD_YADJM_101232_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_YADJM_101232_ADataSet();
	}
...
/* 작성시간 : Mon Jan 10 13:21:43 KST 2011 */