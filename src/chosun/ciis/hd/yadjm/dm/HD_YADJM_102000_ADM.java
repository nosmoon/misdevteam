...
public class HD_YADJM_102000_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_YADJM_102000_ADM(){}
	public HD_YADJM_102000_ADM(String cmpy_cd, String yadjm_yy, String yadjm_clsf, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_YADJM_102000_A(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_YADJM_102000_ADM dm = (HD_YADJM_102000_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.yadjm.ds.HD_YADJM_102000_ADataSet();
	}
