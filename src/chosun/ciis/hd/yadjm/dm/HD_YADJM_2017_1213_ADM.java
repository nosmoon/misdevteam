...
public class HD_YADJM_2017_1213_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_YADJM_2017_1213_ADM(){}
	public HD_YADJM_2017_1213_ADM(String cmpy_cd, String adjm_rvrs_yy, String emp_no, String flnm, String incmg_pers_ip, String incmg_pers, String mode, String ern, String firmnm, String dona_plac_clsf, String dona_yymm, String dona_ptcr_noit, String dona_ptcr_amt, String rmks, String rshp, String obj_pers_flnm, String prn, String corr_txn_prd_dduc_amt, String cyov_amt, String seq, String lastyear_cyov_amt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_YADJM_2017_1213_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_YADJM_2017_1213_ADM dm = (HD_YADJM_2017_1213_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.yadjm.ds.HD_YADJM_2017_1213_ADataSet();
	}
