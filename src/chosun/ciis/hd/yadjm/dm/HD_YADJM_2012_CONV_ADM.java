...
public class HD_YADJM_2012_CONV_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_YADJM_2012_CONV_ADM(){}
	public HD_YADJM_2012_CONV_ADM(String cmpy_cd, String adjm_rvrs_yy, String emp_no, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_YADJM_2012_CONV_A(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_YADJM_2012_CONV_ADM dm = (HD_YADJM_2012_CONV_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.yadjm.ds.HD_YADJM_2012_CONV_ADataSet();
	}
