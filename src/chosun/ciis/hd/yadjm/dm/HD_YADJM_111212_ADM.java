...
public class HD_YADJM_111212_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_YADJM_111212_ADM(){}
	public HD_YADJM_111212_ADM(String cmpy_cd, String adjm_rvrs_yy, String emp_no, String flnm, String incmg_pers_ip, String incmg_pers, String mode, String pay_dt, String ern, String firmnm, String obj_pers_flnm, String prn, String rshp, String obcl_pers_rspc_yn, String pay_noit, String pay_amt, String pay_noit_cash, String pay_amt_cash, String hosp_prof, String seq){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_YADJM_111212_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_YADJM_111212_ADM dm = (HD_YADJM_111212_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_YADJM_111212_ADataSet();
	}
...
/* 작성시간 : Fri Jan 07 10:27:33 KST 2011 */