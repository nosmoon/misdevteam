...
public class HD_YADJM_2013_7000_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_YADJM_2013_7000_LDM(){}
	public HD_YADJM_2013_7000_LDM(String cmpy_cd, String emp_no, String adjm_rvrs_yy, String doc_type, String form_cd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_YADJM_2013_7000_L(? ,? ,? ,? ,? ,?, ? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_YADJM_2013_7000_LDM dm = (HD_YADJM_2013_7000_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.yadjm.ds.HD_YADJM_2013_7000_LDataSet();
	}
