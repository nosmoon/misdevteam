...
public class HD_YADJM_5402_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_YADJM_5402_ADM(){}
	public HD_YADJM_5402_ADM(String cmpy_cd, String adjm_rvrs_yy, String emp_no, String seq, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_YADJM_5402_A(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_YADJM_5402_ADM dm = (HD_YADJM_5402_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.yadjm.ds.HD_YADJM_5402_ADataSet();
	}
...
/* 작성시간 : Mon Jan 13 11:35:17 KST 2014 */