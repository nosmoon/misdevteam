...
public class HD_YADJM_177001_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
...
//	 2016년 추가 end 
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_YADJM_177001_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? , ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_YADJM_177001_ADM dm = (HD_YADJM_177001_ADM)bdm;
		...
		cstmt.setString(74, dm.att_frmmm);
		cstmt.setString(75, dm.att_tomm);
		cstmt.setString(76, dm.att_inqrmm);
		cstmt.setString(77, dm.ftyr_tot_amt);
		cstmt.setString(78, dm.ftyr_market_tot_amt);
		cstmt.setString(79, dm.ftyr_tmoney_tot_amt);
		cstmt.setString(80, dm.first_year_tot_amt);
		cstmt.setString(81, dm.second_year_tot_amt);
		cstmt.setString(82, dm.inqr_strt_mm);
		cstmt.setString(83, dm.inqr_end_mm);
		cstmt.setString(84, dm.lend_loan_amt);
		...
		cstmt.setString(85, dm.sbdy_apln_sum);
		cstmt.setString(86, dm.conb_sum);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.yadjm.ds.HD_YADJM_177001_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("edu_cl = [" + getEdu_cl() + "]");
