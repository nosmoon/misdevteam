...
public class HD_YADJM_2018_1210_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String book_show_use_onta;
	public String book_show_use_etc;
	...
	public HD_YADJM_2018_1210_ADM(String cmpy_cd, String mode, String adjm_rvrs_yy, String emp_no, String faml_seq, String faml_rshp_cd, String faml_prn, String faml_flnm, String base_dduc_yn, String obcl_pers_dduc_yn, String fml_hshd_dduc_yn, String care_fee_dduc_yn, String one_paren_dduc_yn, String adopt_dt, String dth_dt, String obcl_pers_clsf, String edu_fee_clsf_cd, String edu_cost_onta, String edu_cost_etc, String edu_splen_pers_onta, String edu_splen_pers_etc, String asrc_prpn_insr_fee_onta, String asrc_prpn_insr_fee_etc, String obcl_pers_insr_onta, String obcl_pers_insr_etc, String crdt_card_tot_amt_onta, String crdt_card_tot_amt_etc, String debit_card_tot_amt_onta, String debit_card_tot_amt_etc, String cash_rcpt_onta, String trad_mrkt_onta, String trad_mrkt_etc, String public_trans_amt_onta, String public_trans_amt_etc, String book_show_use_onta, String book_show_use_etc, String prsn_pens, String pens_savg, String invsm_cmpd_invsm_amt_6, String invsm_cmpd_invsm_amt, String hous_subc_savg, String multy_house_plan_savg, String ltrm_hous_savg, String labr_hous_savg, String hous_rcpm_won_li_amt_repa, String monthly_rent_amt, String hous_loan_amt_int_1, String ltrm_mogg_loan_amt_int_re, String hous_loan_amt_int, String hous_loan_amt_int_2012_1, String hous_loan_amt_int_2012_2, String ltrm_stok_savg_incm_dduc1, String ltrm_stok_savg_incm_dduc2, String ltrm_stok_savg_incm_dduc3, String lvcmpy_pens, String smallbiz_incm_dduc, String larg_sum_no_lease_house, String debit_card_1st_amt_onta, String debit_card_2nd_amt_onta, String debit_card_1st_amt_etc, String debit_card_2nd_amt_etc, String cash_rcpt_1st_onta, String cash_rcpt_2nd_onta, String trad_all_1st_amt_onta, String trad_all_2nd_amt_onta, String trad_all_1st_amt_etc, String trad_all_2nd_amt_etc, String trans_all_1st_amt_onta, String trans_all_2nd_amt_onta, String trans_all_1st_amt_etc, String trans_all_2nd_amt_etc, String crdt_card_incd_pre_onta, String crdt_card_incd_pre_etc, String debit_card_incd_pre_onta, String debit_card_incd_pre_etc, String cash_rcpt_incd_pre_onta, String trad_pre_amt_onta, String trad_pre_amt_etc, String trans_pre_amt_onta, String trans_pre_amt_etc, String ltrm_invsm_stock_amt, String ftyr_crdt_card_onta, String ftyr_crdt_card_etc, String ftyr_debit_card_onta, String ftyr_debit_card_etc, String ftyr_cash_rcpt_onta, String ftyr_trad_amt_onta, String ftyr_trad_amt_etc, String ftyr_trans_amt_onta, String ftyr_trans_amt_etc, String connect_ip, String connect_userid){
		...
		this.book_show_use_onta = book_show_use_onta;
		this.book_show_use_etc = book_show_use_etc;
	...
	public void setBook_show_use_onta(String book_show_use_onta){
		this.book_show_use_onta = book_show_use_onta;
	}

	public void setBook_show_use_etc(String book_show_use_etc){
		this.book_show_use_etc = book_show_use_etc;
	}
	...
	public String getBook_show_use_onta(){
		return this.book_show_use_onta;
	}

	public String getBook_show_use_etc(){
		return this.book_show_use_etc;
	}
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_YADJM_2018_1210_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_YADJM_2018_1210_ADM dm = (HD_YADJM_2018_1210_ADM)bdm;
		...
		cstmt.setString(37, dm.book_show_use_onta);
		cstmt.setString(38, dm.book_show_use_etc);
		cstmt.setString(39, dm.prsn_pens);
		cstmt.setString(40, dm.pens_savg);
		cstmt.setString(41, dm.invsm_cmpd_invsm_amt_6);
		cstmt.setString(42, dm.invsm_cmpd_invsm_amt);
		cstmt.setString(43, dm.hous_subc_savg);
		cstmt.setString(44, dm.multy_house_plan_savg);
		cstmt.setString(45, dm.ltrm_hous_savg);
		cstmt.setString(46, dm.labr_hous_savg);
		cstmt.setString(47, dm.hous_rcpm_won_li_amt_repa);
		cstmt.setString(48, dm.monthly_rent_amt);
		cstmt.setString(49, dm.hous_loan_amt_int_1);
		cstmt.setString(50, dm.ltrm_mogg_loan_amt_int_re);
		cstmt.setString(51, dm.hous_loan_amt_int);
		cstmt.setString(52, dm.hous_loan_amt_int_2012_1);
		cstmt.setString(53, dm.hous_loan_amt_int_2012_2);
		cstmt.setString(54, dm.ltrm_stok_savg_incm_dduc1);
		cstmt.setString(55, dm.ltrm_stok_savg_incm_dduc2);
		cstmt.setString(56, dm.ltrm_stok_savg_incm_dduc3);
		cstmt.setString(57, dm.lvcmpy_pens);
		cstmt.setString(58, dm.smallbiz_incm_dduc);
		cstmt.setString(59, dm.larg_sum_no_lease_house);
		cstmt.setString(60, dm.debit_card_1st_amt_onta);
		cstmt.setString(61, dm.debit_card_2nd_amt_onta);
		cstmt.setString(62, dm.debit_card_1st_amt_etc);
		cstmt.setString(63, dm.debit_card_2nd_amt_etc);
		cstmt.setString(64, dm.cash_rcpt_1st_onta);
		cstmt.setString(65, dm.cash_rcpt_2nd_onta);
		cstmt.setString(66, dm.trad_all_1st_amt_onta);
		cstmt.setString(67, dm.trad_all_2nd_amt_onta);
		cstmt.setString(68, dm.trad_all_1st_amt_etc);
		cstmt.setString(69, dm.trad_all_2nd_amt_etc);
		cstmt.setString(70, dm.trans_all_1st_amt_onta);
		cstmt.setString(71, dm.trans_all_2nd_amt_onta);
		cstmt.setString(72, dm.trans_all_1st_amt_etc);
		cstmt.setString(73, dm.trans_all_2nd_amt_etc);
		cstmt.setString(74, dm.crdt_card_incd_pre_onta);
		cstmt.setString(75, dm.crdt_card_incd_pre_etc);
		cstmt.setString(76, dm.debit_card_incd_pre_onta);
		cstmt.setString(77, dm.debit_card_incd_pre_etc);
		cstmt.setString(78, dm.cash_rcpt_incd_pre_onta);
		cstmt.setString(79, dm.trad_pre_amt_onta);
		cstmt.setString(80, dm.trad_pre_amt_etc);
		cstmt.setString(81, dm.trans_pre_amt_onta);
		cstmt.setString(82, dm.trans_pre_amt_etc);
		cstmt.setString(83, dm.ltrm_invsm_stock_amt);
		cstmt.setString(84, dm.ftyr_crdt_card_onta);
		cstmt.setString(85, dm.ftyr_crdt_card_etc);
		cstmt.setString(86, dm.ftyr_debit_card_onta);
		cstmt.setString(87, dm.ftyr_debit_card_etc);
		cstmt.setString(88, dm.ftyr_cash_rcpt_onta);
		cstmt.setString(89, dm.ftyr_trad_amt_onta);
		cstmt.setString(90, dm.ftyr_trad_amt_etc);
		cstmt.setString(91, dm.ftyr_trans_amt_onta);
		cstmt.setString(92, dm.ftyr_trans_amt_etc);
		cstmt.setString(93, dm.connect_ip);
		cstmt.setString(94, dm.connect_userid);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.yadjm.ds.HD_YADJM_2018_1210_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("book_show_use_onta = [" + getBook_show_use_onta() + "]");
		System.out.println("book_show_use_etc = [" + getBook_show_use_etc() + "]");
...
String book_show_use_onta = req.getParameter("book_show_use_onta");
if( book_show_use_onta == null){
	System.out.println(this.toString+" : book_show_use_onta is null" );
}else{
	System.out.println(this.toString+" : book_show_use_onta is "+book_show_use_onta );
}
String book_show_use_etc = req.getParameter("book_show_use_etc");
if( book_show_use_etc == null){
	System.out.println(this.toString+" : book_show_use_etc is null" );
}else{
	System.out.println(this.toString+" : book_show_use_etc is "+book_show_use_etc );
}
...
String book_show_use_onta = Util.checkString(req.getParameter("book_show_use_onta"));
String book_show_use_etc = Util.checkString(req.getParameter("book_show_use_etc"));
...
String book_show_use_onta = Util.Uni2Ksc(Util.checkString(req.getParameter("book_show_use_onta")));
String book_show_use_etc = Util.Uni2Ksc(Util.checkString(req.getParameter("book_show_use_etc")));
...
dm.setBook_show_use_onta(book_show_use_onta);
dm.setBook_show_use_etc(book_show_use_etc);
