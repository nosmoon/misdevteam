...
public class HD_YADJM_2014_1231_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_YADJM_2014_1231_LDM(){}
	public HD_YADJM_2014_1231_LDM(String cmpy_cd, String adjm_rvrs_yy, String emp_no, String stok_savg_type){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_YADJM_2014_1231_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_YADJM_2014_1231_LDM dm = (HD_YADJM_2014_1231_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.yadjm.ds.HD_YADJM_2014_1231_LDataSet();
	}
