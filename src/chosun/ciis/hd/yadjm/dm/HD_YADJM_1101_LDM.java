...
public class HD_YADJM_1101_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String adjm_yy;

	public HD_YADJM_1101_LDM(){}
	public HD_YADJM_1101_LDM(String cmpy_cd, String adjm_yy){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_YADJM_1101_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_YADJM_1101_LDM dm = (HD_YADJM_1101_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.yadjm.ds.HD_YADJM_1101_LDataSet();
	}
