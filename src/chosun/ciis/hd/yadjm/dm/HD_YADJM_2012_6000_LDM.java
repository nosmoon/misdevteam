...
public class HD_YADJM_2012_6000_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String emp_no;
	public String adjm_rvrs_yy;

	public HD_YADJM_2012_6000_LDM(){}
	public HD_YADJM_2012_6000_LDM(String cmpy_cd, String emp_no, String adjm_rvrs_yy){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_YADJM_2012_6000_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_YADJM_2012_6000_LDM dm = (HD_YADJM_2012_6000_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.yadjm.ds.HD_YADJM_2012_6000_LDataSet();
	}
