...
public class HD_YADJM_2013_1234_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String adjm_rvrs_yy;
	public String emp_no;

	public HD_YADJM_2013_1234_LDM(){}
	public HD_YADJM_2013_1234_LDM(String cmpy_cd, String adjm_rvrs_yy, String emp_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_YADJM_2013_1234_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_YADJM_2013_1234_LDM dm = (HD_YADJM_2013_1234_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.yadjm.ds.HD_YADJM_2013_1234_LDataSet();
	}
