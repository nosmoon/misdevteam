...
public class HD_YADJM_106001_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_YADJM_106001_ADM(){}
	public HD_YADJM_106001_ADM(String cmpy_cd, String emp_no, String adjm_rvrs_yy, String end_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_YADJM_106001_A(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_YADJM_106001_ADM dm = (HD_YADJM_106001_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_YADJM_106001_ADataSet();
	}
