...
public class HD_YADJM_5400_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_YADJM_5400_LDM(){}
	public HD_YADJM_5400_LDM(String cmpy_cd, String adjm_rvrs_yy, String emp_no, String seq){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_YADJM_5400_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_YADJM_5400_LDM dm = (HD_YADJM_5400_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.yadjm.ds.HD_YADJM_5400_LDataSet();
	}
