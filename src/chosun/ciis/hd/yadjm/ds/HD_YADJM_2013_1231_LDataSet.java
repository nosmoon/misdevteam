...
public class HD_YADJM_2013_1231_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_YADJM_2013_1231_LDataSet(){}
	public HD_YADJM_2013_1231_LDataSet(String errcode, String errmsg){
  ...
  System.out.print("가각");
		...
		while(rset0.next()){
			HD_YADJM_2013_1231_LCURLISTRecord rec = new HD_YADJM_2013_1231_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_YADJM_2013_1231_LCURLISTRecord curlistRec = (HD_YADJM_2013_1231_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
