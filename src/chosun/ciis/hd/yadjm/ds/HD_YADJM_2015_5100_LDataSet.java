...
public class HD_YADJM_2015_5100_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_YADJM_2015_5100_LDataSet(){}
	public HD_YADJM_2015_5100_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_YADJM_2015_5100_LCURLISTRecord rec = new HD_YADJM_2015_5100_LCURLISTRecord();
