...
public class HD_YADJM_2016_1214_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public HD_YADJM_2016_1214_LDataSet(){}
	public HD_YADJM_2016_1214_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_YADJM_2016_1214_LCURLISTRecord rec = new HD_YADJM_2016_1214_LCURLISTRecord();
		...
		while(rset1.next()){
			HD_YADJM_2016_1214_LCURLIST1Record rec = new HD_YADJM_2016_1214_LCURLIST1Record();
		...
		while(rset2.next()){
			HD_YADJM_2016_1214_LCURLIST2Record rec = new HD_YADJM_2016_1214_LCURLIST2Record();
		...
		while(rset3.next()){
			HD_YADJM_2016_1214_LCURLIST3Record rec = new HD_YADJM_2016_1214_LCURLIST3Record();
