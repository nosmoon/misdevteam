...
public class HD_YADJM_111250_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_YADJM_111250_LDataSet(){}
	public HD_YADJM_111250_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_YADJM_111250_LCURLISTRecord rec = new HD_YADJM_111250_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_YADJM_111250_LCURLISTRecord curlistRec = (HD_YADJM_111250_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
