...
public class HD_YADJM_2016_1220_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public HD_YADJM_2016_1220_LDataSet(){}
	public HD_YADJM_2016_1220_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_YADJM_2016_1220_LCURLISTRecord rec = new HD_YADJM_2016_1220_LCURLISTRecord();
		...
		while(rset1.next()){
			HD_YADJM_2016_1220_LCURLIST1Record rec = new HD_YADJM_2016_1220_LCURLIST1Record();
		...
		while(rset2.next()){
			HD_YADJM_2016_1220_LCURLIST2Record rec = new HD_YADJM_2016_1220_LCURLIST2Record();
		...
		while(rset3.next()){
			HD_YADJM_2016_1220_LCURLIST3Record rec = new HD_YADJM_2016_1220_LCURLIST3Record();
		...
		while(rset4.next()){
			HD_YADJM_2016_1220_LCURLIST4Record rec = new HD_YADJM_2016_1220_LCURLIST4Record();
		...
		while(rset5.next()){
			HD_YADJM_2016_1220_LCURLIST5Record rec = new HD_YADJM_2016_1220_LCURLIST5Record();
			rec.befrduty_cnt = Util.checkString(rset5.getString("befrduty_cnt"));
			this.curlist5.add(rec);
		}
		ResultSet rset6 = (ResultSet) cstmt.getObject(12);
		while(rset6.next()){
			HD_YADJM_2016_1220_LCURLIST6Record rec = new HD_YADJM_2016_1220_LCURLIST6Record();
