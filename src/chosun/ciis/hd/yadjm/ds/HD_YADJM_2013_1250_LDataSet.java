...
public class HD_YADJM_2013_1250_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_YADJM_2013_1250_LDataSet(){}
	public HD_YADJM_2013_1250_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_YADJM_2013_1250_LCURLISTRecord rec = new HD_YADJM_2013_1250_LCURLISTRecord();
...
<%
	HD_YADJM_2013_1250_LDataSet ds = (HD_YADJM_2013_1250_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_YADJM_2013_1250_LCURLISTRecord curlistRec = (HD_YADJM_2013_1250_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
