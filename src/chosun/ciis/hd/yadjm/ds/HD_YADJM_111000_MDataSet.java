...
public class HD_YADJM_111000_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public String errcode;
	public String errmsg;
	public String xx_emp_no_010;
	public String xx_emp_no_020;

	public HD_YADJM_111000_MDataSet(){}
	public HD_YADJM_111000_MDataSet(String errcode, String errmsg, String xx_emp_no_010, String xx_emp_no_020){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.xx_emp_no_020 = Util.checkString(cstmt.getString(6));
	}
}/*----------------------------------------------------------------------------------------------------
Web Tier에서 DataSet 객체 관련 코드 작성시 사용하십시오.

<%
	HD_YADJM_111000_MDataSet ds = (HD_YADJM_111000_MDataSet)request.getAttribute("ds");
%>
...
/* 작성시간 : Tue Feb 14 18:02:46 KST 2012 */