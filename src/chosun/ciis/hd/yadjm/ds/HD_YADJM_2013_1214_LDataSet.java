...
public class HD_YADJM_2013_1214_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public HD_YADJM_2013_1214_LDataSet(){}
	public HD_YADJM_2013_1214_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_YADJM_2013_1214_LCURLISTRecord rec = new HD_YADJM_2013_1214_LCURLISTRecord();
		...
		while(rset1.next()){
			HD_YADJM_2013_1214_LCURLIST1Record rec = new HD_YADJM_2013_1214_LCURLIST1Record();
		...
		while(rset2.next()){
			HD_YADJM_2013_1214_LCURLIST2Record rec = new HD_YADJM_2013_1214_LCURLIST2Record();
		...
		while(rset3.next()){
			HD_YADJM_2013_1214_LCURLIST3Record rec = new HD_YADJM_2013_1214_LCURLIST3Record();
...
<%
	HD_YADJM_2013_1214_LDataSet ds = (HD_YADJM_2013_1214_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_YADJM_2013_1214_LCURLISTRecord curlistRec = (HD_YADJM_2013_1214_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		HD_YADJM_2013_1214_LCURLIST1Record curlist1Rec = (HD_YADJM_2013_1214_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		HD_YADJM_2013_1214_LCURLIST2Record curlist2Rec = (HD_YADJM_2013_1214_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		HD_YADJM_2013_1214_LCURLIST3Record curlist3Rec = (HD_YADJM_2013_1214_LCURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>
