...
public class HD_COST_1100_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist1 = new ArrayList();
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_COST_1100_LDataSet(){}
	public HD_COST_1100_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_COST_1100_LCURLISTRecord rec = new HD_COST_1100_LCURLISTRecord();
			...
			rec.real_fee_subj_sel_item_cd = Util.checkString(rset0.getString("real_fee_subj_sel_item_cd"));
			rec.item_seq = Util.checkString(rset0.getString("item_seq"));
			rec.real_fee_subj_sel_fee = Util.checkString(rset0.getString("real_fee_subj_sel_fee"));
			rec.subj_sel_ptcr = Util.checkString(rset0.getString("subj_sel_ptcr"));
		...
		while(rset1.next()){
			HD_COST_1100_LCURLIST1Record rec = new HD_COST_1100_LCURLIST1Record();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_COST_1100_LCURLISTRecord curlistRec = (HD_COST_1100_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		HD_COST_1100_LCURLIST1Record curlist1Rec = (HD_COST_1100_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>
...
<%= curlistRec.real_fee_subj_sel_item_cd%>
<%= curlistRec.item_seq%>
<%= curlistRec.real_fee_subj_sel_fee%>
<%= curlistRec.subj_sel_ptcr%>
<%= curlistRec.cmpy_cd%>
<%= curlistRec.emp_no%>
<%= curlistRec.occr_dt%>
<%= curlistRec.seq%>
