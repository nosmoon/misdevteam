...
public class HD_COST_2102_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_COST_2102_LDataSet(){}
	public HD_COST_2102_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_COST_2102_LCURLISTRecord rec = new HD_COST_2102_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_COST_2102_LCURLISTRecord curlistRec = (HD_COST_2102_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
