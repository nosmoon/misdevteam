...
public class HD_COST_3101_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_COST_3101_ADM(){}
	public HD_COST_3101_ADM(String cmpy_cd, String mode, String emp_no, String flnm, String duty_dt, String item_cd, String prsnt_tm, String finish_tm, String finish_dd_clsf, String cont, String pay_cost, String dept_cd, String dty_cd, String posi_cd, String seq, String occr_dt, String medi_cd, String dtl_medi_cd, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_COST_3101_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_COST_3101_ADM dm = (HD_COST_3101_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.cost.ds.HD_COST_3101_ADataSet();
	}
...
/* 작성시간 : Tue Nov 13 10:43:55 KST 2012 */