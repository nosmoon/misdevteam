...
public class HD_COST_1106_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_COST_1106_ADM(){}
	public HD_COST_1106_ADM(String cmpy_cd, String mode, String aplc_dt, String emp_no, String slip_proc_seq, String ss_emp_no, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_COST_1106_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_COST_1106_ADM dm = (HD_COST_1106_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.cost.ds.HD_COST_1106_ADataSet();
	}
...
/* 작성시간 : Tue Aug 04 13:37:35 KST 2009 */