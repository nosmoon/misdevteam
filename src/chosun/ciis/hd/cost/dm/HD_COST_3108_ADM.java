...
public class HD_COST_3108_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_COST_3108_ADM(){}
	public HD_COST_3108_ADM(String cmpy_cd, String mode, String aplc_dt, String emp_no, String slip_proc_seq, String ss_emp_no, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_COST_3108_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_COST_3108_ADM dm = (HD_COST_3108_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.cost.ds.HD_COST_3108_ADataSet();
	}
...
/* 작성시간 : Tue Nov 13 13:47:53 KST 2012 */