...
public class HD_COST_2108_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_COST_2108_ADM(){}
	public HD_COST_2108_ADM(String cmpy_cd, String mode, String aplc_dt, String emp_no, String slip_proc_seq, String ss_emp_no, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_COST_2108_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_COST_2108_ADM dm = (HD_COST_2108_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.cost.ds.HD_COST_2108_ADataSet();
	}
...
/* 작성시간 : Mon Jul 09 21:38:45 KST 2012 */