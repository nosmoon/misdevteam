...
public class HD_COST_1003_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_COST_1003_ADM(){}
	public HD_COST_1003_ADM(String cmpy_cd, String mode, String emp_no, String flnm, String subj_sel_dt, String real_fee_subj_sel_cd, String itme_seq, String real_fee_subj_sel_fee, String subj_sel_ptcr, String dept_cd, String dty_cd, String posi_cd, String seq, String occr_dt, String medi_cd, String dtl_medi_cd, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_COST_1003_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_COST_1003_ADM dm = (HD_COST_1003_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.cost.ds.HD_COST_1003_ADataSet();
	}
...
/* 작성시간 : Wed Jul 04 19:25:11 KST 2012 */