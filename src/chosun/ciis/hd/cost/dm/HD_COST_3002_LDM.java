...
public class HD_COST_3002_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_COST_3002_LDM(){}
	public HD_COST_3002_LDM(String cmpy_cd, String occr_dt, String proc_stat, String dept_cd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_COST_3002_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_COST_3002_LDM dm = (HD_COST_3002_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.cost.ds.HD_COST_3002_LDataSet();
	}
