...
public class HD_COST_1103_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_COST_1103_ADM(){}
	public HD_COST_1103_ADM(String mode, String cmpy_cd, String emp_no, String real_fee_subj_sel_fee, String subj_sel_dt, String flnm, String dept_cd, String medi_cd, String dtls_medi_cd, String slip_proc_mang_dt, String slip_proc_mang_seq, String s_mode, String tmp_crdt_amt, String titl, String incmg_pers_ipadd, String ss_emp_no){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_COST_1103_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_COST_1103_ADM dm = (HD_COST_1103_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.mode);
		cstmt.setString(4, dm.cmpy_cd);
		cstmt.setString(5, dm.emp_no);
		cstmt.setString(6, dm.real_fee_subj_sel_fee);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.cost.ds.HD_COST_1103_ADataSet();
	}
...
/* 작성시간 : Mon Jul 09 20:32:17 KST 2012 */