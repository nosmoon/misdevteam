...
public class HD_COST_1004_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_COST_1004_ADM(){}
	public HD_COST_1004_ADM(String mode, String cmpy_cd, String slip_proc_mang_dt, String slip_proc_mang_seq, String incmg_pers_ipadd, String incmg_pers){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_COST_1004_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_COST_1004_ADM dm = (HD_COST_1004_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.cost.ds.HD_COST_1004_ADataSet();
	}
...
/* 작성시간 : Tue Jul 21 14:34:13 KST 2009 */