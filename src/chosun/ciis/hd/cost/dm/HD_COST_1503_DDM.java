...
public class HD_COST_1503_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_COST_1503_DDM(){}
	public HD_COST_1503_DDM(String mode, String cmpy_cd, String slip_proc_mang_dt, String slip_proc_mang_seq, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String slip_incmg_pers, String slip_incmg_pers_ipadd, String incmg_pers_ipadd, String ss_emp_no){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_COST_1503_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_COST_1503_DDM dm = (HD_COST_1503_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.cost.ds.HD_COST_1503_DDataSet();
	}
...
/* 작성시간 : Wed May 27 14:56:31 KST 2009 */