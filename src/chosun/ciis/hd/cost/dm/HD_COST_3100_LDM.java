...
public class HD_COST_3100_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_COST_3100_LDM(){}
	public HD_COST_3100_LDM(String cmpy_cd, String occr_fr_dt, String occr_to_dt, String proc_stat, String actu_slip_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_COST_3100_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_COST_3100_LDM dm = (HD_COST_3100_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.cost.ds.HD_COST_3100_LDataSet();
	}
