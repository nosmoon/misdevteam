...
public class HD_COST_1102_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_COST_1102_LDM(){}
	public HD_COST_1102_LDM(String cmpy_cd, String occr_dt, String proc_stat, String actu_slip_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_COST_1102_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_COST_1102_LDM dm = (HD_COST_1102_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.cost.ds.HD_COST_1102_LDataSet();
	}
...
/* 작성시간 : Tue May 12 19:34:18 KST 2009 */