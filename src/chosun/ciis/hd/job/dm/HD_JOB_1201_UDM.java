...
public class HD_JOB_1201_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_JOB_1201_UDM(){}
	public HD_JOB_1201_UDM(String cmpy_cd, String mode, String send, String retu, String emp_no, String occr_dt, String seq, String incmg_pers, String emp_no_tm){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_JOB_1201_U(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_JOB_1201_UDM dm = (HD_JOB_1201_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_JOB_1201_UDataSet();
	}
