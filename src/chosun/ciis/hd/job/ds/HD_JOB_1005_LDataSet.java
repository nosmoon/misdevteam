...
public class HD_JOB_1005_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_JOB_1005_LDataSet(){}
	public HD_JOB_1005_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_JOB_1005_LCURLISTRecord rec = new HD_JOB_1005_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_JOB_1005_LCURLISTRecord curlistRec = (HD_JOB_1005_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
