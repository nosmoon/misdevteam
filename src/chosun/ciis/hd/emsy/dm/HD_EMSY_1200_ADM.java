...
public class HD_EMSY_1200_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String saly_yy;
	public String saly_no;

	public HD_EMSY_1200_ADM(){}
	public HD_EMSY_1200_ADM(String cmpy_cd, String saly_yy, String saly_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EMSY_1200_A(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EMSY_1200_ADM dm = (HD_EMSY_1200_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_EMSY_1200_ADataSet();
	}
...
/* 작성시간 : Tue Oct 12 10:57:56 KST 2010 */