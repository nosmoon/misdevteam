...
public class HD_EMSY_2008_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EMSY_2008_ADM(){}
	public HD_EMSY_2008_ADM(String cmpy_cd, String saly_yy, String saly_no, String emp_no, String stoemail, String success_yn){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EMSY_2008_A(? ,? ,? ,? ,? ,? ,?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EMSY_2008_ADM dm = (HD_EMSY_2008_ADM)bdm;
		...
		cstmt.setString(8, dm.success_yn);
	}

	public BaseDataSet createDataSetObject(){
		return new HD_EMSY_2008_ADataSet();
	}
...
/* 작성시간 : Tue Oct 12 16:06:23 KST 2010 */