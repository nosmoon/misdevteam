...
public class HD_EMSY_2002_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String saly_yy;
	public String saly_no;

	public HD_EMSY_2002_LDM(){}
	public HD_EMSY_2002_LDM(String cmpy_cd, String saly_yy, String saly_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EMSY_2002_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EMSY_2002_LDM dm = (HD_EMSY_2002_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_EMSY_2002_LDataSet();
	}
