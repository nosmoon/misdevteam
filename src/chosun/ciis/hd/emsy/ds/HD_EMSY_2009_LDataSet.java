...
public class HD_EMSY_2009_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_EMSY_2009_LDataSet(){}
	public HD_EMSY_2009_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_EMSY_2009_LCURLISTRecord rec = new HD_EMSY_2009_LCURLISTRecord();
...
<%
	HD_EMSY_2009_LDataSet ds = (HD_EMSY_2009_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_EMSY_2009_LCURLISTRecord curlistRec = (HD_EMSY_2009_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Wed Jun 10 13:55:27 KST 2015 */