...
public class HD_CORR_1300_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_CORR_1300_LDM(){}
	public HD_CORR_1300_LDM(String cmpy_cd, String fr_pay_yymm, String to_pay_yymm, String natn_cd, String duty_area){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_CORR_1300_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_CORR_1300_LDM dm = (HD_CORR_1300_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.corr.ds.HD_CORR_1300_LDataSet();
	}
