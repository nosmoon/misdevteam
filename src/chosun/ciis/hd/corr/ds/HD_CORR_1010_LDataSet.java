...
public class HD_CORR_1010_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_CORR_1010_LDataSet(){}
	public HD_CORR_1010_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_CORR_1010_LCURLISTRecord rec = new HD_CORR_1010_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_CORR_1010_LCURLISTRecord curlistRec = (HD_CORR_1010_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
