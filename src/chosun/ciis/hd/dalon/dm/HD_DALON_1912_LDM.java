...
public class HD_DALON_1912_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DALON_1912_LDM(){}
	public HD_DALON_1912_LDM(String cmpy_cd, String duty_dt_fm, String duty_dt_to, String pay_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_1912_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_1912_LDM dm = (HD_DALON_1912_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_DALON_1912_LDataSet();
	}
