...
public class HD_DALON_1202_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DALON_1202_ADM(){}
	public HD_DALON_1202_ADM(String mode, String cmpy_cd, String aply_basi_dt, String seq, String new_apst_dt, String dd_subj_sel_fee_clsf, String pay_amt, String remk, String connect_ip, String connect_userid){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_1202_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_1202_ADM dm = (HD_DALON_1202_ADM)bdm;
		...
		cstmt.setString(8, dm.dd_subj_sel_fee_clsf);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.dalon.ds.HD_DALON_1202_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("dd_subj_sel_fee_clsf = [" + getDd_subj_sel_fee_clsf() + "]");
...
String dd_subj_sel_fee_clsf = req.getParameter("dd_subj_sel_fee_clsf");
if( dd_subj_sel_fee_clsf == null){
	System.out.println(this.toString+" : dd_subj_sel_fee_clsf is null" );
}else{
	System.out.println(this.toString+" : dd_subj_sel_fee_clsf is "+dd_subj_sel_fee_clsf );
}
...
String dd_subj_sel_fee_clsf = Util.checkString(req.getParameter("dd_subj_sel_fee_clsf"));
...
String dd_subj_sel_fee_clsf = Util.Uni2Ksc(Util.checkString(req.getParameter("dd_subj_sel_fee_clsf")));
...
dm.setDd_subj_sel_fee_clsf(dd_subj_sel_fee_clsf);
...
/* 작성시간 : Thu May 21 20:58:08 KST 2009 */