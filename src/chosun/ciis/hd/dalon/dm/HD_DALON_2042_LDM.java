...
public class HD_DALON_2042_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DALON_2042_LDM(){}
	public HD_DALON_2042_LDM(String cmpy_cd, String search_duty_dt, String pay_dt, String search_dept_cd, String search_emp_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_2042_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_2042_LDM dm = (HD_DALON_2042_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.dalon.ds.HD_DALON_2042_LDataSet();
	}
