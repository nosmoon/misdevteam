...
public class HD_DALON_1701_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String bonsa_gbn;

	public HD_DALON_1701_LDM(){}
	public HD_DALON_1701_LDM(String cmpy_cd, String duty_dt_fm, String duty_dt_to, String dept_cd, String emp_no, String actu_slip_no, String pay_dt, String proc_clsf, String bonsa_gbn){
	...
	public void setBonsa_gbn(String bonsa_gbn){
		this.bonsa_gbn = bonsa_gbn;
	}
	...
	public String getBonsa_gbn(){
		return this.bonsa_gbn;
	}

	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_1701_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_1701_LDM dm = (HD_DALON_1701_LDM)bdm;
		...
		cstmt.setString(13, dm.bonsa_gbn);
	}

	public BaseDataSet createDataSetObject(){
		return new HD_DALON_1701_LDataSet();
	}
	...
	public void print(){
		...
		System.out.println("bonsa_gbn = [" + getBonsa_gbn() + "]");
	}
}
/*----------------------------------------------------------------------------------------------------
...
String bonsa_gbn = req.getParameter("bonsa_gbn");
if( bonsa_gbn == null){
	System.out.println(this.toString+" : bonsa_gbn is null" );
}else{
	System.out.println(this.toString+" : bonsa_gbn is "+bonsa_gbn );
}
----------------------------------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------------------------------
...
String bonsa_gbn = Util.checkString(req.getParameter("bonsa_gbn"));
----------------------------------------------------------------------------------------------------*//*----------------------------------------------------------------------------------------------------
...
String bonsa_gbn = Util.Uni2Ksc(Util.checkString(req.getParameter("bonsa_gbn")));
----------------------------------------------------------------------------------------------------*/
...
dm.setBonsa_gbn(bonsa_gbn);
----------------------------------------------------------------------------------------------------*/


/* 작성시간 : Mon May 17 14:48:11 KST 2010 */