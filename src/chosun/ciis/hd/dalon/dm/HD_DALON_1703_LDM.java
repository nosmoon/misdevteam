...
public class HD_DALON_1703_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DALON_1703_LDM(){}
	public HD_DALON_1703_LDM(String cmpy_cd, String duty_dt_fm, String duty_dt_to, String pay_dt, String bonsa_gbn){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_1703_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_1703_LDM dm = (HD_DALON_1703_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_DALON_1703_LDataSet();
	}
