...
public class HD_DALON_2043_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DALON_2043_ADM(){}
	public HD_DALON_2043_ADM(String mode, String connect_ip, String connect_userid, String cmpy_cd, String dept_cd, String emp_no, String duty_dt, String vgl_duty_dt, String prvdd_prsnt_tm, String prvdd_finish_tm, String thdd_prsnt_tm, String thdd_finish_tm, String thdd_duty_tm, String pay_dt, String pay_cost, String seq){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_2043_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_2043_ADM dm = (HD_DALON_2043_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.dalon.ds.HD_DALON_2043_ADataSet();
	}
...
/* 작성시간 : Fri Aug 31 17:57:35 KST 2018 */