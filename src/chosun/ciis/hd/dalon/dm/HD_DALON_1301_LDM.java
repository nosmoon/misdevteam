...
public class HD_DALON_1301_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String aply_basi_dt;

	public HD_DALON_1301_LDM(){}
	public HD_DALON_1301_LDM(String cmpy_cd, String aply_basi_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_1301_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_1301_LDM dm = (HD_DALON_1301_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.dalon.ds.HD_DALON_1301_LDataSet();
	}
