...
public class HD_DALON_2046_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DALON_2046_DDM(){}
	public HD_DALON_2046_DDM(String mode, String cmpy_cd, String slip_proc_mang_dt, String slip_proc_mang_seq, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String slip_incmg_pers, String slip_incmg_pers_ipadd, String incmg_pers_ipadd, String ss_emp_no){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_2046_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_2046_DDM dm = (HD_DALON_2046_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.dalon.ds.HD_DALON_2046_DDataSet();
	}
...
/* 작성시간 : Mon Jan 30 09:56:12 KST 2012 */