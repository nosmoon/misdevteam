...
public class HD_DALON_1915_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DALON_1915_LDM(){}
	public HD_DALON_1915_LDM(String cmpy_cd, String duty_dt_fm, String duty_dt_to, String pay_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_1915_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_1915_LDM dm = (HD_DALON_1915_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.dalon.ds.HD_DALON_1915_LDataSet();
	}
...
/* 작성시간 : Wed Jan 18 20:13:14 KST 2012 */