...
public class HD_DALON_1702_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DALON_1702_LDM(){}
	public HD_DALON_1702_LDM(String cmpy_cd, String duty_dt_fm, String duty_dt_to, String pay_dt, String bonsa_gbn){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_1702_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_1702_LDM dm = (HD_DALON_1702_LDM)bdm;
		...
		cstmt.setString(7, dm.bonsa_gbn);
		cstmt.registerOutParameter(8, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new HD_DALON_1702_LDataSet();
	}
...
/* 작성시간 : Mon May 17 14:02:16 KST 2010 */