...
public class HD_DALON_1703_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DALON_1703_ADM(){}
	public HD_DALON_1703_ADM(String mode, String connect_ip, String connect_userid, String cmpy_cd, String dept_cd, String emp_no, String duty_dt, String prsnt_tm, String finish_dd_clsf, String finish_tm, String cost_obj_clsf, String out_in_plac, String pay_dt, String pay_cost){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_1703_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_1703_ADM dm = (HD_DALON_1703_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.dalon.ds.HD_DALON_1703_ADataSet();
	}
...
/* 작성시간 : Tue Apr 21 14:34:37 KST 2009 */