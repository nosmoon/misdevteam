...
public class HD_DALON_1052_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DALON_1052_ADM(){}
	public HD_DALON_1052_ADM(String mode, String cmpy_cd, String seq, String prvdd_prsnt_tm_prv, String finish_dd_clsf, String prvdd_finish_tm_aft, String prvdd_finish_tm_prv, String thdd_prsnt_tm_aft, String thdd_prsnt_tm_prv, String prsnt_hody_clsf, String finish_hody_clsf, String pay_amt, String connect_ip, String connect_userid){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_1052_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_1052_ADM dm = (HD_DALON_1052_ADM)bdm;
		...
		cstmt.setString(12, dm.prsnt_hody_clsf);
		cstmt.setString(13, dm.finish_hody_clsf);
		cstmt.setString(14, dm.pay_amt);
		cstmt.setString(15, dm.connect_ip);
		cstmt.setString(16, dm.connect_userid);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.dalon.ds.HD_DALON_1052_ADataSet();
	}
...
/* 작성시간 : Wed Dec 12 14:47:26 KST 2018 */