...
public class HD_DALON_1909_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String slip_proc_seq;

	public HD_DALON_1909_DDM(){}
	public HD_DALON_1909_DDM(String cmpy_cd, String slip_proc_seq){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_1909_D(? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_1909_DDM dm = (HD_DALON_1909_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_DALON_1909_DDataSet();
	}
...
/* 작성시간 : Mon Jun 07 14:39:52 KST 2010 */