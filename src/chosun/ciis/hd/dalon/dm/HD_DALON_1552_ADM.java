...
public class HD_DALON_1552_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DALON_1552_ADM(){}
	public HD_DALON_1552_ADM(String mode, String cmpy_cd, String chk, String emp_no, String cost_obj_clsf, String occr_dt, String seq, String dept_cd, String frdt, String todt, String out_in_plac, String cost, String proc_stat, String excl_pers_clsf, String tablename, String connect_ip, String connect_userid){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_1552_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_1552_ADM dm = (HD_DALON_1552_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.dalon.ds.HD_DALON_1552_ADataSet();
	}
...
/* 작성시간 : Mon Jul 21 18:26:27 KST 2014 */