...
public class HD_DALON_1503_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DALON_1503_LDM(){}
	public HD_DALON_1503_LDM(String cmpy_cd, String occr_dt, String cost_obj_clsf, String emp_no, String dept_cd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_1503_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_1503_LDM dm = (HD_DALON_1503_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_DALON_1503_LDataSet();
	}
