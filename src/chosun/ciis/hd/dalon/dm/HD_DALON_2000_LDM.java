...
public class HD_DALON_2000_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DALON_2000_LDM(){}
	public HD_DALON_2000_LDM(String cmpy_cd, String duty_dt_fm, String duty_dt_to, String dept_cd, String emp_no, String actu_slip_no, String pay_dt, String proc_clsf, String emp_clsf){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_2000_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_2000_LDM dm = (HD_DALON_2000_LDM)bdm;
		...
		cstmt.setString(11, dm.emp_clsf);
		cstmt.registerOutParameter(12, OracleTypes.CURSOR);
		cstmt.registerOutParameter(13, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.dalon.ds.HD_DALON_2000_LDataSet();
	}
