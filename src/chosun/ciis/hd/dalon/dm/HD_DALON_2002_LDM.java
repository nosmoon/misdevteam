...
public class HD_DALON_2002_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DALON_2002_LDM(){}
	public HD_DALON_2002_LDM(String cmpy_cd, String search_duty_dt, String pay_dt, String search_emp_no, String search_dept_cd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_2002_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_2002_LDM dm = (HD_DALON_2002_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.search_duty_dt);
		cstmt.setString(5, dm.pay_dt);
		cstmt.setString(6, dm.search_emp_no);
		cstmt.setString(7, dm.search_dept_cd);
		cstmt.registerOutParameter(8, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.dalon.ds.HD_DALON_2002_LDataSet();
	}
...
/* 작성시간 : Fri Apr 24 13:31:59 KST 2009 */