...
public class HD_DALON_2047_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DALON_2047_LDM(){}
	public HD_DALON_2047_LDM(String cmpy_cd, String duty_dt_fm, String duty_dt_to, String pay_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_2047_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_2047_LDM dm = (HD_DALON_2047_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.dalon.ds.HD_DALON_2047_LDataSet();
	}
