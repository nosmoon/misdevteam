...
public class HD_DALON_2003_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DALON_2003_ADM(){}
	public HD_DALON_2003_ADM(String mode, String connect_ip, String connect_userid, String cmpy_cd, String dept_cd, String emp_no, String duty_dt, String prsnt_tm, String finish_tm, String finish_dd_clsf, String pay_dt, String pay_cost){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_2003_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_2003_ADM dm = (HD_DALON_2003_ADM)bdm;
		...
		cstmt.setString(11, dm.finish_tm);
		cstmt.setString(12, dm.finish_dd_clsf);
		cstmt.setString(13, dm.pay_dt);
		cstmt.setString(14, dm.pay_cost);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.dalon.ds.HD_DALON_2003_ADataSet();
	}
...
/* 작성시간 : Fri Apr 24 14:16:10 KST 2009 */