...
public class HD_DALON_1802_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DALON_1802_ADM(){}
	public HD_DALON_1802_ADM(String mode, String cmpy_cd, String emp_no, String duty_dt, String slip_proc_mang_dt, String slip_proc_mang_seq, String s_mode, String tmp_dr_amt, String flnm, String dept_cd, String tmp_crdt_amt, String titl, String incmg_pers_ipadd, String ss_emp_no){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DALON_1802_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DALON_1802_ADM dm = (HD_DALON_1802_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.dalon.ds.HD_DALON_1802_ADataSet();
	}
...
/* 작성시간 : Thu Aug 06 21:01:31 KST 2009 */