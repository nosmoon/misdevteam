...
public class HD_DALON_1708_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public String errcode;
	public String errmsg;
	public String xx_dept_cd;
	public String xx_dept_nm;
	public String xx_not_cost_obj_clsf;
	...
	public HD_DALON_1708_MDataSet(){}
	public HD_DALON_1708_MDataSet(String errcode, String errmsg, String xx_dept_cd, String xx_dept_nm, String xx_not_cost_obj_clsf, String xx_proc_stat_010, String xx_proc_stat_020, String xx_proc_stat_030, String xx_proc_stat_040, String xx_proc_stat_050, String xx_proc_stat_060, String xx_finish_dd_clsf_010, String xx_finish_dd_clsf_020){
		this.errcode = errcode;
		this.errmsg = errmsg;
		this.xx_dept_cd = xx_dept_cd;
		this.xx_dept_nm = xx_dept_nm;
		this.xx_not_cost_obj_clsf = xx_not_cost_obj_clsf;
	...
	public void setXx_not_cost_obj_clsf(String xx_not_cost_obj_clsf){
		this.xx_not_cost_obj_clsf = xx_not_cost_obj_clsf;
	}
	...
	public String getXx_not_cost_obj_clsf(){
		return this.xx_not_cost_obj_clsf;
	}
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.xx_not_cost_obj_clsf = Util.checkString(cstmt.getString(7));
		...
		this.xx_finish_dd_clsf_010 = Util.checkString(cstmt.getString(14));
		this.xx_finish_dd_clsf_020 = Util.checkString(cstmt.getString(15));
	}
}/*----------------------------------------------------------------------------------------------------
Web Tier에서 DataSet 객체 관련 코드 작성시 사용하십시오.

<%
	HD_DALON_1708_MDataSet ds = (HD_DALON_1708_MDataSet)request.getAttribute("ds");
%>
...
/* 작성시간 : Wed Feb 01 09:58:12 KST 2012 */