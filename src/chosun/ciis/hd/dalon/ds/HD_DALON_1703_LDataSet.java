...
public class HD_DALON_1703_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_DALON_1703_LDataSet(){}
	public HD_DALON_1703_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_DALON_1703_LCURLISTRecord rec = new HD_DALON_1703_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_DALON_1703_LCURLISTRecord curlistRec = (HD_DALON_1703_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
