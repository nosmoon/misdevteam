...
public class HD_DALON_1402_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_DALON_1402_LDataSet(){}
	public HD_DALON_1402_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_DALON_1402_LCURLISTRecord rec = new HD_DALON_1402_LCURLISTRecord();
...
<%
	HD_DALON_1402_LDataSet ds = (HD_DALON_1402_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_DALON_1402_LCURLISTRecord curlistRec = (HD_DALON_1402_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
