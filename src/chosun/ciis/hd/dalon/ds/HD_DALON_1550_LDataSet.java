...
public class HD_DALON_1550_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_DALON_1550_LDataSet(){}
	public HD_DALON_1550_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_DALON_1550_LCURLISTRecord rec = new HD_DALON_1550_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_DALON_1550_LCURLISTRecord curlistRec = (HD_DALON_1550_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
