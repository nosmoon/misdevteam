...
public class HD_DALON_1900_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist1 = new ArrayList();
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_DALON_1900_LDataSet(){}
	public HD_DALON_1900_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_DALON_1900_LCURLISTRecord rec = new HD_DALON_1900_LCURLISTRecord();
			...
			rec.vgl_duty_dt = Util.checkString(rset0.getString("vgl_duty_dt"));
			rec.prvdd_prsnt_tm = Util.checkString(rset0.getString("prvdd_prsnt_tm"));
			rec.prvdd_finish_tm = Util.checkString(rset0.getString("prvdd_finish_tm"));
			rec.thdd_prsnt_tm = Util.checkString(rset0.getString("thdd_prsnt_tm"));
			rec.thdd_finish_tm = Util.checkString(rset0.getString("thdd_finish_tm"));
			rec.thdd_duty_tm = Util.checkString(rset0.getString("thdd_duty_tm"));
		...
		while(rset1.next()){
			HD_DALON_1900_LCURLIST1Record rec = new HD_DALON_1900_LCURLIST1Record();
...
<%
	HD_DALON_1900_LDataSet ds = (HD_DALON_1900_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_DALON_1900_LCURLISTRecord curlistRec = (HD_DALON_1900_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		HD_DALON_1900_LCURLIST1Record curlist1Rec = (HD_DALON_1900_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>
...
<%= curlistRec.dty_cd%>
<%= curlistRec.posi_cd%>
<%= curlistRec.vgl_duty_dt%>
<%= curlistRec.prvdd_prsnt_tm%>
<%= curlistRec.prvdd_finish_tm%>
<%= curlistRec.thdd_prsnt_tm%>
<%= curlistRec.thdd_finish_tm%>
<%= curlistRec.thdd_duty_tm%>
<%= curlistRec.pay_dt%>
<%= curlistRec.pay_cost%>
...
/* 작성시간 : Mon Jun 01 11:38:38 KST 2015 */