...
public class HD_INSR_1100_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_INSR_1100_LDataSet(){}
	public HD_INSR_1100_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_INSR_1100_LCURLISTRecord rec = new HD_INSR_1100_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_INSR_1100_LCURLISTRecord curlistRec = (HD_INSR_1100_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
