...
public class HD_INSR_1510_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String saly;

	public HD_INSR_1510_LDM(){}
	public HD_INSR_1510_LDM(String cmpy_cd, String saly){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INSR_1510_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INSR_1510_LDM dm = (HD_INSR_1510_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.insr.ds.HD_INSR_1510_LDataSet();
	}
