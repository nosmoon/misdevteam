...
public class HD_INSR_2001_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String aply_basi_dt;

	public HD_INSR_2001_LDM(){}
	public HD_INSR_2001_LDM(String cmpy_cd, String aply_basi_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INSR_2001_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INSR_2001_LDM dm = (HD_INSR_2001_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.insr.ds.HD_INSR_2001_LDataSet();
	}
