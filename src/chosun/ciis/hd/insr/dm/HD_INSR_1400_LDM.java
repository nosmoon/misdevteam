...
public class HD_INSR_1400_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String saly_yy;

	public HD_INSR_1400_LDM(){}
	public HD_INSR_1400_LDM(String cmpy_cd, String saly_yy){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INSR_1400_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INSR_1400_LDM dm = (HD_INSR_1400_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_INSR_1400_LDataSet();
	}
...
/* 작성시간 : Mon May 18 10:02:20 KST 2009 */