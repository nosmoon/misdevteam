...
public class HD_INSR_1300_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String saly;

	public HD_INSR_1300_LDM(){}
	public HD_INSR_1300_LDM(String cmpy_cd, String saly){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INSR_1300_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INSR_1300_LDM dm = (HD_INSR_1300_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_INSR_1300_LDataSet();
	}
...
/* 작성시간 : Fri May 15 13:34:22 KST 2009 */