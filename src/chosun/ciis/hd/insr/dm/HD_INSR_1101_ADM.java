...
public class HD_INSR_1101_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_INSR_1101_ADM(){}
	public HD_INSR_1101_ADM(String cmpy_cd, String search_yyyymm, String prn, String slf_burd_amt, String incmg_pers_ipadd, String incmg_pers, String chg_pers, String flag){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INSR_1101_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INSR_1101_ADM dm = (HD_INSR_1101_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_INSR_1101_ADataSet();
	}
