...
public class HD_INSR_1102_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String search_yyyymm;

	public HD_INSR_1102_LDM(){}
	public HD_INSR_1102_LDM(String cmpy_cd, String search_yyyymm){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INSR_1102_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INSR_1102_LDM dm = (HD_INSR_1102_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_INSR_1102_LDataSet();
	}
