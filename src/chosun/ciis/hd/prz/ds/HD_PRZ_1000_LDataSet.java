...
public class HD_PRZ_1000_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_PRZ_1000_LDataSet(){}
	public HD_PRZ_1000_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_PRZ_1000_LCURLISTRecord rec = new HD_PRZ_1000_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_PRZ_1000_LCURLISTRecord curlistRec = (HD_PRZ_1000_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
