...
public class HD_PRZ_1000_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_PRZ_1000_LDM(){}
	public HD_PRZ_1000_LDM(String cmpy_cd, String emp_no, String req_pers_emp_no, String nm_korn, String dept_cd, String emp_clsf_cd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_PRZ_1000_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_PRZ_1000_LDM dm = (HD_PRZ_1000_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.emp_no);
		cstmt.setString(5, dm.req_pers_emp_no);
		cstmt.setString(6, dm.nm_korn);
		cstmt.setString(7, dm.dept_cd);
		cstmt.setString(8, dm.emp_clsf_cd);
		cstmt.registerOutParameter(9, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.prz.ds.HD_PRZ_1000_LDataSet();
	}
...
/* 작성시간 : Mon Mar 30 20:27:00 KST 2009 */