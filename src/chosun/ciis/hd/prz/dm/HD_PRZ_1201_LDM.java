...
public class HD_PRZ_1201_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_PRZ_1201_LDM(){}
	public HD_PRZ_1201_LDM(String cmpy_cd, String emp_no, String nm_korn, String dept_cd, String emp_clsf_cd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_PRZ_1201_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_PRZ_1201_LDM dm = (HD_PRZ_1201_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.prz.ds.HD_PRZ_1201_LDataSet();
	}
