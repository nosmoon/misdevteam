...
public class HD_INFO_1002_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public HD_INFO_1002_SDataSet(){}
	public HD_INFO_1002_SDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException {
		...
		if(rset0.next()){
			HD_INFO_1002_SCURLISTRecord rec = new HD_INFO_1002_SCURLISTRecord();
			
			
			image = rset0.getBinaryStream("phot");
			
			if(image != null){
				encodeimage = HD_INFO_1002_SDataSet.base64Encode(HD_INFO_1002_SDataSet.readFromStream(image));				
			}
//			byteImage = StreamUtil.readFromStream(image);
//			rec.sjsajin = StreamUtil.readFromStream(image); 
//			this.image =  rset0.getBinaryStream(0);
//			rec.sjsajin = (byte[]) rset0.getObject("sjsajin");
//			curlist.add(rec);
		}
	}
}/*----------------------------------------------------------------------------------------------------
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_INFO_1002_SCURLISTRecord curlistRec = (HD_INFO_1002_SCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
