...
public class HD_INFO_5230_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_INFO_5230_LDataSet(){}
	public HD_INFO_5230_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_INFO_5230_LCURLISTRecord rec = new HD_INFO_5230_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_INFO_5230_LCURLISTRecord curlistRec = (HD_INFO_5230_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
