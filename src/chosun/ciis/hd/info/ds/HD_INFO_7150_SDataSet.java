...
public class HD_INFO_7150_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public HD_INFO_7150_SDataSet(){}
	public HD_INFO_7150_SDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_INFO_7150_SCURLISTRecord rec = new HD_INFO_7150_SCURLISTRecord();
			phot = rset0.getBinaryStream("phot");  
			//rec.phot = Util.checkString(rset0.getString("phot"));
			//this.curlist.add(rec);
			if(phot != null){
			encodeimage_phot = HD_INFO_7150_SDataSet.base64Encode(HD_INFO_7150_SDataSet.readFromStream(phot));	
			}
		}
	}
}/*----------------------------------------------------------------------------------------------------
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_INFO_7150_SCURLISTRecord curlistRec = (HD_INFO_7150_SCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
