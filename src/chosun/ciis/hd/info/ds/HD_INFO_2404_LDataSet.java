...
public class HD_INFO_2404_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;
	
	public HD_INFO_2404_LDataSet(){}
	public HD_INFO_2404_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_INFO_2404_LCURLISTRecord rec = new HD_INFO_2404_LCURLISTRecord();
			rec.emp_no = Util.checkString(rset0.getString("emp_no"));
			in = rset0.getBinaryStream("phot");
			rec.phot = HD_INFO_2402_LDataSet.readFromStream(in);
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_INFO_2404_LCURLISTRecord curlistRec = (HD_INFO_2404_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
