...
public class HD_INFO_5241_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_INFO_5241_LDataSet(){}
	public HD_INFO_5241_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_INFO_5241_LCURLISTRecord rec = new HD_INFO_5241_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_INFO_5241_LCURLISTRecord curlistRec = (HD_INFO_5241_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Wed Jun 17 21:27:41 KST 2009 */