...
public class HD_INFO_7110_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_INFO_7110_LDataSet(){}
	public HD_INFO_7110_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_INFO_7110_LCURLISTRecord rec = new HD_INFO_7110_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_INFO_7110_LCURLISTRecord curlistRec = (HD_INFO_7110_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
