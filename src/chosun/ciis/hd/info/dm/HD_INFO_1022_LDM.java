...
public class HD_INFO_1022_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String scl_clsf;

	public HD_INFO_1022_LDM(){}
	public HD_INFO_1022_LDM(String cmpy_cd, String scl_clsf){
	...
	public String getSQL(){
		 return "{ call SP_HD_INFO_1022_L( ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INFO_1022_LDM dm = (HD_INFO_1022_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.info.ds.HD_INFO_1022_LDataSet();
	}
