...
public class HD_INFO_6010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	public String cmpy_cd;
	public String emp_no;

	public HD_INFO_6010_LDM(){}
	public HD_INFO_6010_LDM(String cmpy_cd, String emp_no){
	...
	public void setIncmg_pers_ipadd(String emp_no){
		this.emp_no = emp_no;
	}
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INFO_6010_L(? ,? ,? ,?,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INFO_6010_LDM dm = (HD_INFO_6010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.info.ds.HD_INFO_6010_LDataSet();
	}
...
/* 작성시간 : Thu Apr 07 15:59:21 KST 2016 */