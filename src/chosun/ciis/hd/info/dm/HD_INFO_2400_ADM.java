...
public class HD_INFO_2400_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_INFO_2400_ADM(){}
	public HD_INFO_2400_ADM(String cmpy_cd, String emp_no, byte[] phot, String file_size, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INFO_2400_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INFO_2400_ADM dm = (HD_INFO_2400_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.info.ds.HD_INFO_2400_ADataSet();
	}
...
/* 작성시간 : Thu Jun 04 19:00:11 KST 2009 */