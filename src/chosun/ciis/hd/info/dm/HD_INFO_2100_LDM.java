...
public class HD_INFO_2100_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String cd;

	public HD_INFO_2100_LDM(){}
	public HD_INFO_2100_LDM(String cmpy_cd, String cd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INFO_2100_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INFO_2100_LDM dm = (HD_INFO_2100_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.info.ds.HD_INFO_2100_LDataSet();
	}
