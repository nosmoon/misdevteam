...
public class HD_INFO_7110_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_INFO_7110_LDM(){}
	public HD_INFO_7110_LDM(String cmpy_cd, String supr_dept_cd, String dept_cd, String chrg_posk_cd, String flnm, String medi_cd, String thrw_pgm, String work_yn, String ss_emp_no, String chrg_posk_nm){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INFO_7110_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INFO_7110_LDM dm = (HD_INFO_7110_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.info.ds.HD_INFO_7110_LDataSet();
	}
