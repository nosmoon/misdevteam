...
public class HD_INFO_1012_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INFO_1012_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INFO_1012_ADM dm = (HD_INFO_1012_ADM)bdm;
		...
		cstmt.setString(49, dm.aprv_in_cmpy);
		cstmt.setString(50, dm.blod_cd);
		cstmt.setString(51, dm.in_cmpy_psgp_cd);
		cstmt.setString(52, dm.in_cmpy_octgr_cd);
		cstmt.setString(53, dm.in_cmpy_posk_cd);
		cstmt.setString(54, dm.cur_jobforc_cd);
		cstmt.setString(55, dm.cur_jobkind_cd);
		cstmt.setString(56, dm.cur_jobnon_cd);
		cstmt.setString(57, dm.saly_shft_bank_cd);
		cstmt.setString(58, dm.saly_shft_acct_no);
		cstmt.setString(59, dm.alon_shft_bank_cd);
		cstmt.setString(60, dm.alon_shft_acct_no);
		cstmt.setString(61, dm.encrg_amt_shft_bank_cd);
		cstmt.setString(62, dm.encrg_amt_shft_acct_no);
		cstmt.setString(63, dm.etc_shft_bank_cd);
		cstmt.setString(64, dm.etc_shft_acct_no);
		cstmt.setString(65, dm.etc_shft_chqe_pay_yn);
		cstmt.setString(66, dm.incmg_pers_ipadd);
		cstmt.setString(67, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.info.ds.HD_INFO_1012_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("aprv_in_cmpy = [" + getAprv_in_cmpy() + "]");
		...
		System.out.println("etc_shft_bank_cd = [" + getEtc_shft_bank_cd() + "]");
		System.out.println("etc_shft_acct_no = [" + getEtc_shft_acct_no() + "]");
		System.out.println("etc_shft_chqe_pay_yn = [" + getEtc_shft_chqe_pay_yn() + "]");
...
String aprv_in_cmpy = req.getParameter("aprv_in_cmpy");
if( aprv_in_cmpy == null){
	System.out.println(this.toString+" : aprv_in_cmpy is null" );
}else{
	System.out.println(this.toString+" : aprv_in_cmpy is "+aprv_in_cmpy );
}
...
String etc_shft_bank_cd = req.getParameter("etc_shft_bank_cd");
if( etc_shft_bank_cd == null){
	System.out.println(this.toString+" : etc_shft_bank_cd is null" );
}else{
	System.out.println(this.toString+" : etc_shft_bank_cd is "+etc_shft_bank_cd );
}
String etc_shft_acct_no = req.getParameter("etc_shft_acct_no");
if( etc_shft_acct_no == null){
	System.out.println(this.toString+" : etc_shft_acct_no is null" );
}else{
	System.out.println(this.toString+" : etc_shft_acct_no is "+etc_shft_acct_no );
}
String etc_shft_chqe_pay_yn = req.getParameter("etc_shft_chqe_pay_yn");
if( etc_shft_chqe_pay_yn == null){
	System.out.println(this.toString+" : etc_shft_chqe_pay_yn is null" );
}else{
	System.out.println(this.toString+" : etc_shft_chqe_pay_yn is "+etc_shft_chqe_pay_yn );
}
...
String aprv_in_cmpy = Util.checkString(req.getParameter("aprv_in_cmpy"));
...
String etc_shft_bank_cd = Util.checkString(req.getParameter("etc_shft_bank_cd"));
String etc_shft_acct_no = Util.checkString(req.getParameter("etc_shft_acct_no"));
String etc_shft_chqe_pay_yn = Util.checkString(req.getParameter("etc_shft_chqe_pay_yn"));
...
String aprv_in_cmpy = Util.Uni2Ksc(Util.checkString(req.getParameter("aprv_in_cmpy")));
...
String etc_shft_bank_cd = Util.Uni2Ksc(Util.checkString(req.getParameter("etc_shft_bank_cd")));
String etc_shft_acct_no = Util.Uni2Ksc(Util.checkString(req.getParameter("etc_shft_acct_no")));
String etc_shft_chqe_pay_yn = Util.Uni2Ksc(Util.checkString(req.getParameter("etc_shft_chqe_pay_yn")));
...
dm.setAprv_in_cmpy(aprv_in_cmpy);
...
dm.setEtc_shft_bank_cd(etc_shft_bank_cd);
dm.setEtc_shft_acct_no(etc_shft_acct_no);
dm.setEtc_shft_chqe_pay_yn(etc_shft_chqe_pay_yn);
dm.setIncmg_pers_ipadd(incmg_pers_ipadd);
dm.setIncmg_pers(incmg_pers);
----------------------------------------------------------------------------------------------------*/


/* 작성시간 : Mon Dec 18 16:02:46 KST 2017 */