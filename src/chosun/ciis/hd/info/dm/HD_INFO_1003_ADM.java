...
public class HD_INFO_1003_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_INFO_1003_ADM(){}
	public HD_INFO_1003_ADM(String cmpy_cd, String emp_clsf, String prn, String flnm, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INFO_1003_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INFO_1003_ADM dm = (HD_INFO_1003_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.emp_clsf);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.info.ds.HD_INFO_1003_ADataSet();
	}
