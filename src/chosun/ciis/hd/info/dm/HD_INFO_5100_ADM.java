...
public class HD_INFO_5100_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_INFO_5100_ADM(){}
	public HD_INFO_5100_ADM(String cmpy_cd, String emp_no, String mode, String addr_clsf_1, String zip_1_1, String zip_2_1, String addr_1, String addr_dtls_1, String tel_no_1, String fax_no_1, String ptph_no_1, String email_id_1, String addr_clsf_2, String zip_1_2, String zip_2_2, String addr_2, String addr_dtls_2, String tel_no_2, String fax_no_2, String ptph_no_2, String email_id_2, String addr_clsf_3, String forn_zip_3, String forn_addr_3, String tel_no_3, String fax_no_3, String ptph_no_3, String email_id_3, String addr_clsf_4, String forn_zip_4, String forn_addr_4, String tel_no_4, String fax_no_4, String ptph_no_4, String email_id_4, String addr_clsf_5, String tel_no_5, String cntc_rshp, String incmg_pers_ipadd, String incmg_pers){
	...
	public void setEmail_id_4(String email_id_4){
		this.email_id_4 = email_id_4;
	}
	...
	public String getEmail_id_4(){
		return this.email_id_4;
	}
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INFO_5100_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INFO_5100_ADM dm = (HD_INFO_5100_ADM)bdm;
		...
		cstmt.setString(12, dm.fax_no_1);
		cstmt.setString(13, dm.ptph_no_1);
		cstmt.setString(14, dm.email_id_1);
		cstmt.setString(15, dm.addr_clsf_2);
		cstmt.setString(16, dm.zip_1_2);
		cstmt.setString(17, dm.zip_2_2);
		cstmt.setString(18, dm.addr_2);
		cstmt.setString(19, dm.addr_dtls_2);
		cstmt.setString(20, dm.tel_no_2);
		cstmt.setString(21, dm.fax_no_2);
		cstmt.setString(22, dm.ptph_no_2);
		cstmt.setString(23, dm.email_id_2);
		...
		cstmt.setString(28, dm.fax_no_3);
		cstmt.setString(29, dm.ptph_no_3);
		cstmt.setString(30, dm.email_id_3);
		cstmt.setString(31, dm.addr_clsf_4);
		cstmt.setString(32, dm.forn_zip_4);
		cstmt.setString(33, dm.forn_addr_4);
		cstmt.setString(34, dm.tel_no_4);
		cstmt.setString(35, dm.fax_no_4);
		cstmt.setString(36, dm.ptph_no_4);
		cstmt.setString(37, dm.email_id_4);
		cstmt.setString(38, dm.addr_clsf_5);
		cstmt.setString(39, dm.tel_no_5);
		cstmt.setString(40, dm.cntc_rshp);
		cstmt.setString(41, dm.incmg_pers_ipadd);
		cstmt.setString(42, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.info.ds.HD_INFO_5100_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("email_id_1 = [" + getEmail_id_1() + "]");
		...
		System.out.println("email_id_3 = [" + getEmail_id_3() + "]");
		...
		System.out.println("email_id_4 = [" + getEmail_id_4() + "]");
...
String email_id_1 = req.getParameter("email_id_1");
if( email_id_1 == null){
	System.out.println(this.toString+" : email_id_1 is null" );
}else{
	System.out.println(this.toString+" : email_id_1 is "+email_id_1 );
}
...
String email_id_3 = req.getParameter("email_id_3");
if( email_id_3 == null){
	System.out.println(this.toString+" : email_id_3 is null" );
}else{
	System.out.println(this.toString+" : email_id_3 is "+email_id_3 );
}
...
String email_id_4 = req.getParameter("email_id_4");
if( email_id_4 == null){
	System.out.println(this.toString+" : email_id_4 is null" );
}else{
	System.out.println(this.toString+" : email_id_4 is "+email_id_4 );
}
...
String email_id_1 = Util.checkString(req.getParameter("email_id_1"));
...
String email_id_3 = Util.checkString(req.getParameter("email_id_3"));
...
String email_id_4 = Util.checkString(req.getParameter("email_id_4"));
...
String email_id_1 = Util.Uni2Ksc(Util.checkString(req.getParameter("email_id_1")));
...
String email_id_3 = Util.Uni2Ksc(Util.checkString(req.getParameter("email_id_3")));
...
String email_id_4 = Util.Uni2Ksc(Util.checkString(req.getParameter("email_id_4")));
...
/* 작성시간 : Mon Dec 29 19:45:02 KST 2014 */