...
public class HD_INFO_7206_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_INFO_7206_ADM(){}
	public HD_INFO_7206_ADM(String mode, String cmpy_cd, String pay_mm, String occr_dt, String seq, String slip_proc_mang_dt, String slip_proc_mang_seq, String mang_no, String incmg_pers_ipadd, String incmg_pers){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INFO_7206_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INFO_7206_ADM dm = (HD_INFO_7206_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.info.ds.HD_INFO_7206_ADataSet();
	}
