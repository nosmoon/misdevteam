...
public class HD_INFO_1024_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_INFO_1024_ADM(){}
	public HD_INFO_1024_ADM(String mode, String cmpy_cd, String emp_no, String schir_seq, String scl_clsf, String scl_cd, String scl_nm, String enty_dt, String grdu_dt, String grdu_clsf, String schir_cd, String majr_clsf_1, String majr_cd_1, String majr_nm_1, String majr_clsf_2, String majr_cd_2, String majr_nm_2, String majr_clsf_3, String majr_cd_3, String majr_nm_3, String sclgg_kind_cd, String plcw_cd, String natn_cd, String incmg_pers, String incmg_pers_ipadd){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INFO_1024_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INFO_1024_ADM dm = (HD_INFO_1024_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.info.ds.HD_INFO_1024_ADataSet();
	}
...
/* 작성시간 : Wed Mar 11 11:00:27 KST 2009 */