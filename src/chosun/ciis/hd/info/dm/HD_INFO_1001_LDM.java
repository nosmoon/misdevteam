...
public class HD_INFO_1001_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_INFO_1001_LDM(){}
	public HD_INFO_1001_LDM(String cmpy_cd, String emp_no, String nm_korn, String prn){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INFO_1001_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INFO_1001_LDM dm = (HD_INFO_1001_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.info.ds.HD_INFO_1001_LDataSet();
	}
