...
public class HD_INFO_3020_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_INFO_3020_ADM(){}
	public HD_INFO_3020_ADM(String mode, String cmpy_cd, String emp_no, String info_clsf, String cont, String incmg_pers_ipadd, String incmg_pers){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INFO_3020_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INFO_3020_ADM dm = (HD_INFO_3020_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.info.ds.HD_INFO_3020_ADataSet();
	}
