...
public class HD_INFO_2401_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_INFO_2401_LDM(){}
	public HD_INFO_2401_LDM(String cmpy_cd, String dept_cd_fr, String dept_cd_to, String emp_no_fr, String emp_no_to){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INFO_2401_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INFO_2401_LDM dm = (HD_INFO_2401_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.info.ds.HD_INFO_2401_LDataSet();
	}
