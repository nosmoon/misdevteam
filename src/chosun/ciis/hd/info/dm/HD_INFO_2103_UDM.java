...
public class HD_INFO_2103_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_INFO_2103_UDM(){}
	public HD_INFO_2103_UDM(String cmpy_cd, String emp_no, String flnm_engl, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INFO_2103_U(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INFO_2103_UDM dm = (HD_INFO_2103_UDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.emp_no);
		cstmt.setString(5, dm.flnm_engl);
		cstmt.setString(6, dm.incmg_pers_ipadd);
		cstmt.setString(7, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.info.ds.HD_INFO_2103_UDataSet();
	}
...
/* 작성시간 : Fri Jul 03 09:43:15 KST 2009 */