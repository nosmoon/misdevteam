...
public class HD_INFO_5252_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_INFO_5252_LDM(){}
	public HD_INFO_5252_LDM(String cmpy_cd, String emp_no, String carr_seq, String occr_dt_fr, String occr_dt_to, String seq, String proc_stat){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_INFO_5252_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_INFO_5252_LDM dm = (HD_INFO_5252_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.emp_no);
		cstmt.setString(5, dm.carr_seq);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.info.ds.HD_INFO_5252_LDataSet();
	}
