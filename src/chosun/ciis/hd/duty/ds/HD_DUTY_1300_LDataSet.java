...
public class HD_DUTY_1300_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist1 = new ArrayList();
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_DUTY_1300_LDataSet(){}
	public HD_DUTY_1300_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_DUTY_1300_LCURLISTRecord rec = new HD_DUTY_1300_LCURLISTRecord();
		...
		while(rset1.next()){
			HD_DUTY_1300_LCURLIST1Record rec = new HD_DUTY_1300_LCURLIST1Record();
...
<%
	HD_DUTY_1300_LDataSet ds = (HD_DUTY_1300_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_DUTY_1300_LCURLISTRecord curlistRec = (HD_DUTY_1300_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		HD_DUTY_1300_LCURLIST1Record curlist1Rec = (HD_DUTY_1300_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Thu Dec 03 12:49:52 KST 2009 */