...
public class HD_DUTY_1106_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DUTY_1106_ADM(){}
	public HD_DUTY_1106_ADM(String mode, String cmpy_cd, String emp_no, String duty_dt, String incmg_pers_ipadd, String incmg_pers){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DUTY_1106_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DUTY_1106_ADM dm = (HD_DUTY_1106_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.duty.ds.HD_DUTY_1106_ADataSet();
	}
