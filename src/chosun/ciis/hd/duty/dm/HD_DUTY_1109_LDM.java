...
public class HD_DUTY_1109_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String emp_no;
	public String duty_dt;

	public HD_DUTY_1109_LDM(){}
	public HD_DUTY_1109_LDM(String cmpy_cd, String emp_no, String duty_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DUTY_1109_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DUTY_1109_LDM dm = (HD_DUTY_1109_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.duty.ds.HD_DUTY_1109_LDataSet();
	}
