...
public class HD_DUTY_1300_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DUTY_1300_LDM(){}
	public HD_DUTY_1300_LDM(String cmpy_cd, String dept_cd, String emp_no, String decid_fr_tm, String decid_to_tm){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DUTY_1300_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DUTY_1300_LDM dm = (HD_DUTY_1300_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_DUTY_1300_LDataSet();
	}
