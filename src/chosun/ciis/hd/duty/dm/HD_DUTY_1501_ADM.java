...
public class HD_DUTY_1501_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DUTY_1501_ADM(){}
	public HD_DUTY_1501_ADM(String cmpy_cd, String emp_no, String search_dt, String last_dt, String dept_cd, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DUTY_1501_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DUTY_1501_ADM dm = (HD_DUTY_1501_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.emp_no);
		cstmt.setString(5, dm.search_dt);
		cstmt.setString(6, dm.last_dt);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.duty.ds.HD_DUTY_1501_ADataSet();
	}
...
/* 작성시간 : Tue Mar 31 18:59:37 KST 2009 */