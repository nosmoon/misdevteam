...
public class HD_DUTY_1301_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DUTY_1301_ADM(){}
	public HD_DUTY_1301_ADM(String cmpy_cd, String duty_dt, String emp_no, String send, String retu, String incmg_pers_ipadd, String incmg_pers, String emp_no_tm, String ep_seq, String aprv_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DUTY_1301_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DUTY_1301_ADM dm = (HD_DUTY_1301_ADM)bdm;
		...
		cstmt.setString(12, dm.aprv_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.duty.ds.HD_DUTY_1301_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("aprv_pers = [" + getAprv_pers() + "]");
	}
}
/*----------------------------------------------------------------------------------------------------
...
String aprv_pers = req.getParameter("aprv_pers");
if( aprv_pers == null){
	System.out.println(this.toString+" : aprv_pers is null" );
}else{
	System.out.println(this.toString+" : aprv_pers is "+aprv_pers );
}
----------------------------------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------------------------------
...
String aprv_pers = Util.checkString(req.getParameter("aprv_pers"));
----------------------------------------------------------------------------------------------------*//*----------------------------------------------------------------------------------------------------
...
String aprv_pers = Util.Uni2Ksc(Util.checkString(req.getParameter("aprv_pers")));
----------------------------------------------------------------------------------------------------*/
...
dm.setEp_seq(ep_seq);
dm.setAprv_pers(aprv_pers);
----------------------------------------------------------------------------------------------------*/


/* 작성시간 : Fri Nov 02 10:37:43 KST 2018 */