...
public class HD_DUTY_WORK_1003_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String emp_no;
	public String duty_dt;

	public HD_DUTY_WORK_1003_DDM(){}
	public HD_DUTY_WORK_1003_DDM(String cmpy_cd, String emp_no, String duty_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DUTY_WORK_1003_D(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DUTY_WORK_1003_DDM dm = (HD_DUTY_WORK_1003_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.duty.ds.HD_DUTY_WORK_1003_DDataSet();
	}
...
/* 작성시간 : Wed Jul 04 15:22:30 KST 2018 */