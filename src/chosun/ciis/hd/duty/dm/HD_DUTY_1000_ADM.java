...
public class HD_DUTY_1000_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DUTY_1000_ADM(){}
	public HD_DUTY_1000_ADM(String cmpy_cd, String clndr_dt, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DUTY_1000_A(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DUTY_1000_ADM dm = (HD_DUTY_1000_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.duty.ds.HD_DUTY_1000_ADataSet();
	}
...
/* 작성시간 : Wed Mar 18 16:15:17 KST 2009 */