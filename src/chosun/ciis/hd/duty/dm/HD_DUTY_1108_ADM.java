...
public class HD_DUTY_1108_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DUTY_1108_ADM(){}
	public HD_DUTY_1108_ADM(String cmpy_cd, String emp_no, String duty_dt, String prsnt_tm, String finish_dd_clsf, String finish_tm, String hody_clsf, String app_emp_no, String incmg_pers_ipadd, String incmg_pers, String alvc_plan_dt, String alvc_plan_resn, String addm_rest_minute){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DUTY_1108_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DUTY_1108_ADM dm = (HD_DUTY_1108_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.duty.ds.HD_DUTY_1108_ADataSet();
	}
...
/* 작성시간 : Mon Jun 25 19:43:49 KST 2018 */