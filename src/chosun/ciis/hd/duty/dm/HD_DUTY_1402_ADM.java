...
public class HD_DUTY_1402_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DUTY_1402_ADM(){}
	public HD_DUTY_1402_ADM(String cmpy_cd, String duty_dt, String emp_no, String save, String alon_pay_mm, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DUTY_1402_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DUTY_1402_ADM dm = (HD_DUTY_1402_ADM)bdm;
		...
		cstmt.setString(7, dm.alon_pay_mm);
		cstmt.setString(8, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.duty.ds.HD_DUTY_1402_ADataSet();
	}
...
/* 작성시간 : Tue Mar 24 15:39:26 KST 2009 */