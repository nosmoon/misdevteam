...
public class HD_DDEMP_1005_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DDEMP_1005_ADM(){}
	public HD_DDEMP_1005_ADM(String mode, String cmpy_cd, String duty_yymm, String occr_dt, String seq, String slip_proc_mang_dt, String slip_proc_mang_seq, String mang_no, String incmg_pers_ipadd, String incmg_pers){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DDEMP_1005_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DDEMP_1005_ADM dm = (HD_DDEMP_1005_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.ddemp.ds.HD_DDEMP_1005_ADataSet();
	}
