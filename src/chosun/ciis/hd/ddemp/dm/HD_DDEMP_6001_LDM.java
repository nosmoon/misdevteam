...
public class HD_DDEMP_6001_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	
	public String cmpy_cd;
	public String prn;

	public HD_DDEMP_6001_LDM(){}
	public HD_DDEMP_6001_LDM(String cmpy_cd, String prn){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DDEMP_6001_L(? ,? ,? ,?, ? ) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DDEMP_6001_LDM dm = (HD_DDEMP_6001_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.ddemp.ds.HD_DDEMP_6001_LDataSet();
	}
