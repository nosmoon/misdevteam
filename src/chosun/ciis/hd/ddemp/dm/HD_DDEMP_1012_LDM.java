...
public class HD_DDEMP_1012_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	
	public String cmpy_cd;
	public String ern;
	public String dlco_nm;

	public HD_DDEMP_1012_LDM(){}
	public HD_DDEMP_1012_LDM(String ern, String dlco_nm){
		this.ern = cmpy_cd;
		this.ern = ern;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DDEMP_1012_L(? ,? ,? ,? ,?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DDEMP_1012_LDM dm = (HD_DDEMP_1012_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.ddemp.ds.HD_DDEMP_1012_LDataSet();
	}
