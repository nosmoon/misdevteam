...
public class HD_DDEMP_1000_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	
	public String cmpy_cd;
	public String ern;
	public String dlco_nm;

	public HD_DDEMP_1000_LDM(){}
	public HD_DDEMP_1000_LDM(String ern, String dlco_nm){
		this.ern = cmpy_cd;
		this.ern = ern;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DDEMP_1000_L(? ,? ,? ,? ,?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DDEMP_1000_LDM dm = (HD_DDEMP_1000_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.ddemp.ds.HD_DDEMP_1000_LDataSet();
	}
