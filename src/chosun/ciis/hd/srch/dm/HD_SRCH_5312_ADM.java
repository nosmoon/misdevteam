...
public class HD_SRCH_5312_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SRCH_5312_ADM(){}
	public HD_SRCH_5312_ADM(String cmpy_cd, String basi_dt, String head_clsf_00_01, String head_clsf_01_01, String head_clsf_01_02, String gridtitle, String clas_clsf1, String clas_clsf2, String prv_mm_amt, String base_mm_amt, String prvmm_cmpr, String remk, String mode, String text_tag, String incmg_pers, String chg_pers){
	...
	public void setClsf_nm1(String clas_clsf1){
		this.clas_clsf1 = clas_clsf1;
	}

	public void setClsf_nm2(String clas_clsf2){
		this.clas_clsf2 = clas_clsf2;
	}
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SRCH_5312_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SRCH_5312_ADM dm = (HD_SRCH_5312_ADM)bdm;
		...
		cstmt.setString(16, dm.mode);
		cstmt.setString(17, dm.text_tag);
		cstmt.setString(18, dm.incmg_pers);
		cstmt.setString(19, dm.chg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.srch.ds.HD_SRCH_5312_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("clsf_nm1 = [" + getClas_clsf1() + "]");
		System.out.println("clsf_nm2 = [" + getClas_clsf2() + "]");
...
String clsf_nm1 = req.getParameter("clsf_nm1");
if( clsf_nm1 == null){
	System.out.println(this.toString+" : clsf_nm1 is null" );
}else{
	System.out.println(this.toString+" : clsf_nm1 is "+clsf_nm1 );
}
String clsf_nm2 = req.getParameter("clsf_nm2");
if( clsf_nm2 == null){
	System.out.println(this.toString+" : clsf_nm2 is null" );
}else{
	System.out.println(this.toString+" : clsf_nm2 is "+clsf_nm2 );
}
...
String clsf_nm1 = Util.checkString(req.getParameter("clsf_nm1"));
String clsf_nm2 = Util.checkString(req.getParameter("clsf_nm2"));
...
String clsf_nm1 = Util.Uni2Ksc(Util.checkString(req.getParameter("clsf_nm1")));
String clsf_nm2 = Util.Uni2Ksc(Util.checkString(req.getParameter("clsf_nm2")));
...
dm.setClsf_nm1(clsf_nm1);
dm.setClsf_nm2(clsf_nm2);
...
/* 작성시간 : Thu Oct 18 16:24:17 KST 2018 */