...
public class HD_SRCH_1400_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String pick_st_dt;
	public String pick_et_dt;

	public HD_SRCH_1400_LDM(){}
	public HD_SRCH_1400_LDM(String cmpy_cd, String pick_st_dt, String pick_et_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SRCH_1400_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SRCH_1400_LDM dm = (HD_SRCH_1400_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.srch.ds.HD_SRCH_1400_LDataSet();
	}
