...
public class HD_SRCH_5321_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String basi_dt;

	public HD_SRCH_5321_LDM(){}
	public HD_SRCH_5321_LDM(String cmpy_cd, String basi_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SRCH_5321_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SRCH_5321_LDM dm = (HD_SRCH_5321_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.srch.ds.HD_SRCH_5321_LDataSet();
	}
