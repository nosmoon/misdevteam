...
public class HD_SRCH_1300_100_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SRCH_1300_100_LDM(){}
	public HD_SRCH_1300_100_LDM(String emp_no, String cmpy_cd, String st_j_dt, String et_j_dt){
		this.emp_no = emp_no;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SRCH_1300_100_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SRCH_1300_100_LDM dm = (HD_SRCH_1300_100_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.srch.ds.HD_SRCH_1300_100_LDataSet();
	}
