...
public class HD_SRCH_1030_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SRCH_1030_LDM(){}
	public HD_SRCH_1030_LDM(String emp_no, String cmpy_cd, String in_cmpy_dt, String dept_cd, String emp_clsf, String cur_job_cd, String dty_cd, String posi_cd, String cmpy_ck){
		this.emp_no = emp_no;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SRCH_1030_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SRCH_1030_LDM dm = (HD_SRCH_1030_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_SRCH_1030_LDataSet();
	}
