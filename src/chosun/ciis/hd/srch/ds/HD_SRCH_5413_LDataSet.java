...
public class HD_SRCH_5413_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist1 = new ArrayList();
	public String errcode;
	public String errmsg;
	public String tag1;

	public HD_SRCH_5413_LDataSet(){}
	public HD_SRCH_5413_LDataSet(String errcode, String errmsg, String tag1){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_SRCH_5413_LCURLIST1Record rec = new HD_SRCH_5413_LCURLIST1Record();
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		HD_SRCH_5413_LCURLIST1Record curlist1Rec = (HD_SRCH_5413_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>
