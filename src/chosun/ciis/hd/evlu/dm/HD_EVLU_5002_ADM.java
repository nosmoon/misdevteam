...
public class HD_EVLU_5002_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_5002_ADM(){}
	public HD_EVLU_5002_ADM(String cmpy_cd, String evlu_yy, String tms_clsf, String evlu_obj_frdt, String evlu_obj_todt, String remk, String incmg_pers_ipadd, String incmg_pers, String chg_pers, String flag){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_5002_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_5002_ADM dm = (HD_EVLU_5002_ADM)bdm;
		...
		cstmt.setString(7, dm.evlu_obj_frdt);
		cstmt.setString(8, dm.evlu_obj_todt);
	...
	public BaseDataSet createDataSetObject(){
		return new HD_EVLU_5002_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("evlu_obj_frdt = [" + getEvlu_obj_frdt() + "]");
		System.out.println("evlu_obj_todt = [" + getEvlu_obj_todt() + "]");
...
String evlu_obj_frdt = req.getParameter("evlu_obj_frdt");
if( evlu_obj_frdt == null){
	System.out.println(this.toString+" : evlu_obj_frdt is null" );
}else{
	System.out.println(this.toString+" : evlu_obj_frdt is "+evlu_obj_frdt );
}
String evlu_obj_todt = req.getParameter("evlu_obj_todt");
if( evlu_obj_todt == null){
	System.out.println(this.toString+" : evlu_obj_todt is null" );
}else{
	System.out.println(this.toString+" : evlu_obj_todt is "+evlu_obj_todt );
}
...
String evlu_obj_frdt = Util.checkString(req.getParameter("evlu_obj_frdt"));
String evlu_obj_todt = Util.checkString(req.getParameter("evlu_obj_todt"));
...
String evlu_obj_frdt = Util.Uni2Ksc(Util.checkString(req.getParameter("evlu_obj_frdt")));
String evlu_obj_todt = Util.Uni2Ksc(Util.checkString(req.getParameter("evlu_obj_todt")));
...
dm.setEvlu_obj_frdt(evlu_obj_frdt);
dm.setEvlu_obj_todt(evlu_obj_todt);
dm.setRemk(remk);
