...
public class HD_EVLU_2600_S_100DM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_2600_S_100DM(){}
	public HD_EVLU_2600_S_100DM(String cmpy_cd, String evlu_yy, String tms_clsf, String emp_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_2600_S_100(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_2600_S_100DM dm = (HD_EVLU_2600_S_100DM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_2600_S_100DataSet();
	}
