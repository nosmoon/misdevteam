...
public class HD_EVLU_1103_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_1103_ADM(){}
	public HD_EVLU_1103_ADM(String cmpy_cd, String evlu_yy_src, String tms_clsf_src, String evlu_yy_dest, String tms_clsf_dest, String incmg_pers_ipadd, String incmg_pers, String chg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_1103_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_1103_ADM dm = (HD_EVLU_1103_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_1103_ADataSet();
	}
