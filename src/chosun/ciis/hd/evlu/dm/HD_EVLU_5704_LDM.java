...
public class HD_EVLU_5704_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String evlu_yy;
	public String tms_clsf;
	public String evlu_grp_cd;
	public String evlu_gbn_cd;

	public HD_EVLU_5704_LDM(){}
	public HD_EVLU_5704_LDM(String cmpy_cd, String evlu_yy, String tms_clsf, String evlu_grp_cd, String evlu_gbn_cd){
		this.cmpy_cd = cmpy_cd;
		this.evlu_yy = evlu_yy;
		this.tms_clsf = tms_clsf;
		this.evlu_grp_cd = evlu_grp_cd;
		this.evlu_gbn_cd = evlu_gbn_cd;
	}
	...
	public void setEvlu_gbn_cd(String evlu_gbn_cd){
		this.evlu_gbn_cd = evlu_gbn_cd;
	}
	...
	public String getEvlu_gbn_cd(){
		return this.evlu_gbn_cd;
	}

	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_5704_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_5704_LDM dm = (HD_EVLU_5704_LDM)bdm;
		...
		cstmt.setString(7, dm.evlu_gbn_cd);
		cstmt.registerOutParameter(8, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new HD_EVLU_5704_LDataSet();
	}
	...
	public void print(){
		...
		System.out.println("evlu_gbn_cd = [" + getEvlu_gbn_cd() + "]");
	}
}
/*----------------------------------------------------------------------------------------------------
...
String evlu_gbn_cd = req.getParameter("evlu_gbn_cd");
if( evlu_gbn_cd == null){
	System.out.println(this.toString+" : evlu_gbn_cd is null" );
}else{
	System.out.println(this.toString+" : evlu_gbn_cd is "+evlu_gbn_cd );
}
----------------------------------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------------------------------
...
String evlu_gbn_cd = Util.checkString(req.getParameter("evlu_gbn_cd"));
----------------------------------------------------------------------------------------------------*//*----------------------------------------------------------------------------------------------------
...
String evlu_gbn_cd = Util.Uni2Ksc(Util.checkString(req.getParameter("evlu_gbn_cd")));
----------------------------------------------------------------------------------------------------*/
