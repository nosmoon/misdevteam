...
public class HD_EVLU_3309_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String evlu_pers_deci_grad_1tms;

	public HD_EVLU_3309_LDM(){}
	public HD_EVLU_3309_LDM(String cmpy_cd, String evlu_yy, String tms_clsf, String evlu_pers_emp_no_1tms, String evlu_grp_cd, String evlu_pers_emp_no, String evlu_pers_deci_grad_1tms){
		...
		this.evlu_pers_deci_grad_1tms = evlu_pers_deci_grad_1tms;
	}
	...
	public void setEvlu_pers_deci_grad_1tms(String evlu_pers_deci_grad_1tms){
		this.evlu_pers_deci_grad_1tms = evlu_pers_deci_grad_1tms;
	}
	...
	public String getEvlu_pers_deci_grad_1tms(){
		return this.evlu_pers_deci_grad_1tms;
	}

	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_3309_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_3309_LDM dm = (HD_EVLU_3309_LDM)bdm;
		...
		cstmt.setString(9, dm.evlu_pers_deci_grad_1tms);
		cstmt.registerOutParameter(10, Types.VARCHAR);
		cstmt.registerOutParameter(11, Types.VARCHAR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_3309_LDataSet();
	}
	...
	public void print(){
		...
		System.out.println("evlu_pers_deci_grad_1tms = [" + getEvlu_pers_deci_grad_1tms() + "]");
	}
}
/*----------------------------------------------------------------------------------------------------
...
String evlu_pers_deci_grad_1tms = req.getParameter("evlu_pers_deci_grad_1tms");
if( evlu_pers_deci_grad_1tms == null){
	System.out.println(this.toString+" : evlu_pers_deci_grad_1tms is null" );
}else{
	System.out.println(this.toString+" : evlu_pers_deci_grad_1tms is "+evlu_pers_deci_grad_1tms );
}
----------------------------------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------------------------------
...
String evlu_pers_deci_grad_1tms = Util.checkString(req.getParameter("evlu_pers_deci_grad_1tms"));
----------------------------------------------------------------------------------------------------*//*----------------------------------------------------------------------------------------------------
...
String evlu_pers_deci_grad_1tms = Util.Uni2Ksc(Util.checkString(req.getParameter("evlu_pers_deci_grad_1tms")));
----------------------------------------------------------------------------------------------------*/
...
dm.setEvlu_pers_deci_grad_1tms(evlu_pers_deci_grad_1tms);
----------------------------------------------------------------------------------------------------*/


/* 작성시간 : Fri Apr 04 10:59:02 KST 2014 */