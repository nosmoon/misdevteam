...
public class HD_EVLU_1004_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_1004_ADM(){}
	public HD_EVLU_1004_ADM(String cmpy_cd, String evlu_yy, String tms_clsf, String evlu_step_clsf, String frdt, String todt, String remk, String incmg_pers_ipadd, String incmg_pers, String chg_pers, String flag){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_1004_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_1004_ADM dm = (HD_EVLU_1004_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.evlu_yy);
		cstmt.setString(5, dm.tms_clsf);
		cstmt.setString(6, dm.evlu_step_clsf);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_1004_ADataSet();
	}
