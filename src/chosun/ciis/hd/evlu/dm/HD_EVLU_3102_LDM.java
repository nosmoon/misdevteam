...
public class HD_EVLU_3102_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_3102_LDM(){}
	public HD_EVLU_3102_LDM(String cmpy_cd, String evlu_yy, String tms_clsf, String evlu_pers_emp_no_1tms, String evlu_grp_cd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_3102_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_3102_LDM dm = (HD_EVLU_3102_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_3102_LDataSet();
	}
...
/* 작성시간 : Tue Jun 19 18:27:12 KST 2018 */