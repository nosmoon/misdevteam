...
public class HD_EVLU_6420_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String evlu_yy;
	public String tms_clsf;
	public String tgt_evlu_pers_emp_no;
	public String evlu_pers_num;

	public HD_EVLU_6420_LDM(){}
	public HD_EVLU_6420_LDM(String cmpy_cd, String evlu_yy, String tms_clsf, String tgt_evlu_pers_emp_no, String evlu_pers_num){
		this.cmpy_cd = cmpy_cd;
		this.evlu_yy = evlu_yy;
		this.tms_clsf = tms_clsf;
		this.tgt_evlu_pers_emp_no = tgt_evlu_pers_emp_no;
		this.evlu_pers_num = evlu_pers_num;
	}
	...
	public void setEvlu_pers_num(String evlu_pers_num){
		this.evlu_pers_num = evlu_pers_num;
	}
	...
	public String getEvlu_pers_num(){
		return this.evlu_pers_num;
	}

	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_6420_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_6420_LDM dm = (HD_EVLU_6420_LDM)bdm;
		...
		cstmt.setString(7, dm.evlu_pers_num);
		cstmt.registerOutParameter(8, Types.VARCHAR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_6420_LDataSet();
	}
	...
	public void print(){
		...
		System.out.println("evlu_pers_num = [" + getEvlu_pers_num() + "]");
	}
}
/*----------------------------------------------------------------------------------------------------
...
String evlu_pers_num = req.getParameter("evlu_pers_num");
if( evlu_pers_num == null){
	System.out.println(this.toString+" : evlu_pers_num is null" );
}else{
	System.out.println(this.toString+" : evlu_pers_num is "+evlu_pers_num );
}
----------------------------------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------------------------------
...
String evlu_pers_num = Util.Uni2Ksc(Util.checkString(req.getParameter("evlu_pers_num")));
----------------------------------------------------------------------------------------------------*/
