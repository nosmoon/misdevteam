...
public class HD_EVLU_3107_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_3107_UDM(){}
	public HD_EVLU_3107_UDM(String cmpy_cd, String evlu_yy, String tms_clsf, String evlu_pers_emp_no_1tms, String evlu_grp_cd, String chg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_3107_U(? ,? ,? ,? ,? ,? ,?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_3107_UDM dm = (HD_EVLU_3107_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_3107_UDataSet();
	}
...
/* 작성시간 : Wed Jun 10 10:12:54 KST 2009 */