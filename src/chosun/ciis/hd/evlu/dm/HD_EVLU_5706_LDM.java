...
public class HD_EVLU_5706_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_5706_LDM(){}
	public HD_EVLU_5706_LDM(String cmpy_cd, String evlu_yy, String tms_clsf, String nm_korn){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_5706_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_5706_LDM dm = (HD_EVLU_5706_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_EVLU_5706_LDataSet();
	}
