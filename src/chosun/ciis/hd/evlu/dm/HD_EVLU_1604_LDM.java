...
public class HD_EVLU_1604_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_1604_LDM(){}
	public HD_EVLU_1604_LDM(String cmpy_cd, String evlu_yy, String tms_clsf, String evlu_grp_cd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_1604_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_1604_LDM dm = (HD_EVLU_1604_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_1604_LDataSet();
	}
