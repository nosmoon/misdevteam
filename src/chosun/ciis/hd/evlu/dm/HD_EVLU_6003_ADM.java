...
public class HD_EVLU_6003_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String evlu_yy;
	public String tms_clsf;
	public String evlu_step;
	...
	public HD_EVLU_6003_ADM(){}
	public HD_EVLU_6003_ADM(String cmpy_cd, String evlu_yy, String tms_clsf, String evlu_step, String evlu_stat, String incmg_pers_ipadd, String incmg_pers, String chg_pers, String flag){
		this.cmpy_cd = cmpy_cd;
		this.evlu_yy = evlu_yy;
		this.tms_clsf = tms_clsf;
		this.evlu_step = evlu_step;
	...
	public void setEvlu_step(String evlu_step){
		this.evlu_step = evlu_step;
	}
	...
	public String getEvlu_step(){
		return this.evlu_step;
	}
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_6003_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_6003_ADM dm = (HD_EVLU_6003_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.evlu_yy);
		cstmt.setString(5, dm.tms_clsf);
		cstmt.setString(6, dm.evlu_step);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_6003_ADataSet();
	}
    ...
    public void print(){
        ...
        System.out.println("evlu_step = " + getEvlu_step());
...
String evlu_step = req.getParameter("evlu_step");
if( evlu_step == null){
	System.out.println(this.toString+" : evlu_step is null" );
}else{
	System.out.println(this.toString+" : evlu_step is "+evlu_step );
}
...
String evlu_step = Util.Uni2Ksc(Util.checkString(req.getParameter("evlu_step")));
...
/* 작성시간 : Mon Jun 08 20:37:01 KST 2009 */