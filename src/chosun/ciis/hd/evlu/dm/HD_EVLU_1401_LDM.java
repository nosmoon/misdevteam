...
public class HD_EVLU_1401_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_1401_LDM(){}
	public HD_EVLU_1401_LDM(String cmpy_cd, String evlu_yy, String tms_clsf, String evlu_lcls_grp_cd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_1401_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_1401_LDM dm = (HD_EVLU_1401_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_1401_LDataSet();
	}
