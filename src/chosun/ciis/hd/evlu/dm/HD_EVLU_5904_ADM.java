...
public class HD_EVLU_5904_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_5904_ADM(){}
	public HD_EVLU_5904_ADM(String cmpy_cd, String evlu_yy, String tms_clsf, String evlu_pers_emp_no, String evlu_pers_gbn, String tgt_evlu_pers_emp_no, String item_cd, String grad_cd, String scor, String evlu_opn, String incmg_pers_ipadd, String incmg_pers, String chg_pers, String flag, String tot_evlu){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_5904_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_5904_ADM dm = (HD_EVLU_5904_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_5904_ADataSet();
	}
...
/* 작성시간 : Thu Sep 24 16:20:47 KST 2015 */