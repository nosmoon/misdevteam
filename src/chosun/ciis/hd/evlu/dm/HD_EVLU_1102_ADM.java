...
public class HD_EVLU_1102_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_1102_ADM(){}
	public HD_EVLU_1102_ADM(String cmpy_cd, String evlu_yy, String tms_clsf, String dtls_item_cd, String remk, String incmg_pers_ipadd, String incmg_pers, String chg_pers, String flag){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_1102_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_1102_ADM dm = (HD_EVLU_1102_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.evlu_yy);
		cstmt.setString(5, dm.tms_clsf);
		cstmt.setString(6, dm.dtls_item_cd);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_1102_ADataSet();
	}
    ...
    public void print(){
        ...
        System.out.println("dtls_item_cd = " + getDtls_item_cd());
...
String dtls_item_cd = req.getParameter("dtls_item_cd");
if( dtls_item_cd == null){
	System.out.println(this.toString+" : dtls_item_cd is null" );
}else{
	System.out.println(this.toString+" : dtls_item_cd is "+dtls_item_cd );
}
...
String dtls_item_cd = Util.checkString(req.getParameter("dtls_item_cd"));
...
String dtls_item_cd = Util.Uni2Ksc(Util.checkString(req.getParameter("dtls_item_cd")));
...
/* 작성시간 : Thu May 14 16:07:21 KST 2009 */