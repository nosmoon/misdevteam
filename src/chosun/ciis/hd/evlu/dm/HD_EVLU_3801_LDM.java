...
public class HD_EVLU_3801_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String evlu_yy;
	public String tms_clsf;

	public HD_EVLU_3801_LDM(){}
	public HD_EVLU_3801_LDM(String cmpy_cd, String evlu_yy, String tms_clsf){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_3801_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_3801_LDM dm = (HD_EVLU_3801_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_3801_LDataSet();
	}
