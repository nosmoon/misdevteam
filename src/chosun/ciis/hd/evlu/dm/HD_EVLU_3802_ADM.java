...
public class HD_EVLU_3802_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_3802_ADM(){}
	public HD_EVLU_3802_ADM(String cmpy_cd, String evlu_yy, String tms_clsf, String evlu_grp_cd_2tms, String evlu_grp_nm_2tms, String incmg_pers_ipadd, String incmg_pers, String chg_pers, String flag){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_3802_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_3802_ADM dm = (HD_EVLU_3802_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.evlu_yy);
		cstmt.setString(5, dm.tms_clsf);
		cstmt.setString(6, dm.evlu_grp_cd_2tms);
		cstmt.setString(7, dm.evlu_grp_nm_2tms);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_3802_ADataSet();
	}
    ...
    public void print(){
        ...
        System.out.println("evlu_grp_nm_2tms = " + getEvlu_grp_nm_2tms());
...
String evlu_grp_nm_2tms = req.getParameter("evlu_grp_nm_2tms");
if( evlu_grp_nm_2tms == null){
	System.out.println(this.toString+" : evlu_grp_nm_2tms is null" );
}else{
	System.out.println(this.toString+" : evlu_grp_nm_2tms is "+evlu_grp_nm_2tms );
}
...
String evlu_grp_nm_2tms = Util.checkString(req.getParameter("evlu_grp_nm_2tms"));
...
String evlu_grp_nm_2tms = Util.Uni2Ksc(Util.checkString(req.getParameter("evlu_grp_nm_2tms")));
...
/* 작성시간 : Thu Oct 15 11:50:28 KST 2009 */