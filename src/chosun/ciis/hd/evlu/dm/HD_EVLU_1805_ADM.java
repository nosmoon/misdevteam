...
public class HD_EVLU_1805_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_1805_ADM(){}
	public HD_EVLU_1805_ADM(String cmpy_cd, String evlu_yy, String tms_clsf, String evlu_lcls_grp_cd, String evlu_grp_cd, String evlu_part_cd, String evlu_indx_cd, String act_indx_cd, String incmg_pers_ipadd, String incmg_pers, String chg_pers, String flag){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_1805_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_1805_ADM dm = (HD_EVLU_1805_ADM)bdm;
		...
		cstmt.setString(8, dm.evlu_part_cd);
		cstmt.setString(9, dm.evlu_indx_cd);
		cstmt.setString(10, dm.act_indx_cd);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_1805_ADataSet();
	}
...
/* 작성시간 : Mon May 18 20:45:02 KST 2009 */