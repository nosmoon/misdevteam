...
public class HD_EVLU_3000_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_3000_SDM(){}
	public HD_EVLU_3000_SDM(String cmpy_cd, String evlu_yy, String tms_clsf, String emp_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_3000_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_3000_SDM dm = (HD_EVLU_3000_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_3000_SDataSet();
	}
