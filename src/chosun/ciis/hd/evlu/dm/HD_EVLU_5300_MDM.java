...
public class HD_EVLU_5300_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String tms_clsf;
	public String evlu_yy;

	public HD_EVLU_5300_MDM(){}
	public HD_EVLU_5300_MDM(String cmpy_cd, String tms_clsf, String evlu_yy){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_5300_M(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_5300_MDM dm = (HD_EVLU_5300_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_EVLU_5300_MDataSet();
	}
