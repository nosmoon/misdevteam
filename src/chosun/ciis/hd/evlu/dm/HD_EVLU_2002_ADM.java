...
public class HD_EVLU_2002_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_2002_ADM(){}
	public HD_EVLU_2002_ADM(String cmpy_cd, String evlu_yy, String tms_clsf, String prz_pnsh_clsf_cd, String dtls_clsf_cd, String scor, String incmg_pers_ipadd, String incmg_pers, String chg_pers, String flag){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_2002_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_2002_ADM dm = (HD_EVLU_2002_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.evlu_yy);
		cstmt.setString(5, dm.tms_clsf);
		cstmt.setString(6, dm.prz_pnsh_clsf_cd);
		cstmt.setString(7, dm.dtls_clsf_cd);
		cstmt.setString(8, dm.scor);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_2002_ADataSet();
	}
    ...
    public void print(){
        ...
        System.out.println("prz_pnsh_clsf_cd = " + getPrz_pnsh_clsf_cd());
...
String prz_pnsh_clsf_cd = req.getParameter("prz_pnsh_clsf_cd");
if( prz_pnsh_clsf_cd == null){
	System.out.println(this.toString+" : prz_pnsh_clsf_cd is null" );
}else{
	System.out.println(this.toString+" : prz_pnsh_clsf_cd is "+prz_pnsh_clsf_cd );
}
...
String prz_pnsh_clsf_cd = Util.checkString(req.getParameter("prz_pnsh_clsf_cd"));
...
String prz_pnsh_clsf_cd = Util.Uni2Ksc(Util.checkString(req.getParameter("prz_pnsh_clsf_cd")));
...
/* 작성시간 : Mon May 18 22:37:07 KST 2009 */