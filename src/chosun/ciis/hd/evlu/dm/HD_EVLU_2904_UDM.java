...
public class HD_EVLU_2904_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_2904_UDM(){}
	public HD_EVLU_2904_UDM(String cmpy_cd, String evlu_yy, String tms_clsf, String asst_evlu_pers_emp_no, String tgt_evlu_pers_emp_no, String evlu_grad_cd, String evlu_opn, String incmg_pers_ipadd, String incmg_pers, String chg_pers, String flag){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_2904_U(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_2904_UDM dm = (HD_EVLU_2904_UDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.evlu_yy);
		cstmt.setString(5, dm.tms_clsf);
		cstmt.setString(6, dm.asst_evlu_pers_emp_no);
		cstmt.setString(7, dm.tgt_evlu_pers_emp_no);
		cstmt.setString(8, dm.evlu_grad_cd);
		cstmt.setString(9, dm.evlu_opn);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_2904_UDataSet();
	}
...
/* 작성시간 : Tue Oct 20 10:25:03 KST 2009 */