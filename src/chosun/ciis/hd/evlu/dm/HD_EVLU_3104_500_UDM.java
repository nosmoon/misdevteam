...
public class HD_EVLU_3104_500_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_3104_500_UDM(){}
	public HD_EVLU_3104_500_UDM(String cmpy_cd, String evlu_yy, String tms_clsf, String evlu_pers_emp_no_1tms, String emp_no, String busn_rslt_scor, String evlu_part_cd1, String evlu_part_cd2, String evlu_part_cd3, String evlu_part_cd4, String evlu_part_cd5, String evlu_part_cd6, String evlu_cmpt_opn_1tms, String incmg_pers_ipadd, String incmg_pers, String chg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_3104_500_U(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_3104_500_UDM dm = (HD_EVLU_3104_500_UDM)bdm;
		...
		cstmt.setString(14, dm.evlu_part_cd6);
		cstmt.setString(15, dm.evlu_cmpt_opn_1tms);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_3104_500_UDataSet();
	}
	...
	public void print(){
		...
		System.out.println("evlu_part_cd6 = [" + getEvlu_part_cd6() + "]");
...
String evlu_part_cd6 = req.getParameter("evlu_part_cd6");
if( evlu_part_cd6 == null){
	System.out.println(this.toString+" : evlu_part_cd6 is null" );
}else{
	System.out.println(this.toString+" : evlu_part_cd6 is "+evlu_part_cd6 );
}
...
String evlu_part_cd6 = Util.Uni2Ksc(Util.checkString(req.getParameter("evlu_part_cd6")));
...
/* 작성시간 : Wed Jun 20 18:37:30 KST 2018 */