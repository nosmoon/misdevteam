...
public class HD_EVLU_5602_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_5602_ADM(){}
	public HD_EVLU_5602_ADM(String cmpy_cd, String evlu_yy, String tms_clsf, String evlu_step_clsf, String rfl_ratio, String remk, String incmg_pers_ipadd, String incmg_pers, String chg_pers, String flag){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_5602_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_5602_ADM dm = (HD_EVLU_5602_ADM)bdm;
		...
		cstmt.setString(7, dm.evlu_step_clsf);
		cstmt.setString(8, dm.rfl_ratio);
	...
	public BaseDataSet createDataSetObject(){
		return new HD_EVLU_5602_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("evlu_step_clsf = [" + getEvlu_step_clsf() + "]");
		System.out.println("rfl_ratio = [" + getRfl_ratio() + "]");
...
String evlu_step_clsf = req.getParameter("evlu_step_clsf");
if( evlu_step_clsf == null){
	System.out.println(this.toString+" : evlu_step_clsf is null" );
}else{
	System.out.println(this.toString+" : evlu_step_clsf is "+evlu_step_clsf );
}
String rfl_ratio = req.getParameter("rfl_ratio");
if( rfl_ratio == null){
	System.out.println(this.toString+" : rfl_ratio is null" );
}else{
	System.out.println(this.toString+" : rfl_ratio is "+rfl_ratio );
}
...
String evlu_step_clsf = Util.checkString(req.getParameter("evlu_step_clsf"));
String rfl_ratio = Util.checkString(req.getParameter("rfl_ratio"));
...
String evlu_step_clsf = Util.Uni2Ksc(Util.checkString(req.getParameter("evlu_step_clsf")));
String rfl_ratio = Util.Uni2Ksc(Util.checkString(req.getParameter("rfl_ratio")));
...
/* 작성시간 : Fri Jun 05 10:24:31 KST 2009 */