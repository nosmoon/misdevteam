...
public class HD_EVLU_5901_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_5901_LDM(){}
	public HD_EVLU_5901_LDM(String cmpy_cd, String tms_clsf, String evlu_yy, String evlu_pers_emp_no_tms, String evlu_pers_gbn){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_5901_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_5901_LDM dm = (HD_EVLU_5901_LDM)bdm;
		...
		cstmt.setString(7, dm.evlu_pers_gbn);
		cstmt.registerOutParameter(8, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new HD_EVLU_5901_LDataSet();
	}
