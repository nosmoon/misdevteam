...
public class HD_EVLU_6204_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_6204_ADM(){}
	public HD_EVLU_6204_ADM(String cmpy_cd, String evlu_yy, String tms_clsf, String chg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_6204_A(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_6204_ADM dm = (HD_EVLU_6204_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_6204_ADataSet();
	}
...
/* 작성시간 : Mon Oct 12 15:54:37 KST 2015 */