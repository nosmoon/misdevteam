...
public class HD_EVLU_1702_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_1702_ADM(){}
	public HD_EVLU_1702_ADM(String cmpy_cd, String evlu_yy, String tms_clsf, String grad_cd, String divn_ratio, String remk, String incmg_pers_ipadd, String incmg_pers, String chg_pers, String flag){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_1702_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_1702_ADM dm = (HD_EVLU_1702_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.evlu_yy);
		cstmt.setString(5, dm.tms_clsf);
		cstmt.setString(6, dm.grad_cd);
		cstmt.setString(7, dm.divn_ratio);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_1702_ADataSet();
	}
    ...
    public void print(){
        ...
        System.out.println("divn_ratio = " + getDivn_ratio());
...
String divn_ratio = req.getParameter("divn_ratio");
if( divn_ratio == null){
	System.out.println(this.toString+" : divn_ratio is null" );
}else{
	System.out.println(this.toString+" : divn_ratio is "+divn_ratio );
}
...
String divn_ratio = Util.checkString(req.getParameter("divn_ratio"));
...
String divn_ratio = Util.Uni2Ksc(Util.checkString(req.getParameter("divn_ratio")));
...
/* 작성시간 : Mon May 18 17:17:28 KST 2009 */