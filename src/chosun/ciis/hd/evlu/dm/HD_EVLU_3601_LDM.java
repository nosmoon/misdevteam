...
public class HD_EVLU_3601_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String evlu_yy;
	public String tms_clsf;
	public String evlu_done_yn;
	public String evlu_done_stat;
	public String evlu_grp_cd;

	public HD_EVLU_3601_LDM(){}
	public HD_EVLU_3601_LDM(String cmpy_cd, String evlu_yy, String tms_clsf, String evlu_done_yn, String evlu_done_stat, String evlu_grp_cd){
		this.cmpy_cd = cmpy_cd;
		this.evlu_yy = evlu_yy;
		this.tms_clsf = tms_clsf;
		this.evlu_done_yn = evlu_done_yn;
		this.evlu_done_stat = evlu_done_stat;
	...
	public void setEvlu_done_yn(String evlu_done_yn){
		this.evlu_done_yn = evlu_done_yn;
	}

	public void setEvlu_done_stat(String evlu_done_stat){
		this.evlu_done_stat = evlu_done_stat;
	}
	...
	public String getEvlu_done_yn(){
		return this.evlu_done_yn;
	}

	public String getEvlu_done_stat(){
		return this.evlu_done_stat;
	}
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_3601_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_3601_LDM dm = (HD_EVLU_3601_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.evlu_yy);
		cstmt.setString(5, dm.tms_clsf);
		cstmt.setString(6, dm.evlu_done_yn);
		cstmt.setString(7, dm.evlu_done_stat);
		cstmt.setString(8, dm.evlu_grp_cd);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_3601_LDataSet();
	}
	...
	public void print(){
		...
		System.out.println("evlu_done_yn = [" + getEvlu_done_yn() + "]");
		System.out.println("evlu_done_stat = [" + getEvlu_done_stat() + "]");
...
String evlu_done_yn = req.getParameter("evlu_done_yn");
if( evlu_done_yn == null){
	System.out.println(this.toString+" : evlu_done_yn is null" );
}else{
	System.out.println(this.toString+" : evlu_done_yn is "+evlu_done_yn );
}
String evlu_done_stat = req.getParameter("evlu_done_stat");
if( evlu_done_stat == null){
	System.out.println(this.toString+" : evlu_done_stat is null" );
}else{
	System.out.println(this.toString+" : evlu_done_stat is "+evlu_done_stat );
}
...
String evlu_done_yn = Util.Uni2Ksc(Util.checkString(req.getParameter("evlu_done_yn")));
String evlu_done_stat = Util.Uni2Ksc(Util.checkString(req.getParameter("evlu_done_stat")));
