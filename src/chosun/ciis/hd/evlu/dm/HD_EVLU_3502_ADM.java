...
public class HD_EVLU_3502_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_3502_ADM(){}
	public HD_EVLU_3502_ADM(String cmpy_cd, String evlu_yy, String tms_clsf, String emp_no, String self_evlu_proc_stat, String asst_evlu_proc_stat, String evlu_proc_stat_1tms, String evlu_proc_stat_2tms, String incmg_pers_ipadd, String incmg_pers, String chg_pers, String flag){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_3502_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_3502_ADM dm = (HD_EVLU_3502_ADM)bdm;
		...
		cstmt.setString(7, dm.self_evlu_proc_stat);
		cstmt.setString(8, dm.asst_evlu_proc_stat);
		cstmt.setString(9, dm.evlu_proc_stat_1tms);
		cstmt.setString(10, dm.evlu_proc_stat_2tms);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_3502_ADataSet();
	}
    ...
    public void print(){
        ...
        System.out.println("evlu_proc_stat_1tms = " + getEvlu_proc_stat_1tms());
        System.out.println("evlu_proc_stat_2tms = " + getEvlu_proc_stat_2tms());
...
String evlu_proc_stat_1tms = req.getParameter("evlu_proc_stat_1tms");
if( evlu_proc_stat_1tms == null){
	System.out.println(this.toString+" : evlu_proc_stat_1tms is null" );
}else{
	System.out.println(this.toString+" : evlu_proc_stat_1tms is "+evlu_proc_stat_1tms );
}
String evlu_proc_stat_2tms = req.getParameter("evlu_proc_stat_2tms");
if( evlu_proc_stat_2tms == null){
	System.out.println(this.toString+" : evlu_proc_stat_2tms is null" );
}else{
	System.out.println(this.toString+" : evlu_proc_stat_2tms is "+evlu_proc_stat_2tms );
}
...
String evlu_proc_stat_1tms = Util.checkString(req.getParameter("evlu_proc_stat_1tms"));
String evlu_proc_stat_2tms = Util.checkString(req.getParameter("evlu_proc_stat_2tms"));
...
String evlu_proc_stat_1tms = Util.Uni2Ksc(Util.checkString(req.getParameter("evlu_proc_stat_1tms")));
String evlu_proc_stat_2tms = Util.Uni2Ksc(Util.checkString(req.getParameter("evlu_proc_stat_2tms")));
...
/* 작성시간 : Tue Jun 02 18:14:23 KST 2009 */