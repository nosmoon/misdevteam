...
public class HD_EVLU_5102_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_5102_ADM(){}
	public HD_EVLU_5102_ADM(String cmpy_cd, String evlu_yy, String tms_clsf, String dtls_item_cd, String remk, String incmg_pers_ipadd, String incmg_pers, String chg_pers, String flag){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_5102_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_5102_ADM dm = (HD_EVLU_5102_ADM)bdm;
		...
		cstmt.setString(7, dm.dtls_item_cd);
	...
	public BaseDataSet createDataSetObject(){
		return new HD_EVLU_5102_ADataSet();
	}
...
/* 작성시간 : Fri May 22 09:51:17 KST 2009 */