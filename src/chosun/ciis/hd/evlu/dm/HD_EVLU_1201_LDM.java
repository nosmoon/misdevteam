...
public class HD_EVLU_1201_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_1201_LDM(){}
	public HD_EVLU_1201_LDM(String cmpy_cd, String evlu_yy, String tms_clsf, String evlu_lcls_grp_cd, String evlu_grp_cd_2tms){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_1201_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_1201_LDM dm = (HD_EVLU_1201_LDM)bdm;
		...
		cstmt.setString(7, dm.evlu_grp_cd_2tms);
		cstmt.registerOutParameter(8, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_1201_LDataSet();
	}
