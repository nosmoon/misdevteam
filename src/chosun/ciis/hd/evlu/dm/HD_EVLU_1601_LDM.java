...
public class HD_EVLU_1601_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_1601_LDM(){}
	public HD_EVLU_1601_LDM(String cmpy_cd, String evlu_yy, String tms_clsf, String evlu_lcls_grp_cd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_1601_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_1601_LDM dm = (HD_EVLU_1601_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_1601_LDataSet();
	}
...
/* 작성시간 : Sat May 16 22:17:38 KST 2009 */