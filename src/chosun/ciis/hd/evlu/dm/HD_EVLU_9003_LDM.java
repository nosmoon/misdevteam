...
public class HD_EVLU_9003_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_9003_LDM(){}
	public HD_EVLU_9003_LDM(String cmpy_cd, String evlu_yy, String tms_clsf, String tgt_evlu_pers_emp_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_9003_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_9003_LDM dm = (HD_EVLU_9003_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_9003_LDataSet();
	}
