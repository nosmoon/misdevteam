...
public class HD_EVLU_5703_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_5703_ADM(){}
	public HD_EVLU_5703_ADM(String cmpy_cd, String evlu_yy, String tms_clsf, String evlu_grp_cd, String emp_no, String dept_cd, String obj_excl_clsf, String up_emp_no1, String up_emp_no2, String in_cmpy_dt, String incmg_pers_ipadd, String incmg_pers, String chg_pers, String flag){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_5703_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_5703_ADM dm = (HD_EVLU_5703_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_EVLU_5703_ADataSet();
	}
...
/* 작성시간 : Mon Jun 08 10:00:06 KST 2009 */