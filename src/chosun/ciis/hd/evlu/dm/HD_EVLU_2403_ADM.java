...
public class HD_EVLU_2403_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_2403_ADM(){}
	public HD_EVLU_2403_ADM(String cmpy_cd, String evlu_yy, String tms_clsf, String chg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_2403_A(? ,? ,? ,? ,?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_2403_ADM dm = (HD_EVLU_2403_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_2403_ADataSet();
	}
...
/* 작성시간 : Thu May 21 16:02:39 KST 2009 */