...
public class HD_EVLU_6002_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_6002_ADM(){}
	public HD_EVLU_6002_ADM(String cmpy_cd, String evlu_yy, String tms_clsf, String emp_no, String evlu_proc_stat_1tms, String evlu_proc_stat_2tms, String incmg_pers_ipadd, String incmg_pers, String chg_pers, String flag){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_6002_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_6002_ADM dm = (HD_EVLU_6002_ADM)bdm;
		...
		cstmt.setString(7, dm.evlu_proc_stat_1tms);
		cstmt.setString(8, dm.evlu_proc_stat_2tms);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_6002_ADataSet();
	}
...
/* 작성시간 : Mon Jun 08 20:28:11 KST 2009 */