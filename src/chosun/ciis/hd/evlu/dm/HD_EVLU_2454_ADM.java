...
public class HD_EVLU_2454_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_2454_ADM(){}
	public HD_EVLU_2454_ADM(String cmpy_cd, String evlu_yy, String tms_clsf, String emp_no, String flnm, String evlu_dp_nm, String evlu_dp_scor, String incmg_pers_ipadd, String incmg_pers, String chg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_2454_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_2454_ADM dm = (HD_EVLU_2454_ADM)bdm;
		...
		cstmt.setString(8, dm.evlu_dp_nm);
		cstmt.setString(9, dm.evlu_dp_scor);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_2454_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("evlu_dp_nm = [" + getEvlu_dp_nm() + "]");
		System.out.println("evlu_dp_scor = [" + getEvlu_dp_scor() + "]");
...
String evlu_dp_nm = req.getParameter("evlu_dp_nm");
if( evlu_dp_nm == null){
	System.out.println(this.toString+" : evlu_dp_nm is null" );
}else{
	System.out.println(this.toString+" : evlu_dp_nm is "+evlu_dp_nm );
}
String evlu_dp_scor = req.getParameter("evlu_dp_scor");
if( evlu_dp_scor == null){
	System.out.println(this.toString+" : evlu_dp_scor is null" );
}else{
	System.out.println(this.toString+" : evlu_dp_scor is "+evlu_dp_scor );
}
...
String evlu_dp_nm = Util.checkString(req.getParameter("evlu_dp_nm"));
String evlu_dp_scor = Util.checkString(req.getParameter("evlu_dp_scor"));
...
String evlu_dp_nm = Util.Uni2Ksc(Util.checkString(req.getParameter("evlu_dp_nm")));
String evlu_dp_scor = Util.Uni2Ksc(Util.checkString(req.getParameter("evlu_dp_scor")));
...
dm.setEmp_no(emp_no);
dm.setFlnm(flnm);
dm.setEvlu_dp_nm(evlu_dp_nm);
dm.setEvlu_dp_scor(evlu_dp_scor);
