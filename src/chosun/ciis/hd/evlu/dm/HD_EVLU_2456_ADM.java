...
public class HD_EVLU_2456_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EVLU_2456_ADM(){}
	public HD_EVLU_2456_ADM(String cmpy_cd, String evlu_yy, String tms_clsf, String emp_no, String evlu_grp_cd, String evlu_pers_emp_no_1tms, String evlu_pers_emp_no_2tms, String asst_evlu_pers_emp_no, String incmg_pers_ipadd, String incmg_pers, String chg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EVLU_2456_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EVLU_2456_ADM dm = (HD_EVLU_2456_ADM)bdm;
		...
		cstmt.setString(8, dm.evlu_pers_emp_no_1tms);
		cstmt.setString(9, dm.evlu_pers_emp_no_2tms);
		cstmt.setString(10, dm.asst_evlu_pers_emp_no);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.evlu.ds.HD_EVLU_2456_ADataSet();
	}
...
/* 작성시간 : Fri Nov 10 15:01:23 KST 2017 */