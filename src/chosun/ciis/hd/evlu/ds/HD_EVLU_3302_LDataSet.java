...
public class HD_EVLU_3302_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public HD_EVLU_3302_LDataSet(){}
	public HD_EVLU_3302_LDataSet(String errcode, String errmsg, String s_nops_2tms, String a_pls_nops_2tms){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_EVLU_3302_LCURLISTRecord rec = new HD_EVLU_3302_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_EVLU_3302_LCURLISTRecord curlistRec = (HD_EVLU_3302_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
