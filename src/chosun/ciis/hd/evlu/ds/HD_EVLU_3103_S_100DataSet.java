...
public class HD_EVLU_3103_S_100DataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public HD_EVLU_3103_S_100DataSet(){}
	public HD_EVLU_3103_S_100DataSet(String errcode, String errmsg, String dept_nm, String grp_nm1, String grp_nm2, String emp_no, String nm_korn, String asst_cnt, String nm_korn_1tms, String nm_korn_2tms, String evlu_cd, String spc_psdo_redu_scorcnt, String evlu_proc_stat_1tms, String evlu_proc_stat_2tms, String rfl_ratio_10, String rfl_ratio_20, String rfl_ratio_30, String rfl_ratio_40, String rfl_ratio_50, String slf_achv_desc1, String slf_achv_desc2, String asst_evlu_grad_cd, String asst_evlu_opn, String busn_rslt_scor, String evlu_part_cd1, String evlu_part_cd2, String evlu_part_cd3, String evlu_part_cd4, String evlu_part_cd5, String evlu_cmpt_opn_1tms, String cmpt_scor, String self_evlu_proc_stat, String asst_evlu_proc_stat, String asst_pnt, String rvis_scor_1tms, String evlu_prz_nm, String evlu_dp_nm, String evlu_dp_scorcnt, String asst_evlu_opn_p){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_EVLU_3103_S_100CURLIST1Record rec = new HD_EVLU_3103_S_100CURLIST1Record();
		...
		while(rset1.next()){
			HD_EVLU_3103_S_100CURLIST2Record rec = new HD_EVLU_3103_S_100CURLIST2Record();
		...
		while(rset2.next()){
			HD_EVLU_3103_S_100CURLIST3Record rec = new HD_EVLU_3103_S_100CURLIST3Record();
		...
		while(rset3.next()){
			HD_EVLU_3103_S_100CURLIST4Record rec = new HD_EVLU_3103_S_100CURLIST4Record();
		...
		while(rset4.next()){
			HD_EVLU_3103_S_100CURLIST5Record rec = new HD_EVLU_3103_S_100CURLIST5Record();
		...
		this.evlu_prz_nm = Util.checkString(cstmt.getString(45));
		this.evlu_dp_nm = Util.checkString(cstmt.getString(46));
		this.evlu_dp_scorcnt = Util.checkString(cstmt.getString(47));
		this.asst_evlu_opn_p = Util.checkString(cstmt.getString(48));
	}
}/*----------------------------------------------------------------------------------------------------
Web Tier에서 DataSet 객체 관련 코드 작성시 사용하십시오.

<%
	HD_EVLU_3103_S_100DataSet ds = (HD_EVLU_3103_S_100DataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		HD_EVLU_3103_S_100CURLIST1Record curlist1Rec = (HD_EVLU_3103_S_100CURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		HD_EVLU_3103_S_100CURLIST2Record curlist2Rec = (HD_EVLU_3103_S_100CURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		HD_EVLU_3103_S_100CURLIST3Record curlist3Rec = (HD_EVLU_3103_S_100CURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist4.size(); i++){
		HD_EVLU_3103_S_100CURLIST4Record curlist4Rec = (HD_EVLU_3103_S_100CURLIST4Record)ds.curlist4.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist5.size(); i++){
		HD_EVLU_3103_S_100CURLIST5Record curlist5Rec = (HD_EVLU_3103_S_100CURLIST5Record)ds.curlist5.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Fri Aug 05 11:12:55 KST 2016 */