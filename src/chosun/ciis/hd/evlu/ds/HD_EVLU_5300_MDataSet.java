...
public class HD_EVLU_5300_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_EVLU_5300_MDataSet(){}
	public HD_EVLU_5300_MDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_EVLU_5300_MCURLISTRecord rec = new HD_EVLU_5300_MCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_EVLU_5300_MCURLISTRecord curlistRec = (HD_EVLU_5300_MCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
