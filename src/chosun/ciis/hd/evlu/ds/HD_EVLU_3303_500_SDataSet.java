...
public class HD_EVLU_3303_500_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public HD_EVLU_3303_500_SDataSet(){}
	public HD_EVLU_3303_500_SDataSet(String errcode, String errmsg, String dept_nm, String grp_nm1, String grp_nm2, String emp_no, String nm_korn, String asst_cnt, String nm_korn_1tms, String nm_korn_2tms, String evlu_cd, String spc_psdo_redu_scorcnt, String evlu_proc_stat_1tms, String evlu_proc_stat_2tms, String rfl_ratio_10, String rfl_ratio_20, String rfl_ratio_30, String rfl_ratio_40, String rfl_ratio_50, String rfl_ratio_60, String slf_achv_desc1, String slf_achv_desc2, String asst_evlu_grad_cd, String asst_evlu_opn, String busn_rslt_scor, String evlu_part_cd1, String evlu_part_cd2, String evlu_part_cd3, String evlu_part_cd4, String evlu_part_cd5, String evlu_part_cd6, String evlu_cmpt_opn_1tms, String tmp_grad, String cmpt_scor, String self_evlu_proc_stat, String asst_evlu_proc_stat, String asst_pnt, String rvis_scor_1tms){
		...
		this.rfl_ratio_60 = rfl_ratio_60;
		...
		this.evlu_part_cd6 = evlu_part_cd6;
	...
	public void setRfl_ratio_60(String rfl_ratio_60){
		this.rfl_ratio_60 = rfl_ratio_60;
	}
	...
	public void setEvlu_part_cd6(String evlu_part_cd6){
		this.evlu_part_cd6 = evlu_part_cd6;
	}
	...
	public String getRfl_ratio_60(){
		return this.rfl_ratio_60;
	}
	...
	public String getEvlu_part_cd6(){
		return this.evlu_part_cd6;
	}
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.rfl_ratio_60 = Util.checkString(cstmt.getString(24));
		this.slf_achv_desc1 = Util.checkString(cstmt.getString(25));
		this.slf_achv_desc2 = Util.checkString(cstmt.getString(26));
		ResultSet rset0 = (ResultSet) cstmt.getObject(27);
		while(rset0.next()){
			HD_EVLU_3303_500_SCURLIST1Record rec = new HD_EVLU_3303_500_SCURLIST1Record();
			rec.cdnm = Util.checkString(rset0.getString("cdnm"));
			rec.act_indx_def = Util.checkString(rset0.getString("act_indx_def"));
			this.curlist1.add(rec);
		}
		ResultSet rset1 = (ResultSet) cstmt.getObject(28);
		while(rset1.next()){
			HD_EVLU_3303_500_SCURLIST2Record rec = new HD_EVLU_3303_500_SCURLIST2Record();
			rec.cdnm = Util.checkString(rset1.getString("cdnm"));
			rec.act_indx_def = Util.checkString(rset1.getString("act_indx_def"));
			this.curlist2.add(rec);
		}
		ResultSet rset2 = (ResultSet) cstmt.getObject(29);
		while(rset2.next()){
			HD_EVLU_3303_500_SCURLIST3Record rec = new HD_EVLU_3303_500_SCURLIST3Record();
			rec.cdnm = Util.checkString(rset2.getString("cdnm"));
			rec.act_indx_def = Util.checkString(rset2.getString("act_indx_def"));
			this.curlist3.add(rec);
		}
		ResultSet rset3 = (ResultSet) cstmt.getObject(30);
		while(rset3.next()){
			HD_EVLU_3303_500_SCURLIST4Record rec = new HD_EVLU_3303_500_SCURLIST4Record();
			rec.cdnm = Util.checkString(rset3.getString("cdnm"));
			rec.act_indx_def = Util.checkString(rset3.getString("act_indx_def"));
			this.curlist4.add(rec);
		}
		ResultSet rset4 = (ResultSet) cstmt.getObject(31);
		while(rset4.next()){
			HD_EVLU_3303_500_SCURLIST5Record rec = new HD_EVLU_3303_500_SCURLIST5Record();
			rec.cdnm = Util.checkString(rset4.getString("cdnm"));
			rec.act_indx_def = Util.checkString(rset4.getString("act_indx_def"));
			this.curlist5.add(rec);
		}
		ResultSet rset5 = (ResultSet) cstmt.getObject(32);
		while(rset5.next()){
			HD_EVLU_3303_500_SCURLIST6Record rec = new HD_EVLU_3303_500_SCURLIST6Record();
			rec.cdnm = Util.checkString(rset5.getString("cdnm"));
			rec.act_indx_def = Util.checkString(rset5.getString("act_indx_def"));
			this.curlist6.add(rec);
		}
		this.asst_evlu_grad_cd = Util.checkString(cstmt.getString(33));
		this.asst_evlu_opn = Util.checkString(cstmt.getString(34));
		this.busn_rslt_scor = Util.checkString(cstmt.getString(35));
		this.evlu_part_cd1 = Util.checkString(cstmt.getString(36));
		this.evlu_part_cd2 = Util.checkString(cstmt.getString(37));
		this.evlu_part_cd3 = Util.checkString(cstmt.getString(38));
		this.evlu_part_cd4 = Util.checkString(cstmt.getString(39));
		this.evlu_part_cd5 = Util.checkString(cstmt.getString(40));
		this.evlu_part_cd6 = Util.checkString(cstmt.getString(41));
		this.evlu_cmpt_opn_1tms = Util.checkString(cstmt.getString(42));
		this.tmp_grad = Util.checkString(cstmt.getString(43));
		this.cmpt_scor = Util.checkString(cstmt.getString(44));
		this.self_evlu_proc_stat = Util.checkString(cstmt.getString(45));
		this.asst_evlu_proc_stat = Util.checkString(cstmt.getString(46));
		this.asst_pnt = Util.checkString(cstmt.getString(47));
		this.rvis_scor_1tms = Util.checkString(cstmt.getString(48));
	}
}/*----------------------------------------------------------------------------------------------------
Web Tier에서 DataSet 객체 관련 코드 작성시 사용하십시오.

<%
	HD_EVLU_3303_500_SDataSet ds = (HD_EVLU_3303_500_SDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		HD_EVLU_3303_500_SCURLIST1Record curlist1Rec = (HD_EVLU_3303_500_SCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		HD_EVLU_3303_500_SCURLIST2Record curlist2Rec = (HD_EVLU_3303_500_SCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		HD_EVLU_3303_500_SCURLIST3Record curlist3Rec = (HD_EVLU_3303_500_SCURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist4.size(); i++){
		HD_EVLU_3303_500_SCURLIST4Record curlist4Rec = (HD_EVLU_3303_500_SCURLIST4Record)ds.curlist4.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist5.size(); i++){
		HD_EVLU_3303_500_SCURLIST5Record curlist5Rec = (HD_EVLU_3303_500_SCURLIST5Record)ds.curlist5.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist6.size(); i++){
		HD_EVLU_3303_500_SCURLIST6Record curlist6Rec = (HD_EVLU_3303_500_SCURLIST6Record)ds.curlist6.get(i);%>
HTML 코드들....
	<%}%>
