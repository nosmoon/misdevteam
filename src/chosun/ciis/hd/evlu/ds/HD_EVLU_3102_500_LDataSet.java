...
public class HD_EVLU_3102_500_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public HD_EVLU_3102_500_LDataSet(){}
	public HD_EVLU_3102_500_LDataSet(String errcode, String errmsg, String s_nops_2tms, String a_pls_nops_2tms){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_EVLU_3102_500_LCURLISTRecord rec = new HD_EVLU_3102_500_LCURLISTRecord();
...
<%
	HD_EVLU_3102_500_LDataSet ds = (HD_EVLU_3102_500_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_EVLU_3102_500_LCURLISTRecord curlistRec = (HD_EVLU_3102_500_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Wed Jun 20 14:40:58 KST 2018 */