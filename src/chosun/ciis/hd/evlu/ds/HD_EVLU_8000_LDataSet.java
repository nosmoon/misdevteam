...
public class HD_EVLU_8000_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;
	public String valid_evlu_cd;

	public HD_EVLU_8000_LDataSet(){}
	public HD_EVLU_8000_LDataSet(String errcode, String errmsg, String valid_evlu_cd){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_EVLU_8000_LCURLISTRecord rec = new HD_EVLU_8000_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_EVLU_8000_LCURLISTRecord curlistRec = (HD_EVLU_8000_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
