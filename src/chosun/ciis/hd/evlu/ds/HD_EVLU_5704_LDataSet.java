...
public class HD_EVLU_5704_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_EVLU_5704_LDataSet(){}
	public HD_EVLU_5704_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_EVLU_5704_LCURLISTRecord rec = new HD_EVLU_5704_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_EVLU_5704_LCURLISTRecord curlistRec = (HD_EVLU_5704_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
