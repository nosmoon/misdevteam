...
public class HD_EVLU_2600_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_EVLU_2600_SCURLIST1Record rec = new HD_EVLU_2600_SCURLIST1Record();
		...
		while(rset1.next()){
			HD_EVLU_2600_SCURLIST2Record rec = new HD_EVLU_2600_SCURLIST2Record();
...
<%
	HD_EVLU_2600_SDataSet ds = (HD_EVLU_2600_SDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		HD_EVLU_2600_SCURLIST1Record curlist1Rec = (HD_EVLU_2600_SCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		HD_EVLU_2600_SCURLIST2Record curlist2Rec = (HD_EVLU_2600_SCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Fri Apr 18 16:09:49 KST 2014 */