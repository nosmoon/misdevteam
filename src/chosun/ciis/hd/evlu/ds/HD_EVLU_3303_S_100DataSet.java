...
public class HD_EVLU_3303_S_100DataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public String asst_evlu_opn_p;

	public HD_EVLU_3303_S_100DataSet(){}
	public HD_EVLU_3303_S_100DataSet(String errcode, String errmsg, String dept_nm, String grp_nm1, String grp_nm2, String emp_no, String nm_korn, String asst_cnt, String nm_korn_1tms, String nm_korn_2tms, String evlu_cd, String spc_psdo_redu_scorcnt, String evlu_proc_stat_1tms, String evlu_proc_stat_2tms, String rfl_ratio_10, String rfl_ratio_20, String rfl_ratio_30, String rfl_ratio_40, String rfl_ratio_50, String slf_achv_desc1, String slf_achv_desc2, String asst_evlu_grad_cd, String asst_evlu_opn, String busn_rslt_scor, String evlu_part_cd1, String evlu_part_cd2, String evlu_part_cd3, String evlu_part_cd4, String evlu_part_cd5, String evlu_cmpt_opn_1tms, String tmp_grad, String cmpt_scor, String self_evlu_proc_stat, String asst_evlu_proc_stat, String asst_pnt, String rvis_scor_1tms, String evlu_prz_nm, String evlu_dp_nm, String evlu_dp_scorcnt, String asst_evlu_opn_p){
		...
		this.asst_evlu_opn_p = asst_evlu_opn_p;
	}
	...
	public void setAsst_evlu_opn_p(String asst_evlu_opn_p){
		this.asst_evlu_opn_p = asst_evlu_opn_p;
	}
	...
	public String getAsst_evlu_opn_p(){
		return this.asst_evlu_opn_p;
	}
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_EVLU_3303_S_100CURLIST1Record rec = new HD_EVLU_3303_S_100CURLIST1Record();
		...
		while(rset1.next()){
			HD_EVLU_3303_S_100CURLIST2Record rec = new HD_EVLU_3303_S_100CURLIST2Record();
		...
		while(rset2.next()){
			HD_EVLU_3303_S_100CURLIST3Record rec = new HD_EVLU_3303_S_100CURLIST3Record();
		...
		while(rset3.next()){
			HD_EVLU_3303_S_100CURLIST4Record rec = new HD_EVLU_3303_S_100CURLIST4Record();
		...
		while(rset4.next()){
			HD_EVLU_3303_S_100CURLIST5Record rec = new HD_EVLU_3303_S_100CURLIST5Record();
		...
		this.tmp_grad = Util.checkString(cstmt.getString(40));
		this.cmpt_scor = Util.checkString(cstmt.getString(41));
		this.self_evlu_proc_stat = Util.checkString(cstmt.getString(42));
		this.asst_evlu_proc_stat = Util.checkString(cstmt.getString(43));
		this.asst_pnt = Util.checkString(cstmt.getString(44));
		this.rvis_scor_1tms = Util.checkString(cstmt.getString(45));
		this.evlu_prz_nm = Util.checkString(cstmt.getString(46));
		this.evlu_dp_nm = Util.checkString(cstmt.getString(47));
		this.evlu_dp_scorcnt = Util.checkString(cstmt.getString(48));
		this.asst_evlu_opn_p = Util.checkString(cstmt.getString(49));
	}
}/*----------------------------------------------------------------------------------------------------
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		HD_EVLU_3303_S_100CURLIST1Record curlist1Rec = (HD_EVLU_3303_S_100CURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		HD_EVLU_3303_S_100CURLIST2Record curlist2Rec = (HD_EVLU_3303_S_100CURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		HD_EVLU_3303_S_100CURLIST3Record curlist3Rec = (HD_EVLU_3303_S_100CURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist4.size(); i++){
		HD_EVLU_3303_S_100CURLIST4Record curlist4Rec = (HD_EVLU_3303_S_100CURLIST4Record)ds.curlist4.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist5.size(); i++){
		HD_EVLU_3303_S_100CURLIST5Record curlist5Rec = (HD_EVLU_3303_S_100CURLIST5Record)ds.curlist5.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Fri Aug 05 11:13:02 KST 2016 */