...
public class HD_EVLU_5801_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public HD_EVLU_5801_LDataSet(){}
	public HD_EVLU_5801_LDataSet(String errcode, String errmsg, String pgm_id, String pgm_nm, String pgm_url, String job_clsf, String annc_link_clsf){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_EVLU_5801_LCURLISTRecord rec = new HD_EVLU_5801_LCURLISTRecord();
...
<%
	HD_EVLU_5801_LDataSet ds = (HD_EVLU_5801_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_EVLU_5801_LCURLISTRecord curlistRec = (HD_EVLU_5801_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
