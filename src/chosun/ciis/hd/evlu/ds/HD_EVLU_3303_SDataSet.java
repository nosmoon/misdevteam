...
public class HD_EVLU_3303_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public HD_EVLU_3303_SDataSet(){}
	public HD_EVLU_3303_SDataSet(String errcode, String errmsg, String dept_nm, String grp_nm1, String grp_nm2, String emp_no, String nm_korn, String asst_cnt, String nm_korn_1tms, String nm_korn_2tms, String evlu_cd, String spc_psdo_redu_scorcnt, String evlu_proc_stat_1tms, String evlu_proc_stat_2tms, String rfl_ratio_10, String rfl_ratio_20, String rfl_ratio_30, String rfl_ratio_40, String rfl_ratio_50, String slf_achv_desc1, String slf_achv_desc2, String asst_evlu_grad_cd, String asst_evlu_opn, String busn_rslt_scor, String evlu_part_cd1, String evlu_part_cd2, String evlu_part_cd3, String evlu_part_cd4, String evlu_part_cd5, String evlu_cmpt_opn_1tms, String tmp_grad, String cmpt_scor, String self_evlu_proc_stat, String asst_evlu_proc_stat, String asst_pnt, String rvis_scor_1tms){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_EVLU_3303_SCURLIST1Record rec = new HD_EVLU_3303_SCURLIST1Record();
		...
		while(rset1.next()){
			HD_EVLU_3303_SCURLIST2Record rec = new HD_EVLU_3303_SCURLIST2Record();
		...
		while(rset2.next()){
			HD_EVLU_3303_SCURLIST3Record rec = new HD_EVLU_3303_SCURLIST3Record();
		...
		while(rset3.next()){
			HD_EVLU_3303_SCURLIST4Record rec = new HD_EVLU_3303_SCURLIST4Record();
		...
		while(rset4.next()){
			HD_EVLU_3303_SCURLIST5Record rec = new HD_EVLU_3303_SCURLIST5Record();
...
<%
	HD_EVLU_3303_SDataSet ds = (HD_EVLU_3303_SDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		HD_EVLU_3303_SCURLIST1Record curlist1Rec = (HD_EVLU_3303_SCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		HD_EVLU_3303_SCURLIST2Record curlist2Rec = (HD_EVLU_3303_SCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		HD_EVLU_3303_SCURLIST3Record curlist3Rec = (HD_EVLU_3303_SCURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist4.size(); i++){
		HD_EVLU_3303_SCURLIST4Record curlist4Rec = (HD_EVLU_3303_SCURLIST4Record)ds.curlist4.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist5.size(); i++){
		HD_EVLU_3303_SCURLIST5Record curlist5Rec = (HD_EVLU_3303_SCURLIST5Record)ds.curlist5.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Tue Apr 01 20:31:20 KST 2014 */