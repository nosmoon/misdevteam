...
public class HD_EVLU_3103_500_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.asst_evlu_grad_cd = Util.checkString(cstmt.getString(27));
		this.asst_evlu_opn = Util.checkString(cstmt.getString(28));
		this.busn_rslt_scor = Util.checkString(cstmt.getString(29));
		this.evlu_part_cd1 = Util.checkString(cstmt.getString(30));
		this.evlu_part_cd2 = Util.checkString(cstmt.getString(31));
		this.evlu_part_cd3 = Util.checkString(cstmt.getString(32));
		this.evlu_part_cd4 = Util.checkString(cstmt.getString(33));
		this.evlu_part_cd5 = Util.checkString(cstmt.getString(34));
		this.evlu_part_cd6 = Util.checkString(cstmt.getString(35));
		this.evlu_cmpt_opn_1tms = Util.checkString(cstmt.getString(36));
		this.cmpt_scor = Util.checkString(cstmt.getString(37));
		this.self_evlu_proc_stat = Util.checkString(cstmt.getString(38));
		this.asst_evlu_proc_stat = Util.checkString(cstmt.getString(39));
		this.asst_pnt = Util.checkString(cstmt.getString(40));
		this.rvis_scor_1tms = Util.checkString(cstmt.getString(41));
		ResultSet rset0 = (ResultSet) cstmt.getObject(42);
		while(rset0.next()){
			HD_EVLU_3103_500_SCURLIST1Record rec = new HD_EVLU_3103_500_SCURLIST1Record();
			rec.cdnm = Util.checkString(rset0.getString("cdnm"));
			rec.act_indx_def = Util.checkString(rset0.getString("act_indx_def"));
			this.curlist1.add(rec);
		}
		ResultSet rset1 = (ResultSet) cstmt.getObject(43);
		while(rset1.next()){
			HD_EVLU_3103_500_SCURLIST2Record rec = new HD_EVLU_3103_500_SCURLIST2Record();
			rec.cdnm = Util.checkString(rset1.getString("cdnm"));
			rec.act_indx_def = Util.checkString(rset1.getString("act_indx_def"));
			this.curlist2.add(rec);
		}
		ResultSet rset2 = (ResultSet) cstmt.getObject(44);
		while(rset2.next()){
			HD_EVLU_3103_500_SCURLIST3Record rec = new HD_EVLU_3103_500_SCURLIST3Record();
			rec.cdnm = Util.checkString(rset2.getString("cdnm"));
			rec.act_indx_def = Util.checkString(rset2.getString("act_indx_def"));
			this.curlist3.add(rec);
		}
		ResultSet rset3 = (ResultSet) cstmt.getObject(45);
		while(rset3.next()){
			HD_EVLU_3103_500_SCURLIST4Record rec = new HD_EVLU_3103_500_SCURLIST4Record();
		...
		while(rset4.next()){
			HD_EVLU_3103_500_SCURLIST5Record rec = new HD_EVLU_3103_500_SCURLIST5Record();
...
<%
	HD_EVLU_3103_500_SDataSet ds = (HD_EVLU_3103_500_SDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		HD_EVLU_3103_500_SCURLIST1Record curlist1Rec = (HD_EVLU_3103_500_SCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		HD_EVLU_3103_500_SCURLIST2Record curlist2Rec = (HD_EVLU_3103_500_SCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		HD_EVLU_3103_500_SCURLIST3Record curlist3Rec = (HD_EVLU_3103_500_SCURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist4.size(); i++){
		HD_EVLU_3103_500_SCURLIST4Record curlist4Rec = (HD_EVLU_3103_500_SCURLIST4Record)ds.curlist4.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist5.size(); i++){
		HD_EVLU_3103_500_SCURLIST5Record curlist5Rec = (HD_EVLU_3103_500_SCURLIST5Record)ds.curlist5.get(i);%>
HTML 코드들....
	<%}%>
