...
public class HD_AFFR_6012_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_6012_ADM(){}
	public HD_AFFR_6012_ADM(String mode, String cmpy_cd, String emp_no, String certi_clsf, String occr_dt, String seq, String u_ipadd, String u_id){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_6012_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_6012_ADM dm = (HD_AFFR_6012_ADM)bdm;
		...
		cstmt.setString(9, dm.u_ipadd);
		cstmt.setString(10, dm.u_id);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_6012_ADataSet();
	}
