...
public class HD_AFFR_9604_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_9604_LDM(){}
	public HD_AFFR_9604_LDM(String cmpy_cd, String mang_no, String expn_clsf_cd, String aply_obj_clsf, String str_dt, String limt_amt, String sply_amt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_9604_L(? ,? ,? ,? ,? ,? ,? ,? ,?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_9604_LDM dm = (HD_AFFR_9604_LDM)bdm;
		...
		cstmt.setString(9, dm.sply_amt);
		cstmt.registerOutParameter(10, Types.INTEGER);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_9604_LDataSet();
	}
