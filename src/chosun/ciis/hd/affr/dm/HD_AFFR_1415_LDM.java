...
public class HD_AFFR_1415_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_1415_LDM(){}
	public HD_AFFR_1415_LDM(String cmpy_cd, String emp_no, String fr_occr_dt, String to_occr_dt, String pay_plac_clsf, String actu_slip_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_1415_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_1415_LDM dm = (HD_AFFR_1415_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_1415_LDataSet();
	}
