...
public class HD_AFFR_1602_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_1602_ADM(){}
	public HD_AFFR_1602_ADM(String mode, String cmpy_cd, String emp_no, String occr_dt, String seq, String flnm, String dept_cd, String dty_cd, String posi_cd, String scl_exps_pay_yy, String scl_exps_pay_qq, String scl_exps_clsf, String scl_exps_pay_plac_clsf, String obj_pers_flnm, String obj_pers_prn, String scl_nm, String grade, String scl_part, String aplc_amt, String vdty_amt, String pay_amt, String remk, String slip_proc_mang_dt, String slip_proc_mang_seq, String aplc_dt, String aplc_seq, String incmg_pers_ipadd, String emp_clsf, String ss_emp_no){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_1602_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_1602_ADM dm = (HD_AFFR_1602_ADM)bdm;
		...
		cstmt.setString(27, dm.aplc_dt);
		cstmt.setString(28, dm.aplc_seq);
		cstmt.setString(29, dm.incmg_pers_ipadd);
		cstmt.setString(30, dm.emp_clsf);
		cstmt.setString(31, dm.ss_emp_no);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_1602_ADataSet();
	}
...
/* 작성시간 : Wed Mar 18 16:08:17 KST 2009 */