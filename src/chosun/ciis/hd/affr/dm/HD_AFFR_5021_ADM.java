...
public class HD_AFFR_5021_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_5021_ADM(){}
	public HD_AFFR_5021_ADM(String cmpy_cd, String emp_no, String mode, String proc_stat, String certi_clsf, String occr_dt, String seq, String aplc_dt){		
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_5021_A(? ,? ,? ,? ,? ,? ,? ,?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_5021_ADM dm = (HD_AFFR_5021_ADM)bdm;
		...
		cstmt.setString(10, dm.aplc_dt);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_5021_ADataSet();
	}
