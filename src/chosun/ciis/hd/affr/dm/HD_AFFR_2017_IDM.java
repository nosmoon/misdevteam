...
public class HD_AFFR_2017_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_2017_IDM(){}
	public HD_AFFR_2017_IDM(String cmpy_cd, String sply_yymm, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_2017_I(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_2017_IDM dm = (HD_AFFR_2017_IDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.sply_yymm);
		cstmt.setString(5, dm.incmg_pers_ipadd);
		cstmt.setString(6, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_2017_IDataSet();
	}
