...
public class HD_AFFR_1002_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_1002_LDM(){}
	public HD_AFFR_1002_LDM(String cmpy_cd, String emp_no, String ss_emp_no, String search_year){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_1002_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_1002_LDM dm = (HD_AFFR_1002_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_1002_LDataSet();
	}
...
/* 작성시간 : Mon Dec 10 10:09:44 KST 2012 */