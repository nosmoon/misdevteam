...
public class HD_AFFR_9603_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_9603_ADM(){}
	public HD_AFFR_9603_ADM(String cmpy_cd, String mode, String mang_no, String seq, String proc_mang_dt, String incmg_pers_ipadd, String ss_emp_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_9603_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_9603_ADM dm = (HD_AFFR_9603_ADM)bdm;
		...
		cstmt.setString(7, dm.proc_mang_dt);
		cstmt.setString(8, dm.incmg_pers_ipadd);
		cstmt.setString(9, dm.ss_emp_no);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_9603_ADataSet();
	}
