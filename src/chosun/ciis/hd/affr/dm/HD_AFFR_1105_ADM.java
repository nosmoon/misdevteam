...
public class HD_AFFR_1105_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_1105_ADM(){}
	public HD_AFFR_1105_ADM(String cmpy_cd, String s_mode, String tmp_dr_amt, String flnm, String dept_cd, String titl2, String cmpy_welf_fund_clsf, String emp_no, String tmp_crdt_amt, String titl, String slip_proc_mang_dt, String slip_proc_mang_seq, String occr_dt, String seq, String rcpt_clsf, String incmg_pers_ipadd, String ss_emp_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_1105_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_1105_ADM dm = (HD_AFFR_1105_ADM)bdm;
		...
		cstmt.setString(8, dm.titl2);
		cstmt.setString(9, dm.cmpy_welf_fund_clsf);
		cstmt.setString(10, dm.emp_no);
		cstmt.setString(11, dm.tmp_crdt_amt);
		cstmt.setString(12, dm.titl);
		cstmt.setString(13, dm.slip_proc_mang_dt);
		cstmt.setString(14, dm.slip_proc_mang_seq);
		cstmt.setString(15, dm.occr_dt);
		cstmt.setString(16, dm.seq);
		cstmt.setString(17, dm.rcpt_clsf);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_1105_ADataSet();
	}
