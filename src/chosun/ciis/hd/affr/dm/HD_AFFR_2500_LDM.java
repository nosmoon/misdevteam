...
public class HD_AFFR_2500_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_2500_LDM(){}
	public HD_AFFR_2500_LDM(String cmpy_cd, String chk_yy, String lvcmpy_dt, String emp_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_2500_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_2500_LDM dm = (HD_AFFR_2500_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_2500_LDataSet();
	}
