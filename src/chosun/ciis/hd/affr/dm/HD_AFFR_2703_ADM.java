...
public class HD_AFFR_2703_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_2703_ADM(){}
	public HD_AFFR_2703_ADM(String cmpy_cd, String mode, String emp_no, String flnm, String dept_cd, String dty_cd, String posi_cd, String seq, String occr_dt, String incmg_pers_ipadd, String ss_emp_no, String faml_seq, String hospz_med_exam_pers_flnm, String faml_rshp_cd, String real_ward_fee, String sply_ward_fee, String real_hospz_med_exam_fee, String sply_hospz_med_exam_fee, String hospz_med_exam_frdt, String hospz_med_exam_todt, String hospz_med_exam_dds, String disea_cont, String hospz_med_exam_hosp_nm, String slip_proc_mang_dt, String slip_proc_mang_seq, String emp_clsf){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_2703_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_2703_ADM dm = (HD_AFFR_2703_ADM)bdm;
		...
		cstmt.setString(26, dm.slip_proc_mang_dt);
		cstmt.setString(27, dm.slip_proc_mang_seq);
		cstmt.setString(28, dm.emp_clsf);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_2703_ADataSet();
	}
...
/* 작성시간 : Tue Aug 04 17:43:18 KST 2009 */