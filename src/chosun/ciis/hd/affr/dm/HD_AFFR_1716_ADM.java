...
public class HD_AFFR_1716_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_1716_ADM(){}
	public HD_AFFR_1716_ADM(String cmpy_cd, String s_mode, String tmp_dr_amt, String flnm, String dept_cd, String cmpy_welf_fund_clsf, String emp_no, String tmp_crdt_amt, String titl, String slip_proc_mang_dt, String slip_proc_mang_seq, String occr_dt, String seq, String incmg_pers_ipadd, String ss_emp_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_1716_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_1716_ADM dm = (HD_AFFR_1716_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_1716_ADataSet();
	}
...
/* 작성시간 : Tue Aug 11 14:07:19 KST 2009 */