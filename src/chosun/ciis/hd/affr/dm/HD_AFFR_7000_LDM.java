...
public class HD_AFFR_7000_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String certi_clsf_ck;

	public HD_AFFR_7000_LDM(){}
	public HD_AFFR_7000_LDM(String cmpy_cd, String certi_clsf_ck){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_7000_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_7000_LDM dm = (HD_AFFR_7000_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.certi_clsf_ck);
		cstmt.registerOutParameter(5, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_7000_LDataSet();
	}
...
/* 작성시간 : Tue Mar 17 17:14:35 KST 2009 */