...
public class HD_AFFR_1004_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String mang_cd_1;

	public HD_AFFR_1004_LDM(){}
	public HD_AFFR_1004_LDM(String cmpy_cd, String mang_cd_1){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_1004_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_1004_LDM dm = (HD_AFFR_1004_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_1004_LDataSet();
	}
