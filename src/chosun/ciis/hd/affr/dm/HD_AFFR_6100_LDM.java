...
public class HD_AFFR_6100_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_6100_LDM(){}
	public HD_AFFR_6100_LDM(String emp_no, String cmpy_cd, String st_aplc_dt, String en_aplc_dt, String certi_clsf, String issu_clsf){
		this.emp_no = emp_no;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_6100_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_6100_LDM dm = (HD_AFFR_6100_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_6100_LDataSet();
	}
