...
public class HD_AFFR_1412_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String emp_no;
	public String faml_flnm;

	public HD_AFFR_1412_LDM(){}
	public HD_AFFR_1412_LDM(String cmpy_cd, String emp_no, String faml_flnm){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_1412_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_1412_LDM dm = (HD_AFFR_1412_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.emp_no);
		cstmt.setString(5, dm.faml_flnm);
		cstmt.registerOutParameter(6, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_1412_LDataSet();
	}
...
/* 작성시간 : Mon Mar 30 16:07:06 KST 2009 */