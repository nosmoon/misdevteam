...
public class HD_AFFR_9030_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String usag_clsf_cd;

	public HD_AFFR_9030_MDM(){}
	public HD_AFFR_9030_MDM(String cmpy_cd, String usag_clsf_cd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_9030_M(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_9030_MDM dm = (HD_AFFR_9030_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_9030_MDataSet();
	}
