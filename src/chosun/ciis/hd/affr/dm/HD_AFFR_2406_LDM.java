...
public class HD_AFFR_2406_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_2406_LDM(){}
	public HD_AFFR_2406_LDM(String cmpy_cd, String fr_occr_dt, String to_occr_dt, String pay_plac_clsf, String emp_no, String proc_stat, String chk_dt, String chk_obj_pers_rshp, String actu_slip_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_2406_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_2406_LDM dm = (HD_AFFR_2406_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_2406_LDataSet();
	}
...
/* 작성시간 : Mon Jun 01 17:02:54 KST 2009 */