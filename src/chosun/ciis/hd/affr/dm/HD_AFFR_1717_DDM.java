...
public class HD_AFFR_1717_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_1717_DDM(){}
	public HD_AFFR_1717_DDM(String mode, String cmpy_cd, String slip_proc_mang_dt, String slip_proc_mang_seq, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String cmpy_welf_fund_clsf, String slip_incmg_pers, String slip_incmg_pers_ipadd, String incmg_pers_ipadd, String ss_emp_no){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_1717_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_1717_DDM dm = (HD_AFFR_1717_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_1717_DDataSet();
	}
...
/* 작성시간 : Sun Jul 26 15:51:23 KST 2009 */