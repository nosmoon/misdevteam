...
public class HD_AFFR_2412_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_2412_LDM(){}
	public HD_AFFR_2412_LDM(String cmpy_cd, String emp_no, String occr_yy, String ss_emp_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_2412_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_2412_LDM dm = (HD_AFFR_2412_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.emp_no);
		cstmt.setString(5, dm.occr_yy);
		cstmt.setString(6, dm.ss_emp_no);
		cstmt.registerOutParameter(7, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_2412_LDataSet();
	}
