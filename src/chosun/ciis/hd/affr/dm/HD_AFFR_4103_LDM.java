...
public class HD_AFFR_4103_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String aply_yy;

	public HD_AFFR_4103_LDM(){}
	public HD_AFFR_4103_LDM(String cmpy_cd, String aply_yy){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_4103_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_4103_LDM dm = (HD_AFFR_4103_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_4103_LDataSet();
	}
