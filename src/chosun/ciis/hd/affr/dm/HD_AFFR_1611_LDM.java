...
public class HD_AFFR_1611_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String emp_no;
	public String ss_emp_no;

	public HD_AFFR_1611_LDM(){}
	public HD_AFFR_1611_LDM(String cmpy_cd, String emp_no, String ss_emp_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_1611_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_1611_LDM dm = (HD_AFFR_1611_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_1611_LDataSet();
	}
