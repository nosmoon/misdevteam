...
public class HD_AFFR_2211_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_2211_ADM(){}
	public HD_AFFR_2211_ADM(String mode, String cmpy_cd, String emp_no, String occr_dt, String seq, String flnm, String dept_cd, String dty_cd, String posi_cd, String ofcr_clsf, String pay_plac_clsf, String congr_condl_dt, String congr_condl_cd, String congr_condl_fee, String art_flower, String ofcr_congr_condl_fee, String ofcr_art_flower, String remk, String slip_proc_mang_dt, String slip_proc_mang_seq, String ss_emp_no, String incmg_pers_ipadd, String genl_affrs_clsf){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_2211_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_2211_ADM dm = (HD_AFFR_2211_ADM)bdm;
		...
		cstmt.setString(13, dm.pay_plac_clsf);
		cstmt.setString(14, dm.congr_condl_dt);
		cstmt.setString(15, dm.congr_condl_cd);
		cstmt.setString(16, dm.congr_condl_fee);
		cstmt.setString(17, dm.art_flower);
		cstmt.setString(18, dm.ofcr_congr_condl_fee);
		cstmt.setString(19, dm.ofcr_art_flower);
		cstmt.setString(20, dm.remk);
		cstmt.setString(21, dm.slip_proc_mang_dt);
		cstmt.setString(22, dm.slip_proc_mang_seq);
		cstmt.setString(23, dm.ss_emp_no);
		cstmt.setString(24, dm.incmg_pers_ipadd);
		cstmt.setString(25, dm.genl_affrs_clsf);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_2211_ADataSet();
	}
...
/* 작성시간 : Wed Dec 18 14:50:06 KST 2013 */