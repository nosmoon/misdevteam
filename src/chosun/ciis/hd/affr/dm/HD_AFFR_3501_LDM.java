...
public class HD_AFFR_3501_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_3501_LDM(){}
	public HD_AFFR_3501_LDM(String cmpy_cd, String sch_yyyy, String emp_no, String entr_clsf, String sch_clsf){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_3501_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_3501_LDM dm = (HD_AFFR_3501_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_3501_LDataSet();
	}
