...
public class HD_AFFR_3800_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_3800_ADM(){}
	public HD_AFFR_3800_ADM(String cmpy_cd, String mode, String emp_no, String dept_cd, String aplc_dt, String acq_pers, String start_plac, String ariv_plac, String use_purp, String cont_item, String remk, String aplc_cnfm_yn, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_3800_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_3800_ADM dm = (HD_AFFR_3800_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_3800_ADataSet();
	}
...
/* 작성시간 : Fri Dec 07 18:05:44 KST 2018 */