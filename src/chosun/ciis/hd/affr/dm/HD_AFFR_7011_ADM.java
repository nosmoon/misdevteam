...
public class HD_AFFR_7011_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_7011_ADM(){}
	public HD_AFFR_7011_ADM(String mode, String cmpy_cd, String emp_no, String certi_clsf, String occr_dt, String seq, String aplc_dt, String issu_num_shet, String usag, String remk, String cntc_plac, String email, String engl_flnm, String u_id, String u_ipadd, String dept_cd, String dty_cd, String posi_cd, String korn_flnm){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_7011_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_7011_ADM dm = (HD_AFFR_7011_ADM)bdm;
		...
		cstmt.setString(21, dm.korn_flnm);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_7011_ADataSet();
	}
...
/* 작성시간 : Wed Mar 18 13:25:35 KST 2009 */