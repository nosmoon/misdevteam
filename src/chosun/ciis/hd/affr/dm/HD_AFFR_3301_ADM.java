...
public class HD_AFFR_3301_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_3301_ADM(){}
	public HD_AFFR_3301_ADM(String mode, String cmpy_cd, String occr_dt, String seq, String sply_clsf_cd, String aply_basi_dt, String hlth_chk_fee, String incmg_pers_ipadd, String ss_emp_no){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_3301_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_3301_ADM dm = (HD_AFFR_3301_ADM)bdm;
		...
		cstmt.setString(9, dm.hlth_chk_fee);
		cstmt.setString(10, dm.incmg_pers_ipadd);
		cstmt.setString(11, dm.ss_emp_no);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_3301_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("hlth_chk_fee = [" + getHlth_chk_fee() + "]");
...
String hlth_chk_fee = req.getParameter("hlth_chk_fee");
if( hlth_chk_fee == null){
	System.out.println(this.toString+" : hlth_chk_fee is null" );
}else{
	System.out.println(this.toString+" : hlth_chk_fee is "+hlth_chk_fee );
}
...
String hlth_chk_fee = Util.checkString(req.getParameter("hlth_chk_fee"));
...
String hlth_chk_fee = Util.Uni2Ksc(Util.checkString(req.getParameter("hlth_chk_fee")));
...
/* 작성시간 : Fri Jul 24 11:46:15 KST 2009 */