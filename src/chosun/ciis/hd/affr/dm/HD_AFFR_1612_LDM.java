...
public class HD_AFFR_1612_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String emp_no;
	public String obj_pers_flnm;

	public HD_AFFR_1612_LDM(){}
	public HD_AFFR_1612_LDM(String cmpy_cd, String emp_no, String obj_pers_flnm){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_1612_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_1612_LDM dm = (HD_AFFR_1612_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_1612_LDataSet();
	}
