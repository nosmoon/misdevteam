...
public class HD_AFFR_1003_500_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_1003_500_ADM(){}
	public HD_AFFR_1003_500_ADM(String mode, String cmpy_cd, String emp_no, String seq, String flnm, String dept_cd, String dty_cd, String posi_cd, String use_frdt, String use_todt, String use_dds, String cmpy_sply_use_yn, String tel_no, String ptph_no, String email_addr, String remk, String guest_room_cnt, String emp_clsf, String incmg_pers, String incmg_pers_ipadd, String occr_dt, String aplc_amt, String rcpt_clsf){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_1003_500_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_1003_500_ADM dm = (HD_AFFR_1003_500_ADM)bdm;
		...
		cstmt.setString(14, dm.cmpy_sply_use_yn);
		cstmt.setString(15, dm.tel_no);
		cstmt.setString(16, dm.ptph_no);
		cstmt.setString(17, dm.email_addr);
		cstmt.setString(18, dm.remk);
		cstmt.setString(19, dm.guest_room_cnt);
		cstmt.setString(20, dm.emp_clsf);
		cstmt.setString(21, dm.incmg_pers);
		cstmt.setString(22, dm.incmg_pers_ipadd);
		cstmt.setString(23, dm.occr_dt);
		cstmt.setString(24, dm.aplc_amt);
		cstmt.setString(25, dm.rcpt_clsf);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_1003_500_ADataSet();
	}
...
/* 작성시간 : Thu Dec 13 15:14:44 KST 2012 */