...
public class HD_AFFR_8020_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_AFFR_8020_LDM(){}
	public HD_AFFR_8020_LDM(String cmpy_cd, String emp_no, String occr_yy, String ss_emp_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_AFFR_8020_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_AFFR_8020_LDM dm = (HD_AFFR_8020_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.affr.ds.HD_AFFR_8020_LDataSet();
	}
