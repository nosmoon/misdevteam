...
public class HD_AFFR_1601_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist2 = new ArrayList();
	public ArrayList curlist1 = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_AFFR_1601_LDataSet(){}
	public HD_AFFR_1601_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_AFFR_1601_LCURLIST1Record rec = new HD_AFFR_1601_LCURLIST1Record();
		...
		while(rset1.next()){
			HD_AFFR_1601_LCURLIST2Record rec = new HD_AFFR_1601_LCURLIST2Record();
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		HD_AFFR_1601_LCURLIST1Record curlist1Rec = (HD_AFFR_1601_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		HD_AFFR_1601_LCURLIST2Record curlist2Rec = (HD_AFFR_1601_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>
