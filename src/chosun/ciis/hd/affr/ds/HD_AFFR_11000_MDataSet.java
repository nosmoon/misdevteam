...
public class HD_AFFR_11000_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public HD_AFFR_11000_MDataSet(){}
	public HD_AFFR_11000_MDataSet(String errcode, String errmsg, String xx_proc_stat_010, String xx_proc_stat_020, String xx_proc_stat_030, String xx_proc_stat_040, String xx_proc_stat_050){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_AFFR_11000_MXX_COMBO_010Record rec = new HD_AFFR_11000_MXX_COMBO_010Record();
...
<%
	HD_AFFR_11000_MDataSet ds = (HD_AFFR_11000_MDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.xx_combo_010.size(); i++){
		HD_AFFR_11000_MXX_COMBO_010Record xx_combo_010Rec = (HD_AFFR_11000_MXX_COMBO_010Record)ds.xx_combo_010.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Thu Aug 08 16:49:02 KST 2013 */