...
public class HD_AFFR_6100_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist2 = new ArrayList();
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_AFFR_6100_LDataSet(){}
	public HD_AFFR_6100_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_AFFR_6100_LCURLISTRecord rec = new HD_AFFR_6100_LCURLISTRecord();
		...
		while(rset1.next()){
			HD_AFFR_6100_LCURLIST2Record rec = new HD_AFFR_6100_LCURLIST2Record();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_AFFR_6100_LCURLISTRecord curlistRec = (HD_AFFR_6100_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		HD_AFFR_6100_LCURLIST2Record curlist2Rec = (HD_AFFR_6100_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Wed Mar 18 18:56:52 KST 2009 */