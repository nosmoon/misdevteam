...
public class HD_AFFR_24000_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public String xx_chk_obj_pers_rshp;

	public HD_AFFR_24000_MDataSet(){}
	public HD_AFFR_24000_MDataSet(String errcode, String errmsg, String xx_proc_stat_010, String xx_proc_stat_020, String xx_proc_stat_030, String xx_proc_stat_040, String xx_proc_stat_050, String xx_chk_obj_pers_rshp){
		...
		this.xx_chk_obj_pers_rshp = xx_chk_obj_pers_rshp;
	}
	...
	public void setXx_chk_obj_pers_rshp(String xx_chk_obj_pers_rshp){
		this.xx_chk_obj_pers_rshp = xx_chk_obj_pers_rshp;
	}
	...
	public String getXx_chk_obj_pers_rshp(){
		return this.xx_chk_obj_pers_rshp;
	}
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_AFFR_24000_MXX_COMBO_010Record rec = new HD_AFFR_24000_MXX_COMBO_010Record();
		...
		this.xx_chk_obj_pers_rshp = Util.checkString(cstmt.getString(11));
	}
}/*----------------------------------------------------------------------------------------------------
Web Tier에서 DataSet 객체 관련 코드 작성시 사용하십시오.

<%
	HD_AFFR_24000_MDataSet ds = (HD_AFFR_24000_MDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.xx_combo_010.size(); i++){
		HD_AFFR_24000_MXX_COMBO_010Record xx_combo_010Rec = (HD_AFFR_24000_MXX_COMBO_010Record)ds.xx_combo_010.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Fri Feb 17 15:12:14 KST 2012 */