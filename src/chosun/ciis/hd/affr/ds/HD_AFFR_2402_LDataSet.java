...
public class HD_AFFR_2402_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_AFFR_2402_LDataSet(){}
	public HD_AFFR_2402_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_AFFR_2402_LCURLISTRecord rec = new HD_AFFR_2402_LCURLISTRecord();
...
<%
	HD_AFFR_2402_LDataSet ds = (HD_AFFR_2402_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_AFFR_2402_LCURLISTRecord curlistRec = (HD_AFFR_2402_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Sun Jun 28 18:22:34 KST 2009 */