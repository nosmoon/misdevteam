...
public class HD_AFFR_1002_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_AFFR_1002_LDataSet(){}
	public HD_AFFR_1002_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_AFFR_1002_LCURLISTRecord rec = new HD_AFFR_1002_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_AFFR_1002_LCURLISTRecord curlistRec = (HD_AFFR_1002_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Mon Dec 10 10:09:45 KST 2012 */