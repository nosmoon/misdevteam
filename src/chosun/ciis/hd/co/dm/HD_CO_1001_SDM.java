...
public class HD_CO_1001_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_CO_1001_SDM(){}
	public HD_CO_1001_SDM(String cmpy_cd, String emp_no, String nm_korn, String prn){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_CO_1001_S(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_CO_1001_SDM dm = (HD_CO_1001_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.co.ds.HD_CO_1001_SDataSet();
	}
