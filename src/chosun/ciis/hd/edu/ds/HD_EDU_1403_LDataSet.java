...
public class HD_EDU_1403_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_EDU_1403_LDataSet(){}
	public HD_EDU_1403_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_EDU_1403_LCURLISTRecord rec = new HD_EDU_1403_LCURLISTRecord();
...
<%
	HD_EDU_1403_LDataSet ds = (HD_EDU_1403_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_EDU_1403_LCURLISTRecord curlistRec = (HD_EDU_1403_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Wed Sep 05 16:10:05 KST 2018 */