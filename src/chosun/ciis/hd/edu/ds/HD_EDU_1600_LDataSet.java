...
public class HD_EDU_1600_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_EDU_1600_LDataSet(){}
	public HD_EDU_1600_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_EDU_1600_LCURLISTRecord rec = new HD_EDU_1600_LCURLISTRecord();
...
<%
	HD_EDU_1600_LDataSet ds = (HD_EDU_1600_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_EDU_1600_LCURLISTRecord curlistRec = (HD_EDU_1600_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Fri Mar 20 16:20:02 KST 2009 */