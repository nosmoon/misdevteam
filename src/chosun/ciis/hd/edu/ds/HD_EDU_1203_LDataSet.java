...
public class HD_EDU_1203_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_EDU_1203_LDataSet(){}
	public HD_EDU_1203_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_EDU_1203_LCURLISTRecord rec = new HD_EDU_1203_LCURLISTRecord();
...
<%
	HD_EDU_1203_LDataSet ds = (HD_EDU_1203_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_EDU_1203_LCURLISTRecord curlistRec = (HD_EDU_1203_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Thu Mar 19 11:35:10 KST 2009 */