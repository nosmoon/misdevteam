...
public class HD_EDU_5005_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EDU_5005_ADM(){}
	public HD_EDU_5005_ADM(String cmpy_cd, String emp_no, String mode, String proc_stat, String acpn_no, String occr_dt, String seq){		
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EDU_5005_A(? ,? ,? ,? ,? ,? ,? ,?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EDU_5005_ADM dm = (HD_EDU_5005_ADM)bdm;
		...
		cstmt.setString(7, dm.acpn_no);
		cstmt.setString(8, dm.occr_dt);
		cstmt.setString(9, dm.seq);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.edu.ds.HD_EDU_5005_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("cmpy_cd2 = [" + getCmpy_cd() + "]");
		System.out.println("emp_no34 = [" + getEmp_no() + "]");
