...
public class HD_EDU_1112_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EDU_1112_LDM(){}
	public HD_EDU_1112_LDM(String cmpy_cd, String emp_no, String occr_dt, String occr_seq){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EDU_1112_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EDU_1112_LDM dm = (HD_EDU_1112_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_EDU_1112_LDataSet();
	}
