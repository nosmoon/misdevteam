...
public class HD_EDU_1211_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EDU_1211_DDM(){}
	public HD_EDU_1211_DDM(String cmpy_cd, String emp_no, String occr_dt, String occr_seq){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EDU_1211_D(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EDU_1211_DDM dm = (HD_EDU_1211_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_EDU_1211_DDataSet();
	}
...
/* 작성시간 : Tue Aug 25 09:11:40 KST 2009 */