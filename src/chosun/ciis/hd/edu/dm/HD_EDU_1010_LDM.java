...
public class HD_EDU_1010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EDU_1010_LDM(){}
	public HD_EDU_1010_LDM(String cmpy_cd, String emp_no, String edu_frdt, String edu_todt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EDU_1010_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EDU_1010_LDM dm = (HD_EDU_1010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.edu.ds.HD_EDU_1010_LDataSet();
	}
