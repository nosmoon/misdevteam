...
public class HD_EDU_1110_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EDU_1110_ADM(){}
	public HD_EDU_1110_ADM(String cmpy_cd, String emp_no, String occr_dt, String occr_seq, String remk, String incmg_pers_ipadd, String incmg_pers, String chg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EDU_1110_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EDU_1110_ADM dm = (HD_EDU_1110_ADM)bdm;
		...
		//System.out.println("!1!!11111      "+dm.remk.toCharArray().length);
	...
	public BaseDataSet createDataSetObject(){
		return new HD_EDU_1110_ADataSet();
	}
...
/* 작성시간 : Fri Aug 21 17:09:22 KST 2009 */