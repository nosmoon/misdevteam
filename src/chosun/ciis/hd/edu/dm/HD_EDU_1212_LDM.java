...
public class HD_EDU_1212_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EDU_1212_LDM(){}
	public HD_EDU_1212_LDM(String cmpy_cd, String emp_no, String occr_dt, String occr_seq){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EDU_1212_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EDU_1212_LDM dm = (HD_EDU_1212_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_EDU_1212_LDataSet();
	}
