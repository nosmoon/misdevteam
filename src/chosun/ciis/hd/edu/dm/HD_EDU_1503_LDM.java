...
public class HD_EDU_1503_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EDU_1503_LDM(){}
	public HD_EDU_1503_LDM(String cmpy_cd, String emp_no, String nm_korn, String dept_cd, String emp_clsf_cd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EDU_1503_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EDU_1503_LDM dm = (HD_EDU_1503_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.edu.ds.HD_EDU_1503_LDataSet();
	}
