...
public class HD_EDU_2210_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EDU_2210_UDM(){}
	public HD_EDU_2210_UDM(String cmpy_cd, String mode, String check, String emp_no, String occr_dt, String seq, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EDU_2210_U(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EDU_2210_UDM dm = (HD_EDU_2210_UDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.mode);
		cstmt.setString(5, dm.check);
	...
	public BaseDataSet createDataSetObject(){
		return new HD_EDU_2210_UDataSet();
	}
...
/* 작성시간 : Tue Apr 12 17:24:16 KST 2011 */