...
public class HD_EDU_1711_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EDU_1711_ADM(){}
	public HD_EDU_1711_ADM(String cmpy_cd, String emp_no, String mode, String proc_stat, String occr_dt, String seq){		
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EDU_1711_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EDU_1711_ADM dm = (HD_EDU_1711_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.edu.ds.HD_EDU_1711_ADataSet();
	}
