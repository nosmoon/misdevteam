...
public class HD_EDU_1403_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EDU_1403_LDM(){}
	public HD_EDU_1403_LDM(String cmpy_cd, String emp_no, String dept_cd, String dept_nm, String edu_frdt, String edu_todt, String complt_yn){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EDU_1403_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EDU_1403_LDM dm = (HD_EDU_1403_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.edu.ds.HD_EDU_1403_LDataSet();
	}
