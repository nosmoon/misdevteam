...
public class HD_EDU_1801_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_EDU_1801_LDM(){}
	public HD_EDU_1801_LDM(String cmpy_cd, String dept_cd, String dept_nm, String edu_frdt, String edu_todt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_EDU_1801_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_EDU_1801_LDM dm = (HD_EDU_1801_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.edu.ds.HD_EDU_1801_LDataSet();
	}
