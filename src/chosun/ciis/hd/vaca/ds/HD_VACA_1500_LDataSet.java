...
public class HD_VACA_1500_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_VACA_1500_LDataSet(){}
	public HD_VACA_1500_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_VACA_1500_LCURLISTRecord rec = new HD_VACA_1500_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_VACA_1500_LCURLISTRecord curlistRec = (HD_VACA_1500_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
