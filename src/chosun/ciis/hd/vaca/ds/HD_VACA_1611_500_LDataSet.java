...
public class HD_VACA_1611_500_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public HD_VACA_1611_500_LDataSet(){}
	public HD_VACA_1611_500_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_VACA_1611_500_LCURLISTRecord rec = new HD_VACA_1611_500_LCURLISTRecord();
			...
			rec.year_paid_vaca = Util.checkString(rset0.getString("year_paid_vaca"));
			rec.oneyear_under_vaca = Util.checkString(rset0.getString("oneyear_under_vaca"));
		...
		while(rset1.next()){
			HD_VACA_1611_500_LCURLIST1Record rec = new HD_VACA_1611_500_LCURLIST1Record();
		...
		while(rset2.next()){
			HD_VACA_1611_500_LCURLIST2Record rec = new HD_VACA_1611_500_LCURLIST2Record();
		...
		while(rset3.next()){
			HD_VACA_1611_500_LCURLIST3Record rec = new HD_VACA_1611_500_LCURLIST3Record();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_VACA_1611_500_LCURLISTRecord curlistRec = (HD_VACA_1611_500_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		HD_VACA_1611_500_LCURLIST1Record curlist1Rec = (HD_VACA_1611_500_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		HD_VACA_1611_500_LCURLIST2Record curlist2Rec = (HD_VACA_1611_500_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		HD_VACA_1611_500_LCURLIST3Record curlist3Rec = (HD_VACA_1611_500_LCURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>
...
<%= curlistRec.year_paid_vaca%>
<%= curlistRec.oneyear_under_vaca%>
