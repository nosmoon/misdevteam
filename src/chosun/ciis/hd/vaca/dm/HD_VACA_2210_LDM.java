...
public class HD_VACA_2210_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String saly_yy;
	public String saly_no;

	public HD_VACA_2210_LDM(){}
	public HD_VACA_2210_LDM(String cmpy_cd, String saly_yy, String saly_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_VACA_2210_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_VACA_2210_LDM dm = (HD_VACA_2210_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.vaca.ds.HD_VACA_2210_LDataSet();
	}
