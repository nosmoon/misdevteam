...
public class HD_VACA_1712_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_VACA_1712_DDM(){}
	public HD_VACA_1712_DDM(String mode, String cmpy_cd, String del_chk, String emp_no, String occr_dt, String seq){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_VACA_1712_D(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_VACA_1712_DDM dm = (HD_VACA_1712_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_VACA_1712_DDataSet();
	}
...
/* 작성시간 : Tue Dec 07 17:35:06 KST 2010 */