...
public class HD_VACA_3000_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_VACA_3000_ADM(){}
	public HD_VACA_3000_ADM(String cmpy_cd, String clndr_dt, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_VACA_3000_A(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_VACA_3000_ADM dm = (HD_VACA_3000_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.vaca.ds.HD_VACA_3000_ADataSet();
	}
