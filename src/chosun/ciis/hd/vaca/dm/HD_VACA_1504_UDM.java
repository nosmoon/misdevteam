...
public class HD_VACA_1504_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_VACA_1504_UDM(){}
	public HD_VACA_1504_UDM(String mode, String cmpy_cd, String emp_no, String seq, String occr_dt, String incmg_pers_ipadd, String ss_emp_no){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_VACA_1504_U(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_VACA_1504_UDM dm = (HD_VACA_1504_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.vaca.ds.HD_VACA_1504_UDataSet();
	}
...
/* 작성시간 : Sat Apr 25 19:07:36 KST 2009 */