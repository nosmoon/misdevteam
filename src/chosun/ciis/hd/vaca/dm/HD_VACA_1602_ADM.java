...
public class HD_VACA_1602_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_VACA_1602_ADM(){}
	public HD_VACA_1602_ADM(String mode, String cmpy_cd, String emp_no, String occr_dt, String seq, String dept_cd, String vaca_clsf, String vaca_dtls_clsf, String vaca_frdt, String vaca_todt, String vaca_dds, String alvc_use_dt, String remk, String emp_no_tm, String u_ipadd, String u_id){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_VACA_1602_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_VACA_1602_ADM dm = (HD_VACA_1602_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.vaca.ds.HD_VACA_1602_ADataSet();
	}
...
/* 작성시간 : Thu Jul 30 17:39:38 KST 2009 */