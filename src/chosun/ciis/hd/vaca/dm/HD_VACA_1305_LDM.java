...
public class HD_VACA_1305_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String aply_yy;
	public String emp_no;

	public HD_VACA_1305_LDM(){}
	public HD_VACA_1305_LDM(String cmpy_cd, String aply_yy, String emp_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_VACA_1305_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_VACA_1305_LDM dm = (HD_VACA_1305_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.vaca.ds.HD_VACA_1305_LDataSet();
	}
