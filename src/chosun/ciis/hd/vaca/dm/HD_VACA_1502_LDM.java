...
public class HD_VACA_1502_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String emp_no;
	public String aply_yy;

	public HD_VACA_1502_LDM(){}
	public HD_VACA_1502_LDM(String cmpy_cd, String emp_no, String aply_yy){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_VACA_1502_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_VACA_1502_LDM dm = (HD_VACA_1502_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_VACA_1502_LDataSet();
	}
