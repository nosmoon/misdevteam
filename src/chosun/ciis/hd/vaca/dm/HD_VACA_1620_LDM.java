...
public class HD_VACA_1620_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String prv_aprv_emp_no;

	public HD_VACA_1620_LDM(){}
	public HD_VACA_1620_LDM(String cmpy_cd, String prv_aprv_emp_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_VACA_1620_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_VACA_1620_LDM dm = (HD_VACA_1620_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.prv_aprv_emp_no);
		cstmt.registerOutParameter(5, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.vaca.ds.HD_VACA_1620_LDataSet();
	}
