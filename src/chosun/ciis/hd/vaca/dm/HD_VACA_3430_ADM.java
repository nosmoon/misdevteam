...
public class HD_VACA_3430_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_VACA_3430_ADM(){}
	public HD_VACA_3430_ADM(String mode, String cmpy_cd, String plan_dt, String emp_no, String dept_cd, String dty_cd, String posi_cd, String exec_clsf, String incmg_pers_ipadd, String incmg_pers){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_VACA_3430_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_VACA_3430_ADM dm = (HD_VACA_3430_ADM)bdm;
		...
		cstmt.setString(10, dm.exec_clsf);
		cstmt.setString(11, dm.incmg_pers_ipadd);
		cstmt.setString(12, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.vaca.ds.HD_VACA_3430_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("exec_clsf = [" + getExec_clsf() + "]");
...
String exec_clsf = req.getParameter("exec_clsf");
if( exec_clsf == null){
	System.out.println(this.toString+" : exec_clsf is null" );
}else{
	System.out.println(this.toString+" : exec_clsf is "+exec_clsf );
}
...
String exec_clsf = Util.checkString(req.getParameter("exec_clsf"));
...
String exec_clsf = Util.Uni2Ksc(Util.checkString(req.getParameter("exec_clsf")));
