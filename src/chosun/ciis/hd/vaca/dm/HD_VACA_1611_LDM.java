...
public class HD_VACA_1611_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_VACA_1611_LDM(){}
	public HD_VACA_1611_LDM(String cmpy_cd, String emp_no, String aply_yy, String search_frdt, String search_todt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_VACA_1611_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_VACA_1611_LDM dm = (HD_VACA_1611_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.vaca.ds.HD_VACA_1611_LDataSet();
	}
