...
public class HD_VACA_1900_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_VACA_1900_LDM(){}
	public HD_VACA_1900_LDM(String cmpy_cd, String dept_cd, String emp_no, String emp_nm, String dept_nm, String occr_dt, String emp_clsf){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_VACA_1900_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_VACA_1900_LDM dm = (HD_VACA_1900_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_VACA_1900_LDataSet();
	}
