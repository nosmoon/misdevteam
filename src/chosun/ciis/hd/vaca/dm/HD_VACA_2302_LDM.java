...
public class HD_VACA_2302_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_VACA_2302_LDM(){}
	public HD_VACA_2302_LDM(String cmpy_cd, String emp_no, String dept_cd, String incmg_pers, String fr_dt, String to_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_VACA_2302_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_VACA_2302_LDM dm = (HD_VACA_2302_LDM)bdm;
		...
		cstmt.setString(8, dm.fr_dt);
		cstmt.setString(9, dm.to_dt);
		cstmt.registerOutParameter(10, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.vaca.ds.HD_VACA_2302_LDataSet();
	}
