...
public class HD_VACA_1620_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_VACA_1620_ADM(){}
	public HD_VACA_1620_ADM(String mode, String cmpy_cd, String seq, String obj_dept_cd, String obj_emp_no, String prv_aprv_emp_no, String aft_aprv_emp_no, String fr_dt, String to_dt, String use_yn, String incmg_pers_ipadd, String incmg_pers, String incmg_dt_tm, String chg_pers, String chg_dt_tm){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_VACA_1620_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_VACA_1620_ADM dm = (HD_VACA_1620_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.vaca.ds.HD_VACA_1620_ADataSet();
	}
...
/* 작성시간 : Tue Aug 14 15:53:13 KST 2018 */