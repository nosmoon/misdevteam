...
public class HD_VACA_3120_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String plan_dt;

	public HD_VACA_3120_LDM(){}
	public HD_VACA_3120_LDM(String cmpy_cd, String plan_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_VACA_3120_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_VACA_3120_LDM dm = (HD_VACA_3120_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.vaca.ds.HD_VACA_3120_LDataSet();
	}
...
/* 작성시간 : Wed Jun 03 17:36:42 KST 2015 */