...
public class HD_VACA_3460_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String plan_dt;
	public String u_id;

	public HD_VACA_3460_ADM(){}
	public HD_VACA_3460_ADM(String cmpy_cd, String plan_dt, String u_id){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_VACA_3460_A(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_VACA_3460_ADM dm = (HD_VACA_3460_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.vaca.ds.HD_VACA_3460_ADataSet();
	}
...
/* 작성시간 : Mon Aug 31 15:15:59 KST 2015 */