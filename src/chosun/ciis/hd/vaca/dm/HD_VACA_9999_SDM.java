...
public class HD_VACA_9999_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String fr_dt;
	public String to_dt;

	public HD_VACA_9999_SDM(){}
	public HD_VACA_9999_SDM(String cmpy_cd, String fr_dt, String to_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_VACA_9999_S(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_VACA_9999_SDM dm = (HD_VACA_9999_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.vaca.ds.HD_VACA_9999_SDataSet();
	}
