...
public class HD_VACA_3150_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String plan_dt;

	public HD_VACA_3150_LDM(){}
	public HD_VACA_3150_LDM(String cmpy_cd, String plan_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_VACA_3150_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_VACA_3150_LDM dm = (HD_VACA_3150_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.vaca.ds.HD_VACA_3150_LDataSet();
	}
