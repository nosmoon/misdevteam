...
public class HD_HLYWRK_1302_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_HLYWRK_1302_ADM(){}
	public HD_HLYWRK_1302_ADM(String mode, String chk, String re_chk, String cmpy_cd, String duty_dt, String emp_no, String alvc_use_dt, String alvc_use_yn, String alvc_plan_dt, String base_alon, String cmpn_alon, String alon_pay_mm, String u_id){
		this.mode = mode;
		this.chk = chk;
		this.re_chk = re_chk;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_HLYWRK_1302_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_HLYWRK_1302_ADM dm = (HD_HLYWRK_1302_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.hlywrk.ds.HD_HLYWRK_1302_ADataSet();
	}
...
/* 작성시간 : Thu Jul 23 19:17:11 KST 2009 */