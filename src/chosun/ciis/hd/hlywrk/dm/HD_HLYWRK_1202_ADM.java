...
public class HD_HLYWRK_1202_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_HLYWRK_1202_ADM(){}
	public HD_HLYWRK_1202_ADM(String mode, String cmpy_cd, String duty_dt, String emp_no, String u_id, String emp_no_tm, String ep_seq){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_HLYWRK_1202_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_HLYWRK_1202_ADM dm = (HD_HLYWRK_1202_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.hlywrk.ds.HD_HLYWRK_1202_ADataSet();
	}
...
/* 작성시간 : Thu Nov 19 16:03:10 KST 2009 */