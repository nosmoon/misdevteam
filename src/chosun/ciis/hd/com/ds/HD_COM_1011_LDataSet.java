...
public class HD_COM_1011_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_COM_1011_LDataSet(){}
	public HD_COM_1011_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_COM_1011_LCURLISTRecord rec = new HD_COM_1011_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_COM_1001_LCURLISTRecord curlistRec = (HD_COM_1001_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
