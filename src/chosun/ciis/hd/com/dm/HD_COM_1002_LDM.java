...
public class HD_COM_1002_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_COM_1002_LDM(){}
	public HD_COM_1002_LDM(String cmpy_cd, String emp_no, String nm_korn, String dept_cd, String emp_clsf_cd, String lvcmpy){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_COM_1002_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_COM_1002_LDM dm = (HD_COM_1002_LDM)bdm;
		...
		cstmt.setString(8, dm.lvcmpy);
		cstmt.registerOutParameter(9, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new HD_COM_1002_LDataSet();
	}
...
/* 작성시간 : Wed Aug 04 10:32:26 KST 2010 */