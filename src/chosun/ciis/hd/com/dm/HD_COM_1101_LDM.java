...
public class HD_COM_1101_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_COM_1101_LDM(){}
	public HD_COM_1101_LDM(String cmpy_cd, String search_tag, String dept_cd, String abrv_nm){
	...
	public String getSQL(){
		 return "{ call SP_HD_COM_1101_L( ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_COM_1101_LDM dm = (HD_COM_1101_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.com.ds.HD_COM_1101_LDataSet();
	}
