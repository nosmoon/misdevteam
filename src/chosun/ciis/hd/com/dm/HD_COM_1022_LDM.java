...
public class HD_COM_1022_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_COM_1022_LDM(){}
	public HD_COM_1022_LDM(String cmpy_cd, String emp_no, String nm_korn, String dept_cd, String emp_clsf_cd, String lvcmpy){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_COM_1022_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_COM_1022_LDM dm = (HD_COM_1022_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_COM_1022_LDataSet();
	}
