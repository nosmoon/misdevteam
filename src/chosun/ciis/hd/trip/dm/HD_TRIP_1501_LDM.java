...
public class HD_TRIP_1501_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_TRIP_1501_LDM(){}
	public HD_TRIP_1501_LDM(String cmpy_cd, String occr_dt, String seq, String with_seq, String emp_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_TRIP_1501_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_TRIP_1501_LDM dm = (HD_TRIP_1501_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.occr_dt);
		cstmt.setString(5, dm.seq);
		cstmt.setString(6, dm.with_seq);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.trip.ds.HD_TRIP_1501_LDataSet();
	}
