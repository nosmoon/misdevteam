...
public class HD_TRIP_1100_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_TRIP_1100_LDM(){}
	public HD_TRIP_1100_LDM(String cmpy_cd, String fr_dt, String to_dt, String actu_slip_no, String proc_stat, String emp_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_TRIP_1100_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_TRIP_1100_LDM dm = (HD_TRIP_1100_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.trip.ds.HD_TRIP_1100_LDataSet();
	}
