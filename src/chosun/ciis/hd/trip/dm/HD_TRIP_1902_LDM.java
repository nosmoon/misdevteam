...
public class HD_TRIP_1902_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_TRIP_1902_LDM(){}
	public HD_TRIP_1902_LDM(String cmpy_cd, String busi_trip_frdt, String busi_trip_todt, String proc_stat, String actu_slip_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_TRIP_1902_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_TRIP_1902_LDM dm = (HD_TRIP_1902_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.trip.ds.HD_TRIP_1902_LDataSet();
	}
