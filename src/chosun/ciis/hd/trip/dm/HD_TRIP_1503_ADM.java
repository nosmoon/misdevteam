...
public class HD_TRIP_1503_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_TRIP_1503_ADM(){}
	public HD_TRIP_1503_ADM(String mode, String cmpy_cd, String emp_no, String occr_dt, String seq, String with_seq, String flnm, String dept_cd, String dty_cd, String posi_cd, String busi_trip_purp, String busi_trip_dest, String busi_trip_frdt, String busi_trip_todt, String busi_trip_dds, String invit_instt, String busi_trip_fee_burd_clsf, String busi_trip_neces, String aviat_fee, String fix_aviat_fee, String adjm_aviat_fee, String stay_fee, String fix_stay_fee, String adjm_stay_fee, String dd_fee, String fix_dd_fee, String adjm_dd_fee, String ceph_use_yn, String busi_trip_fee_stot, String remk, String proc_stat, String genl_affrs_clsf, String g_mode, String g_cmpy_cd, String g_emp_no, String g_occr_dt, String g_seq, String g_with_seq, String g_flnm, String g_dept_cd, String g_dty_cd, String g_posi_cd, String g_cost_fix_clsf, String d_mode, String d_cmpy_cd, String d_emp_no, String d_occr_dt, String d_seq, String d_sub_seq, String d_with_seq, String d_start_area, String d_midl_start_dt, String d_dest, String d_busi_trip_cont, String e_mode, String e_cmpy_cd, String e_emp_no, String e_occr_dt, String e_seq, String e_sub_seq, String e_with_seq, String e_etc_cost_ptcr, String e_etc_cost, String e_fix_etc_cost, String e_adjm_etc_cost, String e_etc_cost_neces, String u_ipadd, String u_id){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_TRIP_1503_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_TRIP_1503_ADM dm = (HD_TRIP_1503_ADM)bdm;
		...
		cstmt.setString(13, dm.busi_trip_purp);
		cstmt.setString(14, dm.busi_trip_dest);
		cstmt.setString(15, dm.busi_trip_frdt);
		cstmt.setString(16, dm.busi_trip_todt);
		cstmt.setString(17, dm.busi_trip_dds);
		cstmt.setString(18, dm.invit_instt);
		cstmt.setString(19, dm.busi_trip_fee_burd_clsf);
		cstmt.setString(20, dm.busi_trip_neces);
		cstmt.setString(21, dm.aviat_fee);
		cstmt.setString(22, dm.fix_aviat_fee);
		cstmt.setString(23, dm.adjm_aviat_fee);
		cstmt.setString(24, dm.stay_fee);
		cstmt.setString(25, dm.fix_stay_fee);
		cstmt.setString(26, dm.adjm_stay_fee);
		cstmt.setString(27, dm.dd_fee);
		cstmt.setString(28, dm.fix_dd_fee);
		cstmt.setString(29, dm.adjm_dd_fee);
		cstmt.setString(30, dm.ceph_use_yn);
		cstmt.setString(31, dm.busi_trip_fee_stot);
		cstmt.setString(32, dm.remk);
		cstmt.setString(33, dm.proc_stat);
		cstmt.setString(34, dm.genl_affrs_clsf);
		cstmt.setString(35, dm.g_mode);
		cstmt.setString(36, dm.g_cmpy_cd);
		cstmt.setString(37, dm.g_emp_no);
		cstmt.setString(38, dm.g_occr_dt);
		cstmt.setString(39, dm.g_seq);
		cstmt.setString(40, dm.g_with_seq);
		cstmt.setString(41, dm.g_flnm);
		cstmt.setString(42, dm.g_dept_cd);
		cstmt.setString(43, dm.g_dty_cd);
		cstmt.setString(44, dm.g_posi_cd);
		cstmt.setString(45, dm.g_cost_fix_clsf);
		cstmt.setString(46, dm.d_mode);
		cstmt.setString(47, dm.d_cmpy_cd);
		cstmt.setString(48, dm.d_emp_no);
		cstmt.setString(49, dm.d_occr_dt);
		cstmt.setString(50, dm.d_seq);
		cstmt.setString(51, dm.d_sub_seq);
		cstmt.setString(52, dm.d_with_seq);
		cstmt.setString(53, dm.d_start_area);
		cstmt.setString(54, dm.d_midl_start_dt);
		cstmt.setString(55, dm.d_dest);
		cstmt.setString(56, dm.d_busi_trip_cont);
		cstmt.setString(57, dm.e_mode);
		cstmt.setString(58, dm.e_cmpy_cd);
		cstmt.setString(59, dm.e_emp_no);
		cstmt.setString(60, dm.e_occr_dt);
		cstmt.setString(61, dm.e_seq);
		cstmt.setString(62, dm.e_sub_seq);
		cstmt.setString(63, dm.e_with_seq);
		cstmt.setString(64, dm.e_etc_cost_ptcr);
		cstmt.setString(65, dm.e_etc_cost);
		cstmt.setString(66, dm.e_fix_etc_cost);
		cstmt.setString(67, dm.e_adjm_etc_cost);
		cstmt.setString(68, dm.e_etc_cost_neces);
		cstmt.setString(69, dm.u_ipadd);
		cstmt.setString(70, dm.u_id);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.trip.ds.HD_TRIP_1503_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("g_cost_fix_clsf = [" + getG_cost_fix_clsf() + "]");
...
String g_cost_fix_clsf = req.getParameter("g_cost_fix_clsf");
if( g_cost_fix_clsf == null){
	System.out.println(this.toString+" : g_cost_fix_clsf is null" );
}else{
	System.out.println(this.toString+" : g_cost_fix_clsf is "+g_cost_fix_clsf );
}
...
String g_cost_fix_clsf = Util.checkString(req.getParameter("g_cost_fix_clsf"));
...
String g_cost_fix_clsf = Util.Uni2Ksc(Util.checkString(req.getParameter("g_cost_fix_clsf")));
...
dm.setG_cost_fix_clsf(g_cost_fix_clsf);
dm.setD_mode(d_mode);
...
/* 작성시간 : Tue May 12 10:52:13 KST 2009 */