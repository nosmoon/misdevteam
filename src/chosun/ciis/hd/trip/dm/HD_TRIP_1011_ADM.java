...
public class HD_TRIP_1011_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_TRIP_1011_ADM(){}
	public HD_TRIP_1011_ADM(String cmpy_cd, String emp_no, String mode, String proc_stat, String occr_dt, String seq){		
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_TRIP_1011_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_TRIP_1011_ADM dm = (HD_TRIP_1011_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.trip.ds.HD_TRIP_1011_ADataSet();
	}
