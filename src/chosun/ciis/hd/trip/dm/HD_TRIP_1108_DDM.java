...
public class HD_TRIP_1108_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_TRIP_1108_DDM(){}
	public HD_TRIP_1108_DDM(String mode, String cmpy_cd, String slip_proc_mang_dt, String slip_proc_mang_seq, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String slip_incmg_pers, String slip_incmg_pers_ipadd, String incmg_pers_ipadd, String ss_emp_no){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_TRIP_1108_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_TRIP_1108_DDM dm = (HD_TRIP_1108_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.trip.ds.HD_TRIP_1108_DDataSet();
	}
...
/* 작성시간 : Wed Sep 02 03:40:08 KST 2009 */