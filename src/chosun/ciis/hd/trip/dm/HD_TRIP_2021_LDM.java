...
public class HD_TRIP_2021_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String aply_basi_dt;

	public HD_TRIP_2021_LDM(){}
	public HD_TRIP_2021_LDM(String cmpy_cd, String aply_basi_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_TRIP_2021_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_TRIP_2021_LDM dm = (HD_TRIP_2021_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.trip.ds.HD_TRIP_2021_LDataSet();
	}
