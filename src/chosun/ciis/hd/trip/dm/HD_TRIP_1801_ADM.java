...
public class HD_TRIP_1801_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_TRIP_1801_ADM(){}
	public HD_TRIP_1801_ADM(String mode, String cmpy_cd, String slip_proc_mang_dt, String slip_proc_mang_seq, String u_ipadd, String u_id){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_TRIP_1801_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_TRIP_1801_ADM dm = (HD_TRIP_1801_ADM)bdm;
		...
		cstmt.setString(7, dm.u_ipadd);
		cstmt.setString(8, dm.u_id);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.trip.ds.HD_TRIP_1801_ADataSet();
	}
