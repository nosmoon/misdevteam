...
public class HD_TRIP_1103_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_TRIP_1103_ADM(){}
	public HD_TRIP_1103_ADM(String mode, String emp_no, String busi_trip_fee_stot, String dd_fee, String dd_stay_fee, String trff_fee, String cmpy_cd, String occr_dt, String seq, String mode_tm, String emp_no_tm, String busi_trip_dt_tm, String start_area_tm, String via_area_tm, String ariv_area_tm, String stay_area_tm, String path_clsf_tm, String dd_fee_tm, String stay_clsf_tm, String stay_fee_tm, String occr_dt_tm, String seq_tm, String sub_seq_tm, String cmpy_cd_tm, String trff_means_cd_tm, String trff_means_etc_tm, String incmg_pers){
		this.mode = mode;
		this.emp_no = emp_no;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_TRIP_1103_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_TRIP_1103_ADM dm = (HD_TRIP_1103_ADM)bdm;
		...
		cstmt.setString(7, dm.dd_stay_fee);
		cstmt.setString(8, dm.trff_fee);
		cstmt.setString(9, dm.cmpy_cd);
		cstmt.setString(10, dm.occr_dt);
		cstmt.setString(11, dm.seq);
		cstmt.setString(12, dm.mode_tm);
		cstmt.setString(13, dm.emp_no_tm);
		cstmt.setString(14, dm.busi_trip_dt_tm);
		cstmt.setString(15, dm.start_area_tm);
		cstmt.setString(16, dm.via_area_tm);
		cstmt.setString(17, dm.ariv_area_tm);
		cstmt.setString(18, dm.stay_area_tm);
		cstmt.setString(19, dm.path_clsf_tm);
		cstmt.setString(20, dm.dd_fee_tm);
		cstmt.setString(21, dm.stay_clsf_tm);
		cstmt.setString(22, dm.stay_fee_tm);
		cstmt.setString(23, dm.occr_dt_tm);
		cstmt.setString(24, dm.seq_tm);
		cstmt.setString(25, dm.sub_seq_tm);
		cstmt.setString(26, dm.cmpy_cd_tm);
		cstmt.setString(27, dm.trff_means_cd_tm);
		cstmt.setString(28, dm.trff_means_etc_tm);
		cstmt.setString(29, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.trip.ds.HD_TRIP_1103_ADataSet();
	}
...
/* 작성시간 : Tue Aug 18 20:22:58 KST 2009 */