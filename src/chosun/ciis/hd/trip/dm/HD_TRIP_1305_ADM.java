...
public class HD_TRIP_1305_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_TRIP_1305_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_TRIP_1305_ADM dm = (HD_TRIP_1305_ADM)bdm;
		...
		cstmt.setString(11, dm.with_seq);
		...
		cstmt.setString(17, dm.busi_trip_purp);
		cstmt.setString(18, dm.busi_trip_dest);
		cstmt.setString(19, dm.busi_trip_frdt);
		cstmt.setString(20, dm.busi_trip_todt);
		cstmt.setString(21, dm.busi_trip_dds);
		cstmt.setString(22, dm.invit_instt);
		cstmt.setString(23, dm.busi_trip_fee_burd_clsf);
		cstmt.setString(24, dm.busi_trip_neces);
		cstmt.setString(25, dm.aviat_fee);
		cstmt.setString(26, dm.stay_fee);
		cstmt.setString(27, dm.dd_fee);
		cstmt.setString(28, dm.ceph_use_yn);
		cstmt.setString(29, dm.busi_trip_fee_stot);
		cstmt.setString(30, dm.via_area);
		cstmt.setString(31, dm.remk);
		cstmt.setString(32, dm.proc_stat);
		cstmt.setString(33, dm.genl_affrs_clsf);
		cstmt.setString(34, dm.g_mode);
		cstmt.setString(35, dm.g_cmpy_cd);
		cstmt.setString(36, dm.g_emp_no);
		cstmt.setString(37, dm.g_occr_dt);
		cstmt.setString(38, dm.g_seq);
		cstmt.setString(39, dm.g_with_seq);
		cstmt.setString(40, dm.g_flnm);
		cstmt.setString(41, dm.g_dept_cd);
		cstmt.setString(42, dm.g_dty_cd);
		cstmt.setString(43, dm.g_posi_cd);
		cstmt.setString(44, dm.d_mode);
		cstmt.setString(45, dm.d_cmpy_cd);
		cstmt.setString(46, dm.d_emp_no);
		cstmt.setString(47, dm.d_occr_dt);
		cstmt.setString(48, dm.d_seq);
		cstmt.setString(49, dm.d_sub_seq);
		cstmt.setString(50, dm.d_with_seq);
		cstmt.setString(51, dm.d_start_area);
		cstmt.setString(52, dm.d_midl_start_dt);
		cstmt.setString(53, dm.d_dest);
		cstmt.setString(54, dm.d_busi_trip_cont);
		cstmt.setString(55, dm.e_mode);
		cstmt.setString(56, dm.e_cmpy_cd);
		cstmt.setString(57, dm.e_emp_no);
		cstmt.setString(58, dm.e_occr_dt);
		cstmt.setString(59, dm.e_seq);
		cstmt.setString(60, dm.e_sub_seq);
		cstmt.setString(61, dm.e_with_seq);
		cstmt.setString(62, dm.e_etc_cost_ptcr);
		cstmt.setString(63, dm.e_etc_cost);
		cstmt.setString(64, dm.e_etc_cost_neces);
		cstmt.setString(65, dm.u_ipadd);
		cstmt.setString(66, dm.u_id);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.trip.ds.HD_TRIP_1305_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("via_area = [" + getVia_area() + "]");
...
String via_area = req.getParameter("via_area");
if( via_area == null){
	System.out.println(this.toString+" : via_area is null" );
}else{
	System.out.println(this.toString+" : via_area is "+via_area );
}
...
String via_area = Util.checkString(req.getParameter("via_area"));
...
String via_area = Util.Uni2Ksc(Util.checkString(req.getParameter("via_area")));
...
/* 작성시간 : Sat Aug 22 16:30:57 KST 2009 */