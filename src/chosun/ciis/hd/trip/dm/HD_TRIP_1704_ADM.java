...
public class HD_TRIP_1704_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_TRIP_1704_ADM(){}
	public HD_TRIP_1704_ADM(String mode, String cmpy_cd, String emp_no, String occr_dt, String seq, String flnm, String dept_cd, String dty_cd, String posi_cd, String busi_trip_frdt, String busi_trip_todt, String busi_trip_purp, String dd_fee, String busi_trip_dds, String busi_trip_fee_stot, String stay_area, String stay_clsf, String slip_proc_mang_seq, String slip_proc_mang_dt, String u_ipadd, String u_id){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_TRIP_1704_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_TRIP_1704_ADM dm = (HD_TRIP_1704_ADM)bdm;
		...
		cstmt.setString(20, dm.slip_proc_mang_seq);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.trip.ds.HD_TRIP_1704_ADataSet();
	}
...
/* 작성시간 : Tue Jul 21 22:26:29 KST 2009 */