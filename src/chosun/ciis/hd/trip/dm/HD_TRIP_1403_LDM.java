...
public class HD_TRIP_1403_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String proc_stat_clsf;
	public String cmpy_cd;
	public String emp_no;

	public HD_TRIP_1403_LDM(){}
	public HD_TRIP_1403_LDM(String proc_stat_clsf, String cmpy_cd, String emp_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_TRIP_1403_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_TRIP_1403_LDM dm = (HD_TRIP_1403_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.trip.ds.HD_TRIP_1403_LDataSet();
	}
