...
public class HD_TRIP_1702_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_TRIP_1702_ADM(){}
	public HD_TRIP_1702_ADM(String mode, String cmpy_cd, String emp_no, String occr_dt, String seq, String flnm, String dept_cd, String dty_cd, String posi_cd, String busi_trip_frdt, String busi_trip_todt, String busi_trip_purp, String dd_fee, String busi_trip_dds, String busi_trip_fee_stot, String stay_area, String stay_clsf, String u_ipadd, String u_id){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_TRIP_1702_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_TRIP_1702_ADM dm = (HD_TRIP_1702_ADM)bdm;
		...
		cstmt.setString(20, dm.u_ipadd);
		cstmt.setString(21, dm.u_id);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.trip.ds.HD_TRIP_1702_ADataSet();
	}
...
/* 작성시간 : Thu May 07 13:36:38 KST 2009 */