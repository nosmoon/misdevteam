...
public class HD_TRIP_1010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_TRIP_1010_LDM(){}
	public HD_TRIP_1010_LDM(String cmpy_cd, String emp_no, String busi_trip_frdt, String busi_trip_todt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_TRIP_1010_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_TRIP_1010_LDM dm = (HD_TRIP_1010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.trip.ds.HD_TRIP_1010_LDataSet();
	}
