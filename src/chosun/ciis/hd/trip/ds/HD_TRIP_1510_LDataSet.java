...
public class HD_TRIP_1510_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_TRIP_1510_LDataSet(){}
	public HD_TRIP_1510_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_TRIP_1510_LCURLISTRecord rec = new HD_TRIP_1510_LCURLISTRecord();
...
<%
	HD_TRIP_1510_LDataSet ds = (HD_TRIP_1510_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_TRIP_1510_LCURLISTRecord curlistRec = (HD_TRIP_1510_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
