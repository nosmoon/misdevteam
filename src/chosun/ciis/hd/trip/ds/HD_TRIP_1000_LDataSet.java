...
public class HD_TRIP_1000_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public HD_TRIP_1000_LDataSet(){}
	public HD_TRIP_1000_LDataSet(String errcode, String errmsg, String xx_trff_means_cd){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_TRIP_1000_LCURLIST1Record rec = new HD_TRIP_1000_LCURLIST1Record();
		...
		while(rset1.next()){
			HD_TRIP_1000_LCURLIST2Record rec = new HD_TRIP_1000_LCURLIST2Record();
		...
		while(rset2.next()){
			HD_TRIP_1000_LCURLIST3Record rec = new HD_TRIP_1000_LCURLIST3Record();
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		HD_TRIP_1000_LCURLIST1Record curlist1Rec = (HD_TRIP_1000_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		HD_TRIP_1000_LCURLIST2Record curlist2Rec = (HD_TRIP_1000_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		HD_TRIP_1000_LCURLIST3Record curlist3Rec = (HD_TRIP_1000_LCURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>
