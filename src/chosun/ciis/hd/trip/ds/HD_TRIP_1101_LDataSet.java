...
public class HD_TRIP_1101_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist2 = new ArrayList();
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_TRIP_1101_LDataSet(){}
	public HD_TRIP_1101_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_TRIP_1101_LCURLISTRecord rec = new HD_TRIP_1101_LCURLISTRecord();
		...
		while(rset1.next()){
			HD_TRIP_1101_LCURLIST2Record rec = new HD_TRIP_1101_LCURLIST2Record();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_TRIP_1101_LCURLISTRecord curlistRec = (HD_TRIP_1101_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		HD_TRIP_1101_LCURLIST2Record curlist2Rec = (HD_TRIP_1101_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>
