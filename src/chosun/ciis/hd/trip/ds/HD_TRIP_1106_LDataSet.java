...
public class HD_TRIP_1106_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_TRIP_1106_LDataSet(){}
	public HD_TRIP_1106_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_TRIP_1106_LCURLISTRecord rec = new HD_TRIP_1106_LCURLISTRecord();
...
<%
	HD_TRIP_1106_LDataSet ds = (HD_TRIP_1106_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_TRIP_1106_LCURLISTRecord curlistRec = (HD_TRIP_1106_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Thu May 14 16:34:13 KST 2009 */