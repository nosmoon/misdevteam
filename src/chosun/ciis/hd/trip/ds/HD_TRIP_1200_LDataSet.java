...
public class HD_TRIP_1200_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_TRIP_1200_LDataSet(){}
	public HD_TRIP_1200_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_TRIP_1200_LCURLISTRecord rec = new HD_TRIP_1200_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_TRIP_1200_LCURLISTRecord curlistRec = (HD_TRIP_1200_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
