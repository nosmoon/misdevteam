...
public class HD_PRSN_2010_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_PRSN_2010_ADM(){}
	public HD_PRSN_2010_ADM(String cmpy_cd, String emp_no, String flnm, String dept_cd, String dty_cd, String posi_cd, String pgm_id, String pgm_nm, String pgm_url, String job_clsf, String annc_frdt, String annc_todt, String annc_cont, String annc_clsf, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_PRSN_2010_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_PRSN_2010_ADM dm = (HD_PRSN_2010_ADM)bdm;
		...
		cstmt.setString(15, dm.annc_cont);
		cstmt.setString(16, dm.annc_clsf);
		cstmt.setString(17, dm.incmg_pers_ipadd);
		cstmt.setString(18, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.prsn.ds.HD_PRSN_2010_ADataSet();
	}
...
/* 작성시간 : Thu Jul 30 14:30:36 KST 2009 */