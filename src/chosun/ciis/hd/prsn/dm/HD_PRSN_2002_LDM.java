...
public class HD_PRSN_2002_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String pgm_id;

	public HD_PRSN_2002_LDM(){}
	public HD_PRSN_2002_LDM(String cmpy_cd, String pgm_id){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_PRSN_2002_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_PRSN_2002_LDM dm = (HD_PRSN_2002_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.prsn.ds.HD_PRSN_2002_LDataSet();
	}
