...
public class HD_PRSN_6002_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_PRSN_6002_ADM(){}
	public HD_PRSN_6002_ADM(String cmpy_cd, String mode, String seq, String obj_dept_cd, String obj_emp_no, String prv_aprv_emp_no, String aft_aprv_emp_no, String fr_dt, String to_dt, String use_yn, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_PRSN_6002_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_PRSN_6002_ADM dm = (HD_PRSN_6002_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.prsn.ds.HD_PRSN_6002_ADataSet();
	}
...
/* 작성시간 : Tue Aug 07 13:48:51 KST 2018 */