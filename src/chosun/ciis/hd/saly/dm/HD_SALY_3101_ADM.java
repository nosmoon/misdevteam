...
public class HD_SALY_3101_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SALY_3101_ADM(){}
	public HD_SALY_3101_ADM(String cmpy_cd, String mode, String saly_yy, String saly_no, String emp_no, String flnm, String dept_cd, String dty_cd, String posi_cd, String park_fee_dduc, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_3101_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_3101_ADM dm = (HD_SALY_3101_ADM)bdm;
		...
		cstmt.setString(12, dm.park_fee_dduc);
		cstmt.setString(13, dm.incmg_pers_ipadd);
		cstmt.setString(14, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_3101_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("park_fee_dduc = [" + getPark_fee_dduc() + "]");
...
String park_fee_dduc = req.getParameter("park_fee_dduc");
if( park_fee_dduc == null){
	System.out.println(this.toString+" : park_fee_dduc is null" );
}else{
	System.out.println(this.toString+" : park_fee_dduc is "+park_fee_dduc );
}
...
String park_fee_dduc = Util.checkString(req.getParameter("park_fee_dduc"));
...
String park_fee_dduc = Util.Uni2Ksc(Util.checkString(req.getParameter("park_fee_dduc")));
...
dm.setPark_fee_dduc(park_fee_dduc);
dm.setIncmg_pers_ipadd(incmg_pers_ipadd);
dm.setIncmg_pers(incmg_pers);
----------------------------------------------------------------------------------------------------*/


/* 작성시간 : Wed May 06 11:41:02 KST 2009 */