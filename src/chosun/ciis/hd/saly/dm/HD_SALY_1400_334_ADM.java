...
public class HD_SALY_1400_334_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SALY_1400_334_ADM(){}
	public HD_SALY_1400_334_ADM(String cmpy_cd, String saly_yy, String saly_no, String saly_pay_dt, String appmt_dt, String sgyb, String incmg_pers_ipadd, String incmg_pers){
	...
	public void setSgyb(String sgyb){
		this.sgyb = sgyb;
	}
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_1400_334_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_1400_334_ADM dm = (HD_SALY_1400_334_ADM)bdm;
		...
		cstmt.setString(8, dm.sgyb);
		cstmt.setString(9, dm.incmg_pers_ipadd);
		cstmt.setString(10, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_1400_334_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("sgyb = [" + getSgyb() + "]");
...
String sgyb = req.getParameter("sgyb");
if( sgyb == null){
	System.out.println(this.toString+" : sgyb is null" );
}else{
	System.out.println(this.toString+" : sgyb is "+sgyb );
}
...
String sgyb = Util.checkString(req.getParameter("sgyb"));
...
String sgyb = Util.Uni2Ksc(Util.checkString(req.getParameter("sgyb")));
...
/* 작성시간 : Thu Jul 10 18:47:34 KST 2014 */