...
public class HD_SALY_3315_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String saly_yy;
	public String saly_no;
	public String saly_pay_dt;
	public String tmp_clsf;
	public String incmg_pers_ipadd;
	public String incmg_pers;

	public HD_SALY_3315_ADM(){}
	public HD_SALY_3315_ADM(String cmpy_cd, String saly_yy, String saly_no, String saly_pay_dt, String tmp_clsf, String incmg_pers_ipadd, String incmg_pers){
		this.cmpy_cd = cmpy_cd;
		this.saly_yy = saly_yy;
		this.saly_no = saly_no;
		this.saly_pay_dt = saly_pay_dt;
		this.tmp_clsf = tmp_clsf;
	...
	public void setTmp_clsf(String tmp_clsf){
		this.tmp_clsf = tmp_clsf;
	}
	...
	public String getTmp_clsf(){
		return this.tmp_clsf;
	}
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_3315_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_3315_ADM dm = (HD_SALY_3315_ADM)bdm;
		...
		cstmt.setString(7, dm.tmp_clsf);
		cstmt.setString(8, dm.incmg_pers_ipadd);
		cstmt.setString(9, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_3315_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("tmp_clsf = [" + getTmp_clsf() + "]");
...
String tmp_clsf = req.getParameter("tmp_clsf");
if( tmp_clsf == null){
	System.out.println(this.toString+" : tmp_clsf is null" );
}else{
	System.out.println(this.toString+" : tmp_clsf is "+tmp_clsf );
}
...
String tmp_clsf = Util.checkString(req.getParameter("tmp_clsf"));
...
String tmp_clsf = Util.Uni2Ksc(Util.checkString(req.getParameter("tmp_clsf")));
...
dm.setTmp_clsf(tmp_clsf);
dm.setIncmg_pers_ipadd(incmg_pers_ipadd);
dm.setIncmg_pers(incmg_pers);
----------------------------------------------------------------------------------------------------*/


/* 작성시간 : Thu Aug 27 19:50:06 KST 2009 */