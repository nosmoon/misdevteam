...
public class HD_SALY_4500_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SALY_4500_ADM(){}
	public HD_SALY_4500_ADM(String cmpy_cd, String saly_yy, String saly_pay_dt, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_4500_A(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_4500_ADM dm = (HD_SALY_4500_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.saly_yy);
		cstmt.setString(5, dm.saly_pay_dt);
		cstmt.setString(6, dm.incmg_pers_ipadd);
		cstmt.setString(7, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_4500_ADataSet();
	}
...
/* 작성시간 : Tue Dec 17 19:11:47 KST 2013 */