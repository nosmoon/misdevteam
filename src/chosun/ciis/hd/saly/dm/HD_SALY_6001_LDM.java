...
public class HD_SALY_6001_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SALY_6001_LDM(){}
	public HD_SALY_6001_LDM(String cmpy_cd, String emp_no, String lvcmpy_dt, String emp_clsf){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_6001_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_6001_LDM dm = (HD_SALY_6001_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_SALY_6001_LDataSet();
	}
...
/* 작성시간 : Wed Nov 17 13:59:45 KST 2010 */