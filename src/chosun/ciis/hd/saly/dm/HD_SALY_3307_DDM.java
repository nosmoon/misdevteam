...
public class HD_SALY_3307_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SALY_3307_DDM(){}
	public HD_SALY_3307_DDM(String cmpy_cd, String saly_yy, String saly_no, String saly_pay_dt, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_3307_D(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_3307_DDM dm = (HD_SALY_3307_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_3307_DDataSet();
	}
...
/* 작성시간 : Thu May 21 14:56:12 KST 2009 */