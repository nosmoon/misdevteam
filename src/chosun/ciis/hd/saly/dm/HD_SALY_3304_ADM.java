...
public class HD_SALY_3304_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SALY_3304_ADM(){}
	public HD_SALY_3304_ADM(String cmpy_cd, String saly_yy, String saly_no, String saly_pay_dt, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_3304_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_3304_ADM dm = (HD_SALY_3304_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_3304_ADataSet();
	}
...
/* 작성시간 : Wed May 20 14:35:37 KST 2009 */