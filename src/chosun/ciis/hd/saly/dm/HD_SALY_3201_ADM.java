...
public class HD_SALY_3201_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String base_stay_fee;
	public String incmg_pers_ipadd;
	public String incmg_pers;

	public HD_SALY_3201_ADM(){}
	public HD_SALY_3201_ADM(String cmpy_cd, String mode, String saly_yy, String saly_no, String emp_no, String flnm, String dept_cd, String dty_cd, String posi_cd, String base_stay_fee, String incmg_pers_ipadd, String incmg_pers){
		...
		this.base_stay_fee = base_stay_fee;
	...
	public void setBase_stay_fee(String base_stay_fee){
		this.base_stay_fee = base_stay_fee;
	}
	...
	public String getBase_stay_fee(){
		return this.base_stay_fee;
	}
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_3201_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_3201_ADM dm = (HD_SALY_3201_ADM)bdm;
		...
		cstmt.setString(12, dm.base_stay_fee);
		cstmt.setString(13, dm.incmg_pers_ipadd);
		cstmt.setString(14, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_3201_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("base_stay_fee = [" + getBase_stay_fee() + "]");
...
String base_stay_fee = req.getParameter("base_stay_fee");
if( base_stay_fee == null){
	System.out.println(this.toString+" : base_stay_fee is null" );
}else{
	System.out.println(this.toString+" : base_stay_fee is "+base_stay_fee );
}
...
String base_stay_fee = Util.checkString(req.getParameter("base_stay_fee"));
...
String base_stay_fee = Util.Uni2Ksc(Util.checkString(req.getParameter("base_stay_fee")));
...
dm.setBase_stay_fee(base_stay_fee);
dm.setIncmg_pers_ipadd(incmg_pers_ipadd);
dm.setIncmg_pers(incmg_pers);
----------------------------------------------------------------------------------------------------*/


/* 작성시간 : Wed May 06 14:12:28 KST 2009 */