...
public class HD_SALY_3300_A_GYSGDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SALY_3300_A_GYSGDM(){}
	public HD_SALY_3300_A_GYSGDM(String cmpy_cd, String saly_yy, String saly_no, String saly_pay_dt, String year_rfl_yn, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_3300_A_GYSG(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_3300_A_GYSGDM dm = (HD_SALY_3300_A_GYSGDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_3300_A_GYSGDataSet();
	}
...
/* 작성시간 : Tue Dec 10 13:48:42 KST 2013 */