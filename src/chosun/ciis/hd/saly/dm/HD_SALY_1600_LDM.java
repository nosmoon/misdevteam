...
public class HD_SALY_1600_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String emp_no;
	public String nm_korn;

	public HD_SALY_1600_LDM(){}
	public HD_SALY_1600_LDM(String cmpy_cd, String emp_no, String nm_korn){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_1600_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_1600_LDM dm = (HD_SALY_1600_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_1600_LDataSet();
	}
