...
public class HD_SALY_3313_PDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SALY_3313_PDM(){}
	public HD_SALY_3313_PDM(String cmpy_cd, String saly_yy, String saly_no, String saly_pay_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_3313_P(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_3313_PDM dm = (HD_SALY_3313_PDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_3313_PDataSet();
	}
