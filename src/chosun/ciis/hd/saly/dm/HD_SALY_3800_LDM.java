...
public class HD_SALY_3800_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String saly_yy;
	public String saly_no;

	public HD_SALY_3800_LDM(){}
	public HD_SALY_3800_LDM(String cmpy_cd, String saly_yy, String saly_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_3800_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_3800_LDM dm = (HD_SALY_3800_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_3800_LDataSet();
	}
