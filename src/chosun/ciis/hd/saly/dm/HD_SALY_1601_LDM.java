...
public class HD_SALY_1601_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String emp_no;
	public String saly_yy;

	public HD_SALY_1601_LDM(){}
	public HD_SALY_1601_LDM(String cmpy_cd, String emp_no, String saly_yy){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_1601_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_1601_LDM dm = (HD_SALY_1601_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_SALY_1601_LDataSet();
	}
