...
public class HD_SALY_1700_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SALY_1700_LDM(){}
	public HD_SALY_1700_LDM(String cmpy_cd, String saly_yy, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_1700_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_1700_LDM dm = (HD_SALY_1700_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_1700_LDataSet();
	}
