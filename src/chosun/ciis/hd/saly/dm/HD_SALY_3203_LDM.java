...
public class HD_SALY_3203_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SALY_3203_LDM(){}
	public HD_SALY_3203_LDM(String cmpy_cd, String saly_yy, String saly_no, String emp_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_3203_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_3203_LDM dm = (HD_SALY_3203_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_3203_LDataSet();
	}
