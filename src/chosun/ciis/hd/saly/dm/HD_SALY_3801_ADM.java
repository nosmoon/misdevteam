...
public class HD_SALY_3801_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SALY_3801_ADM(){}
	public HD_SALY_3801_ADM(String cmpy_cd, String mode, String saly_yy, String saly_no, String emp_no, String flnm, String dept_cd, String dty_cd, String posi_cd, String prsn_pens_dduc, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_3801_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_3801_ADM dm = (HD_SALY_3801_ADM)bdm;
		...
		cstmt.setString(12, dm.prsn_pens_dduc);
		cstmt.setString(13, dm.incmg_pers_ipadd);
		cstmt.setString(14, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_3801_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("prsn_pens_dduc = [" + getPrsn_pens_dduc() + "]");
...
String prsn_pens_dduc = req.getParameter("prsn_pens_dduc");
if( prsn_pens_dduc == null){
	System.out.println(this.toString+" : prsn_pens_dduc is null" );
}else{
	System.out.println(this.toString+" : prsn_pens_dduc is "+prsn_pens_dduc );
}
...
String prsn_pens_dduc = Util.checkString(req.getParameter("prsn_pens_dduc"));
...
String prsn_pens_dduc = Util.Uni2Ksc(Util.checkString(req.getParameter("prsn_pens_dduc")));
...
dm.setPrsn_pens_dduc(prsn_pens_dduc);
