...
public class HD_SALY_3311_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SALY_3311_LDM(){}
	public HD_SALY_3311_LDM(String cmpy_cd, String saly_yy, String saly_no, String saly_pay_dt, String tmp_clsf){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_3311_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_3311_LDM dm = (HD_SALY_3311_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_3311_LDataSet();
	}
...
/* 작성시간 : Fri May 22 13:56:55 KST 2009 */