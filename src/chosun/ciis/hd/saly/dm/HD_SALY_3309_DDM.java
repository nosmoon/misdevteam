...
public class HD_SALY_3309_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SALY_3309_DDM(){}
	public HD_SALY_3309_DDM(String cmpy_cd, String saly_yy, String saly_no, String saly_pay_dt, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_3309_D(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_3309_DDM dm = (HD_SALY_3309_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_3309_DDataSet();
	}
...
/* 작성시간 : Thu May 21 17:45:27 KST 2009 */