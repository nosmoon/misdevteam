...
public class HD_SALY_8102_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SALY_8102_LDM(){}
	public HD_SALY_8102_LDM(String cmpy_cd, String emp_no, String pens_aply_mm, String pens_clsf, String prsn_pens_amt, String proc_stat){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_8102_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_8102_LDM dm = (HD_SALY_8102_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_8102_LDataSet();
	}
