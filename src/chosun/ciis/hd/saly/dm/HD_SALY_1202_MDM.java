...
public class HD_SALY_1202_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String saly_yy;
	public String saly_no;

	public HD_SALY_1202_MDM(){}
	public HD_SALY_1202_MDM(String cmpy_cd, String saly_yy, String saly_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_1202_M(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_1202_MDM dm = (HD_SALY_1202_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_1202_MDataSet();
	}
