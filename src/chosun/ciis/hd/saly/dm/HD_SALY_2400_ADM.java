...
public class HD_SALY_2400_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SALY_2400_ADM(){}
	public HD_SALY_2400_ADM(String cmpy_cd, String mode, String emp_no, String base_saly){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_2400_A(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_2400_ADM dm = (HD_SALY_2400_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.mode);
		cstmt.setString(5, dm.emp_no);
		cstmt.setString(6, dm.base_saly);
		cstmt.registerOutParameter(7, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new HD_SALY_2400_ADataSet();
	}
...
/* 작성시간 : Fri Jul 30 16:56:33 KST 2010 */