...
public class HD_SALY_5005_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_SALY_5005_LDM(){}
	public HD_SALY_5005_LDM(String cmpy_cd, String emp_no, String saly_yy, String saly_no){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_5005_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_5005_LDM dm = (HD_SALY_5005_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_5005_LDataSet();
	}
