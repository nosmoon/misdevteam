...
public class HD_SALY_1501_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String incmg_pers;

	public HD_SALY_1501_MDM(){}
	public HD_SALY_1501_MDM(String cmpy_cd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_SALY_1501_M(? ,? ,? ,?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_SALY_1501_MDM dm = (HD_SALY_1501_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.saly.ds.HD_SALY_1501_MDataSet();
	}
...
/* 작성시간 : Wed Apr 22 20:56:33 KST 2009 */