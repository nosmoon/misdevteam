...
public class HD_SALY_1211_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_SALY_1211_LDataSet(){}
	public HD_SALY_1211_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_SALY_1211_LCURLISTRecord rec = new HD_SALY_1211_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_SALY_1211_LCURLISTRecord curlistRec = (HD_SALY_1211_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Tue Apr 28 16:11:08 KST 2009 */