...
public class HD_SALY_8004_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_SALY_8004_LDataSet(){}
	public HD_SALY_8004_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_SALY_8004_LCURLISTRecord rec = new HD_SALY_8004_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_SALY_8004_LCURLISTRecord curlistRec = (HD_SALY_8004_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
