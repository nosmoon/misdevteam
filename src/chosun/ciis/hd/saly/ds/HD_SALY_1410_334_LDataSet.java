...
public class HD_SALY_1410_334_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_SALY_1410_334_LDataSet(){}
	public HD_SALY_1410_334_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_SALY_1410_334_LCURLISTRecord rec = new HD_SALY_1410_334_LCURLISTRecord();
...
<%
	HD_SALY_1410_334_LDataSet ds = (HD_SALY_1410_334_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_SALY_1410_334_LCURLISTRecord curlistRec = (HD_SALY_1410_334_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Mon Apr 06 16:04:10 KST 2015 */