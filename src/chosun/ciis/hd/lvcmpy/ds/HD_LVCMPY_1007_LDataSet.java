...
public class HD_LVCMPY_1007_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist2 = new ArrayList();
	public ArrayList curlist1 = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_LVCMPY_1007_LDataSet(){}
	public HD_LVCMPY_1007_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_LVCMPY_1007_LCURLIST1Record rec = new HD_LVCMPY_1007_LCURLIST1Record();
		...
		while(rset1.next()){
			HD_LVCMPY_1007_LCURLIST2Record rec = new HD_LVCMPY_1007_LCURLIST2Record();
...
<%
	HD_LVCMPY_1007_LDataSet ds = (HD_LVCMPY_1007_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		HD_LVCMPY_1007_LCURLIST1Record curlist1Rec = (HD_LVCMPY_1007_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		HD_LVCMPY_1007_LCURLIST2Record curlist2Rec = (HD_LVCMPY_1007_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Wed Apr 29 14:46:47 KST 2009 */