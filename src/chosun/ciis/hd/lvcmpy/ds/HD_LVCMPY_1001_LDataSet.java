...
public class HD_LVCMPY_1001_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_LVCMPY_1001_LDataSet(){}
	public HD_LVCMPY_1001_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_LVCMPY_1001_LCURLISTRecord rec = new HD_LVCMPY_1001_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_LVCMPY_1001_LCURLISTRecord curlistRec = (HD_LVCMPY_1001_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
