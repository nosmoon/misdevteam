...
public class HD_LVCMPY_3300_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String estm_work_dt;

	public HD_LVCMPY_3300_LDM(){}
	public HD_LVCMPY_3300_LDM(String cmpy_cd, String estm_work_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_LVCMPY_3300_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_LVCMPY_3300_LDM dm = (HD_LVCMPY_3300_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.lvcmpy.ds.HD_LVCMPY_3300_LDataSet();
	}
