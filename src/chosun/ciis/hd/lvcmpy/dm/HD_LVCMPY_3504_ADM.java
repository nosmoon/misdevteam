...
public class HD_LVCMPY_3504_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_LVCMPY_3504_ADM(){}
	public HD_LVCMPY_3504_ADM(String cmpy_cd, String acml_dt, String u_ipadd, String u_id){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_LVCMPY_3504_A(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_LVCMPY_3504_ADM dm = (HD_LVCMPY_3504_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.lvcmpy.ds.HD_LVCMPY_3504_ADataSet();
	}
...
/* 작성시간 : Thu Oct 15 15:19:16 KST 2009 */