...
public class HD_LVCMPY_1109_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String emp_no;
	public String cmpy_cd;
	public String lvcmpy_dt;

	public HD_LVCMPY_1109_LDM(){}
	public HD_LVCMPY_1109_LDM(String emp_no, String cmpy_cd, String lvcmpy_dt){
		this.emp_no = emp_no;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_LVCMPY_1109_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_LVCMPY_1109_LDM dm = (HD_LVCMPY_1109_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.lvcmpy.ds.HD_LVCMPY_1109_LDataSet();
	}
