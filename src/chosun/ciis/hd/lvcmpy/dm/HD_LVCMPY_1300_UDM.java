...
public class HD_LVCMPY_1300_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_LVCMPY_1300_UDM(){}
	public HD_LVCMPY_1300_UDM(String cmpy_cd, String emp_no, String lvcmpy_mm_np, String lvcmpy_mm_hlth, String lvcmpy_mm_emp, String emp_insr_fee_drbk_amt, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_LVCMPY_1300_U(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_LVCMPY_1300_UDM dm = (HD_LVCMPY_1300_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.lvcmpy.ds.HD_LVCMPY_1300_UDataSet();
	}
...
/* 작성시간 : Mon May 04 15:37:34 KST 2009 */