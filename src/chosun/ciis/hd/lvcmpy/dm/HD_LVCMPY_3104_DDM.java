...
public class HD_LVCMPY_3104_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_LVCMPY_3104_DDM(){}
	public HD_LVCMPY_3104_DDM(String cmpy_cd, String estm_dt, String slip_occr_dt, String slip_occr_seq, String acml_yy, String acml_mm, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_LVCMPY_3104_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_LVCMPY_3104_DDM dm = (HD_LVCMPY_3104_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.lvcmpy.ds.HD_LVCMPY_3104_DDataSet();
	}
...
/* 작성시간 : Tue Jun 09 17:53:18 KST 2009 */