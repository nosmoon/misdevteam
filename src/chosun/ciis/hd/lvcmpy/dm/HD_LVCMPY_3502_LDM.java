...
public class HD_LVCMPY_3502_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String acml_yy;
	public String acml_mm;

	public HD_LVCMPY_3502_LDM(){}
	public HD_LVCMPY_3502_LDM(String cmpy_cd, String acml_yy, String acml_mm){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_LVCMPY_3502_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_LVCMPY_3502_LDM dm = (HD_LVCMPY_3502_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.lvcmpy.ds.HD_LVCMPY_3502_LDataSet();
	}
