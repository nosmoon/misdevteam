...
public class HD_LVCMPY_3002_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_LVCMPY_3002_ADM(){}
	public HD_LVCMPY_3002_ADM(String cmpy_cd, String estm_clsf, String estm_yy, String estm_work_dt, String emp_dtls_clsf_ratio, String emp_clsf_ratio, String estm_fr_dt, String estm_to_dt, String u_ipadd, String u_id){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_LVCMPY_3002_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_LVCMPY_3002_ADM dm = (HD_LVCMPY_3002_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.lvcmpy.ds.HD_LVCMPY_3002_ADataSet();
	}
...
/* 작성시간 : Wed Oct 28 10:16:38 KST 2009 */