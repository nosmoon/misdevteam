...
public class HD_LVCMPY_2606_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String emp_no;
	public String lvcmpy_dt;

	public HD_LVCMPY_2606_LDM(){}
	public HD_LVCMPY_2606_LDM(String cmpy_cd, String emp_no, String lvcmpy_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_LVCMPY_2606_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_LVCMPY_2606_LDM dm = (HD_LVCMPY_2606_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.lvcmpy.ds.HD_LVCMPY_2606_LDataSet();
	}
