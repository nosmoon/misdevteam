...
public class HD_LVCMPY_3001_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_LVCMPY_3001_ADM(){}
	public HD_LVCMPY_3001_ADM(String cmpy_cd, String estm_clsf, String estm_work_dt, String emp_dtls_clsf_ratio, String emp_clsf_ratio, String u_ipadd, String u_id){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_LVCMPY_3001_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_LVCMPY_3001_ADM dm = (HD_LVCMPY_3001_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.lvcmpy.ds.HD_LVCMPY_3001_ADataSet();
	}
...
/* 작성시간 : Tue Jun 02 15:34:48 KST 2009 */