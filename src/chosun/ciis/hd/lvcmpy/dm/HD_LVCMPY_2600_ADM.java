...
public class HD_LVCMPY_2600_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_LVCMPY_2600_ADM(){}
	public HD_LVCMPY_2600_ADM(String cmpy_cd, String emp_no, String lvcmpy_clsf, String lvcmpy_dt_tm, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_LVCMPY_2600_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_LVCMPY_2600_ADM dm = (HD_LVCMPY_2600_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.lvcmpy.ds.HD_LVCMPY_2600_ADataSet();
	}
...
/* 작성시간 : Wed May 20 09:46:51 KST 2009 */