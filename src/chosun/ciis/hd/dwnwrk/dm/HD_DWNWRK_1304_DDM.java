...
public class HD_DWNWRK_1304_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_DWNWRK_1304_DDM(){}
	public HD_DWNWRK_1304_DDM(String mode, String cmpy_cd, String slip_proc_mang_dt, String slip_proc_mang_seq, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String slip_incmg_pers, String slip_incmg_pers_ipadd, String incmg_pers_ipadd, String ss_emp_no){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DWNWRK_1304_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DWNWRK_1304_DDM dm = (HD_DWNWRK_1304_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.dwnwrk.ds.HD_DWNWRK_1304_DDataSet();
	}
...
/* 작성시간 : Fri May 08 09:43:02 KST 2009 */