...
public class HD_DWNWRK_1001_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String aply_basi_dt;
	public String cmpy_cd;

	public HD_DWNWRK_1001_LDM(){}
	public HD_DWNWRK_1001_LDM(String aply_basi_dt, String cmpy_cd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_DWNWRK_1001_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_DWNWRK_1001_LDM dm = (HD_DWNWRK_1001_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.dwnwrk.ds.HD_DWNWRK_1001_LDataSet();
	}
