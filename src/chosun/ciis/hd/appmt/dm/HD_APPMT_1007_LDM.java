...
public class HD_APPMT_1007_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String emp_no;
	public String nm_korn;

	public HD_APPMT_1007_LDM(){}
	public HD_APPMT_1007_LDM(String cmpy_cd, String emp_no, String nm_korn){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_APPMT_1007_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_APPMT_1007_LDM dm = (HD_APPMT_1007_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new HD_APPMT_1007_LDataSet();
	}
