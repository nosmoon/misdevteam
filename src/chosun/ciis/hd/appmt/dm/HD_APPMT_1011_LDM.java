...
public class HD_APPMT_1011_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_APPMT_1011_LDM(){}
	public HD_APPMT_1011_LDM(String cmpy_cd, String emp_no, String flnm, String appmt_cd, String dept_cd, String appmt_dt_fm, String appmt_dt_to, String appmt_stat_clsf, String lvcmpy_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_APPMT_1011_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_APPMT_1011_LDM dm = (HD_APPMT_1011_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.appmt.ds.HD_APPMT_1011_LDataSet();
	}
