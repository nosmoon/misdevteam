...
public class HD_APPMT_2001_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String emp_no;
	public String appmt_dt;

	public HD_APPMT_2001_LDM(){}
	public HD_APPMT_2001_LDM(String cmpy_cd, String emp_no, String appmt_dt){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_APPMT_2001_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_APPMT_2001_LDM dm = (HD_APPMT_2001_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.emp_no);
		cstmt.setString(5, dm.appmt_dt);
		cstmt.registerOutParameter(6, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.appmt.ds.HD_APPMT_2001_LDataSet();
	}
