...
public class HD_APPMT_1101_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_APPMT_1101_UDM(){}
	public HD_APPMT_1101_UDM(String save, String mode, String cmpy_cd, String emp_no, String flnm, String dept_cd, String addm_dept_cd, String dty_cd, String posi_cd, String appmt_cd, String appmt_resn_cd, String appmt_dt, String appmt_cont, String mtry_dt, String emp_clsf_cd, String emp_dtls_clsf, String seq, String occr_dt, String incmg_pers, String incmg_pers_ipadd){
		this.save = save;
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_APPMT_1101_U(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_APPMT_1101_UDM dm = (HD_APPMT_1101_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.appmt.ds.HD_APPMT_1101_UDataSet();
	}
...
/* 작성시간 : Fri Jul 17 18:25:35 KST 2009 */