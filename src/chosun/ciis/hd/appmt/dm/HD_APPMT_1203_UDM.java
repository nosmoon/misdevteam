...
public class HD_APPMT_1203_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_APPMT_1203_UDM(){}
	public HD_APPMT_1203_UDM(String cmpy_cd, String emp_no, String flnm, String dept_cd, String appmt_cd, String appmt_resn_cd, String appmt_dt, String mtry_dt, String emp_clsf_cd, String base_saly, String posk_saly, String saly_stot, String appmt_sort, String appmt_cont, String seq, String occr_dt, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_APPMT_1203_U(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_APPMT_1203_UDM dm = (HD_APPMT_1203_UDM)bdm;
		...
		cstmt.setString(14, dm.saly_stot);
		cstmt.setString(15, dm.appmt_sort);
		cstmt.setString(16, dm.appmt_cont);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.appmt.ds.HD_APPMT_1203_UDataSet();
	}
...
/* 작성시간 : Wed Mar 11 10:27:21 KST 2009 */