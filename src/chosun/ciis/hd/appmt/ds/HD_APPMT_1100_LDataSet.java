...
public class HD_APPMT_1100_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_APPMT_1100_LDataSet(){}
	public HD_APPMT_1100_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_APPMT_1100_LCURLISTRecord rec = new HD_APPMT_1100_LCURLISTRecord();
			...
			rec.appmt_stat_clsf_nm = Util.checkString(rset0.getString("appmt_stat_clsf_nm"));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_APPMT_1100_LCURLISTRecord curlistRec = (HD_APPMT_1100_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Tue Jun 17 11:44:21 KST 2014 */