...
public class HD_APPMT_1002_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_APPMT_1002_LDataSet(){}
	public HD_APPMT_1002_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_APPMT_1002_LCURLISTRecord rec = new HD_APPMT_1002_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_APPMT_1002_LCURLISTRecord curlistRec = (HD_APPMT_1002_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
