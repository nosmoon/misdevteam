...
public class HD_CRCL_1400_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_CRCL_1400_LDM(){}
	public HD_CRCL_1400_LDM(String cmpy_cd, String paty_crc_cd, String from_dt, String to_dt, String entr_clsf){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_CRCL_1400_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_CRCL_1400_LDM dm = (HD_CRCL_1400_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.paty_crc_cd);
		cstmt.setString(5, dm.from_dt);
		cstmt.setString(6, dm.to_dt);
		cstmt.setString(7, dm.entr_clsf);
		cstmt.registerOutParameter(8, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.crcl.ds.HD_CRCL_1400_LDataSet();
	}
