...
public class HD_CRCL_1202_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_CRCL_1202_ADM(){}
	public HD_CRCL_1202_ADM(String mode, String cmpy_cd, String emp_no, String occr_dt, String seq, String flnm, String dept_cd, String dty_cd, String posi_cd, String paty_crc_cd, String entr_dt, String lve_dt, String entr_yn, String incmg_pers_ipadd, String incmg_pers, String chg_pers){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_CRCL_1202_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_CRCL_1202_ADM dm = (HD_CRCL_1202_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.crcl.ds.HD_CRCL_1202_ADataSet();
	}
...
/* 작성시간 : Wed Feb 18 14:30:49 KST 2009 */