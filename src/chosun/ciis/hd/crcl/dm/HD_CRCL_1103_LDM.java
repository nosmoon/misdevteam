...
public class HD_CRCL_1103_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String emp_no;
	public String nm_korn;

	public HD_CRCL_1103_LDM(){}
	public HD_CRCL_1103_LDM(String cmpy_cd, String emp_no, String nm_korn){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_CRCL_1103_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_CRCL_1103_LDM dm = (HD_CRCL_1103_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.crcl.ds.HD_CRCL_1103_LDataSet();
	}
