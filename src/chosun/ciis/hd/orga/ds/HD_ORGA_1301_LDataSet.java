...
public class HD_ORGA_1301_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public HD_ORGA_1301_LDataSet(){}
	public HD_ORGA_1301_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			HD_ORGA_1301_LCURLISTRecord rec = new HD_ORGA_1301_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		HD_ORGA_1301_LCURLISTRecord curlistRec = (HD_ORGA_1301_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
