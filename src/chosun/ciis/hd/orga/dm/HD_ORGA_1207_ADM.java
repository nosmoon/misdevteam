...
public class HD_ORGA_1207_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public HD_ORGA_1207_ADM(){}
	public HD_ORGA_1207_ADM(String cmpy_cd, String orga_reorga_dd, String supr_dept_cd, String dept_cd, String level, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_ORGA_1207_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_ORGA_1207_ADM dm = (HD_ORGA_1207_ADM)bdm;
		...
		cstmt.setString(7, dm.level);
		cstmt.setString(8, dm.incmg_pers_ipadd);
		cstmt.setString(9, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.orga.ds.HD_ORGA_1207_ADataSet();
	}
...
/* 작성시간 : Thu Jun 11 17:40:56 KST 2009 */