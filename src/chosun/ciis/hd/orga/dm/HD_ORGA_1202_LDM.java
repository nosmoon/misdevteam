...
public class HD_ORGA_1202_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String orga_reorga_dd;

	public HD_ORGA_1202_LDM(){}
	public HD_ORGA_1202_LDM(String cmpy_cd, String orga_reorga_dd){
	...
	public String getSQL(){
		 return "{ call MISHDL.SP_HD_ORGA_1202_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		HD_ORGA_1202_LDM dm = (HD_ORGA_1202_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.hd.orga.ds.HD_ORGA_1202_LDataSet();
	}
