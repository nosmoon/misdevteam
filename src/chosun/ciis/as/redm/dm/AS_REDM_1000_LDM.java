...
public class AS_REDM_1000_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String redm_dt;

	public AS_REDM_1000_LDM(){}
	public AS_REDM_1000_LDM(String cmpy_cd, String redm_dt){
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_REDM_1000_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_REDM_1000_LDM dm = (AS_REDM_1000_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.redm.ds.AS_REDM_1000_LDataSet();
	}
