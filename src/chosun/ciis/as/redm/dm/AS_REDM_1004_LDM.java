...
public class AS_REDM_1004_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String redm_yymm;

	public AS_REDM_1004_LDM(){}
	public AS_REDM_1004_LDM(String cmpy_cd, String redm_yymm){
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_REDM_1004_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_REDM_1004_LDM dm = (AS_REDM_1004_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.redm.ds.AS_REDM_1004_LDataSet();
	}
