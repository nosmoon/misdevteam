...
public class AS_REDM_1503_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AS_REDM_1503_ADM(){}
	public AS_REDM_1503_ADM(String cmpy_cd, String redm_yymm, String incmg_pers_ipadd, String incmg_pers, String chg_pers){
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_REDM_1503_A(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_REDM_1503_ADM dm = (AS_REDM_1503_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.redm.ds.AS_REDM_1503_ADataSet();
	}
