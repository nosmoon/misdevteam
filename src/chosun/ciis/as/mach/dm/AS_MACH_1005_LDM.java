...
public class AS_MACH_1005_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String work_clsf;

	public AS_MACH_1005_LDM(){}
	public AS_MACH_1005_LDM(String cmpy_cd, String work_clsf){
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_MACH_1005_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_MACH_1005_LDM dm = (AS_MACH_1005_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.mach.ds.AS_MACH_1005_LDataSet();
	}
