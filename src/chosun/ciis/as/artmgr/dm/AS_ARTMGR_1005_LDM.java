...
public class AS_ARTMGR_1005_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String art_prod_no;

	public AS_ARTMGR_1005_LDM(){}
	public AS_ARTMGR_1005_LDM(String cmpy_cd, String art_prod_no){
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_ARTMGR_1005_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_ARTMGR_1005_LDM dm = (AS_ARTMGR_1005_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.artmgr.ds.AS_ARTMGR_1005_LDataSet();
	}
