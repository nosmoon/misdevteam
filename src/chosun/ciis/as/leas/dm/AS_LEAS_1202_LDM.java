...
public class AS_LEAS_1202_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String clam_yymm;
	public String clam_seq;

	public AS_LEAS_1202_LDM(){}
	public AS_LEAS_1202_LDM(String cmpy_cd, String clam_yymm, String clam_seq){
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_LEAS_1202_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_LEAS_1202_LDM dm = (AS_LEAS_1202_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.leas.ds.AS_LEAS_1202_LDataSet();
	}
