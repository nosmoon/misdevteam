...
public class AS_LEAS_1103_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_LEAS_1103_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_LEAS_1103_ADM dm = (AS_LEAS_1103_ADM)bdm;
		...
		cstmt.setString(9, dm.leas_fr_dt);
		cstmt.setString(10, dm.leas_to_dt);
		cstmt.setString(11, dm.draft_no);
		cstmt.setString(12, dm.cntr_leas_amt);
		cstmt.setString(13, dm.leas_cntr_dt);
		cstmt.setString(14, dm.cntr_mang_amt);
		cstmt.setString(15, dm.midw_expy_dt);
		cstmt.setString(16, dm.cntr_gurt_amt);
		cstmt.setString(17, dm.cntr_star);
		cstmt.setString(18, dm.leas_clam_cycl);
		cstmt.setString(19, dm.mang_clam_cycl);
		cstmt.setString(20, dm.pymt_clsf);
		cstmt.setString(21, dm.expy_remk);
		cstmt.setString(22, dm.good_clsf);
		cstmt.setString(23, dm.ser_no);
		cstmt.setString(24, dm.leas_area_size);
		cstmt.setString(25, dm.remk);
		cstmt.setString(26, dm.gurt_dlco_ern);
		cstmt.setString(27, dm.ref_cntr_no);
		cstmt.setString(28, dm.leas_dlco_ern);
		cstmt.setString(29, dm.hire_dlco_clsf_cd);
		cstmt.setString(30, dm.hire_dlco_ern);
		cstmt.setString(31, dm.end_clsf);
		cstmt.setString(32, dm.vat_non_yn);
		...
		cstmt.setString(38, dm.leas_telno1);
		cstmt.setString(39, dm.leas_telno2);
		cstmt.setString(40, dm.leas_telno3);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.leas.ds.AS_LEAS_1103_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("vat_non_yn = [" + getVat_non_yn() + "]");
		System.out.println("incmg_pers_ipadd = [" + getIncmg_pers_ipadd() + "]");
		System.out.println("incmg_pers = [" + getIncmg_pers() + "]");
		System.out.println("chg_pers = [" + getChg_pers() + "]");
		System.out.println("frex_rcpm_yn = [" + getFrex_rcpm_yn() + "]");
		System.out.println("email = [" + getEmail() + "]");
		System.out.println("leas_telno1 = [" + getLeas_telno1() + "]");
		System.out.println("leas_telno2 = [" + getLeas_telno2() + "]");
		System.out.println("leas_telno3 = [" + getLeas_telno3() + "]");
	}
}
/*----------------------------------------------------------------------------------------------------
...
String vat_non_yn = req.getParameter("vat_non_yn");
if( vat_non_yn == null){
	System.out.println(this.toString+" : vat_non_yn is null" );
}else{
	System.out.println(this.toString+" : vat_non_yn is "+vat_non_yn );
}
...
String leas_telno1 = req.getParameter("leas_telno1");
if( leas_telno1 == null){
	System.out.println(this.toString+" : leas_telno1 is null" );
}else{
	System.out.println(this.toString+" : leas_telno1 is "+leas_telno1 );
}
String leas_telno2 = req.getParameter("leas_telno2");
if( leas_telno2 == null){
	System.out.println(this.toString+" : leas_telno2 is null" );
}else{
	System.out.println(this.toString+" : leas_telno2 is "+leas_telno2 );
}
String leas_telno3 = req.getParameter("leas_telno3");
if( leas_telno3 == null){
	System.out.println(this.toString+" : leas_telno3 is null" );
}else{
	System.out.println(this.toString+" : leas_telno3 is "+leas_telno3 );
}
----------------------------------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------------------------------
...
String vat_non_yn = Util.checkString(req.getParameter("vat_non_yn"));
...
String leas_telno1 = Util.checkString(req.getParameter("leas_telno1"));
String leas_telno2 = Util.checkString(req.getParameter("leas_telno2"));
String leas_telno3 = Util.checkString(req.getParameter("leas_telno3"));
----------------------------------------------------------------------------------------------------*//*----------------------------------------------------------------------------------------------------
...
String vat_non_yn = Util.Uni2Ksc(Util.checkString(req.getParameter("vat_non_yn")));
...
String leas_telno1 = Util.Uni2Ksc(Util.checkString(req.getParameter("leas_telno1")));
String leas_telno2 = Util.Uni2Ksc(Util.checkString(req.getParameter("leas_telno2")));
String leas_telno3 = Util.Uni2Ksc(Util.checkString(req.getParameter("leas_telno3")));
----------------------------------------------------------------------------------------------------*/
...
dm.setVat_non_yn(vat_non_yn);
dm.setIncmg_pers_ipadd(incmg_pers_ipadd);
dm.setIncmg_pers(incmg_pers);
dm.setChg_pers(chg_pers);
dm.setFrex_rcpm_yn(frex_rcpm_yn);
dm.setEmail(email);
dm.setLeas_telno1(leas_telno1);
dm.setLeas_telno2(leas_telno2);
dm.setLeas_telno3(leas_telno3);
----------------------------------------------------------------------------------------------------*/
