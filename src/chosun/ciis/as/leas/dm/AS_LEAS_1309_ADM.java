...
public class AS_LEAS_1309_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_LEAS_1309_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_LEAS_1309_ADM dm = (AS_LEAS_1309_ADM)bdm;
		...
		cstmt.setString(19, dm.precpt_rcpm_amt);
		cstmt.setString(20, dm.trufnd_rcpm_amt);
		cstmt.setString(21, dm.trufnd_dlco_clsf_cd);
		cstmt.setString(22, dm.trufnd_dlco_ern);
		cstmt.setString(23, dm.trufnd_slip_clsf_cd);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.leas.ds.AS_LEAS_1309_ADataSet();
	}
