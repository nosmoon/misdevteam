...
public class AS_LEAS_1301_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AS_LEAS_1301_LDM(){}
	public AS_LEAS_1301_LDM(String cmpy_cd, String job_clsf, String bldg_cd, String hire_dlco_ern, String cntr_no, String cntr_star){
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_LEAS_1301_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_LEAS_1301_LDM dm = (AS_LEAS_1301_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.leas.ds.AS_LEAS_1301_LDataSet();
	}
