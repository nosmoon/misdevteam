...
public class AS_LEAS_1304_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_LEAS_1304_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_LEAS_1304_IDM dm = (AS_LEAS_1304_IDM)bdm;
		...
		cstmt.setString(11, dm.inout_clsf);
		cstmt.setString(12, dm.inout_acct_clsf);
		cstmt.setString(13, dm.gurt_payo_clsf);
		cstmt.setString(14, dm.remk);
		cstmt.setString(15, dm.bldg_cd);
		cstmt.setString(16, dm.cntr_yy);
		cstmt.setString(17, dm.cntr_seq);
		cstmt.setString(18, dm.clam_yymm);
		cstmt.setString(19, dm.clam_seq);
		cstmt.setString(20, dm.leas_rcpm_amt);
		cstmt.setString(21, dm.mang_rcpm_amt);
		cstmt.setString(22, dm.vat_rcpm_amt);
		...
		cstmt.setString(57, dm.trufnd_rcpm_amt);
		cstmt.setString(58, dm.trufnd_dlco_clsf_cd);
		cstmt.setString(59, dm.trufnd_dlco_ern);
		cstmt.setString(60, dm.trufnd_slip_clsf_cd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.leas.ds.AS_LEAS_1304_IDataSet();
	}
...
/* 작성시간 : Mon Jun 07 17:13:46 KST 2010 */