...
public class AS_LEAS_1211_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AS_LEAS_1211_ADM(){}
	public AS_LEAS_1211_ADM(String cmpy_cd, String clam_dt, String dept_cd, String incmg_pers_ipadd, String incmg_pers, String chg_pers){
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_LEAS_1211_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_LEAS_1211_ADM dm = (AS_LEAS_1211_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.leas.ds.AS_LEAS_1211_ADataSet();
	}
...
/* 작성시간 : Sat Jul 11 11:13:09 KST 2009 */