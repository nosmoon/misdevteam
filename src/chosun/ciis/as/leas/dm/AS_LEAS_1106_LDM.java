...
public class AS_LEAS_1106_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String aset_no;

	public AS_LEAS_1106_LDM(){}
	public AS_LEAS_1106_LDM(String cmpy_cd, String aset_no){
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_LEAS_1106_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_LEAS_1106_LDM dm = (AS_LEAS_1106_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.leas.ds.AS_LEAS_1106_LDataSet();
	}
