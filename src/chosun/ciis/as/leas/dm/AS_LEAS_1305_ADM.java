...
public class AS_LEAS_1305_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_LEAS_1305_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_LEAS_1305_ADM dm = (AS_LEAS_1305_ADM)bdm;
		...
		cstmt.setString(10, dm.rcpm_dt);
		cstmt.setString(11, dm.rcpm_shet_no);
		cstmt.setString(12, dm.dlco_clsf_cd);
		cstmt.setString(13, dm.dlco_ern);
		cstmt.setString(14, dm.inout_clsf);
		cstmt.setString(15, dm.remk);
		cstmt.setString(16, dm.bldg_cd);
		cstmt.setString(17, dm.cntr_yy);
		cstmt.setString(18, dm.cntr_seq);
		cstmt.setString(19, dm.clam_yymm);
		cstmt.setString(20, dm.clam_seq);
		cstmt.setString(21, dm.leas_rcpm_amt);
		cstmt.setString(22, dm.mang_rcpm_amt);
		cstmt.setString(23, dm.vat_rcpm_amt);
		cstmt.setString(24, dm.cash_sub_seq);
		cstmt.setString(25, dm.cash_rcpm_amt);
		cstmt.setString(26, dm.deps_mode);
		cstmt.setString(27, dm.deps_sub_seq);
		cstmt.setString(28, dm.deps_rcpm_amt);
		cstmt.setString(29, dm.deps_rmtt_dt);
		cstmt.setString(30, dm.deps_rmtt_plac);
		cstmt.setString(31, dm.deps_acct_mang_no);
		cstmt.setString(32, dm.deps_coms_amt);
		cstmt.setString(33, dm.deps_biz_reg_no);
		cstmt.setString(34, dm.deps_bank_id);
		cstmt.setString(35, dm.deps_acct_num);
		cstmt.setString(36, dm.deps_tran_date);
		cstmt.setString(37, dm.deps_tran_date_seq);
		cstmt.setString(38, dm.deps_acct_tonghwa_ref);
		cstmt.setString(39, dm.deps_frex_amt);
		cstmt.setString(40, dm.note_mode);
		cstmt.setString(41, dm.note_sub_seq);
		cstmt.setString(42, dm.note_bank_cd);
		cstmt.setString(43, dm.note_note_no);
		cstmt.setString(44, dm.note_note_clsf_cd);
		cstmt.setString(45, dm.note_comp_dt);
		cstmt.setString(46, dm.note_mtry_dt);
		cstmt.setString(47, dm.note_rcpm_amt);
		cstmt.setString(48, dm.note_issu_cmpy_clsf);
		cstmt.setString(49, dm.note_issu_pers_nm);
		cstmt.setString(50, dm.note_rcpm_acct);
		cstmt.setString(51, dm.note_sale_aprv_no);
		cstmt.setString(52, dm.etc_mode);
		cstmt.setString(53, dm.etc_sub_seq);
		cstmt.setString(54, dm.etc_budg_cd);
		cstmt.setString(55, dm.etc_rcpm_amt);
		cstmt.setString(56, dm.etc_bal_occr_slip_clsf);
		cstmt.setString(57, dm.etc_bal_occr_slip_no);
		cstmt.setString(58, dm.trufnd_rcpm_amt);
		cstmt.setString(59, dm.trufnd_dlco_clsf_cd);
		cstmt.setString(60, dm.trufnd_dlco_ern);
		cstmt.setString(61, dm.trufnd_slip_clsf_cd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.leas.ds.AS_LEAS_1305_ADataSet();
	}
...
/* 작성시간 : Mon Jun 07 17:17:51 KST 2010 */