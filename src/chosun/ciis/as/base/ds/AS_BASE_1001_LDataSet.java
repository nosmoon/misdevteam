...
public class AS_BASE_1001_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;
	public String xx_dept_cd;

	public AS_BASE_1001_LDataSet(){}
	public AS_BASE_1001_LDataSet(String errcode, String errmsg, String xx_dept_cd){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AS_BASE_1001_LCURLISTRecord rec = new AS_BASE_1001_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		AS_BASE_1001_LCURLISTRecord curlistRec = (AS_BASE_1001_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
