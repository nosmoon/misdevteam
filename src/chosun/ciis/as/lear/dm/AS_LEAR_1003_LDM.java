...
public class AS_LEAR_1003_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AS_LEAR_1003_LDM(){}
	public AS_LEAR_1003_LDM(String cmpy_cd, String bldg_cd, String hire_dlco_ern, String cntr_star){
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_LEAR_1003_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_LEAR_1003_LDM dm = (AS_LEAR_1003_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.bldg_cd);
		cstmt.setString(5, dm.hire_dlco_ern);
		cstmt.setString(6, dm.cntr_star);
		cstmt.registerOutParameter(7, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.lear.ds.AS_LEAR_1003_LDataSet();
	}
