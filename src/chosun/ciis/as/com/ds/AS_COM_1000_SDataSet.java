...
public class AS_COM_1000_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	******************************************************************************************/
	...
	public AS_COM_1000_SDataSet(){}
	public AS_COM_1000_SDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		if(rset0.next()){
			AS_COM_1000_SCURLISTRecord rec = new AS_COM_1000_SCURLISTRecord();
