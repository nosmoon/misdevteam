...
public class AS_ASET_1802_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AS_ASET_1802_ADM(){}
	public AS_ASET_1802_ADM(String mode, String cmpy_cd, String close_yymm, String incmg_pers_ipadd, String incmg_pers, String chg_pers){
		this.mode = mode;
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_ASET_1802_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_ASET_1802_ADM dm = (AS_ASET_1802_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.aset.ds.AS_ASET_1802_ADataSet();
	}
...
/* 작성시간 : Wed May 06 16:24:10 KST 2009 */