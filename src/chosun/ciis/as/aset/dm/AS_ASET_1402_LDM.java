...
public class AS_ASET_1402_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String ndduc_year;
	public String ndduc_prd_clsf;

	public AS_ASET_1402_LDM(){}
	public AS_ASET_1402_LDM(String cmpy_cd, String ndduc_year, String ndduc_prd_clsf){
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_ASET_1402_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_ASET_1402_LDM dm = (AS_ASET_1402_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.aset.ds.AS_ASET_1402_LDataSet();
	}
