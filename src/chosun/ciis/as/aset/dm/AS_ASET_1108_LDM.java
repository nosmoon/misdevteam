...
public class AS_ASET_1108_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AS_ASET_1108_LDM(){}
	public AS_ASET_1108_LDM(String cmpy_cd, String chg_clsf, String occr_dt, String occr_seq){
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_ASET_1108_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_ASET_1108_LDM dm = (AS_ASET_1108_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.aset.ds.AS_ASET_1108_LDataSet();
	}
