...
public class AS_ASET_1504_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_ASET_1504_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_ASET_1504_ADM dm = (AS_ASET_1504_ADM)bdm;
		...
		cstmt.setString(10, dm.dlco_ern);
		cstmt.setString(11, dm.chg_tot_amt);
		...
		cstmt.setString(16, dm.draft_doc_no2);
		...
		cstmt.setString(21, dm.sub_seq);
		cstmt.setString(22, dm.aset_no);
		cstmt.setString(23, dm.chg_amt);
		cstmt.setString(24, dm.chg_vat_amt);
		cstmt.setString(25, dm.sale_now_acqr_amt);
		cstmt.setString(26, dm.sale_redm_tot_amt);
		cstmt.setString(27, dm.sale_un_redm_amt);
		cstmt.setString(28, dm.sale_pfls_amt);
		cstmt.setString(29, dm.budg_cd);
		cstmt.setString(30, dm.dtls_remk);
		cstmt.setString(31, dm.cash_sub_seq);
		cstmt.setString(32, dm.cash_rcpm_amt);
		cstmt.setString(33, dm.deps_mode);
		cstmt.setString(34, dm.deps_sub_seq);
		cstmt.setString(35, dm.deps_rcpm_amt);
		cstmt.setString(36, dm.deps_rmtt_dt);
		cstmt.setString(37, dm.deps_rmtt_plac);
		cstmt.setString(38, dm.deps_acct_mang_no);
		cstmt.setString(39, dm.deps_coms_amt);
		cstmt.setString(40, dm.deps_biz_reg_no);
		cstmt.setString(41, dm.deps_bank_id);
		cstmt.setString(42, dm.deps_acct_num);
		cstmt.setString(43, dm.deps_tran_date);
		cstmt.setString(44, dm.deps_tran_date_seq);
		cstmt.setString(45, dm.note_mode);
		cstmt.setString(46, dm.note_sub_seq);
		cstmt.setString(47, dm.note_bank_cd);
		cstmt.setString(48, dm.note_note_no);
		cstmt.setString(49, dm.note_note_clsf_cd);
		cstmt.setString(50, dm.note_comp_dt);
		cstmt.setString(51, dm.note_mtry_dt);
		cstmt.setString(52, dm.note_rcpm_amt);
		cstmt.setString(53, dm.note_issu_cmpy_clsf);
		cstmt.setString(54, dm.note_issu_pers_nm);
		cstmt.setString(55, dm.note_rcpm_acct);
		cstmt.setString(56, dm.note_sale_aprv_no);
		cstmt.setString(57, dm.etc_mode);
		cstmt.setString(58, dm.etc_sub_seq);
		cstmt.setString(59, dm.etc_budg_cd);
		cstmt.setString(60, dm.etc_rcpm_amt);
		cstmt.setString(61, dm.etc_bal_occr_slip_clsf);
		cstmt.setString(62, dm.etc_bal_occr_slip_no);
		cstmt.setString(63, dm.dept_cd);
		cstmt.setString(64, dm.rcpm_amt);
		cstmt.setString(65, dm.rcpm_shet_no);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.aset.ds.AS_ASET_1504_ADataSet();
	}
    ...
    public void print(){
        ...
        System.out.println("chg_tot_amt = " + getChg_tot_amt());
...
String chg_tot_amt = req.getParameter("chg_tot_amt");
if( chg_tot_amt == null){
	System.out.println(this.toString+" : chg_tot_amt is null" );
}else{
	System.out.println(this.toString+" : chg_tot_amt is "+chg_tot_amt );
}
...
String chg_tot_amt = Util.checkString(req.getParameter("chg_tot_amt"));
...
String chg_tot_amt = Util.Uni2Ksc(Util.checkString(req.getParameter("chg_tot_amt")));
...
/* 작성시간 : Wed May 27 11:41:08 KST 2009 */