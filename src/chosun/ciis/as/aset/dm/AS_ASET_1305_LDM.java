...
public class AS_ASET_1305_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String aset_no_list;

	public AS_ASET_1305_LDM(){}
	public AS_ASET_1305_LDM(String cmpy_cd, String aset_no_list){
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_ASET_1305_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_ASET_1305_LDM dm = (AS_ASET_1305_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.aset.ds.AS_ASET_1305_LDataSet();
	}
