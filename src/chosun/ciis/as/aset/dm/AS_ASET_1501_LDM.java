...
public class AS_ASET_1501_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String occr_dt;
	public String occr_seq;

	public AS_ASET_1501_LDM(){}
	public AS_ASET_1501_LDM(String cmpy_cd, String occr_dt, String occr_seq){
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_ASET_1501_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_ASET_1501_LDM dm = (AS_ASET_1501_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.aset.ds.AS_ASET_1501_LDataSet();
	}
