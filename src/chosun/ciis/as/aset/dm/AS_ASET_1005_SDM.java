...
public class AS_ASET_1005_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String aset_no;

	public AS_ASET_1005_SDM(){}
	public AS_ASET_1005_SDM(String cmpy_cd, String aset_no){
	...
	public String getSQL(){
		 return "{ call MISAST.SP_AS_ASET_1005_S(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AS_ASET_1005_SDM dm = (AS_ASET_1005_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.as.aset.ds.AS_ASET_1005_SDataSet();
	}
