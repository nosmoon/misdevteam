...
public class AS_ASET_1903_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public AS_ASET_1903_LDataSet(){}
	public AS_ASET_1903_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AS_ASET_1903_LCURLISTRecord rec = new AS_ASET_1903_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		AS_ASET_1903_LCURLISTRecord curlistRec = (AS_ASET_1903_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
