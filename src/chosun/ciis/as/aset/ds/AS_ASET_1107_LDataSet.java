...
public class AS_ASET_1107_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public AS_ASET_1107_LDataSet(){}
	public AS_ASET_1107_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AS_ASET_1107_LCURLISTRecord rec = new AS_ASET_1107_LCURLISTRecord();
...
<%
	AS_ASET_1107_LDataSet ds = (AS_ASET_1107_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		AS_ASET_1107_LCURLISTRecord curlistRec = (AS_ASET_1107_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
