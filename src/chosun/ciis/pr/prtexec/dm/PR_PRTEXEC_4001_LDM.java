...
public class PR_PRTEXEC_4001_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PRTEXEC_4001_LDM(){}
	public PR_PRTEXEC_4001_LDM(String cmpy_cd, String fac_clsf, String issu_dt_fr, String issu_dt_to){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_PRTEXEC_4001_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PRTEXEC_4001_LDM dm = (PR_PRTEXEC_4001_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtexec.ds.PR_PRTEXEC_4001_LDataSet();
	}
