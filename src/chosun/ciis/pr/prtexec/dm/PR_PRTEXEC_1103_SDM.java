...
public class PR_PRTEXEC_1103_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PRTEXEC_1103_SDM(){}
	public PR_PRTEXEC_1103_SDM(String cmpy_cd, String medi_cd, String sect_cd, String issu_dt){
	...
	public String getSQL(){
		 return "{ call SP_PR_PRTEXEC_1103_S( ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PRTEXEC_1103_SDM dm = (PR_PRTEXEC_1103_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtexec.ds.PR_PRTEXEC_1103_SDataSet();
	}
