...
public class PR_PRTEXEC_4003_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String occr_yymm;

	public PR_PRTEXEC_4003_LDM(){}
	public PR_PRTEXEC_4003_LDM(String cmpy_cd, String occr_yymm){
	...
	public String getSQL(){
		 return "{ call SP_PR_PRTEXEC_4003_L( ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PRTEXEC_4003_LDM dm = (PR_PRTEXEC_4003_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtexec.ds.PR_PRTEXEC_4003_LDataSet();
	}
