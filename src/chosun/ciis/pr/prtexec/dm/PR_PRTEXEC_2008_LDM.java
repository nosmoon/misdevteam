...
public class PR_PRTEXEC_2008_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String issu_dt_fr;
	public String issu_dt_to;

	public PR_PRTEXEC_2008_LDM(){}
	public PR_PRTEXEC_2008_LDM(String cmpy_cd, String issu_dt_fr, String issu_dt_to){
	...
	public String getSQL(){
		 return "{ call SP_PR_PRTEXEC_2008_L( ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PRTEXEC_2008_LDM dm = (PR_PRTEXEC_2008_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtexec.ds.PR_PRTEXEC_2008_LDataSet();
	}
