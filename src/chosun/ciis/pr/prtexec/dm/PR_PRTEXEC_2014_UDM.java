...
public class PR_PRTEXEC_2014_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PRTEXEC_2014_UDM(){}
	public PR_PRTEXEC_2014_UDM(String cmpy_cd, String issu_dt, String medi_cd, String sect_cd, String incmg_pers_ipaddr, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_PR_PRTEXEC_2014_U( ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PRTEXEC_2014_UDM dm = (PR_PRTEXEC_2014_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtexec.ds.PR_PRTEXEC_2014_UDataSet();
	}
