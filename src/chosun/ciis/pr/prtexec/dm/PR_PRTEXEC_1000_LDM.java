...
public class PR_PRTEXEC_1000_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PRTEXEC_1000_LDM(){}
	public PR_PRTEXEC_1000_LDM(String cmpy_cd, String fac_clsf, String medi_cd, String sect_cd, String pcnt, String clr_pcnt, String aply_dt){
	...
	public String getSQL(){
		 return "{ call SP_PR_PRTEXEC_1000_L( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PRTEXEC_1000_LDM dm = (PR_PRTEXEC_1000_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtexec.ds.PR_PRTEXEC_1000_LDataSet();
	}
