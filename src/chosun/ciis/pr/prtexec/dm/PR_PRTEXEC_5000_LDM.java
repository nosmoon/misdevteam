...
public class PR_PRTEXEC_5000_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PRTEXEC_5000_LDM(){}
	public PR_PRTEXEC_5000_LDM(String cmpy_cd, String prt_dt, String issu_dt, String fac_clsf, String medi_cd, String sect_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_PRTEXEC_5000_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PRTEXEC_5000_LDM dm = (PR_PRTEXEC_5000_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtexec.ds.PR_PRTEXEC_5000_LDataSet();
	}
