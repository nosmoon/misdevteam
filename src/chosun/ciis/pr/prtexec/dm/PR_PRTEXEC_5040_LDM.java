...
public class PR_PRTEXEC_5040_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PRTEXEC_5040_LDM(){}
	public PR_PRTEXEC_5040_LDM(String cmpy_cd, String prt_dt, String issu_dt, String fac_clsf){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_PRTEXEC_5040_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PRTEXEC_5040_LDM dm = (PR_PRTEXEC_5040_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtexec.ds.PR_PRTEXEC_5040_LDataSet();
	}
...
/* 작성시간 : Tue May 12 17:15:50 KST 2009 */