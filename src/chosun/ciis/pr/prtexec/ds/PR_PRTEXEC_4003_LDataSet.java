...
public class PR_PRTEXEC_4003_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public PR_PRTEXEC_4003_LDataSet(){}
	public PR_PRTEXEC_4003_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PR_PRTEXEC_4003_LCURLISTRecord rec = new PR_PRTEXEC_4003_LCURLISTRecord();
