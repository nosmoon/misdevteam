...
public class PR_PRTEXEC_2000_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public PR_PRTEXEC_2000_LDataSet(){}
	public PR_PRTEXEC_2000_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PR_PRTEXEC_2000_LCURLISTRecord rec = new PR_PRTEXEC_2000_LCURLISTRecord();
			...
			rec.d_mon2 = Util.checkString(rset0.getString("d_mon2"));
			rec.d_mon2_cnt = Util.checkString(rset0.getString("d_mon2_cnt"));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		PR_PRTEXEC_2000_LCURLISTRecord curlistRec = (PR_PRTEXEC_2000_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Mon May 11 22:36:34 KST 2009 */