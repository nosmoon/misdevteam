...
public class PR_PAPMAKE_1007_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String duty_dt;
	public String fac_clsf;

	public PR_PAPMAKE_1007_LDM(){}
	public PR_PAPMAKE_1007_LDM(String cmpy_cd, String duty_dt, String fac_clsf){
	...
	public String getSQL(){
		 return "{ call SP_PR_PAPMAKE_1007_L( ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PAPMAKE_1007_LDM dm = (PR_PAPMAKE_1007_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.papmake.ds.PR_PAPMAKE_1007_LDataSet();
	}
