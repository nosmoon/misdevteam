...
public class PR_PAPMAKE_7021_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PAPMAKE_7021_LDM(){}
	public PR_PAPMAKE_7021_LDM(String cmpy_cd, String ispt_dt, String fac_clsf, String ispt_clsf, String ispt_clas1, String ispt_clas2){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_PAPMAKE_7021_L(? ,? ,? ,? ,? ,? ,?, ? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PAPMAKE_7021_LDM dm = (PR_PAPMAKE_7021_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.papmake.ds.PR_PAPMAKE_7021_LDataSet();
	}
