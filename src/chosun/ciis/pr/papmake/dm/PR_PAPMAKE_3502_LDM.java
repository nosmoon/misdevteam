...
public class PR_PAPMAKE_3502_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String search_dt_fr;
	public String search_dt_to;

	public PR_PAPMAKE_3502_LDM(){}
	public PR_PAPMAKE_3502_LDM(String cmpy_cd, String search_dt_fr, String search_dt_to){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_PAPMAKE_3502_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PAPMAKE_3502_LDM dm = (PR_PAPMAKE_3502_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.papmake.ds.PR_PAPMAKE_3502_LDataSet();
	}
