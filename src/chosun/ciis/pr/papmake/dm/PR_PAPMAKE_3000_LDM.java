...
public class PR_PAPMAKE_3000_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PAPMAKE_3000_LDM(){}
	public PR_PAPMAKE_3000_LDM(String cmpy_cd, String aply_dt_fr, String aply_dt_to, String fac_clsf){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_PAPMAKE_3000_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PAPMAKE_3000_LDM dm = (PR_PAPMAKE_3000_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.papmake.ds.PR_PAPMAKE_3000_LDataSet();
	}
