...
public class PR_PAPMAKE_7101_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PAPMAKE_7101_LDM(){}
	public PR_PAPMAKE_7101_LDM(String cmpy_cd, String ispt_dt, String fac_clsf, String ispt_clsf, String ispt_clas1, String ispt_clas2, String rslt_yn){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_PAPMAKE_7101_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PAPMAKE_7101_LDM dm = (PR_PAPMAKE_7101_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.papmake.ds.PR_PAPMAKE_7101_LDataSet();
	}
...
String rslt_yn = req.getParameter("rslt_yn");
if( rslt_yn == null){
	System.out.println(this.toString+" : rslt_yn is null" );
}else{
	System.out.println(this.toString+" : rslt_yn is "+rslt_yn );
}
----------------------------------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------------------------------
...
String rslt_yn = Util.checkString(req.getParameter("rslt_yn"));
----------------------------------------------------------------------------------------------------*//*----------------------------------------------------------------------------------------------------
...
String rslt_yn = Util.Uni2Ksc(Util.checkString(req.getParameter("rslt_yn")));
----------------------------------------------------------------------------------------------------*/
