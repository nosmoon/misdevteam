...
public class PR_PAPMAKE_1012_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PAPMAKE_1012_UDM(){}
	public PR_PAPMAKE_1012_UDM(String cmpy_cd, String duty_dt, String clos_clsf, String fac_clsf, String incmg_pers_ipaddr, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_PR_PAPMAKE_1012_U( ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PAPMAKE_1012_UDM dm = (PR_PAPMAKE_1012_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.papmake.ds.PR_PAPMAKE_1012_UDataSet();
	}
