...
public class PR_PAPMAKE_3201_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String fac_clsf;
	public String aply_dt;

	public PR_PAPMAKE_3201_LDM(){}
	public PR_PAPMAKE_3201_LDM(String cmpy_cd, String fac_clsf, String aply_dt){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_PAPMAKE_3201_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PAPMAKE_3201_LDM dm = (PR_PAPMAKE_3201_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.papmake.ds.PR_PAPMAKE_3201_LDataSet();
	}
