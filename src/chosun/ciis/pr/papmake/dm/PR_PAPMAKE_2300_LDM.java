...
public class PR_PAPMAKE_2300_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String clos_yymm;

	public PR_PAPMAKE_2300_LDM(){}
	public PR_PAPMAKE_2300_LDM(String cmpy_cd, String clos_yymm){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_PAPMAKE_2300_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PAPMAKE_2300_LDM dm = (PR_PAPMAKE_2300_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.papmake.ds.PR_PAPMAKE_2300_LDataSet();
	}
