...
public class PR_PAPMAKE_1009_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PAPMAKE_1009_LDM(){}
	public PR_PAPMAKE_1009_LDM(String cmpy_cd, String emp_no, String dept_cd, String duty_dt, String fac_clsf){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_PAPMAKE_1009_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PAPMAKE_1009_LDM dm = (PR_PAPMAKE_1009_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.papmake.ds.PR_PAPMAKE_1009_LDataSet();
	}
