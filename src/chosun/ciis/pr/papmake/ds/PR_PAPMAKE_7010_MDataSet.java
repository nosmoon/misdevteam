...
public class PR_PAPMAKE_7010_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public PR_PAPMAKE_7010_MDataSet(){}
	public PR_PAPMAKE_7010_MDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PR_PAPMAKE_7010_MCURLIST1Record rec = new PR_PAPMAKE_7010_MCURLIST1Record();
		...
		while(rset1.next()){
			PR_PAPMAKE_7010_MCURLIST2Record rec = new PR_PAPMAKE_7010_MCURLIST2Record();
		...
		while(rset2.next()){
			PR_PAPMAKE_7010_MCURLIST3Record rec = new PR_PAPMAKE_7010_MCURLIST3Record();
		...
		while(rset3.next()){
			PR_PAPMAKE_7010_MCURLIST4Record rec = new PR_PAPMAKE_7010_MCURLIST4Record();
		...
		while(rset4.next()){
			PR_PAPMAKE_7010_MCURLIST5Record rec = new PR_PAPMAKE_7010_MCURLIST5Record();
		...
		while(rset5.next()){
			PR_PAPMAKE_7010_MCURLIST6Record rec = new PR_PAPMAKE_7010_MCURLIST6Record();
