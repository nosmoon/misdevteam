...
public class PR_PAPMAKE_7100_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public PR_PAPMAKE_7100_LDataSet(){}
	public PR_PAPMAKE_7100_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PR_PAPMAKE_7100_LCURLISTRecord rec = new PR_PAPMAKE_7100_LCURLISTRecord();
