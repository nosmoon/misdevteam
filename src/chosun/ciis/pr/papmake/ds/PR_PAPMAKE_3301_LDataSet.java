...
public class PR_PAPMAKE_3301_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public PR_PAPMAKE_3301_LDataSet(){}
	public PR_PAPMAKE_3301_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PR_PAPMAKE_3301_LCURLISTRecord rec = new PR_PAPMAKE_3301_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		PR_PAPMAKE_3301_LCURLISTRecord curlistRec = (PR_PAPMAKE_3301_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
