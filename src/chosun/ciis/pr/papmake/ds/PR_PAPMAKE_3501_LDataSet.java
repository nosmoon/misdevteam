...
public class PR_PAPMAKE_3501_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public PR_PAPMAKE_3501_LDataSet(){}
	public PR_PAPMAKE_3501_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PR_PAPMAKE_3501_LCURLISTRecord rec = new PR_PAPMAKE_3501_LCURLISTRecord();
...
<%
	PR_PAPMAKE_3501_LDataSet ds = (PR_PAPMAKE_3501_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		PR_PAPMAKE_3501_LCURLISTRecord curlistRec = (PR_PAPMAKE_3501_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Fri Jul 15 17:46:12 KST 2016 */