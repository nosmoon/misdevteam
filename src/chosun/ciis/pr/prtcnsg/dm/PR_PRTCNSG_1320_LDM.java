...
public class PR_PRTCNSG_1320_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PRTCNSG_1320_LDM(){}
	public PR_PRTCNSG_1320_LDM(String cmpy_cd, String aply_dt, String fac_clsf, String papcmpy_cd, String paper_uprc, String paper_portage){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_PRTCNSG_1320_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PRTCNSG_1320_LDM dm = (PR_PRTCNSG_1320_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtcnsg.ds.PR_PRTCNSG_1320_LDataSet();
	}
