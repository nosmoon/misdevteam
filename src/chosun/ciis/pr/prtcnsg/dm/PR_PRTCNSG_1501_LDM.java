...
public class PR_PRTCNSG_1501_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PRTCNSG_1501_LDM(){}
	public PR_PRTCNSG_1501_LDM(String cmpy_cd, String medi_cd, String vat, String issu_dt_yyyy, String issu_dt_mm){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_PRTCNSG_1501_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PRTCNSG_1501_LDM dm = (PR_PRTCNSG_1501_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtcnsg.ds.PR_PRTCNSG_1501_LDataSet();
	}
