...
public class PR_OTHCNSM_1331_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_OTHCNSM_1331_ADM(){}
	public PR_OTHCNSM_1331_ADM(String cmpy_cd, String aply_dt, String psplat_clsf, String psplat_fee, String gnaw_fee, String fac_clsf, String incmg_pers_ipaddr, String incmg_pers, String gubun){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_OTHCNSM_1331_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_OTHCNSM_1331_ADM dm = (PR_OTHCNSM_1331_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.aply_dt);
		cstmt.setString(5, dm.psplat_clsf);
		cstmt.setString(6, dm.psplat_fee);
		cstmt.setString(7, dm.gnaw_fee);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtcnsg.ds.PR_OTHCNSM_1331_ADataSet();
	}
...
/* 작성시간 : Mon May 25 17:12:56 KST 2009 */