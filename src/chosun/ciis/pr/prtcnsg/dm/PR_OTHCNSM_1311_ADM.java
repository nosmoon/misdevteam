...
public class PR_OTHCNSM_1311_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_OTHCNSM_1311_ADM(){}
	public PR_OTHCNSM_1311_ADM(String cmpy_cd, String fac_clsf, String aply_dt, String prt_basi_qty, String pj_basi_qty, String prt_uprc_bw_1, String prt_uprc_clr_1, String prt_uprc_bw_2, String prt_uprc_clr_2, String prt_pj_rate_bw_1, String prt_pj_rate_clr_1, String prt_pj_rate_bw_2, String prt_pj_rate_clr_2, String film_make_fee, String pack_fee, String paper_wgt, String eps_no, String incmg_pers_ipaddr, String incmg_pers, String gubun){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_OTHCNSM_1311_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_OTHCNSM_1311_ADM dm = (PR_OTHCNSM_1311_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtcnsg.ds.PR_OTHCNSM_1311_ADataSet();
	}
