...
public class PR_OTHCNSM_2401_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String fac_clsf;
	public String issu_yymm;

	public PR_OTHCNSM_2401_LDM(){}
	public PR_OTHCNSM_2401_LDM(String cmpy_cd, String fac_clsf, String issu_yymm){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_OTHCNSM_2401_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_OTHCNSM_2401_LDM dm = (PR_OTHCNSM_2401_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtcnsg.ds.PR_OTHCNSM_2401_LDataSet();
	}
