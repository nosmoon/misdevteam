...
public class PR_OTHCNSM_1401_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_OTHCNSM_1401_LDM(){}
	public PR_OTHCNSM_1401_LDM(String cmpy_cd, String medi_cd, String vat, String issu_dt_yyyy, String issu_dt_mm){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_OTHCNSM_1401_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_OTHCNSM_1401_LDM dm = (PR_OTHCNSM_1401_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtcnsg.ds.PR_OTHCNSM_1401_LDataSet();
	}
