...
public class PR_PRTCNSG_1100_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PRTCNSG_1100_LDM(){}
	public PR_PRTCNSG_1100_LDM(String cmpy_cd, String fac_clsf, String issu_dt, String prt_dt, String medi_cd, String sect_cd, String prt_clsf, String papcmpy_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_PRTCNSG_1100_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PRTCNSG_1100_LDM dm = (PR_PRTCNSG_1100_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtcnsg.ds.PR_PRTCNSG_1100_LDataSet();
	}
