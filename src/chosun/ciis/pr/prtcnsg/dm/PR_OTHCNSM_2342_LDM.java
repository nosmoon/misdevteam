...
public class PR_OTHCNSM_2342_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_OTHCNSM_2342_LDM(){}
	public PR_OTHCNSM_2342_LDM(String cmpy_cd, String fac_clsf, String aply_dt, String sect_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_OTHCNSM_2342_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_OTHCNSM_2342_LDM dm = (PR_OTHCNSM_2342_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtcnsg.ds.PR_OTHCNSM_2342_LDataSet();
	}
