...
public class PR_PRTCNSG_1200_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PRTCNSG_1200_LDM(){}
	public PR_PRTCNSG_1200_LDM(String cmpy_cd, String issu_dt_fr, String issu_dt_to, String fac_clsf, String medi_cd, String sect_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_PRTCNSG_1200_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PRTCNSG_1200_LDM dm = (PR_PRTCNSG_1200_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtcnsg.ds.PR_PRTCNSG_1200_LDataSet();
	}
