...
public class PR_OTHCNSM_1330_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String fac_clsf;
	public String aply_dt;

	public PR_OTHCNSM_1330_LDM(){}
	public PR_OTHCNSM_1330_LDM(String cmpy_cd, String fac_clsf, String aply_dt){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_OTHCNSM_1330_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_OTHCNSM_1330_LDM dm = (PR_OTHCNSM_1330_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtcnsg.ds.PR_OTHCNSM_1330_LDataSet();
	}
