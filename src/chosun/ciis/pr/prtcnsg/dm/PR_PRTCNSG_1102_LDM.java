...
public class PR_PRTCNSG_1102_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PRTCNSG_1102_LDM(){}
	public PR_PRTCNSG_1102_LDM(String cmpy_cd, String fac_clsf, String issu_dt, String prt_dt, String medi_cd, String sect_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_PRTCNSG_1102_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PRTCNSG_1102_LDM dm = (PR_PRTCNSG_1102_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtcnsg.ds.PR_PRTCNSG_1102_LDataSet();
	}
