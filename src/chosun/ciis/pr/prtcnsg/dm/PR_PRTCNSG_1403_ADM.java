...
public class PR_PRTCNSG_1403_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PRTCNSG_1403_ADM(){}
	public PR_PRTCNSG_1403_ADM(String cmpy_cd, String incmg_pers_ipaddr, String incmg_pers, String issu_dt_yyyy, String issu_dt_mm, String medi_cd){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_PRTCNSG_1403_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PRTCNSG_1403_ADM dm = (PR_PRTCNSG_1403_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtcnsg.ds.PR_PRTCNSG_1403_ADataSet();
	}
