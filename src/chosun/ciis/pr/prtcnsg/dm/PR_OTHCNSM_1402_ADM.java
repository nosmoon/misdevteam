...
public class PR_OTHCNSM_1402_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_OTHCNSM_1402_ADM(){}
	public PR_OTHCNSM_1402_ADM(String cmpy_cd, String incmg_pers_ipaddr, String incmg_pers, String issu_dt_yyyy, String issu_dt_mm, String medi_cd, String vat, String emp_no, String clos_dt){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_OTHCNSM_1402_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_OTHCNSM_1402_ADM dm = (PR_OTHCNSM_1402_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtcnsg.ds.PR_OTHCNSM_1402_ADataSet();
	}
