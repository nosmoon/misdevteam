...
public class PR_OTHCNSM_1321_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_OTHCNSM_1321_ADM(){}
	public PR_OTHCNSM_1321_ADM(String cmpy_cd, String fac_clsf, String aply_dt, String papcmpy_cd, String paper_uprc, String paper_portage, String incmg_pers_ipaddr, String incmg_pers, String gubun){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_OTHCNSM_1321_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_OTHCNSM_1321_ADM dm = (PR_OTHCNSM_1321_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtcnsg.ds.PR_OTHCNSM_1321_ADataSet();
	}
