...
public class PR_PRTCNSG_1331_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PRTCNSG_1331_ADM(){}
	public PR_PRTCNSG_1331_ADM(String cmpy_cd, String aply_dt, String psplat_clsf, String psplat_fee, String gnaw_fee, String fac_clsf, String incmg_pers_ipaddr, String incmg_pers, String gubun){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_PRTCNSG_1331_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PRTCNSG_1331_ADM dm = (PR_PRTCNSG_1331_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtcnsg.ds.PR_PRTCNSG_1331_ADataSet();
	}
