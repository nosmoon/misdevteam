...
public class PR_PRTCNSG_1502_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PR_PRTCNSG_1502_ADM(){}
	public PR_PRTCNSG_1502_ADM(String cmpy_cd, String incmg_pers_ipaddr, String incmg_pers, String issu_dt_yyyy, String issu_dt_mm, String medi_cd, String vat, String emp_no, String clos_dt, String fac_clsf){
	...
	public String getSQL(){
		 return "{ call MISMAT.SP_PR_PRTCNSG_1502_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PR_PRTCNSG_1502_ADM dm = (PR_PRTCNSG_1502_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pr.prtcnsg.ds.PR_PRTCNSG_1502_ADataSet();
	}
