...
public class PR_PRTCNSG_1100_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public PR_PRTCNSG_1100_LDataSet(){}
	public PR_PRTCNSG_1100_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PR_PRTCNSG_1100_LCURLIST1Record rec = new PR_PRTCNSG_1100_LCURLIST1Record();
		...
		while(rset1.next()){
			PR_PRTCNSG_1100_LCURLIST2Record rec = new PR_PRTCNSG_1100_LCURLIST2Record();
			rec.data = Util.checkString(rset1.getString("data"));
			this.curlist2.add(rec);
		}
		ResultSet rset2 = (ResultSet) cstmt.getObject(13);
		while(rset2.next()){
			PR_PRTCNSG_1100_LCURLIST3Record rec = new PR_PRTCNSG_1100_LCURLIST3Record();
		...
		while(rset3.next()){
			PR_PRTCNSG_1100_LCURLIST4Record rec = new PR_PRTCNSG_1100_LCURLIST4Record();
		...
		while(rset4.next()){
			PR_PRTCNSG_1100_LCURLIST5Record rec = new PR_PRTCNSG_1100_LCURLIST5Record();
		...
		while(rset5.next()){
			PR_PRTCNSG_1100_LCURLIST6Record rec = new PR_PRTCNSG_1100_LCURLIST6Record();
		...
		while(rset6.next()){
			PR_PRTCNSG_1100_LCURLIST7Record rec = new PR_PRTCNSG_1100_LCURLIST7Record();
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		PR_PRTCNSG_1100_LCURLIST1Record curlist1Rec = (PR_PRTCNSG_1100_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		PR_PRTCNSG_1100_LCURLIST2Record curlist2Rec = (PR_PRTCNSG_1100_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		PR_PRTCNSG_1100_LCURLIST3Record curlist3Rec = (PR_PRTCNSG_1100_LCURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist4.size(); i++){
		PR_PRTCNSG_1100_LCURLIST4Record curlist4Rec = (PR_PRTCNSG_1100_LCURLIST4Record)ds.curlist4.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist5.size(); i++){
		PR_PRTCNSG_1100_LCURLIST5Record curlist5Rec = (PR_PRTCNSG_1100_LCURLIST5Record)ds.curlist5.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist6.size(); i++){
		PR_PRTCNSG_1100_LCURLIST6Record curlist6Rec = (PR_PRTCNSG_1100_LCURLIST6Record)ds.curlist6.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist7.size(); i++){
		PR_PRTCNSG_1100_LCURLIST7Record curlist7Rec = (PR_PRTCNSG_1100_LCURLIST7Record)ds.curlist7.get(i);%>
HTML 코드들....
	<%}%>
