...
public class PR_PRTCNSG_1200_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public PR_PRTCNSG_1200_LDataSet(){}
	public PR_PRTCNSG_1200_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PR_PRTCNSG_1200_LCURLISTRecord rec = new PR_PRTCNSG_1200_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		PR_PRTCNSG_1200_LCURLISTRecord curlistRec = (PR_PRTCNSG_1200_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
