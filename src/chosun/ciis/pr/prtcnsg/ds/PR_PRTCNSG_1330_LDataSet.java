...
public class PR_PRTCNSG_1330_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public PR_PRTCNSG_1330_LDataSet(){}
	public PR_PRTCNSG_1330_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PR_PRTCNSG_1330_LCURLIST1Record rec = new PR_PRTCNSG_1330_LCURLIST1Record();
		...
		while(rset1.next()){
			PR_PRTCNSG_1330_LCURLIST2Record rec = new PR_PRTCNSG_1330_LCURLIST2Record();
		...
		while(rset2.next()){
			PR_PRTCNSG_1330_LCURLIST3Record rec = new PR_PRTCNSG_1330_LCURLIST3Record();
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		PR_PRTCNSG_1330_LCURLIST1Record curlist1Rec = (PR_PRTCNSG_1330_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		PR_PRTCNSG_1330_LCURLIST2Record curlist2Rec = (PR_PRTCNSG_1330_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		PR_PRTCNSG_1330_LCURLIST3Record curlist3Rec = (PR_PRTCNSG_1330_LCURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>
