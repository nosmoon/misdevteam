...
public class PR_OTHCNSM_2000_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public PR_OTHCNSM_2000_MDataSet(){}
	public PR_OTHCNSM_2000_MDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PR_OTHCNSM_2000_MCURLIST1Record rec = new PR_OTHCNSM_2000_MCURLIST1Record();
		...
		while(rset1.next()){
			PR_OTHCNSM_2000_MCURLIST2Record rec = new PR_OTHCNSM_2000_MCURLIST2Record();
		...
		while(rset2.next()){
			PR_OTHCNSM_2000_MCURLIST3Record rec = new PR_OTHCNSM_2000_MCURLIST3Record();
		...
		while(rset3.next()){
			PR_OTHCNSM_2000_MCURLIST4Record rec = new PR_OTHCNSM_2000_MCURLIST4Record();
		...
		while(rset4.next()){
			PR_OTHCNSM_2000_MCURLIST5Record rec = new PR_OTHCNSM_2000_MCURLIST5Record();
		...
		while(rset5.next()){
			PR_OTHCNSM_2000_MCURLIST6Record rec = new PR_OTHCNSM_2000_MCURLIST6Record();
		...
		while(rset6.next()){
			PR_OTHCNSM_2000_MCURLIST7Record rec = new PR_OTHCNSM_2000_MCURLIST7Record();
...
<%
	PR_OTHCNSM_2000_MDataSet ds = (PR_OTHCNSM_2000_MDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		PR_OTHCNSM_2000_MCURLIST1Record curlist1Rec = (PR_OTHCNSM_2000_MCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		PR_OTHCNSM_2000_MCURLIST2Record curlist2Rec = (PR_OTHCNSM_2000_MCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		PR_OTHCNSM_2000_MCURLIST3Record curlist3Rec = (PR_OTHCNSM_2000_MCURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist4.size(); i++){
		PR_OTHCNSM_2000_MCURLIST4Record curlist4Rec = (PR_OTHCNSM_2000_MCURLIST4Record)ds.curlist4.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist5.size(); i++){
		PR_OTHCNSM_2000_MCURLIST5Record curlist5Rec = (PR_OTHCNSM_2000_MCURLIST5Record)ds.curlist5.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist6.size(); i++){
		PR_OTHCNSM_2000_MCURLIST6Record curlist6Rec = (PR_OTHCNSM_2000_MCURLIST6Record)ds.curlist6.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist7.size(); i++){
		PR_OTHCNSM_2000_MCURLIST7Record curlist7Rec = (PR_OTHCNSM_2000_MCURLIST7Record)ds.curlist7.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Tue Sep 22 23:08:40 KST 2009 */