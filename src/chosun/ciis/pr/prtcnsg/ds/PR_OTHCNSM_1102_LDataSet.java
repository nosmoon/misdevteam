...
public class PR_OTHCNSM_1102_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist2 = new ArrayList();
	public ArrayList curlist1 = new ArrayList();
	public String errcode;
	public String errmsg;

	public PR_OTHCNSM_1102_LDataSet(){}
	public PR_OTHCNSM_1102_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PR_OTHCNSM_1102_LCURLIST1Record rec = new PR_OTHCNSM_1102_LCURLIST1Record();
		...
		while(rset1.next()){
			PR_OTHCNSM_1102_LCURLIST2Record rec = new PR_OTHCNSM_1102_LCURLIST2Record();
...
<%
	PR_OTHCNSM_1102_LDataSet ds = (PR_OTHCNSM_1102_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		PR_OTHCNSM_1102_LCURLIST1Record curlist1Rec = (PR_OTHCNSM_1102_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		PR_OTHCNSM_1102_LCURLIST2Record curlist2Rec = (PR_OTHCNSM_1102_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>
