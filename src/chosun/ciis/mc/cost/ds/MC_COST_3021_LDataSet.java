...
public class MC_COST_3021_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MC_COST_3021_LDataSet(){}
	public MC_COST_3021_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset1.next()){
			MC_COST_3021_LCURLISTRecord rec = new MC_COST_3021_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		MC_COST_3021_LCURLISTRecord curlistRec = (MC_COST_3021_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
