...
public class MC_COST_3082_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MC_COST_3082_LDataSet(){}
	public MC_COST_3082_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MC_COST_3082_LCURLISTRecord rec = new MC_COST_3082_LCURLISTRecord();
			rec.chk = Util.checkString(rset0.getString("chk"));
			rec.bbgbcd = Util.checkString(rset0.getString("bbgbcd"));
...
<%
	MC_COST_3082_LDataSet ds = (MC_COST_3082_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		MC_COST_3082_LCURLISTRecord curlistRec = (MC_COST_3082_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
