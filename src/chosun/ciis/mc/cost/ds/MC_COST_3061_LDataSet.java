...
public class MC_COST_3061_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MC_COST_3061_LDataSet(){}
	public MC_COST_3061_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MC_COST_3061_LCURLISTRecord rec = new MC_COST_3061_LCURLISTRecord();
...
<%
	MC_COST_3061_LDataSet ds = (MC_COST_3061_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		MC_COST_3061_LCURLISTRecord curlistRec = (MC_COST_3061_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
