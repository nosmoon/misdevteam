...
public class MC_COST_3081_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MC_COST_3081_LDataSet(){}
	public MC_COST_3081_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MC_COST_3081_LCURLISTRecord rec = new MC_COST_3081_LCURLISTRecord();
			rec.yymm = Util.checkString(rset0.getString("yymm"));
			rec.dstb_clsf_cd = Util.checkString(rset0.getString("dstb_clsf_cd"));
...
<%
	MC_COST_3081_LDataSet ds = (MC_COST_3081_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		MC_COST_3081_LCURLISTRecord curlistRec = (MC_COST_3081_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
