...
public class MC_COST_2000_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public MC_COST_2000_MDataSet(){}
	public MC_COST_2000_MDataSet(String errcode, String errmsg, String xx_cost_clsf_010, String xx_dstb_cdfr, String xx_dstb_cdto, String xx_clos_clsf, String xx_cost_clsf_020, String xx_job_clsf_00, String xx_cd_clsf_010){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MC_COST_2000_MCURLISTRecord rec = new MC_COST_2000_MCURLISTRecord();
			rec.work_cym = Util.checkString(rset0.getString("work_cym"));
			this.curlist.add(rec);
		}
		this.xx_cost_clsf_010 = Util.checkString(cstmt.getString(6));
		this.xx_dstb_cdfr = Util.checkString(cstmt.getString(7));
		this.xx_dstb_cdto = Util.checkString(cstmt.getString(8));
		this.xx_clos_clsf = Util.checkString(cstmt.getString(9));
		this.xx_cost_clsf_020 = Util.checkString(cstmt.getString(10));
		this.xx_job_clsf_00 = Util.checkString(cstmt.getString(11));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		MC_COST_2000_MCURLISTRecord curlistRec = (MC_COST_2000_MCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Wed Jan 11 16:42:40 KST 2012 */