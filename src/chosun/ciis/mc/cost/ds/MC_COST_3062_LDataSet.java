...
public class MC_COST_3062_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MC_COST_3062_LDataSet(){}
	public MC_COST_3062_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MC_COST_3062_LCURLISTRecord rec = new MC_COST_3062_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		MC_COST_3062_LCURLISTRecord curlistRec = (MC_COST_3062_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
