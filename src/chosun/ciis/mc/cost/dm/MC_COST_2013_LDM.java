...
public class MC_COST_2013_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String cost_dstb_cd;
	public String yymm;

	public MC_COST_2013_LDM(){}
	public MC_COST_2013_LDM(String cmpy_cd, String cost_dstb_cd, String yymm){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_COST_2013_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_COST_2013_LDM dm = (MC_COST_2013_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.cost.ds.MC_COST_2013_LDataSet();
	}
