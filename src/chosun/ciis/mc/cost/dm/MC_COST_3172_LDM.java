...
public class MC_COST_3172_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_COST_3172_LDM(){}
	public MC_COST_3172_LDM(String cmpy_cd, String yymm_fr, String yymm_to, String dept_cd, String dept_len){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_COST_3172_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_COST_3172_LDM dm = (MC_COST_3172_LDM)bdm;
		...
		cstmt.setString(7, dm.dept_len);
		cstmt.registerOutParameter(8, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.cost.ds.MC_COST_3172_LDataSet();
	}
