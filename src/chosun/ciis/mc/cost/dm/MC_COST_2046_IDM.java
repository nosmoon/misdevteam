...
public class MC_COST_2046_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_COST_2046_IDM(){}
	public MC_COST_2046_IDM(String cmpy_cd, String yymm, String cost_dstb_cd, String dept_cd, String medi_cd, long qty, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_COST_2046_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_COST_2046_IDM dm = (MC_COST_2046_IDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.cost.ds.MC_COST_2046_IDataSet();
	}
