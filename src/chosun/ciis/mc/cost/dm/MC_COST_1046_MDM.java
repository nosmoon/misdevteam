...
public class MC_COST_1046_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String cd;

	public MC_COST_1046_MDM(){}
	public MC_COST_1046_MDM(String cmpy_cd, String cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_COST_1046_M(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_COST_1046_MDM dm = (MC_COST_1046_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.cost.ds.MC_COST_1046_MDataSet();
	}
