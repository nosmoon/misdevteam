...
public class MC_COST_3082_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_COST_3082_LDM(){}
	public MC_COST_3082_LDM(String cmpy_cd, String clas_len, String clas_zero, String dept_len, String dept_zero, String yymm_fr, String yymm_to, String dept_cd2, String dstb_clsf_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_COST_3082_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_COST_3082_LDM dm = (MC_COST_3082_LDM)bdm;
		...
		cstmt.setString(11, dm.dstb_clsf_cd);
		cstmt.registerOutParameter(12, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.cost.ds.MC_COST_3082_LDataSet();
	}
