...
public class MC_COST_3018_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String yymm;
	public String slip_clsf;

	public MC_COST_3018_LDM(){}
	public MC_COST_3018_LDM(String cmpy_cd, String yymm, String slip_clsf){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_COST_3018_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_COST_3018_LDM dm = (MC_COST_3018_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.cost.ds.MC_COST_3018_LDataSet();
	}
