...
public class MC_COST_2055_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_COST_2055_DDM(){}
	public MC_COST_2055_DDM(String cmpy_cd, String yymm, String dstb_cd, String dept_cd, String medi_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_COST_2055_D(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_COST_2055_DDM dm = (MC_COST_2055_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.cost.ds.MC_COST_2055_DDataSet();
	}
...
/* 작성시간 : Thu May 14 09:41:16 KST 2009 */