...
public class MC_COST_2001_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_COST_2001_LDM(){}
	public MC_COST_2001_LDM(String cmpy_cd, String yymm, String cost_clsf, String cost_dstb_cd, String cost_dstb_cdfr, String cost_dstb_cdto){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_COST_2001_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_COST_2001_LDM dm = (MC_COST_2001_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.cost.ds.MC_COST_2001_LDataSet();
	}
