...
public class MC_COST_3004_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_COST_3004_IDM(){}
	public MC_COST_3004_IDM(String cmpy_cd, String yymm, String tms_yb, long tms, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_COST_3004_I(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_COST_3004_IDM dm = (MC_COST_3004_IDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.yymm);
		cstmt.setString(5, dm.tms_yb);
		cstmt.setLong(6, dm.tms);
		cstmt.setString(7, dm.incmg_pers);
		cstmt.setString(8, dm.incmg_pers_ipadd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.cost.ds.MC_COST_3004_IDataSet();
	}
...
/* 작성시간 : Fri Aug 07 18:26:20 KST 2009 */