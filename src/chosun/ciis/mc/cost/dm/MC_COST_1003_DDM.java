...
public class MC_COST_1003_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String cost_dstb_cd;

	public MC_COST_1003_DDM(){}
	public MC_COST_1003_DDM(String cmpy_cd, String cost_dstb_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_COST_1003_D(? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_COST_1003_DDM dm = (MC_COST_1003_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.cost.ds.MC_COST_1003_DDataSet();
	}
...
/* 작성시간 : Thu Apr 16 10:33:40 KST 2009 */