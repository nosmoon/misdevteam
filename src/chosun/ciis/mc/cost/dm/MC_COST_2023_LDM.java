...
public class MC_COST_2023_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String yymm;
	public String clos_clsf;

	public MC_COST_2023_LDM(){}
	public MC_COST_2023_LDM(String cmpy_cd, String yymm, String clos_clsf){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_COST_2023_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_COST_2023_LDM dm = (MC_COST_2023_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.cost.ds.MC_COST_2023_LDataSet();
	}
