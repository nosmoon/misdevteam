...
public class MC_COST_2014_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_COST_2014_DDM(){}
	public MC_COST_2014_DDM(String cmpy_cd, String yymm, String clsf_cd, String yymm_fr, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_COST_2014_D(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_COST_2014_DDM dm = (MC_COST_2014_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.cost.ds.MC_COST_2014_DDataSet();
	}
