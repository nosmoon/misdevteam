...
public class MC_COST_3171_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_COST_3171_LDM(){}
	public MC_COST_3171_LDM(String cmpy_cd, String yymm_fr, String yymm_to, String dept_cd2, String clas_len, String dept_len, String clas_zero, String dept_zero){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_COST_3171_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_COST_3171_LDM dm = (MC_COST_3171_LDM)bdm;
		...
		cstmt.setString(7, dm.clas_len);
		cstmt.setString(8, dm.dept_len);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.cost.ds.MC_COST_3171_LDataSet();
	}
