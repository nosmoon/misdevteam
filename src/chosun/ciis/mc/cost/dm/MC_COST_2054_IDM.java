...
public class MC_COST_2054_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_COST_2054_IDM(){}
	public MC_COST_2054_IDM(String cmpy_cd, String yymm, String dstb_cd, String dept_cd, String medi_cd, long qty, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_COST_2054_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_COST_2054_IDM dm = (MC_COST_2054_IDM)bdm;
		...
		cstmt.setLong(8, dm.qty);
		cstmt.setString(9, dm.incmg_pers);
		cstmt.setString(10, dm.incmg_pers_ipadd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.cost.ds.MC_COST_2054_IDataSet();
	}
...
/* 작성시간 : Thu May 14 09:44:25 KST 2009 */