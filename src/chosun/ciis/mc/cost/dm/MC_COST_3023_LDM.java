...
public class MC_COST_3023_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String cd;

	public MC_COST_3023_LDM(){}
	public MC_COST_3023_LDM(String cmpy_cd, String cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_COST_3023_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_COST_3023_LDM dm = (MC_COST_3023_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.cost.ds.MC_COST_3023_LDataSet();
	}
