...
public class MC_CO_3000Servlet extends chosun.ciis.co.base.servlet.BaseServlet {
	...
	*/
	public void process(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			String servletMappedUrl = "/mc/co3000/";
	...
	public String executeWorker(HttpServletRequest req, HttpServletResponse res, int pid) throws AppException, IOException, SQLException {
		...
		BaseWB wb = null;
		switch(pid) {
			case MC_CO_3000WBMapping.MC_CO_9999:
				wb = new MC_CO_3000WB();
				((MC_CO_3000WB)wb).getDummyList(req, res);
