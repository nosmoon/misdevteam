...
public class MC_CO_1009_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_CO_1009_LDM(){}
	public MC_CO_1009_LDM(String cmpy_cd, String cd, String cdnm, String job_clsf, String cd_clsf){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_CO_1009_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_CO_1009_LDM dm = (MC_CO_1009_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.co.ds.MC_CO_1009_LDataSet();
	}
