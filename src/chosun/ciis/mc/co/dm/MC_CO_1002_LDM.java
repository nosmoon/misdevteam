...
public class MC_CO_1002_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_CO_1002_LDM(){}
	public MC_CO_1002_LDM(String cmpy_cd, String cd, String cdnm, String dept_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_CO_1002_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_CO_1002_LDM dm = (MC_CO_1002_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.co.ds.MC_CO_1002_LDataSet();
	}
