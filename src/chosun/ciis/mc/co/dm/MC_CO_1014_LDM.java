...
public class MC_CO_1014_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String cd;
	public String cdnm;

	public MC_CO_1014_LDM(){}
	public MC_CO_1014_LDM(String cmpy_cd, String cd, String cdnm){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_CO_1014_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_CO_1014_LDM dm = (MC_CO_1014_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.co.ds.MC_CO_1014_LDataSet();
	}
