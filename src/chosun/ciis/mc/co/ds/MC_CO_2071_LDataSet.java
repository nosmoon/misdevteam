...
public class MC_CO_2071_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist1 = new ArrayList();
	public String errcode;
	public String errmsg;

	public MC_CO_2071_LDataSet(){}
	public MC_CO_2071_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MC_CO_2071_LCURLIST1Record rec = new MC_CO_2071_LCURLIST1Record();
...
<%
	MC_CO_2071_LDataSet ds = (MC_CO_2071_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		MC_CO_2071_LCURLIST1Record curlist1Rec = (MC_CO_2071_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>
