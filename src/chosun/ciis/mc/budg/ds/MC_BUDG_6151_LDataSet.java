...
public class MC_BUDG_6151_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MC_BUDG_6151_LDataSet(){}
	public MC_BUDG_6151_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MC_BUDG_6151_LCURLISTRecord rec = new MC_BUDG_6151_LCURLISTRecord();
