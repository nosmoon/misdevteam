...
public class MC_BUDG_5021_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MC_BUDG_5021_LDataSet(){}
	public MC_BUDG_5021_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MC_BUDG_5021_LCURLISTRecord rec = new MC_BUDG_5021_LCURLISTRecord();
...
<%
	MC_BUDG_5021_LDataSet ds = (MC_BUDG_5021_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		MC_BUDG_5021_LCURLISTRecord curlistRec = (MC_BUDG_5021_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
