...
public class MC_BUDG_4006_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public MC_BUDG_4006_LDataSet(){}
	public MC_BUDG_4006_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			MC_BUDG_4006_LCURLISTRecord rec = new MC_BUDG_4006_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		MC_BUDG_4006_LCURLISTRecord curlistRec = (MC_BUDG_4006_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
