...
public class MC_BUDG_6130_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String yy;

	public MC_BUDG_6130_MDM(){}
	public MC_BUDG_6130_MDM(String cmpy_cd, String yy){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_6130_M(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_6130_MDM dm = (MC_BUDG_6130_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_6130_MDataSet();
	}
