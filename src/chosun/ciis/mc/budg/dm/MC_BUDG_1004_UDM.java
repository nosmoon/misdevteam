...
public class MC_BUDG_1004_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_1004_UDM(){}
	public MC_BUDG_1004_UDM(String cmpy_cd, String budg_clas_cd, String prt_clsf_cd, String budg_type_cd, String budg_cdnm, String budg_cdynm, String clas_cd1, String clas_cd2, String clas_cd3, String clas_cd4, String gain_reso_yn, String cyov_yn, String lesd_yn, String advc_cndt_yn, String limt_chk_yn, String posbfee_yn, String fixfee_yn, String medi_dstb_cd, String dtls_medi_dstb_cd, String whco_ndstb_cd, String whco_comn_cost_yn, String via_dept_cd, String dstb_acct_cd, String drcr_bal_clsf, String use_bgn_dt, String use_end_dt, String use_yn, String chg_pers, String dlco_clsf, String mang_item_cd, String mang_item_nm, String mang_item_val, String budg_cd, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_1004_U(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_1004_UDM dm = (MC_BUDG_1004_UDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.budg_clas_cd);
		cstmt.setString(5, dm.prt_clsf_cd);
		cstmt.setString(6, dm.budg_type_cd);
		cstmt.setString(7, dm.budg_cdnm);
		cstmt.setString(8, dm.budg_cdynm);
		cstmt.setString(9, dm.clas_cd1);
		cstmt.setString(10, dm.clas_cd2);
		cstmt.setString(11, dm.clas_cd3);
		cstmt.setString(12, dm.clas_cd4);
		cstmt.setString(13, dm.gain_reso_yn);
		cstmt.setString(14, dm.cyov_yn);
		cstmt.setString(15, dm.lesd_yn);
		cstmt.setString(16, dm.advc_cndt_yn);
		cstmt.setString(17, dm.limt_chk_yn);
		cstmt.setString(18, dm.posbfee_yn);
		cstmt.setString(19, dm.fixfee_yn);
		cstmt.setString(20, dm.medi_dstb_cd);
		cstmt.setString(21, dm.dtls_medi_dstb_cd);
		cstmt.setString(22, dm.whco_ndstb_cd);
		cstmt.setString(23, dm.whco_comn_cost_yn);
		cstmt.setString(24, dm.via_dept_cd);
		cstmt.setString(25, dm.dstb_acct_cd);
		cstmt.setString(26, dm.drcr_bal_clsf);
		cstmt.setString(27, dm.use_bgn_dt);
		cstmt.setString(28, dm.use_end_dt);
		cstmt.setString(29, dm.use_yn);
		cstmt.setString(30, dm.chg_pers);
		cstmt.setString(31, dm.dlco_clsf);
		cstmt.setString(32, dm.mang_item_cd);
		cstmt.setString(33, dm.mang_item_nm);
		cstmt.setString(34, dm.mang_item_val);
		cstmt.setString(35, dm.budg_cd);
		cstmt.setString(36, dm.incmg_pers_ipadd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_1004_UDataSet();
	}
