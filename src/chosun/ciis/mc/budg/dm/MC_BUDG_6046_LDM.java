...
public class MC_BUDG_6046_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String budg_yymm;

	public MC_BUDG_6046_LDM(){}
	public MC_BUDG_6046_LDM(String cmpy_cd, String budg_yymm){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_6046_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_6046_LDM dm = (MC_BUDG_6046_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_6046_LDataSet();
	}
...
/* 작성시간 : Mon May 18 15:01:52 KST 2009 */