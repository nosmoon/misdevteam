...
public class MC_BUDG_4052_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_4052_LDM(){}
	public MC_BUDG_4052_LDM(String cmpy_cd, String work_dt, String hsty_no, String budg_yymm, String dept_cd, String evnt_cd, String work_no, String use_dept_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_4052_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_4052_LDM dm = (MC_BUDG_4052_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_4052_LDataSet();
	}
