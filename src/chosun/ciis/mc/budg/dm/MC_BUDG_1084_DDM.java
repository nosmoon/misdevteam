...
public class MC_BUDG_1084_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String budg_clas_cd;

	public MC_BUDG_1084_DDM(){}
	public MC_BUDG_1084_DDM(String cmpy_cd, String budg_clas_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_1084_D(? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_1084_DDM dm = (MC_BUDG_1084_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_1084_DDataSet();
	}
...
/* 작성시간 : Fri Jun 12 15:41:01 KST 2009 */