...
public class MC_BUDG_1071_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String budg_frcd;
	public String budg_tocd;

	public MC_BUDG_1071_LDM(){}
	public MC_BUDG_1071_LDM(String cmpy_cd, String budg_frcd, String budg_tocd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_1071_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_1071_LDM dm = (MC_BUDG_1071_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_1071_LDataSet();
	}
