...
public class MC_BUDG_2118_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_2118_LDM(){}
	public MC_BUDG_2118_LDM(String cmpy_cd, String budg_yymm, String budg_cd, String dept_cd, String work_no, String seq, String medi_cd, String use_dept_cd, String crte_clsf, String job_clsf, String dtls_clsf){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_2118_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_2118_LDM dm = (MC_BUDG_2118_LDM)bdm;
		...
		cstmt.setString(13, dm.dtls_clsf);
		cstmt.registerOutParameter(14, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_2118_LDataSet();
	}
