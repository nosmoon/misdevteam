...
public class MC_BUDG_2124_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_2124_SDM(){}
	public MC_BUDG_2124_SDM(String cmpy_cd, String budg_yymm, String dept_cd, String evnt_cd, String work_no){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_2124_S(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_2124_SDM dm = (MC_BUDG_2124_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_2124_SDataSet();
	}
