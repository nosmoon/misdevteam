...
public class MC_BUDG_2021_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_2021_LDM(){}
	public MC_BUDG_2021_LDM(String cmpy_cd, String yyyy, String job_clsf_cd, String dtls_clsf_cd, String medi_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_2021_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_2021_LDM dm = (MC_BUDG_2021_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_2021_LDataSet();
	}
