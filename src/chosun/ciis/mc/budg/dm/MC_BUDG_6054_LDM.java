...
public class MC_BUDG_6054_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_6054_LDM(){}
	public MC_BUDG_6054_LDM(String cmpy_cd, String bulen, String buzero, String beyymm, String wayymm, String budg_yymm, String dept_cd, String tms){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_6054_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_6054_LDM dm = (MC_BUDG_6054_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_6054_LDataSet();
	}
