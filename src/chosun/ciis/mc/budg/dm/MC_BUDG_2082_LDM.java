...
public class MC_BUDG_2082_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_2082_LDM(){}
	public MC_BUDG_2082_LDM(String cmpy_cd, String budg_type_cd, String budg_yymm, String budg_cd, String dept_cd, String work_no, String seq){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_2082_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_2082_LDM dm = (MC_BUDG_2082_LDM)bdm;
		...
		cstmt.setString(8, dm.work_no);
		cstmt.setString(9, dm.seq);
		cstmt.registerOutParameter(10, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_2082_LDataSet();
	}
