...
public class MC_BUDG_6152_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_6152_IDM(){}
	public MC_BUDG_6152_IDM(String cmpy_cd, String yymm, String non_dduc_yn, String area_clsf, String paper_amt, String submat_amt, String prt_amt, String non_dduc_paper_amt, String non_dduc_submat_amt, String non_dduc_prt_amt, String paper_amt_cost, String submat_amt_cost, String prt_amt_cost, String pcnt_cost, String cho_issu_cnt, String local_issu_cnt, String avg_cnt, String non_dduc_rate, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_6152_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_6152_IDM dm = (MC_BUDG_6152_IDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_6152_IDataSet();
	}
