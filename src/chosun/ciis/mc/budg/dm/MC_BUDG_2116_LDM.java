...
public class MC_BUDG_2116_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String dept_cd;
	public String budg_type_cd;

	public MC_BUDG_2116_LDM(){}
	public MC_BUDG_2116_LDM(String cmpy_cd, String dept_cd, String budg_type_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_2116_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_2116_LDM dm = (MC_BUDG_2116_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.dept_cd);
		cstmt.setString(5, dm.budg_type_cd);
		cstmt.registerOutParameter(6, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_2116_LDataSet();
	}
