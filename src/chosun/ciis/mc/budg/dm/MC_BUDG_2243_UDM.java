...
public class MC_BUDG_2243_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_2243_UDM(){}
	public MC_BUDG_2243_UDM(String cmpy_cd, String clos_yn, String yyyy, String dept_cd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_2243_U(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_2243_UDM dm = (MC_BUDG_2243_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_2243_UDataSet();
	}
