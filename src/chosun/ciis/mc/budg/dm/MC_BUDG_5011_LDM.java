...
public class MC_BUDG_5011_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_5011_LDM(){}
	public MC_BUDG_5011_LDM(String cmpy_cd, String budg_yymm, String dept_cd, String budg_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_5011_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_5011_LDM dm = (MC_BUDG_5011_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_5011_LDataSet();
	}
