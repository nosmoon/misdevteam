...
public class MC_BUDG_5070_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String budg_yy;

	public MC_BUDG_5070_MDM(){}
	public MC_BUDG_5070_MDM(String cmpy_cd, String budg_yy){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_5070_M(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_5070_MDM dm = (MC_BUDG_5070_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_5070_MDataSet();
	}
