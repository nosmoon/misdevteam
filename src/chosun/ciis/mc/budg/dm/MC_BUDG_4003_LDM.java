...
public class MC_BUDG_4003_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_4003_LDM(){}
	public MC_BUDG_4003_LDM(String cmpy_cd, String budg_yymm, String budg_cd, String dept_cd, String evnt_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_4003_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_4003_LDM dm = (MC_BUDG_4003_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_4003_LDataSet();
	}
