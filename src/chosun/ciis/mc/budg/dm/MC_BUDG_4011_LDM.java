...
public class MC_BUDG_4011_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_4011_LDM(){}
	public MC_BUDG_4011_LDM(String cmpy_cd, String budg_yymm, String budg_cd, String dept_cd, String evnt_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_4011_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_4011_LDM dm = (MC_BUDG_4011_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_4011_LDataSet();
	}
...
/* 작성시간 : Mon May 25 17:35:31 KST 2009 */