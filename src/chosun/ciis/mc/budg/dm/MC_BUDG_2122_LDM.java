...
public class MC_BUDG_2122_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_2122_LDM(){}
	public MC_BUDG_2122_LDM(String cmpy_cd, String clas_cd1, String budg_yyyy, String evnt_cd, String work_no, String dept_cd, String use_dept_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_2122_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_2122_LDM dm = (MC_BUDG_2122_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.clas_cd1);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_2122_LDataSet();
	}
