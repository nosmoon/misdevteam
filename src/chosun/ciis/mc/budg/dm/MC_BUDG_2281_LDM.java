...
public class MC_BUDG_2281_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_2281_LDM(){}
	public MC_BUDG_2281_LDM(String cmpy_cd, String budg_yy, String evnt_cd, String budg_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_2281_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_2281_LDM dm = (MC_BUDG_2281_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_2281_LDataSet();
	}
