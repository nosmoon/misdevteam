...
public class MC_BUDG_2091_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_2091_LDM(){}
	public MC_BUDG_2091_LDM(String cmpy_cd, String yymm, String budg_cd, String dept_cd, String work_no, String seq, String use_dept_cd, String job_clsf_cd, String dtls_clsf_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_2091_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_2091_LDM dm = (MC_BUDG_2091_LDM)bdm;
		...
		cstmt.setString(10, dm.job_clsf_cd);
		cstmt.setString(11, dm.dtls_clsf_cd);
		cstmt.registerOutParameter(12, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_2091_LDataSet();
	}
