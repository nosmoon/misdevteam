...
public class MC_BUDG_4030_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_4030_MDM(){}
	public MC_BUDG_4030_MDM(String cmpy_cd, String work_dt, String clsf_cd, String crte_clsf, String hsty_no, String kind){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_4030_M(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_4030_MDM dm = (MC_BUDG_4030_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_4030_MDataSet();
	}
