...
public class MC_BUDG_5172_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String budg_yy;
	public String subtot_clsf;

	public MC_BUDG_5172_LDM(){}
	public MC_BUDG_5172_LDM(String cmpy_cd, String budg_yy, String subtot_clsf){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_5172_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_5172_LDM dm = (MC_BUDG_5172_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_5172_LDataSet();
	}
