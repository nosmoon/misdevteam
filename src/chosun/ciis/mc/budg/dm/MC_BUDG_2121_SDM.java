...
public class MC_BUDG_2121_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String evnt_cd;

	public MC_BUDG_2121_SDM(){}
	public MC_BUDG_2121_SDM(String cmpy_cd, String evnt_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_2121_S(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_2121_SDM dm = (MC_BUDG_2121_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_2121_SDataSet();
	}
