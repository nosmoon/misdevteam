...
public class MC_BUDG_4101_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_4101_IDM(){}
	public MC_BUDG_4101_IDM(String cmpy_cd, String chg_prv_dept_cd, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_4101_I(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_4101_IDM dm = (MC_BUDG_4101_IDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_4101_IDataSet();
	}
