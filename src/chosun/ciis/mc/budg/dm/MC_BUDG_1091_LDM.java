...
public class MC_BUDG_1091_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_1091_LDM(){}
	public MC_BUDG_1091_LDM(String cmpy_cd, String budg_frcd, String budg_tocd, String prt_clsf_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_1091_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_1091_LDM dm = (MC_BUDG_1091_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_1091_LDataSet();
	}
