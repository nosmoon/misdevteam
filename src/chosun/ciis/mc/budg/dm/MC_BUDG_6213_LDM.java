...
public class MC_BUDG_6213_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String yy;
	public String tms;

	public MC_BUDG_6213_LDM(){}
	public MC_BUDG_6213_LDM(String cmpy_cd, String yy, String tms){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_6213_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_6213_LDM dm = (MC_BUDG_6213_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_6213_LDataSet();
	}
