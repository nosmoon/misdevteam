...
public class MC_BUDG_2113_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_2113_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_2113_IDM dm = (MC_BUDG_2113_IDM)bdm;
		...
		cstmt.setString(14, dm.new_medi_cd);
		cstmt.setString(15, dm.old_medi_cd);
		cstmt.setString(16, dm.use_dept_cd);
		cstmt.setString(17, dm.req_qunt);
		cstmt.setString(18, dm.req_uprc);
		cstmt.setString(19, dm.req_amt);
		cstmt.setString(20, dm.rmks);
		cstmt.setString(21, dm.crte_clsf);
		cstmt.setString(22, dm.incmg_pers);
		cstmt.setString(23, dm.job_clsf);
		cstmt.setString(24, dm.dtls_clsf);
		cstmt.setString(25, dm.ini_plan_qunt);
		cstmt.setString(26, dm.incmg_pers_ipadd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_2113_IDataSet();
	}
...
/* 작성시간 : Wed May 27 20:50:10 KST 2009 */