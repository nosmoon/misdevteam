...
public class MC_BUDG_4122_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_4122_DDM(){}
	public MC_BUDG_4122_DDM(String cmpy_cd, String chg_aft_dept_cd, String incmg_pers_ipadd, String incmg_pers, String proc_yymm){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_4122_D(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_4122_DDM dm = (MC_BUDG_4122_DDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.chg_aft_dept_cd);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_4122_DDataSet();
	}
