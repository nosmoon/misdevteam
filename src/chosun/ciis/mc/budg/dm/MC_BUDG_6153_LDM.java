...
public class MC_BUDG_6153_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_6153_LDM(){}
	public MC_BUDG_6153_LDM(String cmpy_cd, String yymm_fr, String yymm_to, String kind){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_6153_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_6153_LDM dm = (MC_BUDG_6153_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_6153_LDataSet();
	}
