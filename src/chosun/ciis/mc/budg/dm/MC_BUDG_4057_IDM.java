...
public class MC_BUDG_4057_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_4057_IDM(){}
	public MC_BUDG_4057_IDM(String cmpy_cd, String work_dt, String budg_yymm, String budg_cd, String dept_cd, String evnt_cd, String work_no, String rmks2, String use_dept_cd, String rmks, String amt, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_4057_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_4057_IDM dm = (MC_BUDG_4057_IDM)bdm;
		...
		cstmt.setString(13, dm.amt);
		cstmt.setString(14, dm.incmg_pers);
		cstmt.setString(15, dm.incmg_pers_ipadd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_4057_IDataSet();
	}
