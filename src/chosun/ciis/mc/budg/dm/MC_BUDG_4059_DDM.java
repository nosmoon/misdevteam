...
public class MC_BUDG_4059_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_4059_DDM(){}
	public MC_BUDG_4059_DDM(String cmpy_cd, String yyyy, String work_dt, String hsty_no, String sub_no){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_4059_D(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_4059_DDM dm = (MC_BUDG_4059_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_4059_DDataSet();
	}
