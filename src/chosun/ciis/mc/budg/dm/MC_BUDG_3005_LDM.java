...
public class MC_BUDG_3005_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String budg_yymm;

	public MC_BUDG_3005_LDM(){}
	public MC_BUDG_3005_LDM(String cmpy_cd, String budg_yymm){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_3005_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_3005_LDM dm = (MC_BUDG_3005_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_3005_LDataSet();
	}
