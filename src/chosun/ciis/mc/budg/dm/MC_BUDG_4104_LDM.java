...
public class MC_BUDG_4104_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String chg_prv_dept_cd;

	public MC_BUDG_4104_LDM(){}
	public MC_BUDG_4104_LDM(String cmpy_cd, String chg_prv_dept_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_4104_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_4104_LDM dm = (MC_BUDG_4104_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_4104_LDataSet();
	}
