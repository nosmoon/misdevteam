...
public class MC_BUDG_5061_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String fisc_mm;
	public String sort;

	public MC_BUDG_5061_LDM(){}
	public MC_BUDG_5061_LDM(String cmpy_cd, String fisc_mm, String sort){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_5061_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_5061_LDM dm = (MC_BUDG_5061_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_5061_LDataSet();
	}
