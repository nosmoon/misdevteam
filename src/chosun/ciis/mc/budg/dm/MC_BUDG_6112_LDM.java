...
public class MC_BUDG_6112_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_6112_LDM(){}
	public MC_BUDG_6112_LDM(String cmpy_cd, String yyyy, String tms, String last_yyyymm, String clas_cd1, String clas_cd2, String clas_cd3, String clas_cd4){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_6112_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_6112_LDM dm = (MC_BUDG_6112_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_6112_LDataSet();
	}
