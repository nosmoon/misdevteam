...
public class MC_BUDG_2084_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_2084_DDM(){}
	public MC_BUDG_2084_DDM(String cmpy_cd, String del_cnt, String tag, String budg_yy, String budg_cd, String dept_cd, String evnt_cd, String work_no, String seq, String chg_pers){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_2084_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_2084_DDM dm = (MC_BUDG_2084_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_2084_DDataSet();
	}
