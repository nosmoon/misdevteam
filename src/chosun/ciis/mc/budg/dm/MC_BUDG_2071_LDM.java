...
public class MC_BUDG_2071_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_2071_LDM(){}
	public MC_BUDG_2071_LDM(String cmpy_cd, String budg_yymm, String budg_cd, String dept_cd, String evnt_cd, String work_no){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_2071_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_2071_LDM dm = (MC_BUDG_2071_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_2071_LDataSet();
	}
