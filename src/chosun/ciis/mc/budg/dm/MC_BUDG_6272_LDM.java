...
public class MC_BUDG_6272_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_6272_LDM(){}
	public MC_BUDG_6272_LDM(String cmpy_cd, String bulen, String buzero, String tms1, String cls_cd, String budg_yy, String budg_cd, String dept_cd, String tms2){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_6272_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_6272_LDM dm = (MC_BUDG_6272_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_6272_LDataSet();
	}
