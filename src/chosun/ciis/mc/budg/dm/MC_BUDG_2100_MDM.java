...
public class MC_BUDG_2100_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_2100_MDM(){}
	public MC_BUDG_2100_MDM(String cmpy_cd, String dept_cd, String budg_cd, String budg_cd1){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_2100_M(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_2100_MDM dm = (MC_BUDG_2100_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_2100_MDataSet();
	}
