...
public class MC_BUDG_4054_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_4054_LDM(){}
	public MC_BUDG_4054_LDM(String cmpy_cd, String budg_yymm, String evnt_cd, String dept_cd, String budg_cd, String work_no){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_4054_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_4054_LDM dm = (MC_BUDG_4054_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_4054_LDataSet();
	}
