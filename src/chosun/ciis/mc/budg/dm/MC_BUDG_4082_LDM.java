...
public class MC_BUDG_4082_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String evnt_cd;

	public MC_BUDG_4082_LDM(){}
	public MC_BUDG_4082_LDM(String cmpy_cd, String evnt_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_4082_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_4082_LDM dm = (MC_BUDG_4082_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_4082_LDataSet();
	}
