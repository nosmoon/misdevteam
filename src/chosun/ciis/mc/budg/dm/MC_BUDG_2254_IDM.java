...
public class MC_BUDG_2254_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_2254_IDM(){}
	public MC_BUDG_2254_IDM(String cmpy_cd, String yyyy, String tms, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_2254_I(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_2254_IDM dm = (MC_BUDG_2254_IDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_2254_IDataSet();
	}
