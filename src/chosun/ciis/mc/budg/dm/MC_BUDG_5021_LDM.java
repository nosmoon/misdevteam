...
public class MC_BUDG_5021_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_5021_LDM(){}
	public MC_BUDG_5021_LDM(String cmpy_cd, String kind, String budg_yymm_fr, String budg_yymm_to, String budg_cd_fr, String budg_cd_to, String dept_cd, String evnt_cd_fr, String evnt_cd_to, String sort, String dept_len, String dept_zero){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_5021_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_5021_LDM dm = (MC_BUDG_5021_LDM)bdm;
		...
		cstmt.setString(7, dm.budg_cd_fr);
		cstmt.setString(8, dm.budg_cd_to);
		cstmt.setString(9, dm.dept_cd);
		cstmt.setString(10, dm.evnt_cd_fr);
		cstmt.setString(11, dm.evnt_cd_to);
		cstmt.setString(12, dm.sort);
		cstmt.setString(13, dm.dept_len);
		cstmt.setString(14, dm.dept_zero);
		cstmt.registerOutParameter(15, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_5021_LDataSet();
	}
...
/* 작성시간 : Mon May 18 11:48:32 KST 2009 */