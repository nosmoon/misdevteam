...
public class MC_BUDG_6023_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_6023_UDM(){}
	public MC_BUDG_6023_UDM(String cmpy_cd, String budg_yy, String budg_yymm, String job_clsf_cd, String dtls_clsf_cd, String medi_cd, String dept_cd, String tms, String chg_pers){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_6023_U(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_6023_UDM dm = (MC_BUDG_6023_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_6023_UDataSet();
	}
