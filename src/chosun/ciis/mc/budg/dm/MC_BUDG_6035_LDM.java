...
public class MC_BUDG_6035_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String budg_yy;

	public MC_BUDG_6035_LDM(){}
	public MC_BUDG_6035_LDM(String cmpy_cd, String budg_yy){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_6035_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_6035_LDM dm = (MC_BUDG_6035_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_6035_LDataSet();
	}
