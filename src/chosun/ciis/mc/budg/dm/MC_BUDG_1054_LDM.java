...
public class MC_BUDG_1054_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String min_max;
	public String sql;

	public MC_BUDG_1054_LDM(){}
	public MC_BUDG_1054_LDM(String cmpy_cd, String min_max, String sql){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_1054_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_1054_LDM dm = (MC_BUDG_1054_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_1054_LDataSet();
	}
