...
public class MC_BUDG_6043_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_6043_LDM(){}
	public MC_BUDG_6043_LDM(String cmpy_cd, String budg_yymm, String tms, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_6043_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_6043_LDM dm = (MC_BUDG_6043_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_6043_LDataSet();
	}
