...
public class MC_BUDG_4074_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_4074_LDM(){}
	public MC_BUDG_4074_LDM(String cmpy_cd, String date_fr, String date_to, String dept_fr, String dept_to){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_4074_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_4074_LDM dm = (MC_BUDG_4074_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_4074_LDataSet();
	}
