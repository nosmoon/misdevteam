...
public class MC_BUDG_6041_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String budg_yy;
	public String kind;

	public MC_BUDG_6041_LDM(){}
	public MC_BUDG_6041_LDM(String cmpy_cd, String budg_yy, String kind){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_6041_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_6041_LDM dm = (MC_BUDG_6041_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_6041_LDataSet();
	}
