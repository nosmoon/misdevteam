...
public class MC_BUDG_4014_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_4014_IDM(){}
	public MC_BUDG_4014_IDM(String cmpy_cd, String budg_yy, String jobtag, String work_dt, String hsty_no, String sub_no, String budg_yymm, String budg_cd, String dept_cd, String evnt_cd, String rmks2, String use_dept_cd, String medi_cd, String rmks, String qunt, String uprc, String amt, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_4014_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_4014_IDM dm = (MC_BUDG_4014_IDM)bdm;
		...
		cstmt.setString(17, dm.qunt);
		cstmt.setString(18, dm.uprc);
		cstmt.setString(19, dm.amt);
		cstmt.setString(20, dm.incmg_pers);
		cstmt.setString(21, dm.incmg_pers_ipadd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_4014_IDataSet();
	}
