...
public class MC_BUDG_4058_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public MC_BUDG_4058_IDM(){}
	public MC_BUDG_4058_IDM(String cmpy_cd, String mode, String work_dt, String hsty_no, String work_no, String sub_no, String budg_yymm, String budg_cd, String dept_cd, String evnt_cd, String rmks2, String use_dept_cd, String rmks, String amt, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_4058_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_4058_IDM dm = (MC_BUDG_4058_IDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_4058_IDataSet();
	}
