...
public class MC_BUDG_6303_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String yymm;
	public String tms;

	public MC_BUDG_6303_LDM(){}
	public MC_BUDG_6303_LDM(String cmpy_cd, String yymm, String tms){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_MC_BUDG_6303_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		MC_BUDG_6303_LDM dm = (MC_BUDG_6303_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.mc.budg.ds.MC_BUDG_6303_LDataSet();
	}
