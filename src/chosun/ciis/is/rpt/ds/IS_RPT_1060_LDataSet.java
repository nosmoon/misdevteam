...
public class IS_RPT_1060_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist1 = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_RPT_1060_LDataSet(){}
	public IS_RPT_1060_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_RPT_1060_LCURLIST1Record rec = new IS_RPT_1060_LCURLIST1Record();
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		IS_RPT_1060_LCURLIST1Record curlist1Rec = (IS_RPT_1060_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>
