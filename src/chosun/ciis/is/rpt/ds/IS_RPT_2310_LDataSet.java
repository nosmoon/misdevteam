...
public class IS_RPT_2310_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist1 = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_RPT_2310_LDataSet(){}
	public IS_RPT_2310_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_RPT_2310_LCURLIST1Record rec = new IS_RPT_2310_LCURLIST1Record();
...
<%
	IS_RPT_2310_LDataSet ds = (IS_RPT_2310_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		IS_RPT_2310_LCURLIST1Record curlist1Rec = (IS_RPT_2310_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Mon Jun 04 18:42:25 KST 2012 */