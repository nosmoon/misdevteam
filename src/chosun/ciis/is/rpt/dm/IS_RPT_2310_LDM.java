...
public class IS_RPT_2310_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_RPT_2310_LDM(){}
	public IS_RPT_2310_LDM(String cmpy_cd, String cmpy_clsf, String yymm, String purc_dlco_no, String sido, String gu, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_RPT_2310_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_RPT_2310_LDM dm = (IS_RPT_2310_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.rpt.ds.IS_RPT_2310_LDataSet();
	}
