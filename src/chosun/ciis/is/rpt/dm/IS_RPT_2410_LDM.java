...
public class IS_RPT_2410_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_RPT_2410_LDM(){}
	public IS_RPT_2410_LDM(String cmpy_cd, String yyyy, String purc_dlco_no, String sido, String gu, String asnt_dstc_cd, String sale_clsf, String spc_sale_clsf, String spc_sale_clsf_n, String type, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_RPT_2410_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_RPT_2410_LDM dm = (IS_RPT_2410_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.rpt.ds.IS_RPT_2410_LDataSet();
	}
