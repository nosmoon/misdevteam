...
public class IS_RPT_2010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_RPT_2010_LDM(){}
	public IS_RPT_2010_LDM(String cmpy_cd, String cmpy_clsf, String yyyy, String sido, String gu, String purc_dlco_no, String sale_clsf, String spc_sale_clsf, String spc_sale_clsf_n, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_RPT_2010_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_RPT_2010_LDM dm = (IS_RPT_2010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.rpt.ds.IS_RPT_2010_LDataSet();
	}
...
/* 작성시간 : Mon Jun 04 16:16:28 KST 2012 */