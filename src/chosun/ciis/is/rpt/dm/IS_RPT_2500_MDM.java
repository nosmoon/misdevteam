...
public class IS_RPT_2500_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_RPT_2500_MDM(){}
	public IS_RPT_2500_MDM(String cmpy_cd, String auth_gb, String use_yn, String incmg_pers, String base_dt){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_RPT_2500_M(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_RPT_2500_MDM dm = (IS_RPT_2500_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.rpt.ds.IS_RPT_2500_MDataSet();
	}
