...
public class IS_RPT_1210_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_RPT_1210_LDM(){}
	public IS_RPT_1210_LDM(String cmpy_cd, String fr_dt, String to_dt, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_RPT_1210_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_RPT_1210_LDM dm = (IS_RPT_1210_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.rpt.ds.IS_RPT_1210_LDataSet();
	}
