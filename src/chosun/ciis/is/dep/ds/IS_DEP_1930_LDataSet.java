...
public class IS_DEP_1930_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_DEP_1930_LDataSet(){}
	public IS_DEP_1930_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_DEP_1930_LCURLISTRecord rec = new IS_DEP_1930_LCURLISTRecord();
			...
			rec.trsm_status = Util.checkString(rset0.getString("trsm_status"));
			rec.sms_trsm_dt = Util.checkString(rset0.getString("sms_trsm_dt"));
...
<%
	IS_DEP_1930_LDataSet ds = (IS_DEP_1930_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		IS_DEP_1930_LCURLISTRecord curlistRec = (IS_DEP_1930_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
<%= curlistRec.trsm_status%>
<%= curlistRec.sms_trsm_dt%>
