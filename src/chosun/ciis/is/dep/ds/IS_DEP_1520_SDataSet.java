...
public class IS_DEP_1520_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public IS_DEP_1520_SDataSet(){}
	public IS_DEP_1520_SDataSet(String errcode, String errmsg, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String payo_slip_no, String rcpm_slip_no, String actu_slip_no, String dlco_no, String dlco_nm, String payo_clsf, String rcpm_tot_amt, String medi_cd, String drbk_amt, String clos_stat){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.payo_clsf = Util.checkString(cstmt.getString(13));
		this.rcpm_tot_amt = Util.checkString(cstmt.getString(14));
		this.medi_cd = Util.checkString(cstmt.getString(15));
		this.drbk_amt = Util.checkString(cstmt.getString(16));
		this.clos_stat = Util.checkString(cstmt.getString(17));
	}
}/*----------------------------------------------------------------------------------------------------
