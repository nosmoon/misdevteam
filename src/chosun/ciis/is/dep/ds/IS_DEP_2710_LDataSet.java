...
public class IS_DEP_2710_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_DEP_2710_LDataSet(){}
	public IS_DEP_2710_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_DEP_2710_LCURLISTRecord rec = new IS_DEP_2710_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		IS_DEP_2710_LCURLISTRecord curlistRec = (IS_DEP_2710_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
