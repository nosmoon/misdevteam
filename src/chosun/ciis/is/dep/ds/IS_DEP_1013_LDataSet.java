...
public class IS_DEP_1013_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;
	public String dlco_no;

	public IS_DEP_1013_LDataSet(){}
	public IS_DEP_1013_LDataSet(String errcode, String errmsg, String dlco_no){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_DEP_1013_LCURLISTRecord rec = new IS_DEP_1013_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		IS_DEP_1013_LCURLISTRecord curlistRec = (IS_DEP_1013_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
