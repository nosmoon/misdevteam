...
public class IS_DEP_1010_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public IS_DEP_1010_SDataSet(){}
	public IS_DEP_1010_SDataSet(String errcode, String errmsg, String occr_dt, String slip_clsf, String seq, String rcpm_shet_no, String self_cmpy_yn, String rcpm_plac_clsf, String dlco_no, String dlco_nm, String medi_cd, String dept_cd, String sub_dept_cd, String mchrg_pers, String mchrg_pers_nm, String clos_yn, String seq_clsf, String pre_seq, String next_seq){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_DEP_1010_SCURLIST1Record rec = new IS_DEP_1010_SCURLIST1Record();
		...
		while(rset1.next()){
			IS_DEP_1010_SCURLIST2Record rec = new IS_DEP_1010_SCURLIST2Record();
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		IS_DEP_1010_SCURLIST1Record curlist1Rec = (IS_DEP_1010_SCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		IS_DEP_1010_SCURLIST2Record curlist2Rec = (IS_DEP_1010_SCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Mon Jul 16 19:50:51 KST 2012 */