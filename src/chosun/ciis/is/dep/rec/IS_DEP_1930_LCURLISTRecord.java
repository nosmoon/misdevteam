...
public class IS_DEP_1930_LCURLISTRecord extends java.lang.Object implements java.io.Serializable{
	...
	public String trsm_status;
	public String sms_trsm_dt;
	public String slip_clsf;
	public String seq;
	public String subseq;

	public IS_DEP_1930_LCURLISTRecord(){}
	...
	public void setTrsm_status(String trsm_status){
		this.trsm_status = trsm_status;
	}

	public void setSms_trsm_dt(String sms_trsm_dt){
		this.sms_trsm_dt = sms_trsm_dt;
	}
	...
	public String getTrsm_status(){
		return this.trsm_status;
	}

	public String getSms_trsm_dt(){
		return this.sms_trsm_dt;
	}
