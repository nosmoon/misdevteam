...
public class IS_DEP_1100_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String clos_yymm;
	public String work_clsf;

	public IS_DEP_1100_MDM(){}
	public IS_DEP_1100_MDM(String cmpy_cd, String clos_yymm, String work_clsf){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_DEP_1100_M(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_DEP_1100_MDM dm = (IS_DEP_1100_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.dep.ds.IS_DEP_1100_MDataSet();
	}
...
/* 작성시간 : Thu May 17 09:52:58 KST 2012 */