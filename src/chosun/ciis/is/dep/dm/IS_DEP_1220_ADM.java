...
public class IS_DEP_1220_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_DEP_1220_ADM(){}
	public IS_DEP_1220_ADM(String cmpy_cd, String slip_clsf_cd, String clos_dt, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_DEP_1220_A(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_DEP_1220_ADM dm = (IS_DEP_1220_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.dep.ds.IS_DEP_1220_ADataSet();
	}
...
/* 작성시간 : Wed May 16 21:01:06 KST 2012 */