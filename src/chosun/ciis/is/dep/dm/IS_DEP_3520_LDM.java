...
public class IS_DEP_3520_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_DEP_3520_LDM(){}
	public IS_DEP_3520_LDM(String cmpy_cd, String dlco_no, String frdt, String todt, String basi_dt, String eps_clsf){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_DEP_3520_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_DEP_3520_LDM dm = (IS_DEP_3520_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.dep.ds.IS_DEP_3520_LDataSet();
	}
