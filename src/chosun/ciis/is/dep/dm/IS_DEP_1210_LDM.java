...
public class IS_DEP_1210_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_DEP_1210_LDM(){}
	public IS_DEP_1210_LDM(String cmpy_cd, String slip_clsf_cd, String clos_fryy, String clos_toyy){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_DEP_1210_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_DEP_1210_LDM dm = (IS_DEP_1210_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.dep.ds.IS_DEP_1210_LDataSet();
	}
