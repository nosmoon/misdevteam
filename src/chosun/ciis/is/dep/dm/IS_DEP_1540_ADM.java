...
public class IS_DEP_1540_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_DEP_1540_ADM(){}
	public IS_DEP_1540_ADM(String flag, String cmpy_cd, String payo_clsf, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String medi_cd, String dlco_no, String dlco_nm, String drbk_amt, String incmg_dept_cd, String incmg_pers_ip, String incmg_pers){
		this.flag = flag;
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_DEP_1540_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_DEP_1540_ADM dm = (IS_DEP_1540_ADM)bdm;
		...
		cstmt.setString(12, dm.drbk_amt);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.dep.ds.IS_DEP_1540_ADataSet();
	}
...
/* 작성시간 : Mon May 21 21:45:42 KST 2012 */