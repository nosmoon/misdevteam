...
public class IS_DEP_2900_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_DEP_2900_MDM(){}
	public IS_DEP_2900_MDM(String cmpy_cd, String auth_gb, String use_yn, String incmg_pers, String base_dt){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_DEP_2900_M(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_DEP_2900_MDM dm = (IS_DEP_2900_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.dep.ds.IS_DEP_2900_MDataSet();
	}
