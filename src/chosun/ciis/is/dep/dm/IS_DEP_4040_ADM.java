...
public class IS_DEP_4040_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_DEP_4040_ADM(){}
	public IS_DEP_4040_ADM(String cmpy_cd, String card_rcpm_reg_dt, String card_rcpm_reg_seq, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_DEP_4040_A(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_DEP_4040_ADM dm = (IS_DEP_4040_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.dep.ds.IS_DEP_4040_ADataSet();
	}
...
/* 작성시간 : Tue Jul 10 11:53:03 KST 2012 */