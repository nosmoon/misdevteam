...
public class IS_DEP_1910_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_DEP_1910_LDM(){}
	public IS_DEP_1910_LDM(String cmpy_cd, String occr_frdt, String occr_todt, String chg_frdt, String chg_todt, String dept_cd, String sub_dept_cd, String chrg_pers, String dlco_no, String trsm_yymm, String sms_trsm_yn, String card_rcpm_yn){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_DEP_1910_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_DEP_1910_LDM dm = (IS_DEP_1910_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.dep.ds.IS_DEP_1910_LDataSet();
	}
