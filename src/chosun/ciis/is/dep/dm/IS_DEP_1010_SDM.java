...
public class IS_DEP_1010_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_DEP_1010_SDM(){}
	public IS_DEP_1010_SDM(String cmpy_cd, String occr_dt, String slip_clsf, String seq){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_DEP_1010_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_DEP_1010_SDM dm = (IS_DEP_1010_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.dep.ds.IS_DEP_1010_SDataSet();
	}
