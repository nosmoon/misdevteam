...
public class IS_DEP_1751_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_DEP_1751_LDM(){}
	public IS_DEP_1751_LDM(String cmpy_cd, String slip_clsf, String date_clsf, String frdt, String todt, String dlco_no, String rcpm_clsf, String note_clsf, String mchrg_pers, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_DEP_1751_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_DEP_1751_LDM dm = (IS_DEP_1751_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.dep.ds.IS_DEP_1751_LDataSet();
	}
