...
public class IS_DEP_1620_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_DEP_1620_LDM(){}
	public IS_DEP_1620_LDM(String cmpy_cd, String slip_clsf, String dlco_no, String frdt, String todt, String slcrg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_DEP_1620_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_DEP_1620_LDM dm = (IS_DEP_1620_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.dep.ds.IS_DEP_1620_LDataSet();
	}
