...
public class IS_DEP_3720_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String rept_no;
	public String chk_item;

	public IS_DEP_3720_SDM(){}
	public IS_DEP_3720_SDM(String cmpy_cd, String rept_no, String chk_item){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_DEP_3720_S(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_DEP_3720_SDM dm = (IS_DEP_3720_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.dep.ds.IS_DEP_3720_SDataSet();
	}
...
/* 작성시간 : Mon May 21 09:07:19 KST 2012 */