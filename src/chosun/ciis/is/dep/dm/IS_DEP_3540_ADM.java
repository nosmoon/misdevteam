...
public class IS_DEP_3540_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_DEP_3540_ADM(){}
	public IS_DEP_3540_ADM(String cmpy_cd, String dlco_no, String eps_clsf, String enty_clsf, String rcpm_slip_no, String bank_cd, String note_no, String note_seq, String dhon_occr_dt, String dhon_amt, String dhon_bal, String issu_pers_nm, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_DEP_3540_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_DEP_3540_ADM dm = (IS_DEP_3540_ADM)bdm;
		...
		cstmt.setString(7, dm.rcpm_slip_no);
		cstmt.setString(8, dm.bank_cd);
		cstmt.setString(9, dm.note_no);
		cstmt.setString(10, dm.note_seq);
		cstmt.setString(11, dm.dhon_occr_dt);
		cstmt.setString(12, dm.dhon_amt);
		cstmt.setString(13, dm.dhon_bal);
		cstmt.setString(14, dm.issu_pers_nm);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.dep.ds.IS_DEP_3540_ADataSet();
	}
