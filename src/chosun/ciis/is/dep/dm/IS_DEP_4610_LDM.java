...
public class IS_DEP_4610_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_DEP_4610_LDM(){}
	public IS_DEP_4610_LDM(String cmpy_cd, String work_clsf, String clos_dt, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_DEP_4610_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_DEP_4610_LDM dm = (IS_DEP_4610_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.dep.ds.IS_DEP_4610_LDataSet();
	}
