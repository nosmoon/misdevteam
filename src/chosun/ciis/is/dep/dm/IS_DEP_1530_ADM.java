...
public class IS_DEP_1530_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_DEP_1530_ADM(){}
	public IS_DEP_1530_ADM(String flag, String cmpy_cd, String payo_clsf, String payo_slip_occr_dt, String payo_slip_clsf_cd, String payo_slip_seq, String rcpm_slip_occr_dt, String rcpm_slip_clsf_cd, String rcpm_slip_seq, String medi_cd, String dlco_no, String dlco_nm, String precpt_amt_bal, String occr_amt, String drbk_amt, String incmg_pers_ip, String incmg_pers){
		this.flag = flag;
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_DEP_1530_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_DEP_1530_ADM dm = (IS_DEP_1530_ADM)bdm;
		...
		cstmt.setString(15, dm.precpt_amt_bal);
		cstmt.setString(16, dm.occr_amt);
		cstmt.setString(17, dm.drbk_amt);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.dep.ds.IS_DEP_1530_ADataSet();
	}
...
/* 작성시간 : Mon May 21 20:50:37 KST 2012 */