...
public class IS_DEP_1420_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_DEP_1420_ADM(){}
	public IS_DEP_1420_ADM(String cmpy_cd, String slip_clsf, String occr_dt, String frdt, String todt, String bddb_clsf, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_DEP_1420_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_DEP_1420_ADM dm = (IS_DEP_1420_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.dep.ds.IS_DEP_1420_ADataSet();
	}
...
/* 작성시간 : Mon May 21 19:48:49 KST 2012 */