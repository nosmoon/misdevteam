...
public class IS_DEP_1110_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_DEP_1110_ADM(){}
	public IS_DEP_1110_ADM(String cmpy_cd, String work_clsf, String clos_dt, String incmg_dept_cd, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_DEP_1110_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_DEP_1110_ADM dm = (IS_DEP_1110_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.dep.ds.IS_DEP_1110_ADataSet();
	}
...
/* 작성시간 : Thu May 17 10:16:03 KST 2012 */