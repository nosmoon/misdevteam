...
public class IS_DEP_2720_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_DEP_2720_LDM(){}
	public IS_DEP_2720_LDM(String cmpy_cd, String sale_proc_frdt, String sale_proc_todt, String dept_cd, String sub_dept_cd, String chrg_pers, String dlco_clsf_cd_seq, String sale_clsf, String spc_sale_clsf, String rvord_type){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_DEP_2720_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_DEP_2720_LDM dm = (IS_DEP_2720_LDM)bdm;
		...
		cstmt.setString(11, dm.spc_sale_clsf);
		cstmt.setString(12, dm.rvord_type);
		cstmt.registerOutParameter(13, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.dep.ds.IS_DEP_2720_LDataSet();
	}
