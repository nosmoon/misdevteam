...
public class IS_AGR_2715_ADataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public String errcode;
	public String errmsg;
	public String make_ask_reg_dt;
	public String make_ask_reg_seq;

	public IS_AGR_2715_ADataSet(){}
	public IS_AGR_2715_ADataSet(String errcode, String errmsg, String make_ask_reg_dt, String make_ask_reg_seq){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.make_ask_reg_dt = Util.checkString(cstmt.getString(29));
		this.make_ask_reg_seq = Util.checkString(cstmt.getString(30));
	}
}/*----------------------------------------------------------------------------------------------------
Web Tier에서 DataSet 객체 관련 코드 작성시 사용하십시오.

<%
	IS_AGR_2715_ADataSet ds = (IS_AGR_2715_ADataSet)request.getAttribute("ds");
%>
