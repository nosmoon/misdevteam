...
public class IS_AGR_2900_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public IS_AGR_2900_MDataSet(){}
	public IS_AGR_2900_MDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_AGR_2900_MTEAMLISTRecord rec = new IS_AGR_2900_MTEAMLISTRecord();
		...
		while(rset1.next()){
			IS_AGR_2900_MPARTLISTRecord rec = new IS_AGR_2900_MPARTLISTRecord();
		...
		while(rset2.next()){
			IS_AGR_2900_MCURLIST1Record rec = new IS_AGR_2900_MCURLIST1Record();
		...
		while(rset3.next()){
			IS_AGR_2900_MCURLIST2Record rec = new IS_AGR_2900_MCURLIST2Record();
		...
		while(rset4.next()){
			IS_AGR_2900_MCURLIST3Record rec = new IS_AGR_2900_MCURLIST3Record();
		...
		while(rset5.next()){
			IS_AGR_2900_MCURLIST4Record rec = new IS_AGR_2900_MCURLIST4Record();
		...
		while(rset6.next()){
			IS_AGR_2900_MCURLIST5Record rec = new IS_AGR_2900_MCURLIST5Record();
...
<%
	IS_AGR_2900_MDataSet ds = (IS_AGR_2900_MDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.teamlist.size(); i++){
		IS_AGR_2900_MTEAMLISTRecord teamlistRec = (IS_AGR_2900_MTEAMLISTRecord)ds.teamlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.partlist.size(); i++){
		IS_AGR_2900_MPARTLISTRecord partlistRec = (IS_AGR_2900_MPARTLISTRecord)ds.partlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		IS_AGR_2900_MCURLIST1Record curlist1Rec = (IS_AGR_2900_MCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		IS_AGR_2900_MCURLIST2Record curlist2Rec = (IS_AGR_2900_MCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		IS_AGR_2900_MCURLIST3Record curlist3Rec = (IS_AGR_2900_MCURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist4.size(); i++){
		IS_AGR_2900_MCURLIST4Record curlist4Rec = (IS_AGR_2900_MCURLIST4Record)ds.curlist4.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist5.size(); i++){
		IS_AGR_2900_MCURLIST5Record curlist5Rec = (IS_AGR_2900_MCURLIST5Record)ds.curlist5.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Thu Jun 07 09:23:42 KST 2012 */