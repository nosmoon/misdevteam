...
public class IS_AGR_1830_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_AGR_1830_LDataSet(){}
	public IS_AGR_1830_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_AGR_1830_LCURLISTRecord rec = new IS_AGR_1830_LCURLISTRecord();
...
<%
	IS_AGR_1830_LDataSet ds = (IS_AGR_1830_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		IS_AGR_1830_LCURLISTRecord curlistRec = (IS_AGR_1830_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Fri Jun 01 15:08:04 KST 2012 */