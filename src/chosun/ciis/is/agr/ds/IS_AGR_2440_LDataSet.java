...
public class IS_AGR_2440_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_AGR_2440_LDataSet(){}
	public IS_AGR_2440_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_AGR_2440_LCURLISTRecord rec = new IS_AGR_2440_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		IS_AGR_2440_LCURLISTRecord curlistRec = (IS_AGR_2440_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Fri Jun 01 11:18:54 KST 2012 */