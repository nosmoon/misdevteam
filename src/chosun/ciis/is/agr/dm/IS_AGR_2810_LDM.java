...
public class IS_AGR_2810_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_AGR_2810_LDM(){}
	public IS_AGR_2810_LDM(String cmpy_cd, String make_ask_reg_dt_fr, String make_ask_reg_dt_to, String dept_cd, String sub_dept_cd, String chrg_pers, String dlvs_dt_fr, String dlvs_dt_to, String work_clsf, String std_cd, String clr_cd, String dlco_no, String advcs_cd, String dlco_clsf_cd_seq, String proc_stat, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_AGR_2810_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_AGR_2810_LDM dm = (IS_AGR_2810_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.agr.ds.IS_AGR_2810_LDataSet();
	}
