...
public class IS_AGR_1920_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_AGR_1920_LDM(){}
	public IS_AGR_1920_LDM(String cmpy_cd, String scat_dt_fr, String scat_dt_to, String dept_cd, String sub_dept_cd, String chrg_pers, String spc_sale_clsf, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_AGR_1920_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_AGR_1920_LDM dm = (IS_AGR_1920_LDM)bdm;
		...
		cstmt.setString(9, dm.spc_sale_clsf);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.agr.ds.IS_AGR_1920_LDataSet();
	}
...
/* 작성시간 : Fri Jun 01 16:12:40 KST 2012 */