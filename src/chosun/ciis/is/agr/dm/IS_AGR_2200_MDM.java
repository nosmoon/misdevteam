...
public class IS_AGR_2200_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_AGR_2200_MDM(){}
	public IS_AGR_2200_MDM(String cmpy_cd, String auth_gb, String use_yn, String incmg_pers, String base_dt){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_AGR_2200_M(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_AGR_2200_MDM dm = (IS_AGR_2200_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.agr.ds.IS_AGR_2200_MDataSet();
	}
