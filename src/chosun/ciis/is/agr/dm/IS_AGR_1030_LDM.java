...
public class IS_AGR_1030_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String asnt_dstc_cd;

	public IS_AGR_1030_LDM(){}
	public IS_AGR_1030_LDM(String cmpy_cd, String asnt_dstc_cd){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_AGR_1030_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_AGR_1030_LDM dm = (IS_AGR_1030_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.asnt_dstc_cd);
		cstmt.registerOutParameter(5, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.agr.ds.IS_AGR_1030_LDataSet();
	}
