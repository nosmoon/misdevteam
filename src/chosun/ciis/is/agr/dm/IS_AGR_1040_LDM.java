...
public class IS_AGR_1040_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_AGR_1040_LDM(){}
	public IS_AGR_1040_LDM(String cmpy_cd, String scat_dt_fr, String scat_dt_to, String dept_cd, String sub_dept_cd, String chrg_pers, String dlco_clsf_cd_seq, String advcs_cd, String indt_cd, String sale_clsf, String spc_sale_clsf, String std_cd, String rvord_type, String advt_nm, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_AGR_1040_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_AGR_1040_LDM dm = (IS_AGR_1040_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.agr.ds.IS_AGR_1040_LDataSet();
	}
