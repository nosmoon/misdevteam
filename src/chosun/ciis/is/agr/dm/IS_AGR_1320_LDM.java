...
public class IS_AGR_1320_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_AGR_1320_LDM(){}
	public IS_AGR_1320_LDM(String cmpy_cd, String scat_dt_fr, String scat_dt_to, String dlco_clsf_cd_seq, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_AGR_1320_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_AGR_1320_LDM dm = (IS_AGR_1320_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.agr.ds.IS_AGR_1320_LDataSet();
	}
