...
public class IS_AGR_1940_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_AGR_1940_LDM(){}
	public IS_AGR_1940_LDM(String cmpy_cd, String scat_dt_fr, String scat_dt_to, String dept_cd, String sub_dept_cd, String chrg_pers, String spc_sale_clsf){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_AGR_1940_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_AGR_1940_LDM dm = (IS_AGR_1940_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.agr.ds.IS_AGR_1940_LDataSet();
	}
