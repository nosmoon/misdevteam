...
public class IS_AGR_2710_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_AGR_2710_SDM(){}
	public IS_AGR_2710_SDM(String cmpy_cd, String make_ask_reg_dt, String make_ask_reg_seq, String acwr_reg_dt, String acwr_reg_seq, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_AGR_2710_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_AGR_2710_SDM dm = (IS_AGR_2710_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.agr.ds.IS_AGR_2710_SDataSet();
	}
