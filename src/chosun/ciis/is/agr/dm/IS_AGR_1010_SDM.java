...
public class IS_AGR_1010_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_AGR_1010_SDM(){}
	public IS_AGR_1010_SDM(String cmpy_cd, String acwr_reg_dt, String acwr_reg_seq, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_AGR_1010_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_AGR_1010_SDM dm = (IS_AGR_1010_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.agr.ds.IS_AGR_1010_SDataSet();
	}
