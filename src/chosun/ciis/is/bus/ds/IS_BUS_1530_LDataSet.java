...
public class IS_BUS_1530_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist_b = new ArrayList();
	public ArrayList curlist_a = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_BUS_1530_LDataSet(){}
	public IS_BUS_1530_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_BUS_1530_LCURLIST_ARecord rec = new IS_BUS_1530_LCURLIST_ARecord();
		...
		while(rset1.next()){
			IS_BUS_1530_LCURLIST_BRecord rec = new IS_BUS_1530_LCURLIST_BRecord();
...
<%
	for(int i=0; i<ds.curlist_a.size(); i++){
		IS_BUS_1530_LCURLIST_ARecord curlist_aRec = (IS_BUS_1530_LCURLIST_ARecord)ds.curlist_a.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist_b.size(); i++){
		IS_BUS_1530_LCURLIST_BRecord curlist_bRec = (IS_BUS_1530_LCURLIST_BRecord)ds.curlist_b.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Tue Jun 19 09:41:28 KST 2012 */