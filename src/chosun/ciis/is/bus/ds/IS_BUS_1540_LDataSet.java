...
public class IS_BUS_1540_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist_a = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_BUS_1540_LDataSet(){}
	public IS_BUS_1540_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_BUS_1540_LCURLIST_ARecord rec = new IS_BUS_1540_LCURLIST_ARecord();
...
<%
	IS_BUS_1540_LDataSet ds = (IS_BUS_1540_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist_a.size(); i++){
		IS_BUS_1540_LCURLIST_ARecord curlist_aRec = (IS_BUS_1540_LCURLIST_ARecord)ds.curlist_a.get(i);%>
HTML 코드들....
	<%}%>
