...
public class IS_BUS_1710_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_BUS_1710_LDataSet(){}
	public IS_BUS_1710_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_BUS_1710_LCURLISTRecord rec = new IS_BUS_1710_LCURLISTRecord();
...
<%
	IS_BUS_1710_LDataSet ds = (IS_BUS_1710_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		IS_BUS_1710_LCURLISTRecord curlistRec = (IS_BUS_1710_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
