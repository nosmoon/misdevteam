...
public class IS_BUS_1740_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_BUS_1740_LDataSet(){}
	public IS_BUS_1740_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_BUS_1740_LCURLISTRecord rec = new IS_BUS_1740_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		IS_BUS_1740_LCURLISTRecord curlistRec = (IS_BUS_1740_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
