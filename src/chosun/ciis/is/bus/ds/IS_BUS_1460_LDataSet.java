...
public class IS_BUS_1460_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist_a = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_BUS_1460_LDataSet(){}
	public IS_BUS_1460_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_BUS_1460_LCURLIST_ARecord rec = new IS_BUS_1460_LCURLIST_ARecord();
			rec.dept_cd_nm = Util.checkString(rset0.getString("dept_cd_nm"));
			rec.dw_amt = Util.checkString(rset0.getString("dw_amt"));
			rec.dw_amt_3 = Util.checkString(rset0.getString("dw_amt_3"));
			rec.dw_amt_2 = Util.checkString(rset0.getString("dw_amt_2"));
			rec.jw_amt = Util.checkString(rset0.getString("jw_amt"));
			rec.jw_amt_3 = Util.checkString(rset0.getString("jw_amt_3"));
			rec.jw_amt_2 = Util.checkString(rset0.getString("jw_amt_2"));
			rec.dw_amt_rate = Util.checkString(rset0.getString("dw_amt_rate"));
			rec.dw_amt_3_rate = Util.checkString(rset0.getString("dw_amt_3_rate"));
			rec.dw_amt_2_rate = Util.checkString(rset0.getString("dw_amt_2_rate"));
...
<%
	for(int i=0; i<ds.curlist_a.size(); i++){
		IS_BUS_1460_LCURLIST_ARecord curlist_aRec = (IS_BUS_1460_LCURLIST_ARecord)ds.curlist_a.get(i);%>
HTML 코드들....
	<%}%>
...
<%= curlist_aRec.dw_amt%>
<%= curlist_aRec.dw_amt_3%>
<%= curlist_aRec.dw_amt_2%>
<%= curlist_aRec.jw_amt%>
<%= curlist_aRec.jw_amt_3%>
<%= curlist_aRec.jw_amt_2%>
<%= curlist_aRec.dw_amt_rate%>
<%= curlist_aRec.dw_amt_3_rate%>
<%= curlist_aRec.dw_amt_2_rate%>
<%= curlist_aRec.dm_amt%>
...
/* 작성시간 : Mon Jun 18 13:31:05 KST 2012 */