...
public class IS_BUS_2210_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist_1 = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_BUS_2210_LDataSet(){}
	public IS_BUS_2210_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_BUS_2210_LCURLIST_1Record rec = new IS_BUS_2210_LCURLIST_1Record();
...
<%
	IS_BUS_2210_LDataSet ds = (IS_BUS_2210_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist_1.size(); i++){
		IS_BUS_2210_LCURLIST_1Record curlist_1Rec = (IS_BUS_2210_LCURLIST_1Record)ds.curlist_1.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Thu Jun 21 19:06:24 KST 2012 */