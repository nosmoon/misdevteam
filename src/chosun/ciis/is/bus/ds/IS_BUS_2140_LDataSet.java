...
public class IS_BUS_2140_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist_1 = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_BUS_2140_LDataSet(){}
	public IS_BUS_2140_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_BUS_2140_LCURLIST_1Record rec = new IS_BUS_2140_LCURLIST_1Record();
...
<%
	for(int i=0; i<ds.curlist_1.size(); i++){
		IS_BUS_2140_LCURLIST_1Record curlist_1Rec = (IS_BUS_2140_LCURLIST_1Record)ds.curlist_1.get(i);%>
HTML 코드들....
	<%}%>
