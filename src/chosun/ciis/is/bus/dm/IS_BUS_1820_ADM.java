...
public class IS_BUS_1820_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_BUS_1820_ADM(){}
	public IS_BUS_1820_ADM(String flag, String cmpy_cd, String preng_dt, String seq, String sale_clsf, String spcsale_clsf, String medi_cd, String area_nm, String advcs_nm, String remk_matt, String area_cd, String dept_cd, String sub_dept_cd, String make_pers, String incmg_pers_ip, String incmg_pers){
		this.flag = flag;
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_BUS_1820_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_BUS_1820_ADM dm = (IS_BUS_1820_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.bus.ds.IS_BUS_1820_ADataSet();
	}
...
/* 작성시간 : Wed Jun 20 19:12:13 KST 2012 */