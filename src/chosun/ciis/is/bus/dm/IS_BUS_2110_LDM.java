...
public class IS_BUS_2110_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_BUS_2110_LDM(){}
	public IS_BUS_2110_LDM(String cmpy_cd, String feed_frdt, String feed_todt, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_BUS_2110_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_BUS_2110_LDM dm = (IS_BUS_2110_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.bus.ds.IS_BUS_2110_LDataSet();
	}
