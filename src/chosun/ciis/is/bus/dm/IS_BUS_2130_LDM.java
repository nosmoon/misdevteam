...
public class IS_BUS_2130_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String feed_dt;
	public String incmg_pers;

	public IS_BUS_2130_LDM(){}
	public IS_BUS_2130_LDM(String cmpy_cd, String feed_dt, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_BUS_2130_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_BUS_2130_LDM dm = (IS_BUS_2130_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.bus.ds.IS_BUS_2130_LDataSet();
	}
