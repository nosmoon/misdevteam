...
public class IS_BUS_1410_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_BUS_1410_LDM(){}
	public IS_BUS_1410_LDM(String cmpy_cd, String yymm, String wkcd, String dept_cd, String sub_dept_cd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_BUS_1410_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_BUS_1410_LDM dm = (IS_BUS_1410_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.bus.ds.IS_BUS_1410_LDataSet();
	}
