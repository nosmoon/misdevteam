...
public class IS_BUS_1740_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_BUS_1740_LDM(){}
	public IS_BUS_1740_LDM(String cmpy_cd, String yymm, String spcsale_clsf, String sale_clsf){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_BUS_1740_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_BUS_1740_LDM dm = (IS_BUS_1740_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.bus.ds.IS_BUS_1740_LDataSet();
	}
