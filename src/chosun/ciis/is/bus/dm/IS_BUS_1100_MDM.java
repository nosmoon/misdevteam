...
public class IS_BUS_1100_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_BUS_1100_MDM(){}
	public IS_BUS_1100_MDM(String cmpy_cd, String auth_gb, String use_yn, String incmg_pers, String base_dt){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_BUS_1100_M(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_BUS_1100_MDM dm = (IS_BUS_1100_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.bus.ds.IS_BUS_1100_MDataSet();
	}
...
/* 작성시간 : Wed Jun 20 09:26:36 KST 2012 */