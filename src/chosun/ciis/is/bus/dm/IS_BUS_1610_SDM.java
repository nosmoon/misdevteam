...
public class IS_BUS_1610_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_BUS_1610_SDM(){}
	public IS_BUS_1610_SDM(String cmpy_cd, String base_dt, String rept_dt, String dept_cd, String sub_dept_cd, String chrg_pers, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_BUS_1610_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_BUS_1610_SDM dm = (IS_BUS_1610_SDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.base_dt);
		cstmt.setString(5, dm.rept_dt);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.bus.ds.IS_BUS_1610_SDataSet();
	}
