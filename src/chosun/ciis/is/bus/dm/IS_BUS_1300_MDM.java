...
public class IS_BUS_1300_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_BUS_1300_MDM(){}
	public IS_BUS_1300_MDM(String cmpy_cd, String auth_gb, String use_yn, String incmg_pers, String base_dt){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_BUS_1300_M(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_BUS_1300_MDM dm = (IS_BUS_1300_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.bus.ds.IS_BUS_1300_MDataSet();
	}
