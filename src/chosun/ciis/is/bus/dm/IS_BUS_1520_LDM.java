...
public class IS_BUS_1520_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_BUS_1520_LDM(){}
	public IS_BUS_1520_LDM(String cmpy_cd, String yymm, String fr_dt, String to_dt, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_BUS_1520_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_BUS_1520_LDM dm = (IS_BUS_1520_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.bus.ds.IS_BUS_1520_LDataSet();
	}
