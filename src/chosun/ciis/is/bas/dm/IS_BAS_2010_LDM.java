...
public class IS_BAS_2010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_BAS_2010_LDM(){}
	public IS_BAS_2010_LDM(String cmpy_cd, String year, String dept_cd, String sub_dept_cd, String chrg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_BAS_2010_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_BAS_2010_LDM dm = (IS_BAS_2010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.bas.ds.IS_BAS_2010_LDataSet();
	}
