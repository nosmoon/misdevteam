...
public class IS_BAS_1210_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_BAS_1210_LDM(){}
	public IS_BAS_1210_LDM(String cmpy_cd, String dlco_clsf_cd_seq, String adms_dstc_cd, String asnt_dstc_cd, String leaf_now_chrg_pers, String dept_cd, String sub_dept_cd){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_BAS_1210_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_BAS_1210_LDM dm = (IS_BAS_1210_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.bas.ds.IS_BAS_1210_LDataSet();
	}
