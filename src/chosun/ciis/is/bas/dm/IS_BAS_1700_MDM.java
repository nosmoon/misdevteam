...
public class IS_BAS_1700_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_BAS_1700_MDM(){}
	public IS_BAS_1700_MDM(String cmpy_cd, String auth_gb, String use_yn, String incmg_pers, String base_dt){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_BAS_1700_M(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_BAS_1700_MDM dm = (IS_BAS_1700_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.bas.ds.IS_BAS_1700_MDataSet();
	}
