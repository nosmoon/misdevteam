...
public class IS_BAS_1220_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_BAS_1220_ADM(){}
	public IS_BAS_1220_ADM(String cmpy_cd, String mode, String dlco_clsf, String dlco_cd, String dlco_seq, String dept_cd, String sub_dept_cd, String leaf_now_chrg_pers, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_BAS_1220_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_BAS_1220_ADM dm = (IS_BAS_1220_ADM)bdm;
		...
		cstmt.setString(10, dm.leaf_now_chrg_pers);
		cstmt.setString(11, dm.incmg_pers);
		cstmt.setString(12, dm.incmg_pers_ip);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.bas.ds.IS_BAS_1220_ADataSet();
	}
