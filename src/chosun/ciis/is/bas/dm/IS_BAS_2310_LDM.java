...
public class IS_BAS_2310_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_BAS_2310_LDM(){}
	public IS_BAS_2310_LDM(String cmpy_cd, String dlco_clsf_cd_seq, String adms_dstc_cd, String asnt_dstc_cd, String leaf_now_chrg_pers, String dept_cd, String sub_dept_cd){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_BAS_2310_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_BAS_2310_LDM dm = (IS_BAS_2310_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.bas.ds.IS_BAS_2310_LDataSet();
	}
...
/* 작성시간 : Fri Apr 27 17:10:45 KST 2012 */