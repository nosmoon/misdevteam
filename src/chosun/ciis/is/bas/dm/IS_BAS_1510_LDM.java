...
public class IS_BAS_1510_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_BAS_1510_LDM(){}
	public IS_BAS_1510_LDM(String cmpy_cd, String advcs_cd, String advcs_nm, String indt_cd){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_BAS_1510_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_BAS_1510_LDM dm = (IS_BAS_1510_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.bas.ds.IS_BAS_1510_LDataSet();
	}
