...
public class IS_BAS_1010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String std_cd;

	public IS_BAS_1010_LDM(){}
	public IS_BAS_1010_LDM(String cmpy_cd, String std_cd){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_BAS_1010_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_BAS_1010_LDM dm = (IS_BAS_1010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.bas.ds.IS_BAS_1010_LDataSet();
	}
