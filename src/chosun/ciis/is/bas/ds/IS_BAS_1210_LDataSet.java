...
public class IS_BAS_1210_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_BAS_1210_LDataSet(){}
	public IS_BAS_1210_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_BAS_1210_LCURLISTRecord rec = new IS_BAS_1210_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		IS_BAS_1210_LCURLISTRecord curlistRec = (IS_BAS_1210_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
