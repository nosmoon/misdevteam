...
public class IS_BAS_2040_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_BAS_2040_LDataSet(){}
	public IS_BAS_2040_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_BAS_2040_LCURLISTRecord rec = new IS_BAS_2040_LCURLISTRecord();
...
<%
	IS_BAS_2040_LDataSet ds = (IS_BAS_2040_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		IS_BAS_2040_LCURLISTRecord curlistRec = (IS_BAS_2040_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
