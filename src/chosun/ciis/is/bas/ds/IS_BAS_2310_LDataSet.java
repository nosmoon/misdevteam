...
public class IS_BAS_2310_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_BAS_2310_LDataSet(){}
	public IS_BAS_2310_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_BAS_2310_LCURLISTRecord rec = new IS_BAS_2310_LCURLISTRecord();
...
<%
	IS_BAS_2310_LDataSet ds = (IS_BAS_2310_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		IS_BAS_2310_LCURLISTRecord curlistRec = (IS_BAS_2310_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
