...
public class IS_SND_1410_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String std_kind_cd;
	public String bnch_qty;
	public String incmg_pers;
	public String incmg_pers_ip;

	public IS_SND_1410_LDM(){}
	public IS_SND_1410_LDM(String cmpy_cd, String scat_dt_fr, String scat_dt_to, String purc_dlco_clsf_cd_seq, String asnt_dstc_cd, String std_kind_cd, String bnch_qty, String incmg_pers, String incmg_pers_ip){
	...
	public void setStd_kind_cd(String std_kind_cd){
		this.std_kind_cd = std_kind_cd;
	}
	...
	public String getStd_kind_cd(){
		return this.std_kind_cd;
	}
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_SND_1410_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_SND_1410_LDM dm = (IS_SND_1410_LDM)bdm;
		...
		cstmt.setString(8, dm.std_kind_cd);
		cstmt.setString(9, dm.bnch_qty);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.snd.ds.IS_SND_1410_LDataSet();
	}
	...
	public void print(){
		...
		System.out.println("std_kind_cd = [" + getStd_kind_cd() + "]");
...
String std_kind_cd = req.getParameter("std_kind_cd");
if( std_kind_cd == null){
	System.out.println(this.toString+" : std_kind_cd is null" );
}else{
	System.out.println(this.toString+" : std_kind_cd is "+std_kind_cd );
}
...
String std_kind_cd = Util.checkString(req.getParameter("std_kind_cd"));
...
String std_kind_cd = Util.Uni2Ksc(Util.checkString(req.getParameter("std_kind_cd")));
