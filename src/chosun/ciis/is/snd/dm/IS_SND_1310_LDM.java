...
public class IS_SND_1310_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_SND_1310_LDM(){}
	public IS_SND_1310_LDM(String cmpy_cd, String scat_dt_fr, String scat_dt_to, String dept_cd, String sub_dept_cd, String chrg_pers, String dlco_clsf_cd_seq, String advcs_cd, String indt_cd, String sale_clsf, String spc_sale_clsf, String std_cd, String wh_cd, String advt_nm, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_SND_1310_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_SND_1310_LDM dm = (IS_SND_1310_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.snd.ds.IS_SND_1310_LDataSet();
	}
