...
public class IS_SND_1430_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_SND_1430_LDM(){}
	public IS_SND_1430_LDM(String cmpy_cd, String scat_dt_fr, String scat_dt_to, String purc_dlco_clsf_cd_seq, String asnt_dstc_cd, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_SND_1430_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_SND_1430_LDM dm = (IS_SND_1430_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.snd.ds.IS_SND_1430_LDataSet();
	}
...
/* 작성시간 : Fri May 25 16:09:57 KST 2012 */