...
public class IS_SND_1255_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_SND_1255_LDM(){}
	public IS_SND_1255_LDM(String flag, String cmpy_cd, String send_dt, String send_seq, String scat_dt_fr, String scat_dt_to, String wh_cd, String std_cd_1, String bnch_qty_1, String cmpy_cd_2, String asnt_dstc_cd_2, String cmpy_cd_3, String acwr_reg_dt_3, String acwr_reg_seq_3, String bnch_qty_3, String cmpy_cd_4, String asnt_dstc_cd_4, String purc_dlco_no_4, String incmg_pers, String incmg_pers_ip){
		this.flag = flag;
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_SND_1255_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_SND_1255_LDM dm = (IS_SND_1255_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.snd.ds.IS_SND_1255_LDataSet();
	}
