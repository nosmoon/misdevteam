...
public class IS_SND_1520_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_SND_1520_LDM(){}
	public IS_SND_1520_LDM(String cmpy_cd, String scat_dt_fr, String scat_dt_to, String dept_cd, String sub_dept_cd, String chrg_pers, String dlco_clsf_cd_seq, String advt_nm, String wh_cd, String advcs_cd, String ariv_plan_tm, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_SND_1520_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_SND_1520_LDM dm = (IS_SND_1520_LDM)bdm;
		...
		cstmt.setString(10, dm.advt_nm);
		cstmt.setString(11, dm.wh_cd);
		cstmt.setString(12, dm.advcs_cd);
		cstmt.setString(13, dm.ariv_plan_tm);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.snd.ds.IS_SND_1520_LDataSet();
	}
	...
	public void print(){
		...
		System.out.println("ariv_plan_tm = [" + getAriv_plan_tm() + "]");
...
String ariv_plan_tm = req.getParameter("ariv_plan_tm");
if( ariv_plan_tm == null){
	System.out.println(this.toString+" : ariv_plan_tm is null" );
}else{
	System.out.println(this.toString+" : ariv_plan_tm is "+ariv_plan_tm );
}
...
String ariv_plan_tm = Util.checkString(req.getParameter("ariv_plan_tm"));
...
String ariv_plan_tm = Util.Uni2Ksc(Util.checkString(req.getParameter("ariv_plan_tm")));
