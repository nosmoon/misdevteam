...
public class IS_SND_1230_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_SND_1230_LDM(){}
	public IS_SND_1230_LDM(String cmpy_cd, String scat_dt_fr, String scat_dt_to, String wh_cd, String std_cd_1, String bnch_qty_1, String cmpy_cd_2, String asnt_dstc_cd_2, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_SND_1230_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_SND_1230_LDM dm = (IS_SND_1230_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.snd.ds.IS_SND_1230_LDataSet();
	}
