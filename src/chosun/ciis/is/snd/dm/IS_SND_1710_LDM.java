...
public class IS_SND_1710_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_SND_1710_LDM(){}
	public IS_SND_1710_LDM(String cmpy_cd, String wh_cd, String send_dt, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_SND_1710_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_SND_1710_LDM dm = (IS_SND_1710_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.snd.ds.IS_SND_1710_LDataSet();
	}
