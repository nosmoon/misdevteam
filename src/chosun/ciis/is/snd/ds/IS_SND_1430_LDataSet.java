...
public class IS_SND_1430_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_SND_1430_LDataSet(){}
	public IS_SND_1430_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_SND_1430_LCURLISTRecord rec = new IS_SND_1430_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		IS_SND_1430_LCURLISTRecord curlistRec = (IS_SND_1430_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
