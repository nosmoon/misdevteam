...
public class IS_SND_1010_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist1 = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_SND_1010_LDataSet(){}
	public IS_SND_1010_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_SND_1010_LCURLIST1Record rec = new IS_SND_1010_LCURLIST1Record();
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		IS_SND_1010_LCURLIST1Record curlist1Rec = (IS_SND_1010_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>
