...
public class IS_COM_1110_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_COM_1110_LDataSet(){}
	public IS_COM_1110_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_COM_1110_LCURLISTRecord rec = new IS_COM_1110_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		IS_COM_1110_LCURLISTRecord curlistRec = (IS_COM_1110_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
