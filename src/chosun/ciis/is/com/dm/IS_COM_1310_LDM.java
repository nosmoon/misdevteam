...
public class IS_COM_1310_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_COM_1310_LDM(){}
	public IS_COM_1310_LDM(String cmpy_cd, String bo_nm, String bo_head_nm, String cntr_stat_clsf, String dept_cd, String bo_cd){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_COM_1310_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_COM_1310_LDM dm = (IS_COM_1310_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.com.ds.IS_COM_1310_LDataSet();
	}
...
/* 작성시간 : Wed May 02 16:34:55 KST 2012 */