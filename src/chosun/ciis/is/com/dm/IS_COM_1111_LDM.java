...
public class IS_COM_1111_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_COM_1111_LDM(){}
	public IS_COM_1111_LDM(String cmpy_cd, String dlco_clsf, String dlco_cd_seq_fr, String dlco_cd_seq_to, String dlco_nm, String ern, String cntr_stat_clsf, String leaf_sale_yn, String leaf_purc_yn, String dmang_bo_yn, String outsd_leaf_cmpy_yn, String vexc_cmpy_yn, String design_cmpy_yn, String excep_main_prt_plac_yn, String isgrp_yn, String sp_deal_yn){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_COM_1111_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_COM_1111_LDM dm = (IS_COM_1111_LDM)bdm;
		...
		cstmt.setString(9, dm.cntr_stat_clsf);
		cstmt.setString(10, dm.leaf_sale_yn);
		cstmt.setString(11, dm.leaf_purc_yn);
		cstmt.setString(12, dm.dmang_bo_yn);
		cstmt.setString(13, dm.outsd_leaf_cmpy_yn);
		cstmt.setString(14, dm.vexc_cmpy_yn);
		cstmt.setString(15, dm.design_cmpy_yn);
		cstmt.setString(16, dm.excep_main_prt_plac_yn);
		cstmt.setString(17, dm.isgrp_yn);
		cstmt.setString(18, dm.sp_deal_yn);
		cstmt.registerOutParameter(19, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.com.ds.IS_COM_1111_LDataSet();
	}
