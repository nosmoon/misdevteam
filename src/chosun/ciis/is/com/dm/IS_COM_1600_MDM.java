...
public class IS_COM_1600_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String medi_clsf;
	public String emp_no;

	public IS_COM_1600_MDM(){}
	public IS_COM_1600_MDM(String cmpy_cd, String medi_clsf, String emp_no){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_COM_1600_M(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_COM_1600_MDM dm = (IS_COM_1600_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.com.ds.IS_COM_1600_MDataSet();
	}
