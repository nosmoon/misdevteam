...
public class IS_COM_1110_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_COM_1110_LDM(){}
	public IS_COM_1110_LDM(String cmpy_cd, String dlco_clsf, String dlco_cd_seq_fr, String dlco_cd_seq_to, String dlco_nm, String ern, String cntr_stat_clsf, String leaf_sale_yn, String leaf_purc_yn, String dmang_bo_yn, String outsd_leaf_cmpy_yn, String vexc_cmpy_yn, String design_cmpy_yn, String excep_main_prt_plac_yn, String isgrp_yn, String sp_deal_yn){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_COM_1110_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_COM_1110_LDM dm = (IS_COM_1110_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.com.ds.IS_COM_1110_LDataSet();
	}
