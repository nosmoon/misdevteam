...
public class IS_SAL_1025_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public IS_SAL_1025_SDataSet(){}
	public IS_SAL_1025_SDataSet(String errcode, String errmsg, String prof_type_cd, String slip_clsf_cd, String slip_occr_dt, String slip_seq, String rcpm_plan_dt, String make_dt, String suply_amt, String vat_amt, String tot_amt, String setoff_yn, String canc_yn, String re_issu_resn_cd, String issu_tms, String tax_item, String suply_erplace_cd, String suply_ern, String suply_dlco_no, String suply_dlco_nm, String suply_presi_nm, String suply_addr, String suply_bizcond, String suply_item, String demand_biz_plc, String demand_ern, String demand_dlco_no, String demand_dlco_nm, String demand_dlco_abrv_nm, String demand_presi_nm, String demand_addr, String demand_bizcond, String demand_item, String remk1, String email_id, String elec_tax_comp_cd, String semuro_no, String chk_cnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.remk1 = Util.checkString(cstmt.getString(37));
		this.email_id = Util.checkString(cstmt.getString(38));
		this.elec_tax_comp_cd = Util.checkString(cstmt.getString(39));
		this.semuro_no = Util.checkString(cstmt.getString(40));
		this.chk_cnt = Util.checkString(cstmt.getString(41));
		ResultSet rset0 = (ResultSet) cstmt.getObject(42);
		while(rset0.next()){
			IS_SAL_1025_SCURLISTRecord rec = new IS_SAL_1025_SCURLISTRecord();
			rec.a_acwr_reg_dt_seq = Util.checkString(rset0.getString("a_acwr_reg_dt_seq"));
			rec.a_dlco_nm = Util.checkString(rset0.getString("a_dlco_nm"));
			rec.a_advt_nm = Util.checkString(rset0.getString("a_advt_nm"));
			rec.a_suply_amt = Util.checkString(rset0.getString("a_suply_amt"));
			rec.a_tqt_suply_amt = Util.checkString(rset0.getString("a_tqt_suply_amt"));
			rec.a_acwr_reg_dt = Util.checkString(rset0.getString("a_acwr_reg_dt"));
			rec.a_acwr_reg_seq = Util.checkString(rset0.getString("a_acwr_reg_seq"));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		IS_SAL_1025_SCURLISTRecord curlistRec = (IS_SAL_1025_SCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
<%= curlistRec.a_acwr_reg_dt_seq%>
<%= curlistRec.a_dlco_nm%>
<%= curlistRec.a_advt_nm%>
<%= curlistRec.a_suply_amt%>
<%= curlistRec.a_tqt_suply_amt%>
<%= curlistRec.a_acwr_reg_dt%>
<%= curlistRec.a_acwr_reg_seq%>
----------------------------------------------------------------------------------------------------*/
