...
public class IS_SAL_1060_ADataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public IS_SAL_1060_ADataSet(){}
	public IS_SAL_1060_ADataSet(String errcode, String errmsg, String prof_type_cd, String slip_clsf_cd, String slip_occr_dt, String slip_seq){
...
<%
	IS_SAL_1060_ADataSet ds = (IS_SAL_1060_ADataSet)request.getAttribute("ds");
%>
