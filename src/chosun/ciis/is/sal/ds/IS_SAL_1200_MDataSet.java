...
public class IS_SAL_1200_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public IS_SAL_1200_MDataSet(){}
	public IS_SAL_1200_MDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			IS_SAL_1200_MCURLISTRecord rec = new IS_SAL_1200_MCURLISTRecord();
...
<%
	IS_SAL_1200_MDataSet ds = (IS_SAL_1200_MDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		IS_SAL_1200_MCURLISTRecord curlistRec = (IS_SAL_1200_MCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Mon May 14 09:55:22 KST 2012 */