...
public class IS_SAL_1660_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_SAL_1660_ADM(){}
	public IS_SAL_1660_ADM(String cmpy_cd, String adjm_dt, String pay_plan_dd_pers, String incmg_dept_cd, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_SAL_1660_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_SAL_1660_ADM dm = (IS_SAL_1660_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.sal.ds.IS_SAL_1660_ADataSet();
	}
...
/* 작성시간 : Tue May 15 11:35:45 KST 2012 */