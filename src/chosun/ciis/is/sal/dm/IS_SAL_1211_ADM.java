...
public class IS_SAL_1211_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_SAL_1211_ADM(){}
	public IS_SAL_1211_ADM(String cmpy_cd, String work_clsf, String clos_dt, String incmg_dept_cd, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_SAL_1211_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_SAL_1211_ADM dm = (IS_SAL_1211_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.sal.ds.IS_SAL_1211_ADataSet();
	}
...
/* 작성시간 : Mon May 14 10:50:13 KST 2012 */