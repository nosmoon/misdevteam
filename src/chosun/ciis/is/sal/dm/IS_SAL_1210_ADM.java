...
public class IS_SAL_1210_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_SAL_1210_ADM(){}
	public IS_SAL_1210_ADM(String cmpy_cd, String work_clsf, String clos_dt, String incmg_dept_cd, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_SAL_1210_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_SAL_1210_ADM dm = (IS_SAL_1210_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.sal.ds.IS_SAL_1210_ADataSet();
	}
...
/* 작성시간 : Mon May 14 10:19:27 KST 2012 */