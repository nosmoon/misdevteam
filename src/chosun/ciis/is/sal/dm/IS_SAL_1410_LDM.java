...
public class IS_SAL_1410_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String work_clsf;
	public String clos_year;

	public IS_SAL_1410_LDM(){}
	public IS_SAL_1410_LDM(String cmpy_cd, String work_clsf, String clos_year){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_SAL_1410_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_SAL_1410_LDM dm = (IS_SAL_1410_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.sal.ds.IS_SAL_1410_LDataSet();
	}
