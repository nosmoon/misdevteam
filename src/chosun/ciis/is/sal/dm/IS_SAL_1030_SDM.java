...
public class IS_SAL_1030_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String dlco_clsf_cd_seq;

	public IS_SAL_1030_SDM(){}
	public IS_SAL_1030_SDM(String cmpy_cd, String dlco_clsf_cd_seq){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_SAL_1030_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_SAL_1030_SDM dm = (IS_SAL_1030_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.sal.ds.IS_SAL_1030_SDataSet();
	}
...
/* 작성시간 : Wed May 09 15:14:58 KST 2012 */