...
public class IS_SAL_1320_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String work_clsf;
	public String clos_yymm;

	public IS_SAL_1320_LDM(){}
	public IS_SAL_1320_LDM(String cmpy_cd, String work_clsf, String clos_yymm){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_SAL_1320_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_SAL_1320_LDM dm = (IS_SAL_1320_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.sal.ds.IS_SAL_1320_LDataSet();
	}
