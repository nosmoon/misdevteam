...
public class IS_SAL_1060_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_SAL_1060_ADM(){}
	public IS_SAL_1060_ADM(String cmpy_cd, String slip_clsf_cd, String slip_occr_dt, String prof_type_cd, String slip_seq, String make_dt, String email_id, String elec_tax_comp_cd, String biz_plc_cd, String remk, String incmg_dept_cd, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_SAL_1060_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_SAL_1060_ADM dm = (IS_SAL_1060_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.sal.ds.IS_SAL_1060_ADataSet();
	}
...
/* 작성시간 : Fri Jul 27 11:00:23 KST 2012 */