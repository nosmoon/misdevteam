...
public class IS_SAL_1430_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_SAL_1430_LDM(){}
	public IS_SAL_1430_LDM(String cmpy_cd, String quarter, String proc_clsf, String clos_year){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_SAL_1430_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_SAL_1430_LDM dm = (IS_SAL_1430_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.sal.ds.IS_SAL_1430_LDataSet();
	}
