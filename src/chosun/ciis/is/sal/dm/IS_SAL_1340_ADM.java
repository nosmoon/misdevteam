...
public class IS_SAL_1340_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_SAL_1340_ADM(){}
	public IS_SAL_1340_ADM(String flag, String cmpy_cd, String work_clsf, String clos_dt, String mang_frdt, String mang_todt, String incmg_pers_ip, String incmg_pers){
		this.flag = flag;
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_SAL_1340_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_SAL_1340_ADM dm = (IS_SAL_1340_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.sal.ds.IS_SAL_1340_ADataSet();
	}
...
/* 작성시간 : Mon May 14 13:07:59 KST 2012 */