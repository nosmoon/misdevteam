...
public class IS_SAL_1910_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public IS_SAL_1910_LDM(){}
	public IS_SAL_1910_LDM(String cmpy_cd, String prof_type_cd, String slip_clsf_cd, String occr_frdt, String occr_todt, String slip_seq, String dlco_no){
	...
	public String getSQL(){
		 return "{ call MISISP.SP_IS_SAL_1910_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		IS_SAL_1910_LDM dm = (IS_SAL_1910_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.is.sal.ds.IS_SAL_1910_LDataSet();
	}
