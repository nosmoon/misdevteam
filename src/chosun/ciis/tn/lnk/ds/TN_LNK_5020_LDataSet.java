...
public class TN_LNK_5020_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public TN_LNK_5020_LDataSet(){}
	public TN_LNK_5020_LDataSet(String errcode, String errmsg, long requestcount, long requestprice, long acptcount, long acptprice, long paycount, long payprice, long errorcount, long errorpayprice, long taxfee, long fee, long delcount, long delprice, long cnclcount, long cnclprice){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			TN_LNK_5020_LCURLISTRecord rec = new TN_LNK_5020_LCURLISTRecord();
...
<%
	TN_LNK_5020_LDataSet ds = (TN_LNK_5020_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		TN_LNK_5020_LCURLISTRecord curlistRec = (TN_LNK_5020_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Tue Mar 28 14:03:59 KST 2017 */