...
public class TN_LNK_6050_ADataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public TN_LNK_6050_ADataSet(){}
	public TN_LNK_6050_ADataSet(String errcode, String errmsg, long data_cnt, long data_amt, String server_ip, String server_port, String tg_begin, String tg_end){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			TN_LNK_6050_ACURLISTRecord rec = new TN_LNK_6050_ACURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		TN_LNK_6050_ACURLISTRecord curlistRec = (TN_LNK_6050_ACURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
