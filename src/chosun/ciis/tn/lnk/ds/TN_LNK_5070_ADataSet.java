...
public class TN_LNK_5070_ADataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public TN_LNK_5070_ADataSet(){}
	public TN_LNK_5070_ADataSet(String errcode, String errmsg, String server_ip, String server_port, long data_cnt, long data_amt, String tg_begin){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.tg_begin = Util.checkString(cstmt.getString(14));
		ResultSet rset0 = (ResultSet) cstmt.getObject(15);
		while(rset0.next()){
			TN_LNK_5070_ACURLISTRecord rec = new TN_LNK_5070_ACURLISTRecord();
...
<%
	TN_LNK_5070_ADataSet ds = (TN_LNK_5070_ADataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		TN_LNK_5070_ACURLISTRecord curlistRec = (TN_LNK_5070_ACURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
