...
public class TN_LNK_6030_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public TN_LNK_6030_LDataSet(){}
	public TN_LNK_6030_LDataSet(String errcode, String errmsg, long totcount, long totprice){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			TN_LNK_6030_LCURLISTRecord rec = new TN_LNK_6030_LCURLISTRecord();
...
<%
	TN_LNK_6030_LDataSet ds = (TN_LNK_6030_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		TN_LNK_6030_LCURLISTRecord curlistRec = (TN_LNK_6030_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
