...
public class TN_LNK_6030_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public TN_LNK_6030_LDM(){}
	public TN_LNK_6030_LDM(String cmpy_cd, String pymtmm, String pymtdd, String deptidx, String supp_clsf, String search_clsf, String search_nm){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_LNK_6030_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_LNK_6030_LDM dm = (TN_LNK_6030_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.pymtmm);
		cstmt.setString(5, dm.pymtdd);
		cstmt.setString(6, dm.deptidx);
		cstmt.setString(7, dm.supp_clsf);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.lnk.ds.TN_LNK_6030_LDataSet();
	}
...
/* 작성시간 : Mon Nov 07 11:20:06 KST 2016 */