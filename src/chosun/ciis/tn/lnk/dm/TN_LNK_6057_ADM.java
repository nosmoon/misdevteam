...
public class TN_LNK_6057_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public TN_LNK_6057_ADM(){}
	public TN_LNK_6057_ADM(String cmpy_cd, String sdsiidx, String incmg_pers_addr, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_LNK_6057_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_LNK_6057_ADM dm = (TN_LNK_6057_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.lnk.ds.TN_LNK_6057_ADataSet();
	}
...
/* 작성시간 : Tue Nov 29 15:20:49 KST 2016 */