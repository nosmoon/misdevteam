...
public class TN_LNK_5040_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public TN_LNK_5040_ADM(){}
	public TN_LNK_5040_ADM(String cmpy_cd, String sdsiidx, String chg_pers_addr, String chg_pers){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_LNK_5040_A(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_LNK_5040_ADM dm = (TN_LNK_5040_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.lnk.ds.TN_LNK_5040_ADataSet();
	}
...
/* 작성시간 : Tue Sep 20 11:06:44 KST 2016 */