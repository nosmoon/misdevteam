...
public class TN_LNK_5055_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public TN_LNK_5055_ADM(){}
	public TN_LNK_5055_ADM(String cmpy_cd, String sdsiidx, String requestdate, String fmsseq, String pymt_cd, String acptdate, String acptprice, String fee, String acptno, String cnclokdate, String result, String resultcode, String resultmsg, String header, String tail, String fmserr, String fmserrmsg, String incmg_pers_addr, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_LNK_5055_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_LNK_5055_ADM dm = (TN_LNK_5055_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.lnk.ds.TN_LNK_5055_ADataSet();
	}
...
/* 작성시간 : Tue Oct 04 10:09:50 KST 2016 */