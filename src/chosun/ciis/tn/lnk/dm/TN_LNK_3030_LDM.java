...
public class TN_LNK_3030_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public TN_LNK_3030_LDM(){}
	public TN_LNK_3030_LDM(String cmpy_cd, String pymtmm, String pymtdd, String cmsidx, String deptidx, String supp_clsf, String search_clsf, String search_nm){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_LNK_3030_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_LNK_3030_LDM dm = (TN_LNK_3030_LDM)bdm;
		...
		cstmt.setString(9, dm.search_clsf);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.lnk.ds.TN_LNK_3030_LDataSet();
	}
