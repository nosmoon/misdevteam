...
public class TN_LNK_5035_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public TN_LNK_5035_ADM(){}
	public TN_LNK_5035_ADM(String cmpy_cd, String file_clsf, String pymtmm, String pymtdd, String promiseidx, String incmg_pers_addr, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_LNK_5035_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_LNK_5035_ADM dm = (TN_LNK_5035_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.lnk.ds.TN_LNK_5035_ADataSet();
	}
...
/* 작성시간 : Fri Sep 23 15:58:00 KST 2016 */