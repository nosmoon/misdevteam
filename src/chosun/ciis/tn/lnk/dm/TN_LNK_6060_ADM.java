...
public class TN_LNK_6060_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public TN_LNK_6060_ADM(){}
	public TN_LNK_6060_ADM(String cmpy_cd, String sdsiidx, String incmg_pers_addr, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_LNK_6060_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_LNK_6060_ADM dm = (TN_LNK_6060_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.lnk.ds.TN_LNK_6060_ADataSet();
	}
