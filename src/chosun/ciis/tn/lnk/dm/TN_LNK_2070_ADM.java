...
public class TN_LNK_2070_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmsidx;
	public String incmg_pers_addr;
	public String incmg_pers;

	public TN_LNK_2070_ADM(){}
	public TN_LNK_2070_ADM(String cmsidx, String incmg_pers_addr, String incmg_pers){
		this.cmsidx = cmsidx;
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_LNK_2070_A(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_LNK_2070_ADM dm = (TN_LNK_2070_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmsidx);
		cstmt.setString(4, dm.incmg_pers_addr);
		cstmt.setString(5, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.lnk.ds.TN_LNK_2070_ADataSet();
	}
...
/* 작성시간 : Thu Oct 06 11:16:51 KST 2016 */