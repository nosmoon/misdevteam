...
public class TN_LNK_6055_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public TN_LNK_6055_ADM(){}
	public TN_LNK_6055_ADM(String cmpy_cd, String sdsiidx, String incmg_pers_addr, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_LNK_6055_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_LNK_6055_ADM dm = (TN_LNK_6055_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.lnk.ds.TN_LNK_6055_ADataSet();
	}
...
/* 작성시간 : Wed Nov 09 11:17:46 KST 2016 */