...
public class TN_LNK_6096_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public TN_LNK_6096_ADM(){}
	public TN_LNK_6096_ADM(String cmpy_cd, String sdsiidx, String jobclsf, String requestdate, String incmg_pers_addr, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_LNK_6096_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_LNK_6096_ADM dm = (TN_LNK_6096_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.sdsiidx);
		cstmt.setString(5, dm.jobclsf);
		cstmt.setString(6, dm.requestdate);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.lnk.ds.TN_LNK_6096_ADataSet();
	}
