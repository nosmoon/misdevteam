...
public class TN_LNK_7010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String yy;

	public TN_LNK_7010_LDM(){}
	public TN_LNK_7010_LDM(String cmpy_cd, String yy){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_LNK_7010_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_LNK_7010_LDM dm = (TN_LNK_7010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.lnk.ds.TN_LNK_7010_LDataSet();
	}
