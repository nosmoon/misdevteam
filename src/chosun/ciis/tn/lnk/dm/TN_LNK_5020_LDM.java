...
public class TN_LNK_5020_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public TN_LNK_5020_LDM(){}
	public TN_LNK_5020_LDM(String cmpy_cd, String pymtmm, String pymtdd, String sdsiidx, String deptidx, String supp_clsf, String result_stat, String search_clsf, String search_nm, String cnclyn, String delyn){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_LNK_5020_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_LNK_5020_LDM dm = (TN_LNK_5020_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.lnk.ds.TN_LNK_5020_LDataSet();
	}
