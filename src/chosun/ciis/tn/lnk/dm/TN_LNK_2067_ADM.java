...
public class TN_LNK_2067_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String incmg_pers_addr;
	public String incmg_pers;

	public TN_LNK_2067_ADM(){}
	public TN_LNK_2067_ADM(String cmpy_cd, String incmg_pers_addr, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_LNK_2067_A(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_LNK_2067_ADM dm = (TN_LNK_2067_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.lnk.ds.TN_LNK_2067_ADataSet();
	}
