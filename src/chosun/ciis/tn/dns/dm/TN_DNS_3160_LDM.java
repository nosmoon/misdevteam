...
public class TN_DNS_3160_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String receiptbulkissueidx;

	public TN_DNS_3160_LDM(){}
	public TN_DNS_3160_LDM(String cmpy_cd, String receiptbulkissueidx){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_DNS_3160_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_DNS_3160_LDM dm = (TN_DNS_3160_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.dns.ds.TN_DNS_3160_LDataSet();
	}
