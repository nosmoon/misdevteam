...
public class TN_DNS_3120_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String receiptbulkissueidx;

	public TN_DNS_3120_LDM(){}
	public TN_DNS_3120_LDM(String cmpy_cd, String receiptbulkissueidx){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_DNS_3120_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_DNS_3120_LDM dm = (TN_DNS_3120_LDM)bdm;
...
//		cstmt.registerOutParameter(7, OracleTypes.CURSOR);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.dns.ds.TN_DNS_3120_LDataSet();
	}
