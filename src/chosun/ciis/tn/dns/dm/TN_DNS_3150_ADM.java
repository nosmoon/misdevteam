...
public class TN_DNS_3150_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public TN_DNS_3150_ADM(){}
	public TN_DNS_3150_ADM(String cmpy_cd, String accflag, String deptidx, String startpaydate, String endpaydate, String issuedate, String issuedeptidx, String includeissued, String receiptcode, String price, String memberidx, String receiptidx, String incmg_pers, String receiptbulkissueidx){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_DNS_3150_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_DNS_3150_ADM dm = (TN_DNS_3150_ADM)bdm;
		...
		cstmt.setString(16, dm.receiptbulkissueidx);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.dns.ds.TN_DNS_3150_ADataSet();
	}
...
/* 작성시간 : Tue Oct 25 20:09:54 KST 2016 */