...
public class TN_DNS_3130_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public TN_DNS_3130_LDataSet(){}
	public TN_DNS_3130_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			TN_DNS_3130_LCURLIST1Record rec = new TN_DNS_3130_LCURLIST1Record();
		...
		while(rset1.next()){
			TN_DNS_3130_LCURLIST2Record rec = new TN_DNS_3130_LCURLIST2Record();
		...
		while(rset2.next()){
			TN_DNS_3130_LCURLIST3Record rec = new TN_DNS_3130_LCURLIST3Record();
			...
			rec.receiptidx = Util.checkString(rset2.getString("receiptidx"));
			...
			rec.receiptcode = Util.checkString(rset2.getString("receiptcode"));
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		TN_DNS_3130_LCURLIST1Record curlist1Rec = (TN_DNS_3130_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		TN_DNS_3130_LCURLIST2Record curlist2Rec = (TN_DNS_3130_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		TN_DNS_3130_LCURLIST3Record curlist3Rec = (TN_DNS_3130_LCURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>
