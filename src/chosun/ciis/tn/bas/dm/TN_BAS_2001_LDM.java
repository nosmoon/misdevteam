...
public class TN_BAS_2001_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String membertype;

	public TN_BAS_2001_LDM(){}
	public TN_BAS_2001_LDM(String cmpy_cd, String membertype){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_BAS_2001_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_BAS_2001_LDM dm = (TN_BAS_2001_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.bas.ds.TN_BAS_2001_LDataSet();
	}
