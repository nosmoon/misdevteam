...
public class TN_BAS_3300_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String organidx;

	public TN_BAS_3300_MDM(){}
	public TN_BAS_3300_MDM(String cmpy_cd, String organidx){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_BAS_3300_M(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_BAS_3300_MDM dm = (TN_BAS_3300_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.bas.ds.TN_BAS_3300_MDataSet();
	}
