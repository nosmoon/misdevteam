...
public class TN_BAS_1101_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String organidx;

	public TN_BAS_1101_LDM(){}
	public TN_BAS_1101_LDM(String cmpy_cd, String organidx){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_BAS_1101_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_BAS_1101_LDM dm = (TN_BAS_1101_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.bas.ds.TN_BAS_1101_LDataSet();
	}
