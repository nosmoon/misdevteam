...
public class TN_BAS_2002_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public TN_BAS_2002_ADM(){}
	public TN_BAS_2002_ADM(String cmpy_cd, String membercategorycode, String parentmembercategorycode, String membertype, String depth, String membercategory, String displayorder, String description){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_BAS_2002_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_BAS_2002_ADM dm = (TN_BAS_2002_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.bas.ds.TN_BAS_2002_ADataSet();
	}
...
/* 작성시간 : Fri Jul 08 14:49:02 KST 2016 */