...
public class TN_RPT_1400_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String srch_date;

	public TN_RPT_1400_LDM(){System.out.println("3333333333333");}
	public TN_RPT_1400_LDM(String cmpy_cd, String srch_date){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_RPT_1400_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_RPT_1400_LDM dm = (TN_RPT_1400_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.rpt.ds.TN_RPT_1400_LDataSet();
	}
...
/* 작성시간 : Thu Nov 17 18:50:42 KST 2016 */