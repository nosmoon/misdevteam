...
public class TN_RPT_1510_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public TN_RPT_1510_LDM(){}
	public TN_RPT_1510_LDM(String cmpy_cd, String memberidx, String seq, String code){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_RPT_1510_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_RPT_1510_LDM dm = (TN_RPT_1510_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.memberidx);
		cstmt.setString(5, dm.seq);
		cstmt.setString(6, dm.code);
		cstmt.registerOutParameter(7, OracleTypes.CURSOR);
		cstmt.registerOutParameter(8, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.rpt.ds.TN_RPT_1510_LDataSet();
	}
