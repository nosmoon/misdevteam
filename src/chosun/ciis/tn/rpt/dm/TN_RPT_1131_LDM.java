...
public class TN_RPT_1131_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String srch_date;

	public TN_RPT_1131_LDM(){}
	public TN_RPT_1131_LDM(String cmpy_cd, String srch_date){
	...
	public String getSQL(){
		 return "{ call MISTNN.SP_TN_RPT_1131_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		TN_RPT_1131_LDM dm = (TN_RPT_1131_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.tn.rpt.ds.TN_RPT_1131_LDataSet();
	}
