...
public class PL_COM_1010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_COM_1010_LDM(){}
	public PL_COM_1010_LDM(String cmpy_cd, String incmg_pers, String dlco_clsf, String area, String dlco_nm, String prv_curr_clsf){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_COM_1010_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_COM_1010_LDM dm = (PL_COM_1010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.com.ds.PL_COM_1010_LDataSet();
	}
