...
public class PL_COM_1310_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_COM_1310_LDM(){}
	public PL_COM_1310_LDM(String cmpy_cd, String incmg_pers, String occr_dt, String slip_clsf, String seq, String dlco_cd, String dlco_seq){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_COM_1310_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_COM_1310_LDM dm = (PL_COM_1310_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.com.ds.PL_COM_1310_LDataSet();
	}
