...
public class PL_COM_1120_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_COM_1120_SDM(){}
	public PL_COM_1120_SDM(String cmpy_cd, String incmg_pers, String medi_clsf, String medi_cd, String medi_nm, String absence_clsf){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_COM_1120_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_COM_1120_SDM dm = (PL_COM_1120_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.com.ds.PL_COM_1120_SDataSet();
	}
