...
import chosun.ciis.pl.sal.dao.PL_SAL_1100DAO;
import chosun.ciis.pl.sal.dm.PL_SAL_1100_MDM;
import chosun.ciis.pl.sal.dm.PL_SAL_1110_LDM;
import chosun.ciis.pl.sal.dm.PL_SAL_1120_LDM;
import chosun.ciis.pl.sal.dm.PL_SAL_1130_ADM;
import chosun.ciis.pl.sal.ds.PL_SAL_1100_MDataSet;
import chosun.ciis.pl.sal.ds.PL_SAL_1110_LDataSet;
import chosun.ciis.pl.sal.ds.PL_SAL_1120_LDataSet;
import chosun.ciis.pl.sal.ds.PL_SAL_1130_ADataSet;

/**
 * 
 */
public class PL_SAL_1100WB extends BaseWB {
     ...
     * @return void
     */
    public void pl_sal_1100_m(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_SAL_1100_MDataSet ds = null;

        // DM Setting
        PL_SAL_1100_MDM dm = new PL_SAL_1100_MDM();
        ...
        try {
        	PL_SAL_1100DAO dao = new PL_SAL_1100DAO();
            ds = dao.pl_sal_1100_m(dm);
...
//        PL_SAL_1100EJBHome home = (PL_SAL_1100EJBHome) JNDIManager.getInstance().getHome("PL_SAL_1100EJB");
//        try {
//        	PL_SAL_1100EJB ejb = home.create();
//            ds = ejb.pl_sal_1100_m(dm);
//            req.setAttribute("ds", ds);
//        }
...
//        }
     ...
     * @return void
     */
    public void pl_sal_1110_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_SAL_1110_LDataSet ds = null;

        // DM Setting
        PL_SAL_1110_LDM dm = new PL_SAL_1110_LDM();
...
//        }
     ...
     * @return void
     */
    public void pl_sal_1120_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_SAL_1120_LDataSet ds = null;

        // DM Setting
        PL_SAL_1120_LDM dm = new PL_SAL_1120_LDM();
...
//        }
     ...
     * @return void
     */
    public void pl_sal_1130_a(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_SAL_1130_ADataSet ds = null;

        // DM Setting
        PL_SAL_1130_ADM dm = new PL_SAL_1130_ADM();
