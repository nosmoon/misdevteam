...
public class PL_SAL_1010_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public PL_SAL_1010_LDataSet(){}
	public PL_SAL_1010_LDataSet(String errcode, String errmsg, String basi_yymm, String basi_dt, String ewh_qty, String deli_qty, String stok_qty){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset1.next()){
			PL_SAL_1010_LDELI_PTCRCURRecord rec = new PL_SAL_1010_LDELI_PTCRCURRecord();
...
<%
	for(int i=0; i<ds.deli_ptcrcur.size(); i++){
		PL_SAL_1010_LDELI_PTCRCURRecord deli_ptcrcurRec = (PL_SAL_1010_LDELI_PTCRCURRecord)ds.deli_ptcrcur.get(i);%>
HTML 코드들....
	<%}%>
