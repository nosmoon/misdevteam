...
public class PL_SAL_1110_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public PL_SAL_1110_LDataSet(){}
	public PL_SAL_1110_LDataSet(String errcode, String errmsg, String basi_yymm, String basi_dt, String ewh_qty, String deli_qty, String stok_qty){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset1.next()){
			PL_SAL_1110_LDELI_PTCRCURRecord rec = new PL_SAL_1110_LDELI_PTCRCURRecord();
			...
			rec.sale_clsf_nm = Util.checkString(rset1.getString("sale_clsf_nm"));
			...
			rec.sell_type_nm = Util.checkString(rset1.getString("sell_type_nm"));
			rec.wh_cd = Util.checkString(rset1.getString("wh_cd"));
			rec.wh_cd_nm = Util.checkString(rset1.getString("wh_cd_nm"));
			...
			rec.deal_seq = Util.checkString(rset1.getString("deal_seq"));
...
<%
	PL_SAL_1110_LDataSet ds = (PL_SAL_1110_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.deli_ptcrcur.size(); i++){
		PL_SAL_1110_LDELI_PTCRCURRecord deli_ptcrcurRec = (PL_SAL_1110_LDELI_PTCRCURRecord)ds.deli_ptcrcur.get(i);%>
HTML 코드들....
	<%}%>
