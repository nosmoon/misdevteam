...
public class PL_SAL_1120_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public PL_SAL_1120_LDataSet(){}
	public PL_SAL_1120_LDataSet(String errcode, String errmsg, String basi_yymm, String basi_dt, String ewh_qty, String deli_qty, String stok_qty){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PL_SAL_1120_LDELI_PTCRCURRecord rec = new PL_SAL_1120_LDELI_PTCRCURRecord();
...
<%
	PL_SAL_1120_LDataSet ds = (PL_SAL_1120_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.deli_ptcrcur.size(); i++){
		PL_SAL_1120_LDELI_PTCRCURRecord deli_ptcrcurRec = (PL_SAL_1120_LDELI_PTCRCURRecord)ds.deli_ptcrcur.get(i);%>
HTML 코드들....
	<%}%>
