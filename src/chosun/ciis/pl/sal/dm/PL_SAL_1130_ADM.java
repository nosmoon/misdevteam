...
public class PL_SAL_1130_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String deal_dt_arr;
	public String deal_grp_seq_arr;
	...
	public PL_SAL_1130_ADM(){}
	public PL_SAL_1130_ADM(String acc_flag, String cmpy_cd, String incmg_pers, String incmg_pers_ip, String medi_cd, String medi_ser_no, String basi_yymm, String basi_dt, String mode_arr, String dlco_clsf_arr, String deal_dt_arr, String deal_grp_seq_arr, String deal_seq_arr, String dlco_cd_arr, String dlco_seq_arr, String send_plac_seq_arr, String wh_cd_arr, String sell_type_arr, String sale_clsf_arr, String sendclsf_arr, String deal_uprc_arr, String deal_qty_arr, String dcrate_arr, String deal_amt_arr, String remk_arr){
		...
		this.deal_dt_arr = deal_dt_arr;
		this.deal_grp_seq_arr = deal_grp_seq_arr;
	...
	public void setDeal_dt_arr(String deal_dt_arr){
		this.deal_dt_arr = deal_dt_arr;
	}

	public void setDeal_grp_seq_arr(String deal_grp_seq_arr){
		this.deal_grp_seq_arr = deal_grp_seq_arr;
	}
	...
	public String getDeal_dt_arr(){
		return this.deal_dt_arr;
	}

	public String getDeal_grp_seq_arr(){
		return this.deal_grp_seq_arr;
	}
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_SAL_1130_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_SAL_1130_ADM dm = (PL_SAL_1130_ADM)bdm;
		...
		cstmt.setString(11, dm.mode_arr);
		cstmt.setString(12, dm.dlco_clsf_arr);
		cstmt.setString(13, dm.deal_dt_arr);
		cstmt.setString(14, dm.deal_grp_seq_arr);
		...
		cstmt.setString(19, dm.wh_cd_arr);
		cstmt.setString(20, dm.sell_type_arr);
		cstmt.setString(21, dm.sale_clsf_arr);
		cstmt.setString(22, dm.sendclsf_arr);
		cstmt.setString(23, dm.deal_uprc_arr);
		cstmt.setString(24, dm.deal_qty_arr);
		cstmt.setString(25, dm.dcrate_arr);
		cstmt.setString(26, dm.deal_amt_arr);
		cstmt.setString(27, dm.remk_arr);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.sal.ds.PL_SAL_1130_ADataSet();
	}
    ...
    public void print(){
        ...
        System.out.println("deal_dt_arr = " + getDeal_dt_arr());
        System.out.println("deal_grp_seq_arr = " + getDeal_grp_seq_arr());
...
String deal_dt_arr = req.getParameter("deal_dt_arr");
if( deal_dt_arr == null){
	System.out.println(this.toString+" : deal_dt_arr is null" );
}else{
	System.out.println(this.toString+" : deal_dt_arr is "+deal_dt_arr );
}
String deal_grp_seq_arr = req.getParameter("deal_grp_seq_arr");
if( deal_grp_seq_arr == null){
	System.out.println(this.toString+" : deal_grp_seq_arr is null" );
}else{
	System.out.println(this.toString+" : deal_grp_seq_arr is "+deal_grp_seq_arr );
}
...
String deal_dt_arr = Util.checkString(req.getParameter("deal_dt_arr"));
String deal_grp_seq_arr = Util.checkString(req.getParameter("deal_grp_seq_arr"));
...
String deal_dt_arr = Util.Uni2Ksc(Util.checkString(req.getParameter("deal_dt_arr")));
String deal_grp_seq_arr = Util.Uni2Ksc(Util.checkString(req.getParameter("deal_grp_seq_arr")));
...
/* 작성시간 : Thu Mar 19 17:38:16 KST 2009 */