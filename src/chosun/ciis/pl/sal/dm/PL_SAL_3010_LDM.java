...
public class PL_SAL_3010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_SAL_3010_LDM(){}
	public PL_SAL_3010_LDM(String cmpy_cd, String incmg_pers, String basi_yymm, String medi_cd, String medi_ser_no, String sendclsf, String dlco_clsf, String dlco_cd, String dlco_seq){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_SAL_3010_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_SAL_3010_LDM dm = (PL_SAL_3010_LDM)bdm;
		...
		cstmt.setString(7, dm.medi_ser_no);
		cstmt.setString(8, dm.sendclsf);
		cstmt.setString(9, dm.dlco_clsf);
		cstmt.setString(10, dm.dlco_cd);
		cstmt.setString(11, dm.dlco_seq);
		cstmt.registerOutParameter(12, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.sal.ds.PL_SAL_3010_LDataSet();
	}
