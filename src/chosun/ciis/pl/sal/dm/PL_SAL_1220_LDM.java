...
public class PL_SAL_1220_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_SAL_1220_LDM(){}
	public PL_SAL_1220_LDM(String cmpy_cd, String incmg_pers, String deal_dt, String deal_grp_seq){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_SAL_1220_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_SAL_1220_LDM dm = (PL_SAL_1220_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.sal.ds.PL_SAL_1220_LDataSet();
	}
