...
public class PL_SAL_1230_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_SAL_1230_ADM(){}
	public PL_SAL_1230_ADM(String acc_flag, String cmpy_cd, String incmg_pers, String incmg_pers_ip, String medi_clsf, String deal_dt, String deal_grp_seq, String basi_yymm, String basi_dt, String dlco_cd, String dlco_seq, String send_plac_seq, String mode_arr, String deal_seq_arr, String medi_cd_arr, String medi_ser_no_arr, String deal_qty_arr, String deal_uprc_arr, String dcrate_arr, String deal_amt_arr, String sale_clsf_arr, String sendclsf_arr, String wh_cd_arr, String sell_type_arr, String remk_arr){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_SAL_1230_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_SAL_1230_ADM dm = (PL_SAL_1230_ADM)bdm;
		...
		cstmt.setString(14, dm.send_plac_seq);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.sal.ds.PL_SAL_1230_ADataSet();
	}
