...
public class PL_SAL_1010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_SAL_1010_LDM(){}
	public PL_SAL_1010_LDM(String cmpy_cd, String incmg_pers, String medi_cd, String medi_ser_no){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_SAL_1010_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_SAL_1010_LDM dm = (PL_SAL_1010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.sal.ds.PL_SAL_1010_LDataSet();
	}
