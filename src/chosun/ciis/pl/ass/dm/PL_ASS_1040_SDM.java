...
public class PL_ASS_1040_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_ASS_1040_SDM(){}
	public PL_ASS_1040_SDM(String cmpy_cd, String incmg_pers, String medi_cd, String medi_ser_no){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_ASS_1040_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_ASS_1040_SDM dm = (PL_ASS_1040_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.ass.ds.PL_ASS_1040_SDataSet();
	}
