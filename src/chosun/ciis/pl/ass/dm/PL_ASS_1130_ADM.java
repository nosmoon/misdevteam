...
public class PL_ASS_1130_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_ASS_1130_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_ASS_1130_ADM dm = (PL_ASS_1130_ADM)bdm;
		...
		cstmt.setString(9, dm.ref_medi_cd);
		cstmt.setString(10, dm.ref_medi_ser_no);
		cstmt.setString(11, dm.basi_bgn_yymm);
		cstmt.setString(12, dm.basi_end_yymm);
		...
		cstmt.setString(32, dm.remk_arr);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.ass.ds.PL_ASS_1130_ADataSet();
	}
