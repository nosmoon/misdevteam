...
import chosun.ciis.pl.cls.dao.PL_CLS_2200DAO;
import chosun.ciis.pl.cls.dm.PL_CLS_2210_LDM;
import chosun.ciis.pl.cls.dm.PL_CLS_2220_ADM;
import chosun.ciis.pl.cls.ds.PL_CLS_2210_LDataSet;
import chosun.ciis.pl.cls.ds.PL_CLS_2220_ADataSet;

/**
 * 
 */
public class PL_CLS_2200WB extends BaseWB {
     ...
     * @return void
     */
    public void pl_cls_2210_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_CLS_2210_LDataSet ds = null;

        // DM Setting
        PL_CLS_2210_LDM dm = new PL_CLS_2210_LDM();
        ...
        try {
        	PL_CLS_2200DAO dao = new PL_CLS_2200DAO();
            ds = dao.pl_cls_2210_l(dm);
...
//        }
     ...
     * @return void
     */
    public void pl_cls_2220_a(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_CLS_2220_ADataSet ds = null;

        // DM Setting
        PL_CLS_2220_ADM dm = new PL_CLS_2220_ADM();
