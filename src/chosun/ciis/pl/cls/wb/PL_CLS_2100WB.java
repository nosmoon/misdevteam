...
import chosun.ciis.pl.cls.dao.PL_CLS_2100DAO;
import chosun.ciis.pl.cls.dm.PL_CLS_2110_LDM;
import chosun.ciis.pl.cls.dm.PL_CLS_2120_ADM;
import chosun.ciis.pl.cls.ds.PL_CLS_2110_LDataSet;
import chosun.ciis.pl.cls.ds.PL_CLS_2120_ADataSet;

/**
 * 
 */
public class PL_CLS_2100WB extends BaseWB {
     ...
     * @return void
     */
    public void pl_cls_2110_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_CLS_2110_LDataSet ds = null;

        // DM Setting
        PL_CLS_2110_LDM dm = new PL_CLS_2110_LDM();
        ...
        try {
        	PL_CLS_2100DAO dao = new PL_CLS_2100DAO();
            ds = dao.pl_cls_2110_l(dm);
...
//        }
     ...
     * @return void
     */
    public void pl_cls_2120_a(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_CLS_2120_ADataSet ds = null;

        // DM Setting
        PL_CLS_2120_ADM dm = new PL_CLS_2120_ADM();
