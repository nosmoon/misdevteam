 ...
 * 
 */
public class PL_CLS_2300WB extends BaseWB {
     ...
     * @return void
     */
    public void pl_cls_2310_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_CLS_2310_LDataSet ds = null;

        // DM Setting
        PL_CLS_2310_LDM dm = new PL_CLS_2310_LDM();
        ...
        try {
        	PL_CLS_2300DAO dao = new PL_CLS_2300DAO();
            ds = dao.pl_cls_2310_l(dm);
...
//        }
     ...
     * @return void
     */
    public void pl_cls_2320_a(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_CLS_2320_ADataSet ds = null;

        // DM Setting
        PL_CLS_2320_ADM dm = new PL_CLS_2320_ADM();
