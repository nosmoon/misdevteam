...
import chosun.ciis.pl.cls.dao.PL_CLS_1000DAO;
import chosun.ciis.pl.cls.dm.PL_CLS_1010_LDM;
import chosun.ciis.pl.cls.dm.PL_CLS_1020_ADM;
import chosun.ciis.pl.cls.ds.PL_CLS_1010_LDataSet;
import chosun.ciis.pl.cls.ds.PL_CLS_1020_ADataSet;

/**
 * 
 */
public class PL_CLS_1000WB extends BaseWB {
     ...
     * @return void
     */
    public void pl_cls_1010_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_CLS_1010_LDataSet ds = null;

        // DM Setting
        PL_CLS_1010_LDM dm = new PL_CLS_1010_LDM();
        ...
        try {
        	PL_CLS_1000DAO dao = new PL_CLS_1000DAO();
            ds = dao.pl_cls_1010_l(dm);
...
//        }
     ...
     * @return void
     */
    public void pl_cls_1020_a(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_CLS_1020_ADataSet ds = null;

        // DM Setting
        PL_CLS_1020_ADM dm = new PL_CLS_1020_ADM();
