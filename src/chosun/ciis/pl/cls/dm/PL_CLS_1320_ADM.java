...
public class PL_CLS_1320_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_CLS_1320_ADM(){}
	public PL_CLS_1320_ADM(String acc_flag, String cmpy_cd, String uid, String incmg_pers, String incmg_pers_ip, String medi_clsf, String basi_yymm, String basi_dt){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_CLS_1320_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_CLS_1320_ADM dm = (PL_CLS_1320_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.cls.ds.PL_CLS_1320_ADataSet();
	}
