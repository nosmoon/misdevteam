...
public class PL_CLS_1730_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_CLS_1730_ADM(){}
	public PL_CLS_1730_ADM(String acc_flag, String cmpy_cd, String uid, String incmg_pers, String incmg_pers_ip, String basi_yymm, String basi_dt){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_CLS_1730_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_CLS_1730_ADM dm = (PL_CLS_1730_ADM)bdm;
		...
		cstmt.setString(8, dm.basi_yymm);
		cstmt.setString(9, dm.basi_dt);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.cls.ds.PL_CLS_1730_ADataSet();
	}
...
/* 작성시간 : Wed Mar 22 20:01:32 KST 2017 */