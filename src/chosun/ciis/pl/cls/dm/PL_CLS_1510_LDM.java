...
public class PL_CLS_1510_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_CLS_1510_LDM(){}
	public PL_CLS_1510_LDM(String cmpy_cd, String incmg_pers, String medi_clsf, String basi_yymm_fr, String basi_yymm_to){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_CLS_1510_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_CLS_1510_LDM dm = (PL_CLS_1510_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.cls.ds.PL_CLS_1510_LDataSet();
	}
