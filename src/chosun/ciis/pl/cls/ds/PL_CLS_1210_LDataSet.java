...
public class PL_CLS_1210_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList ptcrlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public PL_CLS_1210_LDataSet(){}
	public PL_CLS_1210_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset2.next()){
			PL_CLS_1210_LPTCRLISTRecord rec = new PL_CLS_1210_LPTCRLISTRecord();
			...
			rec.deli_qty = Util.checkString(rset2.getString("deli_qty"));
			rec.deli_amt = Util.checkString(rset2.getString("deli_amt"));
			rec.widr_qty = Util.checkString(rset2.getString("widr_qty"));
			rec.widr_amt = Util.checkString(rset2.getString("widr_amt"));
			rec.retn_qty = Util.checkString(rset2.getString("retn_qty"));
			rec.retn_amt = Util.checkString(rset2.getString("retn_amt"));
			rec.sale_qty = Util.checkString(rset2.getString("sale_qty"));
...
<%
	PL_CLS_1210_LDataSet ds = (PL_CLS_1210_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.ptcrlist.size(); i++){
		PL_CLS_1210_LPTCRLISTRecord ptcrlistRec = (PL_CLS_1210_LPTCRLISTRecord)ds.ptcrlist.get(i);%>
HTML 코드들....
	<%}%>
