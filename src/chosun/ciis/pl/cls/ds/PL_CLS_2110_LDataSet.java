...
public class PL_CLS_2110_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList ptcrlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public PL_CLS_2110_LDataSet(){}
	public PL_CLS_2110_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset2.next()){
			PL_CLS_2110_LPTCRLISTRecord rec = new PL_CLS_2110_LPTCRLISTRecord();
