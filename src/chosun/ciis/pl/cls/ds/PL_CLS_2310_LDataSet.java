...
public class PL_CLS_2310_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList ptcrlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public PL_CLS_2310_LDataSet(){}
	public PL_CLS_2310_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PL_CLS_2310_LPTCRLISTRecord rec = new PL_CLS_2310_LPTCRLISTRecord();
...
<%
	PL_CLS_2310_LDataSet ds = (PL_CLS_2310_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.ptcrlist.size(); i++){
		PL_CLS_2310_LPTCRLISTRecord ptcrlistRec = (PL_CLS_2310_LPTCRLISTRecord)ds.ptcrlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Mon May 28 17:37:16 KST 2018 */