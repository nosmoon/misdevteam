...
public class PL_BAS_1030_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_BAS_1030_ADM(){}
	public PL_BAS_1030_ADM(String work_flag, String cmpy_cd, String incmg_pers, String incmg_pers_ip, String medi_cd, String medi_ser_no, String medi_nm, String issu_cmpy, String medi_clsf, String basi_yymm, String reg_dt, String issu_clsf, String uprc, String dcrate, String cont_clas, String author, String type, String std, String page, String unit, String unit_wgt, String absence_clsf, String absence_dt, String cover_modl, String seri_cd, String seri_nm, String cont, String vexc_medi_ser_no, String remk){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_BAS_1030_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_BAS_1030_ADM dm = (PL_BAS_1030_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.bas.ds.PL_BAS_1030_ADataSet();
	}
