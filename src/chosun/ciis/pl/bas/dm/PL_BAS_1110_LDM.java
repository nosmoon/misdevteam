...
public class PL_BAS_1110_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_BAS_1110_LDM(){}
	public PL_BAS_1110_LDM(String cmpy_cd, String incmg_pers, String medi_clsf, String issu_cmpy, String medi_cd, String medi_nm){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_BAS_1110_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_BAS_1110_LDM dm = (PL_BAS_1110_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.bas.ds.PL_BAS_1110_LDataSet();
	}
