...
public class PL_BAS_1160_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_BAS_1160_ADM(){}
	public PL_BAS_1160_ADM(String acc_flag, String cmpy_cd, String incmg_pers, String incmg_pers_ip, String mode_arr, String medi_cd_arr, String medi_ser_no_arr, String appndx_seq_arr, String reg_dt_arr, String appndx_nm_arr, String appndx_qty_arr, String wgt_arr, String remk_arr){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_BAS_1160_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_BAS_1160_ADM dm = (PL_BAS_1160_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.bas.ds.PL_BAS_1160_ADataSet();
	}
