...
public class PL_BAS_1050_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_BAS_1050_ADM(){}
	public PL_BAS_1050_ADM(String acc_flag, String cmpy_cd, String incmg_pers, String incmg_pers_ip, String mode_arr, String medi_cd_arr, String medi_ser_no_arr, String ecnt_seq_arr, String ecnt_arr, String issu_dt_arr, String ewh_dt_arr, String ewh_clsf_arr, String ewh_qty_arr, String wh_cd_arr, String remk_arr){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_BAS_1050_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_BAS_1050_ADM dm = (PL_BAS_1050_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.bas.ds.PL_BAS_1050_ADataSet();
	}
