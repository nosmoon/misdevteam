...
public class PL_BAS_1040_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String issu_seq_arr;
	public String ecnt_arr;
	public String issu_dt_arr;
	public String issu_qty_arr;
	public String remk_arr;

	public PL_BAS_1040_ADM(){}
	public PL_BAS_1040_ADM(String acc_flag, String cmpy_cd, String incmg_pers, String incmg_pers_ip, String mode_arr, String medi_cd_arr, String medi_ser_no_arr, String issu_seq_arr, String ecnt_arr, String issu_dt_arr, String issu_qty_arr, String remk_arr){
		...
		this.issu_seq_arr = issu_seq_arr;
		this.ecnt_arr = ecnt_arr;
		this.issu_dt_arr = issu_dt_arr;
		this.issu_qty_arr = issu_qty_arr;
	...
	public void setIssu_seq_arr(String issu_seq_arr){
		this.issu_seq_arr = issu_seq_arr;
	}
	...
	public void setIssu_qty_arr(String issu_qty_arr){
		this.issu_qty_arr = issu_qty_arr;
	}
	...
	public String getIssu_seq_arr(){
		return this.issu_seq_arr;
	}
	...
	public String getIssu_qty_arr(){
		return this.issu_qty_arr;
	}
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_BAS_1040_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_BAS_1040_ADM dm = (PL_BAS_1040_ADM)bdm;
		...
		cstmt.setString(10, dm.issu_seq_arr);
		cstmt.setString(11, dm.ecnt_arr);
		cstmt.setString(12, dm.issu_dt_arr);
		cstmt.setString(13, dm.issu_qty_arr);
		cstmt.setString(14, dm.remk_arr);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.bas.ds.PL_BAS_1040_ADataSet();
	}
    ...
    public void print(){
        ...
        System.out.println("issu_seq_arr = " + getIssu_seq_arr());
        System.out.println("ecnt_arr = " + getEcnt_arr());
        System.out.println("issu_dt_arr = " + getIssu_dt_arr());
        System.out.println("issu_qty_arr = " + getIssu_qty_arr());
...
String issu_seq_arr = req.getParameter("issu_seq_arr");
if( issu_seq_arr == null){
	System.out.println(this.toString+" : issu_seq_arr is null" );
}else{
	System.out.println(this.toString+" : issu_seq_arr is "+issu_seq_arr );
}
...
String issu_qty_arr = req.getParameter("issu_qty_arr");
if( issu_qty_arr == null){
	System.out.println(this.toString+" : issu_qty_arr is null" );
}else{
	System.out.println(this.toString+" : issu_qty_arr is "+issu_qty_arr );
}
...
String issu_seq_arr = Util.checkString(req.getParameter("issu_seq_arr"));
...
String issu_qty_arr = Util.checkString(req.getParameter("issu_qty_arr"));
...
String issu_seq_arr = Util.Uni2Ksc(Util.checkString(req.getParameter("issu_seq_arr")));
...
String issu_qty_arr = Util.Uni2Ksc(Util.checkString(req.getParameter("issu_qty_arr")));
