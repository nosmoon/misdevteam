...
public class PL_BAS_1000_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String incmg_pers;
	public String medi_clsf;

	public PL_BAS_1000_MDM(){}
	public PL_BAS_1000_MDM(String cmpy_cd, String incmg_pers, String medi_clsf){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_BAS_1000_M(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_BAS_1000_MDM dm = (PL_BAS_1000_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.bas.ds.PL_BAS_1000_MDataSet();
	}
