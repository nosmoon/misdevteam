...
public class PL_BAS_1240_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_BAS_1240_ADM(){}
	public PL_BAS_1240_ADM(String acc_flag, String cmpy_cd, String incmg_pers, String incmg_pers_ip, String mode_arr, String dlco_cd_arr, String dlco_seq_arr, String medi_cd_arr, String deal_yn_arr, String no_val_exne_arr, String dcrate_arr, String wh_cd_arr, String sendclsf_arr, String remk_arr){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_BAS_1240_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_BAS_1240_ADM dm = (PL_BAS_1240_ADM)bdm;
		...
		cstmt.setString(10, dm.medi_cd_arr);
		cstmt.setString(11, dm.deal_yn_arr);
		cstmt.setString(12, dm.no_val_exne_arr);
		cstmt.setString(13, dm.dcrate_arr);
		cstmt.setString(14, dm.wh_cd_arr);
		cstmt.setString(15, dm.sendclsf_arr);
		cstmt.setString(16, dm.remk_arr);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.bas.ds.PL_BAS_1240_ADataSet();
	}
