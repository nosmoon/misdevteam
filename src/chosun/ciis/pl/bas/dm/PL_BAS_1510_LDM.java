...
public class PL_BAS_1510_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_BAS_1510_LDM(){}
	public PL_BAS_1510_LDM(String cmpy_cd, String incmg_pers, String yy, String medi_cd){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_BAS_1510_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_BAS_1510_LDM dm = (PL_BAS_1510_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.bas.ds.PL_BAS_1510_LDataSet();
	}
