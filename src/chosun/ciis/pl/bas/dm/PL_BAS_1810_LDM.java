...
public class PL_BAS_1810_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_BAS_1810_LDM(){}
	public PL_BAS_1810_LDM(String cmpy_cd, String incmg_pers, String issu_cmpy, String hndlmedi_clsf){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_BAS_1810_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_BAS_1810_LDM dm = (PL_BAS_1810_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.incmg_pers);
		cstmt.setString(5, dm.issu_cmpy);
		cstmt.setString(6, dm.hndlmedi_clsf);
		cstmt.registerOutParameter(7, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.bas.ds.PL_BAS_1810_LDataSet();
	}
	...
	public void print(){
		...
		System.out.println("hndlmedi_clsf = [" + getHndlmedi_clsf() + "]");
	}
}
/*----------------------------------------------------------------------------------------------------
...
String hndlmedi_clsf = req.getParameter("hndlmedi_clsf");
if( hndlmedi_clsf == null){
	System.out.println(this.toString+" : hndlmedi_clsf is null" );
}else{
	System.out.println(this.toString+" : hndlmedi_clsf is "+hndlmedi_clsf );
}
----------------------------------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------------------------------
...
String hndlmedi_clsf = Util.checkString(req.getParameter("hndlmedi_clsf"));
----------------------------------------------------------------------------------------------------*//*----------------------------------------------------------------------------------------------------
...
String hndlmedi_clsf = Util.Uni2Ksc(Util.checkString(req.getParameter("hndlmedi_clsf")));
----------------------------------------------------------------------------------------------------*/
