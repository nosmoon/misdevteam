...
import chosun.ciis.pl.bas.dao.PL_BAS_1100DAO;
import chosun.ciis.pl.bas.dm.PL_BAS_1100_MDM;
import chosun.ciis.pl.bas.dm.PL_BAS_1110_LDM;
import chosun.ciis.pl.bas.dm.PL_BAS_1120_LDM;
import chosun.ciis.pl.bas.dm.PL_BAS_1130_ADM;
import chosun.ciis.pl.bas.dm.PL_BAS_1140_ADM;
import chosun.ciis.pl.bas.dm.PL_BAS_1150_ADM;
import chosun.ciis.pl.bas.dm.PL_BAS_1160_ADM;
import chosun.ciis.pl.bas.ds.PL_BAS_1100_MDataSet;
import chosun.ciis.pl.bas.ds.PL_BAS_1110_LDataSet;
import chosun.ciis.pl.bas.ds.PL_BAS_1120_LDataSet;
import chosun.ciis.pl.bas.ds.PL_BAS_1130_ADataSet;
import chosun.ciis.pl.bas.ds.PL_BAS_1140_ADataSet;
import chosun.ciis.pl.bas.ds.PL_BAS_1150_ADataSet;
import chosun.ciis.pl.bas.ds.PL_BAS_1160_ADataSet;
import chosun.ciis.pl.base.wb.BaseWB;

/**
 * 
 */
public class PL_BAS_1100WB extends BaseWB {
     ...
     * @return void
     */
    public void pl_bas_1100_m(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_BAS_1100_MDataSet ds = null;

        // DM Setting
        PL_BAS_1100_MDM dm = new PL_BAS_1100_MDM();
        ...
        try {
        	PL_BAS_1100DAO dao = new PL_BAS_1100DAO();
            ds = dao.pl_bas_1100_m(dm);
...
//        PL_BAS_1100EJBHome home = (PL_BAS_1100EJBHome) JNDIManager.getInstance().getHome("PL_BAS_1100EJB");
//        try {
//        	PL_BAS_1100EJB ejb = home.create();
//            ds = ejb.pl_bas_1100_m(dm);
//            req.setAttribute("ds", ds);
//        }
...
//        }
     ...
     * @return void
     */
    public void pl_bas_1110_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_BAS_1110_LDataSet ds = null;

        // DM Setting
        PL_BAS_1110_LDM dm = new PL_BAS_1110_LDM();
...
//        }
     ...
     * @return void
     */
    public void pl_bas_1120_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_BAS_1120_LDataSet ds = null;

        // DM Setting
        PL_BAS_1120_LDM dm = new PL_BAS_1120_LDM();
...
//        }
     ...
     * @return void
     */
    public void pl_bas_1130_a(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_BAS_1130_ADataSet ds = null;

        // DM Setting
        PL_BAS_1130_ADM dm = new PL_BAS_1130_ADM();
...
//        }
     ...
     * @return void
     */
    public void pl_bas_1140_a(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_BAS_1140_ADataSet ds = null;

        // DM Setting
        PL_BAS_1140_ADM dm = new PL_BAS_1140_ADM();
...
//        }
     ...
     * @return void
     */
    public void pl_bas_1150_a(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_BAS_1150_ADataSet ds = null;

        // DM Setting
        PL_BAS_1150_ADM dm = new PL_BAS_1150_ADM();
...
//        }
     ...
     * @return void
     */
    public void pl_bas_1160_a(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_BAS_1160_ADataSet ds = null;

        // DM Setting
        PL_BAS_1160_ADM dm = new PL_BAS_1160_ADM();
