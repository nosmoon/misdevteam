...
public class PL_BAS_1520_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList trgtptcrcur = new ArrayList();
	public String errcode;
	public String errmsg;

	public PL_BAS_1520_LDataSet(){}
	public PL_BAS_1520_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset2.next()){
			PL_BAS_1520_LTRGTPTCRCURRecord rec = new PL_BAS_1520_LTRGTPTCRCURRecord();
			rec.medi_cd = Util.checkString(rset2.getString("medi_cd"));
			rec.medi_nm = Util.checkString(rset2.getString("medi_nm"));
			rec.dlco_clsf = Util.checkString(rset2.getString("dlco_clsf"));
			rec.dlco_clsf_nm = Util.checkString(rset2.getString("dlco_clsf_nm"));
			rec.basi_yymm = Util.checkString(rset2.getString("basi_yymm"));
			rec.trgt_qty = Util.checkString(rset2.getString("trgt_qty"));
			rec.trgt_amt = Util.checkString(rset2.getString("trgt_amt"));
...
<%
	for(int i=0; i<ds.trgtptcrcur.size(); i++){
		PL_BAS_1520_LTRGTPTCRCURRecord trgtptcrcurRec = (PL_BAS_1520_LTRGTPTCRCURRecord)ds.trgtptcrcur.get(i);%>
HTML 코드들....
	<%}%>
