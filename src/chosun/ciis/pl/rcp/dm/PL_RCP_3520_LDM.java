...
public class PL_RCP_3520_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_RCP_3520_LDM(){}
	public PL_RCP_3520_LDM(String cmpy_cd, String incmg_pers, String fr_dt, String to_dt, String dlco_cd, String dlco_seq){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_RCP_3520_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_RCP_3520_LDM dm = (PL_RCP_3520_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.rcp.ds.PL_RCP_3520_LDataSet();
	}
