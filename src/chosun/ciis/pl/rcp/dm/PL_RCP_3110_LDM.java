...
public class PL_RCP_3110_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_RCP_3110_LDM(){}
	public PL_RCP_3110_LDM(String cmpy_cd, String incmg_pers, String fr_dt, String to_dt, String budg_clsf, String dlco_cd, String dlco_seq){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_RCP_3110_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_RCP_3110_LDM dm = (PL_RCP_3110_LDM)bdm;
		...
		cstmt.setString(7, dm.budg_clsf);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.rcp.ds.PL_RCP_3110_LDataSet();
	}
	...
	public void print(){
		...
		System.out.println("budg_clsf = [" + getBudg_clsf() + "]");
...
String budg_clsf = req.getParameter("budg_clsf");
if( budg_clsf == null){
	System.out.println(this.toString+" : budg_clsf is null" );
}else{
	System.out.println(this.toString+" : budg_clsf is "+budg_clsf );
}
...
String budg_clsf = Util.checkString(req.getParameter("budg_clsf"));
...
String budg_clsf = Util.Uni2Ksc(Util.checkString(req.getParameter("budg_clsf")));
