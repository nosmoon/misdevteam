...
public class PL_RCP_1110_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_RCP_1110_LDM(){}
	public PL_RCP_1110_LDM(String cmpy_cd, String incmg_pers, String basi_dt_fr, String basi_dt_to, String dlco_cd, String dlco_seq){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_RCP_1110_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_RCP_1110_LDM dm = (PL_RCP_1110_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.rcp.ds.PL_RCP_1110_LDataSet();
	}
