...
public class PL_RCP_1130_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList closinfocur = new ArrayList();
	public String errcode;
	public String errmsg;
	public String gurt_amt;

	public PL_RCP_1130_LDataSet(){}
	public PL_RCP_1130_LDataSet(String errcode, String errmsg, String gurt_amt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset3.next()){
			PL_RCP_1130_LCLOSINFOCURRecord rec = new PL_RCP_1130_LCLOSINFOCURRecord();
			rec.medi_clsf = Util.checkString(rset3.getString("medi_clsf"));
			rec.medi_clsf_nm = Util.checkString(rset3.getString("medi_clsf_nm"));
			...
			rec.meda_bal = Util.checkString(rset3.getString("meda_bal"));
			rec.tot_bal = Util.checkString(rset3.getString("tot_bal"));
...
<%
	for(int i=0; i<ds.closinfocur.size(); i++){
		PL_RCP_1130_LCLOSINFOCURRecord closinfocurRec = (PL_RCP_1130_LCLOSINFOCURRecord)ds.closinfocur.get(i);%>
HTML 코드들....
	<%}%>
