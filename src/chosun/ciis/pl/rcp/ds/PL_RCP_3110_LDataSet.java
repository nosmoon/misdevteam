...
public class PL_RCP_3110_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList ptcrlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public PL_RCP_3110_LDataSet(){}
	public PL_RCP_3110_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PL_RCP_3110_LPTCRLISTRecord rec = new PL_RCP_3110_LPTCRLISTRecord();
...
<%
	PL_RCP_3110_LDataSet ds = (PL_RCP_3110_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.ptcrlist.size(); i++){
		PL_RCP_3110_LPTCRLISTRecord ptcrlistRec = (PL_RCP_3110_LPTCRLISTRecord)ds.ptcrlist.get(i);%>
HTML 코드들....
	<%}%>
