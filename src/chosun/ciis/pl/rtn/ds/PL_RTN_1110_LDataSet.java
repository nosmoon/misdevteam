...
public class PL_RTN_1110_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList deal_ptcrlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public PL_RTN_1110_LDataSet(){}
	public PL_RTN_1110_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PL_RTN_1110_LDEAL_PTCRLISTRecord rec = new PL_RTN_1110_LDEAL_PTCRLISTRecord();
...
<%
	PL_RTN_1110_LDataSet ds = (PL_RTN_1110_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.deal_ptcrlist.size(); i++){
		PL_RTN_1110_LDEAL_PTCRLISTRecord deal_ptcrlistRec = (PL_RTN_1110_LDEAL_PTCRLISTRecord)ds.deal_ptcrlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Tue Mar 31 20:56:57 KST 2009 */