...
public class PL_RTN_1020_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList deal_ptcrcur = new ArrayList();
	public String errcode;
	public String errmsg;

	public PL_RTN_1020_LDataSet(){}
	public PL_RTN_1020_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset1.next()){
			PL_RTN_1020_LDEAL_PTCRCURRecord rec = new PL_RTN_1020_LDEAL_PTCRCURRecord();
			...
			rec.prv_deli_qty = Util.checkString(rset1.getString("prv_deli_qty"));
			rec.prv_widr_qty = Util.checkString(rset1.getString("prv_widr_qty"));
			rec.prv_retn_qty = Util.checkString(rset1.getString("prv_retn_qty"));
...
<%
	for(int i=0; i<ds.deal_ptcrcur.size(); i++){
		PL_RTN_1020_LDEAL_PTCRCURRecord deal_ptcrcurRec = (PL_RTN_1020_LDEAL_PTCRCURRecord)ds.deal_ptcrcur.get(i);%>
HTML 코드들....
	<%}%>
