...
public class PL_RTN_1240_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList deal_ptcrcur = new ArrayList();
	public String errcode;
	public String errmsg;

	public PL_RTN_1240_LDataSet(){}
	public PL_RTN_1240_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PL_RTN_1240_LDEAL_PTCRCURRecord rec = new PL_RTN_1240_LDEAL_PTCRCURRecord();
...
<%
	for(int i=0; i<ds.deal_ptcrcur.size(); i++){
		PL_RTN_1240_LDEAL_PTCRCURRecord deal_ptcrcurRec = (PL_RTN_1240_LDEAL_PTCRCURRecord)ds.deal_ptcrcur.get(i);%>
HTML 코드들....
	<%}%>
