...
import chosun.ciis.pl.rtn.dao.PL_RTN_1300DAO;
import chosun.ciis.pl.rtn.dm.PL_RTN_1300_MDM;
import chosun.ciis.pl.rtn.dm.PL_RTN_1310_LDM;
import chosun.ciis.pl.rtn.dm.PL_RTN_1320_LDM;
import chosun.ciis.pl.rtn.dm.PL_RTN_1330_ADM;
import chosun.ciis.pl.rtn.ds.PL_RTN_1300_MDataSet;
import chosun.ciis.pl.rtn.ds.PL_RTN_1310_LDataSet;
import chosun.ciis.pl.rtn.ds.PL_RTN_1320_LDataSet;
import chosun.ciis.pl.rtn.ds.PL_RTN_1330_ADataSet;

/**
 * 
 */
public class PL_RTN_1300WB extends BaseWB {
     ...
     * @return void
     */
    public void pl_rtn_1300_m(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_RTN_1300_MDataSet ds = null;

        // DM Setting
        PL_RTN_1300_MDM dm = new PL_RTN_1300_MDM();
        ...
        try {
        	PL_RTN_1300DAO dao = new PL_RTN_1300DAO();
            ds = dao.pl_rtn_1300_m(dm);
...
//        PL_RTN_1300EJBHome home = (PL_RTN_1300EJBHome) JNDIManager.getInstance().getHome("PL_RTN_1300EJB");
//        try {
//        	PL_RTN_1300EJB ejb = home.create();
//            ds = ejb.pl_rtn_1300_m(dm);
//            req.setAttribute("ds", ds);
//        }
...
//        }
     ...
     * @return void
     */
    public void pl_rtn_1310_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_RTN_1310_LDataSet ds = null;

        // DM Setting
        PL_RTN_1310_LDM dm = new PL_RTN_1310_LDM();
...
//        }
     ...
     * @return void
     */
    public void pl_rtn_1320_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_RTN_1320_LDataSet ds = null;

        // DM Setting
        PL_RTN_1320_LDM dm = new PL_RTN_1320_LDM();
...
//        }
     ...
     * @return void
     */
    public void pl_rtn_1330_a(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_RTN_1330_ADataSet ds = null;

        // DM Setting
        PL_RTN_1330_ADM dm = new PL_RTN_1330_ADM();
    	...
    	String send_plac_seq_arr = (String)hash.get("send_plac_seq");									//발송처 배열   
