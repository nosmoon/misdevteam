...
import chosun.ciis.pl.rtn.dao.PL_RTN_1000DAO;
import chosun.ciis.pl.rtn.dm.PL_RTN_1000_MDM;
import chosun.ciis.pl.rtn.dm.PL_RTN_1010_LDM;
import chosun.ciis.pl.rtn.dm.PL_RTN_1020_LDM;
import chosun.ciis.pl.rtn.dm.PL_RTN_1030_LDM;
import chosun.ciis.pl.rtn.dm.PL_RTN_1040_ADM;
import chosun.ciis.pl.rtn.ds.PL_RTN_1000_MDataSet;
import chosun.ciis.pl.rtn.ds.PL_RTN_1010_LDataSet;
import chosun.ciis.pl.rtn.ds.PL_RTN_1020_LDataSet;
import chosun.ciis.pl.rtn.ds.PL_RTN_1030_LDataSet;
import chosun.ciis.pl.rtn.ds.PL_RTN_1040_ADataSet;

/**
 * 
 */
public class PL_RTN_1000WB extends BaseWB {
     ...
     * @return void
     */
    public void pl_rtn_1000_m(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_RTN_1000_MDataSet ds = null;

        // DM Setting
        PL_RTN_1000_MDM dm = new PL_RTN_1000_MDM();
        ...
        try {
        	PL_RTN_1000DAO dao = new PL_RTN_1000DAO();
            ds = dao.pl_rtn_1000_m(dm);
...
//        PL_RTN_1000EJBHome home = (PL_RTN_1000EJBHome) JNDIManager.getInstance().getHome("PL_RTN_1000EJB");
//        try {
//        	PL_RTN_1000EJB ejb = home.create();
//            ds = ejb.pl_rtn_1000_m(dm);
//            req.setAttribute("ds", ds);
//        }
...
//        }
     ...
     * @return void
     */
    public void pl_rtn_1010_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_RTN_1010_LDataSet ds = null;

        // DM Setting
        PL_RTN_1010_LDM dm = new PL_RTN_1010_LDM();
...
//        }
     ...
     * @return void
     */
    public void pl_rtn_1020_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_RTN_1020_LDataSet ds = null;

        // DM Setting
        PL_RTN_1020_LDM dm = new PL_RTN_1020_LDM();
...
//        }
     ...
     * @return void
     */
    public void pl_rtn_1030_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_RTN_1030_LDataSet ds = null;

        // DM Setting
        PL_RTN_1030_LDM dm = new PL_RTN_1030_LDM();
...
//        }
     ...
     * @return void
     */
    public void pl_rtn_1040_a(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_RTN_1040_ADataSet ds = null;

        // DM Setting
        PL_RTN_1040_ADM dm = new PL_RTN_1040_ADM();
