...
public class PL_RTN_1030_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_RTN_1030_LDM(){}
	public PL_RTN_1030_LDM(String cmpy_cd, String incmg_pers, String basi_yymm, String dlco_cd, String dlco_seq){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_RTN_1030_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_RTN_1030_LDM dm = (PL_RTN_1030_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.rtn.ds.PL_RTN_1030_LDataSet();
	}
