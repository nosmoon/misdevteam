...
public class PL_RTN_1230_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_RTN_1230_ADM(){}
	public PL_RTN_1230_ADM(String acc_flag, String cmpy_cd, String incmg_pers, String incmg_pers_ip, String deal_dt, String deal_grp_seq, String basi_yymm, String basi_dt, String dlco_cd, String dlco_seq, String send_plac_seq, String qty_chk, String mode_arr, String deal_seq_arr, String medi_cd_arr, String medi_ser_no_arr, String deal_qty_arr, String deal_uprc_arr, String dcrate_arr, String deal_amt_arr, String wh_cd_arr, String remk_arr){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_RTN_1230_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_RTN_1230_ADM dm = (PL_RTN_1230_ADM)bdm;
		...
		cstmt.setString(13, dm.send_plac_seq);
		cstmt.setString(14, dm.qty_chk);
		cstmt.setString(15, dm.mode_arr);
		cstmt.setString(16, dm.deal_seq_arr);
		cstmt.setString(17, dm.medi_cd_arr);
		cstmt.setString(18, dm.medi_ser_no_arr);
		...
		cstmt.setString(23, dm.wh_cd_arr);
		cstmt.setString(24, dm.remk_arr);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.rtn.ds.PL_RTN_1230_ADataSet();
	}
