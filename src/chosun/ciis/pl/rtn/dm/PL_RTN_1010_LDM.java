...
public class PL_RTN_1010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_RTN_1010_LDM(){}
	public PL_RTN_1010_LDM(String cmpy_cd, String incmg_pers, String basi_dt_fr, String basi_dt_to, String dlco_cd, String dlco_seq){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_RTN_1010_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_RTN_1010_LDM dm = (PL_RTN_1010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.rtn.ds.PL_RTN_1010_LDataSet();
	}
