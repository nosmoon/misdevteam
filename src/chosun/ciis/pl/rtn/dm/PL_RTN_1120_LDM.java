...
public class PL_RTN_1120_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_RTN_1120_LDM(){}
	public PL_RTN_1120_LDM(String cmpy_cd, String incmg_pers, String deal_dt, String deal_grp_seq){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_RTN_1120_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_RTN_1120_LDM dm = (PL_RTN_1120_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.rtn.ds.PL_RTN_1120_LDataSet();
	}
