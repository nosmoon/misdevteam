...
public class PL_TRN_1030_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_TRN_1030_ADM(){}
	public PL_TRN_1030_ADM(String acc_flag, String cmpy_cd, String incmg_pers, String incmg_pers_ip, String deal_dt, String deal_grp_seq, String basi_yymm, String basi_dt, String dlco_cd, String dlco_seq, String qty_chk, String mode_arr, String deal_seq_arr, String medi_cd_arr, String medi_ser_no_arr, String deal_qty_arr, String deal_uprc_arr, String dcrate_arr, String deal_amt_arr, String wh_cd_arr, String remk_arr){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_TRN_1030_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_TRN_1030_ADM dm = (PL_TRN_1030_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.trn.ds.PL_TRN_1030_ADataSet();
	}
