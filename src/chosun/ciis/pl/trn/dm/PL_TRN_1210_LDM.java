...
public class PL_TRN_1210_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PL_TRN_1210_LDM(){}
	public PL_TRN_1210_LDM(String cmpy_cd, String incmg_pers, String basi_dt_fr, String basi_dt_to, String dlco_cd, String dlco_seq){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_PL_TRN_1210_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PL_TRN_1210_LDM dm = (PL_TRN_1210_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.pl.trn.ds.PL_TRN_1210_LDataSet();
	}
