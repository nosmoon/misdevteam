...
public class PL_TRN_1320_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList deal_ptcrcur = new ArrayList();
	public String errcode;
	public String errmsg;

	public PL_TRN_1320_LDataSet(){}
	public PL_TRN_1320_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset7.next()){
			PL_TRN_1320_LDEAL_PTCRCURRecord rec = new PL_TRN_1320_LDEAL_PTCRCURRecord();
			...
			rec.dlco_cd = Util.checkString(rset7.getString("dlco_cd"));
			rec.dlco_seq = Util.checkString(rset7.getString("dlco_seq"));
			rec.dlco_nm = Util.checkString(rset7.getString("dlco_nm"));
			rec.send_plac_seq = Util.checkString(rset7.getString("send_plac_seq"));
			rec.send_plac_nm = Util.checkString(rset7.getString("send_plac_nm"));
...
<%
	for(int i=0; i<ds.deal_ptcrcur.size(); i++){
		PL_TRN_1320_LDEAL_PTCRCURRecord deal_ptcrcurRec = (PL_TRN_1320_LDEAL_PTCRCURRecord)ds.deal_ptcrcur.get(i);%>
HTML 코드들....
	<%}%>
