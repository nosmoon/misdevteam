...
import chosun.ciis.pl.trn.dao.PL_TRN_1100DAO;
import chosun.ciis.pl.trn.dm.PL_TRN_1100_MDM;
import chosun.ciis.pl.trn.dm.PL_TRN_1110_LDM;
import chosun.ciis.pl.trn.dm.PL_TRN_1120_LDM;
import chosun.ciis.pl.trn.dm.PL_TRN_1130_ADM;
import chosun.ciis.pl.trn.ds.PL_TRN_1100_MDataSet;
import chosun.ciis.pl.trn.ds.PL_TRN_1110_LDataSet;
import chosun.ciis.pl.trn.ds.PL_TRN_1120_LDataSet;
import chosun.ciis.pl.trn.ds.PL_TRN_1130_ADataSet;

/**
 * 
 */
public class PL_TRN_1100WB extends BaseWB {
     ...
     * @return void
     */
    public void pl_trn_1100_m(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_TRN_1100_MDataSet ds = null;

        // DM Setting
        PL_TRN_1100_MDM dm = new PL_TRN_1100_MDM();
        ...
        try {
        	PL_TRN_1100DAO dao = new PL_TRN_1100DAO();
            ds = dao.pl_trn_1100_m(dm);
...
//        PL_TRN_1100EJBHome home = (PL_TRN_1100EJBHome) JNDIManager.getInstance().getHome("PL_TRN_1100EJB");
//        try {
//        	PL_TRN_1100EJB ejb = home.create();
//            ds = ejb.pl_trn_1100_m(dm);
//            req.setAttribute("ds", ds);
//        }
...
//        }
     ...
     * @return void
     */
    public void pl_trn_1110_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_TRN_1110_LDataSet ds = null;

        // DM Setting
        PL_TRN_1110_LDM dm = new PL_TRN_1110_LDM();
...
//        }
     ...
     * @return void
     */
    public void pl_trn_1120_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_TRN_1120_LDataSet ds = null;

        // DM Setting
        PL_TRN_1120_LDM dm = new PL_TRN_1120_LDM();
...
//        }
     ...
     * @return void
     */
    public void pl_trn_1130_a(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_TRN_1130_ADataSet ds = null;

        // DM Setting
        PL_TRN_1130_ADM dm = new PL_TRN_1130_ADM();
