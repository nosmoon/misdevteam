...
import chosun.ciis.pl.trn.dao.PL_TRN_1300DAO;
import chosun.ciis.pl.trn.dm.PL_TRN_1300_MDM;
import chosun.ciis.pl.trn.dm.PL_TRN_1310_LDM;
import chosun.ciis.pl.trn.dm.PL_TRN_1320_LDM;
import chosun.ciis.pl.trn.dm.PL_TRN_1330_ADM;
import chosun.ciis.pl.trn.ds.PL_TRN_1300_MDataSet;
import chosun.ciis.pl.trn.ds.PL_TRN_1310_LDataSet;
import chosun.ciis.pl.trn.ds.PL_TRN_1320_LDataSet;
import chosun.ciis.pl.trn.ds.PL_TRN_1330_ADataSet;

/**
 * 
 */
public class PL_TRN_1300WB extends BaseWB {
     ...
     * @return void
     */
    public void pl_trn_1300_m(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_TRN_1300_MDataSet ds = null;

        // DM Setting
        PL_TRN_1300_MDM dm = new PL_TRN_1300_MDM();
        ...
        try {
        	PL_TRN_1300DAO dao = new PL_TRN_1300DAO();
            ds = dao.pl_trn_1300_m(dm);
...
//        PL_TRN_1300EJBHome home = (PL_TRN_1300EJBHome) JNDIManager.getInstance().getHome("PL_TRN_1300EJB");
//        try {
//        	PL_TRN_1300EJB ejb = home.create();
//            ds = ejb.pl_trn_1300_m(dm);
//            req.setAttribute("ds", ds);
//        }
...
//        }
     ...
     * @return void
     */
    public void pl_trn_1310_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_TRN_1310_LDataSet ds = null;

        // DM Setting
        PL_TRN_1310_LDM dm = new PL_TRN_1310_LDM();
...
//        }
     ...
     * @return void
     */
    public void pl_trn_1320_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_TRN_1320_LDataSet ds = null;

        // DM Setting
        PL_TRN_1320_LDM dm = new PL_TRN_1320_LDM();
...
//        }
     ...
     * @return void
     */
    public void pl_trn_1330_a(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_TRN_1330_ADataSet ds = null;

        // DM Setting
        PL_TRN_1330_ADM dm = new PL_TRN_1330_ADM();
