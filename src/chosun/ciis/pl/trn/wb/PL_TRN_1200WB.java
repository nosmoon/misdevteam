...
import chosun.ciis.pl.trn.dao.PL_TRN_1200DAO;
import chosun.ciis.pl.trn.dm.PL_TRN_1200_MDM;
import chosun.ciis.pl.trn.dm.PL_TRN_1210_LDM;
import chosun.ciis.pl.trn.dm.PL_TRN_1220_LDM;
import chosun.ciis.pl.trn.dm.PL_TRN_1230_ADM;
import chosun.ciis.pl.trn.ds.PL_TRN_1200_MDataSet;
import chosun.ciis.pl.trn.ds.PL_TRN_1210_LDataSet;
import chosun.ciis.pl.trn.ds.PL_TRN_1220_LDataSet;
import chosun.ciis.pl.trn.ds.PL_TRN_1230_ADataSet;

/**
 * 
 */
public class PL_TRN_1200WB extends BaseWB {
     ...
     * @return void
     */
    public void pl_trn_1200_m(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_TRN_1200_MDataSet ds = null;

        // DM Setting
        PL_TRN_1200_MDM dm = new PL_TRN_1200_MDM();
        ...
        try {
        	PL_TRN_1200DAO dao = new PL_TRN_1200DAO();
            ds = dao.pl_trn_1200_m(dm);
...
//        PL_TRN_1200EJBHome home = (PL_TRN_1200EJBHome) JNDIManager.getInstance().getHome("PL_TRN_1200EJB");
//        try {
//        	PL_TRN_1200EJB ejb = home.create();
//            ds = ejb.pl_trn_1200_m(dm);
//            req.setAttribute("ds", ds);
//        }
...
//        }
     ...
     * @return void
     */
    public void pl_trn_1210_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_TRN_1210_LDataSet ds = null;

        // DM Setting
        PL_TRN_1210_LDM dm = new PL_TRN_1210_LDM();
...
//        }
     ...
     * @return void
     */
    public void pl_trn_1220_l(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_TRN_1220_LDataSet ds = null;

        // DM Setting
        PL_TRN_1220_LDM dm = new PL_TRN_1220_LDM();
...
//        }
     ...
     * @return void
     */
    public void pl_trn_1230_a(HttpServletRequest req, HttpServletResponse res) throws   AppException {
    	
        PL_TRN_1230_ADataSet ds = null;

        // DM Setting
        PL_TRN_1230_ADM dm = new PL_TRN_1230_ADM();
