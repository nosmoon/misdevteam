...
public class SL_S_RDR_EXTN_CNFMDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String bocd;
	public String rdr_extndt;
	public String rdr_extnno;

	public SL_S_RDR_EXTN_CNFMDM(){}
	public SL_S_RDR_EXTN_CNFMDM(String bocd, String rdr_extndt, String rdr_extnno){
		this.bocd = bocd;
	...
	public String getSQL(){
		 return "{ call SP_SL_S_RDR_EXTN_CNFM( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SL_S_RDR_EXTN_CNFMDM dm = (SL_S_RDR_EXTN_CNFMDM)bdm;
		...
		cstmt.registerOutParameter(63, OracleTypes.CURSOR);
		cstmt.registerOutParameter(64, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sal.rdr.ds.SL_S_RDR_EXTN_CNFMDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
