...
public class SL_L_READERDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SL_L_READERDM(){}
	public SL_L_READERDM(String bocd, String search_order, String search_ad, String search_cond, String search_pttn, String search_word, String search_stop, long pageno, long pagesize){
		this.bocd = bocd;
	...
	public String getSQL(){
		 return "{ call SP_SL_L_READER( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SL_L_READERDM dm = (SL_L_READERDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sal.rdr.ds.SL_L_READERDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
