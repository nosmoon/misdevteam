/***************************************************************************************************
* 파일명 : SL_S_RDR_EXTN_OUTERDM.java
...
public class SL_S_RDR_EXTN_OUTERDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String bocd;
	public String rdr_extndt;
	public String rdr_extnno;

	public SL_S_RDR_EXTN_OUTERDM(){}
	public SL_S_RDR_EXTN_OUTERDM(String bocd, String rdr_extndt, String rdr_extnno){
		this.bocd = bocd;
	...
	public String getSQL(){
		 return "{ call SP_SL_S_RDR_EXTN_OUTER( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SL_S_RDR_EXTN_OUTERDM dm = (SL_S_RDR_EXTN_OUTERDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sal.rdr.ds.SL_S_RDR_EXTN_OUTERDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
