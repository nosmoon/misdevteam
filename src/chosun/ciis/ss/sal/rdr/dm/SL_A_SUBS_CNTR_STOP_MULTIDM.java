/***************************************************************************************************
* 파일명 : SL_A_SUBS_CNTR_STOP_MULTIDM.java
* 기능 : 중지독자관리-중지(중지처리)
* 작성일자 : 2004-06-08
* 작성자 : 김영윤
***************************************************************************************************/
...
public class SL_A_SUBS_CNTR_STOP_MULTIDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SL_A_SUBS_CNTR_STOP_MULTIDM(){}
	public SL_A_SUBS_CNTR_STOP_MULTIDM(String bocd, String incmgpers, String suspdt, String remk, String rdr_no, String medicd, String freeyn, String freeclsf, String qty, String suspresncd, String resv1, String resv2, String resv3){
		this.bocd = bocd;
	...
	public String getSQL(){
		 return "{ call SP_SL_A_SUBS_CNTR_STOP_MULTI( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SL_A_SUBS_CNTR_STOP_MULTIDM dm = (SL_A_SUBS_CNTR_STOP_MULTIDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.bocd);
		cstmt.setString(4, dm.incmgpers);
		cstmt.setString(5, dm.suspdt);
		cstmt.setString(6, dm.remk);
		cstmt.setString(7, dm.rdr_no);
		cstmt.setString(8, dm.medicd);
		cstmt.setString(9, dm.freeyn);
		cstmt.setString(10, dm.freeclsf);
		cstmt.setString(11, dm.qty);
		cstmt.setString(12, dm.suspresncd);
		cstmt.setString(13, dm.resv1);
		cstmt.setString(14, dm.resv2);
		cstmt.setString(15, dm.resv3);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sal.rdr.ds.SL_A_SUBS_CNTR_STOP_MULTIDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
