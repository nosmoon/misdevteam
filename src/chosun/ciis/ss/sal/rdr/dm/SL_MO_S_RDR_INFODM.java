...
public class SL_MO_S_RDR_INFODM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SL_MO_S_RDR_INFODM(){}
	public SL_MO_S_RDR_INFODM(String bocd, String rdr_no, String medicd, String basiyymm){
		this.bocd = bocd;
		this.rdr_no = rdr_no;
		this.medicd = medicd;
	...
	public String getSQL(){
		 return "{ call SP_SL_MO_S_RDR_INFO( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SL_MO_S_RDR_INFODM dm = (SL_MO_S_RDR_INFODM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sal.rdr.ds.SL_MO_S_RDR_INFODataSet();
	}
