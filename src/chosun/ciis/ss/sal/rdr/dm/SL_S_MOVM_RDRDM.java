...
public class SL_S_MOVM_RDRDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String regdt;
	public String regno;

	public SL_S_MOVM_RDRDM(){}
	public SL_S_MOVM_RDRDM(String regdt, String regno){
		this.regdt = regdt;
		this.regno = regno;
	}
	...
	public String getSQL(){
		 return "{ call SP_SL_S_MOVM_RDR( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SL_S_MOVM_RDRDM dm = (SL_S_MOVM_RDRDM)bdm;
		...
		cstmt.registerOutParameter(45, Types.TIMESTAMP);
		cstmt.registerOutParameter(46, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sal.rdr.ds.SL_S_MOVM_RDRDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
