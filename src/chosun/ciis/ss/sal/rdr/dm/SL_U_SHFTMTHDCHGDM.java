...
public class SL_U_SHFTMTHDCHGDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SL_U_SHFTMTHDCHGDM(){}
	public SL_U_SHFTMTHDCHGDM(String bocd, String incmgpers, String shftclsf, String pymtnm, String pymttel1, String pymttel2, String pymttel3, String bankcd, String acctno, String cardcmpycd, String cardno, String vdtyprd, String prn, String aplcdt, String aplyyymm, String email, String rdr_no, String medicd){
		this.bocd = bocd;
	...
	public String getSQL(){
		 return "{ call SP_SL_U_SHFTMTHDCHG( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SL_U_SHFTMTHDCHGDM dm = (SL_U_SHFTMTHDCHGDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sal.rdr.ds.SL_U_SHFTMTHDCHGDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
