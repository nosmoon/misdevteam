...
public class SL_L_READERDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList readercur = new ArrayList();
	public String errcode;
	public String errmsg;
	public long totalcnt;

	public SL_L_READERDataSet(){}
	public SL_L_READERDataSet(String errcode, String errmsg, long totalcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SL_L_READERREADERCURRecord rec = new SL_L_READERREADERCURRecord();
	...
	public String readercurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SL_L_READERREADERCURRecord rec = (SL_L_READERREADERCURRecord)readercur.get(i);
...
<%
	SL_L_READERDataSet ds = (SL_L_READERDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.readercur.size(); i++){
		SL_L_READERREADERCURRecord readercurRec = (SL_L_READERREADERCURRecord)ds.readercur.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Tue Jun 01 14:29:04 KST 2004 */