/***************************************************************************************************
* 파일명 : SL_S_RDR_EXTN_CNFMDataSet.java
* 기능 : 외부확장확인관리(외부확장상세보기)
* 작성일자 : 2004-07-04
* 작성자 : 김영윤
***************************************************************************************************/
/***************************************************************************************************
...
public class SL_S_RDR_EXTN_CNFMDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SL_S_RDR_EXTN_CNFMDataSet(){}
	public SL_S_RDR_EXTN_CNFMDataSet(String errcode, String errmsg, String medicd, String medinm, String subsuprc, String aplcdt, String qty, String aplcpathcd, String rdr_extntypecd, String rdr_extntypenm, String extnblngcd, String empclsfcd, String empdeptcd, String empdeptnm, String empseq, String bodutycd, String boposicd, String stafclsfcd, String stafno, String rdr_extnbocd, String boemp_no, String extnid, String extnflnm, String extntel1, String extntel2, String extntel3, String extnptph_no1, String extnptph_no2, String extnptph_no3, String extnprn, String aplcpersremk, String rdrnm, String rdrtel_no1, String rdrtel_no2, String rdrtel_no3, String rdrptph_no1, String rdrptph_no2, String rdrptph_no3, String rdremail, String rdroffinm, String rdroffitel_no1, String rdroffitel_no2, String rdroffitel_no3, String dlvzip, String dlvaddr, String dlvdtlsaddr, String dlvhopedt, String corrbocd, String bonm, String tel_no11, String tel_no12, String tel_no13, String tel_no21, String tel_no22, String tel_no23, String resiclsfcd, String resitypecd, String subscnfmstatcd, String curryymm){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.subsuprc = Util.checkString(cstmt.getString(8));
		this.aplcdt = Util.checkString(cstmt.getString(9));
		this.qty = Util.checkString(cstmt.getString(10));
		this.aplcpathcd = Util.checkString(cstmt.getString(11));
		this.rdr_extntypecd = Util.checkString(cstmt.getString(12));
		this.rdr_extntypenm = Util.checkString(cstmt.getString(13));
		this.extnblngcd = Util.checkString(cstmt.getString(14));
		this.empclsfcd = Util.checkString(cstmt.getString(15));
		this.empdeptcd = Util.checkString(cstmt.getString(16));
		this.empdeptnm = Util.checkString(cstmt.getString(17));
		this.empseq = Util.checkString(cstmt.getString(18));
		this.bodutycd = Util.checkString(cstmt.getString(19));
		this.boposicd = Util.checkString(cstmt.getString(20));
		this.stafclsfcd = Util.checkString(cstmt.getString(21));
		this.stafno = Util.checkString(cstmt.getString(22));
		this.rdr_extnbocd = Util.checkString(cstmt.getString(23));
		this.boemp_no = Util.checkString(cstmt.getString(24));
		this.extnid = Util.checkString(cstmt.getString(25));
		this.extnflnm = Util.checkString(cstmt.getString(26));
		this.extntel1 = Util.checkString(cstmt.getString(27));
		this.extntel2 = Util.checkString(cstmt.getString(28));
		this.extntel3 = Util.checkString(cstmt.getString(29));
		this.extnptph_no1 = Util.checkString(cstmt.getString(30));
		this.extnptph_no2 = Util.checkString(cstmt.getString(31));
		this.extnptph_no3 = Util.checkString(cstmt.getString(32));
		this.extnprn = Util.checkString(cstmt.getString(33));
		this.aplcpersremk = Util.checkString(cstmt.getString(34));
		this.rdrnm = Util.checkString(cstmt.getString(35));
		this.rdrtel_no1 = Util.checkString(cstmt.getString(36));
		this.rdrtel_no2 = Util.checkString(cstmt.getString(37));
		this.rdrtel_no3 = Util.checkString(cstmt.getString(38));
		this.rdrptph_no1 = Util.checkString(cstmt.getString(39));
		this.rdrptph_no2 = Util.checkString(cstmt.getString(40));
		this.rdrptph_no3 = Util.checkString(cstmt.getString(41));
		this.rdremail = Util.checkString(cstmt.getString(42));
		this.rdroffinm = Util.checkString(cstmt.getString(43));
		this.rdroffitel_no1 = Util.checkString(cstmt.getString(44));
		this.rdroffitel_no2 = Util.checkString(cstmt.getString(45));
		this.rdroffitel_no3 = Util.checkString(cstmt.getString(46));
		this.dlvzip = Util.checkString(cstmt.getString(47));
		this.dlvaddr = Util.checkString(cstmt.getString(48));
		this.dlvdtlsaddr = Util.checkString(cstmt.getString(49));
		this.dlvhopedt = Util.checkString(cstmt.getString(50));
		this.corrbocd = Util.checkString(cstmt.getString(51));
		this.bonm = Util.checkString(cstmt.getString(52));
		this.tel_no11 = Util.checkString(cstmt.getString(53));
		this.tel_no12 = Util.checkString(cstmt.getString(54));
		this.tel_no13 = Util.checkString(cstmt.getString(55));
		this.tel_no21 = Util.checkString(cstmt.getString(56));
		this.tel_no22 = Util.checkString(cstmt.getString(57));
		this.tel_no23 = Util.checkString(cstmt.getString(58));
		this.resiclsfcd = Util.checkString(cstmt.getString(59));
		this.resitypecd = Util.checkString(cstmt.getString(60));
		this.subscnfmstatcd = Util.checkString(cstmt.getString(61));
		this.curryymm = Util.checkString(cstmt.getString(62));
		ResultSet rset0 = (ResultSet) cstmt.getObject(63);
		while(rset0.next()){
			SL_S_RDR_EXTN_CNFMMEDICDCURRecord rec = new SL_S_RDR_EXTN_CNFMMEDICDCURRecord();
		...
		ResultSet rset1 = (ResultSet) cstmt.getObject(64);
		while(rset1.next()){
			SL_S_RDR_EXTN_CNFMRESICLSFCDCURRecord rec = new SL_S_RDR_EXTN_CNFMRESICLSFCDCURRecord();
	...
	public String medicdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SL_S_RDR_EXTN_CNFMMEDICDCURRecord rec = (SL_S_RDR_EXTN_CNFMMEDICDCURRecord)medicdcur.get(i);
	...
	public String resiclsfcdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SL_S_RDR_EXTN_CNFMRESICLSFCDCURRecord rec = (SL_S_RDR_EXTN_CNFMRESICLSFCDCURRecord)resiclsfcdcur.get(i);
...
<%
	SL_S_RDR_EXTN_CNFMDataSet ds = (SL_S_RDR_EXTN_CNFMDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.medicdcur.size(); i++){
		SL_S_RDR_EXTN_CNFMMEDICDCURRecord medicdcurRec = (SL_S_RDR_EXTN_CNFMMEDICDCURRecord)ds.medicdcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.resiclsfcdcur.size(); i++){
		SL_S_RDR_EXTN_CNFMRESICLSFCDCURRecord resiclsfcdcurRec = (SL_S_RDR_EXTN_CNFMRESICLSFCDCURRecord)ds.resiclsfcdcur.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Sun Jul 04 19:38:19 KST 2004 */