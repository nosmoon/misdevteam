...
public class SL_L_READER_01DM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SL_L_READER_01DM(){}
	public SL_L_READER_01DM(String bocd, String rdr_extndt, String rdr_extnno, String search_order, String search_ad, String search_cond, String search_word, String search_stop, long pageno, long pagesize){
		this.bocd = bocd;
	...
	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SL_L_READER_01DM dm = (SL_L_READER_01DM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sal.common.ds.SL_L_READER_01DataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
