/***************************************************************************************************
* 파일명 : SS_L_READER_01DataSet.java
...
public class SS_L_READER_01DataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList readercur = new ArrayList();
	public String errcode;
	public String errmsg;
	public long totalcnt;

	public SS_L_READER_01DataSet(){}
	public SS_L_READER_01DataSet(String errcode, String errmsg, long totalcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_L_READER_01READERCURRecord rec = new SS_L_READER_01READERCURRecord();
	...
	public String readercurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_READER_01READERCURRecord rec = (SS_L_READER_01READERCURRecord)readercur.get(i);
...
<%
	SS_L_READER_01DataSet ds = (SS_L_READER_01DataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.readercur.size(); i++){
		SS_L_READER_01READERCURRecord readercurRec = (SS_L_READER_01READERCURRecord)ds.readercur.get(i);%>
HTML 코드들....
	<%}%>
