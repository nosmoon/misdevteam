...
public class SS_L_BO_SRCH_TEMPDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curbolist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SS_L_BO_SRCH_TEMPDataSet(){}
	public SS_L_BO_SRCH_TEMPDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_L_BO_SRCH_TEMPCURBOLISTRecord rec = new SS_L_BO_SRCH_TEMPCURBOLISTRecord();
	...
	public String curbolistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_BO_SRCH_TEMPCURBOLISTRecord rec = (SS_L_BO_SRCH_TEMPCURBOLISTRecord)curbolist.get(i);
...
/* 작성시간 : Tue Jul 28 17:07:29 KST 2009 */