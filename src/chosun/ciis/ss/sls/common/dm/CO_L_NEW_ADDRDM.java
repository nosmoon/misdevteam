...
public class CO_L_NEW_ADDRDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public CO_L_NEW_ADDRDM(){}
	public CO_L_NEW_ADDRDM(String sido, String gugun, String rdnm, String bldgnn1, String bldgnn2, String bldgnm, String dong, String bnji1, String bnji2, String job_flag, String bocd, String orderby, long pageno, long pagesize){
		this.sido = sido;
		this.gugun = gugun;
		this.rdnm = rdnm;
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_CO_L_NEW_ADDR(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		CO_L_NEW_ADDRDM dm = (CO_L_NEW_ADDRDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.common.ds.CO_L_NEW_ADDRDataSet();
	}
