...
/**
 * 독자 목록조회(수금형) ( 독자+매체 ) 조회를 위한 DataModel
 *
 */


public class SS_L_RDR_DTLS_SECHDM extends somo.framework.db.BaseDM implements java.io.Serializable{
    ...
    public SS_L_RDR_DTLS_SECHDM(){}
    public SS_L_RDR_DTLS_SECHDM(String bocd, String search_order, String search_ad, String search_cond, String search_word, String search_stop, String search_sg,long pageno, long pagesize){
        this.bocd = bocd;
    ...
    public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
        SS_L_RDR_DTLS_SECHDM dm = (SS_L_RDR_DTLS_SECHDM)bdm;
    ...
    public BaseDataSet createDataSetObject(){
        return new chosun.ciis.ss.sls.common.ds.SS_L_RDR_DTLS_SECHDataSet();
    }
}
/*----------------------------------------------------------------------------------------------------
