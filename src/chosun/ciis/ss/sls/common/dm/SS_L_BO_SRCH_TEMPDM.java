...
public class SS_L_BO_SRCH_TEMPDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_BO_SRCH_TEMPDM(){}
	public SS_L_BO_SRCH_TEMPDM(String deptcd, String areacd, String bonm, String addr3){
		this.deptcd = deptcd;
		this.areacd = areacd;
		this.bonm = bonm;
		this.addr3 = addr3;
	...
	public String getSQL(){
		 return "{ call SP_SS_L_BO_SRCH_TEMP( ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_BO_SRCH_TEMPDM dm = (SS_L_BO_SRCH_TEMPDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.common.ds.SS_L_BO_SRCH_TEMPDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
