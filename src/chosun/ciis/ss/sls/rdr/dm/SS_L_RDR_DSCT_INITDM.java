...
public class SS_L_RDR_DSCT_INITDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_RDR_DSCT_INITDM(){}
	public SS_L_RDR_DSCT_INITDM(String cmpy_cd, String auth_gb, String incmg_pers, String base_dt){
	...
	public String getSQL(){
		 return "{ call SP_SS_L_RDR_DSCT_INIT( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_RDR_DSCT_INITDM dm = (SS_L_RDR_DSCT_INITDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.rdr.ds.SS_L_RDR_DSCT_INITDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
