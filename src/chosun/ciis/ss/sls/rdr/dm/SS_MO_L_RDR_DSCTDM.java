...
public class SS_MO_L_RDR_DSCTDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_MO_L_RDR_DSCTDM(){}
	public SS_MO_L_RDR_DSCTDM(String deptcd, String partcd, String areacd, String bocd, String bonm, String fromtogb, String frdt, String todt, String rdrnm, String rdr_no, String titl, String cont, String dscttypecd, String bocnfmyn, String boprocyn, String acpnpathcd, long pageno, long pagesize, String cns_empnm, String procpers){
		this.deptcd = deptcd;
		this.partcd = partcd;
		this.areacd = areacd;
		this.bocd = bocd;
	...
	public String getSQL(){
		 return "{ call SP_SS_MO_L_RDR_DSCT( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_MO_L_RDR_DSCTDM dm = (SS_MO_L_RDR_DSCTDM)bdm;
		...
		cstmt.setString(12, dm.rdr_no);
		cstmt.setString(13, dm.titl);
		cstmt.setString(14, dm.cont);
		cstmt.setString(15, dm.dscttypecd);
		cstmt.setString(16, dm.bocnfmyn);
		cstmt.setString(17, dm.boprocyn);
		cstmt.setString(18, dm.acpnpathcd);
		cstmt.setLong(19, dm.pageno);
		cstmt.setLong(20, dm.pagesize);
		cstmt.setString(21, dm.cns_empnm);
		cstmt.setString(22, dm.procpers);
		cstmt.registerOutParameter(23, Types.INTEGER);
		cstmt.registerOutParameter(24, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.rdr.ds.SS_MO_L_RDR_DSCTDataSet();
	}
