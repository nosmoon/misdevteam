...
public class SS_L_TM_AGENTLISTDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String search_frdt;
	public String search_todt;

	public SS_L_TM_AGENTLISTDM(){}
	public SS_L_TM_AGENTLISTDM(String search_frdt, String search_todt){
	...
	public String getSQL(){
		 return "{ call CRMCCT_CCT.SP_SS_L_TM_AGENTLIST(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_TM_AGENTLISTDM dm = (SS_L_TM_AGENTLISTDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.rdr.ds.SS_L_TM_AGENTLISTDataSet();
	}
