...
public class SS_S_RDR_MNGMEMBDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList rdrmngmemb = new ArrayList();
	public String errcode;
	public String errmsg;

	public SS_S_RDR_MNGMEMBDataSet(){}
	public SS_S_RDR_MNGMEMBDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_S_RDR_MNGMEMBRDRMNGMEMBRecord rec = new SS_S_RDR_MNGMEMBRDRMNGMEMBRecord();
			...
			rec.custclasnm = Util.checkString(rset0.getString("custclasnm"));
	...
	public String rdrmngmembOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_S_RDR_MNGMEMBRDRMNGMEMBRecord rec = (SS_S_RDR_MNGMEMBRDRMNGMEMBRecord)rdrmngmemb.get(i);
...
<%
	SS_S_RDR_MNGMEMBDataSet ds = (SS_S_RDR_MNGMEMBDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.rdrmngmemb.size(); i++){
		SS_S_RDR_MNGMEMBRDRMNGMEMBRecord rdrmngmembRec = (SS_S_RDR_MNGMEMBRDRMNGMEMBRecord)ds.rdrmngmemb.get(i);%>
HTML 코드들....
	<%}%>
