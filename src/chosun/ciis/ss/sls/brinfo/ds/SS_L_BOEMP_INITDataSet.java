/***************************************************************************************************
* 파일명 : SS_L_BOEMP_INITDataSet.java
...
public class SS_L_BOEMP_INITDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curdeptcd = new ArrayList();
	public String errcode;
	public String errmsg;

	public SS_L_BOEMP_INITDataSet(){}
	public SS_L_BOEMP_INITDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_L_BOEMP_INITCURDEPTCDRecord rec = new SS_L_BOEMP_INITCURDEPTCDRecord();
	...
	public String curdeptcdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_BOEMP_INITCURDEPTCDRecord rec = (SS_L_BOEMP_INITCURDEPTCDRecord)curdeptcd.get(i);
...
<%
	for(int i=0; i<ds.curdeptcd.size(); i++){
		SS_L_BOEMP_INITCURDEPTCDRecord curdeptcdRec = (SS_L_BOEMP_INITCURDEPTCDRecord)ds.curdeptcd.get(i);%>
HTML 코드들....
	<%}%>
