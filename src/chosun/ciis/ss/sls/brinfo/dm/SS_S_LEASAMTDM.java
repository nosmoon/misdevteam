/***************************************************************************************************
* 파일명 : SS_S_LEASAMTDM.java
* 기능 : 지국Info-전세지원금-상세를 위한 DM
* 작성일자 : 2004-04-24
* 작성자 : 김대섭
***************************************************************************************************/
/***************************************************************************************************
...
/**
 * 지국Info-전세지원금-상세를 위한 DM
 */

public class SS_S_LEASAMTDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_S_LEASAMTDM(){}
	public SS_S_LEASAMTDM(String deptcd, String areacd, String bocd, String seq){
		this.deptcd = deptcd;
		this.areacd = areacd;
		this.bocd = bocd;
		this.seq = seq;
	...
	public String getSQL(){
		 return "{ call SP_SS_S_LEASAMT( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_S_LEASAMTDM dm = (SS_S_LEASAMTDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brinfo.ds.SS_S_LEASAMTDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
