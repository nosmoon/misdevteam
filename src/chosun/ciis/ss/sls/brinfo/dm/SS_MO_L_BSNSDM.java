...
public class SS_MO_L_BSNSDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_MO_L_BSNSDM(){}
	public SS_MO_L_BSNSDM(String deptcd, String partcd, String areacd, String bocd, String sendplacnm, String route_clsf, String fromdate, String todate){
		this.deptcd = deptcd;
		this.partcd = partcd;
		this.areacd = areacd;
		this.bocd = bocd;
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_MO_L_BSNS(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_MO_L_BSNSDM dm = (SS_MO_L_BSNSDM)bdm;
		...
		cstmt.setString(9, dm.fromdate);
		cstmt.setString(10, dm.todate);
		cstmt.registerOutParameter(11, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brinfo.ds.SS_MO_L_BSNSDataSet();
	}
