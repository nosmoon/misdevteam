/***************************************************************************************************
 * 파일명   : SP_SS_U_BOACCT.sql
 * 기능     : 지국Info-지국계좌관리(실시간계좌이체) 수정
 * 작성일자 : 2006/11/28
 * 작성자   : 이혁
 **************************************************************************************************/
...
public class SS_U_BOACCTDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_U_BOACCTDM(){}
	public SS_U_BOACCTDM(String seq, String bocd, String acctitem, String bankcd, String acctno, String deps_persnm, String remk, String incmgpers){
		this.seq = seq;
		this.bocd = bocd;
	...
	public String getSQL(){
		 return "{ call SP_SS_U_BOACCT( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_U_BOACCTDM dm = (SS_U_BOACCTDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brinfo.ds.SS_U_BOACCTDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
...
/* 작성시간 : Tue Nov 28 11:52:57 KST 2006 */