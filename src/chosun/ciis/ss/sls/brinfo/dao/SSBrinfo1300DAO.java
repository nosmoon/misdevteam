/***************************************************************************************************
 * 파일명 : SSBrinfo1300DAO.java
 * 기능 : 지국Info-지국조직현황을 위한 DAO
 * 작성일자 : 2004-02-06
 * 작성자 : 고윤홍
 ***************************************************************************************************/
/***************************************************************************************************
...
/**
 * 지국Info-지국조직현황을 위한 DAO
 */
public class SSBrinfo1300DAO {

    /**
     * 지국Info-지국조직현황 초기화
     * @param dm SS_L_BOEMP_INITDM 객체
     * @return SS_L_BOEMP_INITDataSet 객체
     * @throws AppException
     */
    ...
    /**
     * 지국Info-지국조직현황 목록
     * @param dm SS_L_BOEMPDM 객체
     * @return SS_L_BOEMPDataSet 객체
     * @throws AppException
     */
    ...
    /**
     * 지국Info-지국조직현황 상세목록
     * @param dm SS_L_BOEMP_DTLDM 객체
     * @return SS_L_BOEMP_DTLDataSet 객체
     * @throws AppException
     */
