...
public class SS_L_WORKBOOK_APLC_INITDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_WORKBOOK_APLC_INITDM(){}
	public SS_L_WORKBOOK_APLC_INITDM(String cmpy_cd, String auth_gb, String incmg_pers, String base_dt){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_L_WORKBOOK_APLC_INIT(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_WORKBOOK_APLC_INITDM dm = (SS_L_WORKBOOK_APLC_INITDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.health.ds.SS_L_WORKBOOK_APLC_INITDataSet();
	}
...
/* 작성시간 : Mon Jan 12 13:53:06 KST 2015 */