...
public class SS_L_APTDONGUNITTHRW_INIT1DM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_APTDONGUNITTHRW_INIT1DM(){}
	public SS_L_APTDONGUNITTHRW_INIT1DM(String cmpy_cd, String auth_gb, String incmg_pers, String base_dt){
	...
	public String getSQL(){
		 return "{ call SP_SS_L_APTDONGUNITTHRW_INIT1( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_APTDONGUNITTHRW_INIT1DM dm = (SS_L_APTDONGUNITTHRW_INIT1DM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brmgr.ds.SS_L_APTDONGUNITTHRW_INIT1DataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
