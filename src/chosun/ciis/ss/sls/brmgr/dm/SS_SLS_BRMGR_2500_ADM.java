...
public class SS_SLS_BRMGR_2500_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_SLS_BRMGR_2500_ADM(){}
	public SS_SLS_BRMGR_2500_ADM(String bocd, String cmpy_cd, String auth_gb, String incmg_pers, String base_dt){
		this.bocd = bocd;
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_SLS_BRMGR_2500_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_SLS_BRMGR_2500_ADM dm = (SS_SLS_BRMGR_2500_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brmgr.ds.SS_SLS_BRMGR_2500_ADataSet();
	}
