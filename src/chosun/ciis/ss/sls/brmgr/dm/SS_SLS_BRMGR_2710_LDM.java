...
public class SS_SLS_BRMGR_2710_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_SLS_BRMGR_2710_LDM(){}
	public SS_SLS_BRMGR_2710_LDM(String deptcd, String fr_yymm, String to_yymm, String incmgpers, String cmpycd){
		this.deptcd = deptcd;
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_SLS_BRMGR_2710_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_SLS_BRMGR_2710_LDM dm = (SS_SLS_BRMGR_2710_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brmgr.ds.SS_SLS_BRMGR_2710_LDataSet();
	}
