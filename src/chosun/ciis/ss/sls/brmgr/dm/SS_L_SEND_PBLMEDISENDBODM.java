...
public class SS_L_SEND_PBLMEDISENDBODM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_SEND_PBLMEDISENDBODM(){}
	public SS_L_SEND_PBLMEDISENDBODM(String cmpycd, String senddt, String mediser_fr, String mediser_to, String medicd, String deptcd, String areacd, String bocd, long pageno, long pagesize){
		this.cmpycd = cmpycd;
		this.senddt = senddt;
	...
	public String getSQL(){
		 return "{ call SP_SS_L_SEND_PBLMEDISENDBO( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_SEND_PBLMEDISENDBODM dm = (SS_L_SEND_PBLMEDISENDBODM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brmgr.ds.SS_L_SEND_PBLMEDISENDBODataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
