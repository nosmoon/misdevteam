...
public class SS_L_BO_PROXY_INITDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_BO_PROXY_INITDM(){}
	public SS_L_BO_PROXY_INITDM(String cmpy_cd, String auth_gb, String incmg_pers, String base_dt){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_L_BO_PROXY_INIT(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_BO_PROXY_INITDM dm = (SS_L_BO_PROXY_INITDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brmgr.ds.SS_L_BO_PROXY_INITDataSet();
	}
