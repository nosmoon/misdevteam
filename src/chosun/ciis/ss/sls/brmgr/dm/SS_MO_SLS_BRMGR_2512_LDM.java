/***************************************************************************************************
* 파일명 : SS_MO_SLS_BRMGR_2512_LDM.java
...
public class SS_MO_SLS_BRMGR_2512_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_MO_SLS_BRMGR_2512_LDM(){}
	public SS_MO_SLS_BRMGR_2512_LDM(String deptcd, String partcd, String areacd, String bocd, String incmg_pers, String fr_yymm, String to_yymm){
		this.deptcd = deptcd;
		this.partcd = partcd;
		this.areacd = areacd;
		this.bocd = bocd;
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_MO_SLS_BRMGR_2512_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_MO_SLS_BRMGR_2512_LDM dm = (SS_MO_SLS_BRMGR_2512_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brmgr.ds.SS_MO_SLS_BRMGR_2512_LDataSet();
	}
