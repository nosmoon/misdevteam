...
public class SS_SLS_BRMGR_2430_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String jobclsf;
	public String yymm;
	public String incmgpers;

	public SS_SLS_BRMGR_2430_UDM(){}
	public SS_SLS_BRMGR_2430_UDM(String jobclsf, String yymm, String incmgpers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_SLS_BRMGR_2430_U(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_SLS_BRMGR_2430_UDM dm = (SS_SLS_BRMGR_2430_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brmgr.ds.SS_SLS_BRMGR_2430_UDataSet();
	}
...
/* 작성시간 : Wed Feb 03 17:38:58 KST 2016 */