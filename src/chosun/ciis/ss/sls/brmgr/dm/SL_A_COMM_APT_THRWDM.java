...
public class SL_A_COMM_APT_THRWDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String dlvstatcd1;
	public String dlvstatcd2;
	public String dlvstatcd3;
	public String regtype1;
	public String regtype2;
	public String remk;
	public String regdt;

	public SL_A_COMM_APT_THRWDM(){}
	public SL_A_COMM_APT_THRWDM(String accflag, String hmflag, String bocd, String zip, String addr, String addrcd, String dongno, long pyong1, long hoscnt1, long pyong2, long hoscnt2, long pyong3, long hoscnt3, String invsgdt, String invsgno, String invsghhmm, String invsgpers, String housval, String incmgpers, String medicd, String qty, String qtyratio, String bgndlvtm, String enddlvtm, String dlvstatcd, String leaffeednosh, String dlvstatcd1, String dlvstatcd2, String dlvstatcd3, String regtype1, String regtype2, String remk, String regdt){
		...
		this.dlvstatcd1 = dlvstatcd1;
		this.dlvstatcd2 = dlvstatcd2;
		this.dlvstatcd3 = dlvstatcd3;
	...
	public void setDlvstatcd1(String dlvstatcd1){
		this.dlvstatcd1 = dlvstatcd1;
	}

	public void setDlvstatcd2(String dlvstatcd2){
		this.dlvstatcd2 = dlvstatcd2;
	}

	public void setDlvstatcd3(String dlvstatcd3){
		this.dlvstatcd3 = dlvstatcd3;
	}
	...
	public String getDlvstatcd1(){
		return this.dlvstatcd1;
	}

	public String getDlvstatcd2(){
		return this.dlvstatcd2;
	}

	public String getDlvstatcd3(){
		return this.dlvstatcd3;
	}
	...
	public String getSQL(){
		 return "{ call SP_SL_A_COMM_APT_THRW( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SL_A_COMM_APT_THRWDM dm = (SL_A_COMM_APT_THRWDM)bdm;
		...
		cstmt.setString(29, dm.dlvstatcd1);
		cstmt.setString(30, dm.dlvstatcd2);
		cstmt.setString(31, dm.dlvstatcd3);
		cstmt.setString(32, dm.regtype1);
		cstmt.setString(33, dm.regtype2);
		cstmt.setString(34, dm.remk);
		cstmt.setString(35, dm.regdt);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brmgr.ds.SL_A_COMM_APT_THRWDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
...
String dlvstatcd1 = req.getParameter("dlvstatcd1");
if( dlvstatcd1 == null){
	System.out.println(this.toString+" : dlvstatcd1 is null" );
}else{
	System.out.println(this.toString+" : dlvstatcd1 is "+dlvstatcd1 );
}
String dlvstatcd2 = req.getParameter("dlvstatcd2");
if( dlvstatcd2 == null){
	System.out.println(this.toString+" : dlvstatcd2 is null" );
}else{
	System.out.println(this.toString+" : dlvstatcd2 is "+dlvstatcd2 );
}
String dlvstatcd3 = req.getParameter("dlvstatcd3");
if( dlvstatcd3 == null){
	System.out.println(this.toString+" : dlvstatcd3 is null" );
}else{
	System.out.println(this.toString+" : dlvstatcd3 is "+dlvstatcd3 );
}
...
String dlvstatcd1 = Util.Uni2Ksc(Util.checkString(req.getParameter("dlvstatcd1")));
String dlvstatcd2 = Util.Uni2Ksc(Util.checkString(req.getParameter("dlvstatcd2")));
String dlvstatcd3 = Util.Uni2Ksc(Util.checkString(req.getParameter("dlvstatcd3")));
