...
public class SS_L_QTYAPLC2DM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_QTYAPLC2DM(){}
	public SS_L_QTYAPLC2DM(String deptcd, String partcd, String areacd, String dt_clsf, String dt_clsf_chce, String chrgcnfmyn, String closyn){
		this.deptcd = deptcd;
		this.partcd = partcd;
		this.areacd = areacd;
	...
	public String getSQL(){
		 return "{ call SP_SS_L_QTYAPLC2( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_QTYAPLC2DM dm = (SS_L_QTYAPLC2DM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brmgr.ds.SS_L_QTYAPLC2DataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
