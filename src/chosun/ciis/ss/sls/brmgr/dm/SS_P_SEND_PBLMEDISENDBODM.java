...
public class SS_P_SEND_PBLMEDISENDBODM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_P_SEND_PBLMEDISENDBODM(){}
	public SS_P_SEND_PBLMEDISENDBODM(String cmpycd, String senddt, String mediser_fr, String mediser_to, String medicd, String deptcd, String areacd, String bocd){
		this.cmpycd = cmpycd;
		this.senddt = senddt;
	...
	public String getSQL(){
		 return "{ call SP_SS_P_SEND_PBLMEDISENDBO( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_P_SEND_PBLMEDISENDBODM dm = (SS_P_SEND_PBLMEDISENDBODM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brmgr.ds.SS_P_SEND_PBLMEDISENDBODataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
