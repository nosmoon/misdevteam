...
public class SS_L_RDR_MOVMWORK_INITDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_L_RDR_MOVMWORK_INITDataSet(){}
	public SS_L_RDR_MOVMWORK_INITDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_L_RDR_MOVMWORK_INITTEAMLISTRecord rec = new SS_L_RDR_MOVMWORK_INITTEAMLISTRecord();
		...
		while(rset1.next()){
			SS_L_RDR_MOVMWORK_INITPARTLISTRecord rec = new SS_L_RDR_MOVMWORK_INITPARTLISTRecord();
		...
		while(rset2.next()){
			SS_L_RDR_MOVMWORK_INITAREALISTRecord rec = new SS_L_RDR_MOVMWORK_INITAREALISTRecord();
		...
		while(rset3.next()){
			SS_L_RDR_MOVMWORK_INITCURSTATRecord rec = new SS_L_RDR_MOVMWORK_INITCURSTATRecord();
	...
	public String teamlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_RDR_MOVMWORK_INITTEAMLISTRecord rec = (SS_L_RDR_MOVMWORK_INITTEAMLISTRecord)teamlist.get(i);
	...
	public String partlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_RDR_MOVMWORK_INITPARTLISTRecord rec = (SS_L_RDR_MOVMWORK_INITPARTLISTRecord)partlist.get(i);
	...
	public String arealistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_RDR_MOVMWORK_INITAREALISTRecord rec = (SS_L_RDR_MOVMWORK_INITAREALISTRecord)arealist.get(i);
	...
	public String curstatOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_RDR_MOVMWORK_INITCURSTATRecord rec = (SS_L_RDR_MOVMWORK_INITCURSTATRecord)curstat.get(i);
...
<%
	for(int i=0; i<ds.teamlist.size(); i++){
		SS_L_RDR_MOVMWORK_INITTEAMLISTRecord teamlistRec = (SS_L_RDR_MOVMWORK_INITTEAMLISTRecord)ds.teamlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.partlist.size(); i++){
		SS_L_RDR_MOVMWORK_INITPARTLISTRecord partlistRec = (SS_L_RDR_MOVMWORK_INITPARTLISTRecord)ds.partlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.arealist.size(); i++){
		SS_L_RDR_MOVMWORK_INITAREALISTRecord arealistRec = (SS_L_RDR_MOVMWORK_INITAREALISTRecord)ds.arealist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curstat.size(); i++){
		SS_L_RDR_MOVMWORK_INITCURSTATRecord curstatRec = (SS_L_RDR_MOVMWORK_INITCURSTATRecord)ds.curstat.get(i);%>
HTML 코드들....
	<%}%>
