...
public class SL_MO_L_COMM_APT_THRWDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SL_MO_L_COMM_APT_THRWDataSet(){}
	public SL_MO_L_COMM_APT_THRWDataSet(String errcode, String errmsg, long totalcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SL_MO_L_COMM_APT_THRWTHRWLISTCURRecord rec = new SL_MO_L_COMM_APT_THRWTHRWLISTCURRecord();
		...
		while(rset1.next()){
			SL_MO_L_COMM_APT_THRWADDRCDCURRecord rec = new SL_MO_L_COMM_APT_THRWADDRCDCURRecord();
			rec.addrcd = Util.checkString(rset1.getString("addrcd"));
			rec.addrnm = Util.checkString(rset1.getString("addrnm"));
			rec.donglist = Util.checkString(rset1.getString("donglist"));
			this.addrcdcur.add(rec);
		}
		ResultSet rset2 = (ResultSet) cstmt.getObject(12);
		while(rset2.next()){
			SL_MO_L_COMM_APT_THRWDLVSTATCURRecord rec = new SL_MO_L_COMM_APT_THRWDLVSTATCURRecord();
		...
		while(rset3.next()){
			SL_MO_L_COMM_APT_THRWREGTYPECUR1Record rec = new SL_MO_L_COMM_APT_THRWREGTYPECUR1Record();
		...
		while(rset4.next()){
			SL_MO_L_COMM_APT_THRWREGTYPECUR2Record rec = new SL_MO_L_COMM_APT_THRWREGTYPECUR2Record();
	...
	public String thrwlistcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SL_MO_L_COMM_APT_THRWTHRWLISTCURRecord rec = (SL_MO_L_COMM_APT_THRWTHRWLISTCURRecord)thrwlistcur.get(i);
	...
	public String addrcdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SL_MO_L_COMM_APT_THRWADDRCDCURRecord rec = (SL_MO_L_COMM_APT_THRWADDRCDCURRecord)addrcdcur.get(i);
	...
	public String dlvstatcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SL_MO_L_COMM_APT_THRWDLVSTATCURRecord rec = (SL_MO_L_COMM_APT_THRWDLVSTATCURRecord)dlvstatcur.get(i);
	...
	public String regtypecur1OptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SL_MO_L_COMM_APT_THRWREGTYPECUR1Record rec = (SL_MO_L_COMM_APT_THRWREGTYPECUR1Record)regtypecur1.get(i);
	...
	public String regtypecur2OptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SL_MO_L_COMM_APT_THRWREGTYPECUR2Record rec = (SL_MO_L_COMM_APT_THRWREGTYPECUR2Record)regtypecur2.get(i);
...
<%
	for(int i=0; i<ds.thrwlistcur.size(); i++){
		SL_MO_L_COMM_APT_THRWTHRWLISTCURRecord thrwlistcurRec = (SL_MO_L_COMM_APT_THRWTHRWLISTCURRecord)ds.thrwlistcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.addrcdcur.size(); i++){
		SL_MO_L_COMM_APT_THRWADDRCDCURRecord addrcdcurRec = (SL_MO_L_COMM_APT_THRWADDRCDCURRecord)ds.addrcdcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.dlvstatcur.size(); i++){
		SL_MO_L_COMM_APT_THRWDLVSTATCURRecord dlvstatcurRec = (SL_MO_L_COMM_APT_THRWDLVSTATCURRecord)ds.dlvstatcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.regtypecur1.size(); i++){
		SL_MO_L_COMM_APT_THRWREGTYPECUR1Record regtypecur1Rec = (SL_MO_L_COMM_APT_THRWREGTYPECUR1Record)ds.regtypecur1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.regtypecur2.size(); i++){
		SL_MO_L_COMM_APT_THRWREGTYPECUR2Record regtypecur2Rec = (SL_MO_L_COMM_APT_THRWREGTYPECUR2Record)ds.regtypecur2.get(i);%>
HTML 코드들....
	<%}%>
