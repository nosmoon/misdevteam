...
public class SS_L_COMM_APT_THRWDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_L_COMM_APT_THRWDataSet(){}
	public SS_L_COMM_APT_THRWDataSet(String errcode, String errmsg, long totalcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_L_COMM_APT_THRWTHRWLISTCURRecord rec = new SS_L_COMM_APT_THRWTHRWLISTCURRecord();
		...
		while(rset1.next()){
			SS_L_COMM_APT_THRWADDRCDCURRecord rec = new SS_L_COMM_APT_THRWADDRCDCURRecord();
		...
		while(rset2.next()){
			SS_L_COMM_APT_THRWDLVSTATCURRecord rec = new SS_L_COMM_APT_THRWDLVSTATCURRecord();
		...
		while(rset3.next()){
			SS_L_COMM_APT_THRWREGTYPECUR1Record rec = new SS_L_COMM_APT_THRWREGTYPECUR1Record();
		...
		while(rset4.next()){
			SS_L_COMM_APT_THRWREGTYPECUR2Record rec = new SS_L_COMM_APT_THRWREGTYPECUR2Record();
	...
	public String thrwlistcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_COMM_APT_THRWTHRWLISTCURRecord rec = (SS_L_COMM_APT_THRWTHRWLISTCURRecord)thrwlistcur.get(i);
	...
	public String addrcdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_COMM_APT_THRWADDRCDCURRecord rec = (SS_L_COMM_APT_THRWADDRCDCURRecord)addrcdcur.get(i);
	...
	public String dlvstatcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_COMM_APT_THRWDLVSTATCURRecord rec = (SS_L_COMM_APT_THRWDLVSTATCURRecord)dlvstatcur.get(i);
...
//			String name = rec.cicdgb;
	...
	public String regtypecur1OptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_COMM_APT_THRWREGTYPECUR1Record rec = (SS_L_COMM_APT_THRWREGTYPECUR1Record)regtypecur1.get(i);
...
//			String name = rec.cicdgb;
	...
	public String regtypecur2OptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_COMM_APT_THRWREGTYPECUR2Record rec = (SS_L_COMM_APT_THRWREGTYPECUR2Record)regtypecur2.get(i);
...
<%
	SS_L_COMM_APT_THRWDataSet ds = (SS_L_COMM_APT_THRWDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.thrwlistcur.size(); i++){
		SS_L_COMM_APT_THRWTHRWLISTCURRecord thrwlistcurRec = (SS_L_COMM_APT_THRWTHRWLISTCURRecord)ds.thrwlistcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.addrcdcur.size(); i++){
		SS_L_COMM_APT_THRWADDRCDCURRecord addrcdcurRec = (SS_L_COMM_APT_THRWADDRCDCURRecord)ds.addrcdcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.dlvstatcur.size(); i++){
		SS_L_COMM_APT_THRWDLVSTATCURRecord dlvstatcurRec = (SS_L_COMM_APT_THRWDLVSTATCURRecord)ds.dlvstatcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.regtypecur1.size(); i++){
		SS_L_COMM_APT_THRWREGTYPECUR1Record regtypecur1Rec = (SS_L_COMM_APT_THRWREGTYPECUR1Record)ds.regtypecur1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.regtypecur2.size(); i++){
		SS_L_COMM_APT_THRWREGTYPECUR2Record regtypecur2Rec = (SS_L_COMM_APT_THRWREGTYPECUR2Record)ds.regtypecur2.get(i);%>
HTML 코드들....
	<%}%>
