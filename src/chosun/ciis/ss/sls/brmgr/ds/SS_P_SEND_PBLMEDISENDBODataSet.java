...
public class SS_P_SEND_PBLMEDISENDBODataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_P_SEND_PBLMEDISENDBODataSet(){}
	public SS_P_SEND_PBLMEDISENDBODataSet(String errcode, String errmsg, String medinm, long totalcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_P_SEND_PBLMEDISENDBOCURCOMMLISTRecord rec = new SS_P_SEND_PBLMEDISENDBOCURCOMMLISTRecord();
	...
	public String curcommlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_P_SEND_PBLMEDISENDBOCURCOMMLISTRecord rec = (SS_P_SEND_PBLMEDISENDBOCURCOMMLISTRecord)curcommlist.get(i);
...
<%
	SS_P_SEND_PBLMEDISENDBODataSet ds = (SS_P_SEND_PBLMEDISENDBODataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curcommlist.size(); i++){
		SS_P_SEND_PBLMEDISENDBOCURCOMMLISTRecord curcommlistRec = (SS_P_SEND_PBLMEDISENDBOCURCOMMLISTRecord)ds.curcommlist.get(i);%>
HTML 코드들....
	<%}%>
