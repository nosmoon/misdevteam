/***************************************************************************************************
* 파일명 : SS_L_MO_SVY_INITDataSet.java
* 기능 : 
* 작성일자 : 2015.12.08
* 작성자 : 장선희
***************************************************************************************************/
...
public class SS_L_MO_SVY_INITDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_L_MO_SVY_INITDataSet(){}
	public SS_L_MO_SVY_INITDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_L_MO_SVY_INITTEAMLISTRecord rec = new SS_L_MO_SVY_INITTEAMLISTRecord();
		...
		while(rset1.next()){
			SS_L_MO_SVY_INITPARTLISTRecord rec = new SS_L_MO_SVY_INITPARTLISTRecord();
		...
		while(rset2.next()){
			SS_L_MO_SVY_INITAREALISTRecord rec = new SS_L_MO_SVY_INITAREALISTRecord();
		...
		while(rset3.next()){
			SS_L_MO_SVY_INITCUREXTNTYPECDRecord rec = new SS_L_MO_SVY_INITCUREXTNTYPECDRecord();
		...
		while(rset4.next()){
			SS_L_MO_SVY_INITCURMEDICDRecord rec = new SS_L_MO_SVY_INITCURMEDICDRecord();
		...
		while(rset5.next()){
			SS_L_MO_SVY_INITCURSUBSCNFMSTATCDRecord rec = new SS_L_MO_SVY_INITCURSUBSCNFMSTATCDRecord();
		...
		while(rset6.next()){
			SS_L_MO_SVY_INITCURAPLCPATHCDRecord rec = new SS_L_MO_SVY_INITCURAPLCPATHCDRecord();
	...
	public String teamlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_MO_SVY_INITTEAMLISTRecord rec = (SS_L_MO_SVY_INITTEAMLISTRecord)teamlist.get(i);
	...
	public String partlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_MO_SVY_INITPARTLISTRecord rec = (SS_L_MO_SVY_INITPARTLISTRecord)partlist.get(i);
	...
	public String arealistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_MO_SVY_INITAREALISTRecord rec = (SS_L_MO_SVY_INITAREALISTRecord)arealist.get(i);
	...
	public String curextntypecdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_MO_SVY_INITCUREXTNTYPECDRecord rec = (SS_L_MO_SVY_INITCUREXTNTYPECDRecord)curextntypecd.get(i);
	...
	public String curmedicdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_MO_SVY_INITCURMEDICDRecord rec = (SS_L_MO_SVY_INITCURMEDICDRecord)curmedicd.get(i);
	...
	public String cursubscnfmstatcdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_MO_SVY_INITCURSUBSCNFMSTATCDRecord rec = (SS_L_MO_SVY_INITCURSUBSCNFMSTATCDRecord)cursubscnfmstatcd.get(i);
	...
	public String curaplcpathcdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_MO_SVY_INITCURAPLCPATHCDRecord rec = (SS_L_MO_SVY_INITCURAPLCPATHCDRecord)curaplcpathcd.get(i);
...
<%
	for(int i=0; i<ds.teamlist.size(); i++){
		SS_L_MO_SVY_INITTEAMLISTRecord teamlistRec = (SS_L_MO_SVY_INITTEAMLISTRecord)ds.teamlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.partlist.size(); i++){
		SS_L_MO_SVY_INITPARTLISTRecord partlistRec = (SS_L_MO_SVY_INITPARTLISTRecord)ds.partlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.arealist.size(); i++){
		SS_L_MO_SVY_INITAREALISTRecord arealistRec = (SS_L_MO_SVY_INITAREALISTRecord)ds.arealist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curextntypecd.size(); i++){
		SS_L_MO_SVY_INITCUREXTNTYPECDRecord curextntypecdRec = (SS_L_MO_SVY_INITCUREXTNTYPECDRecord)ds.curextntypecd.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curmedicd.size(); i++){
		SS_L_MO_SVY_INITCURMEDICDRecord curmedicdRec = (SS_L_MO_SVY_INITCURMEDICDRecord)ds.curmedicd.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.cursubscnfmstatcd.size(); i++){
		SS_L_MO_SVY_INITCURSUBSCNFMSTATCDRecord cursubscnfmstatcdRec = (SS_L_MO_SVY_INITCURSUBSCNFMSTATCDRecord)ds.cursubscnfmstatcd.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curaplcpathcd.size(); i++){
		SS_L_MO_SVY_INITCURAPLCPATHCDRecord curaplcpathcdRec = (SS_L_MO_SVY_INITCURAPLCPATHCDRecord)ds.curaplcpathcd.get(i);%>
HTML 코드들....
	<%}%>
