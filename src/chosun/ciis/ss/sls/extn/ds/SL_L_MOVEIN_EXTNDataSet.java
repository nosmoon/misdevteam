...
public class SL_L_MOVEIN_EXTNDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SL_L_MOVEIN_EXTNDataSet(){}
	public SL_L_MOVEIN_EXTNDataSet(String errcode, String errmsg, long totalcnt, long subscnt, long realcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SL_L_MOVEIN_EXTNCUREXTNLISTRecord rec = new SL_L_MOVEIN_EXTNCUREXTNLISTRecord();
		...
		this.subscnt = cstmt.getLong(16);
		this.realcnt = cstmt.getLong(17);
	}
	...
	public String curextnlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SL_L_MOVEIN_EXTNCUREXTNLISTRecord rec = (SL_L_MOVEIN_EXTNCUREXTNLISTRecord)curextnlist.get(i);
...
<%
	for(int i=0; i<ds.curextnlist.size(); i++){
		SL_L_MOVEIN_EXTNCUREXTNLISTRecord curextnlistRec = (SL_L_MOVEIN_EXTNCUREXTNLISTRecord)ds.curextnlist.get(i);%>
HTML 코드들....
	<%}%>
