...
public class SS_SLS_EXTN_4210_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curcommlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SS_SLS_EXTN_4210_LDataSet(){}
	public SS_SLS_EXTN_4210_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_SLS_EXTN_4210_LCURCOMMLISTRecord rec = new SS_SLS_EXTN_4210_LCURCOMMLISTRecord();
...
<%
	SS_SLS_EXTN_4210_LDataSet ds = (SS_SLS_EXTN_4210_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curcommlist.size(); i++){
		SS_SLS_EXTN_4210_LCURCOMMLISTRecord curcommlistRec = (SS_SLS_EXTN_4210_LCURCOMMLISTRecord)ds.curcommlist.get(i);%>
HTML 코드들....
	<%}%>
