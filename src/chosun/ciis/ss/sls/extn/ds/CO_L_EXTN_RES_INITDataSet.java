...
public class CO_L_EXTN_RES_INITDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public CO_L_EXTN_RES_INITDataSet(){}
	public CO_L_EXTN_RES_INITDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			CO_L_EXTN_RES_INITTEAMLISTRecord rec = new CO_L_EXTN_RES_INITTEAMLISTRecord();
		...
		while(rset1.next()){
			CO_L_EXTN_RES_INITPARTLISTRecord rec = new CO_L_EXTN_RES_INITPARTLISTRecord();
		...
		while(rset2.next()){
			CO_L_EXTN_RES_INITAREALISTRecord rec = new CO_L_EXTN_RES_INITAREALISTRecord();
		...
		while(rset3.next()){
			CO_L_EXTN_RES_INITMEDICDCURRecord rec = new CO_L_EXTN_RES_INITMEDICDCURRecord();
		...
		while(rset4.next()){
			CO_L_EXTN_RES_INITEXTNTYPECDCURRecord rec = new CO_L_EXTN_RES_INITEXTNTYPECDCURRecord();
		...
		while(rset5.next()){
			CO_L_EXTN_RES_INITCNS_EMPCNFMSTATCDCURRecord rec = new CO_L_EXTN_RES_INITCNS_EMPCNFMSTATCDCURRecord();
		...
		while(rset6.next()){
			CO_L_EXTN_RES_INITCNS_EMPCNFMOCOMCDCURRecord rec = new CO_L_EXTN_RES_INITCNS_EMPCNFMOCOMCDCURRecord();
		...
		while(rset7.next()){
			CO_L_EXTN_RES_INITCHRG_CNFMSTATCDCURRecord rec = new CO_L_EXTN_RES_INITCHRG_CNFMSTATCDCURRecord();
		...
		while(rset8.next()){
			CO_L_EXTN_RES_INITCHRG_CNFMOCOMCDCURRecord rec = new CO_L_EXTN_RES_INITCHRG_CNFMOCOMCDCURRecord();
		...
		while(rset9.next()){
			CO_L_EXTN_RES_INITDSTCINFOCURRecord rec = new CO_L_EXTN_RES_INITDSTCINFOCURRecord();
		...
		while(rset10.next()){
			CO_L_EXTN_RES_INITADDRCDCURRecord rec = new CO_L_EXTN_RES_INITADDRCDCURRecord();
		...
		while(rset11.next()){
			CO_L_EXTN_RES_INITPATY_CLSFCDCURRecord rec = new CO_L_EXTN_RES_INITPATY_CLSFCDCURRecord();
		...
		while(rset12.next()){
			CO_L_EXTN_RES_INITRESITYPECDCURRecord rec = new CO_L_EXTN_RES_INITRESITYPECDCURRecord();
		...
		while(rset13.next()){
			CO_L_EXTN_RES_INITRESICLSFCDCURRecord rec = new CO_L_EXTN_RES_INITRESICLSFCDCURRecord();
		...
		while(rset14.next()){
			CO_L_EXTN_RES_INITDLVMTHDCDCURRecord rec = new CO_L_EXTN_RES_INITDLVMTHDCDCURRecord();
		...
		while(rset15.next()){
			CO_L_EXTN_RES_INITTHRWPLACCDCURRecord rec = new CO_L_EXTN_RES_INITTHRWPLACCDCURRecord();
		...
		while(rset16.next()){
			CO_L_EXTN_RES_INITCLAMTMTHDCDCURRecord rec = new CO_L_EXTN_RES_INITCLAMTMTHDCDCURRecord();
		...
		while(rset17.next()){
			CO_L_EXTN_RES_INITFREECLSFCDCURRecord rec = new CO_L_EXTN_RES_INITFREECLSFCDCURRecord();
		...
		while(rset18.next()){
			CO_L_EXTN_RES_INITAPLCPATHCDCURRecord rec = new CO_L_EXTN_RES_INITAPLCPATHCDCURRecord();
	...
	public String teamlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITTEAMLISTRecord rec = (CO_L_EXTN_RES_INITTEAMLISTRecord)teamlist.get(i);
	...
	public String partlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITPARTLISTRecord rec = (CO_L_EXTN_RES_INITPARTLISTRecord)partlist.get(i);
	...
	public String arealistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITAREALISTRecord rec = (CO_L_EXTN_RES_INITAREALISTRecord)arealist.get(i);
	...
	public String medicdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITMEDICDCURRecord rec = (CO_L_EXTN_RES_INITMEDICDCURRecord)medicdcur.get(i);
	...
	public String extntypecdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITEXTNTYPECDCURRecord rec = (CO_L_EXTN_RES_INITEXTNTYPECDCURRecord)extntypecdcur.get(i);
	...
	public String cns_empcnfmstatcdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITCNS_EMPCNFMSTATCDCURRecord rec = (CO_L_EXTN_RES_INITCNS_EMPCNFMSTATCDCURRecord)cns_empcnfmstatcdcur.get(i);
	...
	public String cns_empcnfmocomcdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITCNS_EMPCNFMOCOMCDCURRecord rec = (CO_L_EXTN_RES_INITCNS_EMPCNFMOCOMCDCURRecord)cns_empcnfmocomcdcur.get(i);
	...
	public String chrg_cnfmstatcdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITCHRG_CNFMSTATCDCURRecord rec = (CO_L_EXTN_RES_INITCHRG_CNFMSTATCDCURRecord)chrg_cnfmstatcdcur.get(i);
	...
	public String chrg_cnfmocomcdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITCHRG_CNFMOCOMCDCURRecord rec = (CO_L_EXTN_RES_INITCHRG_CNFMOCOMCDCURRecord)chrg_cnfmocomcdcur.get(i);
	...
	public String dstcinfocurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITDSTCINFOCURRecord rec = (CO_L_EXTN_RES_INITDSTCINFOCURRecord)dstcinfocur.get(i);
	...
	public String addrcdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITADDRCDCURRecord rec = (CO_L_EXTN_RES_INITADDRCDCURRecord)addrcdcur.get(i);
	...
	public String paty_clsfcdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITPATY_CLSFCDCURRecord rec = (CO_L_EXTN_RES_INITPATY_CLSFCDCURRecord)paty_clsfcdcur.get(i);
	...
	public String resitypecdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITRESITYPECDCURRecord rec = (CO_L_EXTN_RES_INITRESITYPECDCURRecord)resitypecdcur.get(i);
	...
	public String resiclsfcdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITRESICLSFCDCURRecord rec = (CO_L_EXTN_RES_INITRESICLSFCDCURRecord)resiclsfcdcur.get(i);
	...
	public String dlvmthdcdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITDLVMTHDCDCURRecord rec = (CO_L_EXTN_RES_INITDLVMTHDCDCURRecord)dlvmthdcdcur.get(i);
	...
	public String thrwplaccdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITTHRWPLACCDCURRecord rec = (CO_L_EXTN_RES_INITTHRWPLACCDCURRecord)thrwplaccdcur.get(i);
	...
	public String clamtmthdcdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITCLAMTMTHDCDCURRecord rec = (CO_L_EXTN_RES_INITCLAMTMTHDCDCURRecord)clamtmthdcdcur.get(i);
	...
	public String freeclsfcdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITFREECLSFCDCURRecord rec = (CO_L_EXTN_RES_INITFREECLSFCDCURRecord)freeclsfcdcur.get(i);
	...
	public String aplcpathcdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			CO_L_EXTN_RES_INITAPLCPATHCDCURRecord rec = (CO_L_EXTN_RES_INITAPLCPATHCDCURRecord)aplcpathcdcur.get(i);
...
<%
	CO_L_EXTN_RES_INITDataSet ds = (CO_L_EXTN_RES_INITDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.teamlist.size(); i++){
		CO_L_EXTN_RES_INITTEAMLISTRecord teamlistRec = (CO_L_EXTN_RES_INITTEAMLISTRecord)ds.teamlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.partlist.size(); i++){
		CO_L_EXTN_RES_INITPARTLISTRecord partlistRec = (CO_L_EXTN_RES_INITPARTLISTRecord)ds.partlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.arealist.size(); i++){
		CO_L_EXTN_RES_INITAREALISTRecord arealistRec = (CO_L_EXTN_RES_INITAREALISTRecord)ds.arealist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.medicdcur.size(); i++){
		CO_L_EXTN_RES_INITMEDICDCURRecord medicdcurRec = (CO_L_EXTN_RES_INITMEDICDCURRecord)ds.medicdcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.extntypecdcur.size(); i++){
		CO_L_EXTN_RES_INITEXTNTYPECDCURRecord extntypecdcurRec = (CO_L_EXTN_RES_INITEXTNTYPECDCURRecord)ds.extntypecdcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.cns_empcnfmstatcdcur.size(); i++){
		CO_L_EXTN_RES_INITCNS_EMPCNFMSTATCDCURRecord cns_empcnfmstatcdcurRec = (CO_L_EXTN_RES_INITCNS_EMPCNFMSTATCDCURRecord)ds.cns_empcnfmstatcdcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.cns_empcnfmocomcdcur.size(); i++){
		CO_L_EXTN_RES_INITCNS_EMPCNFMOCOMCDCURRecord cns_empcnfmocomcdcurRec = (CO_L_EXTN_RES_INITCNS_EMPCNFMOCOMCDCURRecord)ds.cns_empcnfmocomcdcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.chrg_cnfmstatcdcur.size(); i++){
		CO_L_EXTN_RES_INITCHRG_CNFMSTATCDCURRecord chrg_cnfmstatcdcurRec = (CO_L_EXTN_RES_INITCHRG_CNFMSTATCDCURRecord)ds.chrg_cnfmstatcdcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.chrg_cnfmocomcdcur.size(); i++){
		CO_L_EXTN_RES_INITCHRG_CNFMOCOMCDCURRecord chrg_cnfmocomcdcurRec = (CO_L_EXTN_RES_INITCHRG_CNFMOCOMCDCURRecord)ds.chrg_cnfmocomcdcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.dstcinfocur.size(); i++){
		CO_L_EXTN_RES_INITDSTCINFOCURRecord dstcinfocurRec = (CO_L_EXTN_RES_INITDSTCINFOCURRecord)ds.dstcinfocur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.addrcdcur.size(); i++){
		CO_L_EXTN_RES_INITADDRCDCURRecord addrcdcurRec = (CO_L_EXTN_RES_INITADDRCDCURRecord)ds.addrcdcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.paty_clsfcdcur.size(); i++){
		CO_L_EXTN_RES_INITPATY_CLSFCDCURRecord paty_clsfcdcurRec = (CO_L_EXTN_RES_INITPATY_CLSFCDCURRecord)ds.paty_clsfcdcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.resitypecdcur.size(); i++){
		CO_L_EXTN_RES_INITRESITYPECDCURRecord resitypecdcurRec = (CO_L_EXTN_RES_INITRESITYPECDCURRecord)ds.resitypecdcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.resiclsfcdcur.size(); i++){
		CO_L_EXTN_RES_INITRESICLSFCDCURRecord resiclsfcdcurRec = (CO_L_EXTN_RES_INITRESICLSFCDCURRecord)ds.resiclsfcdcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.dlvmthdcdcur.size(); i++){
		CO_L_EXTN_RES_INITDLVMTHDCDCURRecord dlvmthdcdcurRec = (CO_L_EXTN_RES_INITDLVMTHDCDCURRecord)ds.dlvmthdcdcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.thrwplaccdcur.size(); i++){
		CO_L_EXTN_RES_INITTHRWPLACCDCURRecord thrwplaccdcurRec = (CO_L_EXTN_RES_INITTHRWPLACCDCURRecord)ds.thrwplaccdcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.clamtmthdcdcur.size(); i++){
		CO_L_EXTN_RES_INITCLAMTMTHDCDCURRecord clamtmthdcdcurRec = (CO_L_EXTN_RES_INITCLAMTMTHDCDCURRecord)ds.clamtmthdcdcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.freeclsfcdcur.size(); i++){
		CO_L_EXTN_RES_INITFREECLSFCDCURRecord freeclsfcdcurRec = (CO_L_EXTN_RES_INITFREECLSFCDCURRecord)ds.freeclsfcdcur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.aplcpathcdcur.size(); i++){
		CO_L_EXTN_RES_INITAPLCPATHCDCURRecord aplcpathcdcurRec = (CO_L_EXTN_RES_INITAPLCPATHCDCURRecord)ds.aplcpathcdcur.get(i);%>
HTML 코드들....
	<%}%>
