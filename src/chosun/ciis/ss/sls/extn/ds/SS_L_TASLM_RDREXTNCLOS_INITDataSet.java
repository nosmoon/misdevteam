...
public class SS_L_TASLM_RDREXTNCLOS_INITDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_L_TASLM_RDREXTNCLOS_INITDataSet(){}
	public SS_L_TASLM_RDREXTNCLOS_INITDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_L_TASLM_RDREXTNCLOS_INITAPLCPATHRecord rec = new SS_L_TASLM_RDREXTNCLOS_INITAPLCPATHRecord();
		...
		while(rset1.next()){
			SS_L_TASLM_RDREXTNCLOS_INITCURTYPE1Record rec = new SS_L_TASLM_RDREXTNCLOS_INITCURTYPE1Record();
		...
		while(rset2.next()){
			SS_L_TASLM_RDREXTNCLOS_INITCURTYPE2Record rec = new SS_L_TASLM_RDREXTNCLOS_INITCURTYPE2Record();
		...
		while(rset3.next()){
			SS_L_TASLM_RDREXTNCLOS_INITCURRESITYPERecord rec = new SS_L_TASLM_RDREXTNCLOS_INITCURRESITYPERecord();
		...
		while(rset4.next()){
			SS_L_TASLM_RDREXTNCLOS_INITTEAMLISTRecord rec = new SS_L_TASLM_RDREXTNCLOS_INITTEAMLISTRecord();
		...
		while(rset5.next()){
			SS_L_TASLM_RDREXTNCLOS_INITPARTLISTRecord rec = new SS_L_TASLM_RDREXTNCLOS_INITPARTLISTRecord();
		...
		while(rset6.next()){
			SS_L_TASLM_RDREXTNCLOS_INITAREALISTRecord rec = new SS_L_TASLM_RDREXTNCLOS_INITAREALISTRecord();
	...
	public String aplcpathOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_TASLM_RDREXTNCLOS_INITAPLCPATHRecord rec = (SS_L_TASLM_RDREXTNCLOS_INITAPLCPATHRecord)aplcpath.get(i);
	...
	public String curtype1OptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_TASLM_RDREXTNCLOS_INITCURTYPE1Record rec = (SS_L_TASLM_RDREXTNCLOS_INITCURTYPE1Record)curtype1.get(i);
	...
	public String curtype2OptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_TASLM_RDREXTNCLOS_INITCURTYPE2Record rec = (SS_L_TASLM_RDREXTNCLOS_INITCURTYPE2Record)curtype2.get(i);
	...
	public String curresitypeOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_TASLM_RDREXTNCLOS_INITCURRESITYPERecord rec = (SS_L_TASLM_RDREXTNCLOS_INITCURRESITYPERecord)curresitype.get(i);
	...
	public String teamlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_TASLM_RDREXTNCLOS_INITTEAMLISTRecord rec = (SS_L_TASLM_RDREXTNCLOS_INITTEAMLISTRecord)teamlist.get(i);
	...
	public String partlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_TASLM_RDREXTNCLOS_INITPARTLISTRecord rec = (SS_L_TASLM_RDREXTNCLOS_INITPARTLISTRecord)partlist.get(i);
	...
	public String arealistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_TASLM_RDREXTNCLOS_INITAREALISTRecord rec = (SS_L_TASLM_RDREXTNCLOS_INITAREALISTRecord)arealist.get(i);
...
<%
	SS_L_TASLM_RDREXTNCLOS_INITDataSet ds = (SS_L_TASLM_RDREXTNCLOS_INITDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.aplcpath.size(); i++){
		SS_L_TASLM_RDREXTNCLOS_INITAPLCPATHRecord aplcpathRec = (SS_L_TASLM_RDREXTNCLOS_INITAPLCPATHRecord)ds.aplcpath.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curtype1.size(); i++){
		SS_L_TASLM_RDREXTNCLOS_INITCURTYPE1Record curtype1Rec = (SS_L_TASLM_RDREXTNCLOS_INITCURTYPE1Record)ds.curtype1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curtype2.size(); i++){
		SS_L_TASLM_RDREXTNCLOS_INITCURTYPE2Record curtype2Rec = (SS_L_TASLM_RDREXTNCLOS_INITCURTYPE2Record)ds.curtype2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curresitype.size(); i++){
		SS_L_TASLM_RDREXTNCLOS_INITCURRESITYPERecord curresitypeRec = (SS_L_TASLM_RDREXTNCLOS_INITCURRESITYPERecord)ds.curresitype.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.teamlist.size(); i++){
		SS_L_TASLM_RDREXTNCLOS_INITTEAMLISTRecord teamlistRec = (SS_L_TASLM_RDREXTNCLOS_INITTEAMLISTRecord)ds.teamlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.partlist.size(); i++){
		SS_L_TASLM_RDREXTNCLOS_INITPARTLISTRecord partlistRec = (SS_L_TASLM_RDREXTNCLOS_INITPARTLISTRecord)ds.partlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.arealist.size(); i++){
		SS_L_TASLM_RDREXTNCLOS_INITAREALISTRecord arealistRec = (SS_L_TASLM_RDREXTNCLOS_INITAREALISTRecord)ds.arealist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Wed Aug 26 17:39:53 KST 2009 */