...
/**
 * 지국경영-입주아파트현황-입주아파트조회
 */

public class SL_L_MOVEIN_APTDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curaptlist = new ArrayList();
	public String errcode;
	public String errmsg;
	public long totalcnt;

	public SL_L_MOVEIN_APTDataSet(){}
	public SL_L_MOVEIN_APTDataSet(String errcode, String errmsg, long totalcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SL_L_MOVEIN_APTCURAPTLISTRecord rec = new SL_L_MOVEIN_APTCURAPTLISTRecord();
	...
	public String curaptlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SL_L_MOVEIN_APTCURAPTLISTRecord rec = (SL_L_MOVEIN_APTCURAPTLISTRecord)curaptlist.get(i);
...
<%
	for(int i=0; i<ds.curaptlist.size(); i++){
		SL_L_MOVEIN_APTCURAPTLISTRecord curaptlistRec = (SL_L_MOVEIN_APTCURAPTLISTRecord)ds.curaptlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Fri Apr 03 14:59:53 KST 2009 */