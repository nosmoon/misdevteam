...
public class SS_SLS_EXTN_4830_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curmodlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SS_SLS_EXTN_4830_LDataSet(){}
	public SS_SLS_EXTN_4830_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_SLS_EXTN_4830_LCURMODLISTRecord rec = new SS_SLS_EXTN_4830_LCURMODLISTRecord();
...
<%
	for(int i=0; i<ds.curmodlist.size(); i++){
		SS_SLS_EXTN_4830_LCURMODLISTRecord curmodlistRec = (SS_SLS_EXTN_4830_LCURMODLISTRecord)ds.curmodlist.get(i);%>
HTML 코드들....
	<%}%>
