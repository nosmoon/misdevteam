/***************************************************************************************************
* 파일명 : SS_L_RDR_EXTN_STAFCYB_RSLTDDataSet.java
...
public class SS_L_RDR_EXTN_STAFCYB_RSLTDDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_L_RDR_EXTN_STAFCYB_RSLTDDataSet(){}
	public SS_L_RDR_EXTN_STAFCYB_RSLTDDataSet(String errcode, String errmsg, long nocnfmtotalcnt, long errtotalcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_L_RDR_EXTN_STAFCYB_RSLTDNOCNFMLISTRecord rec = new SS_L_RDR_EXTN_STAFCYB_RSLTDNOCNFMLISTRecord();
		...
		while(rset1.next()){
			SS_L_RDR_EXTN_STAFCYB_RSLTDERRLISTRecord rec = new SS_L_RDR_EXTN_STAFCYB_RSLTDERRLISTRecord();
	...
	public String nocnfmlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_RDR_EXTN_STAFCYB_RSLTDNOCNFMLISTRecord rec = (SS_L_RDR_EXTN_STAFCYB_RSLTDNOCNFMLISTRecord)nocnfmlist.get(i);
	...
	public String errlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_RDR_EXTN_STAFCYB_RSLTDERRLISTRecord rec = (SS_L_RDR_EXTN_STAFCYB_RSLTDERRLISTRecord)errlist.get(i);
