...
public class SS_SLS_EXTN_4410_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curcommlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SS_SLS_EXTN_4410_LDataSet(){}
	public SS_SLS_EXTN_4410_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_SLS_EXTN_4410_LCURCOMMLISTRecord rec = new SS_SLS_EXTN_4410_LCURCOMMLISTRecord();
			rec.deptnm = Util.checkString(rset0.getString("deptnm"));
			rec.partnm = Util.checkString(rset0.getString("partnm"));
			rec.areanm = Util.checkString(rset0.getString("areanm"));
			rec.bonm = Util.checkString(rset0.getString("bonm"));
			rec.dup_gb = Util.checkString(rset0.getString("dup_gb"));
...
<%
	for(int i=0; i<ds.curcommlist.size(); i++){
		SS_SLS_EXTN_4410_LCURCOMMLISTRecord curcommlistRec = (SS_SLS_EXTN_4410_LCURCOMMLISTRecord)ds.curcommlist.get(i);%>
HTML 코드들....
	<%}%>
