...
public class SS_SLS_EXTN_5601_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList userlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SS_SLS_EXTN_5601_LDataSet(){}
	public SS_SLS_EXTN_5601_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_SLS_EXTN_5601_LUSERLISTRecord rec = new SS_SLS_EXTN_5601_LUSERLISTRecord();
...
<%
	for(int i=0; i<ds.userlist.size(); i++){
		SS_SLS_EXTN_5601_LUSERLISTRecord userlistRec = (SS_SLS_EXTN_5601_LUSERLISTRecord)ds.userlist.get(i);%>
HTML 코드들....
	<%}%>
