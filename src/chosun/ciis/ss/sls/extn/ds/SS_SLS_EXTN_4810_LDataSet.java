...
public class SS_SLS_EXTN_4810_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_SLS_EXTN_4810_LDataSet(){}
	public SS_SLS_EXTN_4810_LDataSet(String errcode, String errmsg, String closyn, String closdt, String paydt, String cnfm_qty, String cnfm_amt, String nocnfm_qty, String nocnfm_amt, String meda_amt, String set_amt, String pay_amt, String nopay_amt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_SLS_EXTN_4810_LCURMODLISTRecord rec = new SS_SLS_EXTN_4810_LCURMODLISTRecord();
...
<%
	for(int i=0; i<ds.curmodlist.size(); i++){
		SS_SLS_EXTN_4810_LCURMODLISTRecord curmodlistRec = (SS_SLS_EXTN_4810_LCURMODLISTRecord)ds.curmodlist.get(i);%>
HTML 코드들....
	<%}%>
