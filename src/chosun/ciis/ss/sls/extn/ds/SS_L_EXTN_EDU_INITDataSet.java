...
public class SS_L_EXTN_EDU_INITDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_L_EXTN_EDU_INITDataSet(){}
	public SS_L_EXTN_EDU_INITDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_L_EXTN_EDU_INITTEAMLISTRecord rec = new SS_L_EXTN_EDU_INITTEAMLISTRecord();
		...
		while(rset1.next()){
			SS_L_EXTN_EDU_INITPARTLISTRecord rec = new SS_L_EXTN_EDU_INITPARTLISTRecord();
		...
		while(rset2.next()){
			SS_L_EXTN_EDU_INITAREALISTRecord rec = new SS_L_EXTN_EDU_INITAREALISTRecord();
		...
		while(rset3.next()){
			SS_L_EXTN_EDU_INITCUREXTNTYPECDRecord rec = new SS_L_EXTN_EDU_INITCUREXTNTYPECDRecord();
		...
		while(rset4.next()){
			SS_L_EXTN_EDU_INITCURMEDICDRecord rec = new SS_L_EXTN_EDU_INITCURMEDICDRecord();
		...
		while(rset5.next()){
			SS_L_EXTN_EDU_INITCURSUBSCNFMSTATCDRecord rec = new SS_L_EXTN_EDU_INITCURSUBSCNFMSTATCDRecord();
		...
		while(rset6.next()){
			SS_L_EXTN_EDU_INITCURAPLCPATHCDRecord rec = new SS_L_EXTN_EDU_INITCURAPLCPATHCDRecord();
		...
		while(rset7.next()){
			SS_L_EXTN_EDU_INITCUREDUCDRecord rec = new SS_L_EXTN_EDU_INITCUREDUCDRecord();
		...
		while(rset8.next()){
			SS_L_EXTN_EDU_INITCURJEHUCDRecord rec = new SS_L_EXTN_EDU_INITCURJEHUCDRecord();
	...
	public String teamlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_EXTN_EDU_INITTEAMLISTRecord rec = (SS_L_EXTN_EDU_INITTEAMLISTRecord)teamlist.get(i);
	...
	public String partlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_EXTN_EDU_INITPARTLISTRecord rec = (SS_L_EXTN_EDU_INITPARTLISTRecord)partlist.get(i);
	...
	public String arealistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_EXTN_EDU_INITAREALISTRecord rec = (SS_L_EXTN_EDU_INITAREALISTRecord)arealist.get(i);
	...
	public String curextntypecdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_EXTN_EDU_INITCUREXTNTYPECDRecord rec = (SS_L_EXTN_EDU_INITCUREXTNTYPECDRecord)curextntypecd.get(i);
	...
	public String curmedicdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_EXTN_EDU_INITCURMEDICDRecord rec = (SS_L_EXTN_EDU_INITCURMEDICDRecord)curmedicd.get(i);
	...
	public String cursubscnfmstatcdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_EXTN_EDU_INITCURSUBSCNFMSTATCDRecord rec = (SS_L_EXTN_EDU_INITCURSUBSCNFMSTATCDRecord)cursubscnfmstatcd.get(i);
	...
	public String curaplcpathcdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_EXTN_EDU_INITCURAPLCPATHCDRecord rec = (SS_L_EXTN_EDU_INITCURAPLCPATHCDRecord)curaplcpathcd.get(i);
	...
	public String cureducdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_EXTN_EDU_INITCUREDUCDRecord rec = (SS_L_EXTN_EDU_INITCUREDUCDRecord)cureducd.get(i);
	...
	public String curjehucdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_EXTN_EDU_INITCURJEHUCDRecord rec = (SS_L_EXTN_EDU_INITCURJEHUCDRecord)curjehucd.get(i);
...
<%
	for(int i=0; i<ds.teamlist.size(); i++){
		SS_L_EXTN_EDU_INITTEAMLISTRecord teamlistRec = (SS_L_EXTN_EDU_INITTEAMLISTRecord)ds.teamlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.partlist.size(); i++){
		SS_L_EXTN_EDU_INITPARTLISTRecord partlistRec = (SS_L_EXTN_EDU_INITPARTLISTRecord)ds.partlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.arealist.size(); i++){
		SS_L_EXTN_EDU_INITAREALISTRecord arealistRec = (SS_L_EXTN_EDU_INITAREALISTRecord)ds.arealist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curextntypecd.size(); i++){
		SS_L_EXTN_EDU_INITCUREXTNTYPECDRecord curextntypecdRec = (SS_L_EXTN_EDU_INITCUREXTNTYPECDRecord)ds.curextntypecd.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curmedicd.size(); i++){
		SS_L_EXTN_EDU_INITCURMEDICDRecord curmedicdRec = (SS_L_EXTN_EDU_INITCURMEDICDRecord)ds.curmedicd.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.cursubscnfmstatcd.size(); i++){
		SS_L_EXTN_EDU_INITCURSUBSCNFMSTATCDRecord cursubscnfmstatcdRec = (SS_L_EXTN_EDU_INITCURSUBSCNFMSTATCDRecord)ds.cursubscnfmstatcd.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curaplcpathcd.size(); i++){
		SS_L_EXTN_EDU_INITCURAPLCPATHCDRecord curaplcpathcdRec = (SS_L_EXTN_EDU_INITCURAPLCPATHCDRecord)ds.curaplcpathcd.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.cureducd.size(); i++){
		SS_L_EXTN_EDU_INITCUREDUCDRecord cureducdRec = (SS_L_EXTN_EDU_INITCUREDUCDRecord)ds.cureducd.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curjehucd.size(); i++){
		SS_L_EXTN_EDU_INITCURJEHUCDRecord curjehucdRec = (SS_L_EXTN_EDU_INITCURJEHUCDRecord)ds.curjehucd.get(i);%>
HTML 코드들....
	<%}%>
