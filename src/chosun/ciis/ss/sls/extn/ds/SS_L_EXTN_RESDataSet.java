...
public class SS_L_EXTN_RESDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_L_EXTN_RESDataSet(){}
	public SS_L_EXTN_RESDataSet(String errcode, String errmsg, long chrg_cnfm_cnt, long cns_empcnfm, long totalcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_L_EXTN_RESCURCOMMLISTRecord rec = new SS_L_EXTN_RESCURCOMMLISTRecord();
	...
	public String curcommlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_EXTN_RESCURCOMMLISTRecord rec = (SS_L_EXTN_RESCURCOMMLISTRecord)curcommlist.get(i);
