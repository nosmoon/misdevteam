...
public class SL_L_EXTNCLOS_JM_REPORTDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SL_L_EXTNCLOS_JM_REPORTDataSet(){}
	public SL_L_EXTNCLOS_JM_REPORTDataSet(String errcode, String errmsg, long tota1, long tota2, long tota3, long totasum, long totb1, long totb2, long totb3, long totbsum, long totc1, long totc2, long totc3, long totcsum){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SL_L_EXTNCLOS_JM_REPORTCURSUMLISTRecord rec = new SL_L_EXTNCLOS_JM_REPORTCURSUMLISTRecord();
...
<%
	SL_L_EXTNCLOS_JM_REPORTDataSet ds = (SL_L_EXTNCLOS_JM_REPORTDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.cursumlist.size(); i++){
		SL_L_EXTNCLOS_JM_REPORTCURSUMLISTRecord cursumlistRec = (SL_L_EXTNCLOS_JM_REPORTCURSUMLISTRecord)ds.cursumlist.get(i);%>
HTML 코드들....
	<%}%>
