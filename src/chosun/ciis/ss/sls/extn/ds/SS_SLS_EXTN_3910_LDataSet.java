...
public class SS_SLS_EXTN_3910_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curcommlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SS_SLS_EXTN_3910_LDataSet(){}
	public SS_SLS_EXTN_3910_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_SLS_EXTN_3910_LCURCOMMLISTRecord rec = new SS_SLS_EXTN_3910_LCURCOMMLISTRecord();
...
<%
	for(int i=0; i<ds.curcommlist.size(); i++){
		SS_SLS_EXTN_3910_LCURCOMMLISTRecord curcommlistRec = (SS_SLS_EXTN_3910_LCURCOMMLISTRecord)ds.curcommlist.get(i);%>
HTML 코드들....
	<%}%>
