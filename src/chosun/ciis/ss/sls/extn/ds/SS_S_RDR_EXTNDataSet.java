...
public class SS_S_RDR_EXTNDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.rdr_extndt = Util.checkString(cstmt.getString(11));
		this.rdr_extnno = Util.checkString(cstmt.getString(12));
		this.rdr_no = Util.checkString(cstmt.getString(13));
		this.medicd = Util.checkString(cstmt.getString(14));
		this.cntrno = Util.checkString(cstmt.getString(15));
		this.mangno = Util.checkString(cstmt.getString(16));
		this.medicdnm = Util.checkString(cstmt.getString(17));
		this.aplcdt = Util.checkString(cstmt.getString(18));
		this.qty = cstmt.getLong(19);
		this.aplcpathnm = Util.checkString(cstmt.getString(20));
		this.rdr_extntypecd = Util.checkString(cstmt.getString(21));
		this.rdr_extntypecdnm = Util.checkString(cstmt.getString(22));
		this.extnblngcd = Util.checkString(cstmt.getString(23));
		this.extnblngcdnm = Util.checkString(cstmt.getString(24));
		this.empclsfcdnm = Util.checkString(cstmt.getString(25));
		this.empdeptnm = Util.checkString(cstmt.getString(26));
		this.empseq = Util.checkString(cstmt.getString(27));
		this.bodutycdnm = Util.checkString(cstmt.getString(28));
		this.boposicdnm = Util.checkString(cstmt.getString(29));
		this.stafclsfcdnm = Util.checkString(cstmt.getString(30));
		this.stafno = Util.checkString(cstmt.getString(31));
		this.rdr_extnbocdnm = Util.checkString(cstmt.getString(32));
		this.boemp_no = Util.checkString(cstmt.getString(33));
		this.extnid = Util.checkString(cstmt.getString(34));
		this.extnflnm = Util.checkString(cstmt.getString(35));
		this.extntel1 = Util.checkString(cstmt.getString(36));
		this.extntel2 = Util.checkString(cstmt.getString(37));
		this.extntel3 = Util.checkString(cstmt.getString(38));
		this.extnptph_no1 = Util.checkString(cstmt.getString(39));
		this.extnptph_no2 = Util.checkString(cstmt.getString(40));
		this.extnptph_no3 = Util.checkString(cstmt.getString(41));
		this.extnprn = Util.checkString(cstmt.getString(42));
		this.prvsubsmedicd = Util.checkString(cstmt.getString(43));
		this.rshpclsfcd = Util.checkString(cstmt.getString(44));
		this.rshpclsfcdnm = Util.checkString(cstmt.getString(45));
		this.aplcpersnm = Util.checkString(cstmt.getString(46));
		this.aplcpersemail = Util.checkString(cstmt.getString(47));
		this.aplcperstel_no1 = Util.checkString(cstmt.getString(48));
		this.aplcperstel_no2 = Util.checkString(cstmt.getString(49));
		this.aplcperstel_no3 = Util.checkString(cstmt.getString(50));
		this.aplcpersptph_no1 = Util.checkString(cstmt.getString(51));
		this.aplcpersptph_no2 = Util.checkString(cstmt.getString(52));
		this.aplcpersptph_no3 = Util.checkString(cstmt.getString(53));
		this.aplcpersremk = Util.checkString(cstmt.getString(54));
		this.post_dlvyn = Util.checkString(cstmt.getString(55));
		this.rdrnm = Util.checkString(cstmt.getString(56));
		this.rdrtel_no1 = Util.checkString(cstmt.getString(57));
		this.rdrtel_no2 = Util.checkString(cstmt.getString(58));
		this.rdrtel_no3 = Util.checkString(cstmt.getString(59));
		this.rdrptph_no1 = Util.checkString(cstmt.getString(60));
		this.rdrptph_no2 = Util.checkString(cstmt.getString(61));
		this.rdrptph_no3 = Util.checkString(cstmt.getString(62));
		this.rdremail = Util.checkString(cstmt.getString(63));
		this.dlvzip = Util.checkString(cstmt.getString(64));
		this.dlvaddr = Util.checkString(cstmt.getString(65));
		this.dlvdtlsaddr = Util.checkString(cstmt.getString(66));
		this.dlvhopedt = Util.checkString(cstmt.getString(67));
		this.pymtflnm = Util.checkString(cstmt.getString(68));
		this.pymttel_no1 = Util.checkString(cstmt.getString(69));
		this.pymttel_no2 = Util.checkString(cstmt.getString(70));
		this.pymttel_no3 = Util.checkString(cstmt.getString(71));
		this.pymtptph_no1 = Util.checkString(cstmt.getString(72));
		this.pymtptph_no2 = Util.checkString(cstmt.getString(73));
		this.pymtptph_no3 = Util.checkString(cstmt.getString(74));
		this.exstbocdnm = Util.checkString(cstmt.getString(75));
		this.corrbocdnm = Util.checkString(cstmt.getString(76));
		this.bo_tel_no11 = Util.checkString(cstmt.getString(77));
		this.bo_tel_no12 = Util.checkString(cstmt.getString(78));
		this.bo_tel_no13 = Util.checkString(cstmt.getString(79));
		this.extnbo_tel_no11 = Util.checkString(cstmt.getString(80));
		this.extnbo_tel_no12 = Util.checkString(cstmt.getString(81));
		this.extnbo_tel_no13 = Util.checkString(cstmt.getString(82));
		this.resiclsfcd = Util.checkString(cstmt.getString(83));
		this.resiclsfcdnm = Util.checkString(cstmt.getString(84));
		this.resitypecd = Util.checkString(cstmt.getString(85));
		this.resitypecdnm = Util.checkString(cstmt.getString(86));
		this.bo_headcnfmyn = Util.checkString(cstmt.getString(87));
		this.bo_headcnfmdt = cstmt.getTimestamp(88);
		this.lastdlvcnfmyn = Util.checkString(cstmt.getString(89));
		this.lastdlvcnfmdt = cstmt.getTimestamp(90);
		this.subscnfmstatcdnm = Util.checkString(cstmt.getString(91));
		this.cns_empcnfmstatnm = Util.checkString(cstmt.getString(92));
		this.cns_empid = Util.checkString(cstmt.getString(93));
		this.cns_empnm = Util.checkString(cstmt.getString(94));
		this.remk = Util.checkString(cstmt.getString(95));
		this.prcmsg = Util.checkString(cstmt.getString(96));
		this.aplcperszip = Util.checkString(cstmt.getString(97));
		this.aplcpersaddr = Util.checkString(cstmt.getString(98));
		this.aplcpersdtlsaddr = Util.checkString(cstmt.getString(99));
		this.corrbocd = Util.checkString(cstmt.getString(100));
		this.natnnm = Util.checkString(cstmt.getString(101));
		this.advtpathcd = Util.checkString(cstmt.getString(102));
		this.advtpathnm = Util.checkString(cstmt.getString(103));
		this.bldmngnn = Util.checkString(cstmt.getString(104));
	}
}/*----------------------------------------------------------------------------------------------------
...
/* 작성시간 : Thu Jul 23 17:26:19 KST 2015 */