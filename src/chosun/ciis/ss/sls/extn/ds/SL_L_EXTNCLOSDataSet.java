...
public class SL_L_EXTNCLOSDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SL_L_EXTNCLOSDataSet(){}
	public SL_L_EXTNCLOSDataSet(String errcode, String errmsg, long totalqty, long totalcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SL_L_EXTNCLOSCUREXTNCLOSLISTRecord rec = new SL_L_EXTNCLOSCUREXTNCLOSLISTRecord();
...
<%
	SL_L_EXTNCLOSDataSet ds = (SL_L_EXTNCLOSDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curextncloslist.size(); i++){
		SL_L_EXTNCLOSCUREXTNCLOSLISTRecord curextncloslistRec = (SL_L_EXTNCLOSCUREXTNCLOSLISTRecord)ds.curextncloslist.get(i);%>
HTML 코드들....
	<%}%>
