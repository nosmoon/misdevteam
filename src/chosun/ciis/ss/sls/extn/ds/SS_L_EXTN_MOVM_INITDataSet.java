...
public class SS_L_EXTN_MOVM_INITDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_L_EXTN_MOVM_INITDataSet(){}
	public SS_L_EXTN_MOVM_INITDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_L_EXTN_MOVM_INITTEAMLISTRecord rec = new SS_L_EXTN_MOVM_INITTEAMLISTRecord();
		...
		while(rset1.next()){
			SS_L_EXTN_MOVM_INITPARTLISTRecord rec = new SS_L_EXTN_MOVM_INITPARTLISTRecord();
		...
		while(rset2.next()){
			SS_L_EXTN_MOVM_INITAREALISTRecord rec = new SS_L_EXTN_MOVM_INITAREALISTRecord();
		...
		while(rset3.next()){
			SS_L_EXTN_MOVM_INITCURMEDICDRecord rec = new SS_L_EXTN_MOVM_INITCURMEDICDRecord();
	...
	public String teamlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_EXTN_MOVM_INITTEAMLISTRecord rec = (SS_L_EXTN_MOVM_INITTEAMLISTRecord)teamlist.get(i);
	...
	public String partlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_EXTN_MOVM_INITPARTLISTRecord rec = (SS_L_EXTN_MOVM_INITPARTLISTRecord)partlist.get(i);
	...
	public String arealistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_EXTN_MOVM_INITAREALISTRecord rec = (SS_L_EXTN_MOVM_INITAREALISTRecord)arealist.get(i);
	...
	public String curmedicdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_EXTN_MOVM_INITCURMEDICDRecord rec = (SS_L_EXTN_MOVM_INITCURMEDICDRecord)curmedicd.get(i);
...
<%
	for(int i=0; i<ds.teamlist.size(); i++){
		SS_L_EXTN_MOVM_INITTEAMLISTRecord teamlistRec = (SS_L_EXTN_MOVM_INITTEAMLISTRecord)ds.teamlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.partlist.size(); i++){
		SS_L_EXTN_MOVM_INITPARTLISTRecord partlistRec = (SS_L_EXTN_MOVM_INITPARTLISTRecord)ds.partlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.arealist.size(); i++){
		SS_L_EXTN_MOVM_INITAREALISTRecord arealistRec = (SS_L_EXTN_MOVM_INITAREALISTRecord)ds.arealist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curmedicd.size(); i++){
		SS_L_EXTN_MOVM_INITCURMEDICDRecord curmedicdRec = (SS_L_EXTN_MOVM_INITCURMEDICDRecord)ds.curmedicd.get(i);%>
HTML 코드들....
	<%}%>
