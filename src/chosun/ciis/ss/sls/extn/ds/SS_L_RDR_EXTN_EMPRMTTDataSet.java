/***************************************************************************************************
* 파일명 : SS_L_RDR_EXTN_EMPRMTTDataSet.java
* 기능 : 확장현황-사원확장-수당-목록을 위한 DataSet
* 작성일자 : 2004-04-24
* 작성자 : 김대섭
***************************************************************************************************/
/***************************************************************************************************
...
/**
 * 확장현황-사원확장-수당-목록을 위한 DataSet
 */

public class SS_L_RDR_EXTN_EMPRMTTDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_L_RDR_EXTN_EMPRMTTDataSet(){}
	public SS_L_RDR_EXTN_EMPRMTTDataSet(String errcode, String errmsg, long totalcnt, long totalalonamt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_L_RDR_EXTN_EMPRMTTCURCOMMLISTRecord rec = new SS_L_RDR_EXTN_EMPRMTTCURCOMMLISTRecord();
		...
		this.totalalonamt = cstmt.getLong(11);
	}
	...
	public String curcommlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_RDR_EXTN_EMPRMTTCURCOMMLISTRecord rec = (SS_L_RDR_EXTN_EMPRMTTCURCOMMLISTRecord)curcommlist.get(i);
