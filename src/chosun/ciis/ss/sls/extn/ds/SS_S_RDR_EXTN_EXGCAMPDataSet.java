/***************************************************************************************************
* 파일명 : SS_S_RDR_EXTN_EXGCAMPDataSet.java
* 기능 : 품앗이확장상세를 위한 DataSet
* 작성일자 : 2003-11-20
* 작성자 : 김대섭
***************************************************************************************************/
/***************************************************************************************************
...
public class SS_S_RDR_EXTN_EXGCAMPDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_S_RDR_EXTN_EXGCAMPDataSet(){}
	public SS_S_RDR_EXTN_EXGCAMPDataSet(String errcode, String errmsg, String rdr_extncampno, String campnm, String frdt, String todt, String closyn, String closdt, String alonpayplandt, String remk){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_S_RDR_EXTN_EXGCAMPCURCOMMLISTRecord rec = new SS_S_RDR_EXTN_EXGCAMPCURCOMMLISTRecord();
		...
		while(rset1.next()){
			SS_S_RDR_EXTN_EXGCAMPCURMEDICDRecord rec = new SS_S_RDR_EXTN_EXGCAMPCURMEDICDRecord();
	...
	public String curcommlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_S_RDR_EXTN_EXGCAMPCURCOMMLISTRecord rec = (SS_S_RDR_EXTN_EXGCAMPCURCOMMLISTRecord)curcommlist.get(i);
	...
	public String curmedicdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_S_RDR_EXTN_EXGCAMPCURMEDICDRecord rec = (SS_S_RDR_EXTN_EXGCAMPCURMEDICDRecord)curmedicd.get(i);
...
<%
	SS_S_RDR_EXTN_EXGCAMPDataSet ds = (SS_S_RDR_EXTN_EXGCAMPDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curcommlist.size(); i++){
		SS_S_RDR_EXTN_EXGCAMPCURCOMMLISTRecord curcommlistRec = (SS_S_RDR_EXTN_EXGCAMPCURCOMMLISTRecord)ds.curcommlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curmedicd.size(); i++){
		SS_S_RDR_EXTN_EXGCAMPCURMEDICDRecord curmedicdRec = (SS_S_RDR_EXTN_EXGCAMPCURMEDICDRecord)ds.curmedicd.get(i);%>
HTML 코드들....
	<%}%>
