/***************************************************************************************************
* 파일명 : SS_S_RDR_EXTN_SERVCLOSDataSet.java
* 기능 : 확장현황-조선IS확장-마감(조선IS) 상세를 위한 DataSet
* 작성일자 : 2004-04-24
* 작성자 : 김대섭
***************************************************************************************************/
/***************************************************************************************************
...
/**
 * 확장현황-조선IS확장-마감(조선IS) 상세를 위한 DataSet
 */


public class SS_S_RDR_EXTN_SERVCLOSDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_S_RDR_EXTN_SERVCLOSDataSet(){}
	public SS_S_RDR_EXTN_SERVCLOSDataSet(String errcode, String errmsg, String basidt, String frdt, String todt, String closyn, String closdt, String splychrgclosyn, String splychrgclosdt, String clamdt, String remk){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_S_RDR_EXTN_SERVCLOSCURCOMMLISTRecord rec = new SS_S_RDR_EXTN_SERVCLOSCURCOMMLISTRecord();
		...
		while(rset1.next()){
			SS_S_RDR_EXTN_SERVCLOSCURDEPTCDRecord rec = new SS_S_RDR_EXTN_SERVCLOSCURDEPTCDRecord();
		...
		while(rset2.next()){
			SS_S_RDR_EXTN_SERVCLOSCURMEDICDRecord rec = new SS_S_RDR_EXTN_SERVCLOSCURMEDICDRecord();
	...
	public String curcommlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_S_RDR_EXTN_SERVCLOSCURCOMMLISTRecord rec = (SS_S_RDR_EXTN_SERVCLOSCURCOMMLISTRecord)curcommlist.get(i);
	...
	public String curdeptcdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_S_RDR_EXTN_SERVCLOSCURDEPTCDRecord rec = (SS_S_RDR_EXTN_SERVCLOSCURDEPTCDRecord)curdeptcd.get(i);
	...
	public String curmedicdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_S_RDR_EXTN_SERVCLOSCURMEDICDRecord rec = (SS_S_RDR_EXTN_SERVCLOSCURMEDICDRecord)curmedicd.get(i);
...
<%
	for(int i=0; i<ds.curdeptcd.size(); i++){
		SS_S_RDR_EXTN_SERVCLOSCURDEPTCDRecord curdeptcdRec = (SS_S_RDR_EXTN_SERVCLOSCURDEPTCDRecord)ds.curdeptcd.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curmedicd.size(); i++){
		SS_S_RDR_EXTN_SERVCLOSCURMEDICDRecord curmedicdRec = (SS_S_RDR_EXTN_SERVCLOSCURMEDICDRecord)ds.curmedicd.get(i);%>
HTML 코드들....
	<%}%>
