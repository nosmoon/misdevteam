...
public class SL_S_EXTNCLOS_JM_DTLSDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
...
<%
	SL_S_EXTNCLOS_JM_DTLSDataSet ds = (SL_S_EXTNCLOS_JM_DTLSDataSet)request.getAttribute("ds");
%>
