...
public class SS_L_PROMSTAF_INIT_CYEXTNDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_L_PROMSTAF_INIT_CYEXTNDataSet(){}
	public SS_L_PROMSTAF_INIT_CYEXTNDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_L_PROMSTAF_INIT_CYEXTNCURSTAFCLSFCDRecord rec = new SS_L_PROMSTAF_INIT_CYEXTNCURSTAFCLSFCDRecord();
		...
		while(rset1.next()){
			SS_L_PROMSTAF_INIT_CYEXTNCURCNTRSTATCDRecord rec = new SS_L_PROMSTAF_INIT_CYEXTNCURCNTRSTATCDRecord();
		...
		while(rset2.next()){
			SS_L_PROMSTAF_INIT_CYEXTNCURACCTBANKRecord rec = new SS_L_PROMSTAF_INIT_CYEXTNCURACCTBANKRecord();
	...
	public String curstafclsfcdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_PROMSTAF_INIT_CYEXTNCURSTAFCLSFCDRecord rec = (SS_L_PROMSTAF_INIT_CYEXTNCURSTAFCLSFCDRecord)curstafclsfcd.get(i);
	...
	public String curcntrstatcdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_PROMSTAF_INIT_CYEXTNCURCNTRSTATCDRecord rec = (SS_L_PROMSTAF_INIT_CYEXTNCURCNTRSTATCDRecord)curcntrstatcd.get(i);
	...
	public String curacctbankOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_PROMSTAF_INIT_CYEXTNCURACCTBANKRecord rec = (SS_L_PROMSTAF_INIT_CYEXTNCURACCTBANKRecord)curacctbank.get(i);
...
<%
	for(int i=0; i<ds.curstafclsfcd.size(); i++){
		SS_L_PROMSTAF_INIT_CYEXTNCURSTAFCLSFCDRecord curstafclsfcdRec = (SS_L_PROMSTAF_INIT_CYEXTNCURSTAFCLSFCDRecord)ds.curstafclsfcd.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curcntrstatcd.size(); i++){
		SS_L_PROMSTAF_INIT_CYEXTNCURCNTRSTATCDRecord curcntrstatcdRec = (SS_L_PROMSTAF_INIT_CYEXTNCURCNTRSTATCDRecord)ds.curcntrstatcd.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curacctbank.size(); i++){
		SS_L_PROMSTAF_INIT_CYEXTNCURACCTBANKRecord curacctbankRec = (SS_L_PROMSTAF_INIT_CYEXTNCURACCTBANKRecord)ds.curacctbank.get(i);%>
HTML 코드들....
	<%}%>
