/***************************************************************************************************
* 파일명 : SSExtn4500WB.java
* 기능 : 센터별 무료구분별 무료지 부수 조회
* 작성일자 : 2016.01.29
* 작성자 : 장선희
***************************************************************************************************/
/***************************************************************************************************
...
/**
 * 센터별 무료구분별 무료지 부수 조회 WB
 */

public class SSExtn4500WB {
     ...
     * @throws AppException
     **/
    public void freeNwspList(HttpServletRequest req, HttpServletResponse res) throws AppException {
    	SS_L_FREENWSPDataSet ds = null;
        ...
        // DM Setting
    	SS_L_FREENWSPDM dm = new SS_L_FREENWSPDM();
        dm.setDeptcd(deptcd);
        dm.setPartcd(partcd);
        dm.setAreacd(areacd);
        dm.setBocd(bocd);
        ...
        SSExtn4500DAO dao = new SSExtn4500DAO();
        // DAO 객체의 init 호출
        ds = dao.freeNwspList(dm);
