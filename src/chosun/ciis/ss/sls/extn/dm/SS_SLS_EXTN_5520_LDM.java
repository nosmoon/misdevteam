...
public class SS_SLS_EXTN_5520_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_SLS_EXTN_5520_LDM(){}
	public SS_SLS_EXTN_5520_LDM(String deptcd, String partcd, String areacd, String bocd, String yymm, String extnaloncd){
		this.deptcd = deptcd;
		this.partcd = partcd;
		this.areacd = areacd;
		this.bocd = bocd;
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_SLS_EXTN_5520_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_SLS_EXTN_5520_LDM dm = (SS_SLS_EXTN_5520_LDM)bdm;
		...
		cstmt.setString(8, dm.extnaloncd);
		cstmt.registerOutParameter(9, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_SLS_EXTN_5520_LDataSet();
	}
