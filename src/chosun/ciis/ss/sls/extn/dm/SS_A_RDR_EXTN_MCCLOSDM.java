/***************************************************************************************************
* 파일명 : SS_A_RDR_EXTN_MCCLOSDM.java
* 기능 : 확장현황-조선IS확장-MC마감
* 작성일자 : 2005-02-19
* 작성자 : 김대섭
***************************************************************************************************/
...
public class SS_A_RDR_EXTN_MCCLOSDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_A_RDR_EXTN_MCCLOSDM(){}
	public SS_A_RDR_EXTN_MCCLOSDM(String incmgpers, String accflag, String basidt, String frdt, String todt, String closdt, String clamdt, String remk, String medicdary, String deptcdary, String basiamt1ary, String basiamt2ary, String basiamt3ary){
	...
	public String getSQL(){
		 return "{ call SP_SS_A_RDR_EXTN_MCCLOS( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_A_RDR_EXTN_MCCLOSDM dm = (SS_A_RDR_EXTN_MCCLOSDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_A_RDR_EXTN_MCCLOSDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
...
/* 작성시간 : Sat Feb 19 16:22:49 KST 2005 */