...
public class SS_SLS_EXTN_4820_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_SLS_EXTN_4820_UDM(){}
	public SS_SLS_EXTN_4820_UDM(String incmgpers, String valmm, String bocd, String meda_amt){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_SLS_EXTN_4820_U(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_SLS_EXTN_4820_UDM dm = (SS_SLS_EXTN_4820_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_SLS_EXTN_4820_UDataSet();
	}
...
/* 작성시간 : Thu May 26 14:07:18 KST 2016 */