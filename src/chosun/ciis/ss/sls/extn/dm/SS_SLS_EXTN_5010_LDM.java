...
public class SS_SLS_EXTN_5010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_SLS_EXTN_5010_LDM(){}
	public SS_SLS_EXTN_5010_LDM(String fr_yymm, String to_yymm, String dncomp, String adv_nm, String adv_cmpycd, String adv_officd, String adv_deptcd){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_SLS_EXTN_5010_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_SLS_EXTN_5010_LDM dm = (SS_SLS_EXTN_5010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_SLS_EXTN_5010_LDataSet();
	}
