...
public class SL_L_EXTNCLOSDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SL_L_EXTNCLOSDM(){}
	public SL_L_EXTNCLOSDM(String deptcd, String partcd, String areacd, String bocd, String closmm, String extntype1, String extntype2, String searchcd, String ddremk, String issuspyn, String bocfmyn, String ddcfmyn, long pageno, long pagesize, String common_deptcd, String common_partcd, String common_areacd){
		this.deptcd = deptcd;
		this.partcd = partcd;
		this.areacd = areacd;
		this.bocd = bocd;
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SL_L_EXTNCLOS(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SL_L_EXTNCLOSDM dm = (SL_L_EXTNCLOSDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SL_L_EXTNCLOSDataSet();
	}
...
/* 작성시간 : Fri Dec 16 17:58:04 KST 2011 */