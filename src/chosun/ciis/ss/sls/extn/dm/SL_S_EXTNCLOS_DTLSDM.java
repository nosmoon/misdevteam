...
public class SL_S_EXTNCLOS_DTLSDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SL_S_EXTNCLOS_DTLSDM(){}
	public SL_S_EXTNCLOS_DTLSDM(String bocd, String extndt, String rdr_no, String closmm, String searchcd, String seq){
		this.bocd = bocd;
		this.extndt = extndt;
		this.rdr_no = rdr_no;
		this.closmm = closmm;
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SL_S_EXTNCLOS_DTLS(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SL_S_EXTNCLOS_DTLSDM dm = (SL_S_EXTNCLOS_DTLSDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SL_S_EXTNCLOS_DTLSDataSet();
	}
