...
public class SL_A_EXTNCLOS_JM_DTLSDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SL_A_EXTNCLOS_JM_DTLSDM(){}
	public SL_A_EXTNCLOS_JM_DTLSDM(String bocd, String extndt, String rdr_no, String closmm, String workflag, String bocont, String ddcont, String seq, String chgid){
		this.bocd = bocd;
		this.extndt = extndt;
		this.rdr_no = rdr_no;
		this.closmm = closmm;
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SL_A_EXTNCLOS_JM_DTLS(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SL_A_EXTNCLOS_JM_DTLSDM dm = (SL_A_EXTNCLOS_JM_DTLSDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SL_A_EXTNCLOS_JM_DTLSDataSet();
	}
...
/* 작성시간 : Sun Mar 01 15:20:04 KST 2015 */