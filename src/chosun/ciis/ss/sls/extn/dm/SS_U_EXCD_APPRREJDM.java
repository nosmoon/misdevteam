...
public class SS_U_EXCD_APPRREJDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_U_EXCD_APPRREJDM(){}
	public SS_U_EXCD_APPRREJDM(String uid, String bocd, String extncdusage, String resitype){
		this.uid = uid;
		this.bocd = bocd;
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_U_EXCD_APPRREJ(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_U_EXCD_APPRREJDM dm = (SS_U_EXCD_APPRREJDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_U_EXCD_APPRREJDataSet();
	}
...
/* 작성시간 : Wed Mar 25 14:28:39 KST 2015 */