...
public class SS_SLS_EXTN_5601_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String srch_word;

	public SS_SLS_EXTN_5601_LDM(){}
	public SS_SLS_EXTN_5601_LDM(String srch_word){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_SLS_EXTN_5601_L(? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_SLS_EXTN_5601_LDM dm = (SS_SLS_EXTN_5601_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_SLS_EXTN_5601_LDataSet();
	}
