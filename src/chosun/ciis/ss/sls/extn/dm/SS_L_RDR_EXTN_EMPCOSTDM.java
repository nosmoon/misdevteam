/***************************************************************************************************
* 파일명 : SS_L_RDR_EXTN_EMPCOSTDM.java
* 기능 : 사원확장 비용 목록을 위한 DM
* 작성일자 : 2003-12-13
* 작성자 : 김대섭
***************************************************************************************************/
/***************************************************************************************************
...
public class SS_L_RDR_EXTN_EMPCOSTDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_RDR_EXTN_EMPCOSTDM(){}
	public SS_L_RDR_EXTN_EMPCOSTDM(String accflag, String deptcd, String areacd, String bocd, String basidt, String busnchrgclamtyn, String splychrgclamtyn){
	...
	public String getSQL(){
		 return "{ call SP_SS_L_RDR_EXTN_EMPCOST( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_RDR_EXTN_EMPCOSTDM dm = (SS_L_RDR_EXTN_EMPCOSTDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_L_RDR_EXTN_EMPCOSTDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
