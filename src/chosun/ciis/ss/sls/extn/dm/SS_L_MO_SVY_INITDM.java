/***************************************************************************************************
* 파일명 : SS_L_MO_SVY_INITDM.java
* 기능 :  문자점검독자관리 설문응답 화면 초기상태
* 작성일자 : 2015.12.08
* 작성자 : 장선희
***************************************************************************************************/
/***************************************************************************************************
...
public class SS_L_MO_SVY_INITDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_MO_SVY_INITDM(){}
	public SS_L_MO_SVY_INITDM(String cmpy_cd, String auth_gb, String incmg_pers, String base_dt){
	...
	public String getSQL(){
		 return "{ call SP_SS_L_MO_SVY_INIT( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_MO_SVY_INITDM dm = (SS_L_MO_SVY_INITDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_L_MO_SVY_INITDataSet();
	}
