...
public class SS_SLS_EXTN_4600_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_SLS_EXTN_4600_ADM(){}
	public SS_SLS_EXTN_4600_ADM(String cmpy_cd, String auth_gb, String incmg_pers, String base_dt){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_SLS_EXTN_4600_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_SLS_EXTN_4600_ADM dm = (SS_SLS_EXTN_4600_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_SLS_EXTN_4600_ADataSet();
	}
