/***************************************************************************************************
* 파일명 : SS_A_RDR_EXTN_SLSCLOSDM.java
* 기능 : 확장지원비용 등록,수정,삭제를 위한 DM
* 작성일자 : 2003-12-17
* 작성자 : 김대섭
***************************************************************************************************/
/***************************************************************************************************
...
public class SS_A_RDR_EXTN_SLSCLOSDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_A_RDR_EXTN_SLSCLOSDM(){}
	public SS_A_RDR_EXTN_SLSCLOSDM(String incmgpers, String accflag, String basidt, String frdt, String todt, String closdt){
	...
	public String getSQL(){
		 return "{ call SP_SS_A_RDR_EXTN_SLSCLOS( ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_A_RDR_EXTN_SLSCLOSDM dm = (SS_A_RDR_EXTN_SLSCLOSDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_A_RDR_EXTN_SLSCLOSDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
