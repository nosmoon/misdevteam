/***************************************************************************************************
* 파일명 : SS_L_RDR_EXTN_STAFCYB_RSLTDM.java
...
public class SS_L_RDR_EXTN_STAFCYB_RSLTDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_RDR_EXTN_STAFCYB_RSLTDM(){}
	public SS_L_RDR_EXTN_STAFCYB_RSLTDM(String accflag, String frdt, String todt, String deptcd, String areacd, String bocd, String stafnm, long pageno, long pagesize){
	...
	public String getSQL(){
		 return "{ call SP_SS_L_RDR_EXTN_STAFCYB_RSLT( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_RDR_EXTN_STAFCYB_RSLTDM dm = (SS_L_RDR_EXTN_STAFCYB_RSLTDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_L_RDR_EXTN_STAFCYB_RSLTDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
