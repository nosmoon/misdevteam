...
public class SS_L_EXTN_APTUPLOADDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_EXTN_APTUPLOADDM(){}
	public SS_L_EXTN_APTUPLOADDM(String uid, String aptnm, String deptcd, String addr1, String addr2, String addr3, String tothoscnt, String pyong, String pyongothin, String hoscnt, String saledd, String mvinplandd, String constcmpynm, String apttype){
		this.uid = uid;
		this.aptnm = aptnm;
		this.deptcd = deptcd;
		this.addr1 = addr1;
	...
	public String getSQL(){
		 return "{ call SP_SS_L_EXTN_APTUPLOAD( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_EXTN_APTUPLOADDM dm = (SS_L_EXTN_APTUPLOADDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_L_EXTN_APTUPLOADDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
