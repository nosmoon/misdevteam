...
public class SS_L_EXTN_PATY_NEWDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String srch_word;

	public SS_L_EXTN_PATY_NEWDM(){}
	public SS_L_EXTN_PATY_NEWDM(String srch_word){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_L_EXTN_PATY_NEW(? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_EXTN_PATY_NEWDM dm = (SS_L_EXTN_PATY_NEWDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_L_EXTN_PATY_NEWDataSet();
	}
