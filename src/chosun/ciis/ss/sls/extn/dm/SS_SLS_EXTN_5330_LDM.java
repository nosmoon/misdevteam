...
public class SS_SLS_EXTN_5330_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String bocd;
	public String valmm;

	public SS_SLS_EXTN_5330_LDM(){}
	public SS_SLS_EXTN_5330_LDM(String bocd, String valmm){
		this.bocd = bocd;
		this.valmm = valmm;
	}
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_SLS_EXTN_5330_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_SLS_EXTN_5330_LDM dm = (SS_SLS_EXTN_5330_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_SLS_EXTN_5330_LDataSet();
	}
