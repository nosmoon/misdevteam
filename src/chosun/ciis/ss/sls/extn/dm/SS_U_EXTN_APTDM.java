...
public class SS_U_EXTN_APTDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_U_EXTN_APTDM(){}
	public SS_U_EXTN_APTDM(String uid, String aptcd, String aptnm, String addr1, String addr2, String addr3, String tothoscnt, String pyong, String pyongothin, String hoscnt, String saledd, String mvinplandd, String constcmpynm, String apttype, String deptcd, String partcd, String areacd, String bocd){
		this.uid = uid;
		this.aptcd = aptcd;
		this.aptnm = aptnm;
		this.addr1 = addr1;
	...
	public String getSQL(){
		 return "{ call SP_SS_U_EXTN_APT( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_U_EXTN_APTDM dm = (SS_U_EXTN_APTDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_U_EXTN_APTDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
...
/* 작성시간 : Tue May 19 19:54:11 KST 2009 */