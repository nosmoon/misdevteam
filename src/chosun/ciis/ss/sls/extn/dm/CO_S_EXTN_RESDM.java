...
public class CO_S_EXTN_RESDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String regdt;
	public String regno;

	public CO_S_EXTN_RESDM(){}
	public CO_S_EXTN_RESDM(String regdt, String regno){
		this.regdt = regdt;
		this.regno = regno;
	}
	...
	public String getSQL(){
		 return "{ call SP_CO_S_EXTN_RES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		CO_S_EXTN_RESDM dm = (CO_S_EXTN_RESDM)bdm;
		...
		cstmt.registerOutParameter(63, Types.TIMESTAMP);
		...
		cstmt.registerOutParameter(67, Types.TIMESTAMP);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.CO_S_EXTN_RESDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
...
/* 작성시간 : Fri Jul 13 15:59:18 KST 2007 */