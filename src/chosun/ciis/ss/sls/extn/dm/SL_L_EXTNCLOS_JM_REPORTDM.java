...
public class SL_L_EXTNCLOS_JM_REPORTDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SL_L_EXTNCLOS_JM_REPORTDM(){}
	public SL_L_EXTNCLOS_JM_REPORTDM(String frextndt, String toextndt, String pageflag, long pageno, long pagesize){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SL_L_EXTNCLOS_JM_REPORT(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SL_L_EXTNCLOS_JM_REPORTDM dm = (SL_L_EXTNCLOS_JM_REPORTDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SL_L_EXTNCLOS_JM_REPORTDataSet();
	}
