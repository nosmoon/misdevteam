/***************************************************************************************************
* 파일명 : SS_U_RDR_EXTN_EMPCOSTDM.java
* 기능 : 사원확장 비용 수정을 위한 DM
* 작성일자 : 2003-12-13
* 작성자 : 김대섭
***************************************************************************************************/
/***************************************************************************************************
...
public class SS_U_RDR_EXTN_EMPCOSTDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_U_RDR_EXTN_EMPCOSTDM(){}
	public SS_U_RDR_EXTN_EMPCOSTDM(String incmgpers, String accflag, String basidtary, String bocdary, String checkedary){
	...
	public String getSQL(){
		 return "{ call SP_SS_U_RDR_EXTN_EMPCOST( ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_U_RDR_EXTN_EMPCOSTDM dm = (SS_U_RDR_EXTN_EMPCOSTDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_U_RDR_EXTN_EMPCOSTDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
