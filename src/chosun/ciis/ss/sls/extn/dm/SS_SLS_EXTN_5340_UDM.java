...
public class SS_SLS_EXTN_5340_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_SLS_EXTN_5340_UDM(){}
	public SS_SLS_EXTN_5340_UDM(String incmgpers, String valmm, String clos, String paydt){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_SLS_EXTN_5340_U(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_SLS_EXTN_5340_UDM dm = (SS_SLS_EXTN_5340_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_SLS_EXTN_5340_UDataSet();
	}
...
/* 작성시간 : Wed Oct 11 15:31:21 KST 2017 */