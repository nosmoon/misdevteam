...
public class SS_L_TASLM_RDREXTNCLOS_INITDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_TASLM_RDREXTNCLOS_INITDM(){}
	public SS_L_TASLM_RDREXTNCLOS_INITDM(String cmpy_cd, String auth_gb, String incmg_pers, String base_dt, String yyyymm){
	...
	public String getSQL(){
		 return "{ call SP_SS_L_TASLM_RDREXTNCLOS_INIT( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_TASLM_RDREXTNCLOS_INITDM dm = (SS_L_TASLM_RDREXTNCLOS_INITDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_L_TASLM_RDREXTNCLOS_INITDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
