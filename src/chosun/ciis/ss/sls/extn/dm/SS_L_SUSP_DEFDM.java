...
public class SS_L_SUSP_DEFDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_SUSP_DEFDM(){}
	public SS_L_SUSP_DEFDM(String deptcd, String partcd, String areacd, String bocd, String frdt, String todt, String def_type, String rdrnm, String agentnm, String cns_stat){
		this.deptcd = deptcd;
		this.partcd = partcd;
		this.areacd = areacd;
		this.bocd = bocd;
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_L_SUSP_DEF(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_SUSP_DEFDM dm = (SS_L_SUSP_DEFDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_L_SUSP_DEFDataSet();
	}
