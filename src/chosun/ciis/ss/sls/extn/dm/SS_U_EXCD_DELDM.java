...
public class SS_U_EXCD_DELDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_U_EXCD_DELDM(){}
	public SS_U_EXCD_DELDM(String uid, String bocd, String extncdusage, String resitype){
		this.uid = uid;
		this.bocd = bocd;
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_U_EXCD_DEL(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_U_EXCD_DELDM dm = (SS_U_EXCD_DELDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_U_EXCD_DELDataSet();
	}
...
/* 작성시간 : Wed Mar 25 14:29:07 KST 2015 */