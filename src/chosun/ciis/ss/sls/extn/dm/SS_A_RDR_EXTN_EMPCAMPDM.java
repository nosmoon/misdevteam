/***************************************************************************************************
* 파일명 : SS_A_RDR_EXTN_EMPCAMPDM.java
* 기능 : 사원확장 대화 등록,수정,삭제를 위한 DM
* 작성일자 : 2003-11-18
* 작성자 : 김대섭
***************************************************************************************************/
/***************************************************************************************************
...
public class SS_A_RDR_EXTN_EMPCAMPDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_A_RDR_EXTN_EMPCAMPDM(){}
	public SS_A_RDR_EXTN_EMPCAMPDM(String incmgpers, String accflag, String rdr_extncampno, String campnm, String frdt, String todt, long wght, String closdt, String alonpayplandt, String remk, String medicdary, String alonamtary, String wghtary, String qtyaplydtary, String basivalqtyary){
	...
	public String getSQL(){
		 return "{ call SP_SS_A_RDR_EXTN_EMPCAMP( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_A_RDR_EXTN_EMPCAMPDM dm = (SS_A_RDR_EXTN_EMPCAMPDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_A_RDR_EXTN_EMPCAMPDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
