...
public class SS_L_EXTN_RESDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_EXTN_RESDM(){}
	public SS_L_EXTN_RESDM(String viewflag, String deptcd, String partcd, String areacd, String bocd, String frdt, String todt, String cns_empcnfmstatcd, String cns_empcnfmocomcd, String chrg_cnfmstatcd, String chrg_cnfmocomcd, long pageno, long pagesize){
	...
	public String getSQL(){
		 return "{ call SP_SS_L_EXTN_RES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_EXTN_RESDM dm = (SS_L_EXTN_RESDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SS_L_EXTN_RESDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
...
/* 작성시간 : Tue Sep 08 17:10:04 KST 2009 */