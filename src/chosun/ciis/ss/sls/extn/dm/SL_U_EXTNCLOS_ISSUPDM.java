...
public class SL_U_EXTNCLOS_ISSUPDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String closmm;
	public String chgid;

	public SL_U_EXTNCLOS_ISSUPDM(){}
	public SL_U_EXTNCLOS_ISSUPDM(String closmm, String chgid){
		this.closmm = closmm;
		this.chgid = chgid;
	}
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SL_U_EXTNCLOS_ISSUP(? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SL_U_EXTNCLOS_ISSUPDM dm = (SL_U_EXTNCLOS_ISSUPDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.extn.ds.SL_U_EXTNCLOS_ISSUPDataSet();
	}
...
/* 작성시간 : Tue Jan 03 11:44:23 KST 2012 */