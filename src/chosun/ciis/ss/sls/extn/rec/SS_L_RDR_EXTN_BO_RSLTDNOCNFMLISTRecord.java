/***************************************************************************************************
* 파일명 : SS_L_RDR_EXTN_BO_RSLTDNOCNFMLISTRecord.java
* 기능 : 확장용역비용 조선IS 확장실적(지국별)  미확인 항목 목록을 위한 Record
* 작성일자 : 2003-12-23
* 작성자 : 김대섭
***************************************************************************************************/
/***************************************************************************************************
...
public class SS_L_RDR_EXTN_BO_RSLTDNOCNFMLISTRecord extends java.lang.Object implements java.io.Serializable{

	public String aplcpersnm;
	public String rdr_extndt;
	public String extnflnm;

	public SS_L_RDR_EXTN_BO_RSLTDNOCNFMLISTRecord(){}
