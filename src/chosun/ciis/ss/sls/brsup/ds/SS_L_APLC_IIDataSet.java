...
public class SS_L_APLC_IIDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_L_APLC_IIDataSet(){}
	public SS_L_APLC_IIDataSet(String errcode, String errmsg, long uncnfmcnt, long cnfmcnt, long canccnt, long aprverrcnt, long totalcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_L_APLC_IIRSLTCURRecord rec = new SS_L_APLC_IIRSLTCURRecord();
	...
	public String rsltcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_APLC_IIRSLTCURRecord rec = (SS_L_APLC_IIRSLTCURRecord)rsltcur.get(i);
...
<%
	for(int i=0; i<ds.rsltcur.size(); i++){
		SS_L_APLC_IIRSLTCURRecord rsltcurRec = (SS_L_APLC_IIRSLTCURRecord)ds.rsltcur.get(i);%>
HTML 코드들....
	<%}%>
