...
public class SS_L_EDI_INITDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_L_EDI_INITDataSet(){}
	public SS_L_EDI_INITDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_L_EDI_INITTEAMLISTRecord rec = new SS_L_EDI_INITTEAMLISTRecord();
		...
		while(rset1.next()){
			SS_L_EDI_INITPARTLISTRecord rec = new SS_L_EDI_INITPARTLISTRecord();
		...
		while(rset2.next()){
			SS_L_EDI_INITAREALISTRecord rec = new SS_L_EDI_INITAREALISTRecord();
		...
		while(rset3.next()){
			SS_L_EDI_INITJYCURRecord rec = new SS_L_EDI_INITJYCURRecord();
	...
	public String teamlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_EDI_INITTEAMLISTRecord rec = (SS_L_EDI_INITTEAMLISTRecord)teamlist.get(i);
	...
	public String partlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_EDI_INITPARTLISTRecord rec = (SS_L_EDI_INITPARTLISTRecord)partlist.get(i);
	...
	public String arealistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_EDI_INITAREALISTRecord rec = (SS_L_EDI_INITAREALISTRecord)arealist.get(i);
	...
	public String jycurOptHtml(String selected){
		...
		int size = jycur.size();
		for(int i=0; i<size; i++){
			SS_L_EDI_INITJYCURRecord rec = (SS_L_EDI_INITJYCURRecord)jycur.get(i);
...
<%
	for(int i=0; i<ds.teamlist.size(); i++){
		SS_L_EDI_INITTEAMLISTRecord teamlistRec = (SS_L_EDI_INITTEAMLISTRecord)ds.teamlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.partlist.size(); i++){
		SS_L_EDI_INITPARTLISTRecord partlistRec = (SS_L_EDI_INITPARTLISTRecord)ds.partlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.arealist.size(); i++){
		SS_L_EDI_INITAREALISTRecord arealistRec = (SS_L_EDI_INITAREALISTRecord)ds.arealist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.jycur.size(); i++){
		SS_L_EDI_INITJYCURRecord jycurRec = (SS_L_EDI_INITJYCURRecord)ds.jycur.get(i);%>
HTML 코드들....
	<%}%>
