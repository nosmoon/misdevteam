...
public class SS_L_GIRORECPDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_L_GIRORECPDataSet(){}
	public SS_L_GIRORECPDataSet(String errcode, String errmsg, long normcnt, long errcnt, long rjtcnt, long totalcnt, long finccnt, long rcpmcnt, long normamt, long erramt, long rjtamt, long totalamt, long fincamt, long rcpmamt, long cvscnt, long cvsamt, long cvscoms){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.normcnt = cstmt.getLong(9);
		this.errcnt = cstmt.getLong(10);
		this.rjtcnt = cstmt.getLong(11);
		this.totalcnt = cstmt.getLong(12);
		this.finccnt = cstmt.getLong(13);
		this.rcpmcnt = cstmt.getLong(14);
		this.normamt = cstmt.getLong(15);
		this.erramt = cstmt.getLong(16);
		this.rjtamt = cstmt.getLong(17);
		this.totalamt = cstmt.getLong(18);
		this.fincamt = cstmt.getLong(19);
		this.rcpmamt = cstmt.getLong(20);
		this.cvscnt = cstmt.getLong(21);
		this.cvsamt = cstmt.getLong(22);
		this.cvscoms = cstmt.getLong(23);
		ResultSet rset0 = (ResultSet) cstmt.getObject(24);
		while(rset0.next()){
			SS_L_GIRORECPRSLTCURRecord rec = new SS_L_GIRORECPRSLTCURRecord();
	...
	public String rsltcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_GIRORECPRSLTCURRecord rec = (SS_L_GIRORECPRSLTCURRecord)rsltcur.get(i);
