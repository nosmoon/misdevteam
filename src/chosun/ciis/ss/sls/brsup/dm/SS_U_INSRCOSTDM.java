/***************************************************************************************************
* 파일명 : SS_U_INSRCOSTDM.java
* 기능 : 지국지원-상해보험-비용(지원담당)-저장(수정)을 위한 DM
* 작성일자 : 2004-02-20
* 작성자 : 김대섭
***************************************************************************************************/
/***************************************************************************************************
...
/**
 * 지국지원-상해보험-비용(지원담당)-저장(수정)을 위한 DM
 */

public class SS_U_INSRCOSTDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_U_INSRCOSTDM(){}
	public SS_U_INSRCOSTDM(String incmgpers, String basidtary, String bocdary, String checkedary){
	...
	public String getSQL(){
		 return "{ call SP_SS_U_INSRCOST( ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_U_INSRCOSTDM dm = (SS_U_INSRCOSTDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brsup.ds.SS_U_INSRCOSTDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
