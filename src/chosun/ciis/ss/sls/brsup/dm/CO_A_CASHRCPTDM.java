...
public class CO_A_CASHRCPTDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String pubusage;

	public CO_A_CASHRCPTDM(){}
	public CO_A_CASHRCPTDM(String flag, String rdr_no, String selpubclsf, String aplcpers, String prn, String ptphno1, String ptphno2, String ptphno3, String rcptclsf, String aplcpath, String incmgpers, String pubusage){
		this.flag = flag;
		this.rdr_no = rdr_no;
	...
	public void setPubusage(String pubusage){
		this.pubusage = pubusage;
	}
	...
	public String getPubusage(){
		return this.pubusage;
	}
	...
	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		...
		cstmt.setString(14, dm.pubusage);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brsup.ds.CO_A_CASHRCPTDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
...
String pubusage = req.getParameter("pubusage");
if( pubusage == null){
	System.out.println(this.toString+" : pubusage is null" );
}else{
	System.out.println(this.toString+" : pubusage is "+pubusage );
}
----------------------------------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------------------------------
...
String pubusage = Util.checkString(req.getParameter("pubusage"));
----------------------------------------------------------------------------------------------------*//*----------------------------------------------------------------------------------------------------
...
String pubusage = Util.Uni2Ksc(Util.checkString(req.getParameter("pubusage")));
----------------------------------------------------------------------------------------------------*/
