/***************************************************************************************************
* 파일명 : SS_A_NWSPITEMCOSTCLMTDM.java
* 기능 : 지국지원-신문지원물품-비용(영업담당)-저장(등록)을 위한 DM
* 작성일자 : 2004-02-07
* 작성자 : 김대섭
***************************************************************************************************/
/***************************************************************************************************
...
/**
 * 지국지원-신문지원물품-비용(영업담당)-저장(등록)을 위한 DM
 */

public class SS_A_NWSPITEMCOSTCLMTDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_A_NWSPITEMCOSTCLMTDM(){}
	public SS_A_NWSPITEMCOSTCLMTDM(String incmgpers, String basidtary, String deptcdary, String areacdary, String bocdary, String clamtary, String rcpmpersnmary){
	...
	public String getSQL(){
		 return "{ call SP_SS_A_NWSPITEMCOSTCLMT( ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_A_NWSPITEMCOSTCLMTDM dm = (SS_A_NWSPITEMCOSTCLMTDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brsup.ds.SS_A_NWSPITEMCOSTCLMTDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
