/***************************************************************************************************
* 파일명 : SS_A_SHFT_CLAM_RMSGDM.java
...
public class SS_A_SHFT_CLAM_RMSGDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String incmgpers;
	public String basidt;
	public String shftclsfcd;

	public SS_A_SHFT_CLAM_RMSGDM(){}
	public SS_A_SHFT_CLAM_RMSGDM(String incmgpers, String basidt, String shftclsfcd){
	...
	public String getSQL(){
		 return "{ call SP_SS_A_SHFT_CLAM_RMSG( ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_A_SHFT_CLAM_RMSGDM dm = (SS_A_SHFT_CLAM_RMSGDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brsup.ds.SS_A_SHFT_CLAM_RMSGDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
