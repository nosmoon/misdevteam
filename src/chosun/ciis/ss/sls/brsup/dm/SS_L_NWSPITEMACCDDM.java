...
public class SS_L_NWSPITEMACCDDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_NWSPITEMACCDDM(){}
	public SS_L_NWSPITEMACCDDM(String deptcd, String partcd, String areacd, String bocd, String frdt, String todt, String itemcd, String itemclsf, String sendclsf, String costclsf, long pageno, long pagesize){
		this.deptcd = deptcd;
		this.partcd = partcd;
		this.areacd = areacd;
		this.bocd = bocd;
	...
	public String getSQL(){
		 return "{ call SP_SS_L_NWSPITEMACCD( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_NWSPITEMACCDDM dm = (SS_L_NWSPITEMACCDDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brsup.ds.SS_L_NWSPITEMACCDDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
