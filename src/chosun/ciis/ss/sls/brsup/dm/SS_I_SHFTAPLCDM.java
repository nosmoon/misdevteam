...
public class SS_I_SHFTAPLCDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_I_SHFTAPLCDM(){}
	public SS_I_SHFTAPLCDM(String accflag, String bocd, String incmgpers, String shftclsf, String pymtnm, String pymttel1, String pymttel2, String pymttel3, String bankcd, String acctno, String cardcmpycd, String cardno, String vdtyprd, String prn, String aplcdt, String aplyyymm, String email, String rdr_no, String medicd, String rdrnatvno){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_I_SHFTAPLC(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_I_SHFTAPLCDM dm = (SS_I_SHFTAPLCDM)bdm;
		...
		cstmt.setString(22, dm.rdrnatvno);
		cstmt.registerOutParameter(23, Types.VARCHAR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brsup.ds.SS_I_SHFTAPLCDataSet();
	}
	...
	public void print(){
		...
		System.out.println("rdrnatvno = [" + getRdrnatvno() + "]");
	}
}
/*----------------------------------------------------------------------------------------------------
...
String rdrnatvno = req.getParameter("rdrnatvno");
if( rdrnatvno == null){
	System.out.println(this.toString+" : rdrnatvno is null" );
}else{
	System.out.println(this.toString+" : rdrnatvno is "+rdrnatvno );
}
----------------------------------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------------------------------
