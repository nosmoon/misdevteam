...
public class SS_L_PROMSTAF_ISDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_PROMSTAF_ISDM(){}
	public SS_L_PROMSTAF_ISDM(String stafclsfcd, String cntrstatcd, String stafno, String stafnm, String prn, String ernno, long pageno, long pagesize){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_L_PROMSTAF_IS(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_PROMSTAF_ISDM dm = (SS_L_PROMSTAF_ISDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brsup.ds.SS_L_PROMSTAF_ISDataSet();
	}
