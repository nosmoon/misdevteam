...
public class SS_L_SHFT_PYMT_LOGDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String pymtseq;
	public long pageno;
	public long pagesize;

	public SS_L_SHFT_PYMT_LOGDM(){}
	public SS_L_SHFT_PYMT_LOGDM(String pymtseq, long pageno, long pagesize){
	...
	public String getSQL(){
		 return "{ call SP_SS_L_SHFT_PYMT_LOG( ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_SHFT_PYMT_LOGDM dm = (SS_L_SHFT_PYMT_LOGDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brsup.ds.SS_L_SHFT_PYMT_LOGDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
