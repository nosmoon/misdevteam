/***************************************************************************************************
* 파일명 : SS_L_PROMSTAFDM.java
* 기능 : 지국지원-판촉현황-요원관리-목록을 위한 DM
* 작성일자 : 2004-03-05
* 작성자 : 김대섭
***************************************************************************************************/
/***************************************************************************************************
...
/**
 * 지국지원-판촉현황-요원관리-목록을 위한 DM
 */

public class SS_L_PROMSTAFDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_PROMSTAFDM(){}
	public SS_L_PROMSTAFDM(String stafclsfcd, String cntrstatcd, String stafno, String stafnm, String prn, String ernno, long pageno, long pagesize){
	...
	public String getSQL(){
		 return "{ call SP_SS_L_PROMSTAF( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_PROMSTAFDM dm = (SS_L_PROMSTAFDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brsup.ds.SS_L_PROMSTAFDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
