...
public class SS_L_COMMDEPTCDDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_COMMDEPTCDDM(){}
	public SS_L_COMMDEPTCDDM(String cmpy_cd, String auth_gb, String incmg_pers, String base_dt){
	...
	public String getSQL(){
		 return "{ call SP_SS_L_COMMDEPTCD( ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_COMMDEPTCDDM dm = (SS_L_COMMDEPTCDDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brsup.ds.SS_L_COMMDEPTCDDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
