...
public class SS_L_APLC_IIDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_APLC_IIDM(){}
	public SS_L_APLC_IIDM(String bocd, long pageno, long pagesize, String aplcdt, String aplcclsf, String aplcprocstat, String shftclsf, String sechcond, String sechcont){
		this.bocd = bocd;
		this.pageno = pageno;
	...
	public String getSQL(){
		 return "{ call SP_SS_L_APLC_II( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_APLC_IIDM dm = (SS_L_APLC_IIDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brsup.ds.SS_L_APLC_IIDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
