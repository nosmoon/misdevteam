/***************************************************************************************************
* 파일명 : SS_U_SHFTMTHDCHGDM.java
* 기능 : 지국업무지원-Billing자동이체-신청관리-이체방법전환
* 작성일자 : 2004-06-07
* 작성자 : 김상열
***************************************************************************************************/
/***************************************************************************************************
...
public class SS_U_SHFTMTHDCHGDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_U_SHFTMTHDCHGDM(){}
	public SS_U_SHFTMTHDCHGDM(String bocd, String incmgpers, String shftclsf, String pymtnm, String pymttel1, String pymttel2, String pymttel3, String bankcd, String acctno, String cardcmpycd, String cardno, String vdtyprd, String prn, String aplcdt, String aplyyymm, String email, String rdr_no, String medicd){
		this.bocd = bocd;
	...
	public String getSQL(){
		 return "{ call SP_SS_U_SHFTMTHDCHG( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_U_SHFTMTHDCHGDM dm = (SS_U_SHFTMTHDCHGDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.bocd);
		cstmt.setString(4, dm.incmgpers);
		cstmt.setString(5, dm.shftclsf);
		cstmt.setString(6, dm.pymtnm);
		cstmt.setString(7, dm.pymttel1);
		cstmt.setString(8, dm.pymttel2);
		cstmt.setString(9, dm.pymttel3);
		cstmt.setString(10, dm.bankcd);
		cstmt.setString(11, dm.acctno);
		cstmt.setString(12, dm.cardcmpycd);
		cstmt.setString(13, dm.cardno);
		cstmt.setString(14, dm.vdtyprd);
		cstmt.setString(15, dm.prn);
		cstmt.setString(16, dm.aplcdt);
		cstmt.setString(17, dm.aplyyymm);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brsup.ds.SS_U_SHFTMTHDCHGDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
...
/* 작성시간 : Mon Jun 07 22:50:57 KST 2004 */