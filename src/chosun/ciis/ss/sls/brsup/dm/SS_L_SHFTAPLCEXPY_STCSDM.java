...
public class SS_L_SHFTAPLCEXPY_STCSDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_SHFTAPLCEXPY_STCSDM(){}
	public SS_L_SHFTAPLCEXPY_STCSDM(String rp_clsf, String fr_dt, String to_dt, String shftclsf, String resv1, String resv2, String resv3, String resv4, long pageno, long pagesize){
	...
	public String getSQL(){
		 return "{ call SP_SS_L_SHFTAPLCEXPY_STCS( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_SHFTAPLCEXPY_STCSDM dm = (SS_L_SHFTAPLCEXPY_STCSDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brsup.ds.SS_L_SHFTAPLCEXPY_STCSDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
