...
public class SS_S_SHFT_CLAM_INITDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_S_SHFT_CLAM_INITDM(){}
	public SS_S_SHFT_CLAM_INITDM(String cmpy_cd, String auth_gb, String incmg_pers, String base_dt){
	...
	public String getSQL(){
		 return "{ call SP_SS_S_SHFT_CLAM_INIT( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_S_SHFT_CLAM_INITDM dm = (SS_S_SHFT_CLAM_INITDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.brsup.ds.SS_S_SHFT_CLAM_INITDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
