...
public class SS_L_CAMP_EXTN_INITDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_L_CAMP_EXTN_INITDataSet(){}
	public SS_L_CAMP_EXTN_INITDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_L_CAMP_EXTN_INITCURDEPTCDRecord rec = new SS_L_CAMP_EXTN_INITCURDEPTCDRecord();
		...
		while(rset1.next()){
			SS_L_CAMP_EXTN_INITCUREXTNTYPECDRecord rec = new SS_L_CAMP_EXTN_INITCUREXTNTYPECDRecord();
		...
		while(rset2.next()){
			SS_L_CAMP_EXTN_INITCURMEDICDRecord rec = new SS_L_CAMP_EXTN_INITCURMEDICDRecord();
		...
		while(rset3.next()){
			SS_L_CAMP_EXTN_INITCURSUBSCNFMSTATCDRecord rec = new SS_L_CAMP_EXTN_INITCURSUBSCNFMSTATCDRecord();
		...
		while(rset4.next()){
			SS_L_CAMP_EXTN_INITCURAPLCPATHCDRecord rec = new SS_L_CAMP_EXTN_INITCURAPLCPATHCDRecord();
		...
		while(rset5.next()){
			SS_L_CAMP_EXTN_INITCURCAMPCDRecord rec = new SS_L_CAMP_EXTN_INITCURCAMPCDRecord();
		...
		while(rset6.next()){
			SS_L_CAMP_EXTN_INITCURCAMPEVENTCDRecord rec = new SS_L_CAMP_EXTN_INITCURCAMPEVENTCDRecord();
	...
	public String curdeptcdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_CAMP_EXTN_INITCURDEPTCDRecord rec = (SS_L_CAMP_EXTN_INITCURDEPTCDRecord)curdeptcd.get(i);
	...
	public String curextntypecdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_CAMP_EXTN_INITCUREXTNTYPECDRecord rec = (SS_L_CAMP_EXTN_INITCUREXTNTYPECDRecord)curextntypecd.get(i);
	...
	public String curmedicdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_CAMP_EXTN_INITCURMEDICDRecord rec = (SS_L_CAMP_EXTN_INITCURMEDICDRecord)curmedicd.get(i);
	...
	public String cursubscnfmstatcdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_CAMP_EXTN_INITCURSUBSCNFMSTATCDRecord rec = (SS_L_CAMP_EXTN_INITCURSUBSCNFMSTATCDRecord)cursubscnfmstatcd.get(i);
	...
	public String curaplcpathcdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_CAMP_EXTN_INITCURAPLCPATHCDRecord rec = (SS_L_CAMP_EXTN_INITCURAPLCPATHCDRecord)curaplcpathcd.get(i);
	...
	public String curcampcdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_CAMP_EXTN_INITCURCAMPCDRecord rec = (SS_L_CAMP_EXTN_INITCURCAMPCDRecord)curcampcd.get(i);
	...
	public String curcampeventcdOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_CAMP_EXTN_INITCURCAMPEVENTCDRecord rec = (SS_L_CAMP_EXTN_INITCURCAMPEVENTCDRecord)curcampeventcd.get(i);
...
<%
	for(int i=0; i<ds.curdeptcd.size(); i++){
		SS_L_CAMP_EXTN_INITCURDEPTCDRecord curdeptcdRec = (SS_L_CAMP_EXTN_INITCURDEPTCDRecord)ds.curdeptcd.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curextntypecd.size(); i++){
		SS_L_CAMP_EXTN_INITCUREXTNTYPECDRecord curextntypecdRec = (SS_L_CAMP_EXTN_INITCUREXTNTYPECDRecord)ds.curextntypecd.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curmedicd.size(); i++){
		SS_L_CAMP_EXTN_INITCURMEDICDRecord curmedicdRec = (SS_L_CAMP_EXTN_INITCURMEDICDRecord)ds.curmedicd.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.cursubscnfmstatcd.size(); i++){
		SS_L_CAMP_EXTN_INITCURSUBSCNFMSTATCDRecord cursubscnfmstatcdRec = (SS_L_CAMP_EXTN_INITCURSUBSCNFMSTATCDRecord)ds.cursubscnfmstatcd.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curaplcpathcd.size(); i++){
		SS_L_CAMP_EXTN_INITCURAPLCPATHCDRecord curaplcpathcdRec = (SS_L_CAMP_EXTN_INITCURAPLCPATHCDRecord)ds.curaplcpathcd.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curcampcd.size(); i++){
		SS_L_CAMP_EXTN_INITCURCAMPCDRecord curcampcdRec = (SS_L_CAMP_EXTN_INITCURCAMPCDRecord)ds.curcampcd.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curcampeventcd.size(); i++){
		SS_L_CAMP_EXTN_INITCURCAMPEVENTCDRecord curcampeventcdRec = (SS_L_CAMP_EXTN_INITCURCAMPEVENTCDRecord)ds.curcampeventcd.get(i);%>
HTML 코드들....
	<%}%>
