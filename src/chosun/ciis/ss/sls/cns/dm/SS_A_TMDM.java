...
public class SS_A_TMDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_A_TM(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_A_TMDM dm = (SS_A_TMDM)bdm;
		...
		cstmt.setString(55, dm.bo_procreqitm);
		cstmt.setString(56, dm.bo_cnfmtel);
		cstmt.setString(57, dm.cns_procreqitm);
		cstmt.setString(58, dm.cns_cnfmtel);
		cstmt.setString(59, dm.bldmngnn);
		cstmt.setString(60, dm.movmbldmngnn);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.cns.ds.SS_A_TMDataSet();
	}
	...
	public void print(){
		...
		System.out.println("jobflag = [" + getJobflag() + "]");
		System.out.println("accflag = [" + getAccflag() + "]");
		System.out.println("dt = [" + getDt() + "]");
		System.out.println("no = [" + getNo() + "]");
		System.out.println("rshpclsfcd = [" + getRshpclsfcd() + "]");
		System.out.println("aplcpersnm = [" + getAplcpersnm() + "]");
		System.out.println("aplcperstel_no1 = [" + getAplcperstel_no1() + "]");
		System.out.println("aplcperstel_no2 = [" + getAplcperstel_no2() + "]");
		System.out.println("aplcperstel_no3 = [" + getAplcperstel_no3() + "]");
		System.out.println("aplcpersemail = [" + getAplcpersemail() + "]");
		System.out.println("aplcpersptph_no1 = [" + getAplcpersptph_no1() + "]");
		System.out.println("aplcpersptph_no2 = [" + getAplcpersptph_no2() + "]");
		System.out.println("aplcpersptph_no3 = [" + getAplcpersptph_no3() + "]");
		System.out.println("aplcperszip = [" + getAplcperszip() + "]");
		System.out.println("aplcpersaddr = [" + getAplcpersaddr() + "]");
		System.out.println("aplcpersdtlsaddr = [" + getAplcpersdtlsaddr() + "]");
		System.out.println("rdr_no = [" + getRdr_no() + "]");
		System.out.println("rdrnm = [" + getRdrnm() + "]");
		System.out.println("natncd = [" + getNatncd() + "]");
		...
		System.out.println("rdremail = [" + getRdremail() + "]");
		...
		System.out.println("movmresiclsf = [" + getMovmresiclsf() + "]");
		System.out.println("movmresitype = [" + getMovmresitype() + "]");
		System.out.println("movmdt = [" + getMovmdt() + "]");
		System.out.println("medicd = [" + getMedicd() + "]");
		System.out.println("qty = [" + getQty() + "]");
		System.out.println("dlvhopedt = [" + getDlvhopedt() + "]");
		System.out.println("bocd = [" + getBocd() + "]");
		System.out.println("bocd2 = [" + getBocd2() + "]");
		System.out.println("resiclsfcd = [" + getResiclsfcd() + "]");
		...
		System.out.println("clsfcd = [" + getClsfcd() + "]");
		System.out.println("suspfrdt = [" + getSuspfrdt() + "]");
		System.out.println("susptodt = [" + getSusptodt() + "]");
		System.out.println("vaca_arearegncd = [" + getVaca_arearegncd() + "]");
		System.out.println("vaca_areacd = [" + getVaca_areacd() + "]");
		System.out.println("uid = [" + getUid() + "]");
		System.out.println("nm = [" + getNm() + "]");
		System.out.println("remk = [" + getRemk() + "]");
		System.out.println("cnscnfmyn = [" + getCnscnfmyn() + "]");
		System.out.println("cnscnfmcd = [" + getCnscnfmcd() + "]");
		System.out.println("bo_procreqitm = [" + getBo_procreqitm() + "]");
		System.out.println("bo_cnfmtel = [" + getBo_cnfmtel() + "]");
		System.out.println("cns_procreqitm = [" + getCns_procreqitm() + "]");
		System.out.println("cns_cnfmtel = [" + getCns_cnfmtel() + "]");
		System.out.println("bldmngnn = [" + getBldmngnn() + "]");
		System.out.println("movmbldmngnn = [" + getMovmbldmngnn() + "]");
	}
}
/*----------------------------------------------------------------------------------------------------
...
String bo_procreqitm = req.getParameter("bo_procreqitm");
if( bo_procreqitm == null){
	System.out.println(this.toString+" : bo_procreqitm is null" );
}else{
	System.out.println(this.toString+" : bo_procreqitm is "+bo_procreqitm );
}
String bo_cnfmtel = req.getParameter("bo_cnfmtel");
if( bo_cnfmtel == null){
	System.out.println(this.toString+" : bo_cnfmtel is null" );
}else{
	System.out.println(this.toString+" : bo_cnfmtel is "+bo_cnfmtel );
}
String cns_procreqitm = req.getParameter("cns_procreqitm");
if( cns_procreqitm == null){
	System.out.println(this.toString+" : cns_procreqitm is null" );
}else{
	System.out.println(this.toString+" : cns_procreqitm is "+cns_procreqitm );
}
String cns_cnfmtel = req.getParameter("cns_cnfmtel");
if( cns_cnfmtel == null){
	System.out.println(this.toString+" : cns_cnfmtel is null" );
}else{
	System.out.println(this.toString+" : cns_cnfmtel is "+cns_cnfmtel );
}
...
String movmbldmngnn = req.getParameter("movmbldmngnn");
if( movmbldmngnn == null){
	System.out.println(this.toString+" : movmbldmngnn is null" );
}else{
	System.out.println(this.toString+" : movmbldmngnn is "+movmbldmngnn );
}
----------------------------------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------------------------------
...
String bo_procreqitm = Util.checkString(req.getParameter("bo_procreqitm"));
String bo_cnfmtel = Util.checkString(req.getParameter("bo_cnfmtel"));
String cns_procreqitm = Util.checkString(req.getParameter("cns_procreqitm"));
String cns_cnfmtel = Util.checkString(req.getParameter("cns_cnfmtel"));
String bldmngnn = Util.checkString(req.getParameter("bldmngnn"));
String movmbldmngnn = Util.checkString(req.getParameter("movmbldmngnn"));
----------------------------------------------------------------------------------------------------*//*----------------------------------------------------------------------------------------------------
...
/* 작성시간 : Thu Jul 23 16:47:54 KST 2015 */