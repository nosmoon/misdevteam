/***************************************************************************************************
* 파일명 : SS_U_MOVM_RDRCOSTDM.java
* 기능 : 이사독자-비용-저장을 위한 DM
* 작성일자 : 2004-01-09
* 작성자 : 김대섭
***************************************************************************************************/
/***************************************************************************************************
...
public class SS_U_MOVM_RDRCOSTDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_U_MOVM_RDRCOSTDM(){}
	public SS_U_MOVM_RDRCOSTDM(String incmgpers, String accflag, String basidtary, String bocdary, String checkedary){
	...
	public String getSQL(){
		 return "{ call SP_SS_U_MOVM_RDRCOST( ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_U_MOVM_RDRCOSTDM dm = (SS_U_MOVM_RDRCOSTDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.move.ds.SS_U_MOVM_RDRCOSTDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
