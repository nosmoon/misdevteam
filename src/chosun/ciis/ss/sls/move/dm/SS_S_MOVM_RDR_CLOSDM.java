...
public class SS_S_MOVM_RDR_CLOSDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String regdt;
	public String regno;

	public SS_S_MOVM_RDR_CLOSDM(){}
	public SS_S_MOVM_RDR_CLOSDM(String regdt, String regno){
		this.regdt = regdt;
		this.regno = regno;
	}
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SS_S_MOVM_RDR_CLOS(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_S_MOVM_RDR_CLOSDM dm = (SS_S_MOVM_RDR_CLOSDM)bdm;
		...
		cstmt.registerOutParameter(40, Types.TIMESTAMP);
		cstmt.registerOutParameter(41, Types.VARCHAR);
		cstmt.registerOutParameter(42, Types.VARCHAR);
		cstmt.registerOutParameter(43, Types.TIMESTAMP);
		...
		cstmt.registerOutParameter(52, Types.TIMESTAMP);
		...
		cstmt.registerOutParameter(74, OracleTypes.CURSOR);
		cstmt.registerOutParameter(75, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.move.ds.SS_S_MOVM_RDR_CLOSDataSet();
	}
