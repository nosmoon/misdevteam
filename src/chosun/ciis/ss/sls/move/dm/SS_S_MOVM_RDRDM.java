...
public class SS_S_MOVM_RDRDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String regdt;
	public String regno;

	public SS_S_MOVM_RDRDM(){}
	public SS_S_MOVM_RDRDM(String regdt, String regno){
		this.regdt = regdt;
		this.regno = regno;
	}
	...
	public String getSQL(){
		 return "{ call SP_SS_S_MOVM_RDR( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_S_MOVM_RDRDM dm = (SS_S_MOVM_RDRDM)bdm;
		...
		cstmt.registerOutParameter(69, Types.TIMESTAMP);
		cstmt.registerOutParameter(70, Types.VARCHAR);
		cstmt.registerOutParameter(71, Types.VARCHAR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.move.ds.SS_S_MOVM_RDRDataSet();
	}
