...
public class SS_S_UNIONCHGZIPCODEDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_S_UNIONCHGZIPCODEDM(){}
	public SS_S_UNIONCHGZIPCODEDM(String uid, String workver, String zip1, String zip2, String zip3, String chggubun){
		this.uid = uid;
	...
	public String getSQL(){
		 return "{ call SP_SS_S_UNIONCHGZIPCODE( ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_S_UNIONCHGZIPCODEDM dm = (SS_S_UNIONCHGZIPCODEDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.admin.ds.SS_S_UNIONCHGZIPCODEDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
