...
public class SS_U_CHGZIPCODEDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_U_CHGZIPCODEDM(){}
	public SS_U_CHGZIPCODEDM(String uid, String workver, String chgclsf_cnfm, String zip1_cnfm, String zip2_cnfm, String zip3_cnfm){
		this.uid = uid;
	...
	public String getSQL(){
		 return "{ call SP_SS_U_CHGZIPCODE( ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_U_CHGZIPCODEDM dm = (SS_U_CHGZIPCODEDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.admin.ds.SS_U_CHGZIPCODEDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
