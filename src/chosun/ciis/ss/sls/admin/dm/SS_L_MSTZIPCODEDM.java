...
public class SS_L_MSTZIPCODEDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_MSTZIPCODEDM(){}
	public SS_L_MSTZIPCODEDM(String uid, String zipcode, String areagubun, String areaname, String workver, String chggubun){
		this.uid = uid;
	...
	public String getSQL(){
		 return "{ call SP_SS_L_MSTZIPCODE( ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_MSTZIPCODEDM dm = (SS_L_MSTZIPCODEDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.admin.ds.SS_L_MSTZIPCODEDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
