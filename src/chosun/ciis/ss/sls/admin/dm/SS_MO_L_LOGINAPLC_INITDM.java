/***************************************************************************************************
* 파일명 : SS_MO_L_LOGINAPLC_INITDM.java
* 기능 : 관리자-모바일관리-로그인승인신청 초기화면을 위한 DM
* 작성일자 : 2016-09-22
* 작성자 : 장선희
***************************************************************************************************/
/***************************************************************************************************
...
/**
 *  관리자-모바일관리-로그인승인신청 초기화면을 위한 DM
 */


public class SS_MO_L_LOGINAPLC_INITDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_MO_L_LOGINAPLC_INITDM(){}
	public SS_MO_L_LOGINAPLC_INITDM(String cmpy_cd, String auth_gb, String incmg_pers, String base_dt){
	...
	public String getSQL(){
		 return "{ call SP_SS_MO_L_LOGINAPLC_INIT( ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_MO_L_LOGINAPLC_INITDM dm = (SS_MO_L_LOGINAPLC_INITDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.admin.ds.SS_MO_L_LOGINAPLC_INITDataSet();
	}
