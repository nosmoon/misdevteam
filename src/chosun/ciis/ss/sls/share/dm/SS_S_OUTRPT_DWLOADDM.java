...
public class SS_S_OUTRPT_DWLOADDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String makedt;
	public String makepersid;
	public long dwloadcnt;

	public SS_S_OUTRPT_DWLOADDM(){}
	public SS_S_OUTRPT_DWLOADDM(String makedt, String makepersid, long dwloadcnt){
		this.makedt = makedt;
	...
	public String getSQL(){
		 return "{ call SP_SS_S_OUTRPT_DWLOAD( ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_S_OUTRPT_DWLOADDM dm = (SS_S_OUTRPT_DWLOADDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.share.ds.SS_S_OUTRPT_DWLOADDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
