/***************************************************************************************************
* 파일명 : SS_I_INFOEXG_ANSWERDM.java
* 기능 : 정보공유-공지사항,게시판-답변등록을 위한 DM
* 작성일자 : 2004-04-24
* 작성자 : 김대섭
***************************************************************************************************/
/***************************************************************************************************
...
/**
 * 정보공유-공지사항,게시판-답변등록을 위한 DM
 */

public class SS_I_INFOEXG_ANSWERDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call SP_SS_I_INFOEXG_ANSWER( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_I_INFOEXG_ANSWERDM dm = (SS_I_INFOEXG_ANSWERDM)bdm;
        ...
        cstmt.setBytes(28, dm.filecont);
		cstmt.setString(29, dm.incmgpers);
		cstmt.registerOutParameter(30, Types.VARCHAR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.share.ds.SS_I_INFOEXG_ANSWERDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
