/***************************************************************************************************
* 파일명 : SS_S_JOBREC_DWLOADDM.java
* 기능 : 정보공유 일일업무일지 파일다운로드
* 작성일자 : 2004-01-07
* 작성자 : 고윤홍
***************************************************************************************************/
/***************************************************************************************************
...
public class SS_S_JOBREC_DWLOADDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String makedt;
	public String makepersid;
	public long dwloadcnt;

	public SS_S_JOBREC_DWLOADDM(){}
	public SS_S_JOBREC_DWLOADDM(String makedt, String makepersid, long dwloadcnt){
		this.makedt = makedt;
	...
	public String getSQL(){
		 return "{ call SP_SS_S_JOBREC_DWLOAD( ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_S_JOBREC_DWLOADDM dm = (SS_S_JOBREC_DWLOADDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.share.ds.SS_S_JOBREC_DWLOADDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
...
/* 작성시간 : Wed Jan 07 20:12:17 KST 2004 */