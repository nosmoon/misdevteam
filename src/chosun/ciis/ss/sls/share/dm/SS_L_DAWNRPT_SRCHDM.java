/***************************************************************************************************
* 파일명 : SS_L_DAWNRPT_SRCHDM.java
* 기능 : 정보공유-일지및보고서-새벽근무보고서-검색목록을 위한 DM
* 작성일자 : 2004-04-24
* 작성자 : 김대섭
***************************************************************************************************/
/***************************************************************************************************
...
/**
 * 정보공유-일지및보고서-새벽근무보고서-검색목록을 위한 DM
 */

public class SS_L_DAWNRPT_SRCHDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_DAWNRPT_SRCHDM(){}
	public SS_L_DAWNRPT_SRCHDM(String cmpycd, String jobcd, String uid, String deptcd, String areacd, String sb_dealdeptcd, String sb_areacd, String deptplacyn, String search_word, String search_word_kind, String srchdeptcd, String makedt1, String makedt2, long pageno, long pagesize){
		this.cmpycd = cmpycd;
		this.jobcd = jobcd;
		this.uid = uid;
		this.deptcd = deptcd;
	...
	public String getSQL(){
		 return "{ call SP_SS_L_DAWNRPT_SRCH( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_DAWNRPT_SRCHDM dm = (SS_L_DAWNRPT_SRCHDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.share.ds.SS_L_DAWNRPT_SRCHDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
