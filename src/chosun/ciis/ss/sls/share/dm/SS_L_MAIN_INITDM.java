...
public class SS_L_MAIN_INITDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_MAIN_INITDM(){}
	public SS_L_MAIN_INITDM(String jobcd, String cmpycd, String uid, String sb_areacd, String sb_dealdeptcd, String deptcd, String selldeptcd){
		this.jobcd = jobcd;
		this.cmpycd = cmpycd;
		this.uid = uid;
	...
	public String getSQL(){
		 return "{ call SP_SS_L_MAIN_INIT( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_MAIN_INITDM dm = (SS_L_MAIN_INITDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.share.ds.SS_L_MAIN_INITDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
