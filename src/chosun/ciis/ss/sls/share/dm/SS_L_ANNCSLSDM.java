/***************************************************************************************************
* 파일명 : SS_L_ANNCSLSDM.java
* 기능 : 판매국메인-실시간공지를 위한 DM
* 작성일자 : 2004-04-24
* 작성자 : 김대섭
***************************************************************************************************/
/***************************************************************************************************
...
public class SS_L_ANNCSLSDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SS_L_ANNCSLSDM(){}
	public SS_L_ANNCSLSDM(String jobcd, String cmpycd, String uid, String sb_areacd, String sb_dealdeptcd, String deptcd, String selldeptcd){
		this.jobcd = jobcd;
		this.cmpycd = cmpycd;
		this.uid = uid;
	...
	public String getSQL(){
		 return "{ call SP_SS_L_ANNCSLS( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_L_ANNCSLSDM dm = (SS_L_ANNCSLSDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.share.ds.SS_L_ANNCSLSDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
