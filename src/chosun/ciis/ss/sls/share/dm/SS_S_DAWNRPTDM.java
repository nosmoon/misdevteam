...
public class SS_S_DAWNRPTDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String makedt;
	public String makepersid;
	public long brwscnt;

	public SS_S_DAWNRPTDM(){}
	public SS_S_DAWNRPTDM(String makedt, String makepersid, long brwscnt){
		this.makedt = makedt;
	...
	public String getSQL(){
		 return "{ call SP_SS_S_DAWNRPT( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SS_S_DAWNRPTDM dm = (SS_S_DAWNRPTDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ss.sls.share.ds.SS_S_DAWNRPTDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
