/***************************************************************************************************
* 파일명 : SSShare1400DAO.java
* 기능 : 정보공유 게시판 판매국 처리를 위한 DAO
* 작성일자 : 2003-11-30
* 작성자 : 고윤홍
***************************************************************************************************/
/***************************************************************************************************
...
//               	String blobQuery = "SELECT FILECONT FROM TACOM_INFOEXG WHERE SEQ = '"+tempSeq+"' FOR UPDATE";
	...
	*/
	...
	/**
	* 정보공유 게시판 판매국 상세정보 조회
	* @param SS_S_INFOEXGDM
	* @return 정보공유 게시판 판매국 상세정보 DataSet
	* @throws AppException
	*/
