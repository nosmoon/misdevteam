/***************************************************************************************************
* 파일명 : SS_S_DAWNRPT_DWLOADDataSet.java
...
public class SS_S_DAWNRPT_DWLOADDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_S_DAWNRPT_DWLOADDataSet(){}
	public SS_S_DAWNRPT_DWLOADDataSet(String errcode, String errmsg, String filenm, String filesize, byte[] filecont){
...
<%
	SS_S_DAWNRPT_DWLOADDataSet ds = (SS_S_DAWNRPT_DWLOADDataSet)request.getAttribute("ds");
%>
