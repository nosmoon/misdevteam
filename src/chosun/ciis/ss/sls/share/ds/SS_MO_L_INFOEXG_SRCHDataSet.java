/***************************************************************************************************
* 파일명 : SS_MO_L_INFOEXG_SRCHDataSet.java
...
public class SS_MO_L_INFOEXG_SRCHDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_MO_L_INFOEXG_SRCHDataSet(){}
	public SS_MO_L_INFOEXG_SRCHDataSet(String errcode, String errmsg, String rmsgareanm_param, long totalcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_MO_L_INFOEXG_SRCHINFOEXGLISTRecord rec = new SS_MO_L_INFOEXG_SRCHINFOEXGLISTRecord();
		...
		while(rset1.next()){
			SS_MO_L_INFOEXG_SRCHRMSGEXTTCD_LISTRecord rec = new SS_MO_L_INFOEXG_SRCHRMSGEXTTCD_LISTRecord();
		...
		while(rset2.next()){
			SS_MO_L_INFOEXG_SRCHBUSEOLISTRecord rec = new SS_MO_L_INFOEXG_SRCHBUSEOLISTRecord();
	...
	public String rmsgexttcd_listOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_MO_L_INFOEXG_SRCHRMSGEXTTCD_LISTRecord rec = (SS_MO_L_INFOEXG_SRCHRMSGEXTTCD_LISTRecord)rmsgexttcd_list.get(i);
	...
	public String buseolistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_MO_L_INFOEXG_SRCHBUSEOLISTRecord rec = (SS_MO_L_INFOEXG_SRCHBUSEOLISTRecord)buseolist.get(i);
...
<%
	for(int i=0; i<ds.infoexglist.size(); i++){
		SS_MO_L_INFOEXG_SRCHINFOEXGLISTRecord infoexglistRec = (SS_MO_L_INFOEXG_SRCHINFOEXGLISTRecord)ds.infoexglist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.rmsgexttcd_list.size(); i++){
		SS_MO_L_INFOEXG_SRCHRMSGEXTTCD_LISTRecord rmsgexttcd_listRec = (SS_MO_L_INFOEXG_SRCHRMSGEXTTCD_LISTRecord)ds.rmsgexttcd_list.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.buseolist.size(); i++){
		SS_MO_L_INFOEXG_SRCHBUSEOLISTRecord buseolistRec = (SS_MO_L_INFOEXG_SRCHBUSEOLISTRecord)ds.buseolist.get(i);%>
HTML 코드들....
	<%}%>
