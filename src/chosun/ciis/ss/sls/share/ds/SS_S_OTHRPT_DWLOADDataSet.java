/***************************************************************************************************
* 파일명 : SS_S_OTHRPT_DWLOADDataSet.java
...
public class SS_S_OTHRPT_DWLOADDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SS_S_OTHRPT_DWLOADDataSet(){}
	public SS_S_OTHRPT_DWLOADDataSet(String errcode, String errmsg, String filenm, String filesize, byte[] filecont){
...
<%
	SS_S_OTHRPT_DWLOADDataSet ds = (SS_S_OTHRPT_DWLOADDataSet)request.getAttribute("ds");
%>
