...
public class SSShare1400WB{

    public int filesize = 5*1024*1024;  // 최대 파일 크기 5M
    ...
    public void selectInitList(HttpServletRequest req, HttpServletResponse res) throws AppException{
        ...
        String deptcd = Util.getSessionParameterValue(req, "selldeptcd", false);         //판매부서코드(소속)
    ...
    public void insertInfoexg(HttpServletRequest req, HttpServletResponse res) throws AppException{
        ...
        try {
            ...
            throw new AppException("[SSShare1400WB.insertInfoexg()]","[SSShare1400WB.insertInfoexg()]첨부한 파일의 크기가 너무 크거나, 파일이 올바르지 않습니다.");
        } catch (Exception e) {
            SysException se = new SysException(e);
            LogManager.getInstance().log(se);
            throw se;
    ...
    public void updateInfoexg(HttpServletRequest req, HttpServletResponse res) throws AppException{
        ...
        try {
            ...
            throw new AppException("[SSShare1400WB.updateInfoexg()]","[SSShare1400WB.updateInfoexg()]첨부한 파일의 크기가 너무 크거나, 파일이 올바르지 않습니다.");
        } catch (Exception e) {
            SysException se = new SysException(e);
            LogManager.getInstance().log(se);
            throw se;
    ...
    public void insertAnswerInfoexg(HttpServletRequest req, HttpServletResponse res) throws AppException{
        ...
        try {
            ...
            throw new AppException("[SSShare1400WB.insertAnswerInfoexg()]","[SSShare1400WB.insertAnswerInfoexg()]첨부한 파일의 크기가 너무 크거나, 파일이 올바르지 않습니다.");
        } catch (Exception e) {
            SysException se = new SysException(e);
            LogManager.getInstance().log(se);
            throw se;
