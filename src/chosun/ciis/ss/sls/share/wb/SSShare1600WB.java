/***************************************************************************************************
* 파일명 : SSShare1600WB.java
* 기능 : 정보공유-게시판 신문고 처리를 위한 Work Bean
* 작성일자 : 2003-12-02
* 작성자 : 고윤홍
***************************************************************************************************/
/***************************************************************************************************
...
public class SSShare1600WB{
    ...
    public void selectInitList(HttpServletRequest req, HttpServletResponse res) throws AppException{
        ...
        SSShare1600DAO dao = new SSShare1600DAO();
		// DAO 객체의 selectInitList 호출
		ds = dao.selectInitList(dm);
		req.setAttribute("ds", ds);
		
		/*
        SSShare1600EJBHome home = (SSShare1600EJBHome) JNDIManager.getInstance().getHome("SSShare1600EJB");
        try {
            SSShare1600EJB ejb = home.create();
    ...
    public void answerInfoexg(HttpServletRequest req, HttpServletResponse res) throws AppException{
        ...
        // Request Parameter Processing
        String seq = Util.checkString(req.getParameter("seq"));//모글의 seq
    ...
    public void insertInfoexg(HttpServletRequest req, HttpServletResponse res) throws AppException{
        ...
        try {
            ...
            throw new AppException("[SSShare1600WB.insertInfoexg()]","[SSShare1600WB.insertInfoexg()]첨부한 파일의 크기가 너무 크거나, 파일이 올바르지 않습니다.");
        } catch (Exception e) {
            SysException se = new SysException(e);
            LogManager.getInstance().log(se);
            throw se;
    ...
    public void updateInfoexg(HttpServletRequest req, HttpServletResponse res) throws AppException{
        ...
        try {
            ...
            throw new AppException("[SSShare1600WB.updateInfoexg()]","[SSShare1600WB.updateInfoexg()]첨부한 파일의 크기가 너무 크거나, 파일이 올바르지 않습니다.");
        } catch (Exception e) {
            SysException se = new SysException(e);
            LogManager.getInstance().log(se);
            throw se;
    ...
    public void insertAnswerInfoexg(HttpServletRequest req, HttpServletResponse res) throws AppException{
        ...
        try {
            ...
            throw new AppException("[SSShare1600WB.insertAnswerInfoexg()]","[SSShare1600WB.insertAnswerInfoexg()]첨부한 파일의 크기가 너무 크거나, 파일이 올바르지 않습니다.");
        } catch (Exception e) {
            SysException se = new SysException(e);
            LogManager.getInstance().log(se);
            throw se;
