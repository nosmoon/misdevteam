/***************************************************************************************************
 * 파일명   : SS_L_CYBALON_STAFPAYDataSet.java
 * 기능     : 사이버센터-사이버수당지급 조회
 * 작성일자 : 2005-06-22
 * 작성자   : 김상옥
 **************************************************************************************************/
...
public class SS_L_CYBALON_STAFPAYDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList stafpaylist = new ArrayList();
	public String errcode;
	public String errmsg;
	public long totalcnt;

	public SS_L_CYBALON_STAFPAYDataSet(){}
	public SS_L_CYBALON_STAFPAYDataSet(String errcode, String errmsg, long totalcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SS_L_CYBALON_STAFPAYSTAFPAYLISTRecord rec = new SS_L_CYBALON_STAFPAYSTAFPAYLISTRecord();
	...
	public String stafpaylistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			SS_L_CYBALON_STAFPAYSTAFPAYLISTRecord rec = (SS_L_CYBALON_STAFPAYSTAFPAYLISTRecord)stafpaylist.get(i);
