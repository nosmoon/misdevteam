...
/**
 *  발송-추가발송 확인처리관리 WorkBean
 */
public class PSSend1501WB{
    ...
    public void selectCombolist(HttpServletRequest req, HttpServletResponse res) throws AppException {
        ...
        PSSend1501EJBHome home = (PSSend1501EJBHome) JNDIManager.getInstance().getHome("PSSend1501EJB");
        try {
            PSSend1501EJB ejb = home.create();
   ...
   public void selectList(HttpServletRequest req, HttpServletResponse res) throws
       AppException{
      PS_L_SEND_ADDM_CNFMDataSet ds = null;
      //사용자 세션정보
      String cmpycd      = Util.getSessionParameterValue(req, "cmpycd", true);          // 회사코드
      ...
      PS_L_SEND_ADDM_CNFMDM dm = new PS_L_SEND_ADDM_CNFMDM();
      //dm에 값을 Setting한다.
      dm.setCmpycd(cmpycd);
      dm.setSenddt(senddt);
      dm.setBocd(bocd);
      ...
      PSSend1501EJBHome home = (PSSend1501EJBHome)JNDIManager.getInstance().getHome(
          "PSSend1501EJB");
      try{
         PSSend1501EJB ejb = home.create();
   ...
   public void updateSendcnfm(HttpServletRequest req, HttpServletResponse res) throws
      ...
      PS_U_SEND_ADDM_CNFMDM dm = new PS_U_SEND_ADDM_CNFMDM();
      //dm에 값을 Setting한다.
