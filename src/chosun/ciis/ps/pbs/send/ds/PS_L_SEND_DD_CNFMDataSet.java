...
public class PS_L_SEND_DD_CNFMDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curcommlist = new ArrayList();
	public String errcode;
	public String errmsg;
	public long totalcnt;

	public PS_L_SEND_DD_CNFMDataSet(){}
	public PS_L_SEND_DD_CNFMDataSet(String errcode, String errmsg, long totalcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PS_L_SEND_DD_CNFMCURCOMMLISTRecord rec = new PS_L_SEND_DD_CNFMCURCOMMLISTRecord();
	...
	public String curcommlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			PS_L_SEND_DD_CNFMCURCOMMLISTRecord rec = (PS_L_SEND_DD_CNFMCURCOMMLISTRecord)curcommlist.get(i);
...
<%
	PS_L_SEND_DD_CNFMDataSet ds = (PS_L_SEND_DD_CNFMDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curcommlist.size(); i++){
		PS_L_SEND_DD_CNFMCURCOMMLISTRecord curcommlistRec = (PS_L_SEND_DD_CNFMCURCOMMLISTRecord)ds.curcommlist.get(i);%>
HTML 코드들....
	<%}%>
