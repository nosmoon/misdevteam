...
public class PS_P_SEND_ADDM_STICKERDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public PS_P_SEND_ADDM_STICKERDataSet(){}
	public PS_P_SEND_ADDM_STICKERDataSet(String errcode, String errmsg, String sendmthdnm, String bonm){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.sendmthdnm = Util.checkString(cstmt.getString(10));
		this.bonm = Util.checkString(cstmt.getString(11));
		ResultSet rset0 = (ResultSet) cstmt.getObject(12);
		while(rset0.next()){
			PS_P_SEND_ADDM_STICKERCURCOMMLISTRecord rec = new PS_P_SEND_ADDM_STICKERCURCOMMLISTRecord();
	...
	public String curcommlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			PS_P_SEND_ADDM_STICKERCURCOMMLISTRecord rec = (PS_P_SEND_ADDM_STICKERCURCOMMLISTRecord)curcommlist.get(i);
...
<%
	PS_P_SEND_ADDM_STICKERDataSet ds = (PS_P_SEND_ADDM_STICKERDataSet)request.getAttribute("ds");
%>
...
/* 작성시간 : Fri Dec 09 11:45:59 KST 2005 */