...
public class PS_L_SEND_DD_PROCDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curcommlist = new ArrayList();
	public String errcode;
	public String errmsg;
	public long totalcnt;

	public PS_L_SEND_DD_PROCDataSet(){}
	public PS_L_SEND_DD_PROCDataSet(String errcode, String errmsg, long totalcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PS_L_SEND_DD_PROCCURCOMMLISTRecord rec = new PS_L_SEND_DD_PROCCURCOMMLISTRecord();
	...
	public String curcommlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			PS_L_SEND_DD_PROCCURCOMMLISTRecord rec = (PS_L_SEND_DD_PROCCURCOMMLISTRecord)curcommlist.get(i);
...
<%
	PS_L_SEND_DD_PROCDataSet ds = (PS_L_SEND_DD_PROCDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curcommlist.size(); i++){
		PS_L_SEND_DD_PROCCURCOMMLISTRecord curcommlistRec = (PS_L_SEND_DD_PROCCURCOMMLISTRecord)ds.curcommlist.get(i);%>
HTML 코드들....
	<%}%>
