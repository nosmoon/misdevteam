/***************************************************************************************************
* 파일명 : PS_P_SEND_LUMP_STICKER.java
* 기능 : 출판 일괄 발송 출력(Excel)
* 작성일자 : 2005-12-08
* 작성자 : 전현표
***************************************************************************************************/
/***************************************************************************************************
...
/**
 * 출판국- 출판 일괄 발송 출력(Excel)
 *
 */

public class PS_P_SEND_LUMP_STICKERDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public PS_P_SEND_LUMP_STICKERDataSet(){}
	public PS_P_SEND_LUMP_STICKERDataSet(String errcode, String errmsg, String medinm, String sendmthdnm, String bonm){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PS_P_SEND_LUMP_STICKERCURCOMMLISTRecord rec = new PS_P_SEND_LUMP_STICKERCURCOMMLISTRecord();
	...
	public String curcommlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			PS_P_SEND_LUMP_STICKERCURCOMMLISTRecord rec = (PS_P_SEND_LUMP_STICKERCURCOMMLISTRecord)curcommlist.get(i);
...
<%
	PS_P_SEND_LUMP_STICKERDataSet ds = (PS_P_SEND_LUMP_STICKERDataSet)request.getAttribute("ds");
%>
...
/* 작성시간 : Wed Aug 22 15:39:24 KST 2007 */