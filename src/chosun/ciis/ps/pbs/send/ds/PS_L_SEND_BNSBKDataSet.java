...
public class PS_L_SEND_BNSBKDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curcommlist = new ArrayList();
	public String errcode;
	public String errmsg;
	public long totalcnt;

	public PS_L_SEND_BNSBKDataSet(){}
	public PS_L_SEND_BNSBKDataSet(String errcode, String errmsg, long totalcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PS_L_SEND_BNSBKCURCOMMLISTRecord rec = new PS_L_SEND_BNSBKCURCOMMLISTRecord();
	...
	public String curcommlistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			PS_L_SEND_BNSBKCURCOMMLISTRecord rec = (PS_L_SEND_BNSBKCURCOMMLISTRecord)curcommlist.get(i);
...
<%
	PS_L_SEND_BNSBKDataSet ds = (PS_L_SEND_BNSBKDataSet)request.getAttribute("ds");
%>
