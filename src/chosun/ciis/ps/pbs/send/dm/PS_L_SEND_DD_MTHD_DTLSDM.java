...
public class PS_L_SEND_DD_MTHD_DTLSDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String bocd;
	public String medicd;
	public String senddt;

	public PS_L_SEND_DD_MTHD_DTLSDM(){}
	public PS_L_SEND_DD_MTHD_DTLSDM(String bocd, String medicd, String senddt){
		this.bocd = bocd;
		this.medicd = medicd;
		this.senddt = senddt;
	}
	...
	public String getSQL(){
		 return "{ call SP_PS_L_SEND_DD_MTHD_DTLS( ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PS_L_SEND_DD_MTHD_DTLSDM dm = (PS_L_SEND_DD_MTHD_DTLSDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ps.pbs.send.ds.PS_L_SEND_DD_MTHD_DTLSDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
