...
public class PS_U_SEND_ADDM_CNFMDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PS_U_SEND_ADDM_CNFMDM(){}
	public PS_U_SEND_ADDM_CNFMDM(String bocd_cnfm, String senddt_cnfm, String medicd_cnfm, String mediser_no_cnfm, String chkcnfm_cnfm, String sendroutedd, String incmgpers){
	...
	public String getSQL(){
		 return "{ call SP_PS_U_SEND_ADDM_CNFM( ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PS_U_SEND_ADDM_CNFMDM dm = (PS_U_SEND_ADDM_CNFMDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ps.pbs.send.ds.PS_U_SEND_ADDM_CNFMDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
...
/* 작성시간 : Thu Apr 05 19:18:04 KST 2007 */