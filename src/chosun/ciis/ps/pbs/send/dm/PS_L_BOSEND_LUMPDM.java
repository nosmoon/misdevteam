...
public class PS_L_BOSEND_LUMPDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PS_L_BOSEND_LUMPDM(){}
	public PS_L_BOSEND_LUMPDM(String acq_bocd, String medicd, String mediser_no, long pageno, long pagesize){
	...
	public String getSQL(){
		 return "{ call SP_PS_L_BOSEND_LUMP( ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PS_L_BOSEND_LUMPDM dm = (PS_L_BOSEND_LUMPDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ps.pbs.send.ds.PS_L_BOSEND_LUMPDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
