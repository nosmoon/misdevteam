...
public class PS_P_SEND_DD_STICKERDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PS_P_SEND_DD_STICKERDM(){}
	public PS_P_SEND_DD_STICKERDM(String senddt, String bocd, String cmpycd, String mediser_no, String medicd, String sendkindcd, String sendmthdcd){
		this.senddt = senddt;
		this.bocd = bocd;
		this.cmpycd = cmpycd;
	...
	public String getSQL(){
		 return "{ call SP_PS_P_SEND_DD_STICKER( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PS_P_SEND_DD_STICKERDM dm = (PS_P_SEND_DD_STICKERDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ps.pbs.send.ds.PS_P_SEND_DD_STICKERDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
