...
public class PS_L_SEND_GIROADDMDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PS_L_SEND_GIROADDMDM(){}
	public PS_L_SEND_GIROADDMDM(String bocd, String cmpycd, String girosenddt, long pageno, long pagesize){
		this.bocd = bocd;
		this.cmpycd = cmpycd;
	...
	public String getSQL(){
		 return "{ call SP_PS_L_SEND_GIROADDM( ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PS_L_SEND_GIROADDMDM dm = (PS_L_SEND_GIROADDMDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ps.pbs.send.ds.PS_L_SEND_GIROADDMDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
