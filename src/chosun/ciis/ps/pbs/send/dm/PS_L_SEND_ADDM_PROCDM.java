...
public class PS_L_SEND_ADDM_PROCDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PS_L_SEND_ADDM_PROCDM(){}
	public PS_L_SEND_ADDM_PROCDM(String senddt, String bocd, String cmpycd, String mediser_no, String medicd, String sendkindcd, String sendmthdcd){
		this.senddt = senddt;
		this.bocd = bocd;
		this.cmpycd = cmpycd;
	...
	public String getSQL(){
		 return "{ call SP_PS_L_SEND_ADDM_PROC( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PS_L_SEND_ADDM_PROCDM dm = (PS_L_SEND_ADDM_PROCDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ps.pbs.send.ds.PS_L_SEND_ADDM_PROCDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
