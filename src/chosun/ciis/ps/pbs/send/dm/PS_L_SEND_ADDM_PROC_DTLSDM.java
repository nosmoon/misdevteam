...
public class PS_L_SEND_ADDM_PROC_DTLSDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PS_L_SEND_ADDM_PROC_DTLSDM(){}
	public PS_L_SEND_ADDM_PROC_DTLSDM(String senddt, String bocd, String mediser_no, String medicd, String sendkindcd, String sendmthdcd, long pageno, long pagesize, String cmpycd){
		this.senddt = senddt;
		this.bocd = bocd;
	...
	public String getSQL(){
		 return "{ call SP_PS_L_SEND_ADDM_PROC_DTLS( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PS_L_SEND_ADDM_PROC_DTLSDM dm = (PS_L_SEND_ADDM_PROC_DTLSDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ps.pbs.send.ds.PS_L_SEND_ADDM_PROC_DTLSDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
