...
public class PS_S_DSCT_CATLDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpycd;
	public String regdt;
	public String regno;

	public PS_S_DSCT_CATLDM(){}
	public PS_S_DSCT_CATLDM(String cmpycd, String regdt, String regno){
		this.cmpycd = cmpycd;
		this.regdt = regdt;
		this.regno = regno;
	}
	...
	public String getSQL(){
		 return "{ call SP_PS_S_DSCT_CATL( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PS_S_DSCT_CATLDM dm = (PS_S_DSCT_CATLDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ps.pbs.support.ds.PS_S_DSCT_CATLDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
