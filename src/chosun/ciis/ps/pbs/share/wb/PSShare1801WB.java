...
public class PSShare1801WB {
    ...
    public void selectInitList(HttpServletRequest req, HttpServletResponse res) throws AppException {
        ...
        PSShare1801EJBHome home = (PSShare1801EJBHome) JNDIManager.getInstance().getHome("PSShare1801EJB");
        try {
            PSShare1801EJB ejb = home.create();
