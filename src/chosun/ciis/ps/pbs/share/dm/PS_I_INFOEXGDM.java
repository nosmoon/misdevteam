...
public class PS_I_INFOEXGDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PS_I_INFOEXGDM(){}
	public PS_I_INFOEXGDM(String clsf, long answergrp, long answerseq, long answerlevl, String notifrdt, String notitodt, String makepersnm, String email, String hmpg, String titl, String cont1, String cont2, String cont3, String cont4, String cont5, String rmsgdept, String rmsgexttcd, String cmpycd, String cmpynm, String filenm, String filesize, byte[] filecont, String incmgpers){
		this.clsf = clsf;
	...
	public String getSQL(){
		 return "{ call SP_PS_I_INFOEXG( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PS_I_INFOEXGDM dm = (PS_I_INFOEXGDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ps.pbs.share.ds.PS_I_INFOEXGDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
