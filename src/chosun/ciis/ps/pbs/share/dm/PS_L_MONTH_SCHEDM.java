...
public class PS_L_MONTH_SCHEDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String deptcd;
	public String incmgpers;
	public String yyyymm;

	public PS_L_MONTH_SCHEDM(){}
	public PS_L_MONTH_SCHEDM(String deptcd, String incmgpers, String yyyymm){
		this.deptcd = deptcd;
	...
	public String getSQL(){
		 return "{ call SP_PS_L_MONTH_SCHE( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PS_L_MONTH_SCHEDM dm = (PS_L_MONTH_SCHEDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ps.pbs.share.ds.PS_L_MONTH_SCHEDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
