...
public class PS_L_BO_READER_SEARCHDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList readerlistcur = new ArrayList();
	public String errcode;
	public String errmsg;
	public long totalcnt;

	public PS_L_BO_READER_SEARCHDataSet(){}
	public PS_L_BO_READER_SEARCHDataSet(String errcode, String errmsg, long totalcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PS_L_BO_READER_SEARCHREADERLISTCURRecord rec = new PS_L_BO_READER_SEARCHREADERLISTCURRecord();
	...
	public String readerlistcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			PS_L_BO_READER_SEARCHREADERLISTCURRecord rec = (PS_L_BO_READER_SEARCHREADERLISTCURRecord)readerlistcur.get(i);
...
<%
	PS_L_BO_READER_SEARCHDataSet ds = (PS_L_BO_READER_SEARCHDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.readerlistcur.size(); i++){
		PS_L_BO_READER_SEARCHREADERLISTCURRecord readerlistcurRec = (PS_L_BO_READER_SEARCHREADERLISTCURRecord)ds.readerlistcur.get(i);%>
HTML 코드들....
	<%}%>
