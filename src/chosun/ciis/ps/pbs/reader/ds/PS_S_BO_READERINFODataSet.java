...
public class PS_S_BO_READERINFODataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList readinfocur = new ArrayList();
	public ArrayList sendmthdcur = new ArrayList();
	public String errcode;
	public String errmsg;

	public PS_S_BO_READERINFODataSet(){}
	public PS_S_BO_READERINFODataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PS_S_BO_READERINFOREADINFOCURRecord rec = new PS_S_BO_READERINFOREADINFOCURRecord();
		...
		while(rset1.next()){
			PS_S_BO_READERINFOSENDMTHDCURRecord rec = new PS_S_BO_READERINFOSENDMTHDCURRecord();
	...
	public String readinfocurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			PS_S_BO_READERINFOREADINFOCURRecord rec = (PS_S_BO_READERINFOREADINFOCURRecord)readinfocur.get(i);
	...
	public String sendmthdcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			PS_S_BO_READERINFOSENDMTHDCURRecord rec = (PS_S_BO_READERINFOSENDMTHDCURRecord)sendmthdcur.get(i);
...
<%
	PS_S_BO_READERINFODataSet ds = (PS_S_BO_READERINFODataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.readinfocur.size(); i++){
		PS_S_BO_READERINFOREADINFOCURRecord readinfocurRec = (PS_S_BO_READERINFOREADINFOCURRecord)ds.readinfocur.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.sendmthdcur.size(); i++){
		PS_S_BO_READERINFOSENDMTHDCURRecord sendmthdcurRec = (PS_S_BO_READERINFOSENDMTHDCURRecord)ds.sendmthdcur.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Fri Mar 30 14:48:37 KST 2007 */