...
public class PS_L_RDR_PUBL_ETCDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList rdr_publcur = new ArrayList();
	public String errcode;
	public String errmsg;
	public long totalcnt;

	public PS_L_RDR_PUBL_ETCDataSet(){}
	public PS_L_RDR_PUBL_ETCDataSet(String errcode, String errmsg, long totalcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PS_L_RDR_PUBL_ETCRDR_PUBLCURRecord rec = new PS_L_RDR_PUBL_ETCRDR_PUBLCURRecord();
	...
	public String rdr_publcurOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			PS_L_RDR_PUBL_ETCRDR_PUBLCURRecord rec = (PS_L_RDR_PUBL_ETCRDR_PUBLCURRecord)rdr_publcur.get(i);
...
<%
	PS_L_RDR_PUBL_ETCDataSet ds = (PS_L_RDR_PUBL_ETCDataSet)request.getAttribute("ds");
%>
