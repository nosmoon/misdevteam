...
public class PS_U_RDR_EXTNDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call SP_PS_U_RDR_EXTN( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PS_U_RDR_EXTNDM dm = (PS_U_RDR_EXTNDM)bdm;
		...
		cstmt.setLong(9, dm.qty);
		cstmt.setString(10, dm.rshpclsfcd);
		cstmt.setString(11, dm.aplcpersnm);
		cstmt.setString(12, dm.aplcperstel_no1);
		cstmt.setString(13, dm.aplcperstel_no2);
		cstmt.setString(14, dm.aplcperstel_no3);
		cstmt.setString(15, dm.aplcpersptph_no1);
		cstmt.setString(16, dm.aplcpersptph_no2);
		cstmt.setString(17, dm.aplcpersptph_no3);
		cstmt.setString(18, dm.aplcpersoffinm);
		cstmt.setString(19, dm.aplcpersposi);
		...
		cstmt.setString(27, dm.rdrprn);
		cstmt.setString(28, dm.rdremail);
		cstmt.setString(29, dm.rdrmembseq);
		cstmt.setString(30, dm.rdrposi);
		cstmt.setString(31, dm.rdroffinm);
		cstmt.setString(32, dm.rdroffitel_no1);
		cstmt.setString(33, dm.rdroffitel_no2);
		cstmt.setString(34, dm.rdroffitel_no3);
		cstmt.setString(35, dm.dlvzip);
		cstmt.setString(36, dm.dlvaddr);
		cstmt.setString(37, dm.dlvdtlsaddr);
		cstmt.setString(38, dm.acqclsf);
		cstmt.setString(39, dm.pymtflnm);
		cstmt.setString(40, dm.pymtoffinm);
		cstmt.setString(41, dm.pymtposi);
		cstmt.setString(42, dm.pymttel_no1);
		cstmt.setString(43, dm.pymttel_no2);
		cstmt.setString(44, dm.pymttel_no3);
		cstmt.setString(45, dm.pymtptph_no1);
		cstmt.setString(46, dm.pymtptph_no2);
		cstmt.setString(47, dm.pymtptph_no3);
		cstmt.setString(48, dm.pymtzip);
		cstmt.setString(49, dm.pymtaddr);
		cstmt.setString(50, dm.pymtdtlsaddr);
		cstmt.setString(51, dm.rcpmmthd);
		cstmt.setString(52, dm.asinbocd);
		cstmt.setString(53, dm.asinresn);
		cstmt.setString(54, dm.resiclsfcd);
		cstmt.setString(55, dm.resitypecd);
		cstmt.setString(56, dm.remk);
		cstmt.setString(57, dm.rdr_extnclsfcd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ps.pbs.reader.ds.PS_U_RDR_EXTNDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
...
/* 작성시간 : Mon May 28 14:34:21 KST 2007 */