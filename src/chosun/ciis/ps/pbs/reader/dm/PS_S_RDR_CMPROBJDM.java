...
public class PS_S_RDR_CMPROBJDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PS_S_RDR_CMPROBJDM(){}
	public PS_S_RDR_CMPROBJDM(String cmpycd, String rdr_no, String medicd, String termsubsno){
		this.cmpycd = cmpycd;
		this.rdr_no = rdr_no;
		this.medicd = medicd;
	...
	public String getSQL(){
		 return "{ call SP_PS_S_RDR_CMPROBJ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PS_S_RDR_CMPROBJDM dm = (PS_S_RDR_CMPROBJDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ps.pbs.reader.ds.PS_S_RDR_CMPROBJDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
