...
public class PS_L_RDR_PUBL_SEARCHDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String empnm_yn;
	public String empnm;

	public PS_L_RDR_PUBL_SEARCHDM(){}
	public PS_L_RDR_PUBL_SEARCHDM(String cmpycd, String incmgpers, String aplcdtfr, String aplcdtto, String medicd, String rdr_no, String rdrnm, String asinbocd, String prn1, String prn2, String tel_kubun, String rdrtel_no1, String rdrtel_no2, String rdrtel_no3, String addr, String email, long pageno, long pagesize, String flnm_yn, String empnm_yn, String empnm){
		this.cmpycd = cmpycd;
	...
	public void setEmpnm_yn(String empnm_yn){
		this.empnm_yn = empnm_yn;
	}
	...
	public String getEmpnm_yn(){
		return this.empnm_yn;
	}
	...
	public String getSQL(){
		 return "{ call SP_PS_L_RDR_PUBL_SEARCH( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PS_L_RDR_PUBL_SEARCHDM dm = (PS_L_RDR_PUBL_SEARCHDM)bdm;
		...
		cstmt.setString(22, dm.empnm_yn);
		cstmt.setString(23, dm.empnm);
		cstmt.registerOutParameter(24, Types.INTEGER);
		cstmt.registerOutParameter(25, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ps.pbs.reader.ds.PS_L_RDR_PUBL_SEARCHDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
...
String empnm_yn = req.getParameter("empnm_yn");
if( empnm_yn == null){
	System.out.println(this.toString+" : empnm_yn is null" );
}else{
	System.out.println(this.toString+" : empnm_yn is "+empnm_yn );
}
...
String empnm_yn = Util.checkString(req.getParameter("empnm_yn"));
...
String empnm_yn = Util.Uni2Ksc(Util.checkString(req.getParameter("empnm_yn")));
