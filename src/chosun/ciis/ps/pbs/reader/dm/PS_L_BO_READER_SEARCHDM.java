...
public class PS_L_BO_READER_SEARCHDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PS_L_BO_READER_SEARCHDM(){}
	public PS_L_BO_READER_SEARCHDM(String cmpycd, String medicd, String gubun1, String nmtext, String rdr_no, String gubun2, String phone1, String phone2, String phone3, String gubun3, String dlvdtlsaddr, String sendmthd, String deptcd, String areacd, String bocd, long pageno, long pagesize){
		this.cmpycd = cmpycd;
		this.medicd = medicd;
		this.gubun1 = gubun1;
		this.nmtext = nmtext;
	...
	public String getSQL(){
		 return "{ call SP_PS_L_BO_READER_SEARCH( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PS_L_BO_READER_SEARCHDM dm = (PS_L_BO_READER_SEARCHDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ps.pbs.reader.ds.PS_L_BO_READER_SEARCHDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
