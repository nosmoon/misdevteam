...
public class CO_U_RDRCRTS_GRAD_GRNTDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String cashrcptstat;
	public String chkseqarr;

	public CO_U_RDRCRTS_GRAD_GRNTDM(){}
	public CO_U_RDRCRTS_GRAD_GRNTDM(String cmpycd, String bocd, String incmgpers, String callpgclsf, String onlmembseqarr, String regdtarr, String regnoarr, String bocdarr, String medicdarr, String rdr_noarr, String rdrgradarr, String dtlsprocstatarr, String errresncdarr, String cashrcptstat, String chkseqarr){
		this.cmpycd = cmpycd;
		this.bocd = bocd;
		...
		this.cashrcptstat = cashrcptstat;
	...
	public void setCashrcptstat(String cashrcptstat){
		this.cashrcptstat = cashrcptstat;
	}
	...
	public String getCashrcptstat(){
		return this.cashrcptstat;
	}
	...
	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		...
		cstmt.setString(16, dm.cashrcptstat);
		cstmt.setString(17, dm.chkseqarr);
		cstmt.registerOutParameter(18, Types.VARCHAR);
		cstmt.registerOutParameter(19, Types.VARCHAR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ps.pbs.reader.ds.CO_U_RDRCRTS_GRAD_GRNTDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
...
String cashrcptstat = req.getParameter("cashrcptstat");
if( cashrcptstat == null){
	System.out.println(this.toString+" : cashrcptstat is null" );
}else{
	System.out.println(this.toString+" : cashrcptstat is "+cashrcptstat );
}
...
String cashrcptstat = Util.checkString(req.getParameter("cashrcptstat"));
