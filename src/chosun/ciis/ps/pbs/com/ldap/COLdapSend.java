	...
	public String sendFile (String userid,String newpass)
	{
		...
		try {
			...
			*/
            ...
            // /was/publishdept/applications/www/WEB-INF/classes/pbs/com/ldap/OLAP/bak 이 있어야 함
	...
	*/
	public static String getProp (String var)
	{
		...
		try {
            ...
            FileInputStream fin = new FileInputStream("/was/publishdept/applications/www/WEB-INF/classes/pbs/com/ldap/olap.properties");
