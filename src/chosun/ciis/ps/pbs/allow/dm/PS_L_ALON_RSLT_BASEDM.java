...
public class PS_L_ALON_RSLT_BASEDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PS_L_ALON_RSLT_BASEDM(){}
	public PS_L_ALON_RSLT_BASEDM(String cmpycd, String bocd, String aloncd, String boemp_no_from, String boemp_no_to, String deptcd, String dutycd, long pageno, long pagesize){
		this.cmpycd = cmpycd;
		this.bocd = bocd;
		this.aloncd = aloncd;
	...
	public String getSQL(){
		 return "{ call SP_PS_L_ALON_RSLT_BASE( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PS_L_ALON_RSLT_BASEDM dm = (PS_L_ALON_RSLT_BASEDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ps.pbs.allow.ds.PS_L_ALON_RSLT_BASEDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
