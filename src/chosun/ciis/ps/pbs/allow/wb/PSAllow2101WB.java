...
public class PSAllow2101WB {
    ...
    public void selectCodeList(HttpServletRequest req, HttpServletResponse res) throws AppException {
        ...
        PSAllow2101EJBHome home = (PSAllow2101EJBHome) JNDIManager.getInstance().getHome("PSAllow2101EJB");
        try {

            PSAllow2101EJB ejb = home.create();
