...
public class PSAllow1601WB {
     ...
     * @return void
     */
    public void selectCodeList(HttpServletRequest req, HttpServletResponse res) throws
        AppException {
        ...
        PSAllow1601EJBHome home = (PSAllow1601EJBHome) JNDIManager.getInstance().
            getHome("PSAllow1601EJB");
        try {

            PSAllow1601EJB ejb = home.create();
     ...
     * @return void
     **/
    public void selectRsltList(HttpServletRequest req, HttpServletResponse res) throws
        AppException {
        ...
        String boemp_no_from = Util.checkString(req.getParameter(
            "boemp_no_from"));
     ...
     * @return void
     **/
    public void accessAlon(HttpServletRequest req, HttpServletResponse res) throws
        AppException {
        ...
        String realprsntdds = Util.checkString(req.getParameter(
            "ls_realprsntdds"));
