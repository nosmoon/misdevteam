...
public class PSAllow1501WB {
    ...
    public void selectCodeList(HttpServletRequest req, HttpServletResponse res) throws AppException {
        ...
        PS_S_EMP_ALONDM dm = new PS_S_EMP_ALONDM(); // DM 값을 Setting한다.

        dm.setCmpycd(cmpycd);
        dm.setIncmgpers(incmgpers);

        PSAllow1501EJBHome home = (PSAllow1501EJBHome) JNDIManager.getInstance().getHome("PSAllow1501EJB");
        try {

            PSAllow1501EJB ejb = home.create();
    ...
    public void selectRsltList(HttpServletRequest req, HttpServletResponse res) throws AppException {
        ...
        PS_L_ALON_RSLTDM dm = new PS_L_ALON_RSLTDM(); // DM 값을 Setting한다.
        dm.setCmpycd(cmpycd);
        dm.setBocd(bocd);
        dm.setAloncd(aloncd);
    ...
    public void accessAlon(HttpServletRequest req, HttpServletResponse res) throws AppException {
        ...
        PS_A_ALONRSLTDM dm = new PS_A_ALONRSLTDM(); // DM 값을 Setting한다.
        dm.setCmpycd(cmpycd);
        dm.setIncmgpers(incmgpers);
        dm.setBocd(bocd);
        dm.setAloncd(aloncd);
