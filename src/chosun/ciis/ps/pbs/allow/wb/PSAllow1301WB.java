...
public class PSAllow1301WB {
    ...
    public void selectCodeList(HttpServletRequest req, HttpServletResponse res) throws AppException {
        ...
        PSAllow1301EJBHome home = (PSAllow1301EJBHome) JNDIManager.getInstance().getHome("PSAllow1301EJB");
        try {

            PSAllow1301EJB ejb = home.create();
