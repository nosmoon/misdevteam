...
public class PS_L_BO_SRCHDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curbolist = new ArrayList();
	public String errcode;
	public String errmsg;

	public PS_L_BO_SRCHDataSet(){}
	public PS_L_BO_SRCHDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			PS_L_BO_SRCHCURBOLISTRecord rec = new PS_L_BO_SRCHCURBOLISTRecord();
			...
			rec.bospcfclsfnm = Util.checkString(rset0.getString("bospcfclsfnm"));
	...
	public String curbolistOptHtml(String selected){
		...
		for(int i=0; i<size; i++){
			PS_L_BO_SRCHCURBOLISTRecord rec = (PS_L_BO_SRCHCURBOLISTRecord)curbolist.get(i);
...
<%= curbolistRec.cntrstatnm%>
<%= curbolistRec.bospcfclsfnm%>
----------------------------------------------------------------------------------------------------*/


/* 작성시간 : Tue May 08 11:23:19 KST 2007 */