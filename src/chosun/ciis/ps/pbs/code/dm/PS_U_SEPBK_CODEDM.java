...
public class PS_U_SEPBK_CODEDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PS_U_SEPBK_CODEDM(){}
	public PS_U_SEPBK_CODEDM(String cmpycd, String medicd, String mediser_no, String medi_clsf, String sep_bookcdnm, String issuclsf, String basiyymm, long uprc, long subsuprc, long dcrate, String contclascd, String author, String type, String std, long page, String covermodl, String reg_dt, long extdtms, String absenceyn, String absencedt, String absenceprocdt, String chgpers, long bundunit, long unitmidlqunt, long pjbasimidlqunt, String sericd, String memo){
		this.cmpycd = cmpycd;
		this.medicd = medicd;
	...
	public String getSQL(){
		 return "{ call SP_PS_U_SEPBK_CODE( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PS_U_SEPBK_CODEDM dm = (PS_U_SEPBK_CODEDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ps.pbs.code.ds.PS_U_SEPBK_CODEDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
...
/* 작성시간 : Tue Sep 21 15:09:50 KST 2004 */