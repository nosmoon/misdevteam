...
public class PS_I_MIDI_UPRCDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public PS_I_MIDI_UPRCDM(){}
	public PS_I_MIDI_UPRCDM(String cmpycd, String bocd, String medicd, String acpnclsf, String acpntype, String natnareaclsf, String cntryys, String aplydt, long sell_amt, long busnalon, long uprc, long extn_cnt, String remk, String incmgpers){
		this.cmpycd = cmpycd;
		this.bocd = bocd;
		this.medicd = medicd;
	...
	public String getSQL(){
		 return "{ call SP_PS_I_MIDI_UPRC( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		PS_I_MIDI_UPRCDM dm = (PS_I_MIDI_UPRCDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ps.pbs.code.ds.PS_I_MIDI_UPRCDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
...
/* 작성시간 : Wed Aug 24 15:55:08 KST 2005 */