...
public class EN_EVNT_1203_LCURLIST1Record extends java.lang.Object implements java.io.Serializable{
	...
	public int reven_budg_amt;
	public int expn_budg_amt;
	public int enpr_reven_stlm_amt;
	public int enpr_expn_stlm_amt;
	public int acct_reven_stlm_amt;
	public int acct_expn_stlm_amt;
	...
	public EN_EVNT_1203_LCURLIST1Record(){}
	...
	public void setReven_budg_amt(int reven_budg_amt){
		this.reven_budg_amt = reven_budg_amt;
	}

	public void setExpn_budg_amt(int expn_budg_amt){
		this.expn_budg_amt = expn_budg_amt;
	}

	public void setEnpr_reven_stlm_amt(int enpr_reven_stlm_amt){
		this.enpr_reven_stlm_amt = enpr_reven_stlm_amt;
	}

	public void setEnpr_expn_stlm_amt(int enpr_expn_stlm_amt){
		this.enpr_expn_stlm_amt = enpr_expn_stlm_amt;
	}

	public void setAcct_reven_stlm_amt(int acct_reven_stlm_amt){
		this.acct_reven_stlm_amt = acct_reven_stlm_amt;
	}

	public void setAcct_expn_stlm_amt(int acct_expn_stlm_amt){
	...
	public int getReven_budg_amt(){
		return this.reven_budg_amt;
	}

	public int getExpn_budg_amt(){
		return this.expn_budg_amt;
	}

	public int getEnpr_reven_stlm_amt(){
		return this.enpr_reven_stlm_amt;
	}

	public int getEnpr_expn_stlm_amt(){
		return this.enpr_expn_stlm_amt;
	}

	public int getAcct_reven_stlm_amt(){
		return this.acct_reven_stlm_amt;
	}

	public int getAcct_expn_stlm_amt(){
