...
public class EN_EVNT_1003_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public EN_EVNT_1003_SDM(){}
	public EN_EVNT_1003_SDM(String cmpy_cd, String evnt_yy, String evnt_cd, String evnt_seq){
	...
	public String getSQL(){
		 return "{ call MISENP.SP_EN_EVNT_1003_S(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		EN_EVNT_1003_SDM dm = (EN_EVNT_1003_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.en.evnt.ds.EN_EVNT_1003_SDataSet();
	}
