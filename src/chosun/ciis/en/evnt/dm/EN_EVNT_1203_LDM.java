...
public class EN_EVNT_1203_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public EN_EVNT_1203_LDM(){}
	public EN_EVNT_1203_LDM(String cmpy_cd, String evnt_yy, String evnt_cd, String evnt_seq){
	...
	public String getSQL(){
		 return "{ call MISENP.SP_EN_EVNT_1203_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		EN_EVNT_1203_LDM dm = (EN_EVNT_1203_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.en.evnt.ds.EN_EVNT_1203_LDataSet();
	}
