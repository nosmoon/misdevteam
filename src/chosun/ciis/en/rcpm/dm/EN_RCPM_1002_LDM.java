...
public class EN_RCPM_1002_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String rcpm_shet_kind;
	public String rcpm_shet_no;

	public EN_RCPM_1002_LDM(){}
	public EN_RCPM_1002_LDM(String cmpy_cd, String rcpm_shet_kind, String rcpm_shet_no){
	...
	public String getSQL(){
		 return "{ call MISENP.SP_EN_RCPM_1002_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		EN_RCPM_1002_LDM dm = (EN_RCPM_1002_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.en.rcpm.ds.EN_RCPM_1002_LDataSet();
	}
