...
public class EN_COMM_1202_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String evnt_cd;

	public EN_COMM_1202_LDM(){}
	public EN_COMM_1202_LDM(String cmpy_cd, String evnt_cd){
	...
	public String getSQL(){
		 return "{ call MISENP.SP_EN_COMM_1202_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		EN_COMM_1202_LDM dm = (EN_COMM_1202_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.en.comm.ds.EN_COMM_1202_LDataSet();
	}
