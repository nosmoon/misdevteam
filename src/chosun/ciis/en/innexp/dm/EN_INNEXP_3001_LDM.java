...
public class EN_INNEXP_3001_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public EN_INNEXP_3001_LDM(){}
	public EN_INNEXP_3001_LDM(String cmpy_cd, String evnt_yy, String occr_dt_fr, String occr_dt_to){
	...
	public String getSQL(){
		 return "{ call MISENP.SP_EN_INNEXP_3001_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		EN_INNEXP_3001_LDM dm = (EN_INNEXP_3001_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.en.innexp.ds.EN_INNEXP_3001_LDataSet();
	}
