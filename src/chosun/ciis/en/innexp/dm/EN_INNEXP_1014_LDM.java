...
public class EN_INNEXP_1014_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public EN_INNEXP_1014_LDM(){}
	public EN_INNEXP_1014_LDM(String cmpy_cd, String evnt_yy, String evnt_cd, String evnt_seq){
	...
	public String getSQL(){
		 return "{ call MISENP.SP_EN_INNEXP_1014_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		EN_INNEXP_1014_LDM dm = (EN_INNEXP_1014_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.en.innexp.ds.EN_INNEXP_1014_LDataSet();
	}
