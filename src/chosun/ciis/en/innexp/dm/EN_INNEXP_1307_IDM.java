...
public class EN_INNEXP_1307_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public EN_INNEXP_1307_IDM(){}
	public EN_INNEXP_1307_IDM(String cmpy_cd, String clos_dt, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISENP.SP_EN_INNEXP_1307_I(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		EN_INNEXP_1307_IDM dm = (EN_INNEXP_1307_IDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.en.innexp.ds.EN_INNEXP_1307_IDataSet();
	}
...
/* 작성시간 : Tue Dec 19 11:30:04 KST 2017 */