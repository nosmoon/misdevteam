...
public class EN_INNEXP_1012_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String bal_occr_slip_no;

	public EN_INNEXP_1012_LDM(){}
	public EN_INNEXP_1012_LDM(String cmpy_cd, String bal_occr_slip_no){
	...
	public String getSQL(){
		 return "{ call MISENP.SP_EN_INNEXP_1012_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		EN_INNEXP_1012_LDM dm = (EN_INNEXP_1012_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.en.innexp.ds.EN_INNEXP_1012_LDataSet();
	}
