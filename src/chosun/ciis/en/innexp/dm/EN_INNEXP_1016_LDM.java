...
public class EN_INNEXP_1016_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public EN_INNEXP_1016_LDM(){}
	public EN_INNEXP_1016_LDM(String cmpy_cd, String evnt_yy, String evnt_cd, String evnt_seq, String reven_dt){
	...
	public String getSQL(){
		 return "{ call MISENP.SP_EN_INNEXP_1016_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		EN_INNEXP_1016_LDM dm = (EN_INNEXP_1016_LDM)bdm;
		...
		cstmt.setString(7, dm.reven_dt);
		cstmt.registerOutParameter(8, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.en.innexp.ds.EN_INNEXP_1016_LDataSet();
	}
...
/* 작성시간 : Tue May 12 12:56:15 KST 2009 */