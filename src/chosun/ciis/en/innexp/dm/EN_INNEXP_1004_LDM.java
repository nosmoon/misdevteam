...
public class EN_INNEXP_1004_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String evnt_yy;
	public String evnt_cd;

	public EN_INNEXP_1004_LDM(){}
	public EN_INNEXP_1004_LDM(String cmpy_cd, String evnt_yy, String evnt_cd){
	...
	public String getSQL(){
		 return "{ call MISENP.SP_EN_INNEXP_1004_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		EN_INNEXP_1004_LDM dm = (EN_INNEXP_1004_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.en.innexp.ds.EN_INNEXP_1004_LDataSet();
	}
