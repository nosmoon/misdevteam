...
public class EN_INNEXP_1306_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public EN_INNEXP_1306_IDM(){}
	public EN_INNEXP_1306_IDM(String cmpy_cd, String clos_dt, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISENP.SP_EN_INNEXP_1306_I(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		EN_INNEXP_1306_IDM dm = (EN_INNEXP_1306_IDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.en.innexp.ds.EN_INNEXP_1306_IDataSet();
	}
...
/* 작성시간 : Tue Dec 19 11:21:22 KST 2017 */