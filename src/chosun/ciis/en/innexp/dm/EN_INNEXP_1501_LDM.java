...
public class EN_INNEXP_1501_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String occr_dt_fr;
	public String occr_dt_to;

	public EN_INNEXP_1501_LDM(){}
	public EN_INNEXP_1501_LDM(String cmpy_cd, String occr_dt_fr, String occr_dt_to){
	...
	public String getSQL(){
		 return "{ call MISENP.SP_EN_INNEXP_1501_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		EN_INNEXP_1501_LDM dm = (EN_INNEXP_1501_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.en.innexp.ds.EN_INNEXP_1501_LDataSet();
	}
