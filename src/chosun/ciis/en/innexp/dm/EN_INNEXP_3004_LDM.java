...
public class EN_INNEXP_3004_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public EN_INNEXP_3004_LDM(){}
	public EN_INNEXP_3004_LDM(String cmpy_cd, String evnt_yy, String sort_clsf, String occr_dt_fr, String occr_dt_to){
	...
	public String getSQL(){
		 return "{ call MISENP.SP_EN_INNEXP_3004_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		EN_INNEXP_3004_LDM dm = (EN_INNEXP_3004_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.en.innexp.ds.EN_INNEXP_3004_LDataSet();
	}
