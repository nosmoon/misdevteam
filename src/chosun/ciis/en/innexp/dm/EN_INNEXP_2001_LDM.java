...
public class EN_INNEXP_2001_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public EN_INNEXP_2001_LDM(){}
	public EN_INNEXP_2001_LDM(String cmpy_cd, String evnt_yy, String evnt_cd, String evnt_seq, String basi_dt, String dept_cd){
	...
	public String getSQL(){
		 return "{ call MISENP.SP_EN_INNEXP_2001_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		EN_INNEXP_2001_LDM dm = (EN_INNEXP_2001_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.en.innexp.ds.EN_INNEXP_2001_LDataSet();
	}
