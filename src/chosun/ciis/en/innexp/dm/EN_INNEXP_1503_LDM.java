...
public class EN_INNEXP_1503_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public EN_INNEXP_1503_LDM(){}
	public EN_INNEXP_1503_LDM(String cmpy_cd, String occr_dt_f, String occr_dt_t, String clsf, String evnt_yy, String evnt_cd, String evnt_seq, String tab_mode){
	...
	public String getSQL(){
		 return "{ call MISENP.SP_EN_INNEXP_1503_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		EN_INNEXP_1503_LDM dm = (EN_INNEXP_1503_LDM)bdm;
		...
		cstmt.setString(10, dm.tab_mode);
		cstmt.registerOutParameter(11, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.en.innexp.ds.EN_INNEXP_1503_LDataSet();
	}
