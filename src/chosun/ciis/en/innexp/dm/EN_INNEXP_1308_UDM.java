...
public class EN_INNEXP_1308_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String clos_dt;
	public String chg_pers;

	public EN_INNEXP_1308_UDM(){}
	public EN_INNEXP_1308_UDM(String cmpy_cd, String clos_dt, String chg_pers){
	...
	public String getSQL(){
		 return "{ call MISENP.SP_EN_INNEXP_1308_U(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		EN_INNEXP_1308_UDM dm = (EN_INNEXP_1308_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.en.innexp.ds.EN_INNEXP_1308_UDataSet();
	}
...
/* 작성시간 : Tue Dec 19 11:30:27 KST 2017 */