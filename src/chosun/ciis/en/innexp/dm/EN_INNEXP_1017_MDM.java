...
public class EN_INNEXP_1017_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public EN_INNEXP_1017_MDM(){}
	public EN_INNEXP_1017_MDM(String cmpy_cd, String evnt_yy, String evnt_cd, String evnt_seq){
	...
	public String getSQL(){
		 return "{ call MISENP.SP_EN_INNEXP_1017_M(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		EN_INNEXP_1017_MDM dm = (EN_INNEXP_1017_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.en.innexp.ds.EN_INNEXP_1017_MDataSet();
	}
