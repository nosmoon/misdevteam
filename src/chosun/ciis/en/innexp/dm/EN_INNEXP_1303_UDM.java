...
public class EN_INNEXP_1303_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String clos_dt;
	public String chg_pers;

	public EN_INNEXP_1303_UDM(){}
	public EN_INNEXP_1303_UDM(String cmpy_cd, String clos_dt, String chg_pers){
	...
	public String getSQL(){
		 return "{ call MISENP.SP_EN_INNEXP_1303_U(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		EN_INNEXP_1303_UDM dm = (EN_INNEXP_1303_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.en.innexp.ds.EN_INNEXP_1303_UDataSet();
	}
...
/* 작성시간 : Thu May 07 19:45:33 KST 2009 */