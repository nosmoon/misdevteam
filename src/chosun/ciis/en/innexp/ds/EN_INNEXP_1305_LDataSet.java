...
public class EN_INNEXP_1305_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public EN_INNEXP_1305_LDataSet(){}
	public EN_INNEXP_1305_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			EN_INNEXP_1305_LCURLISTRecord rec = new EN_INNEXP_1305_LCURLISTRecord();
			...
			rec.clos_type = Util.checkString(rset0.getString("clos_type"));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		EN_INNEXP_1305_LCURLISTRecord curlistRec = (EN_INNEXP_1305_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
