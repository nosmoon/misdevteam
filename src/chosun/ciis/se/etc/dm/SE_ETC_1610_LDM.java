...
public class SE_ETC_1610_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_ETC_1610_LDM(){}
	public SE_ETC_1610_LDM(String cmpy_cd, String yymm, String team, String part, String area, String incmg_pers, String schlevel){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_ETC_1610_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_ETC_1610_LDM dm = (SE_ETC_1610_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.etc.ds.SE_ETC_1610_LDataSet();
	}
