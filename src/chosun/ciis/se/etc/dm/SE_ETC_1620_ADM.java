...
public class SE_ETC_1620_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_ETC_1620_ADM(){}
	public SE_ETC_1620_ADM(String cmpy_cd, String selldeptcd, String yymm, String clos_yn, String areagb, String area_cd, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_ETC_1620_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_ETC_1620_ADM dm = (SE_ETC_1620_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.etc.ds.SE_ETC_1620_ADataSet();
	}
