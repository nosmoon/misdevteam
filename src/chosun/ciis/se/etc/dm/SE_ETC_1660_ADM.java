...
public class SE_ETC_1660_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_ETC_1660_ADM(){}
	public SE_ETC_1660_ADM(String cmpy_cd, String yymm, String house_qty_rate, String bnsite_qty_rate, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_ETC_1660_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_ETC_1660_ADM dm = (SE_ETC_1660_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.yymm);
		cstmt.setString(5, dm.house_qty_rate);
		cstmt.setString(6, dm.bnsite_qty_rate);
		cstmt.setString(7, dm.incmg_pers);
		cstmt.setString(8, dm.incmg_pers_ip);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.etc.ds.SE_ETC_1660_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("house_qty_rate = [" + getHouse_qty_rate() + "]");
		System.out.println("bnsite_qty_rate = [" + getBnsite_qty_rate() + "]");
