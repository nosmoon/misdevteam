...
public class SE_ETC_1340_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_ETC_1340_ADM(){}
	public SE_ETC_1340_ADM(String cmpy_cd, String yymm, String team, String part, String area, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_ETC_1340_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_ETC_1340_ADM dm = (SE_ETC_1340_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.etc.ds.SE_ETC_1340_ADataSet();
	}
