...
public class SE_ETC_1750_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_ETC_1750_UDM(){}
	public SE_ETC_1750_UDM(String cmpy_cd, String mode, String yymm, String pay_seq, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_ETC_1750_U(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_ETC_1750_UDM dm = (SE_ETC_1750_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.etc.ds.SE_ETC_1750_UDataSet();
	}
...
/* 작성시간 : Thu Jul 11 15:08:56 KST 2013 */