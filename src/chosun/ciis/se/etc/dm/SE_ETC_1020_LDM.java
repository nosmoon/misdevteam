...
public class SE_ETC_1020_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_ETC_1020_LDM(){}
	public SE_ETC_1020_LDM(String cmpy_cd, String yymm, String pay_seq, String dept_cd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_ETC_1020_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_ETC_1020_LDM dm = (SE_ETC_1020_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.etc.ds.SE_ETC_1020_LDataSet();
	}
