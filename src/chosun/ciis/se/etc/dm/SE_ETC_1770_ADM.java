...
public class SE_ETC_1770_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_ETC_1770_ADM(){}
	public SE_ETC_1770_ADM(String cmpy_cd, String mode, String yymm, String pay_seq, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_ETC_1770_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_ETC_1770_ADM dm = (SE_ETC_1770_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.etc.ds.SE_ETC_1770_ADataSet();
	}
...
/* 작성시간 : Thu Jul 11 15:27:06 KST 2013 */