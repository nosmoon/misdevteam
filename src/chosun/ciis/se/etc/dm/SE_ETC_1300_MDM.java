...
public class SE_ETC_1300_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_ETC_1300_MDM(){}
	public SE_ETC_1300_MDM(String cmpy_cd, String auth_gb, String incmg_pers, String base_dt, String feat_clsf){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_ETC_1300_M(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_ETC_1300_MDM dm = (SE_ETC_1300_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.etc.ds.SE_ETC_1300_MDataSet();
	}
