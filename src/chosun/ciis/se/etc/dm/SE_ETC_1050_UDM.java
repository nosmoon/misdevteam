...
public class SE_ETC_1050_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_ETC_1050_UDM(){}
	public SE_ETC_1050_UDM(String cmpy_cd, String mode, String yymm, String pay_seq, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_SE_ETC_1050_U( ?, ?, ?, ?, ?, ?, ?, ? ) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_ETC_1050_UDM dm = (SE_ETC_1050_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.etc.ds.SE_ETC_1050_UDataSet();
	}
