...
public class SE_ETC_1510_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_ETC_1510_LDM(){}
	public SE_ETC_1510_LDM(String cmpy_cd, String issu_dt, String team, String part, String area, String incmg_pers, String schlevel){
	...
	public String getSQL(){
		 return "{ call SP_SE_ETC_1510_L( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_ETC_1510_LDM dm = (SE_ETC_1510_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.etc.ds.SE_ETC_1510_LDataSet();
	}
