...
public class SE_ETC_1040_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public void setDdqty_yn(String ddqty_yn){
		this.ddqty_yn = ddqty_yn;
	}
	...
	public String getDdqty_yn(){
		return this.ddqty_yn;
	}
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_ETC_1040_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_ETC_1040_ADM dm = (SE_ETC_1040_ADM)bdm;
		...
		cstmt.setString(18, dm.ddqty_yn);
		cstmt.setString(19, dm.mode_sub);
		cstmt.setString(20, dm.yymm_sub);
		cstmt.setString(21, dm.pay_seq_sub);
		cstmt.setString(22, dm.pay_ptcr_seq);
		cstmt.setString(23, dm.bo_cd);
		cstmt.setString(24, dm.bo_seq);
		cstmt.setString(25, dm.dept_cd_sub);
		cstmt.setString(26, dm.sub_dept_cd);
		cstmt.setString(27, dm.area_cd);
		cstmt.setString(28, dm.chrg_pers);
		cstmt.setString(29, dm.tax_yn_sub);
		cstmt.setString(30, dm.prn);
		cstmt.setString(31, dm.recp_pers_nm);
		cstmt.setString(32, dm.medi_cd);
		cstmt.setString(33, dm.qty);
		cstmt.setString(34, dm.uprc_sub);
		cstmt.setString(35, dm.amt);
		cstmt.setString(36, dm.incm_tax);
		cstmt.setString(37, dm.res_tax);
		cstmt.setString(38, dm.acct_no);
		cstmt.setString(39, dm.bank_cd);
		cstmt.setString(40, dm.rmks);
		cstmt.setString(41, dm.incmg_pers_ip);
		cstmt.setString(42, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.etc.ds.SE_ETC_1040_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("ddqty_yn = [" + getDdqty_yn() + "]");
...
String ddqty_yn = req.getParameter("ddqty_yn");
if( ddqty_yn == null){
	System.out.println(this.toString+" : ddqty_yn is null" );
}else{
	System.out.println(this.toString+" : ddqty_yn is "+ddqty_yn );
}
...
String ddqty_yn = Util.checkString(req.getParameter("ddqty_yn"));
...
String ddqty_yn = Util.Uni2Ksc(Util.checkString(req.getParameter("ddqty_yn")));
...
/* 작성시간 : Thu Aug 24 13:48:30 KST 2017 */