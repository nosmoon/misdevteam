...
public class SE_ETC_1530_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_ETC_1530_ADM(){}
	public SE_ETC_1530_ADM(String cmpy_cd, String selldeptcd, String issu_dt, String clos_yn, String areagb, String area_cd, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call SP_SE_ETC_1530_A( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_ETC_1530_ADM dm = (SE_ETC_1530_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.etc.ds.SE_ETC_1530_ADataSet();
	}
