...
public class SE_ETC_1110_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_ETC_1110_LDM(){}
	public SE_ETC_1110_LDM(String cmpy_cd, String team, String part, String area, String searchform, String bgn_yymm, String end_yymm, String pay_obj_clsf, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_ETC_1110_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_ETC_1110_LDM dm = (SE_ETC_1110_LDM)bdm;
		...
		cstmt.setString(7, dm.searchform);
		cstmt.setString(8, dm.bgn_yymm);
		cstmt.setString(9, dm.end_yymm);
		cstmt.setString(10, dm.pay_obj_clsf);
		cstmt.setString(11, dm.incmg_pers);
		cstmt.registerOutParameter(12, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.etc.ds.SE_ETC_1110_LDataSet();
	}
