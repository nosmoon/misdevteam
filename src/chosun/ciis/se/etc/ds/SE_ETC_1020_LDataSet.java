...
public class SE_ETC_1020_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SE_ETC_1020_LDataSet(){}
	public SE_ETC_1020_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SE_ETC_1020_LCURLISTRecord rec = new SE_ETC_1020_LCURLISTRecord();
...
<%
	SE_ETC_1020_LDataSet ds = (SE_ETC_1020_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		SE_ETC_1020_LCURLISTRecord curlistRec = (SE_ETC_1020_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
