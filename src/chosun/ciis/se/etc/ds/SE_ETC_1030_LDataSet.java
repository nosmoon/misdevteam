...
public class SE_ETC_1030_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SE_ETC_1030_LDataSet(){}
	public SE_ETC_1030_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SE_ETC_1030_LCURLISTRecord rec = new SE_ETC_1030_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		SE_ETC_1030_LCURLISTRecord curlistRec = (SE_ETC_1030_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Mon Jun 29 11:53:46 KST 2009 */