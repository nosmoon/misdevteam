...
public class SE_SAL_2310_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_SAL_2310_SDM(){}
	public SE_SAL_2310_SDM(String cmpy_cd, String yymm, String team, String part, String area, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_SE_SAL_2310_S( ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_SAL_2310_SDM dm = (SE_SAL_2310_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.sal.ds.SE_SAL_2310_SDataSet();
	}
