...
public class SE_SAL_2800_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String widr_yymm;

	public SE_SAL_2800_LDM(){}
	public SE_SAL_2800_LDM(String cmpy_cd, String widr_yymm){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_SAL_2800_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_SAL_2800_LDM dm = (SE_SAL_2800_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.sal.ds.SE_SAL_2800_LDataSet();
	}
