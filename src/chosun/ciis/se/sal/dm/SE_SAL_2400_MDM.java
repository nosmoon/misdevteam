...
public class SE_SAL_2400_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_SAL_2400_MDM(){}
	public SE_SAL_2400_MDM(String cmpy_cd, String auth_gb, String incmg_pers, String base_dt, String feat_clsf){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_SAL_2400_M(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_SAL_2400_MDM dm = (SE_SAL_2400_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.sal.ds.SE_SAL_2400_MDataSet();
	}
