...
public class SE_SAL_2810_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String bo_cd;
	public String bo_seq;

	public SE_SAL_2810_LDM(){}
	public SE_SAL_2810_LDM(String cmpy_cd, String bo_cd, String bo_seq){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_SAL_2810_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_SAL_2810_LDM dm = (SE_SAL_2810_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.sal.ds.SE_SAL_2810_LDataSet();
	}
