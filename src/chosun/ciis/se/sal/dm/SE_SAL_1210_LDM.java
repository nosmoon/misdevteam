...
public class SE_SAL_1210_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_SAL_1210_LDM(){}
	public SE_SAL_1210_LDM(String cmpy_cd, String bgn_yymm, String end_yymm, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_SE_SAL_1210_L( ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_SAL_1210_LDM dm = (SE_SAL_1210_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.sal.ds.SE_SAL_1210_LDataSet();
	}
