...
public class SE_SAL_2610_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_SAL_2610_LDM(){}
	public SE_SAL_2610_LDM(String cmpy_cd, String issu_dt, String team, String part, String area, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_SAL_2610_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_SAL_2610_LDM dm = (SE_SAL_2610_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.sal.ds.SE_SAL_2610_LDataSet();
	}
