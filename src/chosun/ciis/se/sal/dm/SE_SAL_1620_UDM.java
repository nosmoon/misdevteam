...
public class SE_SAL_1620_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_SAL_1620_UDM(){}
	public SE_SAL_1620_UDM(String cmpy_cd, String mode, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String prof_type_cd, String issu_clsf, String make_dt, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_SE_SAL_1620_U( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_SAL_1620_UDM dm = (SE_SAL_1620_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.sal.ds.SE_SAL_1620_UDataSet();
	}
