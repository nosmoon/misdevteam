...
public class SE_SAL_2210_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_SAL_2210_LDM(){}
	public SE_SAL_2210_LDM(String cmpy_cd, String yymm, String team, String part, String area, String searchgubun, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_SE_SAL_2210_L( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_SAL_2210_LDM dm = (SE_SAL_2210_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.sal.ds.SE_SAL_2210_LDataSet();
	}
