...
public class SE_SAL_1410_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_SAL_1410_SDM(){}
	public SE_SAL_1410_SDM(String cmpy_cd, String yymm, String bo_cd, String bo_seq, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_SAL_1410_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_SAL_1410_SDM dm = (SE_SAL_1410_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.sal.ds.SE_SAL_1410_SDataSet();
	}
