...
public class SE_SAL_1780_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_SAL_1780_ADM(){}
	public SE_SAL_1780_ADM(String cmpy_cd, String yymm, String gubun, String vat_gubun, String correct_gubun, String tmsg_type, String stmt_clsf, String pers_clsf, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_SE_SAL_1780_A( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_SAL_1780_ADM dm = (SE_SAL_1780_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.sal.ds.SE_SAL_1780_ADataSet();
	}
