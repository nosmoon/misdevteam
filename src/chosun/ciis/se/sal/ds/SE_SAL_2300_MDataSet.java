...
public class SE_SAL_2300_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SE_SAL_2300_MDataSet(){}
	public SE_SAL_2300_MDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SE_SAL_2300_MTEAMLISTRecord rec = new SE_SAL_2300_MTEAMLISTRecord();
		...
		while(rset1.next()){
			SE_SAL_2300_MPARTLISTRecord rec = new SE_SAL_2300_MPARTLISTRecord();
		...
		while(rset2.next()){
			SE_SAL_2300_MAREALISTRecord rec = new SE_SAL_2300_MAREALISTRecord();
