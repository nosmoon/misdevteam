...
public class SE_SAL_2320_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;
	public String title;

	public SE_SAL_2320_LDataSet(){}
	public SE_SAL_2320_LDataSet(String errcode, String errmsg, String title){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SE_SAL_2320_LCURLISTRecord rec = new SE_SAL_2320_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		SE_SAL_2320_LCURLISTRecord curlistRec = (SE_SAL_2320_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
