...
public class SE_BOI_2310_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BOI_2310_LDM(){}
	public SE_BOI_2310_LDM(String cmpy_cd, String team_cd, String part_cd, String area_cd, String bo_nm, String yymm, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_BOI_2310_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BOI_2310_LDM dm = (SE_BOI_2310_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.boi.ds.SE_BOI_2310_LDataSet();
	}
