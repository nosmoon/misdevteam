...
public class SE_BOI_2920_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String bo_cd;
	public String bo_seq;

	public SE_BOI_2920_SDM(){}
	public SE_BOI_2920_SDM(String bo_cd, String bo_seq){
		this.bo_cd = bo_cd;
		this.bo_seq = bo_seq;
	}
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_BOI_2920_S(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BOI_2920_SDM dm = (SE_BOI_2920_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.boi.ds.SE_BOI_2920_SDataSet();
	}
