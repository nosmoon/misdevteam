...
public class SE_BOI_1420_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BOI_1420_SDM(){}
	public SE_BOI_1420_SDM(String cmpy_cd, String bo_cd, String bo_seq, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_SE_BOI_1420_S( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BOI_1420_SDM dm = (SE_BOI_1420_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.boi.ds.SE_BOI_1420_SDataSet();
	}
