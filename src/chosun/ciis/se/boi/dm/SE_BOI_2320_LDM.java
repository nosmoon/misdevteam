...
public class SE_BOI_2320_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BOI_2320_LDM(){}
	public SE_BOI_2320_LDM(String cmpy_cd, String team_cd, String part_cd, String area_cd, String bo_nm, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_BOI_2320_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BOI_2320_LDM dm = (SE_BOI_2320_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.boi.ds.SE_BOI_2320_LDataSet();
	}
