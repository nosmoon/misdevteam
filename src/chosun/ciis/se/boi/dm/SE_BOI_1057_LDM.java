...
public class SE_BOI_1057_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BOI_1057_LDM(){}
	public SE_BOI_1057_LDM(String cmpy_cd, String bocd, String basi_yymm, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_BOI_1057_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BOI_1057_LDM dm = (SE_BOI_1057_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.boi.ds.SE_BOI_1057_LDataSet();
	}
