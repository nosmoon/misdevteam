/***************************************************************************************************
* 파일명 : SE_MO_BOI_1010_LDM.java_모바일용
* 기능 : 센터관리-센터정보관리-리스트
* 작성일자 : 2017-02-07
* 작성자 : 장선희
***************************************************************************************************/
...
public class SE_MO_BOI_1010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_MO_BOI_1010_LDM(){}
	public SE_MO_BOI_1010_LDM(String cmpy_cd, String team_cd, String part_cd, String area_cd, String cntr_stat_clsf, String bo_cd, String bo_nm, String bo_head_nm, String bo_reg_clsf, String bo_cntr_dt_fr, String bo_cntr_dt_to, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_SE_MO_BOI_1010_L( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_MO_BOI_1010_LDM dm = (SE_MO_BOI_1010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.boi.ds.SE_MO_BOI_1010_LDataSet();
	}
