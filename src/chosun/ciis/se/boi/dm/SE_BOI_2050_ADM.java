...
public class SE_BOI_2050_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BOI_2050_ADM(){}
	public SE_BOI_2050_ADM(String cmpy_cd, String area_cd, String occr_dt, String slip_clsf, String seq, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_BOI_2050_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BOI_2050_ADM dm = (SE_BOI_2050_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.boi.ds.SE_BOI_2050_ADataSet();
	}
...
/* 작성시간 : Mon May 25 17:03:23 KST 2009 */