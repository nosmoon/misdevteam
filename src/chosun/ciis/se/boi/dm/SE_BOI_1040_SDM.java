...
public class SE_BOI_1040_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String bo_cd;
	public String bo_seq;

	public SE_BOI_1040_SDM(){}
	public SE_BOI_1040_SDM(String cmpy_cd, String bo_cd, String bo_seq){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_BOI_1040_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BOI_1040_SDM dm = (SE_BOI_1040_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.boi.ds.SE_BOI_1040_SDataSet();
	}
