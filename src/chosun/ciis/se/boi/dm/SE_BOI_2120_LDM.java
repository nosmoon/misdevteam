...
public class SE_BOI_2120_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BOI_2120_LDM(){}
	public SE_BOI_2120_LDM(String cmpy_cd, String area_cd, String occr_dt, String slip_clsf, String seq, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_BOI_2120_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BOI_2120_LDM dm = (SE_BOI_2120_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.boi.ds.SE_BOI_2120_LDataSet();
	}
