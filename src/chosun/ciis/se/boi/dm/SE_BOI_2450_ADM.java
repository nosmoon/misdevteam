...
public class SE_BOI_2450_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BOI_2450_ADM(){}
	public SE_BOI_2450_ADM(String cmpy_cd, String occr_dt, String slip_clsf, String seq, String mode_ar, String bo_cdseq_ar, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_BOI_2450_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BOI_2450_ADM dm = (SE_BOI_2450_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.boi.ds.SE_BOI_2450_ADataSet();
	}
...
/* 작성시간 : Thu May 28 11:41:22 KST 2009 */