...
public class SE_BOI_1710_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BOI_1710_LDM(){}
	public SE_BOI_1710_LDM(String cmpy_cd, String team_cd, String part_cd, String area_cd, String rcpm_dt1, String rcpm_dt2, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_BOI_1710_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BOI_1710_LDM dm = (SE_BOI_1710_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.boi.ds.SE_BOI_1710_LDataSet();
	}
