...
public class SE_BOI_1940_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BOI_1940_ADM(){}
	public SE_BOI_1940_ADM(String cmpy_cd, String accflag, String occr_dt, String slip_clsf, String seq, String area_cd, String chrg_pers, String bo_cdseq_g, String bo_cdseq_s, String amt, String leas_sply_amt_unrcp_occr_dt, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_BOI_1940_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BOI_1940_ADM dm = (SE_BOI_1940_ADM)bdm;
		...
		cstmt.setString(10, dm.bo_cdseq_g);
		cstmt.setString(11, dm.bo_cdseq_s);
		cstmt.setString(12, dm.amt);
		cstmt.setString(13, dm.leas_sply_amt_unrcp_occr_dt);
		cstmt.setString(14, dm.incmg_pers);
		cstmt.setString(15, dm.incmg_pers_ip);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.boi.ds.SE_BOI_1940_ADataSet();
	}
...
/* 작성시간 : Fri May 22 17:18:42 KST 2009 */