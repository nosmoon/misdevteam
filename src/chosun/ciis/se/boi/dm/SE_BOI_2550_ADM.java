...
public class SE_BOI_2550_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BOI_2550_ADM(){}
	public SE_BOI_2550_ADM(String cmpy_cd, String area_cd, String occr_dt, String slip_clsf, String seq, String mode_ar, String bo_cdseq_ar, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_BOI_2550_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BOI_2550_ADM dm = (SE_BOI_2550_ADM)bdm;
		...
		cstmt.setString(9, dm.bo_cdseq_ar);
		cstmt.setString(10, dm.incmg_pers);
		cstmt.setString(11, dm.incmg_pers_ip);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.boi.ds.SE_BOI_2550_ADataSet();
	}
...
/* 작성시간 : Fri May 29 09:47:40 KST 2009 */