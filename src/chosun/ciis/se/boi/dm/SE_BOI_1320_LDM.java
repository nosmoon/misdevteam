...
public class SE_BOI_1320_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BOI_1320_LDM(){}
	public SE_BOI_1320_LDM(String cmpy_cd, String team_cd, String part_cd, String area_cd, String chrg_flnm, String cntr_dt1, String cntr_dt2, String bo_feat_clsf, String cntr_stat_clsf, String sido_cd, String adms_dstc_cd, String order_gb, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_SE_BOI_1320_L( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BOI_1320_LDM dm = (SE_BOI_1320_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.boi.ds.SE_BOI_1320_LDataSet();
	}
