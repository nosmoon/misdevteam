...
public class SE_BOI_1930_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SE_BOI_1930_LDataSet(){}
	public SE_BOI_1930_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SE_BOI_1930_LCURLISTRecord rec = new SE_BOI_1930_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		SE_BOI_1930_LCURLISTRecord curlistRec = (SE_BOI_1930_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
