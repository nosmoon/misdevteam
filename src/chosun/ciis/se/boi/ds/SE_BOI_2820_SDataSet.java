...
public class SE_BOI_2820_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SE_BOI_2820_SDataSet(){}
	public SE_BOI_2820_SDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SE_BOI_2820_SCURLISTRecord rec = new SE_BOI_2820_SCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		SE_BOI_2820_SCURLISTRecord curlistRec = (SE_BOI_2820_SCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Wed Nov 02 10:29:40 KST 2016 */