...
public class SE_BAS_1200_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SE_BAS_1200_MDataSet(){}
	public SE_BAS_1200_MDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset1.next()){
			SE_BAS_1200_MMEDILISTRecord rec = new SE_BAS_1200_MMEDILISTRecord();
		...
		while(rset2.next()){
			SE_BAS_1200_MSELLCLSFLISTRecord rec = new SE_BAS_1200_MSELLCLSFLISTRecord();
