...
public class SE_BAS_1210_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BAS_1210_LDM(){}
	public SE_BAS_1210_LDM(String cmpy_cd, String aply_yymm_fr, String aply_yymm_to, String medi_cd, String sell_net_clsf){
	...
	public String getSQL(){
		 return "{ call SP_SE_BAS_1210_L( ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BAS_1210_LDM dm = (SE_BAS_1210_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.bas.ds.SE_BAS_1210_LDataSet();
	}
