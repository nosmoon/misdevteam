...
public class SE_BAS_1100_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BAS_1100_MDM(){}
	public SE_BAS_1100_MDM(String cmpy_cd, String auth_gb, String incmg_pers, String base_dt, String feat_clsf){
	...
	public String getSQL(){
		 return "{ call SP_SE_BAS_1100_M( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? ) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BAS_1100_MDM dm = (SE_BAS_1100_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.bas.ds.SE_BAS_1100_MDataSet();
	}
