...
public class SE_RCP_4040_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_RCP_4040_ADM(){}
	public SE_RCP_4040_ADM(String cmpy_cd, String accflag, String occr_dt, String slip_clsf, String seq, String area_cd, String bank_cd, String rmtt_dt, String rmtt_plac, String mode_ar, String bo_cdseq_ar, String chrg_pers_ar, String net_sale_amt_ar, String sp_amt_ar, String amt1_ar, String amt2_ar, String amt3_ar, String amt_tot_ar, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_RCP_4040_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_RCP_4040_ADM dm = (SE_RCP_4040_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.rcp.ds.SE_RCP_4040_ADataSet();
	}
