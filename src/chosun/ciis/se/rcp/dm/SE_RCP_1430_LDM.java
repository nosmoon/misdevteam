...
public class SE_RCP_1430_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String bo_cdseq;
	public String incmg_pers;

	public SE_RCP_1430_LDM(){}
	public SE_RCP_1430_LDM(String cmpy_cd, String bo_cdseq, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_RCP_1430_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_RCP_1430_LDM dm = (SE_RCP_1430_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.rcp.ds.SE_RCP_1430_LDataSet();
	}
