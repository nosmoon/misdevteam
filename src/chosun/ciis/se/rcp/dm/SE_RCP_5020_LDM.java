...
public class SE_RCP_5020_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_RCP_5020_LDM(){}
	public SE_RCP_5020_LDM(String cmpy_cd, String gubun, String dt, String team, String part, String area, String searchgubun, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_SE_RCP_5020_L( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_RCP_5020_LDM dm = (SE_RCP_5020_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.rcp.ds.SE_RCP_5020_LDataSet();
	}
