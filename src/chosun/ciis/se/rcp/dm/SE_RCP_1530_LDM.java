...
public class SE_RCP_1530_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_RCP_1530_LDM(){}
	public SE_RCP_1530_LDM(String cmpy_cd, String bo_cdseq, String rcpm_dt, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_RCP_1530_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_RCP_1530_LDM dm = (SE_RCP_1530_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.rcp.ds.SE_RCP_1530_LDataSet();
	}
...
/* 작성시간 : Mon May 04 16:18:05 KST 2009 */