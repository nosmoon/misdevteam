...
public class SE_RCP_1740_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_RCP_1740_ADM(){}
	public SE_RCP_1740_ADM(String cmpy_cd, String accflag, String occr_dt, String slip_clsf, String seq, String area_cd, String bank_cd, String mode_ar, String bo_cdseq_ar, String chrg_pers_ar, String acct_tot_ar, String acpt_tot_ar, String amt1_ar, String amt2_ar, String rcpm_shet_no_ar, String rmtt_dt_ar, String rmtt_plac_ar, String biz_reg_no_ar, String bank_id_ar, String acct_num_ar, String tran_date_seq_ar, String tran_amt_ar, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_RCP_1740_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_RCP_1740_ADM dm = (SE_RCP_1740_ADM)bdm;
		...
		cstmt.setString(16, dm.amt2_ar);
		cstmt.setString(17, dm.rcpm_shet_no_ar);
		cstmt.setString(18, dm.rmtt_dt_ar);
		cstmt.setString(19, dm.rmtt_plac_ar);
		cstmt.setString(20, dm.biz_reg_no_ar);
		cstmt.setString(21, dm.bank_id_ar);
		cstmt.setString(22, dm.acct_num_ar);
		cstmt.setString(23, dm.tran_date_seq_ar);
		cstmt.setString(24, dm.tran_amt_ar);
		cstmt.setString(25, dm.incmg_pers);
		cstmt.setString(26, dm.incmg_pers_ip);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.rcp.ds.SE_RCP_1740_ADataSet();
	}
...
/* 작성시간 : Wed Jun 03 19:41:44 KST 2009 */