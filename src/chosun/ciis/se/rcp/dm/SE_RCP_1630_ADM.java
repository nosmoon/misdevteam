...
public class SE_RCP_1630_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String accflag;
	public String mode_ar;
	public String bo_cdseq_ar;
	public String acct_no_ar;
	public String incmg_pers;
	public String incmg_pers_ip;

	public SE_RCP_1630_ADM(){}
	public SE_RCP_1630_ADM(String cmpy_cd, String accflag, String mode_ar, String bo_cdseq_ar, String acct_no_ar, String incmg_pers, String incmg_pers_ip){
		this.cmpy_cd = cmpy_cd;
		this.accflag = accflag;
		this.mode_ar = mode_ar;
		this.bo_cdseq_ar = bo_cdseq_ar;
		this.acct_no_ar = acct_no_ar;
	...
	public void setAcct_no_ar(String acct_no_ar){
		this.acct_no_ar = acct_no_ar;
	}
	...
	public String getAcct_no_ar(){
		return this.acct_no_ar;
	}
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_RCP_1630_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_RCP_1630_ADM dm = (SE_RCP_1630_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.accflag);
		cstmt.setString(5, dm.mode_ar);
		cstmt.setString(6, dm.bo_cdseq_ar);
		cstmt.setString(7, dm.acct_no_ar);
		cstmt.setString(8, dm.incmg_pers);
		cstmt.setString(9, dm.incmg_pers_ip);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.rcp.ds.SE_RCP_1630_ADataSet();
	}
    ...
    public void print(){
        ...
        System.out.println("acct_no_ar = " + getAcct_no_ar());
...
String acct_no_ar = req.getParameter("acct_no_ar");
if( acct_no_ar == null){
	System.out.println(this.toString+" : acct_no_ar is null" );
}else{
	System.out.println(this.toString+" : acct_no_ar is "+acct_no_ar );
}
...
String acct_no_ar = Util.checkString(req.getParameter("acct_no_ar"));
...
String acct_no_ar = Util.Uni2Ksc(Util.checkString(req.getParameter("acct_no_ar")));
...
dm.setAcct_no_ar(acct_no_ar);
dm.setIncmg_pers(incmg_pers);
dm.setIncmg_pers_ip(incmg_pers_ip);
----------------------------------------------------------------------------------------------------*/


/* 작성시간 : Wed May 06 09:49:35 KST 2009 */