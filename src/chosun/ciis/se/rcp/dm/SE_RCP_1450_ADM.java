...
public class SE_RCP_1450_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_RCP_1450_ADM(){}
	public SE_RCP_1450_ADM(String cmpy_cd, String area_cd, String occr_dt, String slip_clsf, String seq, String rcpm_dt, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_RCP_1450_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_RCP_1450_ADM dm = (SE_RCP_1450_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.rcp.ds.SE_RCP_1450_ADataSet();
	}
...
/* 작성시간 : Thu Jun 04 12:06:03 KST 2009 */