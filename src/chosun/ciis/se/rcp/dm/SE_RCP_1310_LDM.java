...
public class SE_RCP_1310_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_RCP_1310_LDM(){}
	public SE_RCP_1310_LDM(String cmpy_cd, String team_cd, String part_cd, String area_cd, String rcpm_dt1, String rcpm_dt2, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_RCP_1310_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_RCP_1310_LDM dm = (SE_RCP_1310_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.rcp.ds.SE_RCP_1310_LDataSet();
	}
