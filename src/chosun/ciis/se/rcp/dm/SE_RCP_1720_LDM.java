...
public class SE_RCP_1720_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_RCP_1720_LDM(){}
	public SE_RCP_1720_LDM(String cmpy_cd, String area_cd, String occr_dt, String slip_clsf, String seq, String rcpm_dt, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_RCP_1720_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_RCP_1720_LDM dm = (SE_RCP_1720_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.rcp.ds.SE_RCP_1720_LDataSet();
	}
