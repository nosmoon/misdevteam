...
public class SE_RCP_2710_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_RCP_2710_LDM(){}
	public SE_RCP_2710_LDM(String cmpy_cd, String incmg_pers, String team_cd, String part_cd, String area_cd, String yymm, String schlevel){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_RCP_2710_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_RCP_2710_LDM dm = (SE_RCP_2710_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.rcp.ds.SE_RCP_2710_LDataSet();
	}
