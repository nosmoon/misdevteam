...
public class SE_RCP_2820_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_RCP_2820_LDM(){}
	public SE_RCP_2820_LDM(String cmpy_cd, String yymm, String bo_cd, String bo_seq, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_SE_RCP_2820_L( ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_RCP_2820_LDM dm = (SE_RCP_2820_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.rcp.ds.SE_RCP_2820_LDataSet();
	}
