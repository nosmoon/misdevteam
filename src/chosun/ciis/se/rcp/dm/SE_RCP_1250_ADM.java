...
public class SE_RCP_1250_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_RCP_1250_ADM(){}
	public SE_RCP_1250_ADM(String cmpy_cd, String area_cd, String occr_dt, String slip_clsf, String seq, String rcpm_dt, String mode_ar, String bo_cdseq_ar, String acpt_rcpm_reg_tot_amt_ar, String rcpm_amt_ar, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_RCP_1250_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_RCP_1250_ADM dm = (SE_RCP_1250_ADM)bdm;
		...
		cstmt.setString(11, dm.acpt_rcpm_reg_tot_amt_ar);
		cstmt.setString(12, dm.rcpm_amt_ar);
		cstmt.setString(13, dm.incmg_pers);
		cstmt.setString(14, dm.incmg_pers_ip);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.rcp.ds.SE_RCP_1250_ADataSet();
	}
...
/* 작성시간 : Wed Apr 22 16:16:43 KST 2009 */