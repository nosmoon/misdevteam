...
public class SE_RCP_4650_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_RCP_4650_ADM(){}
	public SE_RCP_4650_ADM(String cmpy_cd, String area_cd, String occr_dt, String slip_clsf, String seq, String rcpm_dt, String mode_ar, String bo_cd_ar, String bo_seq_ar, String amt_tot_ar, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_RCP_4650_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_RCP_4650_ADM dm = (SE_RCP_4650_ADM)bdm;
		...
		cstmt.setString(12, dm.amt_tot_ar);
		cstmt.setString(13, dm.incmg_pers);
		cstmt.setString(14, dm.incmg_pers_ip);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.rcp.ds.SE_RCP_4650_ADataSet();
	}
...
/* 작성시간 : Mon Jul 10 15:27:32 KST 2017 */