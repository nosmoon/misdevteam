...
public class SE_RCP_3000_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_RCP_3000_MDM(){}
	public SE_RCP_3000_MDM(String cmpy_cd, String auth_gb, String incmg_pers, String base_dt, String feat_clsf){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_RCP_3000_M(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_RCP_3000_MDM dm = (SE_RCP_3000_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.rcp.ds.SE_RCP_3000_MDataSet();
	}
