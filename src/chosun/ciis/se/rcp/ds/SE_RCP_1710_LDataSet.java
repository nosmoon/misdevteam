...
public class SE_RCP_1710_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SE_RCP_1710_LDataSet(){}
	public SE_RCP_1710_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset1.next()){
			SE_RCP_1710_LCURLISTRecord rec = new SE_RCP_1710_LCURLISTRecord();
			...
			rec.acct_slip_no = Util.checkString(rset1.getString("acct_slip_no"));
...
<%
	SE_RCP_1710_LDataSet ds = (SE_RCP_1710_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		SE_RCP_1710_LCURLISTRecord curlistRec = (SE_RCP_1710_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
