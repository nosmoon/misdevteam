...
public class SE_RCP_1620_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SE_RCP_1620_LDataSet(){}
	public SE_RCP_1620_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SE_RCP_1620_LCURLISTRecord rec = new SE_RCP_1620_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		SE_RCP_1620_LCURLISTRecord curlistRec = (SE_RCP_1620_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
