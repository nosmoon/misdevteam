...
public class SE_RCP_4620_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SE_RCP_4620_LDataSet(){}
	public SE_RCP_4620_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SE_RCP_4620_LCURLISTRecord rec = new SE_RCP_4620_LCURLISTRecord();
			...
			rec.amt_rate = Util.checkString(rset0.getString("amt_rate"));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		SE_RCP_4620_LCURLISTRecord curlistRec = (SE_RCP_4620_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Mon Jul 10 11:38:20 KST 2017 */