...
public class SE_RCP_4630_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SE_RCP_4630_LDataSet(){}
	public SE_RCP_4630_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SE_RCP_4630_LCURLISTRecord rec = new SE_RCP_4630_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		SE_RCP_4630_LCURLISTRecord curlistRec = (SE_RCP_4630_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
