...
public class SE_TRG_1020_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SE_TRG_1020_LDataSet(){}
	public SE_TRG_1020_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SE_TRG_1020_LCURLISTRecord rec = new SE_TRG_1020_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		SE_TRG_1020_LCURLISTRecord curlistRec = (SE_TRG_1020_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
