...
public class SE_TRG_1210_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SE_TRG_1210_LDataSet(){}
	public SE_TRG_1210_LDataSet(String errcode, String errmsg, String colcnt, String title){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SE_TRG_1210_LCURLISTRecord rec = new SE_TRG_1210_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		SE_TRG_1210_LCURLISTRecord curlistRec = (SE_TRG_1210_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
