...
public class SE_TRG_1420_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_TRG_1420_LDM(){}
	public SE_TRG_1420_LDM(String cmpy_cd, String incmg_pers, String callgb, String team_cd, String yymm){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_TRG_1420_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_TRG_1420_LDM dm = (SE_TRG_1420_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.trg.ds.SE_TRG_1420_LDataSet();
	}
