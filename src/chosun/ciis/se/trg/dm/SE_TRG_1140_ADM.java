...
public class SE_TRG_1140_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_TRG_1140_ADM(){}
	public SE_TRG_1140_ADM(String cmpy_cd, String yyyy, String clos_yn, String mode_ar, String area_cd_ar, String bo_cd_ar, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_TRG_1140_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_TRG_1140_ADM dm = (SE_TRG_1140_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.trg.ds.SE_TRG_1140_ADataSet();
	}
...
/* 작성시간 : Thu Mar 26 14:49:32 KST 2009 */