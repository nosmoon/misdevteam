...
public class SE_TRG_1510_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_TRG_1510_LDM(){}
	public SE_TRG_1510_LDM(String cmpy_cd, String team_cd, String part_cd, String area_cd, String chrgpers, String yymm, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_TRG_1510_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_TRG_1510_LDM dm = (SE_TRG_1510_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.trg.ds.SE_TRG_1510_LDataSet();
	}
