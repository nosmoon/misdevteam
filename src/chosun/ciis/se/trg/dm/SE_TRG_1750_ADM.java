...
public class SE_TRG_1750_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_TRG_1750_ADM(){}
	public SE_TRG_1750_ADM(String cmpy_cd, String selldeptcd, String yy, String evlu_seq, String clos_yn, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_TRG_1750_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_TRG_1750_ADM dm = (SE_TRG_1750_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.trg.ds.SE_TRG_1750_ADataSet();
	}
...
/* 작성시간 : Tue Apr 07 20:30:02 KST 2009 */