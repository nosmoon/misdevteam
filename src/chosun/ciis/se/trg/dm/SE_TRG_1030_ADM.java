...
public class SE_TRG_1030_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_TRG_1030_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_TRG_1030_ADM dm = (SE_TRG_1030_ADM)bdm;
		...
		cstmt.setString(8, dm.trgt_clsf_ar);
		cstmt.setString(9, dm.trgt_01_ar);
		cstmt.setString(10, dm.trgt_02_ar);
		cstmt.setString(11, dm.trgt_03_ar);
		cstmt.setString(12, dm.trgt_04_ar);
		cstmt.setString(13, dm.trgt_05_ar);
		cstmt.setString(14, dm.trgt_06_ar);
		cstmt.setString(15, dm.trgt_07_ar);
		cstmt.setString(16, dm.trgt_08_ar);
		cstmt.setString(17, dm.trgt_09_ar);
		cstmt.setString(18, dm.trgt_10_ar);
		cstmt.setString(19, dm.trgt_11_ar);
		cstmt.setString(20, dm.trgt_12_ar);
		cstmt.setString(21, dm.incmg_pers);
		cstmt.setString(22, dm.incmg_pers_ip);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.trg.ds.SE_TRG_1030_ADataSet();
	}
...
/* 작성시간 : Fri Mar 20 18:02:08 KST 2009 */