...
public class SE_TRG_1120_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_TRG_1120_LDM(){}
	public SE_TRG_1120_LDM(String cmpy_cd, String incmg_pers, String area_cd, String bo_cd, String bo_seq, String yyyy){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_TRG_1120_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_TRG_1120_LDM dm = (SE_TRG_1120_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.trg.ds.SE_TRG_1120_LDataSet();
	}
