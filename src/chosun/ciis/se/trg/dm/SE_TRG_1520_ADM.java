...
public class SE_TRG_1520_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_TRG_1520_ADM(){}
	public SE_TRG_1520_ADM(String cmpy_cd, String team_cd, String yymm, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_TRG_1520_A(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_TRG_1520_ADM dm = (SE_TRG_1520_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.trg.ds.SE_TRG_1520_ADataSet();
	}
...
/* 작성시간 : Fri Apr 03 16:55:09 KST 2009 */