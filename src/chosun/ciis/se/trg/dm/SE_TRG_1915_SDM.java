...
public class SE_TRG_1915_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_TRG_1915_SDM(){}
	public SE_TRG_1915_SDM(String cmpy_cd, String bo_cd, String bo_seq, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_TRG_1915_S(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_TRG_1915_SDM dm = (SE_TRG_1915_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.trg.ds.SE_TRG_1915_SDataSet();
	}
