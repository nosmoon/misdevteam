...
public class SE_TEST_1040_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_TEST_1040_DDM(){}
	public SE_TEST_1040_DDM(String mode, String emp_no, String cmpycd, String workcd, String year, String month, String week, String vip_lastweek, String lastweek, String thisweek){
		this.mode = mode;
		this.emp_no = emp_no;
		this.cmpycd = cmpycd;
		this.workcd = workcd;
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_TEST_1040_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_TEST_1040_DDM dm = (SE_TEST_1040_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.test.ds.SE_TEST_1040_DDataSet();
	}
