...
public class SE_TEST_1000_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_TEST_1000_ADM(){}
	public SE_TEST_1000_ADM(String emp_no, String cmpycd, String workcd, String year, String month, String week, String vip_lastweek, String lastweek, String thisweek){
		this.emp_no = emp_no;
		this.cmpycd = cmpycd;
		this.workcd = workcd;
		this.year = year;
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_TEST_1000_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_TEST_1000_ADM dm = (SE_TEST_1000_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.emp_no);
		cstmt.setString(4, dm.cmpycd);
		cstmt.setString(5, dm.workcd);
		cstmt.setString(6, dm.year);
		cstmt.setString(7, dm.month);
		cstmt.setString(8, dm.week);
		cstmt.setString(9, dm.vip_lastweek);
		cstmt.setString(10, dm.lastweek);
		cstmt.setString(11, dm.thisweek);
		cstmt.registerOutParameter(12, Types.VARCHAR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.test.ds.SE_TEST_1000_ADataSet();
	}
...
/* 작성시간 : Tue Jun 11 11:34:18 KST 2013 */