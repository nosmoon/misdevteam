...
public class SE_QTY_1910_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SE_QTY_1910_LDataSet(){}
	public SE_QTY_1910_LDataSet(String errcode, String errmsg, String closyn_cap, String colcnt, String title, String medi_cd, String editable_yn, String regchk_yn){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SE_QTY_1910_LCURLISTRecord rec = new SE_QTY_1910_LCURLISTRecord();
			...
			rec.add_snd_send_plac_seq = Util.checkString(rset0.getString("add_snd_send_plac_seq"));
			rec.add_snd_send_plac_nm = Util.checkString(rset0.getString("add_snd_send_plac_nm"));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		SE_QTY_1910_LCURLISTRecord curlistRec = (SE_QTY_1910_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
<%= curlistRec.calc_qty%>
<%= curlistRec.issu_qty%>
<%= curlistRec.add_snd_bo_cd%>
<%= curlistRec.add_snd_send_plac_seq%>
<%= curlistRec.add_snd_send_plac_nm%>
----------------------------------------------------------------------------------------------------*/
