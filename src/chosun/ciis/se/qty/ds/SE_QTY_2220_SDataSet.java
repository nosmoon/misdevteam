...
public class SE_QTY_2220_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;
	public String sect_cd;

	public SE_QTY_2220_SDataSet(){}
	public SE_QTY_2220_SDataSet(String errcode, String errmsg, String sect_cd){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SE_QTY_2220_SCURLISTRecord rec = new SE_QTY_2220_SCURLISTRecord();
			...
			rec.cnfm_stat_clsf = Util.checkString(rset0.getString("cnfm_stat_clsf"));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		SE_QTY_2220_SCURLISTRecord curlistRec = (SE_QTY_2220_SCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
