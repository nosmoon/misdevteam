...
public class SE_QTY_2310_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_QTY_2310_LDM(){}
	public SE_QTY_2310_LDM(String cmpy_cd, String issu_dt, String send_clos_grp_clsf, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_QTY_2310_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_QTY_2310_LDM dm = (SE_QTY_2310_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.qty.ds.SE_QTY_2310_LDataSet();
	}
