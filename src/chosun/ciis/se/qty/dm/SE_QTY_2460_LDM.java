...
public class SE_QTY_2460_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_QTY_2460_LDM(){}
	public SE_QTY_2460_LDM(String cmpy_cd, String issu_dt, String send_clos_grp_clsf, String clos_tms, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_QTY_2460_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_QTY_2460_LDM dm = (SE_QTY_2460_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.qty.ds.SE_QTY_2460_LDataSet();
	}
...
/* 작성시간 : Tue Jun 30 14:19:18 KST 2009 */