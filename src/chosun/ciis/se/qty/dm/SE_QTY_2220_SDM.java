...
public class SE_QTY_2220_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_QTY_2220_SDM(){}
	public SE_QTY_2220_SDM(String cmpy_cd, String incmg_pers, String reg_dt, String reg_seq){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_QTY_2220_S(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_QTY_2220_SDM dm = (SE_QTY_2220_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.qty.ds.SE_QTY_2220_SDataSet();
	}
