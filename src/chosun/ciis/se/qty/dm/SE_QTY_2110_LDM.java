...
public class SE_QTY_2110_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_QTY_2110_LDM(){}
	public SE_QTY_2110_LDM(String cmpy_cd, String incmg_pers, String issu_dt1, String issu_dt2){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_QTY_2110_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_QTY_2110_LDM dm = (SE_QTY_2110_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.incmg_pers);
		cstmt.setString(5, dm.issu_dt1);
		cstmt.setString(6, dm.issu_dt2);
		cstmt.registerOutParameter(7, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.qty.ds.SE_QTY_2110_LDataSet();
	}
