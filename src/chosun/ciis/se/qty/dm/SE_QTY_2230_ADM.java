...
public class SE_QTY_2230_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_QTY_2230_ADM(){}
	public SE_QTY_2230_ADM(String accflag, String cmpy_cd, String reg_dt, String reg_seq, String medi_cd, String sect_cd, String qty, String prt_rfl_qty, String aplc_pers_nm, String aplc_pers_tel_no_1, String aplc_pers_tel_no_2, String aplc_pers_tel_no_3, String aplc_pers_ptph_no_1, String aplc_pers_ptph_no_2, String aplc_pers_ptph_no_3, String dlv_zip_1, String dlv_zip_2, String dlv_dtls_addr, String dlv_addr, String stmt_issu_req_yn, String sell_clsf, String setl_acct_no, String amt, String arvl_clsf, String cnfm_stat_clsf, String cnfm_msg, String bo_cd, String send_plac_seq, String prt_plac_cd, String ledt_cd, String ecnt_cd, String issu_dt, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_QTY_2230_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_QTY_2230_ADM dm = (SE_QTY_2230_ADM)bdm;
		...
		cstmt.setString(10, dm.prt_rfl_qty);
		cstmt.setString(11, dm.aplc_pers_nm);
		cstmt.setString(12, dm.aplc_pers_tel_no_1);
		cstmt.setString(13, dm.aplc_pers_tel_no_2);
		cstmt.setString(14, dm.aplc_pers_tel_no_3);
		cstmt.setString(15, dm.aplc_pers_ptph_no_1);
		cstmt.setString(16, dm.aplc_pers_ptph_no_2);
		cstmt.setString(17, dm.aplc_pers_ptph_no_3);
		cstmt.setString(18, dm.dlv_zip_1);
		cstmt.setString(19, dm.dlv_zip_2);
		cstmt.setString(20, dm.dlv_dtls_addr);
		cstmt.setString(21, dm.dlv_addr);
		cstmt.setString(22, dm.stmt_issu_req_yn);
		cstmt.setString(23, dm.sell_clsf);
		cstmt.setString(24, dm.setl_acct_no);
		cstmt.setString(25, dm.amt);
		cstmt.setString(26, dm.arvl_clsf);
		cstmt.setString(27, dm.cnfm_stat_clsf);
		cstmt.setString(28, dm.cnfm_msg);
		cstmt.setString(29, dm.bo_cd);
		cstmt.setString(30, dm.send_plac_seq);
		cstmt.setString(31, dm.prt_plac_cd);
		cstmt.setString(32, dm.ledt_cd);
		cstmt.setString(33, dm.ecnt_cd);
		cstmt.setString(34, dm.issu_dt);
		cstmt.setString(35, dm.incmg_pers);
		cstmt.setString(36, dm.incmg_pers_ip);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.qty.ds.SE_QTY_2230_ADataSet();
	}
    ...
    public void print(){
        ...
        System.out.println("prt_rfl_qty = " + getPrt_rfl_qty());
        ...
        System.out.println("cnfm_msg = " + getCnfm_msg());
...
String prt_rfl_qty = req.getParameter("prt_rfl_qty");
if( prt_rfl_qty == null){
	System.out.println(this.toString+" : prt_rfl_qty is null" );
}else{
	System.out.println(this.toString+" : prt_rfl_qty is "+prt_rfl_qty );
}
...
String cnfm_msg = req.getParameter("cnfm_msg");
if( cnfm_msg == null){
	System.out.println(this.toString+" : cnfm_msg is null" );
}else{
	System.out.println(this.toString+" : cnfm_msg is "+cnfm_msg );
}
...
String prt_rfl_qty = Util.checkString(req.getParameter("prt_rfl_qty"));
...
String cnfm_msg = Util.checkString(req.getParameter("cnfm_msg"));
...
String prt_rfl_qty = Util.Uni2Ksc(Util.checkString(req.getParameter("prt_rfl_qty")));
...
String cnfm_msg = Util.Uni2Ksc(Util.checkString(req.getParameter("cnfm_msg")));
...
/* 작성시간 : Mon Jun 01 19:38:15 KST 2009 */