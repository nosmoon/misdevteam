...
public class SE_QTY_2440_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_QTY_2440_ADM(){}
	public SE_QTY_2440_ADM(String cmpy_cd, String issu_dt, String send_clos_grp_clsf, String clos_tms, String clos_yn, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_QTY_2440_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_QTY_2440_ADM dm = (SE_QTY_2440_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.qty.ds.SE_QTY_2440_ADataSet();
	}
...
/* 작성시간 : Tue Mar 17 19:53:01 KST 2009 */