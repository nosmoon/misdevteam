...
public class SE_QTY_2810_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_QTY_2810_LDM(){}
	public SE_QTY_2810_LDM(String cmpy_cd, String team, String part, String area, String medi_cd, String issu_yymm, String spsl_gubun, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_SE_QTY_2810_L( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_QTY_2810_LDM dm = (SE_QTY_2810_LDM)bdm;
		...
		cstmt.setString( 8, dm.issu_yymm	);
		cstmt.setString( 9, dm.spsl_gubun	);
		cstmt.setString(10, dm.incmg_pers	);
		cstmt.registerOutParameter(11, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.qty.ds.SE_QTY_2810_LDataSet();
	}
