...
public class SE_QTY_2680_PDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_QTY_2680_PDM(){}
	public SE_QTY_2680_PDM(String cmpy_cd, String issu_dt, String send_clos_grp_clsf, String clos_tms, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_QTY_2680_P(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_QTY_2680_PDM dm = (SE_QTY_2680_PDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.qty.ds.SE_QTY_2680_PDataSet();
	}
