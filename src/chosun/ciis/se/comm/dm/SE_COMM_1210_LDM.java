...
public class SE_COMM_1210_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_COMM_1210_LDM(){}
	public SE_COMM_1210_LDM(String cmpy_cd, String route_cd, String route_nm, String route_clsf){
	...
	public String getSQL(){
		 return "{ call SP_SE_COMM_1210_L( ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_COMM_1210_LDM dm = (SE_COMM_1210_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.comm.ds.SE_COMM_1210_LDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
