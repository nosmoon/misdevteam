...
public class SE_COMM_1510_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String yy;

	public SE_COMM_1510_LDM(){}
	public SE_COMM_1510_LDM(String cmpy_cd, String yy){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_COMM_1510_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_COMM_1510_LDM dm = (SE_COMM_1510_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.comm.ds.SE_COMM_1510_LDataSet();
	}
