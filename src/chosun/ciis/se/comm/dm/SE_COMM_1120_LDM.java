...
public class SE_COMM_1120_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_COMM_1120_LDM(){}
	public SE_COMM_1120_LDM(String cmpy_cd, String bo_nm, String bo_head_nm, String cntr_stat_clsf, String dept_cd, String bo_cd){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_COMM_1120_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_COMM_1120_LDM dm = (SE_COMM_1120_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.comm.ds.SE_COMM_1120_LDataSet();
	}
