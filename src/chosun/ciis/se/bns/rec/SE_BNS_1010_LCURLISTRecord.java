...
public class SE_BNS_1010_LCURLISTRecord extends java.lang.Object implements java.io.Serializable{
	...
	public String bal;
	public String cyov_compen_divn_amt;
	public String cyov_qunt;
	public String cyov_rcpm_amt;
	public String cyov_bal;
	public String rcpm_rate;

	public SE_BNS_1010_LCURLISTRecord(){}
	...
	public void setCyov_compen_divn_amt(String cyov_compen_divn_amt){
		this.cyov_compen_divn_amt = cyov_compen_divn_amt;
	}

	public void setCyov_qunt(String cyov_qunt){
		this.cyov_qunt = cyov_qunt;
	}

	public void setCyov_rcpm_amt(String cyov_rcpm_amt){
		this.cyov_rcpm_amt = cyov_rcpm_amt;
	}
	...
	public String getCyov_compen_divn_amt(){
		return this.cyov_compen_divn_amt;
	}

	public String getCyov_qunt(){
		return this.cyov_qunt;
	}

	public String getCyov_rcpm_amt(){
		return this.cyov_rcpm_amt;
	}
