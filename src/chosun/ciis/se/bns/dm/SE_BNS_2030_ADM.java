...
public class SE_BNS_2030_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BNS_2030_ADM(){}
	public SE_BNS_2030_ADM(String cmpy_cd, String bgn_yymm, String end_yymm, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_SE_BNS_2030_A( ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BNS_2030_ADM dm = (SE_BNS_2030_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.bns.ds.SE_BNS_2030_ADataSet();
	}
