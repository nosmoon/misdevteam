...
public class SE_BNS_1800_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BNS_1800_MDM(){}
	public SE_BNS_1800_MDM(String cmpy_cd, String auth_gb, String incmg_pers, String base_dt, String feat_clsf){
	...
	public String getSQL(){
		 return "{ call SP_SE_BNS_1800_M( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BNS_1800_MDM dm = (SE_BNS_1800_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.bns.ds.SE_BNS_1800_MDataSet();
	}
