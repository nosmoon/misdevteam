...
public class SE_BNS_2010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BNS_2010_LDM(){}
	public SE_BNS_2010_LDM(String cmpy_cd, String bgn_yymm, String end_yymm, String team, String part, String area, String search_gubun, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_SE_BNS_2010_L( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BNS_2010_LDM dm = (SE_BNS_2010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.bns.ds.SE_BNS_2010_LDataSet();
	}
...
/* 작성시간 : Fri May 01 16:10:25 KST 2009 */