...
public class SE_BNS_1510_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BNS_1510_LDM(){}
	public SE_BNS_1510_LDM(String cmpy_cd, String yymm, String medi_cd, String tms, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_SE_BNS_1510_L( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? ) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BNS_1510_LDM dm = (SE_BNS_1510_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.bns.ds.SE_BNS_1510_LDataSet();
	}
