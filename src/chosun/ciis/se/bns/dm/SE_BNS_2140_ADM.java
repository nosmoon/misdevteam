...
public class SE_BNS_2140_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String bns_item_cd_ar;
	public String divn_dt_ar;
	public String ewh_seq_ar;
	...
	public SE_BNS_2140_ADM(){}
	public SE_BNS_2140_ADM(String cmpy_cd, String accflag, String occr_dt, String slip_clsf, String seq, String area_cd, String bank_cd, String mode_ar, String bo_cdseq_ar, String chrg_pers_ar, String acct_tot_ar, String acpt_tot_ar, String amt1_ar, String bns_item_cd_ar, String divn_dt_ar, String ewh_seq_ar, String rcpm_shet_no_ar, String rmtt_dt_ar, String rmtt_plac_ar, String biz_reg_no_ar, String bank_id_ar, String acct_num_ar, String tran_date_seq_ar, String tran_amt_ar, String incmg_pers, String incmg_pers_ip){
		...
		this.bns_item_cd_ar = bns_item_cd_ar;
		this.divn_dt_ar = divn_dt_ar;
		this.ewh_seq_ar = ewh_seq_ar;
	...
	public void setBns_item_cd_ar(String bns_item_cd_ar){
		this.bns_item_cd_ar = bns_item_cd_ar;
	}

	public void setDivn_dt_ar(String divn_dt_ar){
		this.divn_dt_ar = divn_dt_ar;
	}

	public void setEwh_seq_ar(String ewh_seq_ar){
		this.ewh_seq_ar = ewh_seq_ar;
	}
	...
	public String getBns_item_cd_ar(){
		return this.bns_item_cd_ar;
	}

	public String getDivn_dt_ar(){
		return this.divn_dt_ar;
	}

	public String getEwh_seq_ar(){
		return this.ewh_seq_ar;
	}
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_BNS_2140_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BNS_2140_ADM dm = (SE_BNS_2140_ADM)bdm;
		...
		cstmt.setString(13, dm.acct_tot_ar);
		cstmt.setString(14, dm.acpt_tot_ar);
		cstmt.setString(15, dm.amt1_ar);
		cstmt.setString(16, dm.bns_item_cd_ar);
		cstmt.setString(17, dm.divn_dt_ar);
		cstmt.setString(18, dm.ewh_seq_ar);
		cstmt.setString(19, dm.rcpm_shet_no_ar);
		cstmt.setString(20, dm.rmtt_dt_ar);
		cstmt.setString(21, dm.rmtt_plac_ar);
		cstmt.setString(22, dm.biz_reg_no_ar);
		cstmt.setString(23, dm.bank_id_ar);
		cstmt.setString(24, dm.acct_num_ar);
		cstmt.setString(25, dm.tran_date_seq_ar);
		cstmt.setString(26, dm.tran_amt_ar);
		cstmt.setString(27, dm.incmg_pers);
		cstmt.setString(28, dm.incmg_pers_ip);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.bns.ds.SE_BNS_2140_ADataSet();
	}
    ...
    public void print(){
        ...
        System.out.println("bns_item_cd_ar = " + getBns_item_cd_ar());
        System.out.println("divn_dt_ar = " + getDivn_dt_ar());
        System.out.println("ewh_seq_ar = " + getEwh_seq_ar());
...
String bns_item_cd_ar = req.getParameter("bns_item_cd_ar");
if( bns_item_cd_ar == null){
	System.out.println(this.toString+" : bns_item_cd_ar is null" );
}else{
	System.out.println(this.toString+" : bns_item_cd_ar is "+bns_item_cd_ar );
}
String divn_dt_ar = req.getParameter("divn_dt_ar");
if( divn_dt_ar == null){
	System.out.println(this.toString+" : divn_dt_ar is null" );
}else{
	System.out.println(this.toString+" : divn_dt_ar is "+divn_dt_ar );
}
String ewh_seq_ar = req.getParameter("ewh_seq_ar");
if( ewh_seq_ar == null){
	System.out.println(this.toString+" : ewh_seq_ar is null" );
}else{
	System.out.println(this.toString+" : ewh_seq_ar is "+ewh_seq_ar );
}
...
String bns_item_cd_ar = Util.checkString(req.getParameter("bns_item_cd_ar"));
String divn_dt_ar = Util.checkString(req.getParameter("divn_dt_ar"));
String ewh_seq_ar = Util.checkString(req.getParameter("ewh_seq_ar"));
...
String bns_item_cd_ar = Util.Uni2Ksc(Util.checkString(req.getParameter("bns_item_cd_ar")));
String divn_dt_ar = Util.Uni2Ksc(Util.checkString(req.getParameter("divn_dt_ar")));
String ewh_seq_ar = Util.Uni2Ksc(Util.checkString(req.getParameter("ewh_seq_ar")));
...
dm.setBns_item_cd_ar(bns_item_cd_ar);
dm.setDivn_dt_ar(divn_dt_ar);
dm.setEwh_seq_ar(ewh_seq_ar);
...
/* 작성시간 : Tue Jun 09 21:07:48 KST 2009 */