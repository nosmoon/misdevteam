...
public class SE_BNS_2150_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BNS_2150_ADM(){}
	public SE_BNS_2150_ADM(String cmpy_cd, String area_cd, String occr_dt, String slip_clsf, String seq, String rcpm_dt, String mode_ar, String bo_cdseq_ar, String amt1_ar, String incmg_pers, String incmg_pers_ip){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_BNS_2150_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BNS_2150_ADM dm = (SE_BNS_2150_ADM)bdm;
		...
		cstmt.setString(11, dm.amt1_ar);
		cstmt.setString(12, dm.incmg_pers);
		cstmt.setString(13, dm.incmg_pers_ip);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.bns.ds.SE_BNS_2150_ADataSet();
	}
...
/* 작성시간 : Tue Jun 09 21:06:36 KST 2009 */