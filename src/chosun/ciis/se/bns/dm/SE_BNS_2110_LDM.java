...
public class SE_BNS_2110_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_BNS_2110_LDM(){}
	public SE_BNS_2110_LDM(String cmpy_cd, String team_cd, String part_cd, String area_cd, String rcpm_dt1, String rcpm_dt2, String divn_dt1, String divn_dt2, String bank_cd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_BNS_2110_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_BNS_2110_LDM dm = (SE_BNS_2110_LDM)bdm;
		...
		cstmt.setString(9, dm.divn_dt1);
		cstmt.setString(10, dm.divn_dt2);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.bns.ds.SE_BNS_2110_LDataSet();
	}
