...
public class SE_SND_1040_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public SE_SND_1040_LDataSet(){}
	public SE_SND_1040_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SE_SND_1040_LCURLISTRecord rec = new SE_SND_1040_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		SE_SND_1040_LCURLISTRecord curlistRec = (SE_SND_1040_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
