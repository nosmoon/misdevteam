...
import chosun.ciis.se.snd.rec.SE_SND_1140_LCURLISTRecord;
...
public class SE_SND_1140_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String rownum;
	public String errcode;
	public String errmsg;
	
	public SE_SND_1140_LDataSet(){}
	public SE_SND_1140_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SE_SND_1140_LCURLISTRecord rec = new SE_SND_1140_LCURLISTRecord();
