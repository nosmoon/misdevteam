...
public class SE_SND_1000_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public SE_SND_1000_MDataSet(){}
	public SE_SND_1000_MDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			SE_SND_1000_MCURLISTRecord rec = new SE_SND_1000_MCURLISTRecord();
		...
		while(rset1.next()){
			SE_SND_1000_MROUTELISTRecord rec = new SE_SND_1000_MROUTELISTRecord();
		...
		while(rset2.next()){
			SE_SND_1000_MMEDILISTRecord rec = new SE_SND_1000_MMEDILISTRecord();
		...
		while(rset3.next()){
			SE_SND_1000_MECNTLISTRecord rec = new SE_SND_1000_MECNTLISTRecord();
		...
		while(rset4.next()){
			SE_SND_1000_MLEDTLISTRecord rec = new SE_SND_1000_MLEDTLISTRecord();
