...
public class SE_SND_1230_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_SND_1230_LDM(){}
	public SE_SND_1230_LDM(String cmpy_cd, String job_clsf, String cd_clsf, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_SE_SND_1230_L( ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_SND_1230_LDM dm = (SE_SND_1230_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.snd.ds.SE_SND_1230_LDataSet();
	}
