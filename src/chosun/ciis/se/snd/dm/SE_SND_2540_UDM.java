...
public class SE_SND_2540_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_SND_2540_UDM(){}
	public SE_SND_2540_UDM( String cmpy_cd , String mode, String reg_dt, String reg_seq, String incmg_pers_ip, String incmg_pers ){
	...
	public String getSQL(){
		 return "{ call SP_SE_SND_2540_U( ?, ?, ?, ?, ?, ?, ?, ? ) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_SND_2540_UDM dm = (SE_SND_2540_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.snd.ds.SE_SND_2540_UDataSet();
	}
