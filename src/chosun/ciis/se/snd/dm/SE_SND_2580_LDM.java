...
public class SE_SND_2580_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_SND_2580_LDM(){}
	public SE_SND_2580_LDM(String cmpy_cd, String reg_dt, String reg_seq, String prt_plac_cd, String route_clsf, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_SND_2580_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_SND_2580_LDM dm = (SE_SND_2580_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.snd.ds.SE_SND_2580_LDataSet();
	}
