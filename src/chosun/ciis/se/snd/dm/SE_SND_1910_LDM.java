...
public class SE_SND_1910_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_SND_1910_LDM(){}
	public SE_SND_1910_LDM(String cmpy_cd, String bo_cd, String send_plac_seq, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_SE_SND_1910_L( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_SND_1910_LDM dm = (SE_SND_1910_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.snd.ds.SE_SND_1910_LDataSet();
	}
