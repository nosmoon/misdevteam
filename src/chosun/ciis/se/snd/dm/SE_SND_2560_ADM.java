...
public class SE_SND_2560_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public SE_SND_2560_ADM(){}
	public SE_SND_2560_ADM( String cmpy_cd , String mode, String reg_dt, String reg_seq, String selldeptcd, String incmg_pers_ip, String incmg_pers ){
	...
	public String getSQL(){
		 return "{ call SP_SE_SND_2560_A( ?, ?, ?, ?, ?, ?, ?, ?, ? ) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_SND_2560_ADM dm = (SE_SND_2560_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.snd.ds.SE_SND_2560_ADataSet();
	}
