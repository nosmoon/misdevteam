...
public class SE_SND_1110_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String route_clsf;
	public String route_cd;
	
	public SE_SND_1110_LDM(){}
	public SE_SND_1110_LDM(String cmpy_cd, String route_clsf, String route_cd){
	...
	public String getSQL(){
		 return "{ call SP_SE_SND_1110_L( ?, ?, ?, ?, ?, ?, ? ) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_SND_1110_LDM dm = (SE_SND_1110_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.snd.ds.SE_SND_1110_LDataSet();
	}
