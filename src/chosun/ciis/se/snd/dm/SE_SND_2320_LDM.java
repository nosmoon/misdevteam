...
public class SE_SND_2320_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String tran_cmpy_cd;
	public String incmg_pers;

	public SE_SND_2320_LDM(){}
	public SE_SND_2320_LDM(String cmpy_cd, String tran_cmpy_cd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call CRMSAL_COM.SP_SE_SND_2320_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		SE_SND_2320_LDM dm = (SE_SND_2320_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.se.snd.ds.SE_SND_2320_LDataSet();
	}
