...
public class AD_RES_1230_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_RES_1230_SDM(){}
	public AD_RES_1230_SDM(String cmpy_cd, String medi_cd, String preng_occr_dt, String sect_cd, String sect_seq){
	...
	public String getSQL(){
		 return "{ call SP_AD_RES_1230_S( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_RES_1230_SDM dm = (AD_RES_1230_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.res.ds.AD_RES_1230_SDataSet();
	}
