...
public class AD_RES_2010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String medi_cd;
	public String pubc_dt;

	public AD_RES_2010_LDM(){}
	public AD_RES_2010_LDM(String cmpy_cd, String medi_cd, String pubc_dt){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_RES_2010_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_RES_2010_LDM dm = (AD_RES_2010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.res.ds.AD_RES_2010_LDataSet();
	}
