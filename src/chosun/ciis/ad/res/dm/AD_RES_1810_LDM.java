...
public class AD_RES_1810_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_RES_1810_LDM(){}
	public AD_RES_1810_LDM(String cmpy_cd, String frdt, String todt, String slcrg_pers){
	...
	public String getSQL(){
		 return "{ call SP_AD_RES_1810_L( ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_RES_1810_LDM dm = (AD_RES_1810_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.frdt);
		cstmt.setString(5, dm.todt);
		cstmt.setString(6, dm.slcrg_pers);
		cstmt.registerOutParameter(7, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.res.ds.AD_RES_1810_LDataSet();
	}
