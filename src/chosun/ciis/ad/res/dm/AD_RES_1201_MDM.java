...
public class AD_RES_1201_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String medi_clsf;
	public String emp_no;

	public AD_RES_1201_MDM(){}
	public AD_RES_1201_MDM(String cmpy_cd, String medi_clsf, String emp_no)
	{
	...
	{
		 return "{ call SP_AD_RES_1201_M( ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_RES_1201_MDM dm = (AD_RES_1201_MDM)bdm;
	...
	{
		return new chosun.ciis.ad.res.ds.AD_RES_1201_MDataSet();
	}
