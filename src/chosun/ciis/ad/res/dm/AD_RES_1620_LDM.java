...
public class AD_RES_1620_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_RES_1620_LDM(){}
	public AD_RES_1620_LDM(String cmpy_cd, String medi_cd, String frdt, String todt, String slcrg_pers, String indt_clsf, String hndl_clsf, String dlco_no, String hndl_plac_cd, String grp_cmpy_cd){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_RES_1620_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_RES_1620_LDM dm = (AD_RES_1620_LDM)bdm;
		...
		cstmt.setString(11, dm.hndl_plac_cd);
		cstmt.setString(12, dm.grp_cmpy_cd);
		cstmt.registerOutParameter(13, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.res.ds.AD_RES_1620_LDataSet();
	}
