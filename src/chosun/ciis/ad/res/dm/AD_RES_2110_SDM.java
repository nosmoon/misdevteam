...
public class AD_RES_2110_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_RES_2110_SDM(){}
	public AD_RES_2110_SDM(String cmpy_cd, String medi_cd, String preng_occr_dt, String preng_occr_seq){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_RES_2110_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_RES_2110_SDM dm = (AD_RES_2110_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.res.ds.AD_RES_2110_SDataSet();
	}
