...
public class AD_RES_1400_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String medi_clsf;

	public AD_RES_1400_MDM(){}
	public AD_RES_1400_MDM(String cmpy_cd, String medi_clsf){
	...
	public String getSQL(){
		 return "{ call SP_AD_RES_1400_M( ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_RES_1400_MDM dm = (AD_RES_1400_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.res.ds.AD_RES_1400_MDataSet();
	}
