...
public class AD_RES_1600_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String medi_clsf;
	public String emp_no;

	public AD_RES_1600_MDM(){}
	public AD_RES_1600_MDM(String cmpy_cd, String medi_clsf, String emp_no){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_RES_1600_M(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_RES_1600_MDM dm = (AD_RES_1600_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.res.ds.AD_RES_1600_MDataSet();
	}
