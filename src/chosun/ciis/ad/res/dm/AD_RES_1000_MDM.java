...
public class AD_RES_1000_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String issu_yymm;
	public String medi_cd;

	public AD_RES_1000_MDM(){}
	public AD_RES_1000_MDM(String cmpy_cd, String issu_yymm, String medi_cd){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_RES_1000_M(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_RES_1000_MDM dm = (AD_RES_1000_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.res.ds.AD_RES_1000_MDataSet();
	}
