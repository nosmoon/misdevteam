...
public class AD_RES_1910_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_RES_1910_LDM(){}
	public AD_RES_1910_LDM(String cmpy_cd, String medi_cd, String frdt, String todt, String slcrg_pers, String dlco_no){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_RES_1910_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_RES_1910_LDM dm = (AD_RES_1910_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.res.ds.AD_RES_1910_LDataSet();
	}
