...
import chosun.ciis.ad.res.rec.AD_RES_1910_LCURLISTRecord;
...
public class AD_RES_1910_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_RES_1910_LDataSet(){}
	public AD_RES_1910_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_RES_1910_LCURLISTRecord rec = new AD_RES_1910_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_RES_1910_LCURLISTRecord curlistRec = (AD_RES_1910_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Mon Jun 22 15:48:29 KST 2009 */