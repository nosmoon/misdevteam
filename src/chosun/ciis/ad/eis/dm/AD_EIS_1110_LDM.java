...
public class AD_EIS_1110_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String basi_yymm;

	public AD_EIS_1110_LDM(){}
	public AD_EIS_1110_LDM(String cmpy_cd, String basi_yymm){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_EIS_1110_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_EIS_1110_LDM dm = (AD_EIS_1110_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.eis.ds.AD_EIS_1110_LDataSet();
	}
