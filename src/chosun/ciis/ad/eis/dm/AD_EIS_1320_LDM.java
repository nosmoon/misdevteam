...
public class AD_EIS_1320_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_EIS_1320_LDM(){}
	public AD_EIS_1320_LDM(String cmpy_cd, String frdt, String todt, String unit, String ad_self, String graph_clsf){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_EIS_1320_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_EIS_1320_LDM dm = (AD_EIS_1320_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.eis.ds.AD_EIS_1320_LDataSet();
	}
