...
public class AD_EIS_1450_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_EIS_1450_LDM(){}
	public AD_EIS_1450_LDM(String cmpy_cd, String frdt, String todt, String grp_cmpy_cd){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_EIS_1450_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_EIS_1450_LDM dm = (AD_EIS_1450_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.frdt);
		cstmt.setString(5, dm.todt);
		cstmt.setString(6, dm.grp_cmpy_cd);
		cstmt.registerOutParameter(7, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.eis.ds.AD_EIS_1450_LDataSet();
	}
