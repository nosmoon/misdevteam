...
public class AD_TAX_1130_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public AD_TAX_1130_SDataSet(){}
	public AD_TAX_1130_SDataSet(String errcode, String errmsg, String slip_clsf_cd, String slip_occr_dt, String slip_seq, String prof_type_cd, String hndl_clsf, String dlco_no, String dlco_nm, String make_dt, String suply_amt, String vat_amt, String medi_cd, String del_resn, String ern, String addr, String deal_clsf, String presi_nm, String bizcond, String item, String email_id, String elec_tax_comp_cd, String semuro_no, String tot_fee, String tot_fee_vat, String pay_clsf, String canc_yn, String tot_suply_amt, String tot_vat_amt, String pubc_frdt, String pubc_todt, String chk_cnt, String chnl_clsf){
	...
	public void setTot_fee_vat(String tot_fee_vat){
		this.tot_fee_vat = tot_fee_vat;
	}
	...
	public String getTot_fee_vat(){
		return this.tot_fee_vat;
	}
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.tot_fee_vat = Util.checkString(cstmt.getString(27));
		this.pay_clsf = Util.checkString(cstmt.getString(28));
		this.canc_yn = Util.checkString(cstmt.getString(29));
		this.tot_suply_amt = Util.checkString(cstmt.getString(30));
		this.tot_vat_amt = Util.checkString(cstmt.getString(31));
		this.pubc_frdt = Util.checkString(cstmt.getString(32));
		this.pubc_todt = Util.checkString(cstmt.getString(33));
		this.chk_cnt = Util.checkString(cstmt.getString(34));
		this.chnl_clsf = Util.checkString(cstmt.getString(35));
		ResultSet rset0 = (ResultSet) cstmt.getObject(36);
		while(rset0.next()){
			AD_TAX_1130_SCURLISTRecord rec = new AD_TAX_1130_SCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_TAX_1130_SCURLISTRecord curlistRec = (AD_TAX_1130_SCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Mon Feb 09 18:51:25 KST 2015 */