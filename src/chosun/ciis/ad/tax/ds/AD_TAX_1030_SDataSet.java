...
public class AD_TAX_1030_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public AD_TAX_1030_SDataSet(){}
	public AD_TAX_1030_SDataSet(String errcode, String errmsg, String prof_type_cd, String slip_clsf_cd, String slip_occr_dt, String slip_seq, String make_dt, String suply_amt, String vat_amt, String tot_amt, String setoff_yn, String canc_yn, String re_issu_resn_cd, String issu_tms, String tax_item, String suply_ern, String suply_dlco_no, String suply_dlco_nm, String suply_dlco_abrv_nm, String suply_presi_nm, String suply_addr, String suply_bizcond, String suply_item, String demand_ern, String demand_dlco_no, String demand_dlco_nm, String demand_dlco_abrv_nm, String demand_presi_nm, String demand_addr, String demand_bizcond, String demand_item, String demand_biz_plc, String trust_ern, String trust_dlco_no, String trust_dlco_nm, String trust_dlco_abrv_nm, String trust_presi_nm, String trust_addr, String trust_bizcond, String trust_item, String email_id, String elec_tax_comp_cd, String semuro_no, String chk_cnt, String remk, String chnl_clsf_cd){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.chnl_clsf_cd = Util.checkString(cstmt.getString(49));
		ResultSet rset0 = (ResultSet) cstmt.getObject(50);
		while(rset0.next()){
			AD_TAX_1030_SCURLISTRecord rec = new AD_TAX_1030_SCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_TAX_1030_SCURLISTRecord curlistRec = (AD_TAX_1030_SCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Wed Feb 04 14:00:03 KST 2015 */