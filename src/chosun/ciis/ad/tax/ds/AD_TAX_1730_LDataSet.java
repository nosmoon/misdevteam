...
import chosun.ciis.ad.tax.rec.AD_TAX_1730_LCURLISTRecord;
...
public class AD_TAX_1730_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;
	public String basi_dt;

	public AD_TAX_1730_LDataSet(){}
	public AD_TAX_1730_LDataSet(String errcode, String errmsg, String basi_dt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_TAX_1730_LCURLISTRecord rec = new AD_TAX_1730_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_TAX_1730_LCURLISTRecord curlistRec = (AD_TAX_1730_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
