...
import chosun.ciis.ad.tax.rec.AD_TAX_2700_MCURLISTRecord;
...
public class AD_TAX_2700_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist1 = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_TAX_2700_MDataSet(){}
	public AD_TAX_2700_MDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset1.next()){
			AD_TAX_2700_MCURLISTRecord rec = new AD_TAX_2700_MCURLISTRecord();
