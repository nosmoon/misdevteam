...
import chosun.ciis.ad.tax.rec.AD_TAX_2710_LCURLISTRecord;
...
public class AD_TAX_2710_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_TAX_2710_LDataSet(){}
	public AD_TAX_2710_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_TAX_2710_LCURLISTRecord rec = new AD_TAX_2710_LCURLISTRecord();
