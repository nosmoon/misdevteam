...
public class AD_TAX_1050_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_TAX_1050_LDataSet(){}
	public AD_TAX_1050_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_TAX_1050_LCURLISTRecord rec = new AD_TAX_1050_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_TAX_1050_LCURLISTRecord curlistRec = (AD_TAX_1050_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
