...
public class AD_TAX_2330_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{ 
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_TAX_2330_LDataSet(){}
	public AD_TAX_2330_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_TAX_2330_LCURLISTRecord rec = new AD_TAX_2330_LCURLISTRecord();
...
<%
	AD_TAX_2330_LDataSet ds = (AD_TAX_2330_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_TAX_2330_LCURLISTRecord curlistRec = (AD_TAX_2330_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Tue Nov 14 15:55:49 KST 2017 */