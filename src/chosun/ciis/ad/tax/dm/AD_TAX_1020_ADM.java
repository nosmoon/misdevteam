...
public class AD_TAX_1020_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_TAX_1020_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_1020_ADM dm = (AD_TAX_1020_ADM)bdm;
		...
		cstmt.setString(17, dm.vexc_cmpy_cd);
		cstmt.setString(18, dm.medi_cd);
		cstmt.setString(19, dm.checked);
		cstmt.setString(20, dm.pubc_slip_no);
		cstmt.setString(21, dm.pubc_dt);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_1020_ADataSet();
	}
...
/* 작성시간 : Wed Feb 04 13:59:06 KST 2015 */