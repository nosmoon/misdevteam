...
public class AD_TAX_2400_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String dealmedicd;
	public String emp_no;

	public AD_TAX_2400_MDM(){}
	public AD_TAX_2400_MDM(String cmpy_cd, String dealmedicd, String emp_no){
	...
	{
		 return "{ call MISADV.SP_AD_TAX_2400_M(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException
	{
		AD_TAX_2400_MDM dm = (AD_TAX_2400_MDM)bdm;
	...
	{
		return new chosun.ciis.ad.tax.ds.AD_TAX_2400_MDataSet();
	}
