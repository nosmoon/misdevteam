...
public class AD_TAX_1030_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_TAX_1030_SDM(){}
	public AD_TAX_1030_SDM(String hndl_clsf, String cmpy_cd, String medi_clsf, String prof_type_cd, String slip_clsf_cd, String slip_occr_dt, String slip_seq){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_TAX_1030_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_1030_SDM dm = (AD_TAX_1030_SDM)bdm;
		...
		cstmt.registerOutParameter(50, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_1030_SDataSet();
	}
