...
public class AD_TAX_2210_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_TAX_2210_LDM(){}
	public AD_TAX_2210_LDM(String cmpy_cd, String medi_cd, String hndl_clsf, String dlco_no, String prof_type_cd, String pubc_frdt, String pubc_todt, String make_frdt, String make_todt, String pre_issu_yn, String elec_tax_bill_yn, String acct_cd, String emp_no){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_TAX_2210_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_2210_LDM dm = (AD_TAX_2210_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_2210_LDataSet();
	}
