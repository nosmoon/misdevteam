...
public class AD_TAX_1010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_TAX_1010_LDM(){}
	public AD_TAX_1010_LDM(String cmpy_cd, String medi_cd, String frdt, String todt, String dlco_no, String agn, String chnl_clsf_cd){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_TAX_1010_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_1010_LDM dm = (AD_TAX_1010_LDM)bdm;
		...
		cstmt.setString(9, dm.chnl_clsf_cd);
		cstmt.registerOutParameter(10, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_1010_LDataSet();
	}
