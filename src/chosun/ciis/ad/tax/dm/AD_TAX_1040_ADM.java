...
public class AD_TAX_1040_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_TAX_1040_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_1040_ADM dm = (AD_TAX_1040_ADM)bdm;
		...
		cstmt.setString(33, dm.chnl_clsf_cd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_1040_ADataSet();
	}
...
/* 작성시간 : Wed Feb 04 14:00:13 KST 2015 */