...
public class AD_TAX_1420_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String work_clsf;
	public String clos_yymm;

	public AD_TAX_1420_LDM(){}
	public AD_TAX_1420_LDM(String cmpy_cd, String work_clsf, String clos_yymm){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_TAX_1420_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_1420_LDM dm = (AD_TAX_1420_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_1420_LDataSet();
	}
