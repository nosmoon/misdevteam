...
public class AD_TAX_2330_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{ 
	...
	public AD_TAX_2330_LDM(){}
	public AD_TAX_2330_LDM(String cmpy_cd, String medi_cd, String hndl_clsf, String dlco_no, String frdt, String todt, String basi_dt, String emp_no){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_TAX_2330_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_2330_LDM dm = (AD_TAX_2330_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_2330_LDataSet();
	}
