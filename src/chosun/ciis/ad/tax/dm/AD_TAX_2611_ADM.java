...
public class AD_TAX_2611_ADM extends somo.framework.db.BaseDM implements java.io.Serializable
{
	...
	public AD_TAX_2611_ADM(){}
	public AD_TAX_2611_ADM(String cmpy_cd, String work_clsf, String clos_dt, String incmg_dept_cd, String incmg_pers_ip, String incmg_pers)
	{
	...
	{
		 return "{ call MISADV.SP_AD_TAX_2611_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException
	{
		AD_TAX_2611_ADM dm = (AD_TAX_2611_ADM)bdm;
	...
	{
		return new chosun.ciis.ad.tax.ds.AD_TAX_2611_ADataSet();
	}
