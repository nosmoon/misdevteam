...
public class AD_TAX_1430_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_TAX_1430_LDM(){}
	public AD_TAX_1430_LDM(String cmpy_cd, String quarter, String proc_clsf, String clos_year){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_TAX_1430_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_1430_LDM dm = (AD_TAX_1430_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_1430_LDataSet();
	}
