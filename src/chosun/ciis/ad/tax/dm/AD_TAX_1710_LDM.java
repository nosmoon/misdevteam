...
public class AD_TAX_1710_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_TAX_1710_LDM(){}
	public AD_TAX_1710_LDM(String cmpy_cd, String frdt, String todt, String medi_clsf, String basi_dt, String pay_clsf){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_TAX_1710_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_1710_LDM dm = (AD_TAX_1710_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_1710_LDataSet();
	}
