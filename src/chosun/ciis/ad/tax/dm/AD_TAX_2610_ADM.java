...
public class AD_TAX_2610_ADM extends somo.framework.db.BaseDM implements java.io.Serializable
{
	...
	public AD_TAX_2610_ADM(){}
	public AD_TAX_2610_ADM(String cmpy_cd, String work_clsf, String clos_dt, String incmg_dept_cd, String incmg_pers_ip, String incmg_pers)
	{
	...
	{
		 return "{ call MISADV.SP_AD_TAX_2610_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException
	{
		AD_TAX_2610_ADM dm = (AD_TAX_2610_ADM)bdm;
	...
	{
		return new chosun.ciis.ad.tax.ds.AD_TAX_2610_ADataSet();
	}
