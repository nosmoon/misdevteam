...
public class AD_TAX_2110_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_TAX_2110_LDM(){}
	public AD_TAX_2110_LDM(String cmpy_cd, String hndl_clsf, String dlco_no, String medi_cd, String frdt, String todt, String pay_clsf, String basi_dt){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_TAX_2110_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_2110_LDM dm = (AD_TAX_2110_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_2110_LDataSet();
	}
...
/* 작성시간 : Thu Apr 02 09:25:54 KST 2009 */