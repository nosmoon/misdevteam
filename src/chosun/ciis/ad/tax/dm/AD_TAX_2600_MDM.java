...
public class AD_TAX_2600_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String clos_yymm;
	public String work_clsf;

	public AD_TAX_2600_MDM(){}
	public AD_TAX_2600_MDM(String cmpy_cd, String clos_yymm, String work_clsf){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_TAX_2600_M(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_2600_MDM dm = (AD_TAX_2600_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_2600_MDataSet();
	}
