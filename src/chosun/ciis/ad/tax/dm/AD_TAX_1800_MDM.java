...
public class AD_TAX_1800_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String dealmedicd;

	public AD_TAX_1800_MDM(){}
	public AD_TAX_1800_MDM(String cmpy_cd, String dealmedicd){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_TAX_1800_M(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_1800_MDM dm = (AD_TAX_1800_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_1800_MDataSet();
	}
