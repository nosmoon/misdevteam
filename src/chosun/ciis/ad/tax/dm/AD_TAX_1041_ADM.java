...
public class AD_TAX_1041_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String minus_mkdt;
	public String chnl_clsf_cd;

	public AD_TAX_1041_ADM(){}
	public AD_TAX_1041_ADM(String cmpy_cd, String slip_clsf_cd, String slip_occr_dt, String slip_seq, String prof_type_cd, String make_dt, String suply_amt, String vat_amt, String ern, String dlco_clsf_cd, String dlco_no, String dlco_nm, String presi_nm, String addr, String bizcond, String item, String medi_cd, String re_issu_resn_cd, String issu_tms, String tax_item, String checked, String pubc_slip_no, String pubc_dt, String email_id, String elec_tax_comp_cd, String semuro_no, String biz_plc_cd, String remk, String incmg_pers_ip, String incmg_pers, String minus_mkdt, String chnl_clsf_cd){
	...
	public void setMinus_mkdt(String minus_mkdt){
		this.minus_mkdt = minus_mkdt;
	}
	...
	public String getMinus_mkdt(){
		return this.minus_mkdt;
	}
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_TAX_1041_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_1041_ADM dm = (AD_TAX_1041_ADM)bdm;
		...
		cstmt.setString(33, dm.minus_mkdt);
		cstmt.setString(34, dm.chnl_clsf_cd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_1041_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("minus_mkdt = [" + getMinus_mkdt() + "]");
...
String minus_mkdt = req.getParameter("minus_mkdt");
if( minus_mkdt == null){
	System.out.println(this.toString+" : minus_mkdt is null" );
}else{
	System.out.println(this.toString+" : minus_mkdt is "+minus_mkdt );
}
...
String minus_mkdt = Util.checkString(req.getParameter("minus_mkdt"));
...
String minus_mkdt = Util.Uni2Ksc(Util.checkString(req.getParameter("minus_mkdt")));
...
/* 작성시간 : Wed Feb 04 14:00:24 KST 2015 */