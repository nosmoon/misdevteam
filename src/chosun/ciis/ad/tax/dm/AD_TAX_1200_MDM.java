...
public class AD_TAX_1200_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String dealmedicd;

	public AD_TAX_1200_MDM(){}
	public AD_TAX_1200_MDM(String cmpy_cd, String dealmedicd){
	...
	public String getSQL(){
		 return "{ call SP_AD_TAX_1200_M( ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_1200_MDM dm = (AD_TAX_1200_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_1200_MDataSet();
	}
...
/* 작성시간 : Thu Mar 19 09:39:54 KST 2009 */