...
public class AD_TAX_1120_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_TAX_1120_ADM(){}
	public AD_TAX_1120_ADM(String cmpy_cd, String hndl_clsf, String slip_clsf_cd, String slip_occr_dt, String make_dt, String suply_amt, String vat_amt, String ern, String dlco_no, String dlco_nm, String presi_nm, String addr, String bizcond, String item, String medi_cd, String pubc_frdt, String pubc_todt, String checked, String pubc_slip_no, String email_id, String elec_tax_comp_cd, String semuro_no, String incmg_pers_ip, String incmg_pers, String chnl_clsf){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_TAX_1120_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_1120_ADM dm = (AD_TAX_1120_ADM)bdm;
		...
		cstmt.setString(27, dm.chnl_clsf);
		cstmt.registerOutParameter(28, Types.VARCHAR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_1120_ADataSet();
	}
...
/* 작성시간 : Mon Feb 09 18:51:40 KST 2015 */