...
public class AD_TAX_1021_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_TAX_1021_ADM(){}
	public AD_TAX_1021_ADM(String cmpy_cd, String slip_clsf_cd, String slip_occr_dt, String slip_seq, String prof_type_cd, String make_dt, String tax_item, String suply_amt, String vat_amt, String checked, String pubc_slip_no, String pubc_dt, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_AD_TAX_1021_A( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_1021_ADM dm = (AD_TAX_1021_ADM)bdm;
		...
		cstmt.setString(9, dm.tax_item);
		cstmt.setString(10, dm.suply_amt);
		cstmt.setString(11, dm.vat_amt);
		cstmt.setString(12, dm.checked);
		cstmt.setString(13, dm.pubc_slip_no);
		cstmt.setString(14, dm.pubc_dt);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_1021_ADataSet();
	}
...
/* 작성시간 : Mon Mar 16 20:31:18 KST 2009 */