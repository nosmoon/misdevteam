...
public class AD_TAX_2810_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_TAX_2810_LDM(){}
	
	public AD_TAX_2810_LDM(String cmpy_cd, String medi_cd, String hndl_clsf, String dlco_no, String prof_type_cd, String pubc_frdt, String pubc_todt, String make_frdt, String make_todt, String emp_no) {
		super();
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_TAX_2810_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_2810_LDM dm = (AD_TAX_2810_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_2810_LDataSet();
	}
