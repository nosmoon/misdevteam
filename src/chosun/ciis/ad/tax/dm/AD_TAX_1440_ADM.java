...
public class AD_TAX_1440_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_TAX_1440_ADM(){}
	public AD_TAX_1440_ADM(String flag, String cmpy_cd, String work_clsf, String clos_dt, String mang_frdt, String mang_todt, String incmg_pers_ip, String incmg_pers){
		this.flag = flag;
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_TAX_1440_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_1440_ADM dm = (AD_TAX_1440_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_1440_ADataSet();
	}
...
/* 작성시간 : Wed Apr 01 12:29:12 KST 2009 */