...
public class AD_TAX_1050_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_TAX_1050_LDM(){}
	public AD_TAX_1050_LDM(String cmpy_cd, String medi_cd, String frdt, String todt, String dlco_no, String hndl_clsf, String chrg_pers, String advt_clas1, String advt_clas2, String chnl_clsf_cd){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_TAX_1050_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_1050_LDM dm = (AD_TAX_1050_LDM)bdm;
		...
		cstmt.setString(10, dm.advt_clas1);
		cstmt.setString(11, dm.advt_clas2);
		cstmt.setString(12, dm.chnl_clsf_cd);
		cstmt.registerOutParameter(13, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_1050_LDataSet();
	}
...
/* 작성시간 : Wed Feb 04 14:00:34 KST 2015 */