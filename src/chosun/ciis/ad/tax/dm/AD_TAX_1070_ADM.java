...
public class AD_TAX_1070_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_TAX_1070_ADM(){}
	public AD_TAX_1070_ADM(String cmpy_cd, String slip_clsf_cd, String slip_occr_dt, String slip_seq, String prof_type_cd, String make_dt, String suply_amt, String vat_amt, String ern, String dlco_clsf_cd, String dlco_no, String dlco_nm, String presi_nm, String addr, String bizcond, String item, String medi_cd, String re_issu_resn_cd, String issu_tms, String tax_item, String checked, String trust_dlco_no, String pubc_slip_no, String pubc_dt, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_TAX_1070_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_TAX_1070_ADM dm = (AD_TAX_1070_ADM)bdm;
		...
		cstmt.setString(25, dm.pubc_slip_no);
		cstmt.setString(26, dm.pubc_dt);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.tax.ds.AD_TAX_1070_ADataSet();
	}
...
/* 작성시간 : Wed Sep 16 18:19:48 KST 2009 */