...
public class AD_BRN_2012_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BRN_2012_LDM(){}
	public AD_BRN_2012_LDM(String cmpy_cd, String rept_clsf, String medi_clsf, String search_dt_fr, String search_dt_to, String advcs_clsf, String patr_chrg_pers, String chrg_pers, String search_wd, String dlco_no, String sch_clsf, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BRN_2012_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BRN_2012_LDM dm = (AD_BRN_2012_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.brn.ds.AD_BRN_2012_LDataSet();
	}
