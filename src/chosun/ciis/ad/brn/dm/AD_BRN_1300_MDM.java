...
public class AD_BRN_1300_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String dealmedicd;

	public AD_BRN_1300_MDM(){}
	public AD_BRN_1300_MDM(String cmpy_cd, String dealmedicd){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BRN_1300_M(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BRN_1300_MDM dm = (AD_BRN_1300_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.brn.ds.AD_BRN_1300_MDataSet();
	}
