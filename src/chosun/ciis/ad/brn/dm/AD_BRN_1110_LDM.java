...
public class AD_BRN_1110_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BRN_1110_LDM(){}
	public AD_BRN_1110_LDM(String cmpy_cd, String preng_advt_bo, String medi_cd, String frdt, String todt, String dlco_no){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BRN_1110_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BRN_1110_LDM dm = (AD_BRN_1110_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.brn.ds.AD_BRN_1110_LDataSet();
	}
