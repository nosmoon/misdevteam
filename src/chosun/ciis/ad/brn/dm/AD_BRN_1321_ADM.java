...
public class AD_BRN_1321_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BRN_1321_ADM(){}
	public AD_BRN_1321_ADM(String cmpy_cd, String slip_clsf_cd, String slip_occr_dt, String slip_seq, String prof_type_cd, String make_dt, String tax_item, String suply_amt, String vat_amt, String checked, String pubc_slip_no, String pubc_dt, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BRN_1321_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BRN_1321_ADM dm = (AD_BRN_1321_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.brn.ds.AD_BRN_1321_ADataSet();
	}
