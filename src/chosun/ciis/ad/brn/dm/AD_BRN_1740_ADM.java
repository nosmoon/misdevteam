...
public class AD_BRN_1740_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BRN_1740_ADM(){}
	public AD_BRN_1740_ADM(String cmpy_cd, String job_clsf, String cntc_seq, String answer_cont, String add_file_nm, byte[] add_file, String file_delyn, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BRN_1740_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BRN_1740_ADM dm = (AD_BRN_1740_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.brn.ds.AD_BRN_1740_ADataSet();
	}
...
/* 작성시간 : Thu May 07 16:34:48 KST 2009 */