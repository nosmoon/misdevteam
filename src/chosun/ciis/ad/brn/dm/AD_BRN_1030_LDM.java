...
public class AD_BRN_1030_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BRN_1030_LDM(){}
	public AD_BRN_1030_LDM(String cmpy_cd, String preng_advt_bo, String medi_cd, String bo_chrg_aprv, String pubc_dt){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BRN_1030_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BRN_1030_LDM dm = (AD_BRN_1030_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.preng_advt_bo);
		cstmt.setString(5, dm.medi_cd);
		cstmt.setString(6, dm.bo_chrg_aprv);
		cstmt.setString(7, dm.pubc_dt);
		cstmt.registerOutParameter(8, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.brn.ds.AD_BRN_1030_LDataSet();
	}
