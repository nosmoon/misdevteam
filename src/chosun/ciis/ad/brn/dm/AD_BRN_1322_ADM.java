...
public class AD_BRN_1322_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BRN_1322_ADM(){}
	public AD_BRN_1322_ADM(String cmpy_cd, String slip_clsf_cd, String slip_occr_dt, String slip_seq, String prof_type_cd, String make_dt, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BRN_1322_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BRN_1322_ADM dm = (AD_BRN_1322_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.brn.ds.AD_BRN_1322_ADataSet();
	}
