...
public class AD_BRN_2000_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String page_id;

	public AD_BRN_2000_MDM(){}
	public AD_BRN_2000_MDM(String cmpy_cd, String page_id){
	...
	public String getSQL(){
		 return "{ call SP_AD_BRN_2000_M( ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BRN_2000_MDM dm = (AD_BRN_2000_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.brn.ds.AD_BRN_2000_MDataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
