...
public class AD_BRN_2030_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BRN_2030_ADM(){}
	public AD_BRN_2030_ADM(String cmpy_cd, String rept_clsf, String make_dt, long rept_no, String taem_chf_opn, String incmg_pers, String flag){
	...
	public String getSQL(){
		 return "{ call SP_AD_BRN_2030_A( ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BRN_2030_ADM dm = (AD_BRN_2030_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.brn.ds.AD_BRN_2030_ADataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
