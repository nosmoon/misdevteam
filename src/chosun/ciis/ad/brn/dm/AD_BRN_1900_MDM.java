...
public class AD_BRN_1900_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String preng_advt_bo;

	public AD_BRN_1900_MDM(){}
	public AD_BRN_1900_MDM(String cmpy_cd, String preng_advt_bo){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BRN_1900_M(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BRN_1900_MDM dm = (AD_BRN_1900_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.brn.ds.AD_BRN_1900_MDataSet();
	}
