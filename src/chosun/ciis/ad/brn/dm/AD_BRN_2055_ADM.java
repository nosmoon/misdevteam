...
public class AD_BRN_2055_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BRN_2055_ADM(){}
	public AD_BRN_2055_ADM(String cmpy_cd, String rept_clsf, String make_dt, long rept_no, long add_file_no){
	...
	public String getSQL(){
		 return "{ call SP_AD_BRN_2055_A( ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BRN_2055_ADM dm = (AD_BRN_2055_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.brn.ds.AD_BRN_2055_ADataSet();
	}
}
/*----------------------------------------------------------------------------------------------------
