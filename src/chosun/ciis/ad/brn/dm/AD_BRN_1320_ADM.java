...
public class AD_BRN_1320_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BRN_1320_ADM(){}
	public AD_BRN_1320_ADM(String cmpy_cd, String slip_clsf_cd, String slip_occr_dt, String slip_seq, String prof_type_cd, String make_dt, String suply_amt, String vat_amt, String ern, String dlco_clsf_cd, String dlco_no, String dlco_nm, String presi_nm, String addr, String bizcond, String item, String medi_cd, String re_issu_resn_cd, String issu_tms, String tax_item, String checked, String trust_dlco_no, String pubc_slip_no, String pubc_dt, String email_id, String elec_tax_comp_cd, String semuro_no, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BRN_1320_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BRN_1320_ADM dm = (AD_BRN_1320_ADM)bdm;
		...
		//cstmt.setString(24, dm.trust_dlco_no);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.brn.ds.AD_BRN_1320_ADataSet();
	}
...
/* 작성시간 : Tue Jul 21 19:22:02 KST 2009 */