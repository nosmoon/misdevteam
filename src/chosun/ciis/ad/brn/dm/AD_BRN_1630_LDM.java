...
public class AD_BRN_1630_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BRN_1630_LDM(){}
	public AD_BRN_1630_LDM(String cmpy_cd, String medi_cd, String frdt, String todt, String dlco_no, String preng_advt_bo, String search_mode){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BRN_1630_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BRN_1630_LDM dm = (AD_BRN_1630_LDM)bdm;
		...
		cstmt.setString(9, dm.search_mode);
		cstmt.registerOutParameter(10, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.brn.ds.AD_BRN_1630_LDataSet();
	}
