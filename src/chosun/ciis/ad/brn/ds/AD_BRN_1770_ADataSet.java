...
public class AD_BRN_1770_ADataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public AD_BRN_1770_ADataSet(){}
	public AD_BRN_1770_ADataSet(String errcode, String errmsg, String add_file_nm, byte[] add_file){
...
<%
	AD_BRN_1770_ADataSet ds = (AD_BRN_1770_ADataSet)request.getAttribute("ds");
%>
