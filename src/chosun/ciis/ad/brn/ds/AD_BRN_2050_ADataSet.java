...
public class AD_BRN_2050_ADataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public AD_BRN_2050_ADataSet(){}
	public AD_BRN_2050_ADataSet(String errcode, String errmsg, String rept_no, String add_file_no1, String add_file_no2, String add_file_no3, String add_file_no4, String add_file_no5){
...
<%
	AD_BRN_2050_ADataSet ds = (AD_BRN_2050_ADataSet)request.getAttribute("ds");
%>
