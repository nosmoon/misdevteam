...
public class AD_BRN_2055_ADataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public AD_BRN_2055_ADataSet(){}
	public AD_BRN_2055_ADataSet(String errcode, String errmsg, String add_file_nm, byte[] add_file){
...
<%
	AD_BRN_2055_ADataSet ds = (AD_BRN_2055_ADataSet)request.getAttribute("ds");
%>
