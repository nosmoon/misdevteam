...
public class AD_NMD_2010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String adjm_dt;
	public String incmg_pers;

	public AD_NMD_2010_LDM(){}
	public AD_NMD_2010_LDM(String cmpy_cd, String adjm_dt, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_NMD_2010_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_NMD_2010_LDM dm = (AD_NMD_2010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.nmd.ds.AD_NMD_2010_LDataSet();
	}
