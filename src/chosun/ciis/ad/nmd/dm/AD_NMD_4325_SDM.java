...
public class AD_NMD_4325_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_NMD_4325_SDM(){}
	public AD_NMD_4325_SDM(String cmpy_cd, String drbk_clsf, String slip_occr_dt, String slip_clsf_cd, String slip_seq){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_NMD_4325_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_NMD_4325_SDM dm = (AD_NMD_4325_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.nmd.ds.AD_NMD_4325_SDataSet();
	}
