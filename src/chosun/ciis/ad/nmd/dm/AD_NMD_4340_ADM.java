...
public class AD_NMD_4340_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_NMD_4340_ADM(){}
	public AD_NMD_4340_ADM(String flag, String cmpy_cd, String payo_clsf, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String medi_cd, String hndl_clsf, String dlco_no, String dlco_nm, String drbk_amt, String incmg_dept_cd, String incmg_pers_ip, String incmg_pers){
		this.flag = flag;
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_NMD_4340_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_NMD_4340_ADM dm = (AD_NMD_4340_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.nmd.ds.AD_NMD_4340_ADataSet();
	}
...
/* 작성시간 : Mon Aug 04 11:46:49 KST 2014 */