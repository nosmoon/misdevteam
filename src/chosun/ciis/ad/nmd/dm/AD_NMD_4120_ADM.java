...
public class AD_NMD_4120_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_NMD_4120_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_NMD_4120_ADM dm = (AD_NMD_4120_ADM)bdm;
		...
		cstmt.setString(43, dm.mode3);
		cstmt.setString(44, dm.checked3);
		cstmt.setString(45, dm.medi_cd3);
		cstmt.setString(46, dm.amt3);
		cstmt.setString(47, dm.rcpm_slip_no3);
		cstmt.setString(48, dm.occr_dt3);
		cstmt.setString(49, dm.slip_clsf3);
		cstmt.setString(50, dm.seq3);
		cstmt.setString(51, dm.subseq3);
		cstmt.setString(52, dm.mode4);
		cstmt.setString(53, dm.checked4);
		cstmt.setString(54, dm.swit_dlco4);
		cstmt.setString(55, dm.amt4);
		cstmt.setString(56, dm.rcpm_slip_no4);
		cstmt.setString(57, dm.budg_cd4);
		cstmt.setString(58, dm.occr_dt4);
		cstmt.setString(59, dm.slip_clsf4);
		cstmt.setString(60, dm.seq4);
		cstmt.setString(61, dm.subseq4);
		cstmt.setString(62, dm.mode5);
		cstmt.setString(63, dm.checked5);
		cstmt.setString(64, dm.budg_cd5);
		cstmt.setString(65, dm.amt5);
		cstmt.setString(66, dm.rcpm_slip_no5);
		cstmt.setString(67, dm.occr_dt5);
		cstmt.setString(68, dm.slip_clsf5);
		cstmt.setString(69, dm.seq5);
		cstmt.setString(70, dm.subseq5);
		cstmt.setString(71, dm.medi_cd6);
		cstmt.setString(72, dm.amt6);
		cstmt.setString(73, dm.depo_job_clsf7);
		cstmt.setString(74, dm.amt7);
		cstmt.setString(75, dm.swit_dlco7);
		cstmt.setString(76, dm.amt8);
		cstmt.setString(77, dm.budg_cd8);
		cstmt.setString(78, dm.incmg_pers_ip);
		cstmt.setString(79, dm.incmg_pers);
		cstmt.setString(80, dm.elec_note_key);
		cstmt.registerOutParameter(81, Types.VARCHAR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.nmd.ds.AD_NMD_4120_ADataSet();
	}
...
/* 작성시간 : Mon Apr 07 16:51:18 KST 2014 */