...
public class AD_NMD_5110_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_NMD_5110_LDM(){}
	public AD_NMD_5110_LDM(String cmpy_cd, String medi_cd, String hndl_clsf, String dlco_no, String pubc_frdt, String pubc_todt){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_NMD_5110_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_NMD_5110_LDM dm = (AD_NMD_5110_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.nmd.ds.AD_NMD_5110_LDataSet();
	}
