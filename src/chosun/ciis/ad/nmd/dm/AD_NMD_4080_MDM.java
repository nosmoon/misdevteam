...
public class AD_NMD_4080_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String clos_yymm;
	public String work_clsf;

	public AD_NMD_4080_MDM(){}
	public AD_NMD_4080_MDM(String cmpy_cd, String clos_yymm, String work_clsf){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_NMD_4080_M(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_NMD_4080_MDM dm = (AD_NMD_4080_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.nmd.ds.AD_NMD_4080_MDataSet();
	}
...
/* 작성시간 : Mon Sep 29 17:27:02 KST 2014 */