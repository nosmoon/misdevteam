...
public class AD_NMD_5022_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_NMD_5022_ADM(){}
	public AD_NMD_5022_ADM(String cmpy_cd, String slip_clsf_cd, String slip_occr_dt, String slip_seq, String prof_type_cd, String make_dt, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_NMD_5022_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_NMD_5022_ADM dm = (AD_NMD_5022_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.nmd.ds.AD_NMD_5022_ADataSet();
	}
...
/* 작성시간 : Tue Apr 22 11:57:11 KST 2014 */