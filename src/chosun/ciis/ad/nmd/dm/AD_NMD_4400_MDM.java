...
public class AD_NMD_4400_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String dealmedicd;

	public AD_NMD_4400_MDM(){}
	public AD_NMD_4400_MDM(String cmpy_cd, String dealmedicd){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_NMD_4400_M(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_NMD_4400_MDM dm = (AD_NMD_4400_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.nmd.ds.AD_NMD_4400_MDataSet();
	}
