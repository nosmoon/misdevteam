...
public class AD_NMD_5121_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_NMD_5121_ADM(){}
	public AD_NMD_5121_ADM(String cmpy_cd, String slip_clsf_cd, String slip_occr_dt, String slip_seq, String prof_type_cd, String medi_cd, String dlco_no, String make_dt, String suply_amt, String vat_amt, String pubc_frdt, String pubc_todt, String checked, String pubc_slip_no, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_NMD_5121_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_NMD_5121_ADM dm = (AD_NMD_5121_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.nmd.ds.AD_NMD_5121_ADataSet();
	}
...
/* 작성시간 : Wed May 28 15:58:49 KST 2014 */