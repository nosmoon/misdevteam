...
public class AD_NMD_4110_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_NMD_4110_SDM(){}
	public AD_NMD_4110_SDM(String cmpy_cd, String medi_clsf, String occr_dt, String slip_clsf, String seq){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_NMD_4110_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_NMD_4110_SDM dm = (AD_NMD_4110_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.nmd.ds.AD_NMD_4110_SDataSet();
	}
