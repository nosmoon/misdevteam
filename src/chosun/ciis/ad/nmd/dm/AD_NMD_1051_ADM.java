...
public class AD_NMD_1051_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String sell_mm;

	public AD_NMD_1051_ADM(){}
	public AD_NMD_1051_ADM(String cmpy_cd, String sell_mm){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_NMD_1051_A(? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_NMD_1051_ADM dm = (AD_NMD_1051_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.nmd.ds.AD_NMD_1051_ADataSet();
	}
...
/* 작성시간 : Wed Aug 22 10:36:56 KST 2012 */