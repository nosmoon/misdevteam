...
public class AD_NMD_4081_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_NMD_4081_LDM(){}
	public AD_NMD_4081_LDM(String cmpy_cd, String medi_cd, String frdt, String todt, String agn){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_NMD_4081_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_NMD_4081_LDM dm = (AD_NMD_4081_LDM)bdm;
		...
		cstmt.setString(7, dm.agn);
		cstmt.registerOutParameter(8, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.nmd.ds.AD_NMD_4081_LDataSet();
	}
