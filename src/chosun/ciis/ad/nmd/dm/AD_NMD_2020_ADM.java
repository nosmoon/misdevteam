...
public class AD_NMD_2020_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_NMD_2020_ADM(){}
	public AD_NMD_2020_ADM(String cmpy_cd, String sell_mm, String pay_dt, String occr_dt, String checked, String dlco_no, String dlco_nm, String adjst_amt, String exp_yn, String incmg_pers_ip, String incmg_dept_cd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_NMD_2020_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_NMD_2020_ADM dm = (AD_NMD_2020_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.nmd.ds.AD_NMD_2020_ADataSet();
	}
...
/* 작성시간 : Thu Jul 05 16:58:28 KST 2012 */