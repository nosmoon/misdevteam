...
public class AD_NMD_4070_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_NMD_4070_LDM(){}
	public AD_NMD_4070_LDM(String cmpy_cd, String fr_dt, String to_dt, String select_dt, String medi_cd){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_NMD_4070_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_NMD_4070_LDM dm = (AD_NMD_4070_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.fr_dt);
		cstmt.setString(5, dm.to_dt);
		cstmt.setString(6, dm.select_dt);
		cstmt.setString(7, dm.medi_cd);
		cstmt.registerOutParameter(8, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.nmd.ds.AD_NMD_4070_LDataSet();
	}
