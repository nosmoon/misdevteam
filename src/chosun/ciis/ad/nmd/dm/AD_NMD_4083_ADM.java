...
public class AD_NMD_4083_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_NMD_4083_ADM(){}
	public AD_NMD_4083_ADM(String cmpy_cd, String work_clsf, String clos_dt, String incmg_dept_cd, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_NMD_4083_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_NMD_4083_ADM dm = (AD_NMD_4083_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.nmd.ds.AD_NMD_4083_ADataSet();
	}
...
/* 작성시간 : Mon Sep 29 17:55:32 KST 2014 */