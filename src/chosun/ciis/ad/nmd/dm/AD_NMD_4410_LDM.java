...
public class AD_NMD_4410_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_NMD_4410_LDM(){}
	public AD_NMD_4410_LDM(String cmpy_cd, String dealmedicd, String medi_cd, String hndl_clsf, String dlco_no, String frdt, String todt, String fr_rcpm_shet_no, String to_rcpm_shet_no, String acct_cd, String rmtt_dt, String rmtt_amt, String rmtt_plac, String proc_clsf){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_NMD_4410_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_NMD_4410_LDM dm = (AD_NMD_4410_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.nmd.ds.AD_NMD_4410_LDataSet();
	}
...
/* 작성시간 : Tue Aug 05 10:51:56 KST 2014 */