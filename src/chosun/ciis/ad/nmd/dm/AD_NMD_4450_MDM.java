...
public class AD_NMD_4450_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String medi_clsf;
	public String emp_no;

	public AD_NMD_4450_MDM(){}
	public AD_NMD_4450_MDM(String cmpy_cd, String medi_clsf, String emp_no){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_NMD_4450_M(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_NMD_4450_MDM dm = (AD_NMD_4450_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.nmd.ds.AD_NMD_4450_MDataSet();
	}
