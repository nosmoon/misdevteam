...
public class AD_NMD_4000_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_NMD_4000_MDataSet(){}
	public AD_NMD_4000_MDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_NMD_4000_MCURLISTRecord rec = new AD_NMD_4000_MCURLISTRecord();
...
<%
	AD_NMD_4000_MDataSet ds = (AD_NMD_4000_MDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_NMD_4000_MCURLISTRecord curlistRec = (AD_NMD_4000_MCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Fri Mar 21 10:49:29 KST 2014 */