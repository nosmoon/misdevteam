...
public class AD_NMD_5010_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_NMD_5010_LDataSet(){}
	public AD_NMD_5010_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_NMD_5010_LCURLISTRecord rec = new AD_NMD_5010_LCURLISTRecord();
...
<%
	AD_NMD_5010_LDataSet ds = (AD_NMD_5010_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_NMD_5010_LCURLISTRecord curlistRec = (AD_NMD_5010_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
