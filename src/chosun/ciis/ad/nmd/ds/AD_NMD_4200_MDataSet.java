...
public class AD_NMD_4200_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_NMD_4200_MDataSet(){}
	public AD_NMD_4200_MDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_NMD_4200_MCURLISTRecord rec = new AD_NMD_4200_MCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_NMD_4200_MCURLISTRecord curlistRec = (AD_NMD_4200_MCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
