...
public class AD_NMD_4151_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public AD_NMD_4151_LDataSet(){}
	public AD_NMD_4151_LDataSet(String errcode, String errmsg, String occr_dt, String slip_clsf, String seq, String medi_cd, String dlco_no, String rcpm_plac_clsf, String dlco_nm, long rcpm_tot_amt, long pubc_tot_amt, long setoff_done_amt, long setoff_tobe_amt, long final_setoff_yn, String pubc_frdt, String pubc_todt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.pubc_tot_amt = cstmt.getLong(15);
		this.setoff_done_amt = cstmt.getLong(16);
		this.setoff_tobe_amt = cstmt.getLong(17);
		this.final_setoff_yn = cstmt.getLong(18);
		this.pubc_frdt = Util.checkString(cstmt.getString(19));
		this.pubc_todt = Util.checkString(cstmt.getString(20));
		ResultSet rset0 = (ResultSet) cstmt.getObject(21);
		while(rset0.next()){
			AD_NMD_4151_LCURLISTRecord rec = new AD_NMD_4151_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_NMD_4151_LCURLISTRecord curlistRec = (AD_NMD_4151_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
