...
public class AD_NMD_5011_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public AD_NMD_5011_SDataSet(){}
	public AD_NMD_5011_SDataSet(String errcode, String errmsg, String dlco_no, String ern, String dlco_nm, String dlco_abrv_nm, String presi_nm, String addr, String bizcond, String item, String corp_clsf, String elec_tax_comp_cd, String email_id){
...
<%
	AD_NMD_5011_SDataSet ds = (AD_NMD_5011_SDataSet)request.getAttribute("ds");
%>
...
/* 작성시간 : Tue Apr 22 11:56:36 KST 2014 */