...
public class AD_PUB_1720_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_PUB_1720_ADM(){}
	public AD_PUB_1720_ADM(String flag, String cmpy_cd, String medi_cd, String pubc_occr_dt, String pubc_occr_seq, String proc_dt, String proc_seq, String div_dt, String dlco_no, String advt_cont, String advt_fee, String vat, String pubc_tot_amt, String fee, String coms, String div_pubc_occr_dt, String div_pubc_occr_seq, String incmg_pers_ip, String incmg_pers){
		this.flag = flag;
	...
	public String getSQL(){
		 return "{ call SP_AD_PUB_1720_A( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_PUB_1720_ADM dm = (AD_PUB_1720_ADM)bdm;
		...
		cstmt.setString(13, dm.advt_fee);
		cstmt.setString(14, dm.vat);
		cstmt.setString(15, dm.pubc_tot_amt);
		cstmt.setString(16, dm.fee);
		cstmt.setString(17, dm.coms);
		cstmt.setString(18, dm.div_pubc_occr_dt);
		cstmt.setString(19, dm.div_pubc_occr_seq);
		cstmt.setString(20, dm.incmg_pers_ip);
		cstmt.setString(21, dm.incmg_pers);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.pub.ds.AD_PUB_1720_ADataSet();
	}
...
/* 작성시간 : Tue Feb 17 16:00:45 KST 2009 */