...
public class AD_PUB_1710_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_PUB_1710_SDM(){}
	public AD_PUB_1710_SDM(String cmpy_cd, String medi_cd, String proc_dt, String proc_seq){
	...
	public String getSQL(){
		 return "{ call SP_AD_PUB_1710_S( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_PUB_1710_SDM dm = (AD_PUB_1710_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.pub.ds.AD_PUB_1710_SDataSet();
	}
