...
public class AD_PUB_1630_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String medi_cd;
	public String search_dt;

	public AD_PUB_1630_LDM(){}
	public AD_PUB_1630_LDM(String cmpy_cd, String medi_cd, String search_dt){
	...
	public String getSQL(){
		 return "{ call SP_AD_PUB_1630_L( ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_PUB_1630_LDM dm = (AD_PUB_1630_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.pub.ds.AD_PUB_1630_LDataSet();
	}
