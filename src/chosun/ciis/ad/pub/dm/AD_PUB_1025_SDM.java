...
public class AD_PUB_1025_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_PUB_1025_SDM(){}
	public AD_PUB_1025_SDM(String cmpy_cd, String medi_cd, String preng_occr_dt, String preng_occr_seq){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_PUB_1025_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_PUB_1025_SDM dm = (AD_PUB_1025_SDM)bdm;
		...
		cstmt.registerOutParameter(62, OracleTypes.CURSOR);
		cstmt.registerOutParameter(63, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.pub.ds.AD_PUB_1025_SDataSet();
	}
