...
public class AD_PUB_3027_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_PUB_3027_ADM(){}
	public AD_PUB_3027_ADM(String cmpy_cd, String clos_dt, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_PUB_3027_A(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_PUB_3027_ADM dm = (AD_PUB_3027_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.pub.ds.AD_PUB_3027_ADataSet();
	}
...
/* 작성시간 : Tue Feb 14 16:28:03 KST 2012 */