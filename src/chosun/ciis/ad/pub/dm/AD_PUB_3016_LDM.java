...
public class AD_PUB_3016_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_PUB_3016_LDM(){}
	public AD_PUB_3016_LDM(String cmpy_cd, String medi_clsf, String medi_cd, String frdt, String todt, String line_advt_yn, String nwsp_advt_yn, String self_advt_yn, String grp_cmpy, String indt_clsf_1, String indt_clsf_2, String type_clsf_1, String type_clsf_2, String dlco_clsf, String dlco_no, String slcrg_pers, String mchrg_pers, String emp_no, String ilbo_total){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_PUB_3016_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_PUB_3016_LDM dm = (AD_PUB_3016_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.pub.ds.AD_PUB_3016_LDataSet();
	}
...
/* 작성시간 : Thu Nov 22 17:54:46 KST 2012 */