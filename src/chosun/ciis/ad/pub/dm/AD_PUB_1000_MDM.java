...
public class AD_PUB_1000_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String medi_clsf;

	public AD_PUB_1000_MDM(){}
	public AD_PUB_1000_MDM(String cmpy_cd, String medi_clsf){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_PUB_1000_M(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_PUB_1000_MDM dm = (AD_PUB_1000_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.pub.ds.AD_PUB_1000_MDataSet();
	}
