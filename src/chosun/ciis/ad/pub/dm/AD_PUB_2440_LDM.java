...
public class AD_PUB_2440_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_PUB_2440_LDM(){}
	public AD_PUB_2440_LDM(String cmpy_cd, String frdt, String todt, String evnt_clsf, String spn_clsf){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_PUB_2440_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_PUB_2440_LDM dm = (AD_PUB_2440_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.pub.ds.AD_PUB_2440_LDataSet();
	}
