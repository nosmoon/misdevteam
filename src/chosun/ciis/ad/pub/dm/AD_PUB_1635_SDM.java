...
public class AD_PUB_1635_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_PUB_1635_SDM(){}
	public AD_PUB_1635_SDM(String cmpy_cd, String medi_cd, String pubc_occr_seq, String pubc_occr_dt){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_PUB_1635_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_PUB_1635_SDM dm = (AD_PUB_1635_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.pub.ds.AD_PUB_1635_SDataSet();
	}
