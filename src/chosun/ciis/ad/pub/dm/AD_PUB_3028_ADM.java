...
public class AD_PUB_3028_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_PUB_3028_ADM(){}
	public AD_PUB_3028_ADM(String cmpy_cd, String clos_dt, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_AD_PUB_3028_A(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_PUB_3028_ADM dm = (AD_PUB_3028_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.pub.ds.AD_PUB_3028_ADataSet();
	}
...
/* 작성시간 : Tue Feb 14 17:32:17 KST 2012 */