...
public class AD_PUB_3051_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String fr_dt;
	public String to_dt;

	public AD_PUB_3051_LDM(){}
	public AD_PUB_3051_LDM(String cmpy_cd, String fr_dt, String to_dt){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_PUB_3051_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_PUB_3051_LDM dm = (AD_PUB_3051_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.pub.ds.AD_PUB_3051_LDataSet();
	}
