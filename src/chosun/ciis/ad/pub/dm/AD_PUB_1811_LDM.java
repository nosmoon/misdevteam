...
public class AD_PUB_1811_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_PUB_1811_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_PUB_1811_LDM dm = (AD_PUB_1811_LDM)bdm;
		...
		cstmt.setString(40, dm.acct_cd);
		cstmt.setString(41, dm.emp_no);
		cstmt.setString(42, dm.indt_clsf_1);
		cstmt.setString(43, dm.indt_clsf_2);
		cstmt.setString(44, dm.type_clsf_1);
		cstmt.setString(45, dm.type_clsf_2);
		cstmt.setString(46, dm.line_advt_yn);
		cstmt.setString(47, dm.nwsp_type_yn);
		cstmt.setString(48, dm.self_advt_yn);
		cstmt.setString(49, dm.ilbo_total);
		cstmt.setString(50, dm.evnt_clsf);
		cstmt.registerOutParameter(51, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.pub.ds.AD_PUB_1811_LDataSet();
	}
...
/* 작성시간 : Fri Jan 13 17:23:27 KST 2017 */