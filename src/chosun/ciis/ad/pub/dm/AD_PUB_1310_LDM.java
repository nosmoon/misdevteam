...
public class AD_PUB_1310_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_PUB_1310_LDM(){}
	public AD_PUB_1310_LDM(String cmpy_cd, String medi_cd, String frdt, String todt, String approval, String advt_cont){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_PUB_1310_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_PUB_1310_LDM dm = (AD_PUB_1310_LDM)bdm;
		...
		cstmt.setString(7, dm.approval);
		cstmt.setString(8, dm.advt_cont);
		cstmt.registerOutParameter(9, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.pub.ds.AD_PUB_1310_LDataSet();
	}
