...
public class AD_PUB_1110_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_PUB_1110_LDM(){}
	public AD_PUB_1110_LDM(String cmpy_cd, String medi_cd, String proc_dt, String hndl_clsf, String hndl_plac_cd, String slcrg_pers, String mchrg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_PUB_1110_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_PUB_1110_LDM dm = (AD_PUB_1110_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.pub.ds.AD_PUB_1110_LDataSet();
	}
