...
public class AD_PUB_3025_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_PUB_3025_ADM(){}
	public AD_PUB_3025_ADM(String cmpy_cd, String clos_dt, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_AD_PUB_3025_A(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_PUB_3025_ADM dm = (AD_PUB_3025_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.pub.ds.AD_PUB_3025_ADataSet();
	}
...
/* 작성시간 : Tue Jan 31 15:10:15 KST 2012 */