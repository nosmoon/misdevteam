...
public class AD_PUB_1010_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_PUB_1010_SDM(){}
	public AD_PUB_1010_SDM(String cmpy_cd, String medi_cd, String proc_dt, String proc_seq){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_PUB_1010_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_PUB_1010_SDM dm = (AD_PUB_1010_SDM)bdm;
		...
		cstmt.registerOutParameter(85, OracleTypes.CURSOR);
		cstmt.registerOutParameter(86, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.pub.ds.AD_PUB_1010_SDataSet();
	}
