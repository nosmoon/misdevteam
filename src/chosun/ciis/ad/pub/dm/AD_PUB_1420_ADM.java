...
public class AD_PUB_1420_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_PUB_1420_ADM(){}
	public AD_PUB_1420_ADM(String cmpy_cd, String work_clsf, String clos_dt, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_AD_PUB_1420_A( ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_PUB_1420_ADM dm = (AD_PUB_1420_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.pub.ds.AD_PUB_1420_ADataSet();
	}
...
/* 작성시간 : Fri Mar 06 16:54:10 KST 2009 */