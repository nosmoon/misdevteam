...
public class AD_PUB_2460_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_PUB_2460_LDM(){}
	public AD_PUB_2460_LDM(String cmpy_cd, String frdt, String todt, String evnt_clsf, String spn_clsf){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_PUB_2460_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_PUB_2460_LDM dm = (AD_PUB_2460_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.frdt);
		cstmt.setString(5, dm.todt);
		cstmt.setString(6, dm.evnt_clsf);
		cstmt.setString(7, dm.spn_clsf);
		cstmt.registerOutParameter(8, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.pub.ds.AD_PUB_2460_LDataSet();
	}
