...
public class AD_PUB_1035_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public AD_PUB_1035_SDataSet(String errcode, String errmsg, String medi_cd, String pubc_occr_seq, String pubc_occr_dt, String proc_dt, String proc_seq, String hndl_clsf, String dlco_no, String dlco_nm, String advt_cont, String sect_cd, String sect_seq, String cm, String dn, String uprc, String advt_fee, String vat, String pubc_tot_amt, String agn, String agn_nm, String fee_rate, String fee, String hndl_plac_cd, String hndl_plac_nm, String coms_rate, String coms, String advt_clas, String indt_clsf, String indt_clsf_nm, String mony_kind, String chro_clsf, String type_clsf, String type_clsf_nm, String exrate, String pubc_clsf, String appndx_clsf, String frex_cntr_amt, String edt_clsf, String grp_cmpy_cd, String slcrg_pers, String slcrg_pers_nm, String dept_cd, String dept_nm, String mchrg_pers, String mchrg_pers_nm, String rtax_yn, String upd_resn, String govern_advt_yn, String upd_cont, String tabl_yn, String remk, String pubc_dt, String pre_pubc_slip_no, String pre_pubc_slip_no_crte_dt, String upd_yn, String div_yn, String clos_stat, String clamt_stat, String sale_stmt_issu_yn, String purc_stmt_issu_yn, String purc_stmt_issu_yn2, String elec_tax_stmt_yn, String pubc_side, String std_clsf, String pubc_prd, String pubc_frdt, String pubc_todt, String hp_edt_clsf, String brdg_advt_yn, String nwsp_type_yn, String nwsp_side_type, String dtls_medi_cd, String pre_issu_yn, String pre_day_issu, String seq_clsf, String asist_pers, String asist_pers_nm, String fee_vat, String coms_vat, String pragn_yn){
		...
		this.asist_pers = asist_pers;
		this.asist_pers_nm = asist_pers_nm;
	...
	public void setAsist_pers(String asist_pers){
		this.asist_pers = asist_pers;
	}

	public void setAsist_pers_nm(String asist_pers_nm){
		this.asist_pers_nm = asist_pers_nm;
	}
	...
	public String getAsist_pers(){
		return this.asist_pers;
	}

	public String getAsist_pers_nm(){
		return this.asist_pers_nm;
	}
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.pre_issu_yn = Util.checkString(cstmt.getString(75));
		this.pre_day_issu = Util.checkString(cstmt.getString(76));
		this.seq_clsf = Util.checkString(cstmt.getString(77));
		this.asist_pers = Util.checkString(cstmt.getString(78));
		this.asist_pers_nm = Util.checkString(cstmt.getString(79));
		this.fee_vat = Util.checkString(cstmt.getString(80));
		this.coms_vat = Util.checkString(cstmt.getString(81));
		this.pragn_yn = Util.checkString(cstmt.getString(82));
		ResultSet rset0 = (ResultSet) cstmt.getObject(83);
		while(rset0.next()){
			AD_PUB_1035_SCURLISTRecord rec = new AD_PUB_1035_SCURLISTRecord();
		...
		ResultSet rset1 = (ResultSet) cstmt.getObject(84);
		while(rset1.next()){
			AD_PUB_1035_SCURLIST2Record rec = new AD_PUB_1035_SCURLIST2Record();
...
<%
	AD_PUB_1035_SDataSet ds = (AD_PUB_1035_SDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_PUB_1035_SCURLISTRecord curlistRec = (AD_PUB_1035_SCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		AD_PUB_1035_SCURLIST2Record curlist2Rec = (AD_PUB_1035_SCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>
