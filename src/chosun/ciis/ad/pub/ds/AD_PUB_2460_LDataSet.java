...
public class AD_PUB_2460_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_PUB_2460_LDataSet(){}
	public AD_PUB_2460_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_PUB_2460_LCURLISTRecord rec = new AD_PUB_2460_LCURLISTRecord();
...
<%
	AD_PUB_2460_LDataSet ds = (AD_PUB_2460_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_PUB_2460_LCURLISTRecord curlistRec = (AD_PUB_2460_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Thu Dec 14 17:27:17 KST 2017 */