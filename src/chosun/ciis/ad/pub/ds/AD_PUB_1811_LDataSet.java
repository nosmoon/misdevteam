...
public class AD_PUB_1811_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_PUB_1811_LDataSet(){}
	public AD_PUB_1811_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_PUB_1811_LCURLISTRecord rec = new AD_PUB_1811_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_PUB_1811_LCURLISTRecord curlistRec = (AD_PUB_1811_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
