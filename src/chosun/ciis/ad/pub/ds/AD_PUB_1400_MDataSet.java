...
import chosun.ciis.ad.pub.rec.AD_PUB_1400_MCURLISTRecord;
...
public class AD_PUB_1400_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_PUB_1400_MDataSet(){}
	public AD_PUB_1400_MDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_PUB_1400_MCURLISTRecord rec = new AD_PUB_1400_MCURLISTRecord();
...
<%
	AD_PUB_1400_MDataSet ds = (AD_PUB_1400_MDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_PUB_1400_MCURLISTRecord curlistRec = (AD_PUB_1400_MCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
