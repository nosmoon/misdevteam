...
public class AD_PUB_1625_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public AD_PUB_1625_SDataSet(){}
	public AD_PUB_1625_SDataSet(String errcode, String errmsg, String medi_cd, String preng_occr_dt, String preng_occr_seq, String hndl_clsf, String dlco_no, String dlco_nm, String advt_cont, String pubc_side, String issu_ser_no, String publ_std, String advt_fee, String vat, String pubc_tot_amt, String agn, String agn_nm, String fee_rate, String fee, String hndl_plac_cd, String hndl_plac_nm, String coms_rate, String coms, String indt_clsf, String indt_clsf_nm, String mony_kind, String type_clsf, String type_clsf_nm, String exrate, String chro_clsf, String frex_cntr_amt, String nwsp_type_clsf, String book_appndx_clsf, String slcrg_pers, String slcrg_pers_nm, String dept_cd, String dept_nm, String mchrg_pers, String mchrg_pers_nm, String rtax_yn, String govern_advt_yn, String advcs_offr_yn, String remk, String preng_dt, String tax_email, String tax_clsf, String advt_clsf, String patr_chrg_info){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.hndl_clsf = Util.checkString(cstmt.getString(7));
		...
		this.pubc_side = Util.checkString(cstmt.getString(11));
		this.issu_ser_no = Util.checkString(cstmt.getString(12));
		this.publ_std = Util.checkString(cstmt.getString(13));
		this.advt_fee = Util.checkString(cstmt.getString(14));
		this.vat = Util.checkString(cstmt.getString(15));
		this.pubc_tot_amt = Util.checkString(cstmt.getString(16));
		this.agn = Util.checkString(cstmt.getString(17));
		this.agn_nm = Util.checkString(cstmt.getString(18));
		this.fee_rate = Util.checkString(cstmt.getString(19));
		this.fee = Util.checkString(cstmt.getString(20));
		this.hndl_plac_cd = Util.checkString(cstmt.getString(21));
		this.hndl_plac_nm = Util.checkString(cstmt.getString(22));
		this.coms_rate = Util.checkString(cstmt.getString(23));
		this.coms = Util.checkString(cstmt.getString(24));
		this.indt_clsf = Util.checkString(cstmt.getString(25));
		this.indt_clsf_nm = Util.checkString(cstmt.getString(26));
		this.mony_kind = Util.checkString(cstmt.getString(27));
		this.type_clsf = Util.checkString(cstmt.getString(28));
		this.type_clsf_nm = Util.checkString(cstmt.getString(29));
		this.exrate = Util.checkString(cstmt.getString(30));
		this.chro_clsf = Util.checkString(cstmt.getString(31));
		this.frex_cntr_amt = Util.checkString(cstmt.getString(32));
		this.nwsp_type_clsf = Util.checkString(cstmt.getString(33));
		this.book_appndx_clsf = Util.checkString(cstmt.getString(34));
		this.slcrg_pers = Util.checkString(cstmt.getString(35));
		this.slcrg_pers_nm = Util.checkString(cstmt.getString(36));
		this.dept_cd = Util.checkString(cstmt.getString(37));
		this.dept_nm = Util.checkString(cstmt.getString(38));
		this.mchrg_pers = Util.checkString(cstmt.getString(39));
		this.mchrg_pers_nm = Util.checkString(cstmt.getString(40));
		this.rtax_yn = Util.checkString(cstmt.getString(41));
		this.govern_advt_yn = Util.checkString(cstmt.getString(42));
		this.advcs_offr_yn = Util.checkString(cstmt.getString(43));
		this.remk = Util.checkString(cstmt.getString(44));
		this.preng_dt = Util.checkString(cstmt.getString(45));
		this.tax_email = Util.checkString(cstmt.getString(46));
		this.tax_clsf = Util.checkString(cstmt.getString(47));
		this.advt_clsf = Util.checkString(cstmt.getString(48));
		this.patr_chrg_info = Util.checkString(cstmt.getString(49));
	}
}/*----------------------------------------------------------------------------------------------------
Web Tier에서 DataSet 객체 관련 코드 작성시 사용하십시오.

<%
	AD_PUB_1625_SDataSet ds = (AD_PUB_1625_SDataSet)request.getAttribute("ds");
%>
...
/* 작성시간 : Tue Apr 01 14:14:24 KST 2014 */