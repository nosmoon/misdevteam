...
public class AD_PUB_2310_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public AD_PUB_2310_LDataSet(){}
	public AD_PUB_2310_LDataSet(String errcode, String errmsg, String tot_pubc_amt, String tot_vat_amt, String tot_misu_amt, String tot_fee_amt, String tot_pubc){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.tot_pubc_amt = Util.checkString(cstmt.getString(16));
		this.tot_vat_amt = Util.checkString(cstmt.getString(17));
		this.tot_misu_amt = Util.checkString(cstmt.getString(18));
		this.tot_fee_amt = Util.checkString(cstmt.getString(19));
		this.tot_pubc = Util.checkString(cstmt.getString(20));
		ResultSet rset0 = (ResultSet) cstmt.getObject(21);
		while(rset0.next()){
			AD_PUB_2310_LCURLISTRecord rec = new AD_PUB_2310_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_PUB_2310_LCURLISTRecord curlistRec = (AD_PUB_2310_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
