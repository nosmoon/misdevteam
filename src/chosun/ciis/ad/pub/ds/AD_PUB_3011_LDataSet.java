...
public class AD_PUB_3011_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_PUB_3011_LDataSet(){}
	public AD_PUB_3011_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_PUB_3011_LCURLISTRecord rec = new AD_PUB_3011_LCURLISTRecord();
...
<%
	AD_PUB_3011_LDataSet ds = (AD_PUB_3011_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_PUB_3011_LCURLISTRecord curlistRec = (AD_PUB_3011_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
