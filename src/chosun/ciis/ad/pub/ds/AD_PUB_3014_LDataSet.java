...
public class AD_PUB_3014_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_PUB_3014_LDataSet(){}
	public AD_PUB_3014_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_PUB_3014_LCURLISTRecord rec = new AD_PUB_3014_LCURLISTRecord();
...
<%
	AD_PUB_3014_LDataSet ds = (AD_PUB_3014_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_PUB_3014_LCURLISTRecord curlistRec = (AD_PUB_3014_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Thu Nov 22 17:50:03 KST 2012 */