...
public class AD_PUB_3018_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_PUB_3018_LDataSet(){}
	public AD_PUB_3018_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_PUB_3018_LCURLISTRecord rec = new AD_PUB_3018_LCURLISTRecord();
			rec.cslcrg_pers = Util.checkString(rset0.getString("cslcrg_pers"));
			rec.cslcrg_pers_nm = Util.checkString(rset0.getString("cslcrg_pers_nm"));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_PUB_3018_LCURLISTRecord curlistRec = (AD_PUB_3018_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
<%= curlistRec.cslcrg_pers%>
<%= curlistRec.cslcrg_pers_nm%>
