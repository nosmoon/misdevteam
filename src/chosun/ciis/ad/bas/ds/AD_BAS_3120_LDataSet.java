...
import chosun.ciis.ad.bas.rec.AD_BAS_3120_LCURLIST1Record;
import chosun.ciis.ad.bas.rec.AD_BAS_3120_LCURLIST2Record;
...
public class AD_BAS_3120_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist2 = new ArrayList();
	public ArrayList curlist1 = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_BAS_3120_LDataSet(){}
	public AD_BAS_3120_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_BAS_3120_LCURLIST1Record rec = new AD_BAS_3120_LCURLIST1Record();
		...
		while(rset1.next()){
			AD_BAS_3120_LCURLIST2Record rec = new AD_BAS_3120_LCURLIST2Record();
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		AD_BAS_3120_LCURLIST1Record curlist1Rec = (AD_BAS_3120_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		AD_BAS_3120_LCURLIST2Record curlist2Rec = (AD_BAS_3120_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>
