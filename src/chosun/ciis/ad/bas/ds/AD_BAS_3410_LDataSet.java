...
import chosun.ciis.ad.bas.rec.AD_BAS_3410_LTRGTRecord;

/**
 * 기초자료관리-목표관리(출판) 조회(매체별)
 */


public class AD_BAS_3410_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList trgt = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_BAS_3410_LDataSet(){}
	public AD_BAS_3410_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_BAS_3410_LTRGTRecord rec = new AD_BAS_3410_LTRGTRecord();
...
<%
	for(int i=0; i<ds.trgt.size(); i++){
		AD_BAS_3410_LTRGTRecord trgtRec = (AD_BAS_3410_LTRGTRecord)ds.trgt.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Wed Mar 25 14:37:01 KST 2009 */