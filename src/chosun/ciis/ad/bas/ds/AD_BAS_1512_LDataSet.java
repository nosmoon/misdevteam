...
public class AD_BAS_1512_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public AD_BAS_1512_LDataSet(){}
	public AD_BAS_1512_LDataSet(String errcode, String errmsg, long totalcnt, String rept_clsf){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_BAS_1512_LCURLISTRecord rec = new AD_BAS_1512_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_BAS_1512_LCURLISTRecord curlistRec = (AD_BAS_1512_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
