...
import chosun.ciis.ad.bas.rec.AD_BAS_2810_LCURLISTRecord;
...
public class AD_BAS_2810_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_BAS_2810_LDataSet(){}
	public AD_BAS_2810_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_BAS_2810_LCURLISTRecord rec = new AD_BAS_2810_LCURLISTRecord();
...
<%
	AD_BAS_2810_LDataSet ds = (AD_BAS_2810_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_BAS_2810_LCURLISTRecord curlistRec = (AD_BAS_2810_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
