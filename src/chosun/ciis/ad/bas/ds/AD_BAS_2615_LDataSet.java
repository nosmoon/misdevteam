...
public class AD_BAS_2615_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList trgt = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_BAS_2615_LDataSet(){}
	public AD_BAS_2615_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_BAS_2615_LTRGTRecord rec = new AD_BAS_2615_LTRGTRecord();
...
<%
	AD_BAS_2615_LDataSet ds = (AD_BAS_2615_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.trgt.size(); i++){
		AD_BAS_2615_LTRGTRecord trgtRec = (AD_BAS_2615_LTRGTRecord)ds.trgt.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Tue Aug 25 12:16:46 KST 2009 */