...
import chosun.ciis.ad.bas.rec.AD_BAS_1540_SCURLIST1Record;
import chosun.ciis.ad.bas.rec.AD_BAS_1540_SCURLIST2Record;
...
public class AD_BAS_1540_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public AD_BAS_1540_SDataSet(){}
	public AD_BAS_1540_SDataSet(String errcode, String errmsg, String page_id){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_BAS_1540_SCURLIST1Record rec = new AD_BAS_1540_SCURLIST1Record();
		...
		while(rset1.next()){
			AD_BAS_1540_SCURLIST2Record rec = new AD_BAS_1540_SCURLIST2Record();
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		AD_BAS_1540_SCURLIST1Record curlist1Rec = (AD_BAS_1540_SCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		AD_BAS_1540_SCURLIST2Record curlist2Rec = (AD_BAS_1540_SCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>
