...
public class AD_BAS_1511_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public AD_BAS_1511_LDataSet(){}
	public AD_BAS_1511_LDataSet(String errcode, String errmsg, long totalcnt, String rept_clsf){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_BAS_1511_LCURLISTRecord rec = new AD_BAS_1511_LCURLISTRecord();
...
<%
	AD_BAS_1511_LDataSet ds = (AD_BAS_1511_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_BAS_1511_LCURLISTRecord curlistRec = (AD_BAS_1511_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
