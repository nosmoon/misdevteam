...
import chosun.ciis.ad.bas.rec.AD_BAS_2640_LTRGTRecord;
...
public class AD_BAS_2640_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList trgt = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_BAS_2640_LDataSet(){}
	public AD_BAS_2640_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_BAS_2640_LTRGTRecord rec = new AD_BAS_2640_LTRGTRecord();
...
<%
	for(int i=0; i<ds.trgt.size(); i++){
		AD_BAS_2640_LTRGTRecord trgtRec = (AD_BAS_2640_LTRGTRecord)ds.trgt.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Tue Jun 09 20:19:31 KST 2009 */