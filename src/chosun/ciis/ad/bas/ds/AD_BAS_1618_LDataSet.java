...
public class AD_BAS_1618_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_BAS_1618_LDataSet(){}
	public AD_BAS_1618_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_BAS_1618_LCURLISTRecord rec = new AD_BAS_1618_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_BAS_1618_LCURLISTRecord curlistRec = (AD_BAS_1618_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
