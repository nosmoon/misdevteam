...
public class AD_BAS_3310_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BAS_3310_LDM(){}
	public AD_BAS_3310_LDM(String cmpy_cd, String dlco_clsf, String dlco_no, String fr_dt, String to_dt){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BAS_3310_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BAS_3310_LDM dm = (AD_BAS_3310_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.bas.ds.AD_BAS_3310_LDataSet();
	}
