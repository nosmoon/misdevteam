...
public class AD_BAS_2630_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BAS_2630_LDM(){}
	public AD_BAS_2630_LDM(String cmpy_cd, String trgt_clsf, String trgt_yymm, String chrg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BAS_2630_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BAS_2630_LDM dm = (AD_BAS_2630_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.bas.ds.AD_BAS_2630_LDataSet();
	}
