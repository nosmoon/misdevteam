...
public class AD_BAS_1810_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BAS_1810_LDM(){}
	public AD_BAS_1810_LDM(String cmpy_cd, String medi_clsf, String frdt, String todt, String dlco_clsf, String dlco_no){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BAS_1810_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BAS_1810_LDM dm = (AD_BAS_1810_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.bas.ds.AD_BAS_1810_LDataSet();
	}
...
/* 작성시간 : Thu May 21 10:07:40 KST 2009 */