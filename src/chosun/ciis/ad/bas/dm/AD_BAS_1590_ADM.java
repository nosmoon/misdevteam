...
public class AD_BAS_1590_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BAS_1590_ADM(){}
	public AD_BAS_1590_ADM(String cmpy_cd, String rept_clsf, String make_dt, String rept_no, String add_file_no){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BAS_1590_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BAS_1590_ADM dm = (AD_BAS_1590_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.bas.ds.AD_BAS_1590_ADataSet();
	}
