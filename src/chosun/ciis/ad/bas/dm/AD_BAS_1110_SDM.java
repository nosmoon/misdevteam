...
public class AD_BAS_1110_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BAS_1110_SDM(){}
	public AD_BAS_1110_SDM(String cmpy_cd, String medi_clsf, String dlco_no, String dlco_nm){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BAS_1110_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BAS_1110_SDM dm = (AD_BAS_1110_SDM)bdm;
		...
		cstmt.registerOutParameter(52, OracleTypes.CURSOR);
		cstmt.registerOutParameter(53, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.bas.ds.AD_BAS_1110_SDataSet();
	}
