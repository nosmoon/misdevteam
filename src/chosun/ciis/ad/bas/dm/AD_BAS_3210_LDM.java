...
public class AD_BAS_3210_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String oth_clsf;
	public String pubc_dt;

	public AD_BAS_3210_LDM(){}
	public AD_BAS_3210_LDM(String cmpy_cd, String oth_clsf, String pubc_dt){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BAS_3210_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BAS_3210_LDM dm = (AD_BAS_3210_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.bas.ds.AD_BAS_3210_LDataSet();
	}
