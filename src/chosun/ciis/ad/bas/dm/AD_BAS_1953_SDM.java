...
public class AD_BAS_1953_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BAS_1953_SDM(){}
	public AD_BAS_1953_SDM(String cmpy_cd, String medi_clsf, String dlco_clsf, String dlco_no, String basi_dt){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BAS_1953_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BAS_1953_SDM dm = (AD_BAS_1953_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.bas.ds.AD_BAS_1953_SDataSet();
	}
