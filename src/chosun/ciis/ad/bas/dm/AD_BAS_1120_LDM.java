...
public class AD_BAS_1120_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BAS_1120_LDM(){}
	public AD_BAS_1120_LDM(String cmpy_cd, String medi_clsf, String dlco_no, String frdt, String todt){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BAS_1120_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BAS_1120_LDM dm = (AD_BAS_1120_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.bas.ds.AD_BAS_1120_LDataSet();
	}
