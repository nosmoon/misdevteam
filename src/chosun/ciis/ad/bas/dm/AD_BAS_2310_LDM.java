...
public class AD_BAS_2310_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BAS_2310_LDM(){}
	public AD_BAS_2310_LDM(String cmpy_cd, String oth_clsf, String frdt, String todt, String advt_cont, String pubc_clsf){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BAS_2310_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BAS_2310_LDM dm = (AD_BAS_2310_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.bas.ds.AD_BAS_2310_LDataSet();
	}
