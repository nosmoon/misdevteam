...
public class AD_BAS_2615_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String trgt_clsf;
	public String trgt_yymm;

	public AD_BAS_2615_LDM(){}
	public AD_BAS_2615_LDM(String cmpy_cd, String trgt_clsf, String trgt_yymm){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BAS_2615_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BAS_2615_LDM dm = (AD_BAS_2615_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.bas.ds.AD_BAS_2615_LDataSet();
	}
