...
public class AD_BAS_2750_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String medi_clsf;
	public String acct_nm;

	public AD_BAS_2750_LDM(){}
	public AD_BAS_2750_LDM(String cmpy_cd, String medi_clsf, String acct_nm){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BAS_2750_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BAS_2750_LDM dm = (AD_BAS_2750_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.bas.ds.AD_BAS_2750_LDataSet();
	}
