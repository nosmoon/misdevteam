...
public class AD_BAS_1920_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BAS_1920_SDM(){}
	public AD_BAS_1920_SDM(String cmpy_cd, String medi_clsf, String make_dt, String dlco_no){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BAS_1920_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BAS_1920_SDM dm = (AD_BAS_1920_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.bas.ds.AD_BAS_1920_SDataSet();
	}
...
/* 작성시간 : Wed Jul 22 13:57:36 KST 2009 */