...
public class AD_BAS_2830_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BAS_2830_LDM(){}
	public AD_BAS_2830_LDM(String cmpy_cd, String dealmedicd, String frdt, String todt, String team_cd){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BAS_2830_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BAS_2830_LDM dm = (AD_BAS_2830_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.bas.ds.AD_BAS_2830_LDataSet();
	}
