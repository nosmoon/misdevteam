...
public class AD_BAS_1510_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BAS_1510_LDM(){}
	public AD_BAS_1510_LDM(String cmpy_cd, String rept_clsf, String medi_clsf, String search_dt_fr, String search_dt_to, String advcs_clsf, String patr_chrg_pers, String chrg_pers, String search_wd, String dlco_no, String sch_clsf, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BAS_1510_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BAS_1510_LDM dm = (AD_BAS_1510_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.bas.ds.AD_BAS_1510_LDataSet();
	}
...
/* 작성시간 : Mon Oct 31 15:53:08 KST 2016 */