...
public class AD_BAS_1540_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BAS_1540_SDM(){}
	public AD_BAS_1540_SDM(String cmpy_cd, String rept_clsf, String make_dt, String rept_no, String incmg_pers, String page_id){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BAS_1540_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BAS_1540_SDM dm = (AD_BAS_1540_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.bas.ds.AD_BAS_1540_SDataSet();
	}
