...
public class AD_BAS_3711_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_BAS_3711_LDM(){}
	public AD_BAS_3711_LDM(String cmpy_cd, String oth_clsf, String frdt, String todt, String pubc_asse_cd, String chk_asse, String advt_cont, String sect_nm_cd, String sect_nm_detail, String remk){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_BAS_3711_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_BAS_3711_LDM dm = (AD_BAS_3711_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.bas.ds.AD_BAS_3711_LDataSet();
	}
