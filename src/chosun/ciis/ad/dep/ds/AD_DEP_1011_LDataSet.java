...
public class AD_DEP_1011_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;
	public String dlco_no;

	public AD_DEP_1011_LDataSet(){}
	public AD_DEP_1011_LDataSet(String errcode, String errmsg, String dlco_no){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_DEP_1011_LCURLISTRecord rec = new AD_DEP_1011_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_DEP_1011_LCURLISTRecord curlistRec = (AD_DEP_1011_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Mon Sep 21 19:26:27 KST 2009 */