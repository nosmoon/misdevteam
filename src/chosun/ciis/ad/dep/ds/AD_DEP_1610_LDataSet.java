...
import chosun.ciis.ad.dep.rec.AD_DEP_1610_LCURLIST2Record;
import chosun.ciis.ad.dep.rec.AD_DEP_1610_LCURLISTRecord;
...
public class AD_DEP_1610_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist2 = new ArrayList();
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public AD_DEP_1610_LDataSet(){}
	public AD_DEP_1610_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_DEP_1610_LCURLISTRecord rec = new AD_DEP_1610_LCURLISTRecord();
		...
		while(rset1.next()){
			AD_DEP_1610_LCURLIST2Record rec = new AD_DEP_1610_LCURLIST2Record();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		AD_DEP_1610_LCURLISTRecord curlistRec = (AD_DEP_1610_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		AD_DEP_1610_LCURLIST2Record curlist2Rec = (AD_DEP_1610_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>
