...
public class AD_DEP_1000_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public AD_DEP_1000_MDataSet(){}
	public AD_DEP_1000_MDataSet(String errcode, String errmsg, String xx_note_clsf_cd_001, String xx_note_clsf_cd_002, String xx_note_clsf_cd_003, String xx_note_clsf_cd_004, String xx_note_clsf_cd_005, String xx_job_clsf_02, String xx_cd_clsf_006, String xx_medi_cd_001, String xx_medi_cd_002, String xx_cd_clsf_007){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_DEP_1000_MCURLIST1Record rec = new AD_DEP_1000_MCURLIST1Record();
		...
		while(rset1.next()){
			AD_DEP_1000_MCURLIST2Record rec = new AD_DEP_1000_MCURLIST2Record();
		...
		while(rset2.next()){
			AD_DEP_1000_MCURLIST3Record rec = new AD_DEP_1000_MCURLIST3Record();
		...
		while(rset3.next()){
			AD_DEP_1000_MCURLIST4Record rec = new AD_DEP_1000_MCURLIST4Record();
		...
		while(rset4.next()){
			AD_DEP_1000_MCURLIST5Record rec = new AD_DEP_1000_MCURLIST5Record();
		...
		while(rset5.next()){
			AD_DEP_1000_MCURLIST6Record rec = new AD_DEP_1000_MCURLIST6Record();
		...
		while(rset6.next()){
			AD_DEP_1000_MCURLIST7Record rec = new AD_DEP_1000_MCURLIST7Record();
		...
		while(rset7.next()){
			AD_DEP_1000_MCURLIST8Record rec = new AD_DEP_1000_MCURLIST8Record();
...
<%
	AD_DEP_1000_MDataSet ds = (AD_DEP_1000_MDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		AD_DEP_1000_MCURLIST1Record curlist1Rec = (AD_DEP_1000_MCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		AD_DEP_1000_MCURLIST2Record curlist2Rec = (AD_DEP_1000_MCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		AD_DEP_1000_MCURLIST3Record curlist3Rec = (AD_DEP_1000_MCURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist4.size(); i++){
		AD_DEP_1000_MCURLIST4Record curlist4Rec = (AD_DEP_1000_MCURLIST4Record)ds.curlist4.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist5.size(); i++){
		AD_DEP_1000_MCURLIST5Record curlist5Rec = (AD_DEP_1000_MCURLIST5Record)ds.curlist5.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist6.size(); i++){
		AD_DEP_1000_MCURLIST6Record curlist6Rec = (AD_DEP_1000_MCURLIST6Record)ds.curlist6.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist7.size(); i++){
		AD_DEP_1000_MCURLIST7Record curlist7Rec = (AD_DEP_1000_MCURLIST7Record)ds.curlist7.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist8.size(); i++){
		AD_DEP_1000_MCURLIST8Record curlist8Rec = (AD_DEP_1000_MCURLIST8Record)ds.curlist8.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Thu Feb 02 11:57:17 KST 2012 */