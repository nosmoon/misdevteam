...
public class AD_DEP_1525_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public AD_DEP_1525_SDataSet(){}
	public AD_DEP_1525_SDataSet(String errcode, String errmsg, String medi_cd, String hndl_clsf, String dlco_no, String dlco_nm, String precpt_amt_bal, String mtry_dt, String occr_amt, String proc_clsf){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		this.precpt_amt_bal = Util.checkString(cstmt.getString(12));
		this.mtry_dt = Util.checkString(cstmt.getString(13));
		this.occr_amt = Util.checkString(cstmt.getString(14));
		this.proc_clsf = Util.checkString(cstmt.getString(15));
	}
}/*----------------------------------------------------------------------------------------------------
Web Tier에서 DataSet 객체 관련 코드 작성시 사용하십시오.

<%
	AD_DEP_1525_SDataSet ds = (AD_DEP_1525_SDataSet)request.getAttribute("ds");
%>
...
/* 작성시간 : Wed Mar 25 15:38:05 KST 2009 */