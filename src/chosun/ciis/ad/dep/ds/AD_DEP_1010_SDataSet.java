...
public class AD_DEP_1010_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public AD_DEP_1010_SDataSet(){}
	public AD_DEP_1010_SDataSet(String errcode, String errmsg, String occr_dt, String slip_clsf, String seq, String rcpm_shet_no, String self_cmpy_yn, String rcpm_plac_clsf, String dlco_no, String dlco_nm, String medi_cd, String dept_cd, String dept_nm, String mchrg_pers, String mchrg_pers_nm, String clos_yn, String seq_clsf, String pre_seq, String next_seq, String chnl_clsf){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			AD_DEP_1010_SCURLIST1Record rec = new AD_DEP_1010_SCURLIST1Record();
		...
		while(rset1.next()){
			AD_DEP_1010_SCURLIST2Record rec = new AD_DEP_1010_SCURLIST2Record();
			...
			rec.card_yn = Util.checkString(rset1.getString("card_yn"));
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		AD_DEP_1010_SCURLIST1Record curlist1Rec = (AD_DEP_1010_SCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		AD_DEP_1010_SCURLIST2Record curlist2Rec = (AD_DEP_1010_SCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>
