...
public class AD_DEP_1510_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_DEP_1510_LDM(){}
	public AD_DEP_1510_LDM(String cmpy_cd, String drbk_clsf, String medi_cd, String proc_frdt, String proc_todt, String hndl_clsf, String dlco_no){
	...
	public String getSQL(){
		 return "{ call SP_AD_DEP_1510_L( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_1510_LDM dm = (AD_DEP_1510_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_1510_LDataSet();
	}
