...
public class AD_DEP_3420_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_DEP_3420_LDM(){}
	public AD_DEP_3420_LDM(String cmpy_cd, String medi_cd, String vat, String pubc_ym){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_DEP_3420_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_3420_LDM dm = (AD_DEP_3420_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_3420_LDataSet();
	}
