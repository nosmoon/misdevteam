...
public class AD_DEP_1030_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_DEP_1030_ADM(){}
	public AD_DEP_1030_ADM(String medi_clsf, String cmpy_cd, String occr_dt, String slip_clsf, String seq, String rcpm_shet_no, String self_cmpy_yn, String rcpm_acct, String rcpm_plac_clsf, String dlco_no, String medi_cd, String sale_aprv_no, String dept_cd, String mchrg_pers, String advt_tot_amt, String rcpm_tot_amt, String cash_amt, String fee_amt, String note_no1, String bank_cd1, String note_clsf_cd1, String comp_dt1, String mtry_dt1, String note_amt1, String sale_dscn_amt1, String issu_cmpy_clsf_cd1, String issu_pers_nm1, String mode2, String acct_mang_no2, String rmtt_dt2, String amt2, String rmtt_coms2, String rmtt_plac2, String biz_reg_no2, String bank_id2, String acct_num2, String tran_date_seq2, String current_clsf2, String curc_clsf2, String frex_amt2, String card_yn, String mode3, String checked3, String medi_cd3, String amt3, String rcpm_slip_no3, String occr_dt3, String slip_clsf3, String seq3, String subseq3, String mode4, String checked4, String swit_dlco4, String amt4, String rcpm_slip_no4, String budg_cd4, String occr_dt4, String slip_clsf4, String seq4, String subseq4, String mode5, String checked5, String budg_cd5, String amt5, String rcpm_slip_no5, String occr_dt5, String slip_clsf5, String seq5, String subseq5, String medi_cd6, String amt6, String depo_job_clsf7, String amt7, String swit_dlco7, String amt8, String budg_cd8, String incmg_pers_ip, String incmg_pers, String elec_note_key, String chnl_clsf){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_DEP_1030_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_1030_ADM dm = (AD_DEP_1030_ADM)bdm;
		...
		cstmt.setString(17, dm.advt_tot_amt);
		cstmt.setString(18, dm.rcpm_tot_amt);
		cstmt.setString(19, dm.cash_amt);
		cstmt.setString(20, dm.fee_amt);
		cstmt.setString(21, dm.note_no1);
		cstmt.setString(22, dm.bank_cd1);
		cstmt.setString(23, dm.note_clsf_cd1);
		cstmt.setString(24, dm.comp_dt1);
		cstmt.setString(25, dm.mtry_dt1);
		cstmt.setString(26, dm.note_amt1);
		cstmt.setString(27, dm.sale_dscn_amt1);
		cstmt.setString(28, dm.issu_cmpy_clsf_cd1);
		cstmt.setString(29, dm.issu_pers_nm1);
		cstmt.setString(30, dm.mode2);
		cstmt.setString(31, dm.acct_mang_no2);
		cstmt.setString(32, dm.rmtt_dt2);
		cstmt.setString(33, dm.amt2);
		cstmt.setString(34, dm.rmtt_coms2);
		cstmt.setString(35, dm.rmtt_plac2);
		cstmt.setString(36, dm.biz_reg_no2);
		cstmt.setString(37, dm.bank_id2);
		cstmt.setString(38, dm.acct_num2);
		cstmt.setString(39, dm.tran_date_seq2);
		cstmt.setString(40, dm.current_clsf2);
		cstmt.setString(41, dm.curc_clsf2);
		cstmt.setString(42, dm.frex_amt2);
		cstmt.setString(43, dm.card_yn);
		cstmt.setString(44, dm.mode3);
		cstmt.setString(45, dm.checked3);
		cstmt.setString(46, dm.medi_cd3);
		cstmt.setString(47, dm.amt3);
		cstmt.setString(48, dm.rcpm_slip_no3);
		cstmt.setString(49, dm.occr_dt3);
		cstmt.setString(50, dm.slip_clsf3);
		cstmt.setString(51, dm.seq3);
		cstmt.setString(52, dm.subseq3);
		cstmt.setString(53, dm.mode4);
		cstmt.setString(54, dm.checked4);
		cstmt.setString(55, dm.swit_dlco4);
		cstmt.setString(56, dm.amt4);
		cstmt.setString(57, dm.rcpm_slip_no4);
		cstmt.setString(58, dm.budg_cd4);
		cstmt.setString(59, dm.occr_dt4);
		cstmt.setString(60, dm.slip_clsf4);
		cstmt.setString(61, dm.seq4);
		cstmt.setString(62, dm.subseq4);
		cstmt.setString(63, dm.mode5);
		cstmt.setString(64, dm.checked5);
		cstmt.setString(65, dm.budg_cd5);
		cstmt.setString(66, dm.amt5);
		cstmt.setString(67, dm.rcpm_slip_no5);
		cstmt.setString(68, dm.occr_dt5);
		cstmt.setString(69, dm.slip_clsf5);
		cstmt.setString(70, dm.seq5);
		cstmt.setString(71, dm.subseq5);
		cstmt.setString(72, dm.medi_cd6);
		cstmt.setString(73, dm.amt6);
		cstmt.setString(74, dm.depo_job_clsf7);
		cstmt.setString(75, dm.amt7);
		cstmt.setString(76, dm.swit_dlco7);
		cstmt.setString(77, dm.amt8);
		cstmt.setString(78, dm.budg_cd8);
		cstmt.setString(79, dm.incmg_pers_ip);
		cstmt.setString(80, dm.incmg_pers);
		cstmt.setString(81, dm.elec_note_key);
		cstmt.setString(82, dm.chnl_clsf);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_1030_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("cash_amt = [" + getCash_amt() + "]");
		...
		System.out.println("card_yn = [" + getCard_yn() + "]");
...
String cash_amt = req.getParameter("cash_amt");
if( cash_amt == null){
	System.out.println(this.toString+" : cash_amt is null" );
}else{
	System.out.println(this.toString+" : cash_amt is "+cash_amt );
}
...
String card_yn = req.getParameter("card_yn");
if( card_yn == null){
	System.out.println(this.toString+" : card_yn is null" );
}else{
	System.out.println(this.toString+" : card_yn is "+card_yn );
}
...
String card_yn = Util.checkString(req.getParameter("card_yn"));
...
String cash_amt = Util.Uni2Ksc(Util.checkString(req.getParameter("cash_amt")));
...
String card_yn = Util.Uni2Ksc(Util.checkString(req.getParameter("card_yn")));
...
/* 작성시간 : Thu Feb 05 15:15:20 KST 2015 */