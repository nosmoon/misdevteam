...
public class AD_DEP_2620_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_DEP_2620_LDM(){}
	public AD_DEP_2620_LDM(String cmpy_cd, String frdt, String todt, String medi_cd, String hndl_clsf, String dlco_no){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_DEP_2620_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_2620_LDM dm = (AD_DEP_2620_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_2620_LDataSet();
	}
