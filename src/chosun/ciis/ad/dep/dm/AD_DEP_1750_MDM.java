...
public class AD_DEP_1750_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String medi_clsf;
	public String emp_no;

	public AD_DEP_1750_MDM(){}
	public AD_DEP_1750_MDM(String cmpy_cd, String medi_clsf, String emp_no){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_DEP_1750_M(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_1750_MDM dm = (AD_DEP_1750_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_1750_MDataSet();
	}
