...
public class AD_DEP_2430_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_DEP_2430_LDM(){}
	public AD_DEP_2430_LDM(String cmpy_cd, String bank_cd, String note_no, String note_seq){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_DEP_2430_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_2430_LDM dm = (AD_DEP_2430_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_2430_LDataSet();
	}
