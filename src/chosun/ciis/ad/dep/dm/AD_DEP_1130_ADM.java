...
public class AD_DEP_1130_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String ym_clsf;
	public String work_clsf;
	public String clos_dt;
	public String incmg_pers_ip;
	public String incmg_pers;

	public AD_DEP_1130_ADM(){}
	public AD_DEP_1130_ADM(String cmpy_cd, String ym_clsf, String work_clsf, String clos_dt, String incmg_pers_ip, String incmg_pers){
		this.cmpy_cd = cmpy_cd;
		this.ym_clsf = ym_clsf;
	...
	public void setYm_clsf(String ym_clsf){
		this.ym_clsf = ym_clsf;
	}
	...
	public String getSQL(){
		 return "{ call SP_AD_DEP_1130_A( ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_1130_ADM dm = (AD_DEP_1130_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.ym_clsf);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_1130_ADataSet();
	}
    ...
    public void print(){
        ...
        System.out.println("ym_clsf = " + getYm_clsf());
...
String ym_clsf = req.getParameter("ym_clsf");
if( ym_clsf == null){
	System.out.println(this.toString+" : ym_clsf is null" );
}else{
	System.out.println(this.toString+" : ym_clsf is "+ym_clsf );
}
...
String ym_clsf = Util.checkString(req.getParameter("ym_clsf"));
...
String ym_clsf = Util.Uni2Ksc(Util.checkString(req.getParameter("ym_clsf")));
...
/* 작성시간 : Tue Mar 10 20:31:50 KST 2009 */