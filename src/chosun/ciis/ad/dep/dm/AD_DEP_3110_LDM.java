...
public class AD_DEP_3110_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_DEP_3110_LDM(){}
	public AD_DEP_3110_LDM(String cmpy_cd, String frdt, String medi_cd, String vat){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_DEP_3110_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_3110_LDM dm = (AD_DEP_3110_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_3110_LDataSet();
	}
