...
public class AD_DEP_1100_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String clos_yymm;
	public String work_clsf;

	public AD_DEP_1100_MDM(){}
	public AD_DEP_1100_MDM(String cmpy_cd, String clos_yymm, String work_clsf){
	...
	public String getSQL(){
		 return "{ call SP_AD_DEP_1100_M( ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_1100_MDM dm = (AD_DEP_1100_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_1100_MDataSet();
	}
