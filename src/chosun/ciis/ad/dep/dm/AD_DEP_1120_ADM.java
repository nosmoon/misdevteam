...
public class AD_DEP_1120_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_DEP_1120_ADM(){}
	public AD_DEP_1120_ADM(String cmpy_cd, String work_clsf, String clos_dt, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call SP_AD_DEP_1120_A( ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_1120_ADM dm = (AD_DEP_1120_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_1120_ADataSet();
	}
