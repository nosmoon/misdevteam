...
public class AD_DEP_1840_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_DEP_1840_LDM(){}
	public AD_DEP_1840_LDM(String cmpy_cd, String dlco_no, String pubc_yymm, String rcpm_frdt, String rcpm_todt){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_DEP_1840_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_1840_LDM dm = (AD_DEP_1840_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_1840_LDataSet();
	}
