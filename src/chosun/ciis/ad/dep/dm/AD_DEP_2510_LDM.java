...
public class AD_DEP_2510_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_DEP_2510_LDM(){}
	public AD_DEP_2510_LDM(String cmpy_cd, String proc_yymm, String slip_clsf_cd, String basi_dt){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_DEP_2510_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_2510_LDM dm = (AD_DEP_2510_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_2510_LDataSet();
	}
