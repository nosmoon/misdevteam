...
public class AD_DEP_1610_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_DEP_1610_LDM(){}
	public AD_DEP_1610_LDM(String cmpy_cd, String medi_cd, String dlco_clsf, String dlco_no, String frdt, String todt, String slcrg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_DEP_1610_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_1610_LDM dm = (AD_DEP_1610_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_1610_LDataSet();
	}
