...
public class AD_DEP_3720_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_DEP_3720_ADM(){}
	public AD_DEP_3720_ADM(String flag, String cmpy_cd, String rept_no, String chk_item, String chk_dt, String chk_cont, String incmg_pers_ip, String incmg_pers){
		this.flag = flag;
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_DEP_3720_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_3720_ADM dm = (AD_DEP_3720_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_3720_ADataSet();
	}
