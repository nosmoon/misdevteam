...
public class AD_DEP_1410_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_DEP_1410_ADM(){}
	public AD_DEP_1410_ADM(String cmpy_cd, String slip_clsf, String occr_dt, String frdt, String todt, String bddb_clsf, String incmg_dept_cd, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_DEP_1410_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_1410_ADM dm = (AD_DEP_1410_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_1410_ADataSet();
	}
