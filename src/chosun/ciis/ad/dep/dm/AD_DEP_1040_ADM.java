...
public class AD_DEP_1040_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_DEP_1040_ADM(){}
	public AD_DEP_1040_ADM(String medi_clsf, String cmpy_cd, String occr_dt, String slip_clsf, String seq, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_DEP_1040_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_1040_ADM dm = (AD_DEP_1040_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_1040_ADataSet();
	}
...
/* 작성시간 : Mon Jun 01 16:18:24 KST 2009 */