...
public class AD_DEP_2330_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String dealmedicd;
	public String rcpm_dt;

	public AD_DEP_2330_LDM(){}
	public AD_DEP_2330_LDM(String cmpy_cd, String dealmedicd, String rcpm_dt){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_DEP_2330_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_2330_LDM dm = (AD_DEP_2330_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_2330_LDataSet();
	}
