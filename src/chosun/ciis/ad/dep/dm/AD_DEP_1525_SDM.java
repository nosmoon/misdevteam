...
public class AD_DEP_1525_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_DEP_1525_SDM(){}
	public AD_DEP_1525_SDM(String cmpy_cd, String drbk_clsf, String slip_occr_dt, String slip_clsf_cd, String slip_seq){
	...
	public String getSQL(){
		 return "{ call SP_AD_DEP_1525_S( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_1525_SDM dm = (AD_DEP_1525_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_1525_SDataSet();
	}
