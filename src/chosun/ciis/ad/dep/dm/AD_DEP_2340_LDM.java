...
public class AD_DEP_2340_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_DEP_2340_LDM(){}
	public AD_DEP_2340_LDM(String cmpy_cd, String dealmedicd, String frdt, String todt, String frdt2, String todt2){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_DEP_2340_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_2340_LDM dm = (AD_DEP_2340_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_2340_LDataSet();
	}
