...
public class AD_DEP_1900_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String dealmedicd;

	public AD_DEP_1900_MDM(){}
	public AD_DEP_1900_MDM(String cmpy_cd, String dealmedicd){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_DEP_1900_M(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_DEP_1900_MDM dm = (AD_DEP_1900_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.dep.ds.AD_DEP_1900_MDataSet();
	}
