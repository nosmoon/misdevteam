...
public class AD_EVLU_1000_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String pubc_yyyymmdd;

	public AD_EVLU_1000_LDM(){}
	public AD_EVLU_1000_LDM(String cmpy_cd, String pubc_yyyymmdd){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_EVLU_1000_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_EVLU_1000_LDM dm = (AD_EVLU_1000_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new AD_EVLU_1000_LDataSet();
	}
