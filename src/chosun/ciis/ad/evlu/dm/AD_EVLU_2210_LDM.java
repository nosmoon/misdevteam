...
public class AD_EVLU_2210_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_EVLU_2210_LDM(){}
	public AD_EVLU_2210_LDM(String cmpy_cd, String emp_no, String pubc_yyyymmdd, String scorecode){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_EVLU_2210_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_EVLU_2210_LDM dm = (AD_EVLU_2210_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new AD_EVLU_2210_LDataSet();
	}
