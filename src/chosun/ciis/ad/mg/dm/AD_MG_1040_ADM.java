...
public class AD_MG_1040_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_MG_1040_ADM(){}
	public AD_MG_1040_ADM(String cmpy_cd, String dlco_no, String exec_no, String basi_dt, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_MG_1040_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_MG_1040_ADM dm = (AD_MG_1040_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.dlco_no);
		cstmt.setString(5, dm.exec_no);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.mg.ds.AD_MG_1040_ADataSet();
	}
...
/* 작성시간 : Wed May 13 16:36:06 KST 2009 */