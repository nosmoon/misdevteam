...
public class AD_MG_1050_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_MG_1050_ADM(){}
	public AD_MG_1050_ADM(String cmpy_cd, String dlco_no, String exec_no, String basi_dt, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_MG_1050_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_MG_1050_ADM dm = (AD_MG_1050_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.mg.ds.AD_MG_1050_ADataSet();
	}
...
/* 작성시간 : Wed May 13 16:50:33 KST 2009 */