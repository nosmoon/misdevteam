...
public class AD_MG_1030_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public AD_MG_1030_ADM(){}
	public AD_MG_1030_ADM(String cmpy_cd, String work_clsf, String clos_dt, String basi_dt, String exec_no, String incmg_pers_ip, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_MG_1030_A(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_MG_1030_ADM dm = (AD_MG_1030_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.mg.ds.AD_MG_1030_ADataSet();
	}
