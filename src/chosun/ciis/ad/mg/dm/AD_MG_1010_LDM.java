...
public class AD_MG_1010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String work_clsf;
	public String clos_dt;

	public AD_MG_1010_LDM(){}
	public AD_MG_1010_LDM(String cmpy_cd, String work_clsf, String clos_dt){
	...
	public String getSQL(){
		 return "{ call MISADV.SP_AD_MG_1010_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		AD_MG_1010_LDM dm = (AD_MG_1010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.ad.mg.ds.AD_MG_1010_LDataSet();
	}
