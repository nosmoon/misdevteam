...
public class FC_FUNC_6505_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_6505_DDM(){}
	public FC_FUNC_6505_DDM(String cmpy_cd, String deps_isav_clsf_cd, String deps_isav_no, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_6505_D(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_6505_DDM dm = (FC_FUNC_6505_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_6505_DDataSet();
	}
