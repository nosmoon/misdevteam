...
public class FC_FUNC_6041_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_6041_LDM(){}
	public FC_FUNC_6041_LDM(String cmpy_cd, String mtry_dt_fr, String mtry_dt_to, String flag){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_6041_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_6041_LDM dm = (FC_FUNC_6041_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_6041_LDataSet();
	}
