...
public class FC_FUNC_6114_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_6114_DDM(){}
	public FC_FUNC_6114_DDM(String cmpy_cd, String pymt_dt, String incmg_pers, String incmg_pers_ipadd, String slip_occr_dt, String slip_clsf_cd, String slip_seq){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_6114_D(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_6114_DDM dm = (FC_FUNC_6114_DDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.pymt_dt);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_6114_DDataSet();
	}
...
/* 작성시간 : Mon Mar 16 12:05:08 KST 2009 */