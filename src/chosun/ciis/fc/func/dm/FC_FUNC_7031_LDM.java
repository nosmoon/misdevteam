...
public class FC_FUNC_7031_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String fund_mang_no;
	public String loan_no;

	public FC_FUNC_7031_LDM(){}
	public FC_FUNC_7031_LDM(String cmpy_cd, String fund_mang_no, String loan_no){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_7031_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_7031_LDM dm = (FC_FUNC_7031_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_7031_LDataSet();
	}
