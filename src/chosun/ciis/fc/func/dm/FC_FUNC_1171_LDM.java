...
public class FC_FUNC_1171_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String now_note_stat_dt;
	public String now_note_stat_cd;

	public FC_FUNC_1171_LDM(){}
	public FC_FUNC_1171_LDM(String cmpy_cd, String now_note_stat_dt, String now_note_stat_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_1171_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_1171_LDM dm = (FC_FUNC_1171_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_1171_LDataSet();
	}
