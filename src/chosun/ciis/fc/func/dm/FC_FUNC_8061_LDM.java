...
public class FC_FUNC_8061_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String asum_yymm;
	public String tms;

	public FC_FUNC_8061_LDM(){}
	public FC_FUNC_8061_LDM(String cmpy_cd, String asum_yymm, String tms){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_8061_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_8061_LDM dm = (FC_FUNC_8061_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_8061_LDataSet();
	}
