...
public class FC_FUNC_6003_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_6003_LDM(){}
	public FC_FUNC_6003_LDM(String cmpy_cd, String deps_isav_clsf_cd, String deps_isav_no, String occr_clsf_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_6003_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_6003_LDM dm = (FC_FUNC_6003_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_6003_LDataSet();
	}
