...
public class FC_FUNC_1012_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_1012_LDM(){}
	public FC_FUNC_1012_LDM(String bank_cd, String note_no, String note_seq, String cmpy_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_1012_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_1012_LDM dm = (FC_FUNC_1012_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_1012_LDataSet();
	}
