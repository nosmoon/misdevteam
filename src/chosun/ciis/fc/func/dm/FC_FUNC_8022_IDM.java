...
public class FC_FUNC_8022_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_8022_IDM(){}
	public FC_FUNC_8022_IDM(String cmpy_cd, String uid, String pers, String pers_ipadd, String cntr_clsf_cd, String leas_clsf_cd, String leas_no, String leas_sub_seq, String leas_nm, String cntr_no, String frcr_amt, String won_amt, String libo_int_rate, String dedu_int_rate, String comp_dt, String mtry_dt, String re_leas_yn, String frex_cd, String exrate, String rmks, String pymt_cycl, String pay_plan_tms, String libo_yn, String fst_leas_clsf_cd, String fst_leas_no, String end_aftr, String leas_stat_cd, String end_dt, String basi_int, String leas_int_rate, String prd_int_rate, String tms_leas_amt, String tot_leas_fee, String decid_amt, String prd_int){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_8022_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_8022_IDM dm = (FC_FUNC_8022_IDM)bdm;
		...
		cstmt.setString(26, dm.fst_leas_clsf_cd);
		cstmt.setString(27, dm.fst_leas_no);
		cstmt.setString(28, dm.end_aftr);
		cstmt.setString(29, dm.leas_stat_cd);
		cstmt.setString(30, dm.end_dt);
		cstmt.setString(31, dm.basi_int);
		cstmt.setString(32, dm.leas_int_rate);
		cstmt.setString(33, dm.prd_int_rate);
		cstmt.setString(34, dm.tms_leas_amt);
		cstmt.setString(35, dm.tot_leas_fee);
		cstmt.setString(36, dm.decid_amt);
		cstmt.setString(37, dm.prd_int);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_8022_IDataSet();
	}
...
/* 작성시간 : Fri Mar 27 17:37:09 KST 2009 */