...
public class FC_FUNC_6032_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String deps_isav_clsf_cd;
	public String deps_isav_no;

	public FC_FUNC_6032_LDM(){}
	public FC_FUNC_6032_LDM(String cmpy_cd, String deps_isav_clsf_cd, String deps_isav_no){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_6032_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_6032_LDM dm = (FC_FUNC_6032_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_6032_LDataSet();
	}
