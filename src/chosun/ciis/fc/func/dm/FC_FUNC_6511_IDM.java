...
public class FC_FUNC_6511_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_6511_IDM(){}
	public FC_FUNC_6511_IDM(String cmpy_cd, String deps_isav_clsf_cd, String deps_isav_no, String deps_isav_nm, String dlco_clsf_cd, String dlco_cd, String compnm, String comp_dt, String mtry_dt, String tot_pymt_amt, String int_rate, String incmg_pers, String incmg_pers_ipadd, String rmks, String use_dept_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_6511_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_6511_IDM dm = (FC_FUNC_6511_IDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_6511_IDataSet();
	}
