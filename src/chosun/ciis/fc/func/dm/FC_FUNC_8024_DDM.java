...
public class FC_FUNC_8024_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_8024_DDM(){}
	public FC_FUNC_8024_DDM(String cmpy_cd, String cntr_clsf_cd, String leas_clsf_cd, String leas_no, String leas_sub_seq){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_8024_D(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_8024_DDM dm = (FC_FUNC_8024_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_8024_DDataSet();
	}
