...
public class FC_FUNC_6084_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_6084_DDM(){}
	public FC_FUNC_6084_DDM(String cmpy_cd, String deps_isav_clsf_cd, String deps_isav_no, String int_rate_chg_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_6084_D(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_6084_DDM dm = (FC_FUNC_6084_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_6084_DDataSet();
	}
...
/* 작성시간 : Fri Mar 06 13:57:25 KST 2009 */