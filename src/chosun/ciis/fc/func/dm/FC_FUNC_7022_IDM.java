...
public class FC_FUNC_7022_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_7022_IDM(){}
	public FC_FUNC_7022_IDM(String cmpy_cd, String fund_mang_no, String loan_no, String repay_dt, String repay_amt, String repay_rmks, String incmg_pers, String incmg_pers_ipadd, String use_dept_cd, String repay_slip_occr_dt, String repay_slip_clsf_cd, String repay_slip_seq){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_7022_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_7022_IDM dm = (FC_FUNC_7022_IDM)bdm;
		...
		cstmt.setString(7, dm.repay_amt);
		cstmt.setString(8, dm.repay_rmks);
		cstmt.setString(9, dm.incmg_pers);
		cstmt.setString(10, dm.incmg_pers_ipadd);
		cstmt.setString(11, dm.use_dept_cd);
		cstmt.setString(12, dm.repay_slip_occr_dt);
		cstmt.setString(13, dm.repay_slip_clsf_cd);
		cstmt.setString(14, dm.repay_slip_seq);
		cstmt.registerOutParameter(15, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_7022_IDataSet();
	}
