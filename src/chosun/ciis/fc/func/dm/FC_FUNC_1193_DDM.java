...
public class FC_FUNC_1193_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_1193_DDM(){}
	public FC_FUNC_1193_DDM(String cmpy_cd, String rcpay_dt, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String pch_count, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_1193_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_1193_DDM dm = (FC_FUNC_1193_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_1193_DDataSet();
	}
