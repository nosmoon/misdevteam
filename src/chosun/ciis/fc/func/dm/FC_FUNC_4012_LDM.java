...
public class FC_FUNC_4012_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String pay_note_no;

	public FC_FUNC_4012_LDM(){}
	public FC_FUNC_4012_LDM(String cmpy_cd, String pay_note_no){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_4012_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_4012_LDM dm = (FC_FUNC_4012_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_4012_LDataSet();
	}
