...
public class FC_FUNC_1191_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String rcpay_dt;

	public FC_FUNC_1191_LDM(){}
	public FC_FUNC_1191_LDM(String cmpy_cd, String rcpay_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_1191_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_1191_LDM dm = (FC_FUNC_1191_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_1191_LDataSet();
	}
