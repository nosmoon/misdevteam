...
public class FC_FUNC_8004_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_8004_DDM(){}
	public FC_FUNC_8004_DDM(String cmpy_cd, String cntr_clsf_cd, String leas_clsf_cd, String leas_no, String leas_sub_seq){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_8004_D(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_8004_DDM dm = (FC_FUNC_8004_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_8004_DDataSet();
	}
...
/* 작성시간 : Fri Mar 20 19:09:33 KST 2009 */