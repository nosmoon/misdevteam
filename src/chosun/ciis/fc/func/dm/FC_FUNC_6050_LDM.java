...
public class FC_FUNC_6050_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_6050_LDM(){}
	public FC_FUNC_6050_LDM(String cmpy_cd, String cymd, String deps_isav_clsf_cd, String dlco_clsf_cd, String dlco_cd, String where_string){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_6050_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_6050_LDM dm = (FC_FUNC_6050_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_6050_LDataSet();
	}
