...
public class FC_FUNC_1465_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String note_no;
	public String note_seq;

	public FC_FUNC_1465_LDM(){}
	public FC_FUNC_1465_LDM(String cmpy_cd, String note_no, String note_seq){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_1465_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_1465_LDM dm = (FC_FUNC_1465_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_1465_LDataSet();
	}
