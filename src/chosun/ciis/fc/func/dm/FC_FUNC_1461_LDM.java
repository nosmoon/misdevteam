...
public class FC_FUNC_1461_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_1461_LDM(){}
	public FC_FUNC_1461_LDM(String cmpy_cd, String mtry_dt, String chkpjee, String place){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_1461_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_1461_LDM dm = (FC_FUNC_1461_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_1461_LDataSet();
	}
