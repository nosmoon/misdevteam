...
public class FC_FUNC_1052_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_1052_LDM(){}
	public FC_FUNC_1052_LDM(String cmpy_cd, String stat_dt, String stat_cd, String pch_sql){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_1052_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_1052_LDM dm = (FC_FUNC_1052_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_1052_LDataSet();
	}
