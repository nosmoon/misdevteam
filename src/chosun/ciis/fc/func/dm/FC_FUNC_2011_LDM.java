...
public class FC_FUNC_2011_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_2011_LDM(){}
	public FC_FUNC_2011_LDM(String cmpy_cd, String seci_clsf_cd, String pay_bank_cd, String mtry_dt, String repay_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_2011_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_2011_LDM dm = (FC_FUNC_2011_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_2011_LDataSet();
	}
