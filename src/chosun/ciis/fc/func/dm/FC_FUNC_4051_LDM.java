...
public class FC_FUNC_4051_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_4051_LDM(){}
	public FC_FUNC_4051_LDM(String cmpy_cd, String curacct_clsf_cd, String pch_cymd1fr, String pch_cymd1to){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_4051_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_4051_LDM dm = (FC_FUNC_4051_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_4051_LDataSet();
	}
