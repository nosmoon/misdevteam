...
public class FC_FUNC_1450_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String note_no;

	public FC_FUNC_1450_LDM(){}
	public FC_FUNC_1450_LDM(String cmpy_cd, String note_no){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_1450_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_1450_LDM dm = (FC_FUNC_1450_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_1450_LDataSet();
	}
