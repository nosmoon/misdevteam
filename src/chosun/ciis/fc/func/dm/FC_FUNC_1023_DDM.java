...
public class FC_FUNC_1023_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_1023_DDM(){}
	public FC_FUNC_1023_DDM(String cmpy_cd, String incmg_pers_ipadd, String incmg_pers, String bank_cd, String note_no, String note_seq){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_1023_D(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_1023_DDM dm = (FC_FUNC_1023_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_1023_DDataSet();
	}
