...
public class FC_FUNC_7033_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_7033_DDM(){}
	public FC_FUNC_7033_DDM(String cmpy_cd, String fund_mang_no, String loan_no, String pay_dt, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_7033_D(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_7033_DDM dm = (FC_FUNC_7033_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_7033_DDataSet();
	}
...
/* 작성시간 : Tue Apr 07 11:31:48 KST 2009 */