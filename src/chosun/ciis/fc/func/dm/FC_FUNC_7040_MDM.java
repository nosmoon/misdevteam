...
public class FC_FUNC_7040_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String recp_dt;

	public FC_FUNC_7040_MDM(){}
	public FC_FUNC_7040_MDM(String cmpy_cd, String recp_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_7040_M(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_7040_MDM dm = (FC_FUNC_7040_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_7040_MDataSet();
	}
