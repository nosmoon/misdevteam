...
public class FC_FUNC_8067_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String asum_yymm;
	public String tms;

	public FC_FUNC_8067_DDM(){}
	public FC_FUNC_8067_DDM(String cmpy_cd, String asum_yymm, String tms){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_8067_D(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_8067_DDM dm = (FC_FUNC_8067_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_8067_DDataSet();
	}
