...
public class FC_FUNC_3000_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_3000_LDM(){}
	public FC_FUNC_3000_LDM(String cmpy_cd, String base_amt, String fr_dt, String to_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_3000_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_3000_LDM dm = (FC_FUNC_3000_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.base_amt);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_3000_LDataSet();
	}
