...
public class FC_FUNC_5001_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_5001_LDM(){}
	public FC_FUNC_5001_LDM(String cmpy_cd, String insr_clsf_cd, String insr_no, String comp_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_5001_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_5001_LDM dm = (FC_FUNC_5001_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_5001_LDataSet();
	}
