...
public class FC_FUNC_1453_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_1453_IDM(){}
	public FC_FUNC_1453_IDM(String cmpy_cd, String note_no, String note_seq, String bank_cd, String reg_dt, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_1453_I(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_1453_IDM dm = (FC_FUNC_1453_IDM)bdm;
		...
		cstmt.setString(7, dm.reg_dt);
		cstmt.setString(8, dm.incmg_pers);
		cstmt.setString(9, dm.incmg_pers_ipadd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_1453_IDataSet();
	}
