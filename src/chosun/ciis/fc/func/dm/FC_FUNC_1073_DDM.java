...
public class FC_FUNC_1073_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_1073_DDM(){}
	public FC_FUNC_1073_DDM(String cmpy_cd, String stat_dt, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String incmg_pers, String incmg_pers_ipadd, String pch_count){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_1073_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
		
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_1073_DDM dm = (FC_FUNC_1073_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_1073_DDataSet();
	}
...
/* 작성시간 : Wed Feb 18 19:38:06 KST 2009 */