...
public class FC_FUNC_7003_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_7003_UDM(){}
	public FC_FUNC_7003_UDM(String cmpy_cd, String fund_mang_no, String loan_no, String loan_nm, String loan_amt, String comp_dt, String mtry_dt, String loan_repay_clsf_cd, String int_clsf_cd, String dlco_clsf_cd, String dlco_cd, String loan_patr_budg_cd, String loan_deps_clsf_cd, String colt_note_no, String loan_rmks, String prelae_pay_clsf_cd, String incmg_pers, String incmg_pers_ipadd, String misfnc_dlco_nm, String int_rate){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_7003_U(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_7003_UDM dm = (FC_FUNC_7003_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_7003_UDataSet();
	}
