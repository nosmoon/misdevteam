...
public class FC_FUNC_1413_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_1413_DDM(){}
	public FC_FUNC_1413_DDM(String cmpy_cd, String stat_dt, String stat_cd, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String pch_count, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_1413_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_1413_DDM dm = (FC_FUNC_1413_DDM)bdm;
		...
		cstmt.setString(9, dm.pch_count);
		cstmt.setString(10, dm.incmg_pers);
		cstmt.setString(11, dm.incmg_pers_ipadd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_1413_DDataSet();
	}
