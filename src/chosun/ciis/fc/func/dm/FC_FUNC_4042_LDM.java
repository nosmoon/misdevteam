...
public class FC_FUNC_4042_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_4042_LDM(){}
	public FC_FUNC_4042_LDM(String cmpy_cd, String stat_cd, String curacct_clsf_cd, String pch_cymd1fr, String pch_cymd1to, String pch_cymd2fr, String pch_cymd2to){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_4042_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_4042_LDM dm = (FC_FUNC_4042_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_4042_LDataSet();
	}
