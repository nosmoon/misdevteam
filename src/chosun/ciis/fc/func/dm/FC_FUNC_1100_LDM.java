...
public class FC_FUNC_1100_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String stat_dt;

	public FC_FUNC_1100_LDM(){}
	public FC_FUNC_1100_LDM(String cmpy_cd, String stat_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_1100_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_1100_LDM dm = (FC_FUNC_1100_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_1100_LDataSet();
	}
