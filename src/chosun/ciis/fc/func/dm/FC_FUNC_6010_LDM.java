...
public class FC_FUNC_6010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String comp_dt;

	public FC_FUNC_6010_LDM(){}
	public FC_FUNC_6010_LDM(String cmpy_cd, String comp_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_6010_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_6010_LDM dm = (FC_FUNC_6010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_6010_LDataSet();
	}
