...
public class FC_FUNC_1013_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_1013_LDM(){}
	public FC_FUNC_1013_LDM(String bank_cd, String note_no, String note_seq, String cmpy_cd, String stat_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_1013_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_1013_LDM dm = (FC_FUNC_1013_LDM)bdm;
		...
		cstmt.setString(7, dm.stat_cd);
		cstmt.registerOutParameter(8, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_1013_LDataSet();
	}
