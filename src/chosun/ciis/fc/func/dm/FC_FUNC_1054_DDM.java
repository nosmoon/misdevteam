...
public class FC_FUNC_1054_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_1054_DDM(){}
	public FC_FUNC_1054_DDM(String cmpy_cd, String stat_dt, String stat_cd, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String incmg_pers, String incmg_pers_ipadd, String pch_count){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_1054_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_1054_DDM dm = (FC_FUNC_1054_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_1054_DDataSet();
	}
