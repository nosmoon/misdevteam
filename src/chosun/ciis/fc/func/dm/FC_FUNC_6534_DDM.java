...
public class FC_FUNC_6534_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_6534_DDM(){}
	public FC_FUNC_6534_DDM(String cmpy_cd, String deps_isav_clsf_cd, String deps_isav_no, String recp_dt, String incmg_pers, String incmg_pers_ipadd, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String upintsuigamt, String uptotintamt, String cost_gain_stot, String rcpay_amt_stot){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_6534_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_6534_DDM dm = (FC_FUNC_6534_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_6534_DDataSet();
	}
