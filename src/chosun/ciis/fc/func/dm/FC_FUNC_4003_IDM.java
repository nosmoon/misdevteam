...
public class FC_FUNC_4003_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_4003_IDM(){}
	public FC_FUNC_4003_IDM(String cmpy_cd, String recp_dt, String bgn_no, String pch_count, String curacct_clsf_cd, String bank_cd, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_4003_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_4003_IDM dm = (FC_FUNC_4003_IDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_4003_IDataSet();
	}
...
/* 작성시간 : Fri Mar 06 11:23:42 KST 2009 */