...
public class FC_FUNC_8066_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_8066_UDM(){}
	public FC_FUNC_8066_UDM(String cmpy_cd, String asum_yymm, String tms, String chg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_8066_U(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_8066_UDM dm = (FC_FUNC_8066_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_8066_UDataSet();
	}
