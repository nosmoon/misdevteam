...
public class FC_FUNC_3093_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_3093_DDM(){}
	public FC_FUNC_3093_DDM(String cmpy_cd, String dlco_cd, String prd_end, String seq, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_3093_D(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_3093_DDM dm = (FC_FUNC_3093_DDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.dlco_cd);
		cstmt.setString(5, dm.prd_end);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_3093_DDataSet();
	}
