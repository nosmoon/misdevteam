...
public class FC_FUNC_1190_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String dhon_occr_dt;

	public FC_FUNC_1190_LDM(){}
	public FC_FUNC_1190_LDM(String cmpy_cd, String dhon_occr_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_1190_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_1190_LDM dm = (FC_FUNC_1190_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_1190_LDataSet();
	}
