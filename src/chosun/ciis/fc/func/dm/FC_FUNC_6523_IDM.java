...
public class FC_FUNC_6523_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_6523_IDM(){}
	public FC_FUNC_6523_IDM(String cmpy_cd, String deps_isav_clsf_cd, String deps_isav_no, String int_rate_chg_dt, String int_rate, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_6523_I(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_6523_IDM dm = (FC_FUNC_6523_IDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_6523_IDataSet();
	}
