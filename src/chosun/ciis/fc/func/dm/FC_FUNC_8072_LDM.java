...
public class FC_FUNC_8072_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String leas_clsf_cd;
	public String leas_no;

	public FC_FUNC_8072_LDM(){}
	public FC_FUNC_8072_LDM(String cmpy_cd, String leas_clsf_cd, String leas_no){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_8072_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_8072_LDM dm = (FC_FUNC_8072_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_8072_LDataSet();
	}
