...
public class FC_FUNC_6123_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_6123_IDM(){}
	public FC_FUNC_6123_IDM(String cmpy_cd, String deps_isav_clsf_cd, String deps_isav_no, String recp_dt, String int_rate, String tot_int_amt, String corp_tax_amt, String aft_tax_int_amt, String unrcp_precpt_bal, String int_gain_amt, String rmks, String incmg_pers, String incmg_pers_ipadd, String compgbcd, String compcd, String compnm, String cost_gain_stot, String rcpay_amt_stot, String use_dept_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_6123_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_6123_IDM dm = (FC_FUNC_6123_IDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_6123_IDataSet();
	}
