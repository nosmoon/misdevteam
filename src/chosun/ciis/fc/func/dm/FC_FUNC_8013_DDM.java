...
public class FC_FUNC_8013_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_8013_DDM(){}
	public FC_FUNC_8013_DDM(String cmpy_cd, String cntr_clsf_cd, String leas_clsf_cd, String leas_no, String leas_sub_seq){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_8013_D(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_8013_DDM dm = (FC_FUNC_8013_DDM)bdm;
		...
		cstmt.setString(7, dm.leas_sub_seq);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_8013_DDataSet();
	}
...
/* 작성시간 : Thu Mar 26 14:16:34 KST 2009 */