...
public class FC_FUNC_1091_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_1091_LDM(){}
	public FC_FUNC_1091_LDM(String cmpy_cd, String mtry_dt, String dlco_clsf_cd, String dlco_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_1091_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_1091_LDM dm = (FC_FUNC_1091_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_1091_LDataSet();
	}
