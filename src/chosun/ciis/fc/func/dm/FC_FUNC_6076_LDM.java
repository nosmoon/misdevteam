...
public class FC_FUNC_6076_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_6076_LDM(){}
	public FC_FUNC_6076_LDM(String cmpy_cd, String deps_isav_clsf_cd, String deps_isav_no, String comp_dt, String mtry_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_6076_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_6076_LDM dm = (FC_FUNC_6076_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_6076_LDataSet();
	}
