...
public class FC_FUNC_1020_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_1020_LDM(){}
	public FC_FUNC_1020_LDM(String cmpy_cd, String now_note_stat_cd, String note_amt, String pch_cymd1fr, String pch_cymd1to){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_1020_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_1020_LDM dm = (FC_FUNC_1020_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.now_note_stat_cd);
		cstmt.setString(5, dm.note_amt);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_1020_LDataSet();
	}
