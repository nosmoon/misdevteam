...
public class FC_FUNC_6161_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String and_string;

	public FC_FUNC_6161_LDM(){}
	public FC_FUNC_6161_LDM(String cmpy_cd, String and_string){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_6161_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_6161_LDM dm = (FC_FUNC_6161_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_6161_LDataSet();
	}
