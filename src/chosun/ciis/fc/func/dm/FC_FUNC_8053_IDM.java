...
public class FC_FUNC_8053_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_8053_IDM(){}
	public FC_FUNC_8053_IDM(String cmpy_cd, String insr_clsf_cd, String insr_no, String comp_dt, String insr_nm, String dlco_clsf_cd, String dlco_cd, String bhcompnm, String mtry_dt, String medi_cd, String dtls_medi_cd, String use_dept_cd, String insr_amt, String insr_rate, String frex_cd, String exrate, String frcr_amt, String won_amt, String pymt_rmks, String incmg_pers, String incmg_pers_ipadd, String fisc_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_8053_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_8053_IDM dm = (FC_FUNC_8053_IDM)bdm;
		...
		cstmt.setString(15, dm.insr_amt);
		cstmt.setString(16, dm.insr_rate);
		cstmt.setString(17, dm.frex_cd);
		cstmt.setString(18, dm.exrate);
		cstmt.setString(19, dm.frcr_amt);
		cstmt.setString(20, dm.won_amt);
		cstmt.setString(21, dm.pymt_rmks);
		cstmt.setString(22, dm.incmg_pers);
		cstmt.setString(23, dm.incmg_pers_ipadd);
		cstmt.setString(24, dm.fisc_dt);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_8053_IDataSet();
	}
	...
	public void print(){
		...
		System.out.println("bhcompnm = [" + getBhcompnm() + "]");
...
String bhcompnm = req.getParameter("bhcompnm");
if( bhcompnm == null){
	System.out.println(this.toString+" : bhcompnm is null" );
}else{
	System.out.println(this.toString+" : bhcompnm is "+bhcompnm );
}
...
String bhcompnm = Util.checkString(req.getParameter("bhcompnm"));
...
String bhcompnm = Util.Uni2Ksc(Util.checkString(req.getParameter("bhcompnm")));
