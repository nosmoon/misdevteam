...
public class FC_FUNC_4004_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_4004_ADM(){}
	public FC_FUNC_4004_ADM(String cmpy_cd, String mode, String recp_dt, String bgn_no, String pch_count, String curacct_clsf_cd, String bank_cd, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_4004_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_4004_ADM dm = (FC_FUNC_4004_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.mode);
		cstmt.setString(5, dm.recp_dt);
		cstmt.setString(6, dm.bgn_no);
		cstmt.setString(7, dm.pch_count);
		cstmt.setString(8, dm.curacct_clsf_cd);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_4004_ADataSet();
	}
...
/* 작성시간 : Mon Mar 09 17:47:10 KST 2009 */