...
public class FC_FUNC_6503_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String deps_isav_clsf_cd;
	public String deps_isav_no;
	public String occr_clsf_cd;

	public FC_FUNC_6503_LDM(){}
	public FC_FUNC_6503_LDM(String cmpy_cd, String deps_isav_clsf_cd, String deps_isav_no, String occr_clsf_cd){
		this.cmpy_cd = cmpy_cd;
		this.deps_isav_clsf_cd = deps_isav_clsf_cd;
		this.deps_isav_no = deps_isav_no;
		this.occr_clsf_cd = occr_clsf_cd;
	}
	...
	public void setOccr_clsf_cd(String occr_clsf_cd){
		this.occr_clsf_cd = occr_clsf_cd;
	}
	...
	public String getOccr_clsf_cd(){
		return this.occr_clsf_cd;
	}

	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_6503_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_6503_LDM dm = (FC_FUNC_6503_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.deps_isav_clsf_cd);
		cstmt.setString(5, dm.deps_isav_no);
		cstmt.setString(6, dm.occr_clsf_cd);
		cstmt.registerOutParameter(7, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_6503_LDataSet();
	}
    ...
    public void print(){
        ...
        System.out.println("occr_clsf_cd = " + getOccr_clsf_cd());
    }
}
/*----------------------------------------------------------------------------------------------------
...
String occr_clsf_cd = req.getParameter("occr_clsf_cd");
if( occr_clsf_cd == null){
	System.out.println(this.toString+" : occr_clsf_cd is null" );
}else{
	System.out.println(this.toString+" : occr_clsf_cd is "+occr_clsf_cd );
}
----------------------------------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------------------------------
...
String occr_clsf_cd = Util.checkString(req.getParameter("occr_clsf_cd"));
----------------------------------------------------------------------------------------------------*//*----------------------------------------------------------------------------------------------------
...
String occr_clsf_cd = Util.Uni2Ksc(Util.checkString(req.getParameter("occr_clsf_cd")));
----------------------------------------------------------------------------------------------------*/
...
dm.setOccr_clsf_cd(occr_clsf_cd);
----------------------------------------------------------------------------------------------------*/
