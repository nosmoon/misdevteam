...
public class FC_FUNC_3040_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String yyyy;
	public String base_amt;

	public FC_FUNC_3040_LDM(){}
	public FC_FUNC_3040_LDM(String cmpy_cd, String yyyy, String base_amt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_3040_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_3040_LDM dm = (FC_FUNC_3040_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_3040_LDataSet();
	}
