...
public class FC_FUNC_6074_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_FUNC_6074_DDM(){}
	public FC_FUNC_6074_DDM(String cmpy_cd, String deps_isav_clsf_cd, String deps_isav_no, String pymt_dt, String incmg_pers, String incmg_pers_ipadd, String slip_occr_dt, String slip_clsf_cd, String slip_seq){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_6074_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_6074_DDM dm = (FC_FUNC_6074_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_6074_DDataSet();
	}
