...
public class FC_FUNC_4021_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String pay_note_no;
	public String stat_cd;

	public FC_FUNC_4021_LDM(){}
	public FC_FUNC_4021_LDM(String cmpy_cd, String pay_note_no, String stat_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_FUNC_4021_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_FUNC_4021_LDM dm = (FC_FUNC_4021_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.func.ds.FC_FUNC_4021_LDataSet();
	}
