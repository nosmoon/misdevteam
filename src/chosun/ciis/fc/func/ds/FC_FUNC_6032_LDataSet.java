...
public class FC_FUNC_6032_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_FUNC_6032_LDataSet(){}
	public FC_FUNC_6032_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset2.next()){
			FC_FUNC_6032_LCURLISTRecord rec = new FC_FUNC_6032_LCURLISTRecord();
