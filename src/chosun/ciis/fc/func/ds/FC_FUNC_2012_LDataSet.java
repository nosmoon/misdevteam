...
public class FC_FUNC_2012_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_FUNC_2012_LDataSet(){}
	public FC_FUNC_2012_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_FUNC_2012_LCURLISTRecord rec = new FC_FUNC_2012_LCURLISTRecord();
			rec.pay_bank_cd_nm = Util.checkString(rset0.getString("pay_bank_cd_nm"));
			...
			rec.yugaint2 = Util.checkString(rset0.getString("yugaint2"));
...
<%
	FC_FUNC_2012_LDataSet ds = (FC_FUNC_2012_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_FUNC_2012_LCURLISTRecord curlistRec = (FC_FUNC_2012_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Wed Apr 29 10:48:46 KST 2009 */