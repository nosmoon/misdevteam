...
public class FC_FUNC_1122_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_FUNC_1122_LDataSet(){}
	public FC_FUNC_1122_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_FUNC_1122_LCURLISTRecord rec = new FC_FUNC_1122_LCURLISTRecord();
			...
			rec.bhsgbnm = Util.checkString(rset0.getString("bhsgbnm"));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_FUNC_1122_LCURLISTRecord curlistRec = (FC_FUNC_1122_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
