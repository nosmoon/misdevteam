...
public class FC_FUNC_4042_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_FUNC_4042_LDataSet(){}
	public FC_FUNC_4042_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset2.next()){
			FC_FUNC_4042_LCURLISTRecord rec = new FC_FUNC_4042_LCURLISTRecord();
			rec.eestnm = Util.checkString(rset2.getString("eestnm"));
...
<%
	FC_FUNC_4042_LDataSet ds = (FC_FUNC_4042_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_FUNC_4042_LCURLISTRecord curlistRec = (FC_FUNC_4042_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
