...
public class FC_FUNC_3020_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_FUNC_3020_LDataSet(){}
	public FC_FUNC_3020_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_FUNC_3020_LCURLISTRecord rec = new FC_FUNC_3020_LCURLISTRecord();
			...
			rec.in_note = Util.checkString(rset0.getString("in_note"));
...
<%
	FC_FUNC_3020_LDataSet ds = (FC_FUNC_3020_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_FUNC_3020_LCURLISTRecord curlistRec = (FC_FUNC_3020_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Thu Apr 02 10:49:23 KST 2009 */