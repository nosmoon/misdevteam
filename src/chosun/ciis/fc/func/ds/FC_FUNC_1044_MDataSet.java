...
public class FC_FUNC_1044_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public FC_FUNC_1044_MDataSet(){}
	public FC_FUNC_1044_MDataSet(String errcode, String errmsg, String xx_now_note_stat_cd, String xx_stat_cd, String xx_dlco_clsf_cd){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_FUNC_1044_MXX_CDRecord rec = new FC_FUNC_1044_MXX_CDRecord();
			rec.cd_nm = Util.checkString(rset0.getString("cd_nm"));
			rec.cd = Util.checkString(rset0.getString("cd"));
			this.xx_cd.add(rec);
		}
		this.xx_now_note_stat_cd = Util.checkString(cstmt.getString(6));
		this.xx_stat_cd = Util.checkString(cstmt.getString(7));
...
<%
	FC_FUNC_1044_MDataSet ds = (FC_FUNC_1044_MDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.xx_cd.size(); i++){
		FC_FUNC_1044_MXX_CDRecord xx_cdRec = (FC_FUNC_1044_MXX_CDRecord)ds.xx_cd.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Tue Jan 03 16:20:39 KST 2012 */