...
public class FC_FUNC_6040_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public FC_FUNC_6040_MDataSet(){}
	public FC_FUNC_6040_MDataSet(String errcode, String errmsg, String xx_deps_isav_stat_cd, String xx_budg_cd_010){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_FUNC_6040_MCURLIST1Record rec = new FC_FUNC_6040_MCURLIST1Record();
		...
		while(rset1.next()){
			FC_FUNC_6040_MCURLIST2Record rec = new FC_FUNC_6040_MCURLIST2Record();
		...
		while(rset2.next()){
			FC_FUNC_6040_MXX_BUDG_CD_LISTRecord rec = new FC_FUNC_6040_MXX_BUDG_CD_LISTRecord();
