...
public class FC_FUNC_6020_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList deps_isav_clsf_cd = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_FUNC_6020_MDataSet(){}
	public FC_FUNC_6020_MDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset2.next()){
			FC_FUNC_6020_MDEPS_ISAV_CLSF_CDRecord rec = new FC_FUNC_6020_MDEPS_ISAV_CLSF_CDRecord();
