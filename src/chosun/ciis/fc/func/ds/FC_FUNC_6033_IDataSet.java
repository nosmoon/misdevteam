...
public class FC_FUNC_6033_IDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_FUNC_6033_IDataSet(){}
	public FC_FUNC_6033_IDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_FUNC_6033_ICURLISTRecord rec = new FC_FUNC_6033_ICURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_FUNC_6033_ICURLISTRecord curlistRec = (FC_FUNC_6033_ICURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
