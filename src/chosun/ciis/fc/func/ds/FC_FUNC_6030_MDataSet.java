...
public class FC_FUNC_6030_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList deps_isav_clsf_cd = new ArrayList();
	public String errcode;
	public String errmsg;
	public String xx_deps_isav_stat_cd;

	public FC_FUNC_6030_MDataSet(){}
	public FC_FUNC_6030_MDataSet(String errcode, String errmsg, String xx_deps_isav_stat_cd){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_FUNC_6030_MDEPS_ISAV_CLSF_CDRecord rec = new FC_FUNC_6030_MDEPS_ISAV_CLSF_CDRecord();
