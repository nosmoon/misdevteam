...
public class FC_FUNC_6151_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_FUNC_6151_LDataSet(){}
	public FC_FUNC_6151_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_FUNC_6151_LCURLISTRecord rec = new FC_FUNC_6151_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_FUNC_6151_LCURLISTRecord curlistRec = (FC_FUNC_6151_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
