...
public class FC_FUNC_1451_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_FUNC_1451_LDataSet(){}
	public FC_FUNC_1451_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset1.next()){
			FC_FUNC_1451_LCURLISTRecord rec = new FC_FUNC_1451_LCURLISTRecord();
			rec.reg_dt = Util.checkString(rset1.getString("reg_dt"));
			rec.note_ns = Util.checkString(rset1.getString("note_ns"));
...
<%
	FC_FUNC_1451_LDataSet ds = (FC_FUNC_1451_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_FUNC_1451_LCURLISTRecord curlistRec = (FC_FUNC_1451_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
