...
public class FC_ACCT_2581_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist2 = new ArrayList();
	public ArrayList curlist1 = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_2581_LDataSet(){}
	public FC_ACCT_2581_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset1.next()){
			FC_ACCT_2581_LCURLIST1Record rec = new FC_ACCT_2581_LCURLIST1Record();
			...
			rec.mang_clsf_cdnm = Util.checkString(rset1.getString("mang_clsf_cdnm"));
			...
			rec.withdraw = Util.checkString(rset1.getString("withdraw"));
			this.curlist1.add(rec);
		}
		ResultSet rset2 = (ResultSet) cstmt.getObject(11);
		while(rset2.next()){
			FC_ACCT_2581_LCURLIST2Record rec = new FC_ACCT_2581_LCURLIST2Record();
			...
			rec.incmg_emp_no = Util.checkString(rset2.getString("incmg_emp_no"));
			rec.incmg_emp_nm = Util.checkString(rset2.getString("incmg_emp_nm"));
			...
			rec.mang_clsf_nm = Util.checkString(rset2.getString("mang_clsf_nm"));
			rec.drcr_clsf = Util.checkString(rset2.getString("drcr_clsf"));
			rec.dr_amt = Util.checkString(rset2.getString("dr_amt"));
			rec.crdt_amt = Util.checkString(rset2.getString("crdt_amt"));
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		FC_ACCT_2581_LCURLIST1Record curlist1Rec = (FC_ACCT_2581_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		FC_ACCT_2581_LCURLIST2Record curlist2Rec = (FC_ACCT_2581_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>
