...
public class FC_ACCT_2045_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist1 = new ArrayList();
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_2045_LDataSet(){}
	public FC_ACCT_2045_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_2045_LCURLISTRecord rec = new FC_ACCT_2045_LCURLISTRecord();
		...
		while(rset1.next()){
			FC_ACCT_2045_LCURLIST1Record rec = new FC_ACCT_2045_LCURLIST1Record();
...
<%
	FC_ACCT_2045_LDataSet ds = (FC_ACCT_2045_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_2045_LCURLISTRecord curlistRec = (FC_ACCT_2045_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		FC_ACCT_2045_LCURLIST1Record curlist1Rec = (FC_ACCT_2045_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>
