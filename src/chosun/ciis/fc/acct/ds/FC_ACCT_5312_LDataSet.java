...
public class FC_ACCT_5312_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_5312_LDataSet(){}
	public FC_ACCT_5312_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset1.next()){
			FC_ACCT_5312_LCURLISTRecord rec = new FC_ACCT_5312_LCURLISTRecord();
			...
			rec.acacctynm = Util.checkString(rset1.getString("acacctynm"));
			rec.budg_cd = Util.checkString(rset1.getString("budg_cd"));
			rec.ycyscdnm = Util.checkString(rset1.getString("ycyscdnm"));
			...
			rec.clam_dept_cd = Util.checkString(rset1.getString("clam_dept_cd"));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_5312_LCURLISTRecord curlistRec = (FC_ACCT_5312_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
