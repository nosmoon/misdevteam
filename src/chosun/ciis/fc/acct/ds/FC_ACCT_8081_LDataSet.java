...
public class FC_ACCT_8081_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_8081_LDataSet(){}
	public FC_ACCT_8081_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_8081_LCURLISTRecord rec = new FC_ACCT_8081_LCURLISTRecord();
			...
			rec.seyul = Util.checkString(rset0.getString("seyul"));
			rec.acntcym = Util.checkString(rset0.getString("acntcym"));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_8081_LCURLISTRecord curlistRec = (FC_ACCT_8081_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
