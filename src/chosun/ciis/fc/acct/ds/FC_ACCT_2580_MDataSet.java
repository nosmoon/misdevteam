...
public class FC_ACCT_2580_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public FC_ACCT_2580_MDataSet(){}
	public FC_ACCT_2580_MDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset3.next()){
			FC_ACCT_2580_MCURLIST1Record rec = new FC_ACCT_2580_MCURLIST1Record();
		...
		while(rset4.next()){
			FC_ACCT_2580_MCURLIST2Record rec = new FC_ACCT_2580_MCURLIST2Record();
		...
		while(rset5.next()){
			FC_ACCT_2580_MCURLIST3Record rec = new FC_ACCT_2580_MCURLIST3Record();
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		FC_ACCT_2580_MCURLIST1Record curlist1Rec = (FC_ACCT_2580_MCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		FC_ACCT_2580_MCURLIST2Record curlist2Rec = (FC_ACCT_2580_MCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist3.size(); i++){
		FC_ACCT_2580_MCURLIST3Record curlist3Rec = (FC_ACCT_2580_MCURLIST3Record)ds.curlist3.get(i);%>
HTML 코드들....
	<%}%>
