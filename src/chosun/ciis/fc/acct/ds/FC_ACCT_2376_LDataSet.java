...
public class FC_ACCT_2376_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_2376_LDataSet(){}
	public FC_ACCT_2376_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset2.next()){
			FC_ACCT_2376_LCURLISTRecord rec = new FC_ACCT_2376_LCURLISTRecord();
			rec.check1 = Util.checkString(rset2.getString("check1"));
			...
			rec.sum_cbamt = Util.checkString(rset2.getString("sum_cbamt"));
			rec.sum_dbamt = Util.checkString(rset2.getString("sum_dbamt"));
			rec.incmg_emp_no = Util.checkString(rset2.getString("incmg_emp_no"));
			rec.chrg_emp_no = Util.checkString(rset2.getString("chrg_emp_no"));
			rec.incmg_dt = Util.checkString(rset2.getString("incmg_dt"));
			rec.slip_no = Util.checkString(rset2.getString("slip_no"));
			rec.draft_doc_no = Util.checkString(rset2.getString("draft_doc_no"));
			rec.draft_expn_amt = Util.checkString(rset2.getString("draft_expn_amt"));
			rec.draft_impt_amt = Util.checkString(rset2.getString("draft_impt_amt"));
			rec.draft_doc_dept_cd = Util.checkString(rset2.getString("draft_doc_dept_cd"));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_2376_LCURLISTRecord curlistRec = (FC_ACCT_2376_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
