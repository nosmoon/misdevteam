...
public class FC_ACCT_2200_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public FC_ACCT_2200_MDataSet(){}
	public FC_ACCT_2200_MDataSet(String errcode, String errmsg, String xx_slip_sub_seq, String xx_slip_clsf_30){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_2200_MCURLISTRecord rec = new FC_ACCT_2200_MCURLISTRecord();
...
<%
	FC_ACCT_2200_MDataSet ds = (FC_ACCT_2200_MDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_2200_MCURLISTRecord curlistRec = (FC_ACCT_2200_MCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Mon Jan 02 10:38:05 KST 2012 */