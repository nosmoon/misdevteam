...
public class FC_ACCT_2451_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curcommlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_2451_LDataSet(){}
	public FC_ACCT_2451_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_2451_LCURCOMMLISTRecord rec = new FC_ACCT_2451_LCURCOMMLISTRecord();
...
<%
	FC_ACCT_2451_LDataSet ds = (FC_ACCT_2451_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curcommlist.size(); i++){
		FC_ACCT_2451_LCURCOMMLISTRecord curcommlistRec = (FC_ACCT_2451_LCURCOMMLISTRecord)ds.curcommlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Wed Jul 15 21:46:21 KST 2009 */