...
public class FC_ACCT_4006_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_4006_LDataSet(){}
	public FC_ACCT_4006_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset2.next()){
			FC_ACCT_4006_LCURLISTRecord rec = new FC_ACCT_4006_LCURLISTRecord();
			...
			rec.occr_amt = Util.checkString(rset2.getString("occr_amt"));
			rec.adjm_slip_no = Util.checkString(rset2.getString("adjm_slip_no"));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_4006_LCURLISTRecord curlistRec = (FC_ACCT_4006_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
