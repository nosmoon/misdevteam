...
public class FC_ACCT_2355_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_2355_LDataSet(){}
	public FC_ACCT_2355_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_2355_LCURLISTRecord rec = new FC_ACCT_2355_LCURLISTRecord();
			...
			rec.acctynm = Util.checkString(rset0.getString("acctynm"));
			...
			rec.igbhannm = Util.checkString(rset0.getString("igbhannm"));
...
<%
	FC_ACCT_2355_LDataSet ds = (FC_ACCT_2355_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_2355_LCURLISTRecord curlistRec = (FC_ACCT_2355_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
