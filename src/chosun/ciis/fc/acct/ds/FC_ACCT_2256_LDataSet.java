...
public class FC_ACCT_2256_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList slip_list = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_2256_LDataSet(){}
	public FC_ACCT_2256_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_2256_LSLIP_LISTRecord rec = new FC_ACCT_2256_LSLIP_LISTRecord();
...
<%
	FC_ACCT_2256_LDataSet ds = (FC_ACCT_2256_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.slip_list.size(); i++){
		FC_ACCT_2256_LSLIP_LISTRecord slip_listRec = (FC_ACCT_2256_LSLIP_LISTRecord)ds.slip_list.get(i);%>
HTML 코드들....
	<%}%>
