...
public class FC_ACCT_3076_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_3076_LDataSet(){}
	public FC_ACCT_3076_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset3.next()){
			FC_ACCT_3076_LCURLISTRecord rec = new FC_ACCT_3076_LCURLISTRecord();
