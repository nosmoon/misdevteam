...
public class FC_ACCT_5361_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_5361_LDataSet(){}
	public FC_ACCT_5361_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_5361_LCURLISTRecord rec = new FC_ACCT_5361_LCURLISTRecord();
...
<%
	FC_ACCT_5361_LDataSet ds = (FC_ACCT_5361_LDataSet)request.getAttribute("ds");
%>
Web Tier에서 Record 객체 관련 코드 작성시 사용하십시오.

<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_5361_LCURLISTRecord curlistRec = (FC_ACCT_5361_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Wed Mar 18 15:31:36 KST 2009 */