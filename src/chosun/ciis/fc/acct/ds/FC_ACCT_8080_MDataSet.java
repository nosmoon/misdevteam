...
public class FC_ACCT_8080_MDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	public String xx_c_sdgb_4;
	public String xx_buff_1;
	public String xx_buff_2;
	public String xx_buff_3;

	public FC_ACCT_8080_MDataSet(){}
	public FC_ACCT_8080_MDataSet(String errcode, String errmsg, String xx_acct_cd, String xx_c_sdgb_1, String xx_c_sdgb_2, String xx_c_sdgb_3, String xx_c_sdgb_4, String xx_buff_1, String xx_buff_2, String xx_buff_3){
	...
	public void setXx_c_sdgb_4(String xx_c_sdgb_4){
		this.xx_c_sdgb_4 = xx_c_sdgb_4;
	}
	...
	public String getXx_c_sdgb_4(){
		return this.xx_c_sdgb_4;
	}
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_8080_MERPLACE_CD_CURLISTRecord rec = new FC_ACCT_8080_MERPLACE_CD_CURLISTRecord();
		...
		while(rset1.next()){
			FC_ACCT_8080_MXX_BUFF_3_CURLISTRecord rec = new FC_ACCT_8080_MXX_BUFF_3_CURLISTRecord();
		...
		this.xx_c_sdgb_4 = Util.checkString(cstmt.getString(11));
...
<%
	for(int i=0; i<ds.erplace_cd_curlist.size(); i++){
		FC_ACCT_8080_MERPLACE_CD_CURLISTRecord erplace_cd_curlistRec = (FC_ACCT_8080_MERPLACE_CD_CURLISTRecord)ds.erplace_cd_curlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.xx_buff_3_curlist.size(); i++){
		FC_ACCT_8080_MXX_BUFF_3_CURLISTRecord xx_buff_3_curlistRec = (FC_ACCT_8080_MXX_BUFF_3_CURLISTRecord)ds.xx_buff_3_curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Thu Jul 09 13:30:50 KST 2015 */