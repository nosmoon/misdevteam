...
public class FC_ACCT_2354_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_2354_LDataSet(){}
	public FC_ACCT_2354_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset1.next()){
			FC_ACCT_2354_LCURLISTRecord rec = new FC_ACCT_2354_LCURLISTRecord();
			...
			rec.acctynm = Util.checkString(rset1.getString("acctynm"));
			...
			rec.igbhannm = Util.checkString(rset1.getString("igbhannm"));
			rec.slip_aprv_yn = Util.checkString(rset1.getString("slip_aprv_yn"));
			...
			rec.draft_impt_amt = Util.checkString(rset1.getString("draft_impt_amt"));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_2354_LCURLISTRecord curlistRec = (FC_ACCT_2354_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
