...
public class FC_ACCT_8082_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist2 = new ArrayList();
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_8082_LDataSet(){}
	public FC_ACCT_8082_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_8082_LCURLISTRecord rec = new FC_ACCT_8082_LCURLISTRecord();
		...
		while(rset1.next()){
			FC_ACCT_8082_LCURLIST2Record rec = new FC_ACCT_8082_LCURLIST2Record();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_8082_LCURLISTRecord curlistRec = (FC_ACCT_8082_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		FC_ACCT_8082_LCURLIST2Record curlist2Rec = (FC_ACCT_8082_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>
