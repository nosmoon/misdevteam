...
public class FC_ACCT_2373_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;
	public String note_yn;

	public FC_ACCT_2373_LDataSet(){}
	public FC_ACCT_2373_LDataSet(String errcode, String errmsg, String note_yn){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_2373_LCURLISTRecord rec = new FC_ACCT_2373_LCURLISTRecord();
		...
		this.note_yn = Util.checkString(cstmt.getString(11));
	}
}/*----------------------------------------------------------------------------------------------------
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_2373_LCURLISTRecord curlistRec = (FC_ACCT_2373_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
