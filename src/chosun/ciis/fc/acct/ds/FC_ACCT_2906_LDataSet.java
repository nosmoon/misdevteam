...
public class FC_ACCT_2906_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_2906_LDataSet(){}
	public FC_ACCT_2906_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset1.next()){
			FC_ACCT_2906_LCURLISTRecord rec = new FC_ACCT_2906_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_2906_LCURLISTRecord curlistRec = (FC_ACCT_2906_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
