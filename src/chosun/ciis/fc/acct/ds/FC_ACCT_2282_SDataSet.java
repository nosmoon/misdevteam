...
public class FC_ACCT_2282_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist1 = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_2282_SDataSet(){}
	public FC_ACCT_2282_SDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_2282_SCURLIST1Record rec = new FC_ACCT_2282_SCURLIST1Record();
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		FC_ACCT_2282_SCURLIST1Record curlist1Rec = (FC_ACCT_2282_SCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>
