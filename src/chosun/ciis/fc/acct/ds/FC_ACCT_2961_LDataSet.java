...
public class FC_ACCT_2961_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_2961_LDataSet(){}
	public FC_ACCT_2961_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_2961_LCURLISTRecord rec = new FC_ACCT_2961_LCURLISTRecord();
			...
			rec.gjno = Util.checkString(rset0.getString("gjno"));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_2961_LCURLISTRecord curlistRec = (FC_ACCT_2961_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
