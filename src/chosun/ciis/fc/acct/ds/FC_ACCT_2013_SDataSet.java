...
public class FC_ACCT_2013_SDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_2013_SDataSet(){}
	public FC_ACCT_2013_SDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_2013_SCURLISTRecord rec = new FC_ACCT_2013_SCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_2013_SCURLISTRecord curlistRec = (FC_ACCT_2013_SCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
