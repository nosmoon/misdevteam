...
public class FC_ACCT_1051_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_1051_LDataSet(){}
	public FC_ACCT_1051_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_1051_LCURLISTRecord rec = new FC_ACCT_1051_LCURLISTRecord();
			...
			rec.note_clehous_nm = Util.checkString(rset0.getString("note_clehous_nm"));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_1051_LCURLISTRecord curlistRec = (FC_ACCT_1051_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
