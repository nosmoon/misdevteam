...
public class FC_ACCT_2251_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist1 = new ArrayList();
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_2251_LDataSet(){}
	public FC_ACCT_2251_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_2251_LCURLISTRecord rec = new FC_ACCT_2251_LCURLISTRecord();
		...
		while(rset1.next()){
			FC_ACCT_2251_LCURLIST1Record rec = new FC_ACCT_2251_LCURLIST1Record();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_2251_LCURLISTRecord curlistRec = (FC_ACCT_2251_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist1.size(); i++){
		FC_ACCT_2251_LCURLIST1Record curlist1Rec = (FC_ACCT_2251_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Wed Dec 17 11:11:16 KST 2014 */