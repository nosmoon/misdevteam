...
public class FC_ACCT_9940_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	...
	******************************************************************************************/
	...
	public FC_ACCT_9940_LDataSet(){}
	public FC_ACCT_9940_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_9940_LCURLISTRecord rec = new FC_ACCT_9940_LCURLISTRecord();
