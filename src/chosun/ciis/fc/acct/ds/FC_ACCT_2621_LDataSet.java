...
public class FC_ACCT_2621_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist2 = new ArrayList();
	public ArrayList curlist1 = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_2621_LDataSet(){}
	public FC_ACCT_2621_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_2621_LCURLIST1Record rec = new FC_ACCT_2621_LCURLIST1Record();
		...
		while(rset1.next()){
			FC_ACCT_2621_LCURLIST2Record rec = new FC_ACCT_2621_LCURLIST2Record();
...
<%
	for(int i=0; i<ds.curlist1.size(); i++){
		FC_ACCT_2621_LCURLIST1Record curlist1Rec = (FC_ACCT_2621_LCURLIST1Record)ds.curlist1.get(i);%>
HTML 코드들....
	<%}%>

<%
	for(int i=0; i<ds.curlist2.size(); i++){
		FC_ACCT_2621_LCURLIST2Record curlist2Rec = (FC_ACCT_2621_LCURLIST2Record)ds.curlist2.get(i);%>
HTML 코드들....
	<%}%>
