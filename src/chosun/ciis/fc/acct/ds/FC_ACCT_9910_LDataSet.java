...
public class FC_ACCT_9910_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;
	public long totalcnt;

	public FC_ACCT_9910_LDataSet(){}
	public FC_ACCT_9910_LDataSet(String errcode, String errmsg, long totalcnt){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_9910_LCURLISTRecord rec = new FC_ACCT_9910_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_9910_LCURLISTRecord curlistRec = (FC_ACCT_9910_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
