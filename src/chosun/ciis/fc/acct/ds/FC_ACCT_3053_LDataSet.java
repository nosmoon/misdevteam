...
public class FC_ACCT_3053_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_3053_LDataSet(){}
	public FC_ACCT_3053_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_3053_LCURLISTRecord rec = new FC_ACCT_3053_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_3053_LCURLISTRecord curlistRec = (FC_ACCT_3053_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
...
/* 작성시간 : Mon Feb 16 15:57:53 KST 2009 */