...
public class FC_ACCT_1101_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_ACCT_1101_LDataSet(){}
	public FC_ACCT_1101_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			FC_ACCT_1101_LCURLISTRecord rec = new FC_ACCT_1101_LCURLISTRecord();
			...
			rec.mtrydate = Util.checkString(rset0.getString("mtrydate"));
			...
			rec.rem_cash_hlmt1 = Util.checkString(rset0.getString("rem_cash_hlmt1"));
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_ACCT_1101_LCURLISTRecord curlistRec = (FC_ACCT_1101_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
