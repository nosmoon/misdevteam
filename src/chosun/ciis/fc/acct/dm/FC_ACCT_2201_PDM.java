...
public class FC_ACCT_2201_PDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2201_PDM(){}
	public FC_ACCT_2201_PDM(String cmpy_cd, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String slip_sub_seq){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2201_P(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2201_PDM dm = (FC_ACCT_2201_PDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2201_PDataSet();
	}
