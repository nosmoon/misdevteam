...
public class FC_ACCT_5530_PDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String fisc_yymm;
	public String dlco_clsf_cd;

	public FC_ACCT_5530_PDM(){}
	public FC_ACCT_5530_PDM(String cmpy_cd, String fisc_yymm, String dlco_clsf_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_5530_P(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_5530_PDM dm = (FC_ACCT_5530_PDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_5530_PDataSet();
	}
