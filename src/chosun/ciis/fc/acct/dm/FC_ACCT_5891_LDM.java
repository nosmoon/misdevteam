...
public class FC_ACCT_5891_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_5891_LDM(){}
	public FC_ACCT_5891_LDM(String cmpy_cd, String clsf_cd, String fisc_ym_fr, String fisc_ym_to, String acct_cd_fr, String acct_cd_to){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_5891_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_5891_LDM dm = (FC_ACCT_5891_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_5891_LDataSet();
	}
