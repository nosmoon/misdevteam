...
public class FC_ACCT_2125_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2125_SDM(){}
	public FC_ACCT_2125_SDM(String cmpy_cd, String rcpm_slip_occr_dt, String rcpm_slip_clsf_cd, String rcpm_slip_seq, String slip_occr_dt, String slip_seq){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2125_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2125_SDM dm = (FC_ACCT_2125_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2125_SDataSet();
	}
