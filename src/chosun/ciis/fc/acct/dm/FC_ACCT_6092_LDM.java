...
public class FC_ACCT_6092_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_6092_LDM(){}
	public FC_ACCT_6092_LDM(String cmpy_cd, String make_dt_fr, String make_dt_to, String prof_type_cd, String slip_clsf_cd_fr, String slip_clsf_cd_to, String ern, String erplace_cd, String suply_amt_fr, String suply_amt_to, String vat_amt_fr, String vat_amt_to, String elec_tax_bill_yn, String acct_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_6092_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_6092_LDM dm = (FC_ACCT_6092_LDM)bdm;
		...
		cstmt.setString(7, dm.slip_clsf_cd_fr);
		cstmt.setString(8, dm.slip_clsf_cd_to);
		cstmt.setString(9, dm.ern);
		cstmt.setString(10, dm.erplace_cd);
		cstmt.setString(11, dm.suply_amt_fr);
		cstmt.setString(12, dm.suply_amt_to);
		cstmt.setString(13, dm.vat_amt_fr);
		cstmt.setString(14, dm.vat_amt_to);
		cstmt.setString(15, dm.elec_tax_bill_yn);
		cstmt.setString(16, dm.acct_cd);
		cstmt.registerOutParameter(17, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_6092_LDataSet();
	}
