...
public class FC_ACCT_6013_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String prof_type_cd_in;
	...
	public void setProf_type_cd_in(String prof_type_cd_in){
		this.prof_type_cd_in = prof_type_cd_in;
	}
	...
	public String getProf_type_cd_in(){
		return this.prof_type_cd_in;
	}
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_6013_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_6013_ADM dm = (FC_ACCT_6013_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.prof_type_cd_in);
		cstmt.setString(5, dm.slip_clsf_cd_in);
		cstmt.setString(6, dm.slip_occr_dt_in);
		cstmt.setString(7, dm.slip_seq_in);
		cstmt.setString(8, dm.prof_type_cd);
		cstmt.setString(9, dm.occr_slip_occr_dt);
		cstmt.setString(10, dm.occr_slip_clsf_cd);
		cstmt.setString(11, dm.occr_slip_seq);
		cstmt.setString(12, dm.occr_slip_sub_seq);
		cstmt.setString(13, dm.occr_slip_arow_no);
		cstmt.setString(14, dm.make_dt);
		cstmt.setString(15, dm.erplace_cd);
		cstmt.setString(16, dm.dlco_clsf_cd);
		cstmt.setString(17, dm.dlco_cd);
		cstmt.setString(18, dm.deal_clsf);
		cstmt.setString(19, dm.ern);
		cstmt.setString(20, dm.dlco_nm);
		...
		cstmt.setString(27, dm.tax_stmt_aprv_yn);
		cstmt.setString(28, dm.decl_yn);
		cstmt.setString(29, dm.decl_qq);
		cstmt.setString(30, dm.make_upd_dt);
		cstmt.setString(31, dm.upd_tms);
		cstmt.setString(32, dm.last_upd_dd);
		cstmt.setString(33, dm.issu_pers_emp_no);
		cstmt.setString(34, dm.issu_tms);
		cstmt.setString(35, dm.incmg_dt_tm);
		cstmt.setString(36, dm.incmg_pers);
		cstmt.setString(37, dm.incmg_pers_ipadd);
		cstmt.setString(38, dm.canc_yn);
		cstmt.setString(39, dm.canc_dt);
		cstmt.setString(40, dm.del_resn);
		cstmt.setString(41, dm.mode);
		cstmt.setString(42, dm.slip_arow_no);
		cstmt.setString(43, dm.mmdd);
		cstmt.setString(44, dm.item1);
		cstmt.setString(45, dm.std);
		cstmt.setString(46, dm.qunt);
		cstmt.setString(47, dm.uprc);
		cstmt.setString(48, dm.suply_amt1);
		cstmt.setString(49, dm.vat_amt1);
		cstmt.setString(50, dm.semuro_no);
		cstmt.setString(51, dm.elec_tax_comp_cd);
		cstmt.setString(52, dm.email_id);
		cstmt.setString(53, dm.budg_cd);
		cstmt.setString(54, dm.biz_plc_cd);
		cstmt.setString(55, dm.remk1);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_6013_ADataSet();
	}
	...
	public void print(){
		...
		System.out.println("prof_type_cd_in = [" + getProf_type_cd_in() + "]");
...
String prof_type_cd_in = req.getParameter("prof_type_cd_in");
if( prof_type_cd_in == null){
	System.out.println(this.toString+" : prof_type_cd_in is null" );
}else{
	System.out.println(this.toString+" : prof_type_cd_in is "+prof_type_cd_in );
}
...
String prof_type_cd_in = Util.checkString(req.getParameter("prof_type_cd_in"));
...
String prof_type_cd_in = Util.Uni2Ksc(Util.checkString(req.getParameter("prof_type_cd_in")));
...
dm.setProf_type_cd_in(prof_type_cd_in);
...
/* 작성시간 : Thu May 03 14:35:38 KST 2018 */