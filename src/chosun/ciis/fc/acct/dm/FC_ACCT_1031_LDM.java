...
public class FC_ACCT_1031_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_1031_LDM(){}
	public FC_ACCT_1031_LDM(String cmpy_cd, String acct_cd, String use_dt, String kind){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_1031_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_1031_LDM dm = (FC_ACCT_1031_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_1031_LDataSet();
	}
