...
public class FC_ACCT_3043_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_3043_IDM(){}
	public FC_ACCT_3043_IDM(String cmpy_cd, String stlm_dt, String rmks, String incmg_pers, String incmg_pers_ipadd, String prelae_pay_clsf_cd, String mang_clsf_cd, String mang_no, String comp_dt, String mtry_dt, String won_amt, String dds, String pymt_dt, String prvmm_bal, String thmm_dr, String thmm_crdt, String thmm_bal, String clam_dept_cd, String incmg_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_3043_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_3043_IDM dm = (FC_ACCT_3043_IDM)bdm;
		...
		cstmt.setString(13, dm.won_amt);
		cstmt.setString(14, dm.dds);
		cstmt.setString(15, dm.pymt_dt);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_3043_IDataSet();
	}
...
/* 작성시간 : Tue Feb 10 20:51:20 KST 2009 */