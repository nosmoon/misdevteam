...
public class FC_ACCT_3013_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_3013_IDM(){}
	public FC_ACCT_3013_IDM(String cmpy_cd, String stlm_dt, String rmks, String incmg_pers, String incmg_pers_ipadd, String prelae_pay_clsf_cd, String mang_clsf_cd, String mang_no, String comp_dt, String mtry_dt, String pymt_amt, String int_rate, String prvmm_bal, String thmm_dr, String thmm_crdt, String thmm_bal, String clam_dept_cd, String incmg_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_3013_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_3013_IDM dm = (FC_ACCT_3013_IDM)bdm;
		...
		cstmt.setString(13, dm.pymt_amt);
		cstmt.setString(14, dm.int_rate);
		cstmt.setString(15, dm.prvmm_bal);
		cstmt.setString(16, dm.thmm_dr);
		cstmt.setString(17, dm.thmm_crdt);
		cstmt.setString(18, dm.thmm_bal);
		cstmt.setString(19, dm.clam_dept_cd);
		cstmt.setString(20, dm.incmg_dt);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_3013_IDataSet();
	}
