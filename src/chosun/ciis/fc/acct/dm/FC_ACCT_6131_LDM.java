...
public class FC_ACCT_6131_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String vat_decl_yymm;
	public String erplace_cd;

	public FC_ACCT_6131_LDM(){}
	public FC_ACCT_6131_LDM(String cmpy_cd, String vat_decl_yymm, String erplace_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_6131_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_6131_LDM dm = (FC_ACCT_6131_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_6131_LDataSet();
	}
