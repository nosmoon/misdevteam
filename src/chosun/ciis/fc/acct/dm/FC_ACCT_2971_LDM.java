...
public class FC_ACCT_2971_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2971_LDM(){}
	public FC_ACCT_2971_LDM(String cmpy_cd, String uid, String dlco_cd, String clsf, String frdt, String todt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2971_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2971_LDM dm = (FC_ACCT_2971_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2971_LDataSet();
	}
