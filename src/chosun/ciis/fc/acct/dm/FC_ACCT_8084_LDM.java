...
public class FC_ACCT_8084_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_8084_LDM(){}
	public FC_ACCT_8084_LDM(String cmpy_cd, String inwoncnt, String totcnt, String totamt, String sdtotamt, String sdstotamt, String jmstotamt, String wctotamt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_8084_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_8084_LDM dm = (FC_ACCT_8084_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_8084_LDataSet();
	}
