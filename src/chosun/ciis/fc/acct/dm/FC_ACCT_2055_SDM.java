...
public class FC_ACCT_2055_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2055_SDM(){}
	public FC_ACCT_2055_SDM(String cmpy_cd, String slip_occr_dt, String slip_clsf_cd, String slip_seq_fr, String slip_seq_to){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2055_S(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2055_SDM dm = (FC_ACCT_2055_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2055_SDataSet();
	}
