...
public class FC_ACCT_3073_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_3073_IDM(){}
	public FC_ACCT_3073_IDM(String cmpy_cd, String stlm_dt, String rmks, String incmg_pers, String incmg_pers_ipadd, String prelae_pay_clsf_cd, String mang_clsf_cd, String mang_no, String comp_dt, String mtry_dt, String tot_pymt_amt, String dds, String int_rate, String prvmm_bal, String thmm_dr, String thmm_crdt, String thmm_bal, String clam_dept_cd, String incmg_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_3073_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_3073_IDM dm = (FC_ACCT_3073_IDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_3073_IDataSet();
	}
