...
public class FC_ACCT_2133_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2133_UDM(){}
	public FC_ACCT_2133_UDM(String cmpy_cd, String prof_type_cd, String slip_clsf_cd, String slip_occr_dt, String slip_seq, String make_dt, String erplace_cd, String dlco_clsf_cd, String dlco_cd, String deal_clsf, String ern, String dlco_nm, String presi_nm, String addr, String bizcond, String item, String evnt_cd, String suply_amt, String vat_amt, String tax_stmt_aprv_yn, String make_upd_dt, String upd_tms, String last_upd_dt, String rcpt_nosh, String budg_cd, String ask_emp_no, String ask_dept_cd, String rcpm_plan_dt, String item2, String slip_rcpm_dt, String rcpm_sub_seq, String budg_cd2, String rcpm_amt, String rcpm_dt, String deps_psbk, String coms, String rcpm_pers_nm, String gtieeno, String gtibankcd, String medi_cd, String chg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2133_U(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2133_UDM dm = (FC_ACCT_2133_UDM)bdm;
		...
		cstmt.setString(12, dm.deal_clsf);
		cstmt.setString(13, dm.ern);
		...
		cstmt.setString(19, dm.evnt_cd);
		cstmt.setString(20, dm.suply_amt);
		cstmt.setString(21, dm.vat_amt);
		cstmt.setString(22, dm.tax_stmt_aprv_yn);
		cstmt.setString(23, dm.make_upd_dt);
		cstmt.setString(24, dm.upd_tms);
		cstmt.setString(25, dm.last_upd_dt);
		cstmt.setString(26, dm.rcpt_nosh);
		cstmt.setString(27, dm.budg_cd);
		cstmt.setString(28, dm.ask_emp_no);
		cstmt.setString(29, dm.ask_dept_cd);
		cstmt.setString(30, dm.rcpm_plan_dt);
		cstmt.setString(31, dm.item2);
		cstmt.setString(32, dm.slip_rcpm_dt);
		cstmt.setString(33, dm.rcpm_sub_seq);
		cstmt.setString(34, dm.budg_cd2);
		cstmt.setString(35, dm.rcpm_amt);
		cstmt.setString(36, dm.rcpm_dt);
		cstmt.setString(37, dm.deps_psbk);
		cstmt.setString(38, dm.coms);
		cstmt.setString(39, dm.rcpm_pers_nm);
		cstmt.setString(40, dm.gtieeno);
		cstmt.setString(41, dm.gtibankcd);
		cstmt.setString(42, dm.medi_cd);
		cstmt.setString(43, dm.chg_pers);
		cstmt.setString(44, dm.incmg_pers_ipadd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2133_UDataSet();
	}
	...
	public void print(){
		...
		System.out.println("last_upd_dt = [" + getLast_upd_dt() + "]");
...
String last_upd_dt = req.getParameter("last_upd_dt");
if( last_upd_dt == null){
	System.out.println(this.toString+" : last_upd_dt is null" );
}else{
	System.out.println(this.toString+" : last_upd_dt is "+last_upd_dt );
}
...
String last_upd_dt = Util.checkString(req.getParameter("last_upd_dt"));
...
String last_upd_dt = Util.Uni2Ksc(Util.checkString(req.getParameter("last_upd_dt")));
...
/* 작성시간 : Tue Jun 09 17:39:31 KST 2009 */