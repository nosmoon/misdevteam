...
public class FC_ACCT_1061_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_1061_LDM(){}
	public FC_ACCT_1061_LDM(String cmpy_cd, String job_clsf, String cd_clsf, String cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_1061_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_1061_LDM dm = (FC_ACCT_1061_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_1061_LDataSet();
	}
