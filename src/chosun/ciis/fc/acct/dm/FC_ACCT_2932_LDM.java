...
public class FC_ACCT_2932_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String rmtt_dwload_dt;

	public FC_ACCT_2932_LDM(){}
	public FC_ACCT_2932_LDM(String cmpy_cd, String rmtt_dwload_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2932_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2932_LDM dm = (FC_ACCT_2932_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.rmtt_dwload_dt);
		cstmt.registerOutParameter(5, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2932_LDataSet();
	}
