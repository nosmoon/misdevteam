...
public class FC_ACCT_1112_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String busn_yymm;

	public FC_ACCT_1112_LDM(){}
	public FC_ACCT_1112_LDM(String cmpy_cd, String busn_yymm){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_1112_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_1112_LDM dm = (FC_ACCT_1112_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_1112_LDataSet();
	}
