...
public class FC_ACCT_2372_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2372_LDM(){}
	public FC_ACCT_2372_LDM(String cmpy_cd, String slip_occr_dt, String slip_clsf_cd, String slip_seq_fr, String slip_seq_to, String slip_aprv_yn){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2372_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2372_LDM dm = (FC_ACCT_2372_LDM)bdm;
		...
		cstmt.setString(8, dm.slip_aprv_yn);
		cstmt.registerOutParameter(9, OracleTypes.CURSOR);
		cstmt.registerOutParameter(10, Types.VARCHAR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2372_LDataSet();
	}
