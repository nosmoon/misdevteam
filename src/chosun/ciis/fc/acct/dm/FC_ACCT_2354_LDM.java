...
public class FC_ACCT_2354_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2354_LDM(){}
	public FC_ACCT_2354_LDM(String cmpy_cd, String slip_occr_dt, String slip_clsf_cd, String frslip_seq, String toslip_seq){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2354_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2354_LDM dm = (FC_ACCT_2354_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2354_LDataSet();
	}
