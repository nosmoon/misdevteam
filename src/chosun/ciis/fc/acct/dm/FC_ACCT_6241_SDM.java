...
public class FC_ACCT_6241_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_6241_SDM(){}
	public FC_ACCT_6241_SDM(String cmpy_cd, String erplace_cd, String vat_fr_yymm, String vat_to_yymm, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_6241_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_6241_SDM dm = (FC_ACCT_6241_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_6241_SDataSet();
	}
