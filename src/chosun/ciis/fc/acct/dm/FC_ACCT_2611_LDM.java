...
public class FC_ACCT_2611_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2611_LDM(){}
	public FC_ACCT_2611_LDM(String cmpy_cd, String fr_dt, String to_dt, String fr_budg_cd, String to_budg_cd, String dlco_cmpy_cd, String dlco_clsf_cd, String slip_clsf_cd, String budg_clsf_cd, String cnfm_clsf_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2611_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2611_LDM dm = (FC_ACCT_2611_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2611_LDataSet();
	}
