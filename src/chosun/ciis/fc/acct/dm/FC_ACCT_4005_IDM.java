...
public class FC_ACCT_4005_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_4005_IDM(){}
	public FC_ACCT_4005_IDM(String cmpy_cd, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String slip_sub_seq, String slip_arow_no, String occr_amt, String fisc_dt, String incmg_emp_no, String incmg_pers, String incmg_pers_ipadd, String in_sicsgb){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_4005_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_4005_IDM dm = (FC_ACCT_4005_IDM)bdm;
		...
		cstmt.setString(10, dm.occr_amt);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_4005_IDataSet();
	}
...
/* 작성시간 : Tue Jul 14 17:35:00 KST 2009 */