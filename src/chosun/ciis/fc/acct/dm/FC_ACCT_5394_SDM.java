...
public class FC_ACCT_5394_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_5394_SDM(){}
	public FC_ACCT_5394_SDM(String cmpy_cd, String from_fisc_dt, String to_fisc_dt, String from_acct_cd, String to_acct_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_5394_S(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_5394_SDM dm = (FC_ACCT_5394_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_5394_SDataSet();
	}
