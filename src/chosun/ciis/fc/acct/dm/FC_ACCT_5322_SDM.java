...
public class FC_ACCT_5322_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String fisc_yymm;

	public FC_ACCT_5322_SDM(){}
	public FC_ACCT_5322_SDM(String cmpy_cd, String fisc_yymm){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_5322_S(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_5322_SDM dm = (FC_ACCT_5322_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_5322_SDataSet();
	}
