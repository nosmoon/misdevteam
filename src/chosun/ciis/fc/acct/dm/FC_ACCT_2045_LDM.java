...
public class FC_ACCT_2045_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String occr_dt_from;
	public String occr_dt_to;
	public String occr_acct_cd;
	public String occr_clsf_dt;
	public String dept_cd;
	public String combo1;
	public String combo2;

	public FC_ACCT_2045_LDM(){}
	public FC_ACCT_2045_LDM(String cmpy_cd, String occr_dt_from, String occr_dt_to, String occr_acct_cd, String occr_clsf_dt, String dept_cd, String combo1, String combo2){
		this.cmpy_cd = cmpy_cd;
		this.occr_dt_from = occr_dt_from;
		this.occr_dt_to = occr_dt_to;
		this.occr_acct_cd = occr_acct_cd;
		this.occr_clsf_dt = occr_clsf_dt;
	...
	public void setOccr_clsf_dt(String occr_clsf_dt){
		this.occr_clsf_dt = occr_clsf_dt;
	}
	...
	public String getOccr_clsf_dt(){
		return this.occr_clsf_dt;
	}
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2045_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2045_LDM dm = (FC_ACCT_2045_LDM)bdm;
		...
		cstmt.setString(7, dm.occr_clsf_dt);
		cstmt.setString(8, dm.dept_cd);
		cstmt.setString(9, dm.combo1);
		cstmt.setString(10, dm.combo2);
		cstmt.registerOutParameter(11, OracleTypes.CURSOR);
		cstmt.registerOutParameter(12, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2045_LDataSet();
	}
	...
	public void print(){
		...
		System.out.println("occr_clsf_dt = [" + getOccr_clsf_dt() + "]");
...
String occr_clsf_dt = req.getParameter("occr_clsf_dt");
if( occr_clsf_dt == null){
	System.out.println(this.toString+" : occr_clsf_dt is null" );
}else{
	System.out.println(this.toString+" : occr_clsf_dt is "+occr_clsf_dt );
}
...
String occr_clsf_dt = Util.checkString(req.getParameter("occr_clsf_dt"));
...
String occr_clsf_dt = Util.Uni2Ksc(Util.checkString(req.getParameter("occr_clsf_dt")));
...
dm.setOccr_clsf_dt(occr_clsf_dt);
