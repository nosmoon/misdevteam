...
public class FC_ACCT_7004_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String card_mang_no;

	public FC_ACCT_7004_DDM(){}
	public FC_ACCT_7004_DDM(String cmpy_cd, String card_mang_no){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_7004_D(? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_7004_DDM dm = (FC_ACCT_7004_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_7004_DDataSet();
	}
