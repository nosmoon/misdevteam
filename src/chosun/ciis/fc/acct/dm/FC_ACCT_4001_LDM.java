...
public class FC_ACCT_4001_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_4001_LDM(){}
	public FC_ACCT_4001_LDM(String cmpy_cd, String occr_acct_cd, String from_fisc_dt, String to_fisc_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_4001_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_4001_LDM dm = (FC_ACCT_4001_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_4001_LDataSet();
	}
