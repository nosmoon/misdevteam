...
public class FC_ACCT_1026_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_1026_UDM(){}
	public FC_ACCT_1026_UDM(String cmpy_cd, String acct_type_cd, String acct_cd, String flag, String chg_pers){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_1026_U(? ,? ,? ,? ,? ,?, ?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_1026_UDM dm = (FC_ACCT_1026_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_1026_UDataSet();
	}
...
/* 작성시간 : Mon Jun 16 11:26:05 KST 2014 */