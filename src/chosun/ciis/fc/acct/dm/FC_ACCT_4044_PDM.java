...
public class FC_ACCT_4044_PDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String stat_dt;

	public FC_ACCT_4044_PDM(){}
	public FC_ACCT_4044_PDM(String cmpy_cd, String stat_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_4044_P(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_4044_PDM dm = (FC_ACCT_4044_PDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_4044_PDataSet();
	}
