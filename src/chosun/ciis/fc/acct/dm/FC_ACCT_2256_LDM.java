...
public class FC_ACCT_2256_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2256_LDM(){}
	public FC_ACCT_2256_LDM(String cmpy_cd, String slip_occr_dt, String slip_seq, String slip_sub_seq, String fisc_dt_fr, String fisc_dt_to, String incmg_dt_fr, String incmg_dt_to, String slip_clsf_cd, String incmg_emp_no, String clam_dept_cd, String slip_aprv_yn){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2256_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2256_LDM dm = (FC_ACCT_2256_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2256_LDataSet();
	}
...
/* 작성시간 : Thu May 29 14:49:20 KST 2014 */