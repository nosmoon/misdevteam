...
public class FC_ACCT_2203_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2203_SDM(){}
	public FC_ACCT_2203_SDM(String cmpy_cd, String uid, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String slip_sub_seq, String budg_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2203_S(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2203_SDM dm = (FC_ACCT_2203_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2203_SDataSet();
	}
...
/* 작성시간 : Tue Jul 07 15:28:26 KST 2009 */