...
public class FC_ACCT_8082_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_8082_LDM(){}
	public FC_ACCT_8082_LDM(String cmpy_cd, String from_fisc_dt, String to_fisc_dt, String erplace_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_8082_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_8082_LDM dm = (FC_ACCT_8082_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_8082_LDataSet();
	}
