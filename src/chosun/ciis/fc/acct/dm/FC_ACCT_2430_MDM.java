...
public class FC_ACCT_2430_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String clam_dept_cd;

	public FC_ACCT_2430_MDM(){}
	public FC_ACCT_2430_MDM(String cmpy_cd, String clam_dept_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2430_M(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2430_MDM dm = (FC_ACCT_2430_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2430_MDataSet();
	}
