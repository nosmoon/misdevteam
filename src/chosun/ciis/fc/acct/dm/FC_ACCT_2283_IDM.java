...
public class FC_ACCT_2283_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2283_IDM(){}
	public FC_ACCT_2283_IDM(String cmpy_cd, String slip_occr_dt, String slip_clsf_cd, String fisc_dt, String rmks1, String work_flag, String incmg_pers, String incmg_pers_ipadd, String grid1_mode, String grid1_rownum, String grid1_drcr_clsf_cd, String grid1_budg_cd, String grid1_mang_clsf_cd, String grid1_dr_amt, String grid1_crdt_amt, String grid1_rmks2, String grid1_dlco_clsf_cd, String grid1_dlco_cd, String grid1_dlco_nm, String grid1_boks_dlco_nm){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2283_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2283_IDM dm = (FC_ACCT_2283_IDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2283_IDataSet();
	}
