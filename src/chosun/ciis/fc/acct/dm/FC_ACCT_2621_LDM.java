...
public class FC_ACCT_2621_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2621_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2621_LDM dm = (FC_ACCT_2621_LDM)bdm;
		...
		cstmt.setString(7, dm.fr_budg_cd1);
		cstmt.setString(8, dm.to_budg_cd1);
		cstmt.setString(9, dm.slip_clsf_cd1);
		cstmt.setString(10, dm.budg_clsf_cd1);
		cstmt.setString(11, dm.conn_clsf_cd1);
		cstmt.setString(12, dm.conn_cmpy_cd2);
		cstmt.setString(13, dm.fr_budg_cd2);
		cstmt.setString(14, dm.to_budg_cd2);
		cstmt.setString(15, dm.slip_clsf_cd2);
		cstmt.setString(16, dm.budg_clsf_cd2);
		cstmt.setString(17, dm.conn_clsf_cd2);
		cstmt.registerOutParameter(18, OracleTypes.CURSOR);
		cstmt.registerOutParameter(19, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2621_LDataSet();
	}
...
/* 작성시간 : Thu Dec 18 16:45:59 KST 2014 */