...
public class FC_ACCT_8064_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String submit_dt;

	public FC_ACCT_8064_LDM(){}
	public FC_ACCT_8064_LDM(String cmpy_cd, String submit_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_8064_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_8064_LDM dm = (FC_ACCT_8064_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_8064_LDataSet();
	}
