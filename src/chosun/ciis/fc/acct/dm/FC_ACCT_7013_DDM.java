...
public class FC_ACCT_7013_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_7013_DDM(){}
	public FC_ACCT_7013_DDM(String cmpy_cd, String fisc_fr, String fisc_to, String acct_cd1, String acct_cd2, String acct_cd3, String acct_cd4, String acct_cd5, String acct_cd6, String acct_cd7, String acct_cd8, String acct_cd9, String acct_cd10, String acct_cd11, String acct_cd12){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_7013_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_7013_DDM dm = (FC_ACCT_7013_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_7013_DDataSet();
	}
...
/* 작성시간 : Fri Feb 06 15:13:21 KST 2009 */