...
public class FC_ACCT_3254_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_3254_U(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_3254_UDM dm = (FC_ACCT_3254_UDM)bdm;
		...
		cstmt.setString(36, dm.etc_in);
		cstmt.setString(37, dm.tax_stmt_no);
		cstmt.setString(38, dm.make_dt);
		cstmt.setString(39, dm.erplace_cd);
		cstmt.setString(40, dm.ern);
		cstmt.setString(41, dm.suply_amt);
		cstmt.setString(42, dm.vat_amt);
		cstmt.setString(43, dm.email_id);
		cstmt.setString(44, dm.remk);
		cstmt.setString(45, dm.item);
		cstmt.setString(46, dm.re_issu_resn_cd);
		cstmt.setString(47, dm.setoff_slip_occr_dt);
		cstmt.setString(48, dm.setoff_slip_clsf_cd);
		cstmt.setString(49, dm.setoff_slip_seq);
		cstmt.setString(50, dm.setoff_slip_sub_seq);
		cstmt.setString(51, dm.setoff_slip_arow_no);
		cstmt.setString(52, dm.obj_acct_cd);
		cstmt.setString(53, dm.obj_dt);
		cstmt.setString(54, dm.obj_amt);
		cstmt.setString(55, dm.frcr_clsf_cd);
		cstmt.setString(56, dm.frcr_amt);
		cstmt.setString(57, dm.exrate);
		cstmt.setString(58, dm.note_stat);
		cstmt.setString(59, dm.rmks1);
		cstmt.setString(60, dm.rmks2);
		cstmt.setString(61, dm.incmg_dt);
		cstmt.setString(62, dm.occr_slip_clsf);
		cstmt.setString(63, dm.occr_slip);
		cstmt.setString(64, dm.reso_amt);
		cstmt.setString(65, dm.reso_amt_ch);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_3254_UDataSet();
	}
...
/* 작성시간 : Thu Sep 03 16:43:20 KST 2015 */