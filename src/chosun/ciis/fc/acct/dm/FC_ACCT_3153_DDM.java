...
public class FC_ACCT_3153_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_3153_DDM(){}
	public FC_ACCT_3153_DDM(String cmpy_cd, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String fisc_dt, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_3153_D(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_3153_DDM dm = (FC_ACCT_3153_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_3153_DDataSet();
	}
