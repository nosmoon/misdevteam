...
public class FC_ACCT_2111_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2111_LDM(){}
	public FC_ACCT_2111_LDM(String cmpy_cd, String yymm, String supr_dept_cd, String dept_cd, String sply_basi_cd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2111_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2111_LDM dm = (FC_ACCT_2111_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2111_LDataSet();
	}
