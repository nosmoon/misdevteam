...
public class FC_ACCT_1052_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_1052_ADM(){}
	public FC_ACCT_1052_ADM(String cmpy_cd, String incmg_pers, String incmg_pers_ip, String mode, String cd, String cdnm, String remk, String cd_abrv_nm, String mang_cd_1, String mang_cd_2, String use_yn, String mang_cd_3){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_1052_A(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_1052_ADM dm = (FC_ACCT_1052_ADM)bdm;
		...
		cstmt.setString(12, dm.mang_cd_2);
		cstmt.setString(13, dm.use_yn);
		cstmt.setString(14, dm.mang_cd_3);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_1052_ADataSet();
	}
...
/* 작성시간 : Mon Mar 02 10:40:54 KST 2009 */