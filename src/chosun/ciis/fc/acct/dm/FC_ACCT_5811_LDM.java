...
public class FC_ACCT_5811_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_5811_LDM(){}
	public FC_ACCT_5811_LDM(String cmpy_cd, String frbudg_cd, String tobudg_cd, String frfisc_dt, String tofisc_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_5811_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_5811_LDM dm = (FC_ACCT_5811_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_5811_LDataSet();
	}
