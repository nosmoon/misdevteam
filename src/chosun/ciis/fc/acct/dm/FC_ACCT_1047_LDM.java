...
public class FC_ACCT_1047_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String insd_acct_cd;

	public FC_ACCT_1047_LDM(){}
	public FC_ACCT_1047_LDM(String cmpy_cd, String insd_acct_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_1047_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_1047_LDM dm = (FC_ACCT_1047_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_1047_LDataSet();
	}
