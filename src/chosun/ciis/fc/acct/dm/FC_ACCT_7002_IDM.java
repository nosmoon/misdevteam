...
public class FC_ACCT_7002_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_7002_IDM(){}
	public FC_ACCT_7002_IDM(String cmpy_cd, String card_mang_no, String card_no, String bcusesabeon, String issu_dt, String mtry_dt, String decid_dd, String wste_dt, String dlco_cd, String decid_bank_cd, String memb_dnmn, String emp_no, String incmg_pers_ipadd, String use_yn, String corp_card_clsf, String pch_ynm, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_7002_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_7002_IDM dm = (FC_ACCT_7002_IDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_7002_IDataSet();
	}
