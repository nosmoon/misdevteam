...
public class FC_ACCT_4010_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String from_fisc_dt;
	public String to_fisc_dt;

	public FC_ACCT_4010_LDM(){}
	public FC_ACCT_4010_LDM(String cmpy_cd, String from_fisc_dt, String to_fisc_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_4010_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_4010_LDM dm = (FC_ACCT_4010_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_4010_LDataSet();
	}
