...
public class FC_ACCT_2114_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2114_ADM(){}
	public FC_ACCT_2114_ADM(String cmpy_cd, String yymm, String credel_clsf, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2114_A(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2114_ADM dm = (FC_ACCT_2114_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2114_ADataSet();
	}
...
/* 작성시간 : Thu May 23 15:32:50 KST 2013 */