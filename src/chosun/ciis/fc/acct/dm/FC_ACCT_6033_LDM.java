...
public class FC_ACCT_6033_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String erplace_cd;

	public FC_ACCT_6033_LDM(){}
	public FC_ACCT_6033_LDM(String cmpy_cd, String erplace_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_6033_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_6033_LDM dm = (FC_ACCT_6033_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_6033_LDataSet();
	}
