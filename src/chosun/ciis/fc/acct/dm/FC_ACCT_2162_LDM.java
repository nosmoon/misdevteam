...
public class FC_ACCT_2162_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String incmg_dt;
	public String impt_dept;

	public FC_ACCT_2162_LDM(){}
	public FC_ACCT_2162_LDM(String cmpy_cd, String incmg_dt, String impt_dept){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2162_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2162_LDM dm = (FC_ACCT_2162_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2162_LDataSet();
	}
