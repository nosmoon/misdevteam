...
public class FC_ACCT_2014_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2014_SDM(){}
	public FC_ACCT_2014_SDM(String cmpy_cd, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String draft_doc_no, String draft_dept_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2014_S(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2014_SDM dm = (FC_ACCT_2014_SDM)bdm;
		...
		cstmt.setString(7, dm.draft_doc_no);
		cstmt.setString(8, dm.draft_dept_cd);
		cstmt.registerOutParameter(9, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2014_SDataSet();
	}
