...
public class FC_ACCT_6034_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_6034_LDM(){}
	public FC_ACCT_6034_LDM(String cmpy_cd, String erplace_cd, String fr_slip_occr_dt, String to_slip_occr_dt, String std_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_6034_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_6034_LDM dm = (FC_ACCT_6034_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_6034_LDataSet();
	}
