...
public class FC_ACCT_2194_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2194_SDM(){}
	public FC_ACCT_2194_SDM(String cmpy_cd, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String slip_sub_seq, String slip_occr_dt2, String budg_cd, String budg_cd1, String budg_cd2, String budg_cd3, String budg_cd4, String budg_cd5){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2194_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2194_SDM dm = (FC_ACCT_2194_SDM)bdm;
		...
		cstmt.setString(8, dm.slip_occr_dt2);
		cstmt.setString(9, dm.budg_cd);
		cstmt.setString(10, dm.budg_cd1);
		cstmt.setString(11, dm.budg_cd2);
		cstmt.setString(12, dm.budg_cd3);
		cstmt.setString(13, dm.budg_cd4);
		cstmt.setString(14, dm.budg_cd5);
		cstmt.registerOutParameter(15, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2194_SDataSet();
	}
