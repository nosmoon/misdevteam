...
public class FC_ACCT_2284_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2284_DDM(){}
	public FC_ACCT_2284_DDM(String cmpy_cd, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String work_flag, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2284_D(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2284_DDM dm = (FC_ACCT_2284_DDM)bdm;
		...
		cstmt.setString(7, dm.work_flag);
		cstmt.setString(8, dm.incmg_pers);
		cstmt.setString(9, dm.incmg_pers_ipadd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2284_DDataSet();
	}
