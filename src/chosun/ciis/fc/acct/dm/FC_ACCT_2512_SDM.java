...
public class FC_ACCT_2512_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String acct_cd;

	public FC_ACCT_2512_SDM(){}
	public FC_ACCT_2512_SDM(String cmpy_cd, String acct_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2512_S(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2512_SDM dm = (FC_ACCT_2512_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2512_SDataSet();
	}
