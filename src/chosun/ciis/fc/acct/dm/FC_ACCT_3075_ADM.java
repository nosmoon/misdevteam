...
public class FC_ACCT_3075_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String stlm_dt;

	public FC_ACCT_3075_ADM(){}
	public FC_ACCT_3075_ADM(String cmpy_cd, String stlm_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_3075_A(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_3075_ADM dm = (FC_ACCT_3075_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_3075_ADataSet();
	}
