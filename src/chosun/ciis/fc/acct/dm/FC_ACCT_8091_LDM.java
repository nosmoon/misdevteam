...
public class FC_ACCT_8091_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_8091_LDM(){}
	public FC_ACCT_8091_LDM(String cmpy_cd, String from_fisc_dt, String to_fisc_dt, String dlco_clsf_cd, String dlco_cd, String incm_clsf_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_8091_L(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_8091_LDM dm = (FC_ACCT_8091_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_8091_LDataSet();
	}
