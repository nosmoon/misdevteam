...
public class FC_ACCT_1113_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String busn_yymm;

	public FC_ACCT_1113_DDM(){}
	public FC_ACCT_1113_DDM(String cmpy_cd, String busn_yymm){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_1113_D(? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_1113_DDM dm = (FC_ACCT_1113_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_1113_DDataSet();
	}
