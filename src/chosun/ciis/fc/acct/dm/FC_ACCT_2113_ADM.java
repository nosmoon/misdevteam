...
public class FC_ACCT_2113_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2113_ADM(){}
	public FC_ACCT_2113_ADM(String cmpy_cd, String mode, String emp_no, String sply_basi_cd, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2113_A(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2113_ADM dm = (FC_ACCT_2113_ADM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.mode);
		cstmt.setString(5, dm.emp_no);
		cstmt.setString(6, dm.sply_basi_cd);
		cstmt.setString(7, dm.incmg_pers);
		cstmt.setString(8, dm.incmg_pers_ipadd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2113_ADataSet();
	}
...
/* 작성시간 : Wed May 22 20:49:35 KST 2013 */