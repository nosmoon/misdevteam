...
public class FC_ACCT_4004_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_4004_DDM(){}
	public FC_ACCT_4004_DDM(String cmpy_cd, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String slip_sub_seq, String slip_arow_no, String in_sicsgb, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_4004_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_4004_DDM dm = (FC_ACCT_4004_DDM)bdm;
		...
		cstmt.setString(9, dm.in_sicsgb);
		cstmt.setString(10, dm.incmg_pers);
		cstmt.setString(11, dm.incmg_pers_ipadd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_4004_DDataSet();
	}
...
/* 작성시간 : Tue Mar 24 09:50:27 KST 2009 */