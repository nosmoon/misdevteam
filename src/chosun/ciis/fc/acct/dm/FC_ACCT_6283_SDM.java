...
public class FC_ACCT_6283_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_6283_SDM(){}
	public FC_ACCT_6283_SDM(String cmpy_cd, String decl_unit_clsf_cd, String erplace_cd, String rpt_make_dt, String vat_fr_yymm, String vat_to_yymm, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_6283_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_6283_SDM dm = (FC_ACCT_6283_SDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.decl_unit_clsf_cd);
		cstmt.setString(5, dm.erplace_cd);
		cstmt.setString(6, dm.rpt_make_dt);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_6283_SDataSet();
	}
	...
	public void print(){
		...
		System.out.println("rpt_make_dt = [" + getRpt_make_dt() + "]");
...
String rpt_make_dt = req.getParameter("rpt_make_dt");
if( rpt_make_dt == null){
	System.out.println(this.toString+" : rpt_make_dt is null" );
}else{
	System.out.println(this.toString+" : rpt_make_dt is "+rpt_make_dt );
}
...
String rpt_make_dt = Util.checkString(req.getParameter("rpt_make_dt"));
...
String rpt_make_dt = Util.Uni2Ksc(Util.checkString(req.getParameter("rpt_make_dt")));
