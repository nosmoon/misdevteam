...
public class FC_ACCT_5412_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_5412_SDM(){}
	public FC_ACCT_5412_SDM(String cmpy_cd, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String slip_sub_seq){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_5412_S(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_5412_SDM dm = (FC_ACCT_5412_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_5412_SDataSet();
	}
