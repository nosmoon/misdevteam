...
public class FC_ACCT_2510_MDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String incmg_pers;
	public String acct_cd;

	public FC_ACCT_2510_MDM(){}
	public FC_ACCT_2510_MDM(String cmpy_cd, String incmg_pers, String acct_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2510_M(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2510_MDM dm = (FC_ACCT_2510_MDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2510_MDataSet();
	}
