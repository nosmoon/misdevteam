...
public class FC_ACCT_1048_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String pch_gwhmnm;
	public String mang_item_nm;
	public String prty_rank2;

	public FC_ACCT_1048_UDM(){}
	public FC_ACCT_1048_UDM(String mode, String cmpy_cd, String acct_cd, String acct_subj_nm, String acct_abrv_nm, String slip_incmg_exne, String drcr_occr_clsf, String drcr_bal_clsf, String tbs_exne, String balsht_exne, String pfls_stat_exne, String setoff_yn, String supr_acct_cd, String vip_aset_debt_exne, String acct_levl, String use_yn, String use_dt, String wste_dt, String incmg_pers, String incmg_pers_ipadd, String acct_nm_styl, String insd_acct_cd, String chg_dt, String drcr_clsf, String mand_reg_yn, String bal_mang_clsf, String prty_rank, String mang_item_cd, String pch_gwhmnm, String mang_item_nm, String prty_rank2){
		this.mode = mode;
	...
	public void setPch_gwhmnm(String pch_gwhmnm){
		this.pch_gwhmnm = pch_gwhmnm;
	}
	...
	public String getPch_gwhmnm(){
		return this.pch_gwhmnm;
	}
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_1048_U(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_1048_UDM dm = (FC_ACCT_1048_UDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.mode);
		cstmt.setString(4, dm.cmpy_cd);
		cstmt.setString(5, dm.acct_cd);
		cstmt.setString(6, dm.acct_subj_nm);
		cstmt.setString(7, dm.acct_abrv_nm);
		...
		cstmt.setString(24, dm.insd_acct_cd);
		cstmt.setString(25, dm.chg_dt);
		cstmt.setString(26, dm.drcr_clsf);
		cstmt.setString(27, dm.mand_reg_yn);
		cstmt.setString(28, dm.bal_mang_clsf);
		cstmt.setString(29, dm.prty_rank);
		cstmt.setString(30, dm.mang_item_cd);
		cstmt.setString(31, dm.pch_gwhmnm);
		cstmt.setString(32, dm.mang_item_nm);
		cstmt.setString(33, dm.prty_rank2);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_1048_UDataSet();
	}
	...
	public void print(){
		...
		System.out.println("pch_gwhmnm = [" + getPch_gwhmnm() + "]");
...
String pch_gwhmnm = req.getParameter("pch_gwhmnm");
if( pch_gwhmnm == null){
	System.out.println(this.toString+" : pch_gwhmnm is null" );
}else{
	System.out.println(this.toString+" : pch_gwhmnm is "+pch_gwhmnm );
}
...
String pch_gwhmnm = Util.checkString(req.getParameter("pch_gwhmnm"));
...
String pch_gwhmnm = Util.Uni2Ksc(Util.checkString(req.getParameter("pch_gwhmnm")));
