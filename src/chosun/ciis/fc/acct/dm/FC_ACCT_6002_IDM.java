...
public class FC_ACCT_6002_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_6002_IDM(){}
	public FC_ACCT_6002_IDM(String cmpy_cd, String erplace_cd, String ernm, String ern, String presi_nm, String erplace_addr, String erplace_bizcond, String erplace_item, String taxoff, String corp_reg_no, String intg_dlco_cd, String fac_clsf, String use_yn, String incmg_pers_ipadd, String incmg_pers, String incmg_dt_tm, String ernm_tax, String erplace_cd_tax){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_6002_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_6002_IDM dm = (FC_ACCT_6002_IDM)bdm;
		...
		cstmt.setString(19, dm.ernm_tax);
		cstmt.setString(20, dm.erplace_cd_tax);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_6002_IDataSet();
	}
...
/* 작성시간 : Wed Jan 27 16:01:04 KST 2010 */