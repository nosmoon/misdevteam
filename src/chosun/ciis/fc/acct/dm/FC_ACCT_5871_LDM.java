...
public class FC_ACCT_5871_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_5871_LDM(){}
	public FC_ACCT_5871_LDM(String cmpy_cd, String fisc_dt_fr, String fisc_dt_to, String fisc_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_5871_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_5871_LDM dm = (FC_ACCT_5871_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_5871_LDataSet();
	}
