...
public class FC_ACCT_5301_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String clos_mm;

	public FC_ACCT_5301_LDM(){}
	public FC_ACCT_5301_LDM(String cmpy_cd, String clos_mm){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_5301_L(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_5301_LDM dm = (FC_ACCT_5301_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.clos_mm);
		cstmt.registerOutParameter(5, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_5301_LDataSet();
	}
