...
public class FC_ACCT_1027_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String acct_type_cd;
	public String acct_cd;

	public FC_ACCT_1027_ADM(){}
	public FC_ACCT_1027_ADM(String cmpy_cd, String acct_type_cd, String acct_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_1027_A(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_1027_ADM dm = (FC_ACCT_1027_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_1027_ADataSet();
	}
...
/* 작성시간 : Thu Jan 05 10:30:46 KST 2017 */