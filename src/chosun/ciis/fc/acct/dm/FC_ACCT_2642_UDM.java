...
public class FC_ACCT_2642_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2642_UDM(){}
	public FC_ACCT_2642_UDM(String cmpy_cd, String fr_fisc_dt, String to_fisc_dt, String conn_cmpy_cd1, String data_list1, String conn_cmpy_cd2, String data_list2, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2642_U(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2642_UDM dm = (FC_ACCT_2642_UDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2642_UDataSet();
	}
...
/* 작성시간 : Mon Jan 05 16:04:38 KST 2015 */