...
public class FC_ACCT_2347_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2347_UDM(){}
	public FC_ACCT_2347_UDM(String cmpy_cd, String mode, String note_stat, String slip_arow_no, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String slip_sub_seq, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2347_U(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2347_UDM dm = (FC_ACCT_2347_UDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.mode);
		cstmt.setString(5, dm.note_stat);
		cstmt.setString(6, dm.slip_arow_no);
		cstmt.setString(7, dm.slip_occr_dt);
		cstmt.setString(8, dm.slip_clsf_cd);
		cstmt.setString(9, dm.slip_seq);
		cstmt.setString(10, dm.slip_sub_seq);
		cstmt.setString(11, dm.incmg_pers);
		cstmt.setString(12, dm.incmg_pers_ipadd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2347_UDataSet();
	}
