...
public class FC_ACCT_5312_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_5312_LDM(){}
	public FC_ACCT_5312_LDM(String cmpy_cd, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String slip_sub_seq){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_5312_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_5312_LDM dm = (FC_ACCT_5312_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_5312_LDataSet();
	}
