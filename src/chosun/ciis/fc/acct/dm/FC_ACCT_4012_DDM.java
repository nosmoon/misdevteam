...
public class FC_ACCT_4012_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_4012_DDM(){}
	public FC_ACCT_4012_DDM(String cmpy_cd, String setoff_reserv_dt, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_4012_D(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_4012_DDM dm = (FC_ACCT_4012_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_4012_DDataSet();
	}
