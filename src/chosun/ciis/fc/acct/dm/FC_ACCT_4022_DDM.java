...
public class FC_ACCT_4022_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String setoff_exne;
	public String setoff_dt;
	public String incmg_pers;
	public String incmg_pers_ipadd;

	public FC_ACCT_4022_DDM(){}
	public FC_ACCT_4022_DDM(String cmpy_cd, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String slip_sub_seq, String slip_arow_no, String extnc_acct_cd, String setoff_exne, String setoff_dt, String incmg_pers, String incmg_pers_ipadd){
		...
		this.setoff_exne = setoff_exne;
		this.setoff_dt = setoff_dt;
	...
	public void setSetoff_exne(String setoff_exne){
		this.setoff_exne = setoff_exne;
	}

	public void setSetoff_dt(String setoff_dt){
		this.setoff_dt = setoff_dt;
	}
	...
	public String getSetoff_exne(){
		return this.setoff_exne;
	}

	public String getSetoff_dt(){
		return this.setoff_dt;
	}
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_4022_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_4022_DDM dm = (FC_ACCT_4022_DDM)bdm;
		...
		cstmt.setString(10, dm.setoff_exne);
		cstmt.setString(11, dm.setoff_dt);
		cstmt.setString(12, dm.incmg_pers);
		cstmt.setString(13, dm.incmg_pers_ipadd);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_4022_DDataSet();
	}
	...
	public void print(){
		...
		System.out.println("setoff_exne = [" + getSetoff_exne() + "]");
		System.out.println("setoff_dt = [" + getSetoff_dt() + "]");
...
String setoff_exne = req.getParameter("setoff_exne");
if( setoff_exne == null){
	System.out.println(this.toString+" : setoff_exne is null" );
}else{
	System.out.println(this.toString+" : setoff_exne is "+setoff_exne );
}
String setoff_dt = req.getParameter("setoff_dt");
if( setoff_dt == null){
	System.out.println(this.toString+" : setoff_dt is null" );
}else{
	System.out.println(this.toString+" : setoff_dt is "+setoff_dt );
}
...
String setoff_exne = Util.checkString(req.getParameter("setoff_exne"));
String setoff_dt = Util.checkString(req.getParameter("setoff_dt"));
...
String setoff_exne = Util.Uni2Ksc(Util.checkString(req.getParameter("setoff_exne")));
String setoff_dt = Util.Uni2Ksc(Util.checkString(req.getParameter("setoff_dt")));
...
dm.setSetoff_exne(setoff_exne);
dm.setSetoff_dt(setoff_dt);
dm.setIncmg_pers(incmg_pers);
dm.setIncmg_pers_ipadd(incmg_pers_ipadd);
----------------------------------------------------------------------------------------------------*/


/* 작성시간 : Mon Jun 08 10:14:28 KST 2009 */