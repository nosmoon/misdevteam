...
public class FC_ACCT_3024_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_3024_DDM(){}
	public FC_ACCT_3024_DDM(String cmpy_cd, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String stlm_dt, String incmg_pers, String incmg_pers_ipadd, long pch_count){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_3024_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_3024_DDM dm = (FC_ACCT_3024_DDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_3024_DDataSet();
	}
...
/* 작성시간 : Mon Feb 16 19:56:11 KST 2009 */