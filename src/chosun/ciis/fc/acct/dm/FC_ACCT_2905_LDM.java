...
public class FC_ACCT_2905_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2905_LDM(){}
	public FC_ACCT_2905_LDM(String cmpy_cd, String aprv_slip_occr_dt, String aprv_slip_clsf, String aprv_slip_occr_seqo, String aprv_slip_occr_sub_seq){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2905_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2905_LDM dm = (FC_ACCT_2905_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2905_LDataSet();
	}
