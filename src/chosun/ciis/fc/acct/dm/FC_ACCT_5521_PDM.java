...
public class FC_ACCT_5521_PDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_5521_PDM(){}
	public FC_ACCT_5521_PDM(String cmpy_cd, String fisc_yymm, String dlco_clsf_cd, String dlco_cd_fr, String dlco_cd_to){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_5521_P(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_5521_PDM dm = (FC_ACCT_5521_PDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_5521_PDataSet();
	}
