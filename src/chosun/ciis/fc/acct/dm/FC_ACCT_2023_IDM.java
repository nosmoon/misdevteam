...
public class FC_ACCT_2023_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2023_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2023_IDM dm = (FC_ACCT_2023_IDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.slip_occr_dt);
		cstmt.setString(5, dm.slip_clsf_cd);
		cstmt.setString(6, dm.clam_dept_cd);
		cstmt.setString(7, dm.clam_amt);
		cstmt.setString(8, dm.titl);
		cstmt.setString(9, dm.medi_cd);
		cstmt.setString(10, dm.cost_clsf);
		cstmt.setString(11, dm.budg_yymm);
		cstmt.setString(12, dm.chrg_emp_no);
		cstmt.setString(13, dm.budg_cd);
		cstmt.setString(14, dm.incmg_pers);
		cstmt.setString(15, dm.incmg_pers_ipadd);
		cstmt.setString(16, dm.old_dlco_clsf_cd);
		cstmt.setString(17, dm.old_dlco_cd);
		cstmt.setString(18, dm.pch_compnm);
		cstmt.setString(19, dm.pubc_dt);
		cstmt.setString(20, dm.nosh);
		cstmt.setString(21, dm.uprc);
		cstmt.setString(22, dm.atic_fee);
		cstmt.setString(23, dm.incm_clsf_cd);
		cstmt.setString(24, dm.incm_tax);
		cstmt.setString(25, dm.res_tax);
		cstmt.setString(26, dm.coms);
		cstmt.setString(27, dm.atic_nm);
		cstmt.setString(28, dm.with_tax);
		cstmt.setString(29, dm.pubc_side);
		cstmt.setString(30, dm.cal_pay_amt);
		cstmt.setString(31, dm.bank_clsf);
		cstmt.setString(32, dm.acct_no);
		cstmt.setString(33, dm.deps_pers_nm);
		cstmt.setString(34, dm.dtls_medi_cd);
		cstmt.setString(35, dm.adpay_expn_no);
		cstmt.setString(36, dm.end_yn);
		cstmt.setString(37, dm.draft_doc_no);
		cstmt.setString(38, dm.draft_doc_dept_cd);
		cstmt.setString(39, dm.draft_expn_amt);
		cstmt.registerOutParameter(40, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2023_IDataSet();
	}
...
/* 작성시간 : Thu Jul 09 17:24:19 KST 2009 */