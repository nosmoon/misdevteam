...
public class FC_ACCT_3255_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_3255_DDM(){}
	public FC_ACCT_3255_DDM(String cmpy_cd, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String slip_sub_seq, String incmg_pers, String incmg_pers_ipadd, String in_sicsgb){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_3255_D(? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_3255_DDM dm = (FC_ACCT_3255_DDM)bdm;
		...
		cstmt.setString(10, dm.in_sicsgb);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_3255_DDataSet();
	}
...
/* 작성시간 : Fri May 30 18:33:38 KST 2014 */