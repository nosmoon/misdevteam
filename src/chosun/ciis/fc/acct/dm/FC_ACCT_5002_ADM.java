...
public class FC_ACCT_5002_ADM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_5002_ADM(){}
	public FC_ACCT_5002_ADM(String cmpy_cd, String incmg_dt, String clos_clsf, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_5002_A(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_5002_ADM dm = (FC_ACCT_5002_ADM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_5002_ADataSet();
	}
