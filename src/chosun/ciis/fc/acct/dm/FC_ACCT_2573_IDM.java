...
public class FC_ACCT_2573_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2573_IDM(){}
	public FC_ACCT_2573_IDM(String cmpy_cd, String incmg_chg_pers_ip, String incmg_chg_pers, String biz_reg_no, String bank_id, String acct_num, String acct_tonghwa, String tran_date, String tran_date_seq, String extnc_seq, String fisc_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2573_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2573_IDM dm = (FC_ACCT_2573_IDM)bdm;
		...
		cstmt.setString(13, dm.fisc_dt);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2573_IDataSet();
	}
