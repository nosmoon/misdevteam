...
public class FC_ACCT_6023_EDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_6023_EDM(){}
	public FC_ACCT_6023_EDM(String cmpy_cd, String from_dt, String to_dt, String ndduc_rate, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_6023_E(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_6023_EDM dm = (FC_ACCT_6023_EDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_6023_EDataSet();
	}
