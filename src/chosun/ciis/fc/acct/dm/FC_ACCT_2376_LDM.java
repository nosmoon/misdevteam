...
public class FC_ACCT_2376_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2376_LDM(){}
	public FC_ACCT_2376_LDM(String cmpy_cd, String slip_occr_dt, String slip_occr_dt2, String slip_clsf_cd, String slip_seq_fr, String slip_seq_to, String incmg_emp_no, String fisc_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2376_L(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2376_LDM dm = (FC_ACCT_2376_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2376_LDataSet();
	}
