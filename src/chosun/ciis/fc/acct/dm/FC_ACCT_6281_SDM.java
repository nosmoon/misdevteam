...
public class FC_ACCT_6281_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_6281_SDM(){}
	public FC_ACCT_6281_SDM(String cmpy_cd, String decl_unit_clsf_cd, String vat_fr_yymm, String vat_to_yymm, String incmg_pers, String incmg_pers_ipadd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_6281_S(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_6281_SDM dm = (FC_ACCT_6281_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_6281_SDataSet();
	}
