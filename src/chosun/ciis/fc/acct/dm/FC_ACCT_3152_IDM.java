...
public class FC_ACCT_3152_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_3152_IDM(){}
	public FC_ACCT_3152_IDM(String cmpy_cd, String clam_dept_cd, String incmg_dt, String fisc_dt, String rmks, String slip_no, String obj_amt, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_3152_I(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_3152_IDM dm = (FC_ACCT_3152_IDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_3152_IDataSet();
	}
...
/* 작성시간 : Fri May 15 21:59:44 KST 2009 */