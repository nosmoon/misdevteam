...
public class FC_ACCT_6037_UDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_6037_UDM(){}
	public FC_ACCT_6037_UDM(String cmpy_cd, String mode, String data_clsf, String suply_pers_reg_no, String seq, String erplace_cd, String nosh, String nul_cnt, String suply_amt, String vat_amt, String incmg_pers_ipadd, String incmg_pers){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_6037_U(? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_6037_UDM dm = (FC_ACCT_6037_UDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.mode);
		cstmt.setString(5, dm.data_clsf);
		cstmt.setString(6, dm.suply_pers_reg_no);
		cstmt.setString(7, dm.seq);
		cstmt.setString(8, dm.erplace_cd);
		cstmt.setString(9, dm.nosh);
		cstmt.setString(10, dm.nul_cnt);
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_6037_UDataSet();
	}
...
/* 작성시간 : Thu Dec 06 15:10:54 KST 2012 */