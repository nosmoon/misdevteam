...
public class FC_ACCT_5363_DDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_5363_DDM(){}
	public FC_ACCT_5363_DDM(String cmpy_cd, String slip_occr_dt, String slip_clsf_cd, String slip_seq, String incmg_pers, String incmg_pers_ipadd, String sicsgb){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_5363_D(? ,? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_5363_DDM dm = (FC_ACCT_5363_DDM)bdm;
		...
		cstmt.setString(9, dm.sicsgb);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_5363_DDataSet();
	}
...
/* 작성시간 : Wed Mar 18 17:50:36 KST 2009 */