...
public class FC_ACCT_5861_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String fisc_dt_fr;
	public String fisc_dt_to;

	public FC_ACCT_5861_LDM(){}
	public FC_ACCT_5861_LDM(String cmpy_cd, String fisc_dt_fr, String fisc_dt_to){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_5861_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_5861_LDM dm = (FC_ACCT_5861_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_5861_LDataSet();
	}
