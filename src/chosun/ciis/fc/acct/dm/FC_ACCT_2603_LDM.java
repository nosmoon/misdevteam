...
public class FC_ACCT_2603_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String acct_type_cd;
	public String search_yymm;

	public FC_ACCT_2603_LDM(){}
	public FC_ACCT_2603_LDM(String cmpy_cd, String acct_type_cd, String search_yymm){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2603_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2603_LDM dm = (FC_ACCT_2603_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2603_LDataSet();
	}
