...
public class FC_ACCT_8121_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_8121_LDM(){}
	public FC_ACCT_8121_LDM(String cmpy_cd, String from_fisc_dt, String to_fisc_dt, String erplace_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_8121_L(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_8121_LDM dm = (FC_ACCT_8121_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_8121_LDataSet();
	}
