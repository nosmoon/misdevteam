...
public class FC_ACCT_3041_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String cost_gain_clsf_cd;
	public String stlm_dt;

	public FC_ACCT_3041_LDM(){}
	public FC_ACCT_3041_LDM(String cmpy_cd, String cost_gain_clsf_cd, String stlm_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_3041_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_3041_LDM dm = (FC_ACCT_3041_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_3041_LDataSet();
	}
