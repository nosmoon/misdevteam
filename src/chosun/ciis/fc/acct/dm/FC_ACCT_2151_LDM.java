...
public class FC_ACCT_2151_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_ACCT_2151_LDM(){}
	public FC_ACCT_2151_LDM(String cmpy_cd, String budg_cd, String ask_dept_cd, String slip_occr_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_2151_L(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_2151_LDM dm = (FC_ACCT_2151_LDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.cmpy_cd);
		cstmt.setString(4, dm.budg_cd);
		cstmt.setString(5, dm.ask_dept_cd);
		cstmt.setString(6, dm.slip_occr_dt);
		cstmt.registerOutParameter(7, OracleTypes.CURSOR);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_2151_LDataSet();
	}
