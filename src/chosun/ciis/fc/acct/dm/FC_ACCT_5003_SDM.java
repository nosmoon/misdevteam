...
public class FC_ACCT_5003_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String incmg_dt;

	public FC_ACCT_5003_SDM(){}
	public FC_ACCT_5003_SDM(String cmpy_cd, String incmg_dt){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_ACCT_5003_S(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_ACCT_5003_SDM dm = (FC_ACCT_5003_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.acct.ds.FC_ACCT_5003_SDataSet();
	}
