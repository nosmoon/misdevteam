...
public class FC_CO_1011_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList curlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public FC_CO_1011_LDataSet(){}
	public FC_CO_1011_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset2.next()){
			FC_CO_1011_LCURLISTRecord rec = new FC_CO_1011_LCURLISTRecord();
...
<%
	for(int i=0; i<ds.curlist.size(); i++){
		FC_CO_1011_LCURLISTRecord curlistRec = (FC_CO_1011_LCURLISTRecord)ds.curlist.get(i);%>
HTML 코드들....
	<%}%>
