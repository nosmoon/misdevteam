...
public class FC_CO_4000Servlet extends chosun.ciis.co.base.servlet.BaseServlet {
	...
	*/
	public void process(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			String servletMappedUrl = "/fc/co4000/";
	...
	public String executeWorker(HttpServletRequest req, HttpServletResponse res, int pid) throws AppException, IOException, SQLException {
		...
		switch(pid) {
			case FC_CO_4000WBMapping.FC_CO_9999:
				wb = new FC_CO_4000WB();
				((FC_CO_4000WB)wb).getDummyList(req, res);
