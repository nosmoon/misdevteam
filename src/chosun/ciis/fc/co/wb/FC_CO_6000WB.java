...
public class FC_CO_6000WB extends chosun.ciis.co.base.wb.BaseWB {
	public void getDummyList(HttpServletRequest req, HttpServletResponse res) throws AppException, SQLException {
		...
		/* EJB 수정전 시작
		try {
			FC_CO_6000EJBHome home = (FC_CO_6000EJBHome)JNDIManager.getInstance().getHome("FC_CO_6000EJB");
			FC_CO_6000EJB ejb = home.create();
