...
public class FC_CO_2000WB extends chosun.ciis.co.base.wb.BaseWB {
	public void getDummyList(HttpServletRequest req, HttpServletResponse res) throws AppException, SQLException {
		...
		/* EJB 수정전 시작
		try {
			FC_CO_2000EJBHome home = (FC_CO_2000EJBHome)JNDIManager.getInstance().getHome("FC_CO_2000EJB");
			FC_CO_2000EJB ejb = home.create();
