...
public class FC_CO_8000_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public FC_CO_8000_SDM(){}
	public FC_CO_8000_SDM(String cmpy_cd, String job_clsf, String cd_clsf, String cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_CO_8000_S(? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_CO_8000_SDM dm = (FC_CO_8000_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.co.ds.FC_CO_8000_SDataSet();
	}
