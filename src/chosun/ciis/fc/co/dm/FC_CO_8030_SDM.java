...
public class FC_CO_8030_SDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String cd;

	public FC_CO_8030_SDM(){}
	public FC_CO_8030_SDM(String cmpy_cd, String cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_CO_8030_S(? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_CO_8030_SDM dm = (FC_CO_8030_SDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.co.ds.FC_CO_8030_SDataSet();
	}
