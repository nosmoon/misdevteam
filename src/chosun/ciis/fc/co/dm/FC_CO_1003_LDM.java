...
public class FC_CO_1003_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String cd;
	public String cdnm;

	public FC_CO_1003_LDM(){}
	public FC_CO_1003_LDM(String cmpy_cd, String cd, String cdnm){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_CO_1003_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_CO_1003_LDM dm = (FC_CO_1003_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.co.ds.FC_CO_1003_LDataSet();
	}
