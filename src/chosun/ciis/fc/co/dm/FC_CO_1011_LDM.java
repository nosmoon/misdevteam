...
public class FC_CO_1011_LDM extends somo.framework.db.BaseDM implements java.io.Serializable{

	public String cmpy_cd;
	public String deps_isav_clsf_cd;
	public String deps_isav_stat_cd;

	public FC_CO_1011_LDM(){}
	public FC_CO_1011_LDM(String cmpy_cd, String deps_isav_clsf_cd, String deps_isav_stat_cd){
	...
	public String getSQL(){
		 return "{ call MISFNC.SP_FC_CO_1011_L(? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		FC_CO_1011_LDM dm = (FC_CO_1011_LDM)bdm;
	...
	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.fc.co.ds.FC_CO_1011_LDataSet();
	}
