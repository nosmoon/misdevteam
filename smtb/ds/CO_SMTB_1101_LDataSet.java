...
public class CO_SMTB_1101_LDataSet extends somo.framework.db.BaseDataSet implements java.io.Serializable{
	public ArrayList tax_stmtlist = new ArrayList();
	public String errcode;
	public String errmsg;

	public CO_SMTB_1101_LDataSet(){}
	public CO_SMTB_1101_LDataSet(String errcode, String errmsg){
	...
	public void getValues(CallableStatement cstmt) throws SQLException{
		...
		while(rset0.next()){
			CO_SMTB_1101_LTAX_STMTLISTRecord rec = new CO_SMTB_1101_LTAX_STMTLISTRecord();
			...
			rec.sup_email = Util.checkString(rset0.getString("sup_email"));
			rec.cash_amount = Util.checkString(rset0.getString("cash_amount"));
			rec.note_amount = Util.checkString(rset0.getString("note_amount"));
			rec.check_amount = Util.checkString(rset0.getString("check_amount"));
			rec.receivable_amount = Util.checkString(rset0.getString("receivable_amount"));
...
<%
	for(int i=0; i<ds.tax_stmtlist.size(); i++){
		CO_SMTB_1101_LTAX_STMTLISTRecord tax_stmtlistRec = (CO_SMTB_1101_LTAX_STMTLISTRecord)ds.tax_stmtlist.get(i);%>
HTML 코드들....
	<%}%>
...
<%= tax_stmtlistRec.sup_email%>
<%= tax_stmtlistRec.cash_amount%>
<%= tax_stmtlistRec.note_amount%>
<%= tax_stmtlistRec.check_amount%>
<%= tax_stmtlistRec.receivable_amount%>
----------------------------------------------------------------------------------------------------*/
