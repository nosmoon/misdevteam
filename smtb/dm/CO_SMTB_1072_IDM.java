...
public class CO_SMTB_1072_IDM extends somo.framework.db.BaseDM implements java.io.Serializable{
	...
	public CO_SMTB_1072_IDM(){}
	public CO_SMTB_1072_IDM(String fnd_user, String fnd_regno, String fnd_user_name, String smart_id, String smart_password, String smart_email){
	...
	public String getSQL(){
		 return "{ call MISCOM.SP_CO_SMTB_1072_I(? ,? ,? ,? ,? ,? ,? ,?) }";
	}

	public void setParams(CallableStatement cstmt, BaseDM bdm) throws SQLException{
		CO_SMTB_1072_IDM dm = (CO_SMTB_1072_IDM)bdm;
		cstmt.registerOutParameter(1, Types.VARCHAR);
		cstmt.registerOutParameter(2, Types.VARCHAR);
		cstmt.setString(3, dm.fnd_user);
		cstmt.setString(4, dm.fnd_regno);
		cstmt.setString(5, dm.fnd_user_name);
		cstmt.setString(6, dm.smart_id);
		cstmt.setString(7, dm.smart_password);
		cstmt.setString(8, dm.smart_email);
	}

	public BaseDataSet createDataSetObject(){
		return new chosun.ciis.co.smtb.ds.CO_SMTB_1072_IDataSet();
	}
...
/* 작성시간 : Mon May 16 10:52:18 KST 2011 */