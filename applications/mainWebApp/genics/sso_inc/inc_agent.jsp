...
<iframe id="_sso_frame" name="_sso_frame" width="500" height="0" frameborder="0" style="display:inline;" src="<%=sso_domain%>/sso_auth.jsp?fam_domain=<%=fam_domain%>&file_ext=<%=file_ext%>"></iframe>

<meta http-equiv="refresh" content="60;url=<%=fam_domain%>/genics/sso_inc/inc_agent.jsp">
