...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist6.size(); i++) {
			...
			if(prt_pj.length < 1){
				rx.add(record, "prt_pj_rate_bw_1", rec.prt_pj_rate_bw_1+".00");
			}else{
			...
			if(prt_pj.length < 1){
				rx.add(record, "prt_pj_rate_clr_1", rec.prt_pj_rate_clr_1+".00");
			}else{
...
//				rx.add(record, "prt_pj_rate_clr_1", rec.prt_pj_rate_clr_1);
			...
			if(prt_pj.length < 1){
				rx.add(record, "prt_pj_rate_bw_2", rec.prt_pj_rate_bw_2+".00");
			}else{
...
//				rx.add(record, "prt_pj_rate_bw_2", rec.prt_pj_rate_bw_2);
			...
			if(prt_pj.length < 1){
				rx.add(record, "prt_pj_rate_clr_2", rec.prt_pj_rate_clr_2+".00");
			}else{
