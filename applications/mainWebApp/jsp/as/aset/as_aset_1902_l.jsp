...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			AS_ASET_1902_LCURLISTRecord rec = (AS_ASET_1902_LCURLISTRecord)ds.curlist.get(i);
			int record = rx.add(recordSet, "record", "");
			String aset_clsf = rec.aset_no.substring(0,1);
			...
			rx.add(record, "aset_clsf", aset_clsf );
