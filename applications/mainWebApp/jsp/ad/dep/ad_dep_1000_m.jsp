...
<%
	...
	try {
		...
		for(int i=0; i<ds.curlist1.size(); i++){ 
			AD_DEP_1000_MCURLIST1Record rec = (AD_DEP_1000_MCURLIST1Record)ds.curlist1.get(i);
		...
		for(int i=0; i<ds.curlist2.size(); i++){
			AD_DEP_1000_MCURLIST2Record rec = (AD_DEP_1000_MCURLIST2Record)ds.curlist2.get(i);
		...
		for(int i=0; i<ds.curlist3.size(); i++){
			AD_DEP_1000_MCURLIST3Record rec = (AD_DEP_1000_MCURLIST3Record)ds.curlist3.get(i);
		...
		for(int i=0; i<ds.curlist4.size(); i++){
			AD_DEP_1000_MCURLIST4Record rec = (AD_DEP_1000_MCURLIST4Record)ds.curlist4.get(i);
		...
		for(int i=0; i<ds.curlist5.size(); i++){
			AD_DEP_1000_MCURLIST5Record rec = (AD_DEP_1000_MCURLIST5Record)ds.curlist5.get(i);
		...
		for(int i=0; i<ds.curlist6.size(); i++){
			AD_DEP_1000_MCURLIST6Record rec = (AD_DEP_1000_MCURLIST6Record)ds.curlist6.get(i);
		...
		for(int i=0; i<ds.curlist7.size(); i++){
			AD_DEP_1000_MCURLIST7Record rec = (AD_DEP_1000_MCURLIST7Record)ds.curlist7.get(i);
			int item  = rx.add( prercpm_medi_cd , "item" , "");
			rx.add ( item, "value", rec.cd );
			rx.add ( item, "label", rec.cd+" "+rec.cdnm);
		}	
		...
		for(int i=0; i<ds.curlist8.size(); i++){
			AD_DEP_1000_MCURLIST8Record rec = (AD_DEP_1000_MCURLIST8Record)ds.curlist8.get(i);
			int item  = rx.add( prercpm_medi_cd , "item" , "");
			rx.add ( item, "value", rec.cd );
			rx.add ( item, "label", rec.cd+" "+rec.cdnm);
		}					
