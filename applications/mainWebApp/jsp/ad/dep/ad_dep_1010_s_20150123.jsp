...
//차변:계좌입금	
		...
		for(int i = 0; i < list_02.size(); i++) {
			...
			String card_yn  =   StringUtil.nvl(rec.card_yn);	
			...
			//String card_yn = StringUtil.nvl(rec.card_yn);			
			//if("Y".equals(card_yn)){
			//	rx.add(record, "rmtt_coms", rec.card_coms);						
			//	rmtt_coms	=	StringUtil.toNumber(rec.card_coms);
			//}else{
				rx.add(record, "rmtt_coms", rec.rmtt_coms);			
			//	rmtt_coms	=	StringUtil.toNumber(rec.rmtt_coms);
			//}
