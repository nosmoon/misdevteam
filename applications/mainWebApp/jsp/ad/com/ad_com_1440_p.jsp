...
paramTag[paramTag.length] = '<param name="connection.reportname"			value="SP_AD_COM_1440_P.ozr">';
paramTag[paramTag.length] = '<param name="odi.odinames"						value="SP_AD_COM_1440_P">';
...
paramTag[paramTag.length] = '<param name="export.filename"					value="광고원고수배장_<%=sysDate%>.xls">';
