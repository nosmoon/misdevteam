...
//	int resData = rx.add(root, "resData", "");
	...
	try { 
		...
		rx.add(resForm, "proc_dt", ds.preng_dt);
		rx.add(resForm, "pubc_dt", ds.preng_dt);
		...
		rx.add(resForm, "pubc_occr_seq", "");
		rx.add(resForm, "pubc_occr_dt", "");
		rx.add(resForm, "upd_resn", "" );
		rx.add(resForm, "upd_cont", "");
		rx.add(resForm, "pre_pubc_slip_no", "");
		rx.add(resForm, "pre_pubc_slip_no_crte_dt", "");
		rx.add(resForm, "upd_yn", "");
		rx.add(resForm, "div_yn", "");
		rx.add(resForm, "clos_stat", "");
		rx.add(resForm, "clamt_stat", ""); 
		rx.add(resForm, "sale_stmt_issu_yn", "");
		rx.add(resForm, "purc_stmt_issu_yn", "");
		rx.add(resForm, "elec_tax_stmt_yn", "" );
