...
<%
	...
	try {
		...
		for(int i=0; i<ds.curlist.size(); i++){
			AD_PUB_3200_MCURLISTRecord rec = (AD_PUB_3200_MCURLISTRecord)ds.curlist.get(i);
		...
		for(int i=0; i<ds.curlist2.size(); i++){
			AD_PUB_3200_MCURLIST2Record rec = (AD_PUB_3200_MCURLIST2Record)ds.curlist2.get(i);
