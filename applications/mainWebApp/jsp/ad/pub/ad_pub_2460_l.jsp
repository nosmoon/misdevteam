...
<%
	...
	int gridData = rx.add(root, "gridData4", "");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			AD_PUB_2460_LCURLISTRecord rec = (AD_PUB_2460_LCURLISTRecord)ds.curlist.get(i);
			...
			tot_advt_fee += StringUtil.toLong(rec.eamt);
			tot_fee      += StringUtil.toLong(rec.efee);
		}
