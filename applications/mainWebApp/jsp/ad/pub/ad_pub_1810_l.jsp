...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			...
			rx.add(record,"sale_stmt_issu_yn",rec.sale_stmt_issu_yn.substring(0,1));	//매출발행
			...
			rx.add(record,"pre_issu_yn",rec.sale_stmt_issu_yn.substring(1));	//발행
