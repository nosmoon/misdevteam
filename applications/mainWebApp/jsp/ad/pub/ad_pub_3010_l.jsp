...
//	int resData = rx.add(root, "resData", "");
	...
	try {
		for(int i = 0; i < ds.curlist.size(); i++) {
			AD_PUB_3010_LCURLISTRecord rec = (AD_PUB_3010_LCURLISTRecord)ds.curlist.get(i);
			...
			rx.add(record, "diff_ratio_1"	, StringUtil.toDouble(rec.diff_ratio_1));
			rx.add(record, "diff_ratio_2"	, StringUtil.toDouble(rec.diff_ratio_2));
