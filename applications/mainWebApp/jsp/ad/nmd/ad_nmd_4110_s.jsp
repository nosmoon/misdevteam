...
//대변
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			AD_NMD_4110_SCURLIST2Record rec = (AD_NMD_4110_SCURLIST2Record)ds.curlist2.get(i);
...
//차변:어음내역			
		...
		for(int i=0; i<ds.curlist1.size(); i++){ 
			AD_NMD_4110_SCURLIST1Record rec = (AD_NMD_4110_SCURLIST1Record)ds.curlist1.get(i);
...
//차변:계좌입금	
		...
		for(int i = 0; i < list_02.size(); i++) {
			AD_NMD_4110_SCURLIST2Record rec = (AD_NMD_4110_SCURLIST2Record)list_02.get(i);
...
//차변:선수금대체		
		...
		for(int i = 0; i < list_04.size(); i++) {
			AD_NMD_4110_SCURLIST2Record rec = (AD_NMD_4110_SCURLIST2Record)list_04.get(i);
...
//차변:예수금대체		
		...
		for(int i = 0; i < list_06.size(); i++) {
			AD_NMD_4110_SCURLIST2Record rec = (AD_NMD_4110_SCURLIST2Record)list_06.get(i);
...
//차변:기타입금대체		
		...
		for(int i = 0; i < list_07.size(); i++) {
			AD_NMD_4110_SCURLIST2Record rec = (AD_NMD_4110_SCURLIST2Record)list_07.get(i);
...
//대변:선수금
		...
		for(int i = 0; i < list_08.size(); i++) {
			AD_NMD_4110_SCURLIST2Record rec = (AD_NMD_4110_SCURLIST2Record)list_08.get(i);
			long	amt	=	StringUtil.toNumber(rec.amt);
...
//대변:예수금
		...
		for(int i = 0; i < list_09.size(); i++) {
			AD_NMD_4110_SCURLIST2Record rec = (AD_NMD_4110_SCURLIST2Record)list_09.get(i);
			long	amt	=	StringUtil.toNumber(rec.amt);
...
//대변:기타입금
		...
		for(int i = 0; i < list_10.size(); i++) {
			AD_NMD_4110_SCURLIST2Record rec = (AD_NMD_4110_SCURLIST2Record)list_10.get(i);
			long	amt	=	StringUtil.toNumber(rec.amt);
		...
		if("10".equals(StringUtil.nvl(ds.rcpm_plac_clsf, "1"))){
			rx.add(resForm, "dlco_no", "");		
			rx.add(resForm, "user_id", ds.dlco_no);
		}else{
			rx.add(resForm, "user_id", "");
