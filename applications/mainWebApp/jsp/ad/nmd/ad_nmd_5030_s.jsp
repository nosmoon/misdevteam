...
<%
	...
	try {
		...
		for(int i=0; i<ds.curlist.size(); i++){ 
			AD_NMD_5030_SCURLISTRecord rec = (AD_NMD_5030_SCURLISTRecord)ds.curlist.get(i);
		...
		rx.add( resForm , "trust_presi_nm" , ds.trust_presi_nm);	
		rx.addCData( resForm , "trust_addr" , ds.trust_addr);	
		rx.add( resForm , "trust_bizcond" , ds.trust_bizcond);	
		rx.add( resForm , "trust_item" , ds.trust_item);	
