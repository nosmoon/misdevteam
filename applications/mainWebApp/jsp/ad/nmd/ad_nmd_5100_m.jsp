...
<%
	RwXml rx = new RwXml();
	AD_NMD_5100_MDataSet ds = (AD_NMD_5100_MDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i=0; i<ds.curlist1.size(); i++){ 
			AD_NMD_5100_MCURLIST1Record rec = (AD_NMD_5100_MCURLIST1Record)ds.curlist1.get(i);
		...
		for(int i=0; i<ds.curlist2.size(); i++){ 
			AD_NMD_5100_MCURLIST2Record rec = (AD_NMD_5100_MCURLIST2Record)ds.curlist2.get(i);
		...
		for(int i=0; i<ds.curlist3.size(); i++){ 
			AD_NMD_5100_MCURLIST3Record rec = (AD_NMD_5100_MCURLIST3Record)ds.curlist3.get(i);
