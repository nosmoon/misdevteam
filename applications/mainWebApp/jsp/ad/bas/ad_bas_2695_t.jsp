...
<%
    ...
    String part_cd   = Util.checkString(request.getParameter("part_cd"));   
%>
	<OBJECT width = "865" height = "285" CLASSID="<%=ozClasssID%>">
		<param name="connection.servlet"			value="<%=ozServerIP%>">
		<param name="connection.reportname"			value="ad/SP_AD_BAS_2695_P.ozr">
		<param name="odi.odinames"					value="SP_AD_BAS_2695_P">
		<param name="odi.SP_AD_BAS_2695_P.pcount"	value="4">
		<param name="odi.SP_AD_BAS_2695_P.args1"	value="iv_cmpy_cd=<%=cmpy_cd%>">
		<param name="odi.SP_AD_BAS_2695_P.args2"	value="iv_trgt_clsf=<%=trgt_clsf%>">
		<param name="odi.SP_AD_BAS_2695_P.args3"	value="iv_trgt_yymm=<%=trgt_yymm%>">
		<param name="odi.SP_AD_BAS_2695_P.args4"	value="iv_part_cd=<%=part_cd%>">
