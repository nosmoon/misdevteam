...
<%
	...
	try {
		...
		if(ds.page_id.equals("AD_BAS_1500")){	//일일보고 화면일때만 생성(일일보고 등록 X)
			rx.add ( item3, "value", "");
			rx.add ( item3, "label", "전체");
		}
		for(int i = 0; i < ds.curlist3.size(); i++) {
			AD_BAS_1500_MCURLIST3Record rec = (AD_BAS_1500_MCURLIST3Record)ds.curlist3.get(i);
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			AD_BAS_1500_MCURLIST2Record rec = (AD_BAS_1500_MCURLIST2Record)ds.curlist2.get(i);
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			AD_BAS_1500_MCURLIST1Record rec = (AD_BAS_1500_MCURLIST1Record)ds.curlist1.get(i);
