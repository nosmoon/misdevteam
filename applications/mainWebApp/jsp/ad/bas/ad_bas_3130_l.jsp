...
<%
	...
	try{
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			AD_BAS_3130_LCURLIST1Record rec = (AD_BAS_3130_LCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(gridData1, "record", "");
			
			rx.add(record, "pubc_dt", rec.pubc_dt);
			rx.add(record, "wkdy", rec.wkdy);
			rx.add(record, "tot_pcnt", rec.tot_pcnt); 
			rx.add(record, "tot_clas", DigitUtil.cutUnderPoint(rec.tot_clas,1));
			rx.add(record, "clr_clas", DigitUtil.cutUnderPoint(rec.clr_clas,1));  
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			AD_BAS_3130_LCURLIST2Record rec = (AD_BAS_3130_LCURLIST2Record)ds.curlist2.get(i);
			...
			if(i == ds.curlist2.size()-1){
				AD_BAS_3130_LCURLIST2Record pre_rec = (AD_BAS_3130_LCURLIST2Record)ds.curlist2.get(i-1);
