...
%>
	<OBJECT width = "865" height = "285" CLASSID="<%=ozClasssID%>">
		...
		<param name="connection.reportname"			value="ad/SP_AD_BAS_3440_P.ozr">
		<param name="odi.odinames"					value="SP_AD_BAS_3440_P">
		<param name="odi.SP_AD_BAS_3440_P.pcount"	value="4">
		<param name="odi.SP_AD_BAS_3440_P.args1"	value="cmpy_cd=<%=cmpy_cd%>">
		<param name="odi.SP_AD_BAS_3440_P.args2"	value="trgt_clsf=<%=trgt_clsf%>">
		<param name="odi.SP_AD_BAS_3440_P.args3"	value="trgt_obj=<%=trgt_obj%>">
		<param name="odi.SP_AD_BAS_3440_P.args4"	value="trgt_yymm=<%=trgt_yymm%>">
