...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			AD_EVLU_2100_LCURLIST2Record rec = (AD_EVLU_2100_LCURLIST2Record)ds.curlist2.get(i);
			String tmp1 = "";
			String tmp2 = "";
			int f =1;
		...
		rx.add(record2, "caption", StringUtil.replaceToXml("월^일별평가^항목의견"+caption));
		rx.add(record2, "caption2", StringUtil.replaceToXml("|월^일별평가^항목의견"+caption2));
