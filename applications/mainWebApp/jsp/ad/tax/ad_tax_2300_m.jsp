...
<%
	...
	try {
		...
		for(int i=0; i<ds.curlist1.size(); i++){ 
			AD_TAX_2300_MCURLIST1Record rec = (AD_TAX_2300_MCURLIST1Record)ds.curlist1.get(i);
		...
		for(int i=0; i<ds.curlist2.size(); i++){
			AD_TAX_2300_MCURLIST2Record rec = (AD_TAX_2300_MCURLIST2Record)ds.curlist2.get(i);
