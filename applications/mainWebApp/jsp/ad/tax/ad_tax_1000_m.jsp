...
<%
	...
	try { 
		...
		for(int i=0; i<ds.curlist1.size(); i++){ 
			AD_TAX_1000_MCURLIST1Record rec = (AD_TAX_1000_MCURLIST1Record)ds.curlist1.get(i);
		...
		for(int i=0; i<ds.curlist2.size(); i++){
			AD_TAX_1000_MCURLIST2Record rec = (AD_TAX_1000_MCURLIST2Record)ds.curlist2.get(i);
		...
		for(int i=0; i<ds.curlist3.size(); i++){
			AD_TAX_1000_MCURLIST3Record rec = (AD_TAX_1000_MCURLIST3Record)ds.curlist3.get(i);
		...
		for(int i=0; i<ds.curlist4.size(); i++){
			AD_TAX_1000_MCURLIST4Record rec = (AD_TAX_1000_MCURLIST4Record)ds.curlist4.get(i);
		...
		{
			AD_TAX_1000_MCURLIST5Record rec = (AD_TAX_1000_MCURLIST5Record)ds.curlist5.get(i);
		...
		for(int i=0; i<ds.curlist6.size(); i++){
			AD_TAX_1000_MCURLIST6Record rec = (AD_TAX_1000_MCURLIST6Record)ds.curlist6.get(i);
		...
		rx.add( tempData , "ern2" , ds.ern2);	
		rx.add( tempData , "dlco_nm2" , ds.dlco_nm2);	
		rx.add( tempData , "presi_nm2" , ds.presi_nm2);	
		rx.add( tempData , "addr2" , ds.addr2);	
		rx.add( tempData , "bizcond2" , ds.bizcond2);	
		rx.add( tempData , "item2" , ds.item2);			
