...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			FC_FUNC_7041_LCURLISTRecord rec = (FC_FUNC_7041_LCURLISTRecord)ds.curlist.get(i);
			...
			rx.add(record, "iyul", rec.iyul);
			rx.add(record, "totint", rec.totint);
			rx.add(record, "dlco_nm", rec.dlco_nm);
			rx.add(record, "cigbnm", rec.cigbnm);
		}
