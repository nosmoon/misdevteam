...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			FC_FUNC_6071_LCURLISTRecord rec = (FC_FUNC_6071_LCURLISTRecord)ds.curlist.get(i);
			...
			rx.add(record, "prepay_insfee", rec.prepay_insfee);
			rx.add(record, "insfee", rec.insfee);
			rx.add(record, "insr_amt1", rec.insr_amt1);
			rx.add(record, "isav_amt1", rec.isav_amt1);
			rx.add(record, "insr_amt2", rec.insr_amt2);
			rx.add(record, "isav_amt2", rec.isav_amt2);
		}
