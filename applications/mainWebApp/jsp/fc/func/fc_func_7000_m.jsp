...
<%
	...
	try {
		...
		for(int i = 0; i < ds.xx_budg_cd_list.size(); i++) {
			FC_FUNC_7000_MXX_BUDG_CD_LISTRecord rec = (FC_FUNC_7000_MXX_BUDG_CD_LISTRecord)ds.xx_budg_cd_list.get(i);
		...
		for(int i = 0; i < ds.curlist4.size(); i++) {
			FC_FUNC_7000_MCURLIST4Record rec = (FC_FUNC_7000_MCURLIST4Record)ds.curlist4.get(i);
			int record = rx.add(recordSet, "record", "");
		...
		for(int i = 0; i < ds.curlist3.size(); i++) {
			FC_FUNC_7000_MCURLIST3Record rec = (FC_FUNC_7000_MCURLIST3Record)ds.curlist3.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cd", rec.cd);
			rx.add(record, "cdnm", rec.cdnm);
			rx.add(record, "cd_abrv_nm", rec.cd_abrv_nm);
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			FC_FUNC_7000_MCURLIST2Record rec = (FC_FUNC_7000_MCURLIST2Record)ds.curlist2.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cd", rec.cd);
			rx.add(record, "cdnm", rec.cdnm);
			rx.add(record, "cd_abrv_nm", rec.cd_abrv_nm);
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			FC_FUNC_7000_MCURLIST1Record rec = (FC_FUNC_7000_MCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cd", rec.cd);
			rx.add(record, "cdnm", rec.cdnm);
			rx.add(record, "cd_abrv_nm", rec.cd_abrv_nm);
		...
		for(int i = 0; i < ds.curlist6.size(); i++) {
			FC_FUNC_7000_MCURLIST6Record rec = (FC_FUNC_7000_MCURLIST6Record)ds.curlist6.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cd", rec.cd);
			rx.add(record, "cdnm", rec.cdnm);
			rx.add(record, "cd_abrv_nm", rec.cd_abrv_nm);
		...
		for(int i = 0; i < ds.curlist5.size(); i++) {
			FC_FUNC_7000_MCURLIST5Record rec = (FC_FUNC_7000_MCURLIST5Record)ds.curlist5.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cd", rec.cd);
			rx.add(record, "cdnm", rec.cdnm);
			rx.add(record, "cd_abrv_nm", rec.cd_abrv_nm);
