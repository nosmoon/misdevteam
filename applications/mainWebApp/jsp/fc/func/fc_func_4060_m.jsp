...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			FC_FUNC_4060_MCURLISTRecord rec = (FC_FUNC_4060_MCURLISTRecord)ds.curlist.get(i);
		...
		for(int i = 0; i < ds.xx_stat_cd_list.size(); i++) {
			FC_FUNC_4060_MXX_STAT_CD_LISTRecord rec = (FC_FUNC_4060_MXX_STAT_CD_LISTRecord)ds.xx_stat_cd_list.get(i);
			int record = rx.add(recordSet, "record", "");
...
<% /* 작성시간 : Thu Jun 04 14:43:11 KST 2009 */ %>