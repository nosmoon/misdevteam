...
<%
	RwXml rx = new RwXml();
	FC_FUNC_6520_MDataSet ds = (FC_FUNC_6520_MDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.deps_isav_clsf_cd.size(); i++) {
			FC_FUNC_6520_MDEPS_ISAV_CLSF_CDRecord rec = (FC_FUNC_6520_MDEPS_ISAV_CLSF_CDRecord)ds.deps_isav_clsf_cd.get(i);
