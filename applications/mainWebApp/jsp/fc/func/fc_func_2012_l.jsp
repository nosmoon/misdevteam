...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			FC_FUNC_2012_LCURLISTRecord rec = (FC_FUNC_2012_LCURLISTRecord)ds.curlist.get(i);
			...
			rx.add(record, "yugaint2", rec.yugaint2);
			...
			//rx.add(record, "yugaint2", StringUtil.replaceToXml(rec.yugaint2));
		}
