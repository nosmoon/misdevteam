...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			FC_ACCT_8072_LCURLIST2Record rec = (FC_ACCT_8072_LCURLIST2Record)ds.curlist2.get(i);
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			FC_ACCT_8072_LCURLISTRecord rec = (FC_ACCT_8072_LCURLISTRecord)ds.curlist.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "inwoncnt", rec.inwoncnt);
			rx.add(record, "w_tcnt", rec.w_tcnt);
			rx.add(record, "totamt", rec.totamt);
...
<% /* 작성시간 : Thu Nov 20 14:56:20 KST 2014 */ %>