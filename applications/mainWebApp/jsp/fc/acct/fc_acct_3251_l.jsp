...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			FC_ACCT_3251_LCURLIST1Record rec = (FC_ACCT_3251_LCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "slip_arow_no", rec.slip_arow_no);
			rx.add(record, "budg_cd", rec.budg_cd);
			rx.addCData(record, "pch_sdysnm", rec.pch_sdysnm);
			...
			rx.addCData(record, "mang_clsf_nm", rec.mang_clsf_nm);
			...
			rx.addCData(record, "pch_dsacctnm", rec.pch_dsacctnm);
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			FC_ACCT_3251_LCURLISTRecord rec = (FC_ACCT_3251_LCURLISTRecord)ds.curlist.get(i);
			int record = rx.add(recordSet, "record", "");
