...
<%
	...
	rx.add(dataSet, "xx_dlco_cd_l", ds.xx_dlco_cd_l);	
	rx.add(dataSet, "xx_job_clsf_02", ds.xx_job_clsf_02);	
	rx.add(dataSet, "xx_cd_clsf_020", ds.xx_cd_clsf_020);	
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			FC_ACCT_1190_MCURLISTRecord rec = (FC_ACCT_1190_MCURLISTRecord)ds.curlist.get(i);
...
<% /* 작성시간 : Thu Jul 16 19:42:12 KST 2009 */ %>