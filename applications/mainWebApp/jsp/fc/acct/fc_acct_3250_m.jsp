...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			FC_ACCT_3250_MCURLIST1Record rec = (FC_ACCT_3250_MCURLIST1Record)ds.curlist1.get(i);
		...
		for(int i = 0; i < ds.cur_incm_clsf_list.size(); i++) {
			FC_ACCT_3250_MCUR_INCM_CLSF_LISTRecord rec = (FC_ACCT_3250_MCUR_INCM_CLSF_LISTRecord)ds.cur_incm_clsf_list.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cd", rec.cd);
		...
		for(int i = 0; i < ds.curlist3.size(); i++) {
			FC_ACCT_3250_MCURLIST3Record rec = (FC_ACCT_3250_MCURLIST3Record)ds.curlist3.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cd", rec.cd);
			rx.add(record, "cdnm", rec.cdnm);
			rx.add(record, "cd_abrv_nm", rec.cd_abrv_nm);
