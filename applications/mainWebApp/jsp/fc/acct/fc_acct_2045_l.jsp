...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			FC_ACCT_2045_LCURLIST1Record rec = (FC_ACCT_2045_LCURLIST1Record)ds.curlist1.get(i);
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			FC_ACCT_2045_LCURLISTRecord rec = (FC_ACCT_2045_LCURLISTRecord)ds.curlist.get(i);
			int record = rx.add(recordSet, "record", "");
