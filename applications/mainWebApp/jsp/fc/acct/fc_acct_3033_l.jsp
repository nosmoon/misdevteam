...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curinsrfeelist.size(); i++) {
			FC_ACCT_3033_LCURINSRFEELISTRecord rec = (FC_ACCT_3033_LCURINSRFEELISTRecord)ds.curinsrfeelist.get(i);
		...
		for(int i = 0; i < ds.curtotallist.size(); i++) {
			FC_ACCT_3033_LCURTOTALLISTRecord rec = (FC_ACCT_3033_LCURTOTALLISTRecord)ds.curtotallist.get(i);
			int record = rx.add(recordSet, "record", "");
