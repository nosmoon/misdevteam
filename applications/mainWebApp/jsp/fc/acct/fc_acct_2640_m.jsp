...
<%
	...
	try {
		...
		for(int i = 0; i < ds.cur_slip_clsf_list.size(); i++) {
			FC_ACCT_2640_MCUR_SLIP_CLSF_LISTRecord rec = (FC_ACCT_2640_MCUR_SLIP_CLSF_LISTRecord)ds.cur_slip_clsf_list.get(i);
		...
		for(int i = 0; i < ds.cur_dlco_list.size(); i++) {
			FC_ACCT_2640_MCUR_DLCO_LISTRecord rec = (FC_ACCT_2640_MCUR_DLCO_LISTRecord)ds.cur_dlco_list.get(i);
		...
		for(int i = 0; i < ds.cur_clsf_list.size(); i++) {
			FC_ACCT_2640_MCUR_CLSF_LISTRecord rec = (FC_ACCT_2640_MCUR_CLSF_LISTRecord)ds.cur_clsf_list.get(i);
