...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist4.size(); i++) {
			FC_ACCT_2128_SCURLIST4Record rec = (FC_ACCT_2128_SCURLIST4Record)ds.curlist4.get(i);
		...
		for(int i = 0; i < ds.curlist3.size(); i++) {
			FC_ACCT_2128_SCURLIST3Record rec = (FC_ACCT_2128_SCURLIST3Record)ds.curlist3.get(i);
			int record = rx.add(recordSet, "record", "");
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			FC_ACCT_2128_SCURLIST2Record rec = (FC_ACCT_2128_SCURLIST2Record)ds.curlist2.get(i);
			int record = rx.add(recordSet, "record", "");
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			FC_ACCT_2128_SCURLIST1Record rec = (FC_ACCT_2128_SCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			FC_ACCT_2128_SCURLISTRecord rec = (FC_ACCT_2128_SCURLISTRecord)ds.curlist.get(i);
			int record = rx.add(recordSet, "record", "");
			//rx.add(record, "rcpm_amt", rec.rcpm_amt);
			rx.add(record, "rcpm_amt", StringUtil.replaceToXml(rec.rcpm_amt));
		}
