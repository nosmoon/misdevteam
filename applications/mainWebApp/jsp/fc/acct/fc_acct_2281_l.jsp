...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			FC_ACCT_2281_LCURLIST2Record rec = (FC_ACCT_2281_LCURLIST2Record)ds.curlist2.get(i);
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			FC_ACCT_2281_LCURLIST1Record rec = (FC_ACCT_2281_LCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cmpy_cd", rec.cmpy_cd);
