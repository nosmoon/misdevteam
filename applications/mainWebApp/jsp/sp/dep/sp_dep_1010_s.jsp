...
//대변
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			SP_DEP_1010_SCURLIST2Record rec = (SP_DEP_1010_SCURLIST2Record)ds.curlist2.get(i);
...
//차변:어음내역			
		...
		for(int i=0; i<ds.curlist1.size(); i++){ 
			SP_DEP_1010_SCURLIST1Record rec = (SP_DEP_1010_SCURLIST1Record)ds.curlist1.get(i);
...
//차변:계좌입금	
		...
		for(int i = 0; i < list_02.size(); i++) {
			SP_DEP_1010_SCURLIST2Record rec = (SP_DEP_1010_SCURLIST2Record)list_02.get(i);
...
//차변:현금
		...
		for(int i = 0; i < list_03.size(); i++) {
			SP_DEP_1010_SCURLIST2Record rec = (SP_DEP_1010_SCURLIST2Record)list_03.get(i);
...
//차변:선수금대체		
		...
		for(int i = 0; i < list_04.size(); i++) {
			SP_DEP_1010_SCURLIST2Record rec = (SP_DEP_1010_SCURLIST2Record)list_04.get(i);
...
//차변:예수금대체		
		...
		for(int i = 0; i < list_06.size(); i++) {
			SP_DEP_1010_SCURLIST2Record rec = (SP_DEP_1010_SCURLIST2Record)list_06.get(i);
...
//차변:기타입금대체		
		...
		for(int i = 0; i < list_07.size(); i++) {
			SP_DEP_1010_SCURLIST2Record rec = (SP_DEP_1010_SCURLIST2Record)list_07.get(i);
...
//대변:선수금
		...
		for(int i = 0; i < list_08.size(); i++) {
			SP_DEP_1010_SCURLIST2Record rec = (SP_DEP_1010_SCURLIST2Record)list_08.get(i);
			long	amt	=	StringUtil.toNumber(rec.amt);
...
//대변:예수금
		...
		for(int i = 0; i < list_09.size(); i++) {
			SP_DEP_1010_SCURLIST2Record rec = (SP_DEP_1010_SCURLIST2Record)list_09.get(i);
			long	amt	=	StringUtil.toNumber(rec.amt);

			int record = rx.add(gridData7, "record", "");
			rx.add(record, "depo_job_clsf", rec.budg_cd);
			rx.add(record, "amt", amt);
			rx.add(record, "swit_dlco_nm", rec.dlco_nm);
			rx.add(record, "swit_dlco", rec.dlco_no);
			rx.add(record, "occr_dt", rec.occr_dt);
...
//대변:기타입금
		...
		for(int i = 0; i < list_10.size(); i++) {
			SP_DEP_1010_SCURLIST2Record rec = (SP_DEP_1010_SCURLIST2Record)list_10.get(i);
			long	amt	=	StringUtil.toNumber(rec.amt);
