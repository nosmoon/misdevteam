...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			SP_SAL_2800_MCURLIST2Record rec = (SP_SAL_2800_MCURLIST2Record)ds.curlist2.get(i);
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			SP_SAL_2800_MCURLIST1Record rec = (SP_SAL_2800_MCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
