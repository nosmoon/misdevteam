...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist_2.size(); i++) {
			SP_SAL_2200_MCURLIST_2Record rec = (SP_SAL_2200_MCURLIST_2Record)ds.curlist_2.get(i);
		...
		for(int i = 0; i < ds.curlist_1.size(); i++) {
			SP_SAL_2200_MCURLIST_1Record rec = (SP_SAL_2200_MCURLIST_1Record)ds.curlist_1.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cd", rec.cd);
			rx.add(record, "cdnm", rec.cdnm);
			rx.add(record, "cd_abrv_nm", rec.cd_abrv_nm);
