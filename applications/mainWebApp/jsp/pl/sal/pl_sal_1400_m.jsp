...
<%
	...
	try {
		...
		for(int i = 0; i < ds.sale_clsfcur.size(); i++) {
			PL_SAL_1400_MSALE_CLSFCURRecord rec = (PL_SAL_1400_MSALE_CLSFCURRecord)ds.sale_clsfcur.get(i);
		...
		for(int i = 0; i < ds.sendclsfcur.size(); i++) {
			PL_SAL_1400_MSENDCLSFCURRecord rec = (PL_SAL_1400_MSENDCLSFCURRecord)ds.sendclsfcur.get(i);
		...
		for(int i = 0; i < ds.medi_clsfcur.size(); i++) {
			PL_SAL_1400_MMEDI_CLSFCURRecord rec = (PL_SAL_1400_MMEDI_CLSFCURRecord)ds.medi_clsfcur.get(i);
		...
		for(int i = 0; i < ds.wh_cdcur.size(); i++) {
			PL_SAL_1400_MWH_CDCURRecord rec = (PL_SAL_1400_MWH_CDCURRecord)ds.wh_cdcur.get(i);
		...
		for(int i = 0; i < ds.sell_typecur.size(); i++) {
			PL_SAL_1400_MSELL_TYPECURRecord rec = (PL_SAL_1400_MSELL_TYPECURRecord)ds.sell_typecur.get(i);
		...
		for(int i = 0; i < ds.medi_cdcur.size(); i++) {
			PL_SAL_1400_MMEDI_CDCURRecord rec = (PL_SAL_1400_MMEDI_CDCURRecord)ds.medi_cdcur.get(i);
		...
		for(int i = 0; i < ds.ordr_ptcrcur.size(); i++) {
			PL_SAL_1400_MORDR_PTCRCURRecord rec = (PL_SAL_1400_MORDR_PTCRCURRecord)ds.ordr_ptcrcur.get(i);
