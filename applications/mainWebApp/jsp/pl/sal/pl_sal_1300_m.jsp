...
<%
	...
	try {
		...
		for(int i = 0; i < ds.sale_clsfcur.size(); i++) {
			PL_SAL_1300_MSALE_CLSFCURRecord rec = (PL_SAL_1300_MSALE_CLSFCURRecord)ds.sale_clsfcur.get(i);
		...
		for(int i = 0; i < ds.sendclsfcur.size(); i++) {
			PL_SAL_1300_MSENDCLSFCURRecord rec = (PL_SAL_1300_MSENDCLSFCURRecord)ds.sendclsfcur.get(i);
		...
		for(int i = 0; i < ds.medi_clsfcur.size(); i++) {
			PL_SAL_1300_MMEDI_CLSFCURRecord rec = (PL_SAL_1300_MMEDI_CLSFCURRecord)ds.medi_clsfcur.get(i);
		...
		for(int i = 0; i < ds.wh_cdcur.size(); i++) {
			PL_SAL_1300_MWH_CDCURRecord rec = (PL_SAL_1300_MWH_CDCURRecord)ds.wh_cdcur.get(i);
		...
		for(int i = 0; i < ds.sell_typecur.size(); i++) {
			PL_SAL_1300_MSELL_TYPECURRecord rec = (PL_SAL_1300_MSELL_TYPECURRecord)ds.sell_typecur.get(i);
		...
		for(int i = 0; i < ds.medi_cdcur.size(); i++) {
			PL_SAL_1300_MMEDI_CDCURRecord rec = (PL_SAL_1300_MMEDI_CDCURRecord)ds.medi_cdcur.get(i);
		...
		for(int i = 0; i < ds.deal_ptcrcur.size(); i++) {
			PL_SAL_1300_MDEAL_PTCRCURRecord rec = (PL_SAL_1300_MDEAL_PTCRCURRecord)ds.deal_ptcrcur.get(i);
