...
<%
	...
	try {
		...
		for(int i = 0; i < ds.sendclsfcur.size(); i++) {
			PL_SAL_3100_MSENDCLSFCURRecord rec = (PL_SAL_3100_MSENDCLSFCURRecord)ds.sendclsfcur.get(i);
		...
		for(int i = 0; i < ds.dlco_clsfcur.size(); i++) {
			PL_SAL_3100_MDLCO_CLSFCURRecord rec = (PL_SAL_3100_MDLCO_CLSFCURRecord)ds.dlco_clsfcur.get(i);
		...
		for(int i = 0; i < ds.medi_clsfcur.size(); i++) {
			PL_SAL_3100_MMEDI_CLSFCURRecord rec = (PL_SAL_3100_MMEDI_CLSFCURRecord)ds.medi_clsfcur.get(i);
		...
		for(int i = 0; i < ds.medi_cdcur.size(); i++) {
			PL_SAL_3100_MMEDI_CDCURRecord rec = (PL_SAL_3100_MMEDI_CDCURRecord)ds.medi_cdcur.get(i);
