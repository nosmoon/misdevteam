...
<%
	...
	try {
		...
		for(int i = 0; i < ds.issu_cmpycur.size(); i++) {
			PL_BAS_1000_MISSU_CMPYCURRecord rec = (PL_BAS_1000_MISSU_CMPYCURRecord)ds.issu_cmpycur.get(i);
		...
		for(int i = 0; i < ds.medi_cdcur.size(); i++) {
			PL_BAS_1000_MMEDI_CDCURRecord rec = (PL_BAS_1000_MMEDI_CDCURRecord)ds.medi_cdcur.get(i);
		...
		for(int i = 0; i < ds.typecur.size(); i++) {
			PL_BAS_1000_MTYPECURRecord rec = (PL_BAS_1000_MTYPECURRecord)ds.typecur.get(i);
		...
		for(int i = 0; i < ds.ecntcur.size(); i++) {
			PL_BAS_1000_MECNTCURRecord rec = (PL_BAS_1000_MECNTCURRecord)ds.ecntcur.get(i);
		...
		for(int i = 0; i < ds.ewh_clsfcur.size(); i++) {
			PL_BAS_1000_MEWH_CLSFCURRecord rec = (PL_BAS_1000_MEWH_CLSFCURRecord)ds.ewh_clsfcur.get(i);
		...
		for(int i = 0; i < ds.wh_cdcur.size(); i++) {
			PL_BAS_1000_MWH_CDCURRecord rec = (PL_BAS_1000_MWH_CDCURRecord)ds.wh_cdcur.get(i);
