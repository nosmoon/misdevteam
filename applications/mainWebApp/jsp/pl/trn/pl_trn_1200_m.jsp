...
<%
	...
	try {
		...
		for(int i = 0; i < ds.wh_cdcur.size(); i++) {
			PL_TRN_1200_MWH_CDCURRecord rec = (PL_TRN_1200_MWH_CDCURRecord)ds.wh_cdcur.get(i);
		...
		for(int i = 0; i < ds.medi_cdcur.size(); i++) {
			PL_TRN_1200_MMEDI_CDCURRecord rec = (PL_TRN_1200_MMEDI_CDCURRecord)ds.medi_cdcur.get(i);
		...
		for(int i = 0; i < ds.deal_ptcrcur.size(); i++) {
			PL_TRN_1200_MDEAL_PTCRCURRecord rec = (PL_TRN_1200_MDEAL_PTCRCURRecord)ds.deal_ptcrcur.get(i);
