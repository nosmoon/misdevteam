...
<%
	...
	try {
		...
		for(int i = 0; i < ds.dlco_clsfcur.size(); i++) {
			PL_COM_1000_MDLCO_CLSFCURRecord rec = (PL_COM_1000_MDLCO_CLSFCURRecord)ds.dlco_clsfcur.get(i);
		...
		for(int i = 0; i < ds.areacur.size(); i++) {
			PL_COM_1000_MAREACURRecord rec = (PL_COM_1000_MAREACURRecord)ds.areacur.get(i);
		...
		for(int i = 0; i < ds.prv_curr_clsfcur.size(); i++) {
			PL_COM_1000_MPRV_CURR_CLSFCURRecord rec = (PL_COM_1000_MPRV_CURR_CLSFCURRecord)ds.prv_curr_clsfcur.get(i);
