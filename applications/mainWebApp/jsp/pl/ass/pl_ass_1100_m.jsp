...
<%
	...
	try {
		...
		for(int i = 0; i < ds.sale_clsfcur.size(); i++) {
			PL_ASS_1100_MSALE_CLSFCURRecord rec = (PL_ASS_1100_MSALE_CLSFCURRecord)ds.sale_clsfcur.get(i);
		...
		for(int i = 0; i < ds.sendclsfcur.size(); i++) {
			PL_ASS_1100_MSENDCLSFCURRecord rec = (PL_ASS_1100_MSENDCLSFCURRecord)ds.sendclsfcur.get(i);
		...
		for(int i = 0; i < ds.medi_cdcur.size(); i++) {
			PL_ASS_1100_MMEDI_CDCURRecord rec = (PL_ASS_1100_MMEDI_CDCURRecord)ds.medi_cdcur.get(i);
		...
		for(int i = 0; i < ds.wh_cdcur.size(); i++) {
			PL_ASS_1100_MWH_CDCURRecord rec = (PL_ASS_1100_MWH_CDCURRecord)ds.wh_cdcur.get(i);
		...
		for(int i = 0; i < ds.sell_typecur.size(); i++) {
			PL_ASS_1100_MSELL_TYPECURRecord rec = (PL_ASS_1100_MSELL_TYPECURRecord)ds.sell_typecur.get(i);
		...
		for(int i = 0; i < ds.decid_linecur.size(); i++) {
			PL_ASS_1100_MDECID_LINECURRecord rec = (PL_ASS_1100_MDECID_LINECURRecord)ds.decid_linecur.get(i);
