...
<%
	...
	try {
		...
		rx.add(ASIN_DTLINFO, "ref_ser_no_1", ds.ref_ser_no_1);
		rx.add(ASIN_DTLINFO, "ref_ser_no_2", ds.ref_ser_no_2);
		rx.add(ASIN_DTLINFO, "basi_bgn_ser_no", ds.basi_bgn_ser_no);
		rx.add(ASIN_DTLINFO, "basi_end_ser_no", ds.basi_end_ser_no);
		rx.add(ASIN_DTLINFO, "prd", ds.prd);
		rx.addCData(ASIN_DTLINFO, "remk", ds.remk);
		...
		for(int i = 0; i < ds.asin_plancur.size(); i++) {
			PL_ASS_1020_LASIN_PLANCURRecord rec = (PL_ASS_1020_LASIN_PLANCURRecord)ds.asin_plancur.get(i);
