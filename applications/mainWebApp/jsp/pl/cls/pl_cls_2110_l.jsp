...
<%
	RwXml rx = new RwXml();
	PL_CLS_2110_LDataSet ds = (PL_CLS_2110_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.ptcrlist.size(); i++) {
			PL_CLS_2110_LPTCRLISTRecord rec = (PL_CLS_2110_LPTCRLISTRecord)ds.ptcrlist.get(i);
