...
<%
	...
	try {
		...
		for(int i = 0; i < ds.ptcrlist.size(); i++) {
			PL_RCP_3110_LPTCRLISTRecord rec = (PL_RCP_3110_LPTCRLISTRecord)ds.ptcrlist.get(i);
			...
			rx.addCData(record, "budg_nm", StringUtil.replaceToXml(rec.budg_nm));
