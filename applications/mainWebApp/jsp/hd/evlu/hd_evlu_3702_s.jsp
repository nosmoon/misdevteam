...
<%
	...
	int asst_evlu_opn = rx.add(dataSet, "asst_evlu_opn", ds.asst_evlu_opn);
	...
	int evlu_cmpt_opn_1tms = rx.add(dataSet, "evlu_cmpt_opn_1tms", ds.evlu_cmpt_opn_1tms);
	int tmp_grad = rx.add(dataSet, "tmp_grad", ds.tmp_grad);
	int evlu_pers_meda_opn_2tms = rx.add(dataSet, "evlu_pers_meda_opn_2tms", ds.evlu_pers_meda_opn_2tms);
	int evlu_pers_deci_grad_2tms = rx.add(dataSet, "evlu_pers_deci_grad_2tms", ds.evlu_pers_deci_grad_2tms);
	...
	try {
		...
		for(int i = 0; i < ds.curlist4.size(); i++) {
			HD_EVLU_3702_SCURLIST4Record rec = (HD_EVLU_3702_SCURLIST4Record)ds.curlist4.get(i);
		...
		for(int i = 0; i < ds.curlist3.size(); i++) {
			HD_EVLU_3702_SCURLIST3Record rec = (HD_EVLU_3702_SCURLIST3Record)ds.curlist3.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cdnm", rec.cdnm);
			rx.add(record, "act_indx_def", rec.act_indx_def);
		}
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			HD_EVLU_3702_SCURLIST2Record rec = (HD_EVLU_3702_SCURLIST2Record)ds.curlist2.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cdnm", rec.cdnm);
			rx.add(record, "act_indx_def", rec.act_indx_def);
		}
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			HD_EVLU_3702_SCURLIST1Record rec = (HD_EVLU_3702_SCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cdnm", rec.cdnm);
			rx.add(record, "act_indx_def", rec.act_indx_def);
		}
		...
		for(int i = 0; i < ds.curlist5.size(); i++) {
			HD_EVLU_3702_SCURLIST5Record rec = (HD_EVLU_3702_SCURLIST5Record)ds.curlist5.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cdnm", rec.cdnm);
			rx.add(record, "act_indx_def", rec.act_indx_def);
		}
...
<% /* 작성시간 : Tue Jul 28 17:51:54 KST 2009 */ %>