...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist4.size(); i++) {
			HD_EVLU_3103_500_SCURLIST4Record rec = (HD_EVLU_3103_500_SCURLIST4Record)ds.curlist4.get(i);
		...
		for(int i = 0; i < ds.curlist3.size(); i++) {
			HD_EVLU_3103_500_SCURLIST3Record rec = (HD_EVLU_3103_500_SCURLIST3Record)ds.curlist3.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cdnm", rec.cdnm);
			rx.add(record, "act_indx_def", rec.act_indx_def);
			//rx.add(record, "cdnm", StringUtil.replaceToXml(rec.cdnm));
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			HD_EVLU_3103_500_SCURLIST2Record rec = (HD_EVLU_3103_500_SCURLIST2Record)ds.curlist2.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cdnm", rec.cdnm);
			rx.add(record, "act_indx_def", rec.act_indx_def);
			//rx.add(record, "cdnm", StringUtil.replaceToXml(rec.cdnm));
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			HD_EVLU_3103_500_SCURLIST1Record rec = (HD_EVLU_3103_500_SCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cdnm", rec.cdnm);
			rx.add(record, "act_indx_def", rec.act_indx_def);
			//rx.add(record, "cdnm", StringUtil.replaceToXml(rec.cdnm));
		...
		for(int i = 0; i < ds.curlist5.size(); i++) {
			HD_EVLU_3103_500_SCURLIST5Record rec = (HD_EVLU_3103_500_SCURLIST5Record)ds.curlist5.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cdnm", rec.cdnm);
			rx.add(record, "act_indx_def", rec.act_indx_def);
			//rx.add(record, "cdnm", StringUtil.replaceToXml(rec.cdnm));
