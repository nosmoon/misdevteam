...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_EVLU_3102_500_LCURLISTRecord rec = (HD_EVLU_3102_500_LCURLISTRecord)ds.curlist.get(i);
			...
			//rx.add(record, "self_evlu_proc_stat", StringUtil.replaceToXml(rec.self_evlu_proc_stat));
			//rx.add(record, "asst_evlu_proc_stat", StringUtil.replaceToXml(rec.asst_evlu_proc_stat));
