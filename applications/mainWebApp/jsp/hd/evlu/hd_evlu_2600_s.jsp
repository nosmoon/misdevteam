...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			HD_EVLU_2600_SCURLIST2Record rec = (HD_EVLU_2600_SCURLIST2Record)ds.curlist2.get(i);
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			HD_EVLU_2600_SCURLIST1Record rec = (HD_EVLU_2600_SCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cdnm", rec.cdnm);
			rx.add(record, "act_indx_def", rec.act_indx_def);
		}
