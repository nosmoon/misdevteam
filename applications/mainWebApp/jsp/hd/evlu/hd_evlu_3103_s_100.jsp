...
<%
	...
	int dept_nm	= rx.addCData(dataSet, "dept_nm", ds.dept_nm);
	int grp_nm1	= rx.addCData(dataSet, "grp_nm1", ds.grp_nm1);
	int grp_nm2	= rx.addCData(dataSet, "grp_nm2", ds.grp_nm1);
	...
	int evlu_prz_nm = rx.addCData(dataSet, "evlu_prz_nm", ds.evlu_prz_nm ); //20160725_신규추가 
	int evlu_dp_nm = rx.addCData(dataSet, "evlu_dp_nm", ds.evlu_dp_nm ); //20160725_신규추가
	int evlu_dp_scorcnt = rx.add(dataSet, "evlu_dp_scorcnt", ds.evlu_dp_scorcnt ); //20160725_신규추가
 ...
 System.out.println("evlu_proc_stat_1tms " + evlu_proc_stat_1tms + " : " + ds.evlu_proc_stat_1tms);
	...
	try {
		...
		for(int i = 0; i < ds.curlist4.size(); i++) {
			HD_EVLU_3103_S_100CURLIST4Record rec = (HD_EVLU_3103_S_100CURLIST4Record)ds.curlist4.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cdnm", rec.cdnm);
			rx.addCData(record, "act_indx_def", rec.act_indx_def);
		}
		...
		for(int i = 0; i < ds.curlist3.size(); i++) {
			HD_EVLU_3103_S_100CURLIST3Record rec = (HD_EVLU_3103_S_100CURLIST3Record)ds.curlist3.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cdnm", rec.cdnm);
			rx.addCData(record, "act_indx_def", rec.act_indx_def);
		}
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			HD_EVLU_3103_S_100CURLIST2Record rec = (HD_EVLU_3103_S_100CURLIST2Record)ds.curlist2.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cdnm", rec.cdnm);
			rx.addCData(record, "act_indx_def", rec.act_indx_def);
		}
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			HD_EVLU_3103_S_100CURLIST1Record rec = (HD_EVLU_3103_S_100CURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cdnm", rec.cdnm);
			rx.addCData(record, "act_indx_def", rec.act_indx_def);
		}
		...
		for(int i = 0; i < ds.curlist5.size(); i++) {
			HD_EVLU_3103_S_100CURLIST5Record rec = (HD_EVLU_3103_S_100CURLIST5Record)ds.curlist5.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cdnm", rec.cdnm);
			rx.addCData(record, "act_indx_def", rec.act_indx_def);
		}
