...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_SALY_3313_326_LCURLISTRecord rec = (HD_SALY_3313_326_LCURLISTRecord)ds.curlist.get(i);
			...
			//rx.add(record, "jybhr", StringUtil.replaceToXml(rec.jybhr));
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			HD_SALY_3313_326_LCURLIST1Record rec = (HD_SALY_3313_326_LCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
			...
			//rx.add(record, "etc_saly_nm", StringUtil.replaceToXml(rec.etc_saly_nm));
			//rx.add(record, "etc_saly_cd", StringUtil.replaceToXml(rec.etc_saly_cd));
...
<% /* 작성시간 : Thu Oct 16 16:23:53 KST 2014 */ %>