...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_SALY_3200_LCURLISTRecord rec = (HD_SALY_3200_LCURLISTRecord)ds.curlist.get(i);
			...
			rx.add(record, "base_stay_fee", rec.base_stay_fee);
			...
			//rx.add(record, "base_stay_fee", StringUtil.replaceToXml(rec.base_stay_fee));
