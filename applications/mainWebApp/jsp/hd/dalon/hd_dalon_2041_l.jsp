...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			HD_DALON_2041_LCURLIST1Record rec = (HD_DALON_2041_LCURLIST1Record)ds.curlist1.get(i);
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_DALON_2041_LCURLISTRecord rec = (HD_DALON_2041_LCURLISTRecord)ds.curlist.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cmpy_cd", rec.cmpy_cd);
			rx.add(record, "emp_no", rec.emp_no);
			rx.add(record, "flnm", rec.flnm);
			...
			rx.add(record, "prvdd_prsnt_tm", rec.prsnt_tm);
			rx.add(record, "prvdd_finish_tm", rec.finish_tm);
