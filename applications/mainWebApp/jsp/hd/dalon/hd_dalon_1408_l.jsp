...
<%
	RwXml rx = new RwXml();
	HD_DALON_1408_LDataSet ds = (HD_DALON_1408_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_DALON_1408_LCURLISTRecord rec = (HD_DALON_1408_LCURLISTRecord)ds.curlist.get(i);
			...
			System.out.println("session_dept_cd = "+rec.session_dept_cd);
