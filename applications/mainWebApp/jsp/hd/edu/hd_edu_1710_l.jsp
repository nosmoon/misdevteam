...
<%
	RwXml rx = new RwXml();
	HD_EDU_1710_LDataSet ds = (HD_EDU_1710_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			...
			HD_EDU_1710_LCURLISTRecord rec = (HD_EDU_1710_LCURLISTRecord)ds.curlist.get(i);
			...
			rx.addCData(record, "edu_tm_clsf_nm", rec.edu_tm_clsf_nm);
			rx.addCData(record, "edu_fr_tm", rec.edu_fr_tm);
			rx.addCData(record, "edu_to_tm", rec.edu_to_tm);			
			rx.add(record, "edu_cost", rec.edu_cost);
			rx.addCData(record, "edu_sply_cost", rec.edu_sply_cost);			
			rx.addCData(record, "course_nm", rec.course_nm);
			rx.addCData(record, "lang_nm", rec.lang_nm);
