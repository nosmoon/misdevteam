...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			HD_AFFR_1700_LCURLIST2Record rec = (HD_AFFR_1700_LCURLIST2Record)ds.curlist2.get(i);
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			HD_AFFR_1700_LCURLIST1Record rec = (HD_AFFR_1700_LCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "item", "");
