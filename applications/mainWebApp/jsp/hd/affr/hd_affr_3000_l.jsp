...
<%
	RwXml rx = new RwXml();
	HD_AFFR_3000_LDataSet ds = (HD_AFFR_3000_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_AFFR_3000_LCURLISTRecord rec = (HD_AFFR_3000_LCURLISTRecord)ds.curlist.get(i);
...
<% /* 작성시간 : Mon Mar 30 21:39:51 KST 2009 */ %>