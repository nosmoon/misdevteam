...
<%
	...
	try {
		...
		rx.add(dataSet, "xx_chk_obj_pers_rshp", ds.getXx_chk_obj_pers_rshp());
		
		/****** XX_COMBO_010 BEGIN */
		recordSet = rx.add(dataSet, "XX_COMBO_010", "");

		for(int i = 0; i < ds.xx_combo_010.size(); i++) {
			HD_AFFR_24000_MXX_COMBO_010Record rec = (HD_AFFR_24000_MXX_COMBO_010Record)ds.xx_combo_010.get(i);
