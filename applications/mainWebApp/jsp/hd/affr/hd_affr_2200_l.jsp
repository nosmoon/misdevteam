...
<%
	RwXml rx = new RwXml();
	HD_AFFR_2200_LDataSet ds = (HD_AFFR_2200_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_AFFR_2200_LCURLISTRecord rec = (HD_AFFR_2200_LCURLISTRecord)ds.curlist.get(i);
...
<% /* 작성시간 : Wed Mar 25 10:21:40 KST 2009 */ %>