...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			HD_LVCMPY_1007_LCURLIST2Record rec = (HD_LVCMPY_1007_LCURLIST2Record)ds.curlist2.get(i);
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			HD_LVCMPY_1007_LCURLIST1Record rec = (HD_LVCMPY_1007_LCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cmpy_cd", rec.cmpy_cd);
			rx.add(record, "emp_no", rec.emp_no);
