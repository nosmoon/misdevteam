...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			HD_SRCH_5511_LCURLIST1Record rec = (HD_SRCH_5511_LCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "yymm", rec.yymm);
			rx.add(record, "human_resour_1", rec.human_resour_1);
			rx.add(record, "human_resour_2", rec.human_resour_2);
			rx.add(record, "tot_nops_cnt", rec.tot_nops_cnt);
			rx.add(record, "emp_clsf_30_cnt", rec.emp_clsf_30_cnt);
			rx.add(record, "emp_ratio", rec.emp_ratio);
			rx.add(record, "emp_fml_cnt", rec.emp_fml_cnt);
