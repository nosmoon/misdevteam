...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			...
			rx.add(record, "dty_order", rec.dty_order);
			rx.add(record, "posi_order", rec.posi_order);
			...
			//rx.add(record, "dty_order", StringUtil.replaceToXml(rec.dty_order));
			//rx.add(record, "posi_order", StringUtil.replaceToXml(rec.posi_order));
		}
...
<% /* 작성시간 : Mon Mar 25 11:51:13 KST 2013 */ %>