...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist4.size(); i++) {
			HD_YADJM_2014_1220_LCURLIST4Record rec = (HD_YADJM_2014_1220_LCURLIST4Record)ds.curlist4.get(i);
		...
		for(int i = 0; i < ds.curlist3.size(); i++) {
			HD_YADJM_2014_1220_LCURLIST3Record rec = (HD_YADJM_2014_1220_LCURLIST3Record)ds.curlist3.get(i);
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			HD_YADJM_2014_1220_LCURLIST2Record rec = (HD_YADJM_2014_1220_LCURLIST2Record)ds.curlist2.get(i);
			int record = rx.add(recordSet, "record", "");
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			HD_YADJM_2014_1220_LCURLIST1Record rec = (HD_YADJM_2014_1220_LCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "emp_no", rec.emp_no);
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_YADJM_2014_1220_LCURLISTRecord rec = (HD_YADJM_2014_1220_LCURLISTRecord)ds.curlist.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "adjm_rvrs_yy", rec.adjm_rvrs_yy);
		...
		for(int i = 0; i < ds.curlist6.size(); i++) {
			HD_YADJM_2014_1220_LCURLIST6Record rec = (HD_YADJM_2014_1220_LCURLIST6Record)ds.curlist6.get(i);
			int record = rx.add(recordSet, "record", "");
			...
			System.out.println("-----"+rec.add_file+"-------");
		...
		for(int i = 0; i < ds.curlist5.size(); i++) {
			HD_YADJM_2014_1220_LCURLIST5Record rec = (HD_YADJM_2014_1220_LCURLIST5Record)ds.curlist5.get(i);
			int record = rx.add(recordSet, "record", "");
