...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist4.size(); i++) {
			HD_YADJM_2018_1220_LCURLIST4Record rec = (HD_YADJM_2018_1220_LCURLIST4Record)ds.curlist4.get(i);
			...
			rx.add(record, "public_trans_amt_onta", rec.public_trans_amt_onta);
			rx.add(record, "public_trans_amt_etc", rec.public_trans_amt_etc);
			rx.add(record, "book_show_use_onta", rec.book_show_use_onta);
			rx.add(record, "book_show_use_etc", rec.book_show_use_etc);
			...
			//rx.add(record, "trad_mrkt_onta", StringUtil.replaceToXml(rec.trad_mrkt_onta));
			//rx.add(record, "trad_mrkt_etc", StringUtil.replaceToXml(rec.trad_mrkt_etc));
			//rx.add(record, "public_trans_amt_onta", StringUtil.replaceToXml(rec.public_trans_amt_onta));
			//rx.add(record, "public_trans_amt_etc", StringUtil.replaceToXml(rec.public_trans_amt_etc));
			//rx.add(record, "book_show_use_onta", StringUtil.replaceToXml(rec.book_show_use_onta));
			//rx.add(record, "book_show_use_etc", StringUtil.replaceToXml(rec.book_show_use_etc));
		}
		...
		for(int i = 0; i < ds.curlist3.size(); i++) {
			HD_YADJM_2018_1220_LCURLIST3Record rec = (HD_YADJM_2018_1220_LCURLIST3Record)ds.curlist3.get(i);
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			HD_YADJM_2018_1220_LCURLIST2Record rec = (HD_YADJM_2018_1220_LCURLIST2Record)ds.curlist2.get(i);
			int record = rx.add(recordSet, "record", "");
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			HD_YADJM_2018_1220_LCURLIST1Record rec = (HD_YADJM_2018_1220_LCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "emp_no", rec.emp_no);
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_YADJM_2018_1220_LCURLISTRecord rec = (HD_YADJM_2018_1220_LCURLISTRecord)ds.curlist.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "adjm_rvrs_yy", rec.adjm_rvrs_yy);
			...
			//rx.add(record, "hous_loan_tot_amt", StringUtil.replaceToXml(rec.hous_loan_tot_amt));
		...
		for(int i = 0; i < ds.curlist6.size(); i++) {
			HD_YADJM_2018_1220_LCURLIST6Record rec = (HD_YADJM_2018_1220_LCURLIST6Record)ds.curlist6.get(i);
			int record = rx.add(recordSet, "record", "");
		...
		for(int i = 0; i < ds.curlist5.size(); i++) {
			HD_YADJM_2018_1220_LCURLIST5Record rec = (HD_YADJM_2018_1220_LCURLIST5Record)ds.curlist5.get(i);
			int record = rx.add(recordSet, "record", "");
