...
<%
	RwXml rx = new RwXml();
	HD_YADJM_2016_1231_LDataSet ds = (HD_YADJM_2016_1231_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_YADJM_2016_1231_LCURLISTRecord rec = (HD_YADJM_2016_1231_LCURLISTRecord)ds.curlist.get(i);
...
<% /* 작성시간 : Thu Jan 14 19:55:53 KST 2016 */ %>