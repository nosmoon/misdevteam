...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_YADJM_2013_1250_LCURLISTRecord rec = (HD_YADJM_2013_1250_LCURLISTRecord)ds.curlist.get(i);
			...
			rx.add(record, "lvcmpy_pens_dduc", rec.lvcmpy_pens_dduc);
...
<% /* 작성시간 : Wed Jan 09 20:14:21 KST 2013 */ %>