...
<%
	RwXml rx = new RwXml();
	HD_YADJM_2016_5100_LDataSet ds = (HD_YADJM_2016_5100_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_YADJM_2016_5100_LCURLISTRecord rec = (HD_YADJM_2016_5100_LCURLISTRecord)ds.curlist.get(i);
