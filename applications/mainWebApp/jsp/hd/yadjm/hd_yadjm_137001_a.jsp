	...
	for (int i = 0; (part = multi.readNextPart()) != null; i++) {
		...
		if(part instanceof FilePart){
  		...
  		System.out.println("파일이  " );
			...
			//	TSSPdfTSTValidator.init( "/webstore/pub/ciis/webapps/WEB-INF/lib/cacerts", CertVerifyConst.NONE, null ); // 테스트 서버용 
...
%>
<jsp:forward page="/hd/yadjm/137001">
