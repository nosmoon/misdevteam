...
<%
	RwXml rx = new RwXml();
	HD_YADJM_2017_1221_LDataSet ds = (HD_YADJM_2017_1221_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_YADJM_2017_1221_LCURLISTRecord rec = (HD_YADJM_2017_1221_LCURLISTRecord)ds.curlist.get(i);
...
<% /* 작성시간 : Thu Jan 14 19:52:30 KST 2017 */ %>