...
<%
	RwXml rx = new RwXml();
	HD_YADJM_2017_1250_LDataSet ds = (HD_YADJM_2017_1250_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_YADJM_2017_1250_LCURLISTRecord rec = (HD_YADJM_2017_1250_LCURLISTRecord)ds.curlist.get(i);
