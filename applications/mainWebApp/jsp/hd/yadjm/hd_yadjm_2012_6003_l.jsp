...
<%
	RwXml rx = new RwXml();
	HD_YADJM_2012_6003_LDataSet ds = (HD_YADJM_2012_6003_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_YADJM_2012_6003_LCURLISTRecord rec = (HD_YADJM_2012_6003_LCURLISTRecord)ds.curlist.get(i);
