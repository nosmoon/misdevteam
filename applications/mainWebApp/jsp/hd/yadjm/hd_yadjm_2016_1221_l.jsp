...
<%
	RwXml rx = new RwXml();
	HD_YADJM_2016_1221_LDataSet ds = (HD_YADJM_2016_1221_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_YADJM_2016_1221_LCURLISTRecord rec = (HD_YADJM_2016_1221_LCURLISTRecord)ds.curlist.get(i);
