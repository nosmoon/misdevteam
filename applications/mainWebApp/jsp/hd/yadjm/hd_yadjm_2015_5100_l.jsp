...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_YADJM_2015_5100_LCURLISTRecord rec = (HD_YADJM_2015_5100_LCURLISTRecord)ds.curlist.get(i);
			...
			//rx.add(record, "hous_loan_amt_int_2015_15y_fn", StringUtil.replaceToXml(rec.hous_loan_amt_int_2015_15y_fn));
			//rx.add(record, "hous_loan_amt_int_2015_15y", StringUtil.replaceToXml(rec.hous_loan_amt_int_2015_15y));
			//rx.add(record, "hous_loan_amt_int_2015_15y_etc", StringUtil.replaceToXml(rec.hous_loan_amt_int_2015_15y_etc));
			//rx.add(record, "hous_loan_amt_int_2015_10y", StringUtil.replaceToXml(rec.hous_loan_amt_int_2015_10y));
		}
