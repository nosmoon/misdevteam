...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			HD_TRIP_1100_344_LCURLIST1Record rec = (HD_TRIP_1100_344_LCURLIST1Record)ds.curlist1.get(i);
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_TRIP_1100_344_LCURLISTRecord rec = (HD_TRIP_1100_344_LCURLISTRecord)ds.curlist.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "send", "");
