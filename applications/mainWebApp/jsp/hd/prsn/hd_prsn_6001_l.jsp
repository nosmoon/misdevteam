...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			HD_PRSN_6001_LCURLISTRecord rec = (HD_PRSN_6001_LCURLISTRecord)ds.curlist.get(i);
			...
			rx.add(record, "obj_flnm", rec.obj_flnm);
			rx.add(record, "prv_aprv_emp_no", rec.prv_aprv_emp_no);
			rx.add(record, "prv_aprv_flnm", rec.prv_aprv_flnm);
			rx.add(record, "aft_aprv_emp_no", rec.aft_aprv_emp_no);
			rx.add(record, "aft_aprv_flnm", rec.aft_aprv_flnm);
			...
			//rx.add(record, "obj_flnm", StringUtil.replaceToXml(rec.obj_flnm));
			//rx.add(record, "prv_aprv_emp_no", StringUtil.replaceToXml(rec.prv_aprv_emp_no));
			//rx.add(record, "prv_aprv_flnm", StringUtil.replaceToXml(rec.prv_aprv_flnm));
			//rx.add(record, "aft_aprv_emp_no", StringUtil.replaceToXml(rec.aft_aprv_emp_no));
			//rx.add(record, "aft_aprv_flnm", StringUtil.replaceToXml(rec.aft_aprv_flnm));
