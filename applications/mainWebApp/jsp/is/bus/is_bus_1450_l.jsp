...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist_a.size(); i++) {
			IS_BUS_1450_LCURLIST_ARecord rec = (IS_BUS_1450_LCURLIST_ARecord)ds.curlist_a.get(i);
			...
			//rx.add(record, "w_amt_2_rate", rec.w_amt_2_rate);
			rx.add(record, "w_amt_2_rate", DigitUtil.cutUnderPoint(rec.w_amt_2_rate,2));
			//rx.add(record, "w_amt_rate", rec.w_amt_rate);
			rx.add(record, "w_amt_rate", DigitUtil.cutUnderPoint(rec.w_amt_rate,2));
