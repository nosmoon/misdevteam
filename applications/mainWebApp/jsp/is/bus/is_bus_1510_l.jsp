...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist_a.size(); i++) {
			IS_BUS_1510_LCURLIST_ARecord rec = (IS_BUS_1510_LCURLIST_ARecord)ds.curlist_a.get(i);
			...
			rx.add(record, "jm_rst_amt_s", DigitUtil.cutUnderPoint(rec.jm_rst_amt_s,2));
		}
		/****** CURLIST_A END */
		
		/****** CURLIST_B BEGIN */
		for(int i = 0; i < ds.curlist_b.size(); i++) {
			IS_BUS_1510_LCURLIST_BRecord rec = (IS_BUS_1510_LCURLIST_BRecord)ds.curlist_b.get(i);
