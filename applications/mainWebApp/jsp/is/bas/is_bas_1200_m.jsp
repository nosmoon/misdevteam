...
<%
	...
	try {
		...
		for(int i = 0; i < ds.teamlist.size(); i++) {
			IS_BAS_1200_MTEAMLISTRecord rec = (IS_BAS_1200_MTEAMLISTRecord)ds.teamlist.get(i);
		...
		for(int i = 0; i < ds.partlist.size(); i++) {
			IS_BAS_1200_MPARTLISTRecord rec = (IS_BAS_1200_MPARTLISTRecord)ds.partlist.get(i);
			int record = rx.add(recordSet, "record"			, "");
			rx.add(record, "dept_cd", rec.dept_cd);
			rx.add(record, "dept_nm", rec.dept_nm);
		...
		/****** 검색조건 밑에 콤보_시작   */
		/****** TEAMLIST BEGIN */
		recordSet			= rx.add(formData	, "rf_teamlist"			, "");
		...
		/****** PARTLIST BEGIN */
		recordSet			= rx.add(formData	, "rf_partlist"		, "");
