...
* 수정자 : 김대섭
* 수정일자 : 2004-02-17
* 백업파일명 : ss_common_1101_l.jsp.backup.20040217
...
<select id=areacd_id name="areacd" onChange="area_name(this.options(this.selectedIndex).text);" class="sel_all">
<%if("true".equals(applySessionStr)){
	...
	if(areanmList.size() == 0){	// 지역코드,지역명 갯수가 없음.
		...
		out.println("<option value='' selected>전체</option>");
