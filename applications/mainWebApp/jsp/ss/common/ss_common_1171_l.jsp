...
<%
    ...
    if(ds.mmcur.size() < 1){
        request.setAttribute("appException", new AppException("ss_common_1171_l.jsp(1)","검색결과가 존재하지 않습니다."));
        pageContext.forward("/jsp/ss/comm_jsp/app_error.jsp");
    }

    SS_L_RDR_DTLS_SECHMMCURRecord rec1 = null; // 조회된 월분 목록을 가지는 레코드
