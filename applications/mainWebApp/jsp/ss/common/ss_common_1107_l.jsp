...
<%---------------------------------------------------------------------------------------------------
* 파일명 : ss_common_1107_l.jsp
* 기능 : 지국지원-공정위위약금-지역코드,코드명 목록 가져오기
* 작성일자 : 2003-11-20
* 작성자 : 김대섭
---------------------------------------------------------------------------------------------------%>
...
<select id=fct_frft_areacd_id name="areacd" class="sel_all">
...
<script>
    parent.document.all.fct_frft_areacd_id.outerHTML = fct_frft_areacd_id.outerHTML;
</script>
