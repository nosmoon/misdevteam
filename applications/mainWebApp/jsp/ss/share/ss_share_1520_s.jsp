...
function annc_update(){
	...
	if(ans == true)
	{
	    ...
	    // 액션을 "/ss/share/1530" 서블릿으로 보낸다
	    lo_form1.target = "_self";
	    lo_form1.action = "/ss/share/1530";
	    check_all(lo_form1);
	    lo_form1.submit();
	}
}
...
function annc_answer(){
	...
	lo_form1.rmsgdept.value = o_form2.rmsgdept_temp.value;

    // 액션을 "/ss/share/1560" 서블릿으로 보낸다
    lo_form1.target = "_self";
    lo_form1.action = "/ss/share/1560";
    lo_form1.submit();
...
function annc_recom(){
	...
	if(ans == true)
	{
	    ...
	    // 액션을 "/ss/share/1550" 서블릿으로 보낸다
	    lo_form1.target = "_self";
	    lo_form1.action = "/ss/share/1550";
	    lo_form1.submit();
	}
}
...
<form name="infoexg_update_form" method="post" action="" enctype="multipart/form-data">
	...
	<input type="hidden" name="brwscnt" value="<%= ds.getBrwscnt()%>">
	<input type="hidden" name="rmsgdept_temp" value="<%=ds.getRmsgdept()%>">
...
<%
	  writeDeptOpt(session, out, ds.buseolistOptHtml(ds.getRmsgdept()), true);
%>
      </select>
    </td>
  </tr>
...
<table width="830" border="0"  cellpadding="1" cellspacing="0" align="center">
  <tr>
    <td  height="25" bgcolor="#EBE9DC" class="title">이슈 게시판 상세내역</td>
  </tr>
  <tr>
    <td height="3">
      <!--여백-->
...
<table width="830" border="0" cellspacing="0" align="center" bgcolor="#FFFFFF" class="gray" cellpadding="2">
  ...
  <tr>
    ...
    <td class="gray" width="730" colspan="7">
    	<input name="titl" type="text" style="ime-mode:active;" size="90" class="text_box" value="<%= Util.checkString(ds.getTitl())%>">
    </td>
  </tr>
	<%
...
<table width="830" border="0" cellspacing="0" cellpadding="0" class="title2" align="center">
  ...
  <tr>
    <td align="center" height="24" bgcolor="#E8E8E8">
      <input type="image" id="answer_id" border="0" src="/html/comm_img/bu_re.gif" width="36" height="19" align="absmiddle" onclick="javascript:annc_answer()">
      <input type="image" id="update_id" border="0" src="/html/comm_img/bu_edit.gif" width="36" height="19" align="absmiddle" onclick="javascript:annc_update()">
      <input type="image" id="del_id" border="0" src="/html/comm_img/bu_del.gif" width="39" height="19" align="absmiddle" onclick="javascript:infoexg_delete()">
      <input type="image" id="recomm_id" border="0" src="/html/comm_img/bu_reco.gif" width="36" height="19" align="absmiddle" border="0" onclick="javascript:annc_recom()">
    </td>
