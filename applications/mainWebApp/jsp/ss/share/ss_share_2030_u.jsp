...
function update_ok(){
    alert("수정되었습니다.");
    dawnrpt_update_form.action="/ss/share/2020";
...
<form name="dawnrpt_update_form" method="post" action="">
	<input type="hidden" name="makedt" value="<%=makedt%>">              <!--새벽근무보고 pk값-->
	<input type="hidden" name="makepersid" value="<%=makepersid%>">      <!--새벽근무보고 pk값-->
