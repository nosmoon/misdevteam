...
function update_ok(){
    alert("수정되었습니다.");
    outrpt_update_form.action="/ss/share/1920";
    outrpt_update_form.submit();
}    
-->
</script>

<body onload=update_ok();>
<form name="outrpt_update_form" method="post" action="">
	<input type="hidden" name="makedt" value="<%=makedt%>">              <!--출장보고서 pk값-->
	<input type="hidden" name="makepersid" value="<%=makepersid%>">      <!--출장보고서 pk값-->
