...
<%-- dataset 인스턴스 선언부분--%>
<%
    SS_L_DAWNRPT_INITDataSet ds = (SS_L_DAWNRPT_INITDataSet)request.getAttribute("ds");    // request dataset
...
function list_search(){
    ...
    // 부서(팀) 또는 검색조건을 "/ss/share/2001" 서블릿으로 보낸다
    if(!check_all(lo_form1)) return;								// 폼 유효성 체크
    lo_form1.target = "_self";
...
<table width="830" border="0" cellspacing="0" cellpadding="1" align="center" bgcolor="#FFFFFF" class="gray">
  <tr bgcolor="#dddddd" align="center">
    ...
    for(int i=0 ; i< ds.dawnrptlist.size(); i++) {
        SS_L_DAWNRPT_INITDAWNRPTLISTRecord rec = (SS_L_DAWNRPT_INITDAWNRPTLISTRecord)ds.dawnrptlist.get(i);
    %>
  <tr>
