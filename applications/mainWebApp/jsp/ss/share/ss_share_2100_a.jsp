...
<%-- dataset 인스턴스 선언부분--%>
<%
    SS_L_OTHRPT_INITDataSet ds = (SS_L_OTHRPT_INITDataSet)request.getAttribute("ds");    // request dataset
...
function list_search(){
    ...
    // 부서(팀) 또는 검색조건을 "/ss/share/2101" 서블릿으로 보낸다
    if(!check_all(lo_form1)) return;								// 폼 유효성 체크
    lo_form1.target = "_self";
...
<form name="othrpt_form" method="post" action="">
	<input type="hidden" name="seq" value="">   <!--타사동향보고 pk값-->
...
<table width="830" border="0"  cellpadding="1" cellspacing="0" align="center">
  <tr>
    <td  height="27" bgcolor="#EBE9DC" class="title">타사동향보고 목록</td>
...
<table width="830" border="0" cellspacing="0" cellpadding="1" align="center" bgcolor="#FFFFFF" class="gray">
  <tr bgcolor="#dddddd" align="center">
    ...
    for(int i=0 ; i< ds.othrptlist.size(); i++) {
        SS_L_OTHRPT_INITOTHRPTLISTRecord rec = (SS_L_OTHRPT_INITOTHRPTLISTRecord)ds.othrptlist.get(i);
    %>
  <tr>
