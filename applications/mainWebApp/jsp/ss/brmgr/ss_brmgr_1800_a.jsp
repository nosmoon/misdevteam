...
<%---------------------------------------------------------------------------------------------------
* 파일명 : ss_brmgr_1800_a.jsp
* 기능 : 지국지원-아파트투입률-초기화면(아파트)
* 작성일자 : 2004-11-20
* 작성자 : 김대섭
---------------------------------------------------------------------------------------------------%>
...
function detail_view(bocd, addrcd, dongno){
    ...
    // 지국지사코드,주소코드, 동호수를 "/ss/brmgr/1810" 서블릿으로 보낸다(팝업)
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td bgcolor="#797777" height="25" class="home"><b><img src="/html/comm_img/ic_map.gif" width="25" height="20" align="absmiddle" >투입율조사
      &gt; </b>본지투입율</td>
  </tr>
  <tr>
    <td height="10">
...
%>
			...
			<td bgcolor="#EBE9DC" class="title" width="50""><img src="/html/comm_img/ic_title.gif" width="11" height="7" align="absmiddle">지역</td>
