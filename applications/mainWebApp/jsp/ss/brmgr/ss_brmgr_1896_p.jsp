...
<%--      <input name="image" type="image" id="default_btn" onclick="access_ActMemo('D');window.event.returnValue=false;" src="/html/comm_img/bu_default.gif" align="absmiddle" width="50" height="19"> --%>
    </td>
  </tr>
</table>
<!--HTML IFRAME START------------------------------------------------------------------------------->
