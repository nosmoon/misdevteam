...
//            lo_form.action = "/ss/common/1154";
            lo_form.action = "/ss/brmgr/1826";
            lo_form.target = "ifrm";
            lo_form.submit();
        }

        if( ga_args[2] == "APT" ) {
          document.all.imgTitle.src = "/html/comm_img/bo_find_04.gif";
        }
    }
    ...
    // 부모 윈도우에 값을 리턴
    function set_addr( 	 s_bocd		        //해당지국지사코드
						,s_addrcd	) {	    //해당아파트코드
        window.returnValue =         s_bocd
							+ "\n" + s_addrcd ;
        window.close();
    }
...
//		if(!check_all(lo_form,"/ss/common/1154")) return;
		if(!check_all(lo_form,"/ss/brmgr/1826")) return;
        return;
    }
  ...
  <tr>
    <td height="76">
      ...
      <table width=100% border=0 cellpadding=0 cellspacing=0>
        <tr>
          <td width="16"><img src="/html
/comm_img/zip_find_01.gif" width=16 height=76 ></td>
          <td width=72><img src="/html/comm_img/zip_find_02.gif" width=72 height=76 ></td>
          <td width=133><img id="imgTitle" src="/html/comm_img/zip_find_03.gif" width=133 height=76 ></td>
          </td>
...
<form name="zip_search_form" method="post" onsubmit="zip_search(1)">
        ...
        <tr>
          ...
          <td>&quot;읍/면/동&quot; 을 제외하고 입력 (<font  color="#0066cc">예) 상현동 → 상현</font>
            ) 후 검색버튼을 클릭</td>
        </tr>
        <tr>
          <td width="7">&nbsp;</td>
          <td>&nbsp;읍/면/동
            ...
            <input type="image" src="/html/comm_img/bu_search.gif" align="absmiddle" onclick="zip_search(1);" >
          </td>
        </tr>
        <tr>
