...
<%
    ...
    rxw.makeDataToList(ds, "curaccdcauscd", "cicdnm", "cicodeval", "선택", "", acctTemp, "causCombo");
    rxw.makeDataToList(ds, "curaccdtypecd", "cicdnm", "cicodeval", "선택", "", acctTemp, "typeCombo");
    
    // 조회 결과.
    /*rxw.add(acctTemp, "totalCount", Util.comma(ds.getTotalcnt())); // 총건수    
    rxw.add(acctTemp, "amtTotal", Util.comma(ds.getTotalinsramt())); // 총보험금*/
