...
<%---------------------------------------------------------------------------------------------------
* 파일명 : ss_brsup_1435_a.jsp
* 기능 : 지국지원-상해보험-비용(영업담당)-초기화면
* 작성일자 : 2004-02-20
* 작성자 : 김대섭
---------------------------------------------------------------------------------------------------%>
...
*/
    ...
    // 확장신청목록 조회조건을 "/ss/brsup/1440" 서블릿으로 보낸다
    lo_form1.action = "/ss/brsup/1440";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
...
function cost_save(){
    ...
    // 기준일자, 부서(팀)코드, 지역코드, 지국지사코드, 수금액, 입금자명 문자열 집합정보를 "/ss/brsup/1450" 서블릿으로 보낸다.
    lo_form1.action = "/ss/brsup/1450";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
...
function change_sel_row(obj){
	...
	for(i=2; i<lo_table.rows.length-1; i++){
