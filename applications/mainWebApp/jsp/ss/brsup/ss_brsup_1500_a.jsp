...
<%
	...
	int insraccdListCount = 10;	// 한 화면당 리스트 항목 수
	...
	rxw.makeDataToList(ds, "curprocstat", "cicdnm", "cicodeval", "전체", "", codeData, "processCombo"); // 처리
	rxw.makeDataToList(ds, "curprocstat", "cicdnm", "cicodeval", codeData, "statCombo"); // 처리
