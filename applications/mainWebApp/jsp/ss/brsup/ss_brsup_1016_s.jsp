...
byte[] thumbnail = (byte[])request.getAttribute("thumbnail");
if(thumbnail != null){
	response.setContentType("image/gif");
	
	BufferedInputStream fin = new BufferedInputStream(new ByteArrayInputStream(thumbnail));
	...
	response.setContentType("image/gif");
	File imgFile = new  File("C:\\work\\salesdept\\www\\html\\img\\No_Image.GIF");
