...
<%---------------------------------------------------------------------------------------------------
* 파일명 : ss_brsup_1260_a.jsp
* 기능 : 지국지원-신문지원물품-비용(지원담당)-초기화면
* 작성일자 : 2004-02-08
* 작성자 : 김대섭
---------------------------------------------------------------------------------------------------%>
...
*/
    ...
    // 확장신청목록 조회조건을 "/ss/brsup/1265" 서블릿으로 보낸다
    lo_form1.action = "/ss/brsup/1265";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
...
function cost_save(){
    ...
    // 기준일자, 지국지사코드, 선택여부를 문자열 집합을 "/ss/brsup/1270" 서블릿으로 보낸다.
    lo_form1.action = "/ss/brsup/1270";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
...
%>
  ...
  <tr>
    ...
    <form name="cost_list_form" method="post" action="" >
		...
		<tr bgcolor="#dddddd" height="23" align="right">
