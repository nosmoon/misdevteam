...
<%---------------------------------------------------------------------------------------------------
* 파일명 : ss_move_1240_a.jsp
* 기능 : 이사독자-비용(지원담당)-초기화면
* 작성일자 : 2004-01-09
* 작성자 : 김대섭
---------------------------------------------------------------------------------------------------%>
...
*/
    ...
    // 확장신청목록 조회조건을 "/ss/move/1250" 서블릿으로 보낸다
    lo_form1.action = "/ss/move/1250";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
...
function cost_detail_view(basidt, bocd){
    ...
    // 이사독자비용 기준일자, 지국코드를 "/ss/move/1260" 서블릿으로 보낸다
    lo_form1.basidt.value = basidt;
    lo_form1.bocd.value = bocd;
    lo_form1.action = "/ss/move/1260";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
...
function cost_save(){
    ...
    // 기준일자, 지국지사코드, 선택여부를 문자열 집합과 지원담당 처리구분 정보를 "/ss/move/1270" 서블릿으로 보낸다.
    lo_form1.action = "/ss/move/1270";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
  ...
  <tr>
    <td height="10">
      ...
      <table width="830" border="0"  cellpadding="1" cellspacing="0">
        <tr>
          <td  height="27" bgcolor="#EBE9DC" class="title">이사독자 비용목록</td>
