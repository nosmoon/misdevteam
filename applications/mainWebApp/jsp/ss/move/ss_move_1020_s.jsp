...
<%
	...
	//rxw.add(accTemp, "zip", "[" + Util.FormatZip(ds.getZip()) + "]" + ds.getAddr() + ds.getDtlsaddr()); //독자정보 현주소
	...
	//rxw.add(accTemp, "Movmzip", "[" + Util.FormatZip(ds.getMovmzip()) + "]" + ds.getMovmaddr() + ds.getMovmdtlsaddr()); //이사지정보 배달주소
	...
	rxw.add(accTemp, "cs_cns_empcnfmdt", Util.Timestamp2Str(ds.getCs_cns_empcnfmdt(),"yyyy-MM-dd' 'HH:mm:ss")); //상담원일시
	rxw.flush(out);
%>
