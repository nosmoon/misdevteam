...
<%
	...
	rxw.makeDataToList(ds, "curaplcpathcd", "cicdnm", "cicodeval", "전체", "", codeData, "aplcpathcdCombo");//경로
	rxw.makeDataToList(ds, "curmedicd", "cicdnm", "cicodeval", "전체", "", codeData, "medicdCombo");//매체	
	rxw.makeDataToList(ds, "curmovmrdrtype", "cicdnm", "cicodeval", "전체", "", codeData, "movmrdrtypeCombo");//이사독자유형	
