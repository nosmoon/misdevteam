...
<%
	...
	aList                             =  jdbcMonitor.monitor("SSL",disclsf);
...
<!--
    ...
    function select_display(disclsf){
        ...
        lo_form1.action = "/ss/monitor/1200";
  ...
  <tr>
    <td>
      ...
      <table width="830" border="0" cellpadding="2" cellspacing="0">
        <tr>
          <td width="400" height="27" bgcolor="#EBE9DC" class="title">판매국 CONNECTION POOL</td>
