...
<%
	...
	if( curr_page_no > 1 && total_records > 0){
		out.write("\n<input type=\"image\" id=\"prev_page_btn\" src=\"/html/comm_img/bu_prev01.gif\" alt=\"이전 페이지로\" border=\"0\" align=\"absmiddle\" onclick=\""+js_fn_nm+"("+ (curr_page_no - 1) +");window.event.returnValue=false;\">");
	}else{
	...
	if(total_records > 0 && curr_page_no < total_pages){
		out.write("\n<input type=\"image\" id=\"next_page_btn\" src=\"/html/comm_img/bu_next01.gif\" alt=\"다음 페이지로\" border=\"0\" align=\"absmiddle\" onclick=\""+js_fn_nm+"("+ (curr_page_no + 1)+");window.event.returnValue=false;\">");
	}else{
