...
<%---------------------------------------------------------------------------------------------------
* 파일명 : ss_extn_1740_a.jsp
* 기능 : 확장현황-사이버확장-대회관리-비용-초기화면
* 작성일자 : 2004-04-07
* 작성자 : 고윤홍
---------------------------------------------------------------------------------------------------%>
...
function cost_list_search(){
    ...
    // 확장대회목록 조회조건을 "/ss/extn/1745" 서블릿으로 보낸다
    lo_form1.action = "/ss/extn/1745";
...
function cost_detail_view(basidt){
    ...
    // 사이버확장대회번호를 "/ss/extn/1750" 서블릿으로 보낸다
    lo_form1.basidt.value = basidt;
    lo_form1.action = "/ss/extn/1750";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
...
function cost_add()
{
	...
	// 화면제어
	lo_table1.rows[0].cells[0].innerText = '사이버확장비용마감 등록';	// 상세화면 제목 변경
...
function cost_save(){
    ...
    if(lo_form1.accflag.value == 'I') {	        					// 신규입력일 때
        lo_form1.action = "/ss/extn/1755";
    } else if(lo_form1.accflag.value == 'U') {						// 수정저장일 때
        lo_form1.action = "/ss/extn/1760";
    } else {
      return;
    }
    lo_form1.target = "ifrm";
...
<tr>
    ...
    <form name="cost_list_form" method="post" action="">
        ...
        <tr>
            ...
            <td height="25" class="gray"  align="center" width="90" bgcolor="#DDDDDD"> 등록종료일자</td>
        </tr>
        <%-- 초기화면 목록 반복 시작 --%>
...
<td width="340" valign="top">
    ...
    <table id="cost_detail_title_id" width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
            <td height="25" bgcolor="#EBE9DC" class="title">사이버확장비용마감 등록</td>
        </tr>
        <tr>
            <td height="3">
            <!--여백-->
    ...
    <form name="cost_detail_form" method="post" action="">
        ...
        <input type="hidden" name="closyn" value="">            <!-- 사이버확장비용 마감여부 -->
        <tr>
