...
<%---------------------------------------------------------------------------------------------------
* 파일명 : ss_extn_1245_l.jsp
* 기능 : 확장현황-사원확장-대회관리-비용-목록
* 작성일자 : 2003-12-12
* 작성자 : 김대섭
---------------------------------------------------------------------------------------------------%>
...
<%  for(int i=0; i<ds.curcommlist.size(); i++){
    ...
    <!-- 사원확장비용 상세 링크 -->
    <tr height="25" bgcolor="" onclick="cost_detail_view('<%= curcommlistRec.basidt%>');change_sel_row(this);" style="cursor:hand" onmouseover="mouse_in(this);" onmouseout="mouse_out(this);">
