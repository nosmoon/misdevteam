...
<%
	...
	rxw.makeDataToList(ds, "cureducd", "cicdnm", "cicodeval", codeData, "eduCombo"); // 에듀
	rxw.makeDataToList(ds, "curjehucd", "cicdnm", "cicodeval", codeData, "jehuCombo"); // 제휴
