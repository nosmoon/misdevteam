...
<%
	...
	rxw.add(resTemp, "bo_headcnfmdt", Util.Timestamp2Str(ds.getBo_headcnfmdt(),"yyyy-MM-dd' 'HH:mm:ss")); //일시
	rxw.add(resTemp, "lastdlvcnfmdt", Util.Timestamp2Str(ds.getLastdlvcnfmdt(),"yyyy-MM-dd' 'HH:mm:ss")); //일시
