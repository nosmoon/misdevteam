...
<%---------------------------------------------------------------------------------------------------
* 파일명 : ss_extn_1160_a.jsp
* 기능 : 확장현황-품앗이확장-비용관리(확장담당)-초기화면
* 작성일자 : 2003-12-01
* 작성자 : 김대섭
---------------------------------------------------------------------------------------------------%>
...
*/
    ...
    // 확장신청목록 조회조건을 "/ss/extn/1165" 서블릿으로 보낸다
    lo_form1.action = "/ss/extn/1165";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
...
function cost_detail_view(basidt, bocd){
    ...
    // 품앗이확장비용 기준일자, 지국코드를 "/ss/extn/1170" 서블릿으로 보낸다
...
function cost_save(){
    ...
    // 기준일자, 지국지사코드, 선택여부를 문자열 집합과 지원담당 처리구분 정보를 "/ss/extn/1175" 서블릿으로 보낸다.
    lo_form1.action = "/ss/extn/1175";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
  ...
  <tr>
      ...
      <table width="830" border="0"  cellpadding="1" cellspacing="0">
        <tr>
          ...
          <td  height="27" bgcolor="#EBE9DC" class="title" align="right" width="300">
			...
			<input type="image" src="/html/comm_img/bu_print.gif" width="39" height="19" align="absmiddle" onclick="jsInit();javascript:print_list();window.event.returnValue=false;">            
          </td>
        </tr>
        <tr>
    ...
    <form name="cost_list_form" method="post" action="" >
		...
		<tr bgcolor="#dddddd" align="center" height="23">
			<td width="70" class="gray" align="center">년월</td>
			<td width="80" class="gray" align="center">지역</td>
			<td width="80" class="gray" align="center">지국</td>
			<td width="90" class="gray" align="center">인계금액</td>
			<td width="90" class="gray" align="center">인수금액</td>
			<td width="90" class="gray" align="center">비용금액</td>
			<td width="70" class="gray" align="center">담당수금</td>
			<td class="gray" align="center">입금</td>
			<td width="90" class="gray" align="center">입금일자</td>
			<td width="90" class="gray" align="center">지국구분</td>
		</tr>
		...
		<tr align="center">
			...
			<td width="90" class="gray" align="center">&nbsp;</td>
			<td width="90" class="gray" align="center">&nbsp;</td>
			<td width="70" class="gray" align="center"><input type="checkbox" name="checkbox" value="" disabled>&nbsp;</td>
