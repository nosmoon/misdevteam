...
<%---------------------------------------------------------------------------------------------------
* 파일명 : ss_extn_1282_l.jsp
* 기능 : 확장현황-사원확장-비용관리(담당)-목록
* 작성일자 : 2003-12-13
* 작성자 : 김대섭
---------------------------------------------------------------------------------------------------%>
...
for(int i=0; i<ds.curcommlist.size(); i++){
    SS_L_RDR_EXTN_EMPCOSTCURCOMMLISTRecord curcommlistRec = (SS_L_RDR_EXTN_EMPCOSTCURCOMMLISTRecord)ds.curcommlist.get(i);%>
    	<!-- 사원확장비용 상세 링크 -->
	    <tr  height="25" bgcolor="" onclick="cost_detail_view('<%= curcommlistRec.basidt%>','<%= curcommlistRec.bocd%>');change_sel_row(this);" style="cursor:hand" onmouseover="mouse_in(this);" onmouseout="mouse_out(this);">
	        <td width="100" class="gray" align="center"><%= Util.convertMonthS(curcommlistRec.basidt)%>&nbsp;</td>
	        <td width="125" class="gray" align="left"><%= curcommlistRec.areacdnm%>&nbsp;</td>
	        <td width="125" class="gray" align="left"><%= curcommlistRec.bocdnm%>&nbsp;</td>
