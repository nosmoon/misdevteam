...
<%---------------------------------------------------------------------------------------------------
* 파일명 : ss_extn_1165_l.jsp
* 기능 : 확장현황-품앗이확장-비용관리(확장담당)-목록
* 작성일자 : 2003-12-04
* 작성자 : 김대섭
---------------------------------------------------------------------------------------------------%>
...
for(int i=0; i<ds.curcommlist.size(); i++){
    ...
    <tr bgcolor="" onclick="cost_detail_view('<%= curcommlistRec.basidt%>','<%= curcommlistRec.bocd%>');change_sel_row(this);" style="cursor:hand" onmouseover="mouse_in(this);" onmouseout="mouse_out(this);">
        <td width="70" class="gray" align="center"> <%= Util.convertMonthS(curcommlistRec.basidt)%>&nbsp; </td>
        <td width="80" class="gray" align="left"> <%= curcommlistRec.areacdnm%> &nbsp;</td>
        <td width="80" class="gray" align="left"><%= curcommlistRec.bocdnm%>&nbsp;</td>
        <td width="90" class="gray" align="right"> <%= Util.comma(curcommlistRec.trsfamt)%>&nbsp;</td>
        <td width="90" class="gray" align="right"> <%= Util.comma(curcommlistRec.acptamt)%>&nbsp; </td>
        <td width="90" class="gray" align="right"> <%= Util.comma(curcommlistRec.costamt)%>&nbsp;</td>
