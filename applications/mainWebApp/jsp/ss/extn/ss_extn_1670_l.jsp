...
<form name="staf_list_form" method="post" action="" >
	...
	<tr>
		<td height="24" class="gray"  align="center" bgcolor="#DDDDDD" width="77">요원명</td>
	...
	<tr bgcolor="" onclick="staf_detail_list('<%= curcommlistRec.stafno%>');change_sel_row(this);" style="cursor:hand" onmouseover="mouse_in(this);" onmouseout="mouse_out(this);">
		<td height="22" class="gray" width="77" align="center"><%= curcommlistRec.extnflnm%>&nbsp;</td>
