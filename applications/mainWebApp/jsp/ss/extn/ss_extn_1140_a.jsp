...
<%---------------------------------------------------------------------------------------------------
* 파일명 : ss_extn_1140_a.jsp
* 기능 : 확장현황-품앗이확장-비용관리(담당)-초기화면
* 작성일자 : 2003-12-01
* 작성자 : 김대섭
---------------------------------------------------------------------------------------------------%>
...
*/  
    ...
    // 확장신청목록 조회조건을 "/ss/extn/1145" 서블릿으로 보낸다
    lo_form1.action = "/ss/extn/1145";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
...
function cost_detail_view(basidt, bocd){
    ...
    // 품앗이확장비용 기준일자, 지국코드를 "/ss/extn/1150" 서블릿으로 보낸다
    lo_form1.basidt.value = basidt;
    lo_form1.bocd.value = bocd;
    lo_form1.action = "/ss/extn/1150";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
...
function cost_save(){
    ...
    // 기준일자, 지국지사코드, 선택여부를 문자열 집합과 영업담당 처리구분 정보를 "/ss/extn/1155" 서블릿으로 보낸다.
    lo_form1.action = "/ss/extn/1155";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
  ...
  <tr>
    <td height="10">
      ...
      <table width="830" border="0"  cellpadding="1" cellspacing="0">
        <tr>
          <td  height="27" bgcolor="#EBE9DC" class="title">품앗이확장대회 비용목록</td>
