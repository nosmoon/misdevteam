...
<%---------------------------------------------------------------------------------------------------
* 파일명 : ss_extn_1780_a.jsp
* 기능 : 확장현황-사이버확장-비용관리(영업)-초기화면
* 작성일자 : 2004-04-09
* 작성자 : 고윤홍
---------------------------------------------------------------------------------------------------%>
...
*/
    ...
    // 확장신청목록 조회조건을 "/ss/extn/1782" 서블릿으로 보낸다
    lo_form1.action = "/ss/extn/1782";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
...
function cost_detail_view(basidt, bocd){
    ...
    // 사원확장비용 기준일자, 지국코드를 "/ss/extn/1784" 서블릿으로 보낸다
    lo_form1.basidt.value = basidt;
    lo_form1.bocd.value = bocd;
    lo_form1.action = "/ss/extn/1784";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
...
function cost_save(){
    ...
    // 기준일자, 지국지사코드, 선택여부를 문자열 집합과 영업담당 처리구분 정보를 "/ss/extn/1786" 서블릿으로 보낸다.
    lo_form1.action = "/ss/extn/1786";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
...
%>                    
  ...
  <tr>
    ...
    <form name="cost_list_form" method="post" action="" >
      ...
      <tr>
        <td colspan="9" class="gray" align="center"> 검색조건을 입력하고 조회버튼을 누르세요. </td>
      </tr>
    </form>
    </table>
    <!--사이버확장 비용 목록 끝 ---------------------------------------------------------------------------->
