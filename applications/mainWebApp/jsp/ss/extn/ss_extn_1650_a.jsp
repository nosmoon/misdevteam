...
function alon_save(){
    ...
    // 확장일자, 확장번호, 선택여부를 문자열 집합 정보를 "/ss/extn/1660" 서블릿으로 보낸다.
...
%>
						...
						<td bgcolor="#EBE9DC" width="40"><img src="/html/comm_img/ic_title.gif" width="11" height="7" align="absmiddle">오류</td>
						<td bgcolor="#EBE9DC">
							<select name="subscnfmstatcd" size="1" class="sel_all"><!--구독확인상태코드 목록-->
			...
			<td rowspan="2" class="sea_top"  align="right">
				<input type="image" id="search_id" src="/html/comm_img/bu_search01.gif" width="39" height="35" align="absmiddle" onclick="set_request('L');bo_list_search();window.event.returnValue=false;"></td><!--목록 조회-->
			</td>
        </tr>
		<tr>
			<td>
            		...
            		<tr>
            			<td width="260">
			                ...
			                <select name="fromtogb" class="sel_all">
			                    ...
			                    <option value="3">지급</option>
			                </select>
			                <input name="frdt" type="text" size="10" value="<%= Util.getDate2()%>" class="text_box" caption="시작일자" dataType="date">
			                -
...
<%--	                    
			                    <option value="" selected>전체</option>
			                    <%= ds.curmedicdOptHtml("") %>                              <!-- 신청경로코드, 코드명 목록 -->
--%>			                    
							</select>
						</td>
            			<td>
			                <img src="/html/comm_img/ic_title.gif" width="11" height="7" align="absmiddle">지급&nbsp;
