...
<%---------------------------------------------------------------------------------------------------
* 파일명 : ss_extn_1790_l.jsp
* 기능 : 확장현황-사이버확장-비용관리(지원)-목록
* 작성일자 : 2004-04-09
* 작성자 : 고윤홍
---------------------------------------------------------------------------------------------------%>
...
for(int i=0; i<ds.curcommlist.size(); i++){
    ...
    <tr bgcolor="" onclick="cost_detail_view('<%= curcommlistRec.basidt%>','<%= curcommlistRec.bocd%>');change_sel_row(this);" style="cursor:hand" onmouseover="mouse_in(this);" onmouseout="mouse_out(this);">
        ...
        <td width="110" class="gray" align="center"> <%= curcommlistRec.areacdnm%>&nbsp;</td>
        <td width="110" class="gray" align="center"><%= curcommlistRec.bocdnm%>&nbsp;</td>
