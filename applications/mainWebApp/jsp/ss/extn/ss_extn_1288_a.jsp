...
<%---------------------------------------------------------------------------------------------------
* 파일명 : ss_extn_1288_a.jsp
* 기능 : 확장현황-사원확장-비용관리(확장담당)-초기화면
* 작성일자 : 2003-12-13
* 작성자 : 김대섭
---------------------------------------------------------------------------------------------------%>
...
*/
    ...
    // 확장신청목록 조회조건을 "/ss/extn/1290" 서블릿으로 보낸다
    lo_form1.action = "/ss/extn/1290";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
...
function cost_detail_view(basidt, bocd){
    ...
    // 사원확장비용 기준일자, 지국코드를 "/ss/extn/1292" 서블릿으로 보낸다
    lo_form1.basidt.value = basidt;
    lo_form1.bocd.value = bocd;
    lo_form1.action = "/ss/extn/1292";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
...
function cost_save(){
    ...
    // 기준일자, 지국지사코드, 선택여부를 문자열 집합과 지원담당 처리구분 정보를 "/ss/extn/1294" 서블릿으로 보낸다.
    lo_form1.action = "/ss/extn/1294";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
