...
<%---------------------------------------------------------------------------------------------------
* 파일명 : ss_extn_1100_a.jsp
* 기능 : 확장현황-품앗이확장-대회관리-초기화면
* 작성일자 : 2003-11-24
* 작성자 : 김대섭
---------------------------------------------------------------------------------------------------%>
...
function camp_list_search(){
    ...
    // 확장대회목록 조회조건을 "/ss/extn/1105" 서블릿으로 보낸다
    lo_form1.action = "/ss/extn/1105";
...
function camp_detail_view(rdr_extncampno){
    ...
    // 품앗이확장대회번호를 "/ss/extn/1110" 서블릿으로 보낸다
    lo_form1.rdr_extncampno.value = rdr_extncampno;
    lo_form1.action = "/ss/extn/1110";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
...
function camp_add()
{
	...
	lo_table1.rows[0].cells[0].innerText = '품앗이확장대회 등록';
...
function camp_save(){
   var lo_form1 = document.camp_detail_form;
    ...
    if(lo_form1.accflag.value == 'I') {	        					// 신규입력일 때
        lo_form1.action = "/ss/extn/1115";
    } else if(lo_form1.accflag.value == 'U') {						// 수정저장일 때
        lo_form1.action = "/ss/extn/1120";
    } else {
      return;
    }
    lo_form1.target = "ifrm";
...
//	lo_table1.rows[0].cells[0].innerText = '품앗이확장대회 상세';
...
<td width="340" valign="top">
    ...
    <table id="camp_detail_title_id" width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
            <td height="25" bgcolor="#EBE9DC" class="title">품앗이확장대회 등록</td>
        </tr>
        <tr>
            <td height="3">
            <!--여백-->
    ...
    <form name="camp_detail_form" method="post" action="">
        ...
        <input type="hidden" name="rdr_extncampno" value="">    <!-- 품앗이확장대회번호 -->
        <input type="hidden" name="closyn" value="">            <!-- 품앗이확장대회 마감여부 -->
        ...
        <tr>
            <td bgcolor="#dddddd" class="gray" height="25">수당지급일자<font color="#FF0000">*</font></td>
            <td colspan="3" class="gray" height="25">
