...
<%
	...
	rxw.add(codeData, "pagesize", extnListCount);
	rxw.add(codeData, "emp_nm",Util.getSessionParameterValue(request, "emp_nm", false) );//상담원
	...
	rxw.makeDataToList(ds, "curmedicd", "cicdnm", "cicodeval", codeData, "medicdCombo"); // 그리드매체	
