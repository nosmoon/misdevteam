...
<%@ include file="/comm_jsp/pr_serv_common.jsp" %>

<%---------------------------------------------------------------------------------------------------
* 파일명	: pr_supp_1260_a.jsp
...
//	int		PORT	= 7131;
	...
	////String tid		= "DPT0006501";		//	Test 단말기 번호 - 향후 단말기 번호 변경 요망 => 이체청구시 단말기 번호와 동일
	String tid		= "DPT0022016";
	...
	KSMpiIspBean.argSetInitLog("/data/ipg/ipgadmin/bean/lib/com/ksnet/certify/log","Y","/data/ipg/ipgadmin/bean/lib/com/ksnet/certify/errlog","Y");
