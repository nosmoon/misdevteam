...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			MC_COST_3081_LCURLISTRecord rec = (MC_COST_3081_LCURLISTRecord)ds.curlist.get(i);
			int record = rx.add(recordSet, "record", "");
			//rx.add(record, "yymm", rec.yymm);
			//rx.add(record, "dstb_clsf_cd", rec.dstb_clsf_cd);
			...
			rx.add(record, "dstb_clsf_cd", StringUtil.replaceToXml(rec.dstb_clsf_cd));
