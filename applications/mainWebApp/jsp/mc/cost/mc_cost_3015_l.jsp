...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			MC_COST_3015_LCURLISTRecord rec = (MC_COST_3015_LCURLISTRecord)ds.curlist.get(i);
			...
			rx.add(record, "dstb_dept_cdnm1", rec.dstb_dept_cdnm1);
			...
			//rx.add(record, "dstb_dept_cdnm1", StringUtil.replaceToXml(rec.dstb_dept_cdnm1));
