...
<%
	...
	try {
		rx.add(dataSet, "xx_cost_dstb_cdfr", ds.getXx_cost_dstb_cdfr());
		rx.add(dataSet, "xx_cost_dstb_cdto", ds.getXx_cost_dstb_cdto());
		rx.add(dataSet, "xx_clos_clsf", ds.getXx_clos_clsf());
		rx.add(dataSet, "xx_cd", ds.getXx_cd());
		rx.add(dataSet, "xx_cost_dstb_cd", ds.getXx_cost_dstb_cd());
		rx.add(dataSet, "xx_cost_dstb_cd_020", ds.getXx_cost_dstb_cd_020());
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			MC_COST_2040_MCURLISTRecord rec = (MC_COST_2040_MCURLISTRecord)ds.curlist.get(i);
