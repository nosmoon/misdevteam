...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist_09.size(); i++) {
			MC_COST_3010_ACURLIST_09Record rec = (MC_COST_3010_ACURLIST_09Record)ds.curlist_09.get(i);
		...
		for(int i = 0; i < ds.curlist_08.size(); i++) {
			MC_COST_3010_ACURLIST_08Record rec = (MC_COST_3010_ACURLIST_08Record)ds.curlist_08.get(i);
			int record = rx.add(recordSet, "record", "");
		...
		for(int i = 0; i < ds.curlist_07.size(); i++) {
			MC_COST_3010_ACURLIST_07Record rec = (MC_COST_3010_ACURLIST_07Record)ds.curlist_07.get(i);
			int record = rx.add(recordSet, "record", "");
		...
		for(int i = 0; i < ds.curlist_06.size(); i++) {
			MC_COST_3010_ACURLIST_06Record rec = (MC_COST_3010_ACURLIST_06Record)ds.curlist_06.get(i);
			int record = rx.add(recordSet, "record", "");
		...
		for(int i = 0; i < ds.curlist_05.size(); i++) {
			MC_COST_3010_ACURLIST_05Record rec = (MC_COST_3010_ACURLIST_05Record)ds.curlist_05.get(i);
			int record = rx.add(recordSet, "record", "");
		...
		for(int i = 0; i < ds.curlist_04.size(); i++) {
			MC_COST_3010_ACURLIST_04Record rec = (MC_COST_3010_ACURLIST_04Record)ds.curlist_04.get(i);
			int record = rx.add(recordSet, "record", "");
		...
		for(int i = 0; i < ds.curlist_03.size(); i++) {
			MC_COST_3010_ACURLIST_03Record rec = (MC_COST_3010_ACURLIST_03Record)ds.curlist_03.get(i);
			int record = rx.add(recordSet, "record", "");
		...
		for(int i = 0; i < ds.curlist_02.size(); i++) {
			MC_COST_3010_ACURLIST_02Record rec = (MC_COST_3010_ACURLIST_02Record)ds.curlist_02.get(i);
			int record = rx.add(recordSet, "record", "");
			//rx.add(record, "col1", rec.col1);
			rx.add(record, "col1", StringUtil.replaceToXml(rec.col1));
		}
		...
		for(int i = 0; i < ds.curlist_01.size(); i++) {
			MC_COST_3010_ACURLIST_01Record rec = (MC_COST_3010_ACURLIST_01Record)ds.curlist_01.get(i);
			int record = rx.add(recordSet, "record", "");
			//rx.add(record, "col1", rec.col1);
			rx.add(record, "col1", StringUtil.replaceToXml(rec.col1));
		}
