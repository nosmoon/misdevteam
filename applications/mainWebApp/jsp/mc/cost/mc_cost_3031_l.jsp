...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			MC_COST_3031_LCURLISTRecord rec = (MC_COST_3031_LCURLISTRecord)ds.curlist.get(i);
			...
			rx.add(record, "bj1stbsnm", rec.bj1stbsnm);
			rx.add(record, "dstb_dept_cd2", rec.dstb_dept_cd2);
			rx.add(record, "bj2stbsnm", rec.bj2stbsnm);
			...
			//rx.add(record, "bj1stbsnm", StringUtil.replaceToXml(rec.bj1stbsnm));
			//rx.add(record, "dstb_dept_cd2", StringUtil.replaceToXml(rec.dstb_dept_cd2));
			//rx.add(record, "bj2stbsnm", StringUtil.replaceToXml(rec.bj2stbsnm));
