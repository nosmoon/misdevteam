...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist3.size(); i++) {
			MC_BUDG_6303_LCURLIST3Record rec = (MC_BUDG_6303_LCURLIST3Record)ds.curlist3.get(i);
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			MC_BUDG_6303_LCURLIST2Record rec = (MC_BUDG_6303_LCURLIST2Record)ds.curlist2.get(i);
			int record = rx.add(recordSet, "record", "");
			//rx.add(record, "hdqt_aply_rate", rec.hdqt_aply_rate);
			//rx.add(record, "lcl_aply_rate", rec.lcl_aply_rate);
			rx.add(record, "hdqt_aply_rate", StringUtil.replaceToXml(rec.hdqt_aply_rate));
			rx.add(record, "lcl_aply_rate", StringUtil.replaceToXml(rec.lcl_aply_rate));
		}
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			MC_BUDG_6303_LCURLIST1Record rec = (MC_BUDG_6303_LCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
