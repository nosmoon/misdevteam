...
<%
	RwXml rx = new RwXml();
	MC_BUDG_4005_LDataSet ds = (MC_BUDG_4005_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			MC_BUDG_4005_LCURLIST2Record rec = (MC_BUDG_4005_LCURLIST2Record)ds.curlist2.get(i);
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			MC_BUDG_4005_LCURLIST1Record rec = (MC_BUDG_4005_LCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
