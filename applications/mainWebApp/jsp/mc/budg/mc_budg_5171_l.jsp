...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			MC_BUDG_5171_LCURLISTRecord rec = (MC_BUDG_5171_LCURLISTRecord)ds.curlist.get(i);
			...
			rx.add(record, "curmm_cndt_amt_20", rec.curmm_cndt_amt_20);
			rx.add(record, "curmm_cndt_amt", rec.curmm_cndt_amt);
			rx.add(record, "mon_gap_req", rec.mon_gap_req);	
			...
			rx.add(record, "curmm_budg_req_amt", rec.curmm_budg_req_amt);
