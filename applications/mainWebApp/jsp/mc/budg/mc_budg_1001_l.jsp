...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			MC_BUDG_1001_LCURLISTRecord rec = (MC_BUDG_1001_LCURLISTRecord)ds.curlist.get(i);
			...
			rx.add(record, "gain_reso_yn", rec.gain_reso_yn);
			...
			//rx.add(record, "gain_reso_yn", StringUtil.replaceToXml(rec.gain_reso_yn));
