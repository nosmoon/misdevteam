...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			PR_PRTCNSG_1310_LCURLIST2Record rec = (PR_PRTCNSG_1310_LCURLIST2Record)ds.curlist2.get(i);
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			PR_PRTCNSG_1310_LCURLIST1Record rec = (PR_PRTCNSG_1310_LCURLIST1Record)ds.curlist1.get(i);
			//int record = rx.add(recordSet, "record", "");
			rx.add(recordSet, "cmpy_cd", rec.cmpy_cd);
			rx.add(recordSet, "fac_clsf", rec.fac_clsf);
			rx.add(recordSet, "aply_dt", rec.aply_dt);
			rx.add(recordSet, "prt_basi_qty", rec.prt_basi_qty);
			rx.add(recordSet, "prt_uprc_bw_1", rec.prt_uprc_bw_1);
			rx.add(recordSet, "prt_uprc_clr_1", rec.prt_uprc_clr_1);
			rx.add(recordSet, "prt_uprc_bw_2", rec.prt_uprc_bw_2);
			rx.add(recordSet, "prt_uprc_clr_2", rec.prt_uprc_clr_2);
			rx.add(recordSet, "pj_basi_qty", rec.pj_basi_qty);
			rx.add(recordSet, "prt_pj_rate_bw_1", rec.prt_pj_rate_bw_1);
			rx.add(recordSet, "prt_pj_rate_clr_1", rec.prt_pj_rate_clr_1);
			rx.add(recordSet, "prt_pj_rate_bw_2", rec.prt_pj_rate_bw_2);
			rx.add(recordSet, "prt_pj_rate_clr_2", rec.prt_pj_rate_clr_2);
			rx.add(recordSet, "film_make_fee", rec.film_make_fee);
			rx.add(recordSet, "pack_fee", rec.pack_fee);
			rx.add(recordSet, "paper_wgt", rec.paper_wgt);
			rx.add(recordSet, "dlco_nm", rec.dlco_nm);
			rx.add(recordSet, "eps_no", rec.eps_no);
			rx.add(recordSet, "dlco_no", rec.dlco_no);
			rx.add(recordSet, "incmg_pers", rec.incmg_pers);
			rx.add(recordSet, "incmg_dt_tm", rec.incmg_dt_tm);
			//rx.add(record, "cmpy_cd", StringUtil.replaceToXml(rec.cmpy_cd));
			//rx.add(record, "fac_clsf", StringUtil.replaceToXml(rec.fac_clsf));
			//rx.add(record, "aply_dt", StringUtil.replaceToXml(rec.aply_dt));
			//rx.add(record, "prt_basi_qty", StringUtil.replaceToXml(rec.prt_basi_qty));
