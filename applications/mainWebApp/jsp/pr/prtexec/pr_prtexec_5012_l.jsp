...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			PR_PRTEXEC_5012_LCURLISTRecord rec = (PR_PRTEXEC_5012_LCURLISTRecord)ds.curlist.get(i);
			...
			rx.add(record, "gnr_add_qty", rec.gnr_add_qty);
			rx.add(record, "spsl_add_qty", rec.spsl_add_qty);
		}
