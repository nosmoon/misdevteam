...
<%
	...
	try {
		for(int i = 0; i < ds.curlist.size(); i++) {
			...
			if(rec.fac_clsf.equals("10") && rec.medi_cd.equals("11E")){
				sect_clr_pcnt =rec.sect_clr_pcnt;
				sect_bw_pcnt =rec.sect_bw_pcnt;
			}
		}
		
		rx.add(recordSet, "totalcnt", ds.curlist.size());
		rx.add(recordSet, "sect_clr_pcnt", sect_clr_pcnt);
		rx.add(recordSet, "sect_bw_pcnt", sect_bw_pcnt);
