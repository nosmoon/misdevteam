...
<%
	RwXml rx = new RwXml();
	PR_PAPMAKE_7100_LDataSet ds = (PR_PAPMAKE_7100_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			PR_PAPMAKE_7100_LCURLISTRecord rec = (PR_PAPMAKE_7100_LCURLISTRecord)ds.curlist.get(i);
