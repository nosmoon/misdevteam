...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			PR_PAPMAKE_7101_LCURLISTRecord rec = (PR_PAPMAKE_7101_LCURLISTRecord)ds.curlist.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.addCData(record, "ispt_dt", rec.ispt_dt);
			rx.addCData(record, "fac_clsf", rec.fac_clsf);
			rx.addCData(record, "ispt_clsf", rec.ispt_clsf);
			rx.addCData(record, "ispt_cd", rec.ispt_cd);
			rx.addCData(record, "ispt_nm", rec.ispt_nm);
			rx.addCData(record, "ispt_clas1", rec.ispt_clas1);
			rx.addCData(record, "ispt_clas2", rec.ispt_clas2);
			rx.addCData(record, "ispt_clas3_nm", rec.ispt_clas3_nm);
			rx.addCData(record, "ispt_clas4_nm", rec.ispt_clas4_nm);
			rx.addCData(record, "ispt_rslt", rec.ispt_rslt);
			rx.addCData(record, "remk", rec.remk);
			rx.addCData(record, "chg_pers", rec.chg_pers);
			rx.addCData(record, "chg_dt_tm", rec.chg_dt_tm);
			rx.addCData(record, "ispt_clas3", rec.ispt_clas3);
			rx.addCData(record, "ispt_clas4", rec.ispt_clas4);
			rx.addCData(record, "ispt_clas1_nm", rec.ispt_clas1_nm);
			rx.addCData(record, "ispt_clas2_nm", rec.ispt_clas2_nm);
			rx.addCData(record, "ispt_clsf_nm", rec.ispt_clsf_nm);
