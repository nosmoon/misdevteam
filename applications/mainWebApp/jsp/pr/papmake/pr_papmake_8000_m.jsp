...
<%
	RwXml rx = new RwXml();
	PR_PAPMAKE_8000_MDataSet ds = (PR_PAPMAKE_8000_MDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			PR_PAPMAKE_8000_MCURLISTRecord rec = (PR_PAPMAKE_8000_MCURLISTRecord)ds.curlist.get(i);
