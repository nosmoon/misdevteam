...
<%
	RwXml rx = new RwXml();
	PR_PAPMAKE_2300_LDataSet ds = (PR_PAPMAKE_2300_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			PR_PAPMAKE_2300_LCURLISTRecord rec = (PR_PAPMAKE_2300_LCURLISTRecord)ds.curlist.get(i);
