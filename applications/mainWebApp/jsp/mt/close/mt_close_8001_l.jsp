...
<%
	RwXml rx = new RwXml();
	MT_CLOSE_8001_LDataSet ds = (MT_CLOSE_8001_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			MT_CLOSE_8001_LCURLIST2Record rec = (MT_CLOSE_8001_LCURLIST2Record)ds.curlist2.get(i);
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			MT_CLOSE_8001_LCURLIST1Record rec = (MT_CLOSE_8001_LCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
