...
<%
	RwXml rx = new RwXml();
	MT_CLOSE_7001_LDataSet ds = (MT_CLOSE_7001_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			MT_CLOSE_7001_LCURLIST1Record rec = (MT_CLOSE_7001_LCURLIST1Record)ds.curlist1.get(i);
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			MT_CLOSE_7001_LCURLISTRecord rec = (MT_CLOSE_7001_LCURLISTRecord)ds.curlist.get(i);
			int record = rx.add(recordSet, "record", "");
