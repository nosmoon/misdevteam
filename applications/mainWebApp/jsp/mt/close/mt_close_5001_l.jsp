...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			MT_CLOSE_5001_LCURLISTRecord rec = (MT_CLOSE_5001_LCURLISTRecord)ds.curlist.get(i);
			...
			//rx.add(record, "ewh_budg_cd", StringUtil.replaceToXml(rec.ewh_budg_cd));
			...
			//rx.add(record, "owh_dept", StringUtil.replaceToXml(rec.owh_dept));
		}
