...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist4.size(); i++) {
			MT_CLOSE_7014_LCURLIST4Record rec = (MT_CLOSE_7014_LCURLIST4Record)ds.curlist4.get(i);
		...
		for(int i = 0; i < ds.curlist3.size(); i++) {
			MT_CLOSE_7014_LCURLIST3Record rec = (MT_CLOSE_7014_LCURLIST3Record)ds.curlist3.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cd", rec.cd);
			rx.add(record, "cdnm_cd", rec.cdnm_cd);
			//rx.add(record, "cd", StringUtil.replaceToXml(rec.cd));
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			MT_CLOSE_7014_LCURLIST2Record rec = (MT_CLOSE_7014_LCURLIST2Record)ds.curlist2.get(i);
			int record = rx.add(recordSet, "record", "");
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			MT_CLOSE_7014_LCURLIST1Record rec = (MT_CLOSE_7014_LCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "matr_cd", rec.matr_cd);
			rx.add(record, "matr_nm", rec.matr_nm);
			//rx.add(record, "matr_cd", StringUtil.replaceToXml(rec.matr_cd));
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			MT_CLOSE_7014_LCURLISTRecord rec = (MT_CLOSE_7014_LCURLISTRecord)ds.curlist.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cd", rec.cd);
			rx.add(record, "cdnm", rec.cdnm);
			rx.add(record, "cd_abrv_nm", rec.cd_abrv_nm);
		...
		for(int i = 0; i < ds.curlist5.size(); i++) {
			MT_CLOSE_7014_LCURLIST5Record rec = (MT_CLOSE_7014_LCURLIST5Record)ds.curlist5.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "cd", rec.cd);
			rx.add(record, "cdnm", rec.cdnm);
			rx.add(record, "cd_abrv_nm", rec.cd_abrv_nm);
