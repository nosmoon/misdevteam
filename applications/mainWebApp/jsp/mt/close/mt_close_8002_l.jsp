...
<%
	...
	String str_cap_3    = "자재코드^ 자재명^ 소모량합계^ 소모금액합계";
	...
	try {
			if(ds.curlist2.size() > 0){
			    ...
			    for(int i = 0; i < ds.curlist1.size(); i++) {
			        MT_CLOSE_8002_LCURLIST1Record rec = (MT_CLOSE_8002_LCURLIST1Record)ds.curlist1.get(i);
			        str_width += ", 100";
			    ...
			    for(int i = 0; i < ds.curlist2.size(); i++) {
			        MT_CLOSE_8002_LCURLIST2Record rec = (MT_CLOSE_8002_LCURLIST2Record)ds.curlist2.get(i);
