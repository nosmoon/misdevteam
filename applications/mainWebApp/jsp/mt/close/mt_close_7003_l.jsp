	...
	try {
		if(ds.curlist2.size() > 0){
		    ...
		    for(int i = 0; i < ds.curlist1.size(); i++) {
		        MT_CLOSE_7003_LCURLIST1Record rec = (MT_CLOSE_7003_LCURLIST1Record)ds.curlist1.get(i);
		        str_width += ", 70";
		    ...
		    for(int i = 0; i < ds.curlist2.size(); i++) {
		        MT_CLOSE_7003_LCURLIST2Record rec = (MT_CLOSE_7003_LCURLIST2Record)ds.curlist2.get(i);
