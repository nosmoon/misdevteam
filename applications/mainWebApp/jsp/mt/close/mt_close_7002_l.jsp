	...
	try {
		if(ds.curlist2.size() > 0){
		    ...
		    for(int i = 0; i < ds.curlist1.size(); i++) {
		        MT_CLOSE_7002_LCURLIST1Record rec = (MT_CLOSE_7002_LCURLIST1Record)ds.curlist1.get(i);
		        str_width += ", 100";
		    ...
		    for(int i = 0; i < ds.curlist2.size(); i++) {
		        MT_CLOSE_7002_LCURLIST2Record rec = (MT_CLOSE_7002_LCURLIST2Record)ds.curlist2.get(i);
...
<% /* 작성시간 : Wed Jul 15 10:20:16 KST 2009 */ %>