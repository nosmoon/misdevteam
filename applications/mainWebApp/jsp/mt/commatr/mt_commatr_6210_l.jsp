...
<%
	RwXml rx = new RwXml();
	MT_COMMATR_6210_LDataSet ds = (MT_COMMATR_6210_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			MT_COMMATR_6210_LCURLISTRecord rec = (MT_COMMATR_6210_LCURLISTRecord)ds.curlist.get(i);
