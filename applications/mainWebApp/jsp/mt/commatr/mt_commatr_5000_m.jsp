...
<%
	RwXml rx = new RwXml();
	MT_COMMATR_5000_MDataSet ds = (MT_COMMATR_5000_MDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.medilist.size(); i++) {
			MT_COMMATR_5000_MMEDILISTRecord rec = (MT_COMMATR_5000_MMEDILISTRecord)ds.medilist.get(i);
		...
		for(int i = 0; i < ds.sectlist.size(); i++) {
			MT_COMMATR_5000_MSECTLISTRecord rec = (MT_COMMATR_5000_MSECTLISTRecord)ds.sectlist.get(i);
