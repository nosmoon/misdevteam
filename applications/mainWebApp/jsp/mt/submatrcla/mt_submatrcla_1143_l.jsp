...
<%
	RwXml rx = new RwXml();
	MT_SUBMATRCLA_1143_LDataSet ds = (MT_SUBMATRCLA_1143_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			MT_SUBMATRCLA_1143_LCURLISTRecord rec = (MT_SUBMATRCLA_1143_LCURLISTRecord)ds.curlist.get(i);
