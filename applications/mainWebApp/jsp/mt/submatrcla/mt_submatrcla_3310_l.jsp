...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			MT_SUBMATRCLA_3310_LCURLISTRecord rec = (MT_SUBMATRCLA_3310_LCURLISTRecord)ds.curlist.get(i);
			...
			rx.add(record, "part_clas2_nm", StringUtil.replaceToXml(rec.part_clas2_nm));
			rx.addCData(record, "std", StringUtil.replaceToXml(rec.std));
...
<% /* 작성시간 : Sat Jul 11 17:17:09 KST 2009 */ %>