...
<% 
	RwXml rx = new RwXml();
	MT_SUBMATRCLA_3101_LDataSet ds = (MT_SUBMATRCLA_3101_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			MT_SUBMATRCLA_3101_LCURLISTRecord rec = (MT_SUBMATRCLA_3101_LCURLISTRecord)ds.curlist.get(i);
			...
			rx.add(record, "part_clas2", StringUtil.replaceToXml(rec.part_clas2));
