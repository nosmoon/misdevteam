...
<%
	RwXml rx = new RwXml();
	MT_COMMON_3001_LDataSet ds = (MT_COMMON_3001_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			MT_COMMON_3001_LCURLISTRecord rec = (MT_COMMON_3001_LCURLISTRecord)ds.curlist.get(i);
