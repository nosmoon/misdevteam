...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist4.size(); i++) {
			MT_ETCCAR_1000_500_LCURLIST4Record rec = (MT_ETCCAR_1000_500_LCURLIST4Record)ds.curlist4.get(i);
		...
		for(int i = 0; i < ds.curlist3.size(); i++) {
			MT_ETCCAR_1000_500_LCURLIST3Record rec = (MT_ETCCAR_1000_500_LCURLIST3Record)ds.curlist3.get(i);
			int record = rx.add(recordSet, "record", "");
		...
		for(int i = 0; i < ds.curlist2.size(); i++) {
			MT_ETCCAR_1000_500_LCURLIST2Record rec = (MT_ETCCAR_1000_500_LCURLIST2Record)ds.curlist2.get(i);
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			MT_ETCCAR_1000_500_LCURLIST1Record rec = (MT_ETCCAR_1000_500_LCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "drvr_nm", StringUtil.replaceToXml(rec.drvr_nm));
