...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			MT_PAPINOUT_8008_LCURLIST1Record rec = (MT_PAPINOUT_8008_LCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "gubun", rec.gubun);
			rx.add(record, "msprtdat", (rec.msprtdat.length() < 1 ) ? rec.msprtdat : rec.msprtdat.substring(0,4) + "-" + rec.msprtdat.substring(4,6));
...
<% /* 작성시간 : Wed Jul 01 16:00:42 KST 2009 */ %>