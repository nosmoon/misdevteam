...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist1.size(); i++) {
			MT_PAPINOUT_9112_LCURLIST1Record rec = (MT_PAPINOUT_9112_LCURLIST1Record)ds.curlist1.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "gubun", rec.gubun);
			rx.add(record, "wiibgodat", (rec.wiibgodat.length() < 1 ) ? rec.wiibgodat : rec.wiibgodat.substring(0,4) + "-" + rec.wiibgodat.substring(4,6));
