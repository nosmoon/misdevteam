...
<%
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			MT_PAPINOUT_4301_LCURLISTRecord rec = (MT_PAPINOUT_4301_LCURLISTRecord)ds.curlist.get(i);
			...
			rx.add(record, "cut_err_point", rec.cut_err_point);
			rx.add(record, "cut_err_caus_prd", rec.cut_err_caus_prd);
			rx.add(record, "cut_err_caus_midl", rec.cut_err_caus_midl);
