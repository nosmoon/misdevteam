...
<%
	...
	try {
		...
		for(int i = 0; i < ds.teamlist.size(); i++) {
			SE_RCP_4300_MTEAMLISTRecord rec = (SE_RCP_4300_MTEAMLISTRecord)ds.teamlist.get(i);
		...
		for(int i = 0; i < ds.arealist.size(); i++) {
			SE_RCP_4300_MAREALISTRecord rec = (SE_RCP_4300_MAREALISTRecord)ds.arealist.get(i);
			int record = rx.add(recordSet, "record", "");
		...
		for(int i = 0; i < ds.partlist.size(); i++) {
			SE_RCP_4300_MPARTLISTRecord rec = (SE_RCP_4300_MPARTLISTRecord)ds.partlist.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "dept_cd", rec.dept_cd);
			rx.add(record, "dept_nm", rec.dept_nm);
			rx.add(record, "supr_dept_cd", rec.supr_dept_cd);
...
<% /* 작성시간 : Mon May 25 12:00:41 KST 2009 */ %>