...
<%
	...
	try {
		...
		for(int i = 0; i < ds.team_cdcur.size(); i++) {
			SE_RCP_1500_MTEAM_CDCURRecord rec = (SE_RCP_1500_MTEAM_CDCURRecord)ds.team_cdcur.get(i);
		...
		for(int i = 0; i < ds.part_cdcur.size(); i++) {
			SE_RCP_1500_MPART_CDCURRecord rec = (SE_RCP_1500_MPART_CDCURRecord)ds.part_cdcur.get(i);
		...
		for(int i = 0; i < ds.area_cdcur.size(); i++) {
			SE_RCP_1500_MAREA_CDCURRecord rec = (SE_RCP_1500_MAREA_CDCURRecord)ds.area_cdcur.get(i);
