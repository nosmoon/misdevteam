...
%>
<%---------------------------------------------------------------------------------------------------
* 파일명 : se_rcp_4400_m.jsp
* 기능 : 스포츠조정액(마감일)등록-초기화면
* 작성일자 : 2009-05-18
* 작성자 : 배창희
---------------------------------------------------------------------------------------------------%>
<%---------------------------------------------------------------------------------------------------
...
<%
	...
	try {
		...
		for(int i = 0; i < ds.team_cdcur.size(); i++) {
			SE_RCP_4400_MTEAM_CDCURRecord rec = (SE_RCP_4400_MTEAM_CDCURRecord)ds.team_cdcur.get(i);
		...
		for(int i = 0; i < ds.part_cdcur.size(); i++) {
			SE_RCP_4400_MPART_CDCURRecord rec = (SE_RCP_4400_MPART_CDCURRecord)ds.part_cdcur.get(i);
		...
		for(int i = 0; i < ds.area_cdcur.size(); i++) {
			SE_RCP_4400_MAREA_CDCURRecord rec = (SE_RCP_4400_MAREA_CDCURRecord)ds.area_cdcur.get(i);
