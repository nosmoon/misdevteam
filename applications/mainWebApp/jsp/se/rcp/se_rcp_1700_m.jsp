...
<%
	...
	try {
		...
		for(int i = 0; i < ds.team_cdcur.size(); i++) {
			SE_RCP_1700_MTEAM_CDCURRecord rec = (SE_RCP_1700_MTEAM_CDCURRecord)ds.team_cdcur.get(i);
		...
		for(int i = 0; i < ds.part_cdcur.size(); i++) {
			SE_RCP_1700_MPART_CDCURRecord rec = (SE_RCP_1700_MPART_CDCURRecord)ds.part_cdcur.get(i);
		...
		for(int i = 0; i < ds.area_cdcur.size(); i++) {
			SE_RCP_1700_MAREA_CDCURRecord rec = (SE_RCP_1700_MAREA_CDCURRecord)ds.area_cdcur.get(i);
		...
		for(int i = 0; i < ds.commcdcur1.size(); i++) {
			SE_RCP_1700_MCOMMCDCUR1Record rec = (SE_RCP_1700_MCOMMCDCUR1Record)ds.commcdcur1.get(i);
			item  = rx.add(bank_cd , "item" , "");
