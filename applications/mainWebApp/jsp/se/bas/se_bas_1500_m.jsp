...
<%
	...
	rx.add(root, "bas_yymm", ds.jd_yymm);
	...
	try {
		...
		for(int i = 0; i < ds.teamlist.size(); i++) {
			SE_BAS_1500_MTEAMLISTRecord rec = (SE_BAS_1500_MTEAMLISTRecord)ds.teamlist.get(i);
		...
		for(int i = 0; i < ds.partlist.size(); i++) {
			SE_BAS_1500_MPARTLISTRecord rec = (SE_BAS_1500_MPARTLISTRecord)ds.partlist.get(i);
			int record = rx.add(recordSet, "record", "");
			rx.add(record, "dept_cd", rec.dept_cd);
			rx.add(record, "dept_nm", rec.dept_nm);
		...
		for(int i = 0; i < ds.arealist.size(); i++) {
			SE_BAS_1500_MAREALISTRecord rec = (SE_BAS_1500_MAREALISTRecord)ds.arealist.get(i);
			int record = rx.add(recordSet, "record", "");
