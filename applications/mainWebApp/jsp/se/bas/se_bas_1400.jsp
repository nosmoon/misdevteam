...
<script language="javascript" src="/html/js/TFControlWrite.js"></script>
		...
		<tr>
			<td width="100%" height="100%" style="border:0px; padding:0px;">						
				<div id="TFViewerControlLocation">
					<script>
						TFViewerWrite(TFViewerControlLocation, "mainFrame", "../../../xrw/se/bas/SE_BAS_1400.xrw", "100%", "100%", "http://127.0.0.1:7001");
					</script>
				</div>
			</td>
		</tr> 
