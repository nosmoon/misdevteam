...
%>
<%---------------------------------------------------------------------------------------------------
* 파일명 : se_snd_1140_l.jsp
* 기능 : 판매 - 발송관리 - 노선등록 - 입력용 노선 조회
* 작성일자 : 2009.02.03
* 작성자 : 김대준
---------------------------------------------------------------------------------------------------%>
...
<%
	RwXml rx = new RwXml();
	SE_SND_1140_LDataSet ds = (SE_SND_1140_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			SE_SND_1140_LCURLISTRecord rec = (SE_SND_1140_LCURLISTRecord)ds.curlist.get(i);
