...
<%
	RwXml rx = new RwXml();
	SE_QTY_2460_LDataSet ds = (SE_QTY_2460_LDataSet)request.getAttribute("ds");
	...
	try {
		for(int i = 0; i < ds.curlist.size(); i++) {
			SE_QTY_2460_LCURLISTRecord rec = (SE_QTY_2460_LCURLISTRecord)ds.curlist.get(i);
