...
%>
<%---------------------------------------------------------------------------------------------------
* 파일명 : se_qty_1600_m.jsp
* 기능 : 전월대비유가발송부수조회-초기화면
* 작성일자 : 2009-02-20
* 작성자 : 배창희
---------------------------------------------------------------------------------------------------%>
<%---------------------------------------------------------------------------------------------------
...
<%
	...
	try {
		...
		for(int i = 0; i < ds.team_cdcur.size(); i++) {
			SE_QTY_1600_MTEAM_CDCURRecord rec = (SE_QTY_1600_MTEAM_CDCURRecord)ds.team_cdcur.get(i);
		...
		for(int i = 0; i < ds.part_cdcur.size(); i++) {
			SE_QTY_1600_MPART_CDCURRecord rec = (SE_QTY_1600_MPART_CDCURRecord)ds.part_cdcur.get(i);
		...
		for(int i = 0; i < ds.area_cdcur.size(); i++) {
			SE_QTY_1600_MAREA_CDCURRecord rec = (SE_QTY_1600_MAREA_CDCURRecord)ds.area_cdcur.get(i);
		...
		for(int i = 0; i < ds.commcdcur1.size(); i++) {
			SE_QTY_1600_MCOMMCDCUR1Record rec = (SE_QTY_1600_MCOMMCDCUR1Record)ds.commcdcur1.get(i);
