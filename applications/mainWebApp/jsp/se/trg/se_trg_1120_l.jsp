...
<%
	...
	try {
		for(int i = 0; i < ds.curlist.size(); i++) {
			SE_TRG_1120_LCURLISTRecord rec = (SE_TRG_1120_LCURLISTRecord)ds.curlist.get(i);
			...
			rx.add(record, "pr12_rslt", rec.pr12_rslt);
...
<% /* 작성시간 : Thu Mar 26 14:48:18 KST 2009 */ %>