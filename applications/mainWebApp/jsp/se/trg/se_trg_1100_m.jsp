...
<%
	...
	try {
		...
		for(int i = 0; i < ds.team_cdcur.size(); i++) {
			SE_TRG_1100_MTEAM_CDCURRecord rec = (SE_TRG_1100_MTEAM_CDCURRecord)ds.team_cdcur.get(i);
		...
		for(int i = 0; i < ds.part_cdcur.size(); i++) {
			SE_TRG_1100_MPART_CDCURRecord rec = (SE_TRG_1100_MPART_CDCURRecord)ds.part_cdcur.get(i);
		...
		for(int i = 0; i < ds.area_cdcur.size(); i++) {
			SE_TRG_1100_MAREA_CDCURRecord rec = (SE_TRG_1100_MAREA_CDCURRecord)ds.area_cdcur.get(i);
		...
		int trgt_clsf = rx.add(comboSet, "trgt_clsf", "");
		for(int i = 0; i < ds.commcdcur1.size(); i++) {
			SE_TRG_1100_MCOMMCDCUR1Record rec = (SE_TRG_1100_MCOMMCDCUR1Record)ds.commcdcur1.get(i);
			item  = rx.add( trgt_clsf , "item" , "");
