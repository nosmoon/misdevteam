...
%>
<%---------------------------------------------------------------------------------------------------
* 파일명 : se_comm_1210_l.jsp
* 기능 : 판매 - 노선구분코드 팝업 - 초기화면
* 작성일자 : 2009.01.15
* 작성자 : 김대준
---------------------------------------------------------------------------------------------------%>
...
<%
	RwXml rx = new RwXml();
	SE_COMM_1210_LDataSet ds = (SE_COMM_1210_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			SE_COMM_1210_LCURLISTRecord rec = (SE_COMM_1210_LCURLISTRecord)ds.curlist.get(i);
