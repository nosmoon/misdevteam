...
<%
	RwXml rx = new RwXml();
	TN_BAS_1100_MDataSet ds = (TN_BAS_1100_MDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.xx_combo_010.size(); i++) {
			TN_BAS_1100_MXX_COMBO_010Record rec = (TN_BAS_1100_MXX_COMBO_010Record)ds.xx_combo_010.get(i);
...
<% /* 작성시간 : Fri Jun 17 10:05:04 KST 2016 */ %>