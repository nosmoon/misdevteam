...
<%
	 // getting dataset
    CO_COCD_2020_SDataSet ds = (CO_COCD_2020_SDataSet)request.getAttribute("ds");  // request dataset
	...
	{
		CO_COCD_2020_SCURCOMMLISTRecord rec = (CO_COCD_2020_SCURCOMMLISTRecord)ds.curcommlist.get(i);
