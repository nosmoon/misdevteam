...
<%
	 // getting dataset
    CO_COCD_2010_SDataSet ds = (CO_COCD_2010_SDataSet)request.getAttribute("ds");  // request dataset
	...
	{
		CO_COCD_2010_SCURCOMMLISTRecord rec = (CO_COCD_2010_SCURCOMMLISTRecord)ds.curcommlist.get(i);
