...
function validate_id(s_id){
    ...
    var format = /^(\w{1}\d{4}|\w{1}\d{5}|\w{1}\d{6}|\w{1}\d{7}|\d{5}|\d{6}|\d{7}|\d{8})$/;
      ...
      <table width=493 border=0 cellpadding=0 cellspacing=0>
        ...
        <tr>
          ...
          <td bgcolor="#F2F3F3" height="140">
		    ...
		    <form name="re_pwd_form" method="post" action="/jsp/ps/sm/co_login_1100_u.jsp" >
				...
				<tr bgcolor="#FFFFFF"> 
					...
					<td height="24" align="left"><input type="text" name="userid" size="18" class="text_box" caption="아이디" notEmpty value="<%=userid%>" onkeydown="if(event.keyCode=='13'){document.all.login_btn_id.focus();window.event.returnValue=false;}"></td>
				</tr>
				<tr bgcolor="#FFFFFF"> 
