...
function list_search(curr_page_no)
{
    ...
    lo_form1.aloncd.value= "08" ; // 현금수당
    lo_form1.action = "/ps/allow/1906";
...
function ins_alon(){
    ...
    var ls_trgtnoit      = 0; // 선택된 목표건수 값을 담는다
    var ls_fix_rateclsf  = ""; // 선택된 정렬구분 값을 담는다
    var ls_ratiocalcclsf = ""; // 선택된 비율계산구분  값을 담는다
    var ls_amt           = 0; // 선택된 금액 값을 담는다.
    var ls_ratio         = 0; // 선택된 비율값을 담는다.
    var len  = "" ;
        if(lo_form.insChk){
...
<form name="code_search_form" method="post" action="" onsubmit="list_search(1)">
    ...
    <input name="aloncd" type="hidden" value ="08"><!--//현금수당구분 값-->
  ...
  <tr>
    <td valign="top">
      ...
      <table width="830" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <td height="27" class="title" bgcolor="#EBE9DC"><b>현금수당목록</b></td>
