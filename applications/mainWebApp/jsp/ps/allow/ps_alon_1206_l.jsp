...
%>
        ...
        <tr>
          ...
          <td  width="100" align="center" class="gray">
            <input name="trgtnoit" type="text" size="6" comma caption="목표건수" dataType="number" style='text-align:right;' value="<%= curcommlistRec.trgtnoit%>" class="text_box">
          </td>
          <td  width="100" align="center" class="gray">
          ...
          <td  width="100" align="center" class="gray">
            <input name="amt" type="text" size="10" style='text-align:right;' caption="금액" comma dataType="number" value="<%= curcommlistRec.amt%>" class="text_box">
          </td>
          <td width="100" align="center" class="gray" >
