...
function list_search(curr_page_no)
{
    ...
    lo_form1.aloncd.value= "05" ; // 직책수당
    lo_form1.action = "/ps/allow/1506";
...
<form name="code_search_form" method="post" action="" onsubmit="list_search(1)">
    ...
    <input name="aloncd" type="hidden" value ="05"><!--//직책수당구분 값-->
      ...
      <table width="830" border="0" cellspacing="0" cellpadding="2" class="title1" bgcolor="#EBE9DC">
        <tr>
          ...
          <img src="/html/comm_img/ic_title.gif" width="11" height="7" align="absmiddle">지사<font color="red">*</font>
            ...
            <select id="bodept_sel" name="deptcd" class="sel_all" caption="부서">
              <option value="" >전체</option>
            </select>&nbsp;&nbsp;&nbsp;&nbsp;
            <img src="/html/comm_img/ic_title.gif" width="11" height="7" align="absmiddle">직책
            <select name="dutycd" class="sel_all" caption="직책" >
              <option value="" >전체</option>
              <%=ds.dutycurOptHtml("")%>
            </select>&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td valign="top">
      ...
      <table width="830" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <td height="27" class="title" bgcolor="#EBE9DC"><B>직책수당목록</B></td>
