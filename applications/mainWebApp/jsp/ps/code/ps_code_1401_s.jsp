...
<%
    ...
    rxw.makeDataToList(ds, "asinbocdcur", "bonm", "bocd", "전체", "", initTemp, "branchCombo2"); // 지사
    rxw.makeDataToList(ds, "alonlist", "cicdnm", "cicodeval", "선택", "", initTemp, "branchPayCombo");  // 지사수당지급시점
    rxw.makeDataToList(ds, "alonlist", "cicdnm", "cicodeval", "선택", "", initTemp, "mainPayCombo");  // 본사수당지급시점
