...
function check_enter_search(){
	...
	if(lo_form1.bonm.value != ''){
	    ...
	    lo_form1.action = "/ps/common/1911";
...
function list_search_addr3(){
    ...
    // 읍/면/동 입력을  "/ps/common/1115" 서블릿으로 보낸다
	...
	lo_form1.bonm.value = '';
    lo_form1.action = "/ps/common/1115";
    lo_form1.target = "ifrm";
    lo_form1.submit();
}
...
function list_search_bonm(){
    ...
    // 지국명 입력을 "/ps/common/1115" 서블릿으로 보낸다
	if(lo_form1.bonm.value == ''){
		alert("지국이름을 입력하세요");
		return
	}
