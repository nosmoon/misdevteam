...
/*
        if(lo_form.bocd.value == ''){
			alert("구독자주소를 올바르게 입력해주세요");
			lo_form.dlvzip.value = "";
			lo_form.dlvaddr.value = "";
			return;
		}
*/
...
<form name="shftaplc_detail_form" method="post" action="" >
	...
	<input type="hidden" name="shftclsf"    value="110">	<!--이체구분(지로)-->
...
<tr>
	...
	<td  height="25" bgcolor="#EBE9DC" class="title">이체계좌 정보</td>
	</td>
<tr>
	<td height="3">
	<!--여백-->
...
<table border="0" cellspacing="0" cellpadding="2" width="830" class="gray">
	<tr >
		<td height="25"   width="150" bgcolor="#EBE9DC" class="gray">예금주명<font color="red">*</font></td>
		<td class="gray" >
			<input type="text" name="pymtnm" size="15" style="ime-mode:active;" class="text_box" caption="예금주명" notEmpty>
		</td>
		<td class="gray" bgcolor="#EBE9DC" width="120" >예금주전화번호<font color="red">*</font></td>
		<td class="gray" >
			<input type="text" name="pymttel1" size="4" maxlength="4" class="text_box" caption="예금주전화번호" dataType=integer notEmpty>
			-
			<input type="text" name="pymttel2" size="4" maxlength="4" class="text_box" caption="예금주전화번호" dataType=integer notEmpty>
			-
			<input type="text" name="pymttel3" size="4" maxlength="4" class="text_box" caption="예금주전화번호" dataType=integer notEmpty>
		</td>
	</tr>
	<tr >
		<td height="24" width="150" bgcolor="#EBE9DC" class="gray">이체은행<font color="red">*</font></td>
		<td class="gray" colspan="3" height="24" >
			<select name="bankcd" class="sel_all" caption="이체은행" notEmpty>
	...
	<tr >
		<td height="25" width="150" bgcolor="#EBE9DC" class="gray">계좌번호<font color="red">*</font></td>
		<td class="gray" colspan="3" >
			<input type="text" name="acctno" size="30" maxlength="20" class="text_box" caption="계좌번호" dataType=integer notEmpty>
			◈ -는 제외하고 입력
		</td>
	</tr>
	<tr >
