...
<%
    ...
    if(curr_page_no > 1 && total_records > 0){
        out.write("<img src=\"/html/comm_img/bu_first01.gif\" style=\"cursor:hand\" onclick=\""+js_fn_nm+"(1);\" width=\"17\" height=\"15\" alt=\"처음 페이지로\" align=\"absmiddle\" border=\"0\" >");
    } else {
        out.write("<img src=\"/html/comm_img/bu_first01.gif\" width=\"17\" height=\"15\" alt=\"처음 페이지로\" align=\"absmiddle\" border=\"0\" >");
    }

    if(curr_page_no > 1 && total_records > 0){
        out.write("<img src=\"/html/comm_img/bu_prev01.gif\" style=\"cursor:hand\" onclick=\""+js_fn_nm+"("+(curr_page_no-1)+");\" width=\"22\" height=\"15\" alt=\"이전 페이지로\" align=\"absmiddle\" border=\"0\" >");
    }else{
        out.write("<img src=\"/html/comm_img/bu_prev01.gif\" width=\"22\" height=\"15\" alt=\"이전 페이지로\" align=\"absmiddle\" border=\"0\" >");
    }
    ...
    if(total_records > 0 && curr_page_no < total_pages){
        out.write("<img src=\"/html/comm_img/bu_next01.gif\" style=\"cursor:hand\" onclick=\""+js_fn_nm+"("+(curr_page_no+1)+");\" width=\"22\" height=\"15\" alt=\"다음 페이지로\" align=\"absmiddle\" border=\"0\" >");
    }else{
        out.write("<img src=\"/html/comm_img/bu_next01.gif\" width=\"22\" height=\"15\" alt=\"다음 페이지로\" align=\"absmiddle\" border=\"0\" >");
    }
    if(total_records > 0 && curr_page_no < total_pages){
        out.write("<img src=\"/html/comm_img/bu_end01.gif\" style=\"cursor:hand\" onclick=\""+js_fn_nm+"("+total_pages+");\" width=\"17\" height=\"15\" alt=\"마지막 페이지로\" align=\"absmiddle\" border=\"0\" >");
    }else{
        out.write("<img src=\"/html/comm_img/bu_end01.gif\" width=\"17\" height=\"15\" alt=\"마지막 페이지로\" align=\"absmiddle\" border=\"0\" >");
    }
%>
