...
<%
    //  dataset 인스턴스 선언부분
    PS_P_BO_SEND_LISTDataSet ds = (PS_P_BO_SEND_LISTDataSet)request.getAttribute("ds");  // request dataset

    String sendyymmdd = Util.checkString(request.getParameter("sendyymmdd"));
    String mediser_no = Util.checkString(request.getParameter("mediser_no"));

    String sysDate = Util.getDate();                // 엑셀화일 저장시 파일이름으로 사용
    //String filename = "지국별발송독자_"+sysDate+".xls";    // 엑셀화일 저장시 파일이름으로 사용
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=800 style='border-collapse:
 ...
 <tr height=18 style='height:13.5pt'>
  <td height=18 class=xl24 style='height:13.5pt;border-top:none;border-left:none'>호수</td>
...
-->
  <td class=xl24 style='border-top:none;border-left:none'>구역번호</td>
  <td class=xl24 style='border-top:none;border-left:none'>배달번호</td>
...
<%for(int i=0; i<ds.curcommlist.size(); i++){
 ...
 <tr height=18 style='height:13.5pt'>
  <td height=18 class=xl27 style='height:13.5pt;border-top:none'><%=mediser_no%></td>
  ...
  <td class=xl27 style='border-top:none;border-left:none'><%= curcommlistRec.acq_bonm%></td>

  <td class=xl27 style='border-top:none;border-left:none'><%= curcommlistRec.rdr_no_all%></td>
  <td class=xl27 style='border-top:none;border-left:none'><%= curcommlistRec.acqnm%> <%= curcommlistRec.offposi%></td>
<!--  <td class=xl32 style='border-top:none;border-left:none'>< %= curcommlistRec.telno%></td> -->
<!--  <td class=xl32 style='border-top:none;border-left:none'>< %= curcommlistRec.rdrptph_no%></td> -->
  <td class=xl27 style='border-top:none;border-left:none'><%= curcommlistRec.zip%></td>
  <td class=xl27 style='border-top:none;border-left:none'><%= curcommlistRec.dlvaddr%> <%= curcommlistRec.dlvdtlsaddr%> <%= curcommlistRec.offnm%></td>
  <td class=xl27 style='border-top:none;border-left:none'><%= curcommlistRec.dstccd%></td>
  <td class=xl27 style='border-top:none;border-left:none'><%= curcommlistRec.dlvno%></td>
...
<!--  <td class=xl27 style='border-top:none;border-left:none'>< %=sendyymmdd%></td>
  ...
  <td class=xl32 style='border-top:none;border-left:none'>< %= curcommlistRec.sendcnt%></td>
-->
 </tr>
