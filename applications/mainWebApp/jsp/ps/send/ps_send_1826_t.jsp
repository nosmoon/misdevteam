...
<%
    //  dataset 인스턴스 선언부분
    PS_P_SEND_BNSBK_STICKERDataSet ds = (PS_P_SEND_BNSBK_STICKERDataSet)request.getAttribute("ds");  // request dataset
	String sendmthd = Util.checkString(request.getParameter("slt_sendmthd"));

    String sysDate = Util.getDate();                // 엑셀화일 저장시 파일이름으로 사용
    //String filename = "보너스북발송_"+sysDate+".xls";    // 엑셀화일 저장시 파일이름으로 사용
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=800 style='border-collapse:
 ...
 <tr height=18 style='height:13.5pt'>
  ...
  <td class=xl24 style='border-top:none;border-left:none'>보너스북명</td>
...
<%for(int i=0; i<ds.curcommlist.size(); i++){
 ...
 <tr height=18 style='height:13.5pt'>
  ...
  <td class=xl27 style='border-top:none;border-left:none'><%= curcommlistRec.bnsbk%></td>
  ...
  <td class=xl32 style='border-top:none;border-left:none'><% if(sendmthd.equals("60")) { out.print(curcommlistRec.rnum); } else { out.print("1"); } %></td>
 </tr>
<%}%>
