...
<%
	RwXml rx = new RwXml();
	EN_INNEXP_3102_LDataSet ds = (EN_INNEXP_3102_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			EN_INNEXP_3102_LCURLISTRecord rec = (EN_INNEXP_3102_LCURLISTRecord)ds.curlist.get(i);
