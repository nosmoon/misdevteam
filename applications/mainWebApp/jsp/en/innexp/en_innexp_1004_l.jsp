...
<%
	RwXml rx = new RwXml();
	EN_INNEXP_1004_LDataSet ds = (EN_INNEXP_1004_LDataSet)request.getAttribute("ds");
	...
	try {
		...
		for(int i = 0; i < ds.curlist.size(); i++) {
			EN_INNEXP_1004_LCURLISTRecord rec = (EN_INNEXP_1004_LCURLISTRecord)ds.curlist.get(i);
