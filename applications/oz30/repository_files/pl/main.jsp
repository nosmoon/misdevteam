...
%>
<iframe frameborder=0 name=bodyframe scrolling=no src="http://iam.chosun.com/IMPlus/customer/setLastLoginDate.jsp?SERVICE_ID=MISCOM&USER_ID=<%=uid%>&SERVICE_USER_ID=<%=uid%>" width="500" height="0"></iframe>
<%
...
<script language="javascript">
	...
	function pop_system(){
		jsNewModalWinNoS("/html/popup01_2.html","a","450","520");
	}
</script>
...
.pop_close { color: #000000; cursor: pointer; top: -24px; left: 0; position: absolute; }
</style>
...
<!--
      ...
      if (!isIE5 && !isIE6) 
         ...
         alert!("인터넷 익스플로러 5 이상에서만 볼 수 있습니다!");
//-->
</script>
</HEAD>
            ...
            <table cellSpacing="0" cellPadding="0" width="100%" height="70" border="0" background="/images/top_bg.gif">
                <tr>
			        ...
			        <td valign="middle" rowspan=3 border=0 align="left" width="100" height="70">
			        	...
			        	<script type="text/javascript">swfShow("/flash/logo01.swf", 115, 46)</script>
			        	<br>
			        </td>
                    ...
                    <% if(cmpycd.equals("100") && deptcd.substring(0,2).equals("52") ) { %>
                    		<a href="http://cscafe.chosun.com/login.jsp" target="_blank"><img height="18" border=0 src="/images/05.gif"></a>
                    <% } %>
